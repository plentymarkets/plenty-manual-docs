...
find handbuchcsv.csv -exec sed -r -i -E "s/<<([a-zA-ZäöüÄÖÜß0-9\_\-]+)([a-zA-ZäöüÄÖÜß0-9\/\_\-]+)?\/([a-zA-ZäöüÄÖÜß0-9\_\-]+)(#([a-zA-ZäöüÄÖÜß0-9\_\-]+)?)?(, ?([ a-zA-ZäöüÄÖÜß0-9\(\)\_\-]*)?)>>/xref:\1:\3.adoc\4\[\7]/g;s/\[\.tabs\]/\[tabs\]/ig" {} \;
