...
| Kopiere einen oder mehrere Kataloge, die du in der ersten Spalte der Liste gewählt hast. (xref:partial:catalogues-manage.adoc#190[Wie?])

| material:file_download[]
| Exportiere einen oder mehrere Kataloge, die du in der ersten Spalte der Liste gewählt hast. (xref:partial:catalogues-manage.adoc#270[Wie?]) +
...
| Importiere einen Katalog. (xref:partial:catalogues-manage.adoc#280[Wie?]) +
...
| material:history[]
| Stelle eine vorherige Version eines oder mehrerer Kataloge wieder her. (xref:partial:catalogues-manage.adoc#250[Wie?])

_oder_

Stelle einen gelöschten Katalog wieder her. (xref:partial:catalogues-manage.adoc#240[Wie?])

| material:delete[]
| Lösche einen Katalog. (xref:partial:catalogues-manage.adoc#210[Wie?])
