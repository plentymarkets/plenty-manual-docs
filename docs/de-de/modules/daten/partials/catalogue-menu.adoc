Wenn du das Menü *Daten » Kataloge* öffnest, siehst du als erstes die Katalogübersicht. xref:daten:catalogue-first-contact.adoc#catalogue-overview[Diese Katalogübersicht kannst du hier kennenlernen.]
