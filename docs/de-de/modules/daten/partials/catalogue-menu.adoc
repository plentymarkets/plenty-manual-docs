Wenn du das Menü *Daten » Kataloge* öffnest, siehst du als erstes die Katalogübersicht. xref:daten:catalogues-first-contact.adoc#catalogue-overview[Diese Katalogübersicht kannst du hier kennenlernen.]

ifdef::file-export[Das Katalogmenü siehst du, wenn du einen Katalog mit Marktplatz-Format öffnest.]
ifdef::marketplace-export[Das Katalogmenü siehst du, wenn du einen Katalog mit Standardformat öffnest.]
