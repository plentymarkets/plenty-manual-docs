...
* xref:daten:catalogue-manage.adoc#190[Kataloge kopieren]
* xref:daten:catalogue-manage.adoc#210[Kataloge löschen]
* xref:daten:catalogue-manage.adoc#250[Andere Katalog-Version wiederherstellen]
* xref:daten:catalogue-manage.adoc#240[Gelöschten Katalog wiederherstellen]
* xref:daten:catalogue-manage.adoc#270[Kataloge exportieren]
* xref:daten:catalogue-manage.adoc#280[Kataloge importieren]
* xref:daten:catalogue-manage.adoc#catalogue-rights[Rechte für Backend-Benutzer:innen vergeben]
--
//end::faq-manage[]
