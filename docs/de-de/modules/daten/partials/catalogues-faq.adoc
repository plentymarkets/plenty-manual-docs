...
include::daten:page$artikel.adoc[tag=faq-export-key]

include::daten:page$artikel.adoc[tag=faq-missing-column]

include::daten:page$artikel.adoc[tag=faq-array]

include::daten:page$artikel.adoc[tag=faq-import]
