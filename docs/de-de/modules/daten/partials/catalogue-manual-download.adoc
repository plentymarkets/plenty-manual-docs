...
*_Aber:_* Das Browser-Tab und das plentymarkets Tab *Datenexport* dürfen nicht geschlossen oder neu geladen werden, während der Export läuft. Wenn du es doch tust, wird der Export gestoppt.
|===
