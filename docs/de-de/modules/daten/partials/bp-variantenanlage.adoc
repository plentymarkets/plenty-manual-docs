...
.Importe durchführen
====
Lade den Beispiel-Import herunter, entpacke die ZIP-Datei und xref:daten:ElasticSync.adoc#import-import[importiere die JSON-Datei in dein plentymarkets System].
...
Falls noch nicht bereits getan, lade den Beispiel-Import herunter, entpacke die ZIP-Datei und xref:daten:ElasticSync.adoc#import-import[importiere die JSON-Datei in dein plentymarkets System].
