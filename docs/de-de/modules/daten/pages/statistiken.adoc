...
====
Das auf dieser Seite beschriebene Statistikmodul wird nicht mehr weiterentwickelt. Das bedeutet, dass künftig keine weiteren Funktionalitäten mehr ergänzt werden. Zur Aufbereitung deiner Geschäftszahlen kannst du bereits jetzt das neu entwickelte <<business-entscheidungen/plenty-bi/myview-dashboard#, Dashboard>> nutzen. Dieses ist Teil des Moduls <<business-entscheidungen/plenty-bi#, plentyBI>> und erlaubt dir noch mehr Flexibilität bei der Auswertung deiner Statistiken.
====
