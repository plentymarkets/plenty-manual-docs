...
Mit Hilfe der Änderungshistorie im Menü *Daten » CRM-Historie* kannst du Änderungen an xref:crm:kontakte.adoc#[Kontaktdaten], ShopBooster-Daten oder die Einstellungen zur xref:daten:datenbereinigung.adoc#[Datenbereinigung] nachvollziehen.
