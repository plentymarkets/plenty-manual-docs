...
====
Das Erstellen von neuen Kategorien ist mit dem Datenformat **Item** nicht möglich. Du kannst mit dem Datenformat **Item** lediglich neue Kategorieverknüpfungen am Artikel erstellen. Verwende daher das Datenformat <<daten/export-import/datenformate/category#, Category>>, um neue Kategorien zu erstellen.
====

* **Artikelbilder**

Mit diesem Datenformat können externe Bilder mittels URL importiert werden. Dabei werden vorhandene Artikelbilder ersetzt. Werden mehrere Artikelbilder importiert, müssen diese Artikelbilder kommagetrennt ohne Leerzeichen angegeben werden. Wenn du vorhandene Bilder nicht ersetzen möchtest, importierst du die <<artikel/artikel-verwalten#680, Bilder>> ggf. per FTP-Upload.
...
|Amazon-Produktgenre; mögliche Werte, siehe <<daten/export-import/datenformate/item#50, Wertetabelle amazon_product_type>>.
...
|<<maerkte/amazon/amazon-einrichten#370, Amazon Multi-Channel>> +
**1** = Ja +
**0** = Nein
|
