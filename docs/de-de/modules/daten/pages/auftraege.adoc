...
| Exportiert die xref:auftraege:buchhaltung.adoc#150[Rundungseinstellungen] für den Auftrag. +
0 = Es wird nicht gerundet. +
1 = Es wird gerundet. +
Der automatisch generierte Export key für dieses Feld ist *orderConfig.roundTotalsOnly*.

| *Anzahl der Dezimalstellen*
| Exportiert die gewählte Einstellung zur xref:auftraege:buchhaltung.adoc#150[Anzahl von Nachkommastellen bei Preisen] für den Auftrag. +
