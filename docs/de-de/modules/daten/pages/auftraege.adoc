...
Vergiss nicht die *Export keys* anzupassen, wenn du Datenfelder mehrmals hinzufügst.
...
Die IDs sind im Kapitel <<daten/interne-IDs#30, Bundesländer, Bundesstaaten, Regionen und Bezirke>> aufgelistet.
