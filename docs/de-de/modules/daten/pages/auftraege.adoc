...
| *Eigenschaft*
| Exportiert eine zum Auftrag gehörende Eigenschaft. Mit Eigenschaft sind hier Informationen gemeint, die am Auftrag hängen, nicht die selbst erstellten Bestelleigenschaften. Möchtest du mehrere Eigenschaften exportieren, füge das Feld mehrmals hinzu und triff jeweils die entsprechende Auswahl. +
...
Weitere Informationen zu Adressen erhältst du im Handbuchkapitel xref:crm:kontakte-verwalten.adoc#590[Adressen verwalten].
...
Weitere Informationen zu Kontakten erhältst du im Handbuchkapitel xref:crm:kontakte-verwalten.adoc#90[Kontakte und Firmen verwalten].
...
Informationen zu Typen erhältst du im Handbuchkapitel xref:crm:kontakte-verwalten.adoc#20[Typ erstellen].
...
Informationen zu Kundenklassen erhältst du im Handbuchkapitel xref:crm:kontakte-verwalten.adoc#15[Kundenklasse erstellen].
...
Informationen zu Kontakten und zum Debitorenkotno erhältst du im Handbuchkapitel xref:crm:kontakte-verwalten.adoc#intable-kontakt-bearbeiten-debitorenkonto[Kontakt bearbeiten].
