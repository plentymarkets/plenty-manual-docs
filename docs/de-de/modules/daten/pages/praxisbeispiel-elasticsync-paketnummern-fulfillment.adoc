...
Bitte lies dir auf der Handbuchseite xref:daten:ElasticSync.adoc#1640[Import und Export] durch. Dort wird beschrieben, wie du eine Importdatei importierst.
