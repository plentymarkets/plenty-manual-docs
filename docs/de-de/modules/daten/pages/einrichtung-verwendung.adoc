...
|*Auftragsstatus*
|Beschränkt den Export auf Aufträge, die sich in den ausgewählten xref:auftraege:order-statuses.adoc#[Auftragsstatus] befinden.
...
|Wenn ein Status gewählt ist, werden alle exportierten Aufträge in diesen xref:auftraege:order-statuses.adoc#[Auftragsstatus] verschoben.
|===
...
| *Auftragsstatus ändern*
|Wenn ein Status gewählt ist, werden alle exportierten Aufträge in diesen xref:auftraege:oder-statuses.adoc#[Auftragsstatus] verschoben.
|===
