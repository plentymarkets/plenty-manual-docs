...
|Produkte an Marktplätze übertragen
|* <<daten/daten-exportieren/elastischer-export#200, Elastischer Export>>
* <<daten/daten-exportieren/elastischer-export#300, Plugins für Marktplätze>>

|Daten exportieren, überarbeiten, neu importieren
|* <<daten/daten-exportieren/elastischer-export#200, Elastischer Export>>
* <<daten/daten-exportieren/elastischer-export#500, FormatDesigner>>
|====
...
* <<plugins/hinzugefuegte-plugins-installieren#, Wie werden Plugins installiert?>>
...
* <<daten/daten-exportieren/FormatDesigner#, Wie wird FormatDesigner verwendet?>>
...
*_Hinweis_*: Zusätzliche <<daten/daten-exportieren/elastischer-export#800, Filter- und Formateinstellungen>> werden eingeblendet, sobald du den Typ wählst.
...
*_Hinweis_*: Zum einen sind dies die <<daten/daten-exportieren/elastischer-export#400, Datenformat-Plugins>>, die du aus plentyMarketplace heruntergeladen hast.
Zum anderen sind dies die Datenformate, die du mit Hilfe von <<daten/daten-exportieren/elastischer-export#500, FormatDesigner>> selbst erstellt hast.
...
Welche Filter- und Formateinstellungen du vornehmen musst, hängt davon ab, <<daten/daten-exportieren/elastischer-export#700, welchen Typ du gewählt hast>>.
...
| *Attribut*
|Beschränkt den Export auf ein bestimmtes <<artikel/einstellungen/attribute#, Attribut>>.

| *Sprache*
|Beschränkt den Export auf <<artikel/einstellungen/attribute#1000, Attributnamen in einer bestimmten Sprache>>.
|====
...
| *Ebene*
|Beschränkt den Export auf <<artikel/einstellungen/kategorien#100, Kategorien einer bestimmten Ebene>>.

| *Mandant*
|Beschränkt den Export auf <<artikel/einstellungen/kategorien#700, Kategorien eines bestimmten Mandanten>>.

| *Sprache*
|Beschränkt den Export auf Kategorien, die <<artikel/einstellungen/kategorien#1500, in einer bestimmten Sprache gespeichert>> wurden.

| *Typ*
|Beschränkt den Export auf einen bestimmten <<artikel/einstellungen/kategorien#700, Kategorie-Typ>>.
|====
...
| *Preise*
a|Beschränkt den Export auf Artikel mit <<artikel/artikel-verwalten#240, einem bestimmten Preis>>.
...
| *Tag (UND-Modus)*
|Gib ein oder mehrere Tag-Namen ein. Artikel, die mit _allen_ der gewählten <<willkommen/allgemeine-funktionen/tags#, Tags>> verknüpft sind, werden übertragen.

| *Tag (ODER-Modus)*
|Gib ein oder mehrere Tag-Namen ein. Artikel, die mit _mindestens einem_ der gewählten <<willkommen/allgemeine-funktionen/tags#, Tags>> verknüpft sind, werden übertragen.
...
| *Hersteller-ID*
|Beschränkt den Export auf <<artikel/einstellungen/hersteller#100, Hersteller mit einer bestimmten ID>>.

| *Position*
|Beschränkt den Export auf <<artikel/einstellungen/hersteller#100, Hersteller mit einer bestimmten Positionsnummer>>.
|====
...
|Wenn ein Status gewählt ist, werden alle exportierten Aufträge in diesen <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> verschoben.
|====
...
Die folgenden Filter stehen zur Verfügung, um <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Nachbestellungen>> und <<warenwirtschaft/umbuchungen-vornehmen#, Umbuchungen>> (Bestellungen) vor dem Export zu filtern. Kombiniere Filter, um die Auswahl weiter zu differenzieren.
...
| *Bereich*
|Beschränkt den Export auf Eigenschaften, die <<artikel/einstellungen/eigenschaften#620, für einen bestimmten Bereich>> gelten.

| *Datentyp*
|Beschränkt den Export auf <<artikel/einstellungen/eigenschaften#620, eine bestimmte Art von Eigenschaften>>.
|====
