...
| *Zeitplan: Wochentage* +
(bei Option *Zeitplan*)
| Standardmäßig sind alle Wochentage aktiviert. Klicke in das Feld. Wähle in der eingeblendeten Dropdown-Liste einen oder mehrere Wochentage ab. Exporte werden an diesen Wochentagen gestartet.
