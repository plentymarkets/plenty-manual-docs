...
* <<#optional-recalculate, Zahlenwerte neu berechnen (icon:calculate[set=material] *Formel*)>>
...
→ Eine Datei mit den ersten 5 Datenzeilen kann auf deinem Rechner gespeichert werden.
