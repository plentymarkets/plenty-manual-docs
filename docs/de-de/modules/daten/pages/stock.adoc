...
Detaillierte Informationen zur Vorgehensweise beim Datenaustausch mit dem Datenformat **Stock** findest du im Kapitel xref:daten:daten-exportieren.adoc#90[Warenbestände exportieren] auf der Handbuchseite **Daten exportieren**.
...
| **AveragePrice**
|Durchschnitts-Einkaufspreis (EK), siehe Handbuchseite xref:warenwirtschaft:wareneingaenge-verwalten.adoc#2b[Wareneingang]
|
