...
Mit dem Datenformat *CustomerProperty* exportierst du die im Menü <<crm/kontakte-verwalten#4000, Einrichtung » CRM » Eigenschaften>> gespeicherten Kundeneigenschaften. Du erstellst und exportierst das Datenformat im Menü *Daten » Dynamischer Export*. Wie du das Datenformat exportierst, ist auf der Handbuchseite <<daten/export-import/daten-exportieren#, Daten exportieren>> beschrieben.
...
Die in Tabelle 2 aufgelisteten Datenfelder stehen zum <<daten/export-import/daten-importieren#25, Datenabgleich>> zur Verfügung. Bei Pflichtabgleichfeldern (*P*) muss für die *Importaktion* die Option *Abgleich* gewählt werden. Alternative Abgleichfelder sind mit einem *A* gekennzeichnet.
