...
Jeder Marktplatz strukturiert Produktdaten anders. Oft werden sogar an denselben Marktplatz für verschiedene Produktkategorien (Tierfutter, Haushalt, Lebensmittel) unterschiedliche Produktdaten exportiert. Klar: Für Kinderschuhe sind deine Produktdaten anders als für Katzenfutter. Für Kinderschuhe gibst du zum Bespiel die Schuhgröße und das Material an. Für Katzenfutter zum Beispiel Grundpreisangaben, die Zutatenliste, für welche Katzen das Futter geeignet ist und so weiter.
