...
. Analysiere, welche Merkmale und Freitextfelder du für den Datenexport zu dem Marktplatz nutzt. Merkmale und Freitextfelder können für den Katalogexport nicht mehr verwendet werden. Erstelle deshalb Eigenschaften für alle Daten, die du weiter benötigst. +
