...
Mit den Marktplatz-Formaten des Katalogs exportierst du Varianten- und Bestandsdaten an viele Marktplätze und Preisportale. plentymarkets arbeitet daran, nach und nach alle Marktplätze auf den Katalogexport umzuziehen.

Auf dieser Handbuchseite erfährst du, wie du Kataloge verwendest, um Variantendaten an Marktplätze zu exportieren. Dabei wird nur die allgemeine Vorgehensweise beschrieben.

Genauere Informationen dazu, wie du einen Katalog für die einzelnen Marktplätze erstellst und aufbaust, findest du aber auf den Handbuchseiten der einzelnen xref:maerkte:maerkte.adoc#[Marktplätze].
...
[#properties]
=== Exkurs: Eigenschaften statt Merkmale
...
== Von alten Exporten auf Katalogexport wechseln

Für manche Marktplätze gibt es einen alten Export und einen Katalogexport. Hier erfährst du, wie du wechselst.

. Analysiere, welche Merkmale und Freitextfelder du für den Datenexport zu dem Marktplatz nutzt. Merkmale und Freitextfelder können für den Katalogexport nicht mehr verwendet werden. Erstelle deshalb Eigenschaften für alle Daten, die du weiterhin benötigst. +
