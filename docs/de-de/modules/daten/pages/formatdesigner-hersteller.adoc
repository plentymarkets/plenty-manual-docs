...
| *manufacturerResponsibleCountry*
|
include::artikel:partial$eu-verantwortlicher-land.adoc[]

| *manufacturerResponsibleEmail*
|
include::artikel:partial$eu-verantwortlicher-email.adoc[]

| *manufacturerResponsibleHouseNo*
|
include::artikel:partial$eu-verantwortlicher-haus-nr.adoc[]

| *manufacturerResponsibleName*
|
include::artikel:partial$eu-verantwortlicher-name.adoc[]

| *manufacturerResponsiblePostCode*
|
include::artikel:partial$eu-verantwortlicher-plz.adoc[]

| *manufacturerResponsibleStreet*
|
include::artikel:partial$eu-verantwortlicher-strasse.adoc[]

| *manufacturerResponsibleTown*
|
include::artikel:partial$eu-verantwortlicher-ort.adoc[]
