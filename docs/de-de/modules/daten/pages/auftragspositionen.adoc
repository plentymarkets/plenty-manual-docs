...
|ID der <<artikel/einstellungen/eigenschaften#500, Bestelleigenschaft>> der Auftragsposition

|Wert der Bestelleigenschaft
|Wert der <<artikel/einstellungen/eigenschaften#500, Bestelleigenschaft>> der Auftragsposition

|ID der Gruppe der Bestelleigenschaft
|ID der Gruppe der <<artikel/einstellungen/eigenschaften#500, Bestelleigenschaft>> der Auftragsposition
|====
