...
|Zahl in Tagen eingeben. Nach diesem Zeitraum werden Einträge in der xref:crm:kontakte-verwalten.adoc#5100[Historie] automatisch aus dem plentymarkets System gelöscht. In der Historie werden Änderungen an Daten geloggt. Maximalwert: 365 Tage. +
