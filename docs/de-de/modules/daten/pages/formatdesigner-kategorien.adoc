...
:author: team-item
:description: FormatDesigner: Kategorien können aus plentysystems exportiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Datenfelder.
