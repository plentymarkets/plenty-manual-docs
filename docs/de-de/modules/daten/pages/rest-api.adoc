...
Auch in manchen Plugins, etwa link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze/ebayoauth2_4787[eBay OAuth2^] und link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze/etsy_4689[Etsy^]{nbsp}icon:external-link[], werden sogenannte REST-Routen verwendet, um mit dem plentymarkets System zu kommunizieren. Um dies zu ermöglichen, müssen bestimmte Berechtigungen vergeben werden.
