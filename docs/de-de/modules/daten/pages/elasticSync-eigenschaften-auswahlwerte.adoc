...
Dies kann entweder xref:artikel:elasticSync-eigenschaften.adoc#[per Import] erfolgen.
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:eigenschaften.adoc#700[Einrichtung » Einstellungen » Eigenschaften » Konfiguration » [Eigenschaft öffnen] » Werte]
