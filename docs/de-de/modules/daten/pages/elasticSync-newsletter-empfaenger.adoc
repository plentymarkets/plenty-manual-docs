...
Das Ergebnis des Imports findest du im Backend im Menü xref:crm:newsletter-versenden.adoc#[*Einrichtung » CRM » Newsletter » E-Mails* in der Übersicht *E-Mails pro Ordner*].
...
Das Ergebnis des Imports findest du im Backend im Menü xref:crm:newsletter-versenden.adoc#[*Einrichtung » CRM » Newsletter » E-Mails » [Ordner aufklappen]*]. Dann die Suche (icon:search[role="blue"]) ausführen und den Datensatz aufklappen (icon:plus-square-o[]). Der Wert ist im Feld *Vorname* gespeichert.
...
Das Ergebnis des Imports findest du im Backend im Menü xref:crm:newsletter-versenden.adoc#[*Einrichtung » CRM » Newsletter » E-Mails » [Ordner aufklappen]*]. Dann die Suche (icon:search[role="blue"]) ausführen und den Datensatz aufklappen (icon:plus-square-o[]). Der Wert ist im Feld *Nachname* gespeichert.
...
Das Ergebnis des Imports findest du im Backend im Menü xref:crm:newsletter-versenden.adoc#[*Einrichtung » CRM » Newsletter » E-Mails » [Ordner aufklappen]*]. Dann die Suche (icon:search[role="blue"]) ausführen und den Datensatz aufklappen (icon:plus-square-o[]). Der Wert ist im Feld *E-Mail* gespeichert.
...
Das Ergebnis des Imports findest du im Backend im Menü xref:crm:newsletter-versenden.adoc#[*Einrichtung » CRM » Newsletter » E-Mails » [Ordner aufklappen]*]. Dann die Suche (icon:search[role="blue"]) ausführen und den Datensatz aufklappen (icon:plus-square-o[]). Der Wert ist im Feld *Bestätigt am* gespeichert.
