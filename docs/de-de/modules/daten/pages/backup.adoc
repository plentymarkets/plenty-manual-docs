...
<<automatisierung/prozesse/prozesse-einrichten#220, Systemspezifische Einstellungen>> wie Drucker und Status müssen ggf. neu gewählt werden.
...
Mehr Informationen findest du auf der Handbuchseite zum <<daten/datenlog#, Daten-Log>>.
