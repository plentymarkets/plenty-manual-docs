...
Ein Import dient dazu, die Daten einer Datei in plentymarkets zu plentymarkets zu importieren. Die Importdatei muss per Webspace oder HTTPS zugänglich sein.
