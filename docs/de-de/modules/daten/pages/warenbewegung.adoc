...
:description: Mit Formaten des Typs stockMovement exportierst du Warenbewegungen.
:position: 170
...
|createdAt
|<<warenwirtschaft/warenbestaende-verwalten#1100, Zeitstempel der Warenbewegung>>, wie im Tab *Warenbewegung* der Variante angezeigt.
