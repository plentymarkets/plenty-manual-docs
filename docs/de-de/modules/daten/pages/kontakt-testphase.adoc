...
// TODO: Welcher Wert wird bei Gelangensbestätigung exportiert? Eine Zahl? oder 1/0?
...
// TODO: Was wird bei Gastzugang exportiert? Eine 1? Und 0 wäre dann regulärer Zugang?
