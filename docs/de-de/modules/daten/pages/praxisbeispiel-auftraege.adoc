...
Wirf in diesem Zug auch noch mal einen Blick auf die xref:daten:kataloge-verwalten.adoc#260[Katalogexport] entsprechend regelmäßig in deinen Arbeitsablauf ein.
...
Ändere bei Bedarf die xref:daten:kataloge-verwalten.adoc#162[Export Keys] anpassen. Speichere (icon:save[set=material]) danach den Katalog.
...
Hast du alle Änderungen in den Katalog eingepflegt und ihn gespeichert, kannst du mithilfe der xref:daten:kataloge-verwalten.adoc#260[Katalog exportiert] werden.
