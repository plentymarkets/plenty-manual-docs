...
====
Das Erstellen von neuen Kategorien ist mit dem Datenformat **Variation** nicht möglich. Du kannst mit dem Datenformat **Variation** lediglich neue Kategorieverknüpfungen an der Variante erstellen. Verwende daher das Datenformat <<daten/export-import/datenformate/category#, Category>>, um neue Kategorien zu erstellen.
====

* **Artikelbilder**

Mit diesem Datenformat können externe Bilder mittels URL importiert werden. Dabei werden vorhandene Artikelbilder ersetzt. Werden mehrere Artikelbilder importiert, müssen diese Artikelbilder kommagetrennt ohne Leerzeichen angegeben werden. Wenn du vorhandene Bilder nicht ersetzen möchtest, importiere die <<artikel/artikel-verwalten#680, Bilder>> ggf. per FTP-Upload.
