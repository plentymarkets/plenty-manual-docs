...
:author: team-item
:description: FormatDesigner: Artikelbilder können aus plentymarkets exportiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Datenfelder.
