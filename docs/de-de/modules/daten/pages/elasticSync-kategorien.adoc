...
====
Stell dir mal vor, du bist ganz neu bei plentymarkets und möchtest alle deine Kategoriedaten auf einmal importieren. Wie geht so etwas? Wirf einen Blick auf xref:daten:best-practices-elasticsync-kategorien.adoc#[dieses praktische Beispiel], welches dich Schritt für Schritt durch den Prozess führt.
====
...
Dies teilt plentymarkets mit, wie die Kategorien zueinander in Beziehung stehen.
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-in-linkliste, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: In Linkliste>>
//end::linkliste[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-login, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Sichtbar>>
//end::right[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-sitemap, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Sitemap>>
//end::sichtbar[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#800, Artikel » Kategorien » Tab: Beschreibung 1>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#800, Artikel » Kategorien » Tab: Beschreibung 2>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-kurzbeschreibung, Artikel » Kategorien » Tab: Einstellungen » Eingabefeld: Kurzbeschreibung>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-position, Artikel » Kategorien » Tab: Einstellungen » Eingabefeld: Position>>
//end::position[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-template-liste, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Template-Liste>>
//end::templateliste[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-template-produkt, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Template-Produkt>>
//end::templateprodukt[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-template-seite, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Template-Seite>>
//end::templateseite[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-volltextsuche, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Volltextsuche>>
//end::volltextsuche[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-variablen-funktionen, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Template-Variablen und -Funktionen übersetzen>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-canonical, Artikel » Kategorien » Tab: Einstellungen » Eingabefeld: Canonical>>
//end::canonical[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-elmar-kategorie, Artikel » Kategorien » Tab: Einstellungen » Dropdown-Liste: Elmar-Kategorie>>
//end::elmarkategorie[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/kategorien#intable-mandant, Artikel » Kategorien » Tab: Einstellungen » Checkbox: Mandant (Shop)>>
//end::aktiv[]
