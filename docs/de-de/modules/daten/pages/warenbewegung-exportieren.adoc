...
Um nur bestimmte Daten von Warenbewegungen zu exportieren, kannst du Filter wählen und somit die Daten eingrenzen. Wie du Filter hinzufügst, erfährst du in <<daten/daten-exportieren/kataloge-verwalten#257, diesem Kapitel>>.
