...
:author: team-item
:description: FormatDesigner: Eigenschaften können aus plentysystems exportiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Datenfelder.
