...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:wareneingaenge-verwalten.adoc#500[Waren » Wareneingänge » [Suche ausführen] » [Wareneingang wählen] » Tab: Artikel].
