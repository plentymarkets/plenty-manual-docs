...
====
Stell dir mal vor, du bist ganz neu bei plentymarkets und möchtest alle deine Facettendaten auf einmal importieren. Wie geht so etwas? Wirf einen Blick auf <<daten/daten-importieren/elasticsync-best-practices/facetten#, dieses praktische Beispiel>>, welches dich Schritt für Schritt durch den Prozess führt.
====
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Eingabefeld: CSS-Klasse>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Eingabefeld: Position>>
//end::facetteposition[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Dropdown-Liste: Sortierung>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Feld: Typ>>
//end::facettetyp[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Eingabefeld: Minimale Trefferanzahl>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Eingabefeld: Maximal angezeigte Facettenwerte>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#40, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Einstellungen » Dropdown-Liste: Auswahlart>>
//end::auswahlart[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#50, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Name>>
//end::facettename[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#60, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Werte » Tab: Einstellungen » Eingabefeld: CSS-Klasse>>
//end::wertcssklasse[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#60, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Werte » Tab: Einstellungen » Eingabefeld: Position>>
//end::wertposition[]
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#60, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Werte » Tab: Name>>
//end::wertname[]
...
Werte von Auswahleigenschaften müssen derzeit <<artikel/frontend-artikelsuche-verwalten#60, manuell verknüpft>> werden.
====
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/frontend-artikelsuche-verwalten#60, Einrichtung » Mandant » Global » Dienste » Facettensuche » Tab: Werte » Tab: Verknüpfung>>
//end::linktyp[]
