...
:description: Facetten und Facettenwerten können in plentymarkets importiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Abgleich- und Zuordnungsfelder.
:author: team-item
...
====
Stell dir mal vor, du bist ganz neu bei plentymarkets und möchtest alle deine Facettendaten auf einmal importieren. Wie geht so etwas? Wirf einen Blick auf xref:daten:facetten.adoc#[dieses praktische Beispiel], welches dich Schritt für Schritt durch den Prozess führt.
====
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Eingabefeld: CSS-Klasse]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Eingabefeld: Position]
//end::facetteposition[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Dropdown-Liste: Sortierung]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Feld: Typ]
//end::facettetyp[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Eingabefeld: Minimale Trefferanzahl]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Eingabefeld: Maximal angezeigte Facettenwerte]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#40[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Einstellungen » Dropdown-Liste: Auswahlart]
//end::auswahlart[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#50[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Name]
//end::facettename[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#60[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Werte » Tab: Einstellungen » Eingabefeld: CSS-Klasse]
//end::wertcssklasse[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#60[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Werte » Tab: Einstellungen » Eingabefeld: Position]
//end::wertposition[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#60[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Werte » Tab: Name]
//end::wertname[]
...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:frontend-artikelsuche-verwalten.adoc#60[Einrichtung » Mandant » Global » Webshop » Facettensuche » Tab: Werte » Tab: Verknüpfung]
//end::linktyp[]
