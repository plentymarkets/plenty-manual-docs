...
:description: Wareneingänge können in plentysystems importiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Abgleich- und Zuordnungsfelder.
:author: team-stock
