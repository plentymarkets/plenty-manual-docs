...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:lager-einrichten.adoc#1500[Waren » Wareneingänge » [Suche ausführen\] » [Wareneingang wählen\] » Tab: Artikel].
...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:warenbestaende-verwalten.adoc#intable-ek[Waren » Wareneingänge » [Suche ausführen\] » [Wareneingang wählen\] » Tab: Artikel].
...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:mhd-charge-verwalten.adoc#100[Waren » Wareneingänge » [Suche ausführen\] » [Wareneingang wählen\] » Tab: Artikel].
