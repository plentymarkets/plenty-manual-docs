...
|id
|xref:artikel:artikel-verwalten.adoc#20[ID des Artikels]
...
|name
|xref:artikel:artikel-verwalten.adoc#50[Name 1 des Artikels]
|====
...
|isActive
|xref:artikel:artikel-verwalten.adoc#230[Variante ist aktiv] +
1 = Ja
