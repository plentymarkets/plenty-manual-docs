...
[TIP]
xref:daten:interne-IDs.adoc#20[Auf dieser Handbuchseite] findest du ein Liste mit den internen Länder-IDs und den ISO-Codes, die in plentymarkets verwendet werden können.
