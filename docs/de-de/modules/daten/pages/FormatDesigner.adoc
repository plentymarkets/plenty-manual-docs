...
:nav-alias: FormatDesigner nutzen

include::_textblocks/formatdesigner-export-einleitung.adoc[]

Diese Handbuchseite beschreibt den ersten Schritt. Hier lernst du, wie du das <<daten/daten-exportieren/FormatDesigner#50, FormatDesigner-Plugin einrichtest>>, wie du <<daten/daten-exportieren/FormatDesigner#100, Datenformate erstellst>> und <<daten/daten-exportieren/FormatDesigner/format-typen#, welche Daten>> du exportieren kannst.

Der zweite Schritt, d.h. der eigentliche Export, wird im Menü *Daten » Elastischer Export* vorgenommen. Weitere Informationen zum zweiten Schritt findest du auf der Handbuchseite zum <<daten/daten-exportieren/elastischer-export#, elastischen Export>>.
...
====
Beim FormatDesigner handelt es sich um ein Plugin. Um das FormatDesigner-Plugin nutzen zu können, lade es im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====
...
Grundlegende Informationen dazu, wie du dein plentymarkets System mit Plugins erweitern kannst, findest du im <<plugins#, Plugin-Kapitel>>.
...
Um dich mit der Anwendung des FormatDesigners vertraut zu machen, schaue dir das Praxisbeispiel <<daten/daten-exportieren/dropshipping-elasticexport-bp#, Dropshipping und ElasticExport>> an.
