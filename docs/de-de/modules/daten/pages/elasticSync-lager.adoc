...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#1500, Einrichtung » Waren » Lager » [Lager wählen] » Lagerorte>>.
...
|`box`
|box (für die <<app/funktionen/lagerverwaltung/rollende-kommissionierung#, Rollende Kommissionierung>>)
|====

Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-zweck, Einrichtung » Waren » Lager » [Lager wählen] » Lagerorte>>.
...
|lockedForStockTaking (für die Bestandsaufnahme gesperrt)
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-status, Einrichtung » Waren » Lager » [Lager wählen] » Lagerorte>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#100, Einrichtung » Waren » Lager » [Lager wählen] » Lagerorte>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/wareneingaenge-verwalten#intable-lagerorttyp, Artikel » Artikel bearbeiten » [Artikel öffnen] » Tab: ID einer Variante » Tab: Lager » Spalte: Lagerorttyp>>.
...
Das Ergebnis des Imports findest du im Backend im Menü <<warenwirtschaft/lager-einrichten#intable-notizen, Einrichtung » Waren » Lager » [Lager wählen] » Lagerorte » [Lagerort wählen]>>.
