...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:lager-einrichten.adoc#100[Einrichtung » Waren » Lager » [Lager wählen\] » Lagerorte].
...
Das Ergebnis des Imports findest du im Backend im Menü xref:warenwirtschaft:wareneingaenge-verwalten.adoc#intable-lagerorttyp[Artikel » Artikel bearbeiten » [Artikel öffnen\] » Tab: ID einer Variante » Tab: Lager » Spalte: Lagerorttyp].
