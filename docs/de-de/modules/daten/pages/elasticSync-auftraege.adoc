...
Eigene Eigenschaftstypen für Auftragspositionen können per link:https://developers.plentymarkets.com/api-doc/Order#element_113[Interface^]{nbsp}icon:external-link[] oder per link:https://developers.plentymarkets.com/rest-doc#/Order/post_rest_orders_properties_types[REST^]{nbsp}icon:external-link[] erstellt werden. Sie werden jedoch nicht in der UI angezeigt. +
...
Eigene Eigenschaftstypen für Aufträge können per link:https://developers.plentymarkets.com/api-doc/Order#element_113[Interface^]{nbsp}icon:external-link[] oder per link:https://developers.plentymarkets.com/rest-doc#/Order/post_rest_orders_properties_types[REST^]{nbsp}icon:external-link[] erstellt werden.
...
Die plentymarkets Bundesländer-IDs findest du in dieser link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/Allgemein/Bundeslaender-Bundesstaaten-Provinzen.pdf[PDF-Datei mit einer Liste der Bundesländer]{nbsp}icon:external-link[].
