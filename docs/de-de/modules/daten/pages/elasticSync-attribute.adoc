...
Der interne Name wird nur im plentymarkets Backend geführt und ist nicht im Webshop sichtbar.

*_Standardwert_*: Kein Standardwert

*_Zulässige Importwerte_*: Alphanumerisch

Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#100, Einrichtung » Artikel » Attribute » Tab: Grundeinstellungen » Eingabefeld: Name (intern)>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#100, Einrichtung » Artikel » Attribute » Tab: Grundeinstellungen » Eingabefeld: Position>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#100, Einrichtung » Artikel » Attribute » Tab: Grundeinstellungen » Checkbox: Bildverknüpfung möglich>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#100, Einrichtung » Artikel » Attribute » Tab: Grundeinstellungen » Dropdown-Liste: Attributauswahl im Webshop>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#100, Einrichtung » Artikel » Attribute » Tab: Grundeinstellungen » Checkbox: Gruppierbar in Artikellisten>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#200, Einrichtung » Artikel » Attribute » Tab: Werte » Eingabefeld: Name (intern)>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#200, Einrichtung » Artikel » Attribute » Tab: Werte » Eingabefeld: Position>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#200, Einrichtung » Artikel » Attribute » Tab: Werte » Eingabefeld: Bemerkung>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#200, Einrichtung » Artikel » Attribute » Tab: Werte » Eingabefeld: Prozentualer Anteil>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#1000, Einrichtung » Artikel » Attribute » Tab: Name>>
...
Das Ergebnis des Imports findest du im Backend im Menü: <<artikel/einstellungen/attribute#200, Einrichtung » Artikel » Attribute » Tab: Werte » Eingabefeld: Name>>
