...
:description: Attribute können in plentymarkets importiert werden. Diese Seite dient als Referenz und listet die dafür verfügbaren Abgleich- und Zuordnungsfelder.
:author: team-item
