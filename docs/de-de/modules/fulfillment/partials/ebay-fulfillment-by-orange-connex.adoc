...
* Prüfe die Auftragseinstellungen und passe abhängig von der Einstellung die xref:warenwirtschaft:grundeinstellungen.adoc#200[Hauptlager] an den Varianten an.
