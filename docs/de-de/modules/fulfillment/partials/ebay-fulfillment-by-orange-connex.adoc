...
In diesem Schritt kannst du wählen, welche Dokumente mit dem Outbound-Auftrag gesendet werden. Standardmäßig wird keines der folgenden Dokumente versendet. Aktiviere (icon:toggle_on[set=material, role=skyBlue]) die Schaltflächen für den Lieferschein, den Rücksendeschein oder das Retourenlabel, wenn diese Dokumente mit dem Outbound-Auftrag gesendet werden sollen.
