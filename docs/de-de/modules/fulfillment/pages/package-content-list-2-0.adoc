...
====
Paletten müssen nicht geschlossen sein, um sie im Versand-Center 2.0 anzumelden.
====
...
======
Möchtest du Artikel aus einem Paket wieder entfernen, setze neben den Artikeln im Bereich *Verpackte Artikel* ein Häkchen (icon:check_box[set=material, role=skyBlue]) und klicke auf *Artikel aus dem Paket entfernen* (icon:delete[set=material]). Klicke anschließend auf icon:delete[set=material] *Entfernen*, um die Artikel aus dem Paket zu entfernen.
======
...
====
Aufträge müssen nicht geschlossen sein, um sie im Versand-Center 2.0 anzumelden.
====
