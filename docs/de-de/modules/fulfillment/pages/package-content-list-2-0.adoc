...
======
Möchtest du Artikel aus einem Paket wieder entfernen, setze neben den Artikeln im Bereich *Verpackte Artikel* einen Haken und klicke auf *Artikel aus dem Paket entfernen* (icon:delete[set=material]). Klicke anschließend auf icon:delete[set=material] *Löschen*, um die Artikel aus dem Paket zu entfernen.
======
...
. Klicke anschließend oben auf die weiteren Optionen (icon:more_vert[set=material]).
. Wähle die Option *Paket auf Palette stellen* (icon:table-rows[set=material]). +
