...
In der Übersicht der Paketinhaltsliste 2.0 kannst du alle Aufträge in einer Liste öffnen oder du wählst Filter (material:tune[]), um die Suchergebnisse einzugrenzen.
...
======
Möchtest du Artikel aus einem Paket wieder entfernen, setze neben den Artikeln im Bereich *Verpackte Artikel* ein Häkchen (material:check_box[role=skyBlue]) und klicke auf *Artikel aus dem Paket entfernen* (material:delete[]). Klicke anschließend auf material:delete[] *Entfernen*, um die Artikel aus dem Paket zu entfernen.
======
...
====
Aufträge müssen _nicht_ geschlossen sein, um sie im xref:fulfillment:versand-center-2-0.adoc#[Versand-Center 2.0] anzumelden.
====
