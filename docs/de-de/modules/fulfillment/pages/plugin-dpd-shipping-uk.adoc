...
* xref:fulfillment:versand-vorbereiten.adoc#100[Lieferländer] aktivieren
* xref:fulfillment:versand-vorbereiten.adoc#400[Regionen] erstellen
* den xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister] *DPD Shipping UK* erstellen
* xref:fulfillment:versand-vorbereiten.adoc#1500[Portotabelle] für *DPD Shipping UK* erstellen
...
Sobald du das xref:plugins:hinzugefuegte-plugins-installieren.adoc#plugin-installieren[Plugin in einem Plugin-Set installiert] hast, ist das Plugin im Menü *Einrichtung » Aufträge » Versand* sichtbar.
