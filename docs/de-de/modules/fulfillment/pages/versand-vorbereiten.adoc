...
Auf dieser Handbuchseite ist beschrieben, wie du den Versand vorbereitest und xref:fulfillment:versand-vorbereiten.adoc#4700[Fulfillment-Dienstleister im Überblick].
...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als xref:webshop:ceres-einrichten.adoc#240[Standardlieferland] im Menü *Einrichtung » Mandant » [Mandant wählen] » Aufträge* nicht zur Verfügung.
...
Die Schnittstelle eines Versanddienstleisters richtest du nach dem folgenden Schema ein. Welche Daten du im Menü des Versanddienstleisters eingeben musst, erfährst du in den Unterkapiteln des Kapitels xref:fulfillment:versand-vorbereiten.adoc#2500[Versanddienstleister im Überblick].
...
. Gib die Daten ein.
. Beachte die Informationen zum Versanddienstleister in den Unterkapiteln des Kapitels xref:fulfillment:versand-vorbereiten.adoc#2500[Versanddienstleister im Überblick].
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Die aktuell gültigen, plentymarkets bekannten Tracking-URLs findest du im Kapitel des Versanddienstleisters. Über das Kapitel xref:fulfillment:versand-vorbereiten.adoc#2500[Versanddienstleister im Überblick] gelangst du auf die Kapitel der Versanddienstleister.
====
...
| *Versanddienstleister*
|Wähle den zuvor erstellten xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister] aus der Dropdown-Liste.
...
Weitere Informationen findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#1100[Tipps und Tricks: Portoaufschläge].
...
*_Wichtig:_* Voraussetzung ist, dass das Nachnahme-Plugin installiert ist. Das Plugin findest du im link:https://marketplace.plentymarkets.com/plugins/payment/cashondelivery_5255[plentyMarketplace^]{nbsp}icon:external-link[].
...
*_Wichtig:_* Voraussetzung ist, dass die Plugins link:https://marketplace.plentymarkets.com/plugins/templates/Ceres_4697[plentyShop LTS^]{nbsp}icon:external-link[] und link:https://marketplace.plentymarkets.com/plugins/templates/IO_4696[IO^]{nbsp}icon:external-link[] installiert sind.
...
| *Alternative E-Mail*
|Diese Einstellung ist nur sichtbar, wenn du in der Dropdown-Liste *E-Mail und Telefon übertragen* die Option *Alternative übertragen* gewählt hast. Gib eine alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, ein.

| *Alternative Telefonnr.*
|Diese Einstellung ist nur sichtbar, wenn du in der Dropdown-Liste *E-Mail und Telefon übertragen* die Option *Alternative übertragen* gewählt hast. Gib eine alternative Telefonnummer, die an den Dienstleister übertragen werden soll, ein.
...
| *Letzte Änderung*
|Hier wird das Datum der letzten Änderung des Versandprofils angezeigt.

2+|eBay

| *Konto*
|Wähle ein oder mehrere eBay-Konten oder die Option *ALLE* wählen. +
*_Wichtig:_* Mindestens 2 Konten müssen angelegt sein, andernfalls ist diese Option nicht sichtbar. Weitere Informationen findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#1200[Tipps und Tricks: Versandkosten von Bestellungen über eBay].
...
| *Treueprogramm*
|Wähle ein oder mehrere Treueprogramme. Die Treueprogramme kannst du mit xref:maerkte:amazon-einrichten.adoc#4200[Amazon] verwenden. +
...
| *Berechnungstyp*
|Wähle einen xref:fulfillment:versand-vorbereiten.adoc#1600[Berechnungstyp]. Der Berechnungstyp bildet die Grundlage für die Berechnung der Versandkosten.
...
| *Standardpaket*
|Wähle ein xref:fulfillment:versand-vorbereiten.adoc#1900[Versandpaket], das als Standardpaket für dieses Versandprofil verwendet werden soll. +
...
| *Alternative E-Mail*
|Diese Einstellung ist nur sichtbar, wenn du in der Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt hast. Gib eine alternative E-Mail-Adresse, die an den Dienstleister übertragen werden soll, ein.

| *Alternative Telefonnr.*
|Diese Einstellung ist nur sichtbar, wenn du in der Dropdown-Liste *E-Mail und Telefonnr. übertragen* die Option *Alternative übertragen* gewählt hast. Gib eine alternative Telefonnummer, die an den Dienstleister übertragen werden soll, ein.
...
2+| *_Hinweis:_* Für einige Versanddienstleister werden an dieser Stelle in deinem plentymarkets Backend spezifische Einstellungen sichtbar, nachdem du die Portotabelle gespeichert und neu geladen hast. +
Beispiel: *Amazon Versandeinstellungen*; hier kannst du einen Transportservice und einen Versandservice wählen.
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus deinem plentyShop für die Artikel verwendet. Das xref:webshop:ceres-einrichten.adoc#260[Standardversandprofil] wählst du im Menü *Einrichtung » Mandant » [Mandant wählen] » Aufträge*. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
Mit den xref:automatisierung:aktionen.adoc#430[Versand-Center] zur Verfügung.
...
|xref:fulfillment:versand-vorbereiten.adoc#2700[DHL Easylog]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#2800[DHL Freight]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3000[DHL plentymarkets Import]
|Pollingformat. Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3100[DHL Retoure Beilegeretiketten]
...
|Alte Integration xref:fulfillment:versand-vorbereiten.adoc#3200[DHL Retoure Online]
|Für Händler:innen innerhalb Deutschlands. Retoure: international.
...
|xref:fulfillment:versand-vorbereiten.adoc#3300[DHL Supply Chain]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3400[DHL UK]
...
|xref:fulfillment:versand-vorbereiten.adoc#3500[DPD Cloud Webservice (My DPDBusiness)]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3600[DPD Print]
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
|xref:fulfillment:versand-vorbereiten.adoc#3700[EasyPAK]
|Für Händler:innen innerhalb Österreichs. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3800[GLS Germany]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#3900[Hermes 2-Mann-Handling]
|Für Händler:innen innerhalb Deutschlands. Versand: Deutschland und Europa.

|xref:fulfillment:versand-vorbereiten.adoc#4000[Hermes ProfiPaketService]
|Für Händler:innen innerhalb Deutschlands. Versand: Deutschland und Europa.

|xref:fulfillment:versand-vorbereiten.adoc#4100[Iloxx]
|Für Händler:innen innerhalb Deutschlands. Versand: Deutschland und Europa.

|xref:fulfillment:versand-vorbereiten.adoc#4250[Parcelforce Worldwide]
|Für Händler:innen innerhalb des Vereinigten Königreichs. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#2600[PARCEL.ONE]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#4300[Swiss Post]
|Für Händler:innen innerhalb der Schweiz. Versand: Schweiz.

|xref:fulfillment:versand-vorbereiten.adoc#4230[UK Mail (via NetDespatch)]
|Für Händler:innen innerhalb des Vereinigten Königreichs. Versand: Vereinigtes Königreich.

|xref:fulfillment:versand-vorbereiten.adoc#4400[UPS]
|Für Händler:innen innerhalb Deutschlands. Versand: international.
|====
...
Wie du Versanddienstleister und Versandprofile einrichtest und welche Einstellungen du außerdem vornehmen musst und kannst, ist in den Kapiteln xref:fulfillment:versand-vorbereiten.adoc#2400[Log abrufen] beschrieben. Die dort beschriebenen Einstellungen bilden die Voraussetzung, um nun versanddienstleisterspezifische Einstellungen vorzunehmen. Nimm daher die Einstellungen in den genannten Kapiteln zuerst vor. Fahre anschließend mit diesem Kapitel fort.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.de/content/dam/dhlde/downloads/pdf/geschaeftskunden/dhl-easylog-versandsoftware-infoblatt-022016.pdf[DHL Easylog^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.com/de-de/home/unsere-unternehmensbereiche/fracht.html[DHL Freight^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » DHL Freight*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-interface-dhl-freight>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Niederlassung*
|Gib die dreistellige Abkürzung ein, wie von DHL erhalten.

| *Absenderdaten*
|Gib den Firmennamen ein.

| *Beschreibung der Güter*
|Gib die Beschreibung der Branche ein.

| *Versendernummer, SFTP-Benutzer, SFTP-Passwort*
|Gib die Daten ein, wie von DHL erhalten. +
...
| *SFTP-In/Out-Verzeichnis*
|Aktiviere die Option, um die SFTP-Verzeichnisstruktur von DHL Freight zu nutzen.
|====
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *DHL Freight* vor. Beachte dazu die Erläuterungen in <<#table-shipping-services-dhl-freight>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[table-shipping-services-dhl-freight]]
.Versandservices von DHL Freight in der Portotabelle einstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung

| *DHL Produkt*
|Wähle eines der folgenden Produkte aus der Dropdown-Liste: +
*Standard* +
...
| *DHL Frankatur*
|Wähle eine der folgenden Frankaturen aus der Dropdown-Liste: +
*Unfrei* +
...
Nimm zunächst die Einstellungen im link:https://www.dhl-geschaeftskundenportal.de/webcenter/portal/gkpExternal?_afrLoop=2465780077903302#!%40%40%3F_afrLoop%3D2465780077903302%26_adf.ctrl-state%3D11moofew5r_4[DHL Geschäftskundenportal^]{nbsp}icon:external-link[] vor.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.de/content/dam/images/pdf/GK/Services/dhl-retoure-mit-label-beigefuegt-infoblatt-de-092021.pdf[DHL Retoure Beilegeretiketten^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
+
--
Das Plugin *DHL Retoure Online* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlretoureonline_6714[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung. Installiere es in einem Plugin-Set. Der *DHL Retoure Online*-Assistent ist dann im Menü *Einrichtung » Assistenten » Plugins* im relevanten Plugin-Set sichtbar. Weitere Informationen findest du auf der Handbuchseite xref:fulfillment:plugin-dhl-retoure-online.adoc[DHL Retoure Online].
...
Wenn du noch kein Lager erstellt hast, erstelle zunächst ein Lager oder ein Vertriebs- und Reparaturlager im Menü *Einrichtung » Waren » Lager*. Wie du ein Lager erstellst, ist auf der Handbuchseite xref:warenwirtschaft:lager-einrichten.adoc#[Lager einrichten] beschrieben.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.de/de/geschaeftskunden/paket/leistungen-und-services/retoure.html[DHL Retoure Online^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Weitere Informationen findest du auf der Handbuchseite xref:fulfillment:plugin-dhl-shipping-versenden.adoc#[DHL Shipping (Versenden)]. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.com/de-de/home/unsere-unternehmensbereiche/lieferkette.html[DHL Supply Chain^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dhl.com/gb-en/home.html[DHL UK^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://esolutions.dpd.com/entwickler/dpd-cloud-webservice.aspx[DPD Cloud Webservice (My DPDBusiness)^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Beachte die Meldungen zu Sendungen, die du später über das xref:fulfillment:datenlog.adoc#[Daten-Log].
...
Bevor du die Schnittstelle zu DPD Print in plentymarkets einrichten, registriere dich bei link:https://www.dpd.com/portal_de[DPD^]{nbsp}icon:external-link[]. Mit dem Programm DPD Print erstellst du als DPD-Kund:in DPD-Paketscheine.

Wie du Versanddienstleister und Versandprofile einrichtest und welche Einstellungen du außerdem vornehmen musst und kannst, ist in den Kapiteln xref:fulfillment:versand-vorbereiten.adoc#2400[Log abrufen] beschrieben. Die dort beschriebenen Einstellungen bilden die Voraussetzung, um nun versanddienstleisterspezifische Einstellungen vorzunehmen. Nimm daher die Einstellungen in den genannten Kapiteln zuerst vor. Fahre anschließend mit diesem Kapitel fort.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.dpd.com/de/de/support/it-anbindung-und-dpd-schnittstellen/[DPD Print^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
| *Flex/Predict aktiv*
|Aktiviere die Option, um bei DPD den kostenpflichtigen Vorankündigungsservice link:https://www.dpd.com/de/de/empfangen[Predict^]{nbsp}icon:external-link[] (ehemals Flexzustellung) anzumelden. In der CSV-Datei wird dann der Zusatz *PRO* ausgegeben.
|====
...
Lade dir das link:https://marketplace.plentymarkets.com/plugins/integration/dpdshippinguk_5121[Plugin^]{nbsp}icon:external-link[] kostenlos auf dem plentyMarketplace herunter, um die Schnittstelle zu DPD Shipping UK nutzen zu können.
...
Lade dir das link:https://marketplace.plentymarkets.com/plugins/integration/dpdshippingservices_6320[Plugin^]{nbsp}icon:external-link[] kostenlos auf dem plentyMarketplace herunter, um die Schnittstelle zu DPD Versand-Services nutzen zu können. Zum einfachen Einrichten steht dir nach der erfolgreichen Installation des Plugins ein Assistent zur Verfügung.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.post.at/geschaeftlich.php[EasyPAK^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » EasyPAK*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-interface-easypak>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
|Gib die Daten ein, wie von EasyPAK erhalten.  +
Wenn die Versandart _Nachnahme_ genutzt wird, ist die Angabe der IBAN eine Pflichtangabe. +
*_Hinweis:_* Beachte, dass das Sonderzeichen `"` von der Schnittstelle nicht korrekt verarbeitet werden kann. Wenn `"` in deinen Zugangsdaten enthalten ist, ändere deine Referenznummern beim Versanddienstleister und hier in deinem plentymarkets System.
|====
...
. Wechsele in das Tab *Portotabelle*.
. Klappe die Region auf (icon:angle-down[]).
. Nimm die gewünschten Einstellungen im Bereich *PAT Easypak* vor. Beachte dazu die Erläuterungen in <<#table-shipping-services-easypak>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[[table-shipping-services-easypak]]
.Versandservices von EasyPak in der Portotabelle einstellen
[cols="1,3"]
|====
|Einstellung |Erläuterung

| *Vertragstyp*
|Wähle den Vertragstypen.

| *Produkte*
|Wähle das Produkt.

| *Zusatzleistungen*
|Wähle eine oder mehrere Zusatzleistungen.
|====
...
Damit deine Kund:innen im Bestellvorgang wählen können, ob sie den Montageservice von link:https://www.hermesworld.com/de/unsere-dienstleistungen/distribution/2-mann-handling/2-mann-handling/[Hermes (2-Mann-Handling)^]{nbsp}icon:external-link[] nutzen möchten, musst du diesen Service als Bestellmerkmal anlegen. Lege ein Bestellmerkmal mit den Optionen *Ja* und *Nein* an. Je nach Wahl der Option *Merkmaltyp* sind mehrere Möglichkeiten der Auswahl im Webshop einstellbar.

[TIP]
.Schnittstelle nur für Bestandskund:innen
====
Die Schnittstelle zu Hermes 2-Mann-Handling kann nur noch von Bestandskund:innen genutzt werden. Neukund:innen werden gebeten, sich an die link:https://www.hermesworld.com/de/unsere-dienstleistungen/distribution/2-mann-handling/2-mann-handling/[HERMES Einrichtungs Service GmbH &amp; Co.KG^]{nbsp}icon:external-link[] zu wenden.
====
...
[WARNING]
.Nutze jetzt das Hermes Shipping Interface-Plugin
====
Hermes schaltet die ProfiPaketService-Schnittstelle zum 21.02.2021 ab. Stelle daher jetzt auf *Hermes Shipping Interface* um. Lade dir das Plugin kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====

Wie du Versanddienstleister und Versandprofile einrichtest und welche Einstellungen du außerdem vornehmen musst und kannst, ist in den Kapiteln xref:fulfillment:versand-vorbereiten.adoc#2400[Log abrufen] beschrieben. Die dort beschriebenen Einstellungen bilden die Voraussetzung, um nun versanddienstleisterspezifische Einstellungen vorzunehmen. Nimm daher die Einstellungen in den genannten Kapiteln zuerst vor. Fahre anschließend mit diesem Kapitel fort.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://profipaketservice.hlg.de/wps/portal/PROPS_DEU/Home/Start/[Hermes ProfiPaketService^]{nbsp}icon:external-link[] in plentymarkets einzurichten.

[.instruction]
Schnittstelle einrichten:

. Öffne das Menü *Einrichtung » Aufträge » Versand » Dienstleister » Hermes ProfiPaketService*.
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#table-interface-hermes-profipaketservice>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
| *Zugangsdaten*
|Gib den internen Namen, den Login-Namen und das Passwort ein, wie von Hermes erhalten. +
*_Hinweis:_* Beachte, dass das Sonderzeichen `"` von der Schnittstelle nicht korrekt verarbeitet werden kann. Wenn `"` in deinen Zugangsdaten enthalten ist, ändere deinen Login-Namen bzw. Passwort beim Versanddienstleister und hier in deinem plentymarkets System.

| *Abrechnung zum Staffelpreis*
|Akzeptiere die AGB von Hermes sowie den Hinweis auf die Limitierung des Paketwerts, indem du die beiden Häkchen setzt. Andernfalls steht der Hermes-Dienst nicht zur Verfügung. Du kannst die AGB über den Link aufrufen.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.iloxx.de/home.aspx[Iloxx^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.parcelforce.com/[Parcelforce Worldwide^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://parcel.one/[PARCEL.ONE^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Bevor du die Schnittstelle zu link:https://www.post.ch/de[Swiss Post^]{nbsp}icon:external-link[] in plentymarkets einrichtest, registriere dich bei Swiss Post.
...
Gehe wie im Folgenden beschrieben vor, um link:https://www.ukmail.com/[UK Mail^]{nbsp}icon:external-link[] über die integrierte Schnittstelle zu link:http://www.netdespatch.com/[NetDespatch^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu link:https://www.ups.com/one-to-one/register?sysid=myups&loc=de_DE&WT.svl=Footer[UPS^]{nbsp}icon:external-link[] in plentymarkets einzurichten.
...
|xref:fulfillment:versand-vorbereiten.adoc#4800[DHL Fulfillment]
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
|xref:fulfillment:versand-vorbereiten.adoc#5400[IDS Logistik]
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|xref:fulfillment:versand-vorbereiten.adoc#5500[iLOPACK]
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
Richte link:https://www.dhl.de/de/geschaeftskunden/paket/leistungen-und-services/fulfillment.html[DHL Fulfillment^]{nbsp}icon:external-link[] in deinem plentymarkets System ein. Gehe dazu wie im Folgenden beschrieben vor.
...
Für eine korrekte Verarbeitung der Services ist es wichtig, dass du den Versanddienstleister *DHL Fulfillment* im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versanddienstleister* erstellst. Weitere Informationen findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister erstellen].

Anschließend erstellst du ein eigenes Versandprofil für DHL Fulfillment. Wie du dazu vorgehst, ist im Kapitel xref:fulfillment:versand-vorbereiten.adoc#1000[Versandprofil erstellen] beschrieben.
...
| *Schnittstelle aktiv*
|Setze ein Häkchen, um die Schnittstelle zu aktivieren. Aktivere die Schnittstelle erst, wenn du die xref:fulfillment:versand-vorbereiten.adoc#4900[Lager erstellt] hast.
...
|Merkmalverknüpfung zur Übermittlung der Artikeleigenschaft an DHL Fulfillment. Details dazu im Abschnitt xref:fulfillment:versand-vorbereiten.adoc#5300[Merkmale übermitteln].
...
Weitere Informationen zu Merkmalen findest auf der Handbuchseite xref:artikel:artikel-verwalten.adoc#80[Merkmale aktivieren].
====
...
Um den Briefversand mit DHL Fulfillment nutzen zu können und so z.B. Einschreiben sowohl national als auch international zu versenden, musst du den xref:fulfillment:versand-vorbereiten.adoc#400[Regionen] erstellt sein. +

Anschließend wählst du in der Portotabelle die Region *Deutschland*, das Versandprodukt für den nationalen oder internationalen Versand und aktivierst die Versandservices. Diese Services sind erst in der Portotabelle sichtbar, nachdem du die Einstellungen im Versandprofil gespeichert hast. Beachte auch, dass das Versandprofil am Artikel xref:fulfillment:versand-vorbereiten.adoc#1800[aktiviert] sein muss.

[#5320]
==== Für UK: National und international versenden

Damit du als Händler:in im Vereinigten Königreich über DHL Fulfillment deine Artikel sowohl national als auch international versenden kannst, musst du den xref:fulfillment:versand-vorbereiten.adoc#400[Regionen] erstellt sein.
...
Bevor du die Schnittstelle zu IDS Logistik einrichtest, registriere dich bei link:https://www.ids-logistik.de/de/[IDS Logistik^]{nbsp}icon:external-link[].

Erstelle dann im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versanddienstleister* den Fulfillment-Dienstleister. Wähle in der Spalte *Versanddienstleister* die Option *Sonstiges* aus der Dropdown-Liste. Weitere Informationen findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister erstellen].

Richte anschließend das Versandprofil im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versandprofile* ein. Wie du dazu vorgehst, ist im Kapitel xref:fulfillment:versand-vorbereiten.adoc#1000[Versandprofil erstellen] beschrieben.
...
Bevor du die Schnittstelle zu iLOPACK einrichtest, registriere dich bei link:http://www.ilopack.de/[iLOPACK^]{nbsp}icon:external-link[].

Erstelle dann im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versanddienstleister* den Fulfillment-Dienstleister. Wähle in der Spalte *Versanddienstleister* die Option *Sonstiges* aus der Dropdown-Liste. Weitere Informationen findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister erstellen].

Richte anschließend das Versandprofil im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versandprofile* ein. Wie du dazu vorgehst, ist im Kapitel xref:fulfillment:versand-vorbereiten.adoc#1000[Versandprofil erstellen] beschrieben.

Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu iLOPACK einzurichten. Unterhalb von <<#table-interface-ilopack>> wird beschrieben, wie du die xref:fulfillment:versand-vorbereiten.adoc#datenuebergabe-ilopack[Datenübergabe zu iLOPACK einrichtest].
