...
Beispiel: *Amazon Prime*. Hier kannst du einen Amazon Prime-Service wählen. Diese Services sind nur sichtbar, wenn du vorher das Versandprofil mit dem Versanddienstleister DHL oder DPD erstellt hast. Dies betrifft _nicht_ die Plugins DHL Shipping (Versenden) und DPD Versand-Services. +
