...
Auf dieser Handbuchseite ist beschrieben, wie du den Versand vorbereitest und xref:fulfillment:versand-vorbereiten.adoc#2500[versanddienstleisterspezifische Einstellungen] vornimmst. Einige Dienstleister bieten einen kompletten Service an, der die Lagerung der Artikel einschließt. Weitere Informationen dazu findest du im Kapitel xref:fulfillment:versand-vorbereiten.adoc#4700[Fulfillment-Dienstleister im Überblick].
...
| *Treueprogramm*
|Wähle ein oder mehrere Treueprogramme. Die Treueprogramme kannst du mit xref:maerkte:ebay-einrichten.adoc#6600[eBay Plus] oder xref:maerkte:amazon-einrichten.adoc#4200[Amazon] verwenden. +
...
Um den Briefversand mit DHL Fulfillment nutzen zu können und so z.B. Einschreiben sowohl national als auch international zu versenden, musst du den xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister] erstellen sowie xref:fulfillment:versand-vorbereiten.adoc#1000[Versandprofil] und xref:fulfillment:versand-vorbereiten.adoc#1500[Portotabelle] einrichten. Dafür müssen xref:fulfillment:versand-vorbereiten.adoc#100[Lieferländer] aktiviert und xref:fulfillment:versand-vorbereiten.adoc#400[Regionen] erstellt sein. +
...
Damit du als Händler:in im Vereinigten Königreich über DHL Fulfillment deine Artikel sowohl national als auch international versenden kannst, musst du den xref:fulfillment:versand-vorbereiten.adoc#800[Versanddienstleister] erstellen sowie xref:fulfillment:versand-vorbereiten.adoc#1000[Versandprofil] und xref:fulfillment:versand-vorbereiten.adoc#1500[Portotabelle] einrichten. Dafür müssen xref:fulfillment:versand-vorbereiten.adoc#100[Lieferländer] aktiviert und xref:fulfillment:versand-vorbereiten.adoc#400[Regionen] erstellt sein.
