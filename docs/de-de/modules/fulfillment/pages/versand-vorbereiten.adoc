...
Im folgenden Video-Tutorial lernst du wie du dein plentymarkets System für den Versand mit *DHL Shipping (Versenden)* vorbereitest. Anschließend musst du das *DHL Shipping (Versenden)*-Plugin im plentyMarketplace herunterladen und installieren. Dir stehen dann zum einfachen Einrichten zwei Assistenten zur Verfügung. Alle Informationen zum Einrichten des DHL Shipping (Versenden)-Plugins findest du auf dieser <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, Handbuchseite>>.
...
*Lieferant aktiv* = Lieferländer mit dieser Eigenschaft stehen für die Einstellung als <<webshop/ceres-einrichten#240, Standardlieferland>> im Menü *Einrichtung » Mandant » [Mandant wählen] » Aufträge* nicht zur Verfügung.

| *Lager*
|Wähle das Lager, das dem Lieferland als Hauptlager zugeordnet werden soll und z.B. in Aufträgen automatisch eingestellt sein soll. Wähle *ALLE*, wenn alle Lager dem Lieferland zugeordnet werden sollen. In diesem Fall wird für Aufträge automatisch das Lager mit der kleinsten ID gewählt. Beachte dazu auch die <<auftraege/auftraege-verwalten#, Lagereinstellungen>> im Menü *Einrichtung » Aufträge » Einstellungen*.
...
| *Versanddienstleister*
|Wähle den zuvor erstellten <<fulfillment/versand-vorbereiten#800, Versanddienstleister>> aus der Dropdown-Liste.
...
| *Treueprogramm*
|Wähle ein oder mehrere Treueprogramme. Die Treueprogramme kannst du mit <<maerkte/ebay/ebay-einrichten#6600, eBay Plus>> oder <<maerkte/amazon/amazon-einrichten#4200, Amazon>> verwenden. +
...
| *Berechnungstyp*
|Wähle einen <<fulfillment/versand-vorbereiten#1600, Berechnungstyp>>. Der Berechnungstyp bildet die Grundlage für die Berechnung der Versandkosten.
...
| *Standardpaket*
|Wähle ein <<fulfillment/versand-vorbereiten#1900, Versandpaket>>, das als Standardpaket für dieses Versandprofil verwendet werden soll. +
...
====
Volumen werden nur korrekt berechnet, wenn du im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen]* im Tab *Einstellungen* der Hauptvariante und dort im Bereich <<artikel/artikel-verwalten#270, Maße>> die Länge, Breite und Höhe des Artikels eingegeben hast. Fehlen diese Angaben, wird kein Volumen berechnet und die Berechnung der Versandkosten kann ebenfalls nicht erfolgen.
====
...
Weitere Informationen findest du auf der Handbuchseite <<daten/daten-exportieren/FormatDesigner/format-typen/auftraege#, FormatDesigner>>.
...
====
Wenn ein Auftrag Artikel enthält, bei denen kein Versandprofil aktiviert wurde, wird das Standardversandprofil aus deinem plentyShop für die Artikel verwendet. Das <<webshop/ceres-einrichten#260, Standardversandprofil>> wählst du im Menü *Einrichtung » Mandant » [Mandant wählen] » Aufträge*. Wenn kein Standardversandprofil eingerichtet ist, wird das Versandprofil mit der höchsten Priorität verwendet.
====
...
Wie du Versandpakete bearbeitest, hinzufügst oder löschst, ist auf der Handbuchseite <<fulfillment/versand-center#, Versand-Center nutzen>> beschrieben.
...
Weitere Informationen zu den Log-Einträgen findest du auf der Handbuchseite <<daten/datenlog#, Daten-Log>>.
...
|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dhl-retoure-online#, DHL Retoure Online>>
|Für Händler:innen innerhalb Deutschlands. Retoure: international.

|Alte Integration <<fulfillment/versand-vorbereiten#3200, DHL Retoure Online>>
|Für Händler:innen innerhalb Deutschlands. Retoure: international.

|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>>
...
|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dhl-wunschzustellung#, DHL Wunschzustellung>>
|Für Händler:innen innerhalb Deutschlands. Versand: Deutschland.

|<<fulfillment/versand-vorbereiten#3500, DPD Cloud Webservice (My DPDBusiness)>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|<<fulfillment/versand-vorbereiten#3600, DPD Print>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dpd-shipping-uk#, DPD Shipping UK>>
|Für Händler:innen innerhalb des Vereinigten Königreichs. Versand: international.

|Plugin <<fulfillment/versanddienstleister-plugins/plugin-dpd-versand-services#, DPD Versand Services>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
|<<fulfillment/versand-vorbereiten#4100, Iloxx>>
|Für Händler:innen innerhalb Deutschlands. Versand: Deutschland und Europa.
...
Weitere Informationen findest du auf der Handbuchseite <<artikel/einstellungen/eigenschaften#100, Merkmale und Eigenschaften>>.
...
Wenn du noch kein Lager erstellt hast, erstelle zunächst ein Lager oder ein Vertriebs- und Reparaturlager im Menü *Einrichtung » Waren » Lager*. Wie du ein Lager erstellst, ist auf der Handbuchseite <<warenwirtschaft/lager-einrichten#, Lager einrichten>> beschrieben.
...
Wenn du erlaubst, dass Kunden Retouren selbst anlegen können, stehen die <<auftraege/auftraege-verwalten#410, Retourengründe>>, die du eingegeben hast, auch im *Mein Konto*-Bereich zur Auswahl. +
...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-shipping-versenden#, DHL Shipping (Versenden)>>. Das Plugin *DHL Shipping (Versenden)* steht dir kostenlos im link:https://marketplace.plentymarkets.com/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] zur Verfügung.
...
Weitere Informationen sowie Voraussetzungen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dhl-wunschzustellung#, DHL Wunschzustellung>>.
...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dpd-shipping-uk#, DPD Shipping UK>>.
...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versanddienstleister-plugins/plugin-dpd-versand-services#, DPD Versand-Services>>.
...
|<<fulfillment/ebay-fulfillment-by-orange-connex#, eBay Fulfillment by Orange Connex>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.

|<<maerkte/amazon/amazon-fba-nutzen#, Fulfillment by Amazon>>
|Für Händler:innen innerhalb Deutschlands. Versand: international.
...
====
Die Auftragsübergabe von mit <<payment/zahlungsanbieter/klarna#, Klarna>> bezahlten Aufträgen an DHL Fulfillment ist noch nicht möglich. Nur Aufträge mit einem vorhandenen Rechnungsdokument können an DHL Fulfillment übertragen werden. Klarna übermittelt die Rechnung jedoch erst nach Warenausgang an plentymarkets.
====

Die Sendungsanmeldung an DHL Fulfillment erfolgt automatisch über die Schnittstelle. Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, findest du im Menü *Daten » Log*. Weitere Informationen zu den Log-Einträgen findest du auf der Handbuchseite <<daten/datenlog#, Daten-Log>>.
...
Anschließend erstellst du ein eigenes Versandprofil für DHL Fulfillment. Wie du dazu vorgehst, ist im Kapitel <<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>> beschrieben.
...
Zur Zuordnung legst du im Menü *Einrichtung » Aufträge » Auftragsstatus* 2 <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> für die an DHL Fulfillment übermittelten Aufträge an. Im Folgenden findest du 2 Beispiele:
...
Meldungen zu Sendungen, die bei DHL Fulfillment angemeldet wurden, findest du im Menü *Daten » Log*. Weitere Informationen zu den Log-Einträgen findest du auf der Handbuchseite <<daten/datenlog#, Daten-Log>>.
====
...
| *Schnittstelle aktiv*
|Setze ein Häkchen, um die Schnittstelle zu aktivieren. Aktivere die Schnittstelle erst, wenn du die <<fulfillment/versand-vorbereiten#4900, Lager erstellt>> hast.
...
| *Retourengründe*
|Verknüpfe die Retourengründe von DHL Fulfillment mit den <<auftraege/auftraege-verwalten#410, Retourengründen>>, die du im Menü *Einrichtung » Aufträge » Auftragstypen » Retoure* angelegt hast.
|====

[#5300]
==== Merkmale übermitteln

Erstelle im Menü *Einrichtung » Artikel » Merkmale* Eigenschaften vom Typ *Auswahl* wie beispielsweise _Zerbrechlich_ oder _Originalkarton_, die du anschließend an DHL Fulfillment übermittelst, damit die Artikel logistisch vorbereitet werden können. Wie du ein Merkmal erstellst, ist auf der Handbuchseite <<artikel/einstellungen/eigenschaften#300, Merkmale und Eigenschaften>> beschrieben. Die folgenden Merkmale können an DHL Fulfillment übermittelt werden:
...
Weitere Informationen zu Merkmalen findest auf der Handbuchseite <<artikel/artikel-verwalten#, Artikel manuell anlegen>> im Kapitel <<artikel/artikel-verwalten#80, Merkmale aktivieren>>.
====

Nachdem du die Merkmale erstellt hast, <<artikel/artikel-verwalten#80, aktivierst>> du die Merkmale am Artikel im Tab *Merkmale*. Abschließend ordnest du die Merkmale in der Schnittstellenkonfiguration im Menü *Einrichtung » Aufträge » Versand » Fulfillment » DHL Fulfillment* zu.
...
Weitere Informationen findest du auf der Handbuchseite <<fulfillment/ebay-fulfillment-by-orange-connex#, eBay Fulfillment by Orange Connex>>.

[#5600]
=== Fulfillment by Amazon

FBA ist das Kürzel für Fulfillment by Amazon, einem Service von Amazon, bei dem Amazon die Lagerhaltung sowie die gesamte Logistik übernimmt. Welche Einstellungen du vornehmen musst, um diesen Service zu nutzen, liest du auf der Handbuchseite <<maerkte/amazon/amazon-fba-nutzen#, FBA-Service von Amazon nutzen>>.
...
Richte anschließend das Versandprofil im Menü *Einrichtung » Aufträge » Versand » Optionen* im Tab *Versandprofile* ein. Wie du dazu vorgehst, ist im Kapitel <<fulfillment/versand-vorbereiten#1000, Versandprofil erstellen>> beschrieben.
...
Gehe wie im Folgenden beschrieben vor, um die Schnittstelle zu iLOPACK einzurichten. Unterhalb von <<#table-interface-ilopack>> wird beschrieben, wie du die <<fulfillment/versand-vorbereiten#datenuebergabe-ilopack, Datenübergabe zu iLOPACK einrichtest>>.
