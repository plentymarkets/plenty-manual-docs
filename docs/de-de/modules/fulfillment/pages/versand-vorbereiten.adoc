= Versand vorbereiten
:keywords: Versanddienstleister, Fulfillment-Dienstleister, Fulfillment, Lieferländer, Regionen, Region, Versandprofil, Versandprofile, Portotabelle, Versandpaket, Versandkosten, Tracking-URL, Tracking URL, cbc logistics, PARCEL.ONE, DHL Versenden, DHL plentymarkets Import, DHL Retoure Beilegeretiketten, DHL Retoure Online, DHL Supply Chain, DHL UK, DPD Cloud Webservice, My DPD Business, DPD Print, GLS Germany, Hermes 2-Mann-Handling, Iloxx, UK Mail, NetDespatch, Swiss Post, UPS, DHL Fulfillment, IDS Logistik, iLOPACK, Länderauswahl
...
Zur Zuordnung legst du im Menü *Einrichtung » Aufträge » Auftragsstatus* 2 xref:auftraege:order-statuses.adoc#[Auftragsstatus] für die an DHL Fulfillment übermittelten Aufträge an. Im Folgenden findest du 2 Beispiele:
...
| *Retourengründe*
|Verknüpfe die Retourengründe von DHL Fulfillment mit den xref:auftraege:order-type-return.adoc#enter-return-reasons[Retourengründen], die du im Menü *Einrichtung » Aufträge » Auftragstypen » Retoure* angelegt hast.
|====
