...
Wie du Versandpakete bearbeitest, hinzufügst oder löschst, ist auf der Handbuchseite xref:fulfillment:versand-center-2-0.adoc#[Versand-Center nutzen] beschrieben.
