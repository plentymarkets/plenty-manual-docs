...
:rights-purpose: mit dem DPD Versand-Services-Plugin arbeiten können
:right-one: pass:quotes[*Einrichtung > Aufträge > Versand > Dienstleister > DPD Versand-Services Shipping > Betrachten*]
