...
Alternativ kannst du das Plugin im link:https://marketplace.plentymarkets.com/plugins/integration/dpdshippingservices_6320[plentyMarketplace^]{nbsp}icon:external-link[] herunterladen und installieren.
====
...
+
--
Suche den Auftrag im Menü *Aufträge » Versand-Center 2.0* und klicke auf *Retoure anmelden* (icon:order_return[set=plenty]). Wähle dann den Retourendienstleister *DPDShippingServices* aus der Dropdown-Liste und klicke auf *Retoure anmelden*.

Weitere Informationen findest du auf der Handbuchseite <<fulfillment/versand-center-2-0#retoure-anmelden, Versand-Center 2.0>>.
--
