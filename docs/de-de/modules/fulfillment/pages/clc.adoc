...
Um die Schnittstelle für CLC in deinem plentymarkets System einzurichten, musst du bei link:https://www.tietjegroup.com/kontakt/[CLC^] registriert sein. Schreibe einfach eine E-Mail an link:kontakt@clc.tietjegroup.com[kontakt@clc.tietjegroup.com].
