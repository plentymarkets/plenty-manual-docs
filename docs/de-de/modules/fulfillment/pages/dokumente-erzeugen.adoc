...
Neben der Möglichkeit, größere Mengen an Paketnummern komfortabel über das xref:fulfillment:dokumente-erzeugen.adoc#paketnummern-barcodescanner[Barcodescanners] erledigen.
