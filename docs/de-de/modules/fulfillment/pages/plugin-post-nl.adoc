...
. Suche die Aufträge anhand der Filtereinstellungen wie auf der Handbuchseite xref:fulfillment:versand-center-2-0.adoc#auftrag-suchen[Versand-Center 2.0 (Testphase)] beschrieben. +
...
Weitere Informationen zum Anmelden von Aufträgen findest du auf der Handbuchseite xref:fulfillment:versand-center-2-0.adoc#[Versand-Center 2.0 (Testphase)].
