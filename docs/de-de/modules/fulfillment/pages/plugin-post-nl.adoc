...
. Suche die Aufträge anhand der Filtereinstellungen wie auf der Handbuchseite xref:fulfillment:versand-center2-0.adoc#auftrag-suchen[Versand-Center 2.0 (Testphase)] beschrieben. +
