...
====
Die Schnittstelle zu PostNL wird über ein Plugin integriert. Um das PostNL-Plugin nutzen zu können, lade das Plugin im link:https://marketplace.plentymarkets.com/postNL_7014[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
====
...
* xref:fulfillment:versand-vorbereiten.adoc#1500[Portotabellen] für *PostNL* erstellen +
 ...
 ** Das PostNL-Plugin muss im link:https://marketplace.plentymarkets.com/postNL_7014[plentyMarketplace^]{nbsp}icon:external-link[] heruntergeladen worden sein, damit es dir hier angezeigt wird.
