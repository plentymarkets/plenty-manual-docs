...
[TIP]
.Auftragsnotiz nach Anmeldung einer Retoure
====
...
Wenn du Versandpakete aus dem Versand-Center heraus bearbeitest, öffnet sich in einem neuen Tab die xref:auftraege:paketinhaltsliste.adoc#[Paketinhaltsliste].
