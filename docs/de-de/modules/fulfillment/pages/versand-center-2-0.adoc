...
[#pakete-widget]
== Versandpakete über das Pakete-Widget bearbeiten

In der UI eines Auftrags steht dir das Pakete-Widget zur Verfügung. Du kannst seine Position über myView bestimmen.

[[image-pakete-widget]]
.Pakete-Widget
image::fulfillment:pakete-widget.jpeg[width=640, height=360]

Das Widget bietet dir die Funktionalitäten für Versandpakete aus dem Versand-Center: Mit einem Klick öffnet sich ein Overlay, in dem die Paketdaten angepasst werden können. 

[[table-edit-shipping-package-in-widget]]
.Versandpaket über das Pakete-Widget bearbeiten
[cols="1,3"]
|====
|Einstellung |Erläuterung
