...
======
Als Alternative zur Auftragszusammenfassung eines Tages im Menü *Aufträge » Versand-Center 2.0* kannst du einen xref:daten:auftraege.adoc#1100[Aufträge].
======
...
Weitere Informationen findest du im Bereich <<#auftraege, Aufträge>> im Kapitel xref:auftraege:auftraege-verwalten.adoc#300[Auftragstyp Lieferauftrag nutzen].
