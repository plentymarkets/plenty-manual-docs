...
Mit einem Klick auf *Paket löschen* (material:delete[]) am Ende der Zeile des Pakets kannst du einzelne Pakete löschen. Ein Fenster mit einer Sicherheitsabfrage öffnet sich. Du musst diese Aktion bestätigen.
