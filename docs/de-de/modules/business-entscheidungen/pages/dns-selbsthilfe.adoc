...
image::business-entscheidungen/systemadministration/assets/DNS-Einstellungen.png[width=640, height=360, alt=DNS-Einstellungen]
...
+
image::business-entscheidungen/systemadministration/assets/dnsselbsthilfe_pic004.png[width=640, height=360, alt=A-Record ermitteln]
...
+
image::business-entscheidungen/systemadministration/assets/dnsselbsthilfe_pic005.png[width=640, height=360, alt=CNAME-Record ermitteln]
...
image::business-entscheidungen/systemadministration/assets/DNS-Einstellungen.png[width=640, height=360, alt=Beispiel DNS-Einstellungen]
