...
image::business-entscheidungen:cname-entry-de.png[width=640, height=360, alt=DNS-Einstellungen]
...
+
image::business-entscheidungen:cname-entry-de.png[width=640, height=360]
