...
:position: 1100
:url: business-entscheidungen/plenty-bi/kennzahlen/umsatz
:id: 3EDOK8V
...
Du entscheidest im Bereich <<business-entscheidungen/plenty-bi/kennzahlen/umsatz#100, Berechnung>>, ob mit Brutto-Preisen oder Netto-Preisen multipliziert wird.
So kannst du entweder den Brutto-Umsatz oder den Netto-Umsatz anzeigen lassen.
Wähle zusätzlich eine <<business-entscheidungen/plenty-bi/kennzahlen/umsatz#200, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/plenty-bi/kennzahlen/umsatz#300, Filter>> um zu konkretisieren, nach welchen Kriterien der Umsatz berechnet werden soll.
