...
|order status
|Status des Auftrags im Dezimalformat. Je nach den im System eingerichteten Status werden Zahlen mit bis zu 4 Nachkommastellen ausgegeben. Die IDs der Standardstatus finden Sie auf der Handbuchseite <<daten/interne-IDs#120, Interne IDs in plentymarkets>>.
...
Weitere mögliche Werte für Auftragsherkünfte finden Sie auf der Handbuchseite <<daten/interne-IDs#90, Interne IDs in plentymarkets>>.
