...
////
TODO: Screenshot für Kennzahlen-Menü erstellen (https://wiki.plentymarkets.com/display/DOKU/Screenshots). Wie werden Spalten konfiguriert, wie funktioniert die Suche. Optionen innerhalb bereits erstellter Kennzahlen (z.B. Verwendung einsehen)
////
