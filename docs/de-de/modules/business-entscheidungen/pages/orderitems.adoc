...
:description: Mit dem Datenformat-Creator orderItems kannst du Rohdaten zu Auftragspositionen exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
