...
:description: Mit dem Datenformat-Creator orderStatuses kannst du Rohdaten zu Auftragsstatus exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
