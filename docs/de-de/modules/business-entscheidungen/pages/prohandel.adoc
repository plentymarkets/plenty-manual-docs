...
//Die eigene Artikel-Nummer wird gespeichert unter: xref:artikel:verzeichnis.adoc#50[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Texte » Eingabefeld: Name 1]
...
//ToDo - sobald die neue Artikel-UI standard ist, dann diesen Satz einblenden und dafür den alten Satz löschen
//Die Lieferanten-Artikelnummer wird gespeichert unter: xref:artikel:artikel-verwalten.adoc#170[Artikel » Artikel-UI » [Variante öffnen\] » Element: Einstellungen » Eingabefeld: Externe ID]
...
//ToDo - sobald die neue Artikel-UI standard ist, dann diesen Satz einblenden und dafür den alten Satz löschen
//In plentymarkets findest du den Hersteller eines Artikels im Menü *Artikel » Artikel-UI » [Artikel öffnen] » Element: Einstellungen » Dropdown-Liste: Hersteller*.
...
//ToDo - sobald die neue Artikel-UI standard ist, dann diesen Satz einblenden und dafür den alten Satz löschen
//In plentymarkets findest du die Tags eines Artikels im Menü *Artikel » Artikel-UI » [Variante öffnen] » Element: Tags*.
