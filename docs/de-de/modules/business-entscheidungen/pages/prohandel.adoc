...
* <<willkommen/allgemeine-funktionen/tags#, Tags>>
...
*_Voraussetzung_*:
Hast du bereits die nötigen <<willkommen/allgemeine-funktionen/tags#, Tags in plentymarkets angelegt>>?
...
| *Artikelimport*
|Täglich
|Der Import basiert auf den zuvor gewählten <<business-entscheidungen/prohandel#70, Importeinstellungen>>.
