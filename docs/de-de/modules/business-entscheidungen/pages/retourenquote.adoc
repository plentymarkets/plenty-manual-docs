...
plentymarkets berechnet die Retourenquote, indem die Anzahl der Retouren durch die Anzahl der Aufträge geteilt wird, die *_nicht_* vom Typ Gutschrift oder Retoure sind: +
