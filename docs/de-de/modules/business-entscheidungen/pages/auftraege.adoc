...
:position: 200
:url: business-entscheidungen/plenty-bi/kennzahlen/auftraege
:id: D2IR751
...
:kennzahl: Die Kennzahl Aufträge
:das-bedeutet: So erkennst du auf einen Blick, wie viele Aufträge aufgeschlüsselt nach Auftragsherkunft generiert werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Die Kennzahl Aufträge
:das-bedeutet: So erkennst du auf einen Blick, wie viele Aufträge aufgeschlüsselt nach Lager generiert werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Die Kennzahl Aufträge
:das-bedeutet: So erkennst du auf einen Blick, wie viele Aufträge aufgeschlüsselt nach Mandant generiert werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
