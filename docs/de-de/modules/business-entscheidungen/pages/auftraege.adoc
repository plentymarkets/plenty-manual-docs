...
:description: Erfahre, welche Berechnungen, Dimensionen und Filter dir für die Kennzahl Aufträge zur Verfügung stehen. Diese Seite dient lediglich als Referenz und setzt voraus, dass du bereits Grundkenntnisse über das plentyBI-Tool hast.

:kennzahl: Aufträge

include::partial$kennzahlen-einleitung.adoc[]

plentymarkets berechnet die Anzahl der Aufträge, indem die Aufträge zusammengerechnet werden: +
...
====
Die Kennzahl *Aufträge* ist eine so genannte Standard-Kennzahl. Das bedeutet, dass sie in deinem plentymarkets System bereits mit einigen Voreinstellungen eingerichtet ist.  Du musst also nicht zwingend eine zusätzliche Kennzahl erstellen. Öffne das Menü *Einrichtung » plentyBI » Kennzahlen* und klicke auf die Kennzahl *Aufträge*, die von `plentymarkets` erstellt wurde. Passe bei Bedarf die voreingestellten Optionen an und ergänze die gewünschten <<#200, Filter>>.
====
...
:kennzahl: Die Kennzahl Aufträge
:das-bedeutet: So erkennst du auf einen Blick, wie viele Aufträge aufgeschlüsselt nach den Plugins, über die sie in dein plentymarkets System gelangen, generiert werden. Differenziert wird zusätzlich nach dem Erstellungsdatum der Aufträge.
