= Aufträge
:keywords: Aufträge, Auftragsanzahl, Menge Aufträge, Auftragsmenge, Business Intelligence, Statistik, Statistiken, Kennzahl, Kennzahlen, Dashboard, Rohdaten, Report, Reports, KPI, KPIs, Key Performance Indicator
:id: D2IR751
