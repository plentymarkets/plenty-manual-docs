...
Weitere mögliche Werte sind in unserer link:https://developers.plentymarkets.com/rest-doc/order_order_item_order_item_property/details[Entwicklerdokumentation^]{nbsp}icon:external-link[] zu finden.
