...
:description: Mit dem Datenformat-Creator orderItemProperties kannst du Rohdaten zu Eigenschaften von Auftragspositionen exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
