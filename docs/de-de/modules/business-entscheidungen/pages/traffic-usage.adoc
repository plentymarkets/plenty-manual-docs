...
====
Die Kennzahl *Traffic-Verbrauch* ist eine so genannte Standard-Kennzahl. Das bedeutet, dass sie in deinem plentysystems System bereits mit einigen Voreinstellungen eingerichtet ist. Du musst also nicht zwingend eine zusätzliche Kennzahl erstellen. Öffne das Menü *Einrichtung » plentyBI » Kennzahlen* und klicke auf die Kennzahl *Traffic-Verbrauch*, die von `plentymarkets` erstellt wurde. Passe bei Bedarf die voreingestellten Optionen an und ergänze die gewünschten <<#300, Filter>>.
====
