...
Da diese Kennzahl jedoch dein Verbrauch der Änderungshistorie ermittelt, wirst du nur Daten sehen, wenn du die xref:daten:aenderungshistorie.adoc#1100[Änderungshistorie für dein System aktiviert] hast.
