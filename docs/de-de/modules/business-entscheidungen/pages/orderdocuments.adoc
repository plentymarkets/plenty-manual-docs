...
:description: Mit dem Datenformat-Creator orderDocuments kannst du Rohdaten zu Auftragsdokumenten exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
