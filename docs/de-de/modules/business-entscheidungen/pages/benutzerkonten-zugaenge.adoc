...
. Aktiviere *Bearbeiten* oder *Erstellen* bei den Sichtbarkeiten, bei der die Rolle als Eigner verfügbar sein soll.
. *Speichere* (icon:save[]) die Einstellungen.
