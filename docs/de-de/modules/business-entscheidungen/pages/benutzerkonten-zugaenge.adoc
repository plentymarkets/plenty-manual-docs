...
Im Menü *Einrichtung » Kontoverwaltung » Rollen* kannst du neue Rollen erstellen oder existierende Rollen angepassen. Beim Erstellen oder Bearbeiten einer Rolle kannst du im Menüpunkt *Zugriffsrechte* die Auftragsherkünfte freigeben, die für die Benutzer:innen sichtbar sein sollen. +
