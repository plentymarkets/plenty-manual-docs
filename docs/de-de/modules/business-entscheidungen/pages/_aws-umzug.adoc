...
Wie man eine neue Domain bestellt, die durch plentymarkets verwaltet werden soll kann man dem Handbuch entnehmen: Siehe die Handbuchseite xref:business-entscheidungen:domains.adoc#[Domains].
...
Wie eine externe Domain zu Deinem System hinzugefügt werden kann findest Du in unserem Handbuch. Siehe die Handbuchseite xref:business-entscheidungen:domains.adoc#[Domains].
