...
:kennzahl: Der durchschnittliche Bestellwert
:das-bedeutet: So erkennst du auf einen Blick, welcher durschnittliche Bestellwert aufgeschlüsselt nach den Plugins, über die sie in dein plentymarkets System gelangen, generiert wird. Differenziert wird zusätzlich nach dem Erstellungsdatum der Aufträge.
