...
|*Warenbestand*
|Erstelle im Menü *Daten » Elastischer Export* ein Exportformat für deinen xref:daten:warenbestand.adoc[Warenbestand]. Wir empfehlen mindestens die Auswahl folgender Exportfelder: +
- Item.id = Artikel-ID +
...
|*Warenbewegungen*
|Erstelle im Menü *Daten » Elastischer Export* ein Exportformat für deine xref:daten:warenbewegungen.adoc[Warenbewegungen]. Wir empfehlen mindestens die Auswahl folgender Exportfelder: +
