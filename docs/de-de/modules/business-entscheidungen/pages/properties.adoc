...
|VARCHAR
|property cast
|Eigenschaftstyp, wie in der <<artikel/einstellungen/eigenschaften#600, Eigenschaftskonfiguration>> angegeben, z.B. longText, selection, shortText, usw.

|prop_type
|VARCHAR
|property type
|Bereich in dem die Eigenschaft genutzt wird, wie in der <<artikel/einstellungen/eigenschaften#600, Eigenschaftskonfiguration>> angegeben, z.B. item, contact, usw.
