...
:description: Mit dem Datenformat-Creator orderItemAmounts kannst du Rohdaten zu Beträgen von Auftragspositionen exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
