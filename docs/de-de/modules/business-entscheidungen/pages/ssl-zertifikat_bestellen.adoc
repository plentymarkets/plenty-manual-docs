...
Wenn diese Parent-Domain nicht auf plentymarkets zeigen soll, sondern z.B. auf Shopware, versehe die Parent-Domain mit einem externen A-Record, indem du eine <<business-entscheidungen/systemadministration/domains#210a, Systemverknüpfung erstellst>>.
...
. *_OV und EV Zertifikate_*: Nachdem du die Bestellung im Assistenten aufgegeben hast, musst du noch einen <<business-entscheidungen/systemadministration/ssl-zertifikat_bestellen#1260, Validierungsprozess abschließen>>.

image::business-entscheidungen/systemadministration/assets/ssl-assistent.png[]
...
image::business-entscheidungen/systemadministration/assets/assistent-zusammenfassung.png[]
...
. <<business-entscheidungen/systemadministration/ssl-zertifikat_bestellen#1200, Bestelle das Zertifikat bei Bedarf neu>>.
...
Eine externe Domain kannst du beim externen Hoster belassen und <<business-entscheidungen/systemadministration/domains#160, die DNS-Einstellungen bei diesem externen Hoster speichern>>.
...
image::business-entscheidungen/systemadministration/assets/assistent-abgeschlossen.png[]
