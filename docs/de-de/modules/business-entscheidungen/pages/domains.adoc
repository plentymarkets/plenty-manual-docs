...
. Wähle den gewünschten Domain-Typ aus. Je nachdem, welchen Domain-Typ du wählst, ändern sich die nachfolgenden Schritte und Einstellungen des Assistenten. Klappe die Info-Box unten auf (material:keyboard_arrow_down[]), wenn du zusätzliche Informationen zu einer der Optionen benötigst.
