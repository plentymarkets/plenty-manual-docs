...
|Wert der Eigenschaftsverknüpfung. Wenn die Eigenschaft beispielsweise mit einer Variante verknüpft ist, wird der <<artikel/artikel-verwalten#4800, Wert innerhalb des Artikeldatensatzes>> angegeben.
