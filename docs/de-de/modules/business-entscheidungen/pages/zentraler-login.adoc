...
====
Meldest du dich mit plenty ID, Benutzer:innen-Konto und Passwort ein, wirst du direkt in das Backend des Systems weitergeleitet. Dadurch hast du keinen Zugriff auf die Systemübersicht und kannst dich somit mit dem plentysystems Konto nur in ein System einloggen.
====
