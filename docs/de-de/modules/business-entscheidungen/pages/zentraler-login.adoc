...
[WARNING]
.Login mit plenty ID, Benutzer:innen-Konto und Passwort als Administrator nicht möglich
====
Als Administrator kannst du dich im zentralen Login nur via E-Mail-Adresse anmelden. Das liegt daran, dass wenn du dein Passwort vergessen würdest, keine Möglichkeit hast, dieses selbst zurücksetzen und dich so aus dem System aussperrst.
====
...
image::central-login-account-de.png[width=680,height=680]
...
image::central-login-security-de.png[width=680,height=680]
