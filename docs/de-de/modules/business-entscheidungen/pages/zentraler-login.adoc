...
[#385]
===== Multi-Faktor-Authentifizierung aktivieren mit Anmeldung per E-Mail

[.instruction]
Gehe wie folgt vor, um die Multi-Faktor-Authentifizierung zu aktivieren:
...
--
Wende dich an unser Supportteam im link:https://https://forum.plentymarkets.com/[Forum^].
--
