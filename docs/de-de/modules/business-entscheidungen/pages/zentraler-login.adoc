...
====
Meldest du dich mit plenty ID, Benutzer:innen-Konto und Passwort ein, wirst du direkt in das System weitergeleitet, dadurch hast du keinen Zugrigg auf die Systemübersicht und kannst dich somit mit dem plentysystems Konto nur in ein System einloggen.
====
...
[.instruction]
Multi-Faktor-Authentifizierung aktivieren mit Anmeljdung per PID und Benutzer:innen-Name:
...
--
Wende dich an unser Supportteam im Forum.
--
