...
:position: 400
:url: business-entscheidungen/plenty-bi/kennzahlen/durchschnittliche-anzahl-auftragspositionen
:id: E5VUVYW
...
Wähle zusätzlich eine <<business-entscheidungen/plenty-bi/kennzahlen/durchschnittliche-anzahl-auftragspositionen#100, Dimension>> um festzulegen, wie das Ergebnis aufgeschlüsselt werden soll.
Setze außerdem <<business-entscheidungen/plenty-bi/kennzahlen/durchschnittliche-anzahl-auftragspositionen#200, Filter>> um zu konkretisieren, nach welchen Kriterien die durchschnittliche Anzahl der Auftragspositionen berechnet werden soll.
...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: So erkennst du auf einen Blick, wie viele Auftragspositionen durchschnittlich über welche Auftragsherkunft verkauft werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: So erkennst du auf einen Blick, wie viele Auftragspositionen durchschnittlich über welches Lager verkauft werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: So erkennst du auf einen Blick, wie viele Auftragspositionen durchschnittlich über welchen Mandanten verkauft werden. Differenziert wird zusätzlich nach dem Datum, an dem die Waren für die Aufträge versandt wurden.
