...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: So erkennst du auf einen Blick, wie viele Auftragspositionen durchschnittlich über welchen Mandanten verkauft werden. Differenziert wird zusätzlich nach dem Datum, aan dem der Warenausgang für die Aufträge gebucht wurde.
