...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: Bei der Berechnung wird dementsprechend das Enddatum dess Abonnements einbezogen.
...
:kennzahl: Die durchschnittliche Anzahl der Auftragspositionen
:das-bedeutet: Bei der Berechnung wird dementsprechend das Startdatum dess Abonnements einbezogen.
