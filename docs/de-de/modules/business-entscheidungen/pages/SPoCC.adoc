...
NOTE: Diese Anleitung ist das Richtige für dich, wenn du SPoCC-Kund:in bist, aber noch kein plentymarkets System im produktiven Einsatz hast.
...
| Aktiviere diese Option, um einen vollständigen Artikelimport zu aktivieren. Nach dem ersten vollständigen Artikelimport werden nur noch neue und geänderte Artikeldaten importiert. Falls du später irgendwann wieder einen vollständigen Artikelimport benötigst, aktiviere diese Funktion noch einmal und schließe den Assistenten wie gewohnt ab.
...
* Nach dem ersten Import werden nur noch Teilimporte durchgeführt, die auf den zuvor gewählten xref:business-entscheidungen:SPoCC.adoc#70[Importeinstellungen] basieren.
...
| *Vollständiges Bestands-/Preisupdate*
| Alle 24 Stunden
| // TODO: Die Unterteilung ergibt irgendwie keinen Sinn, oder?

| *Delta Bestands-/Preisupdate*
| Alle 15 Minuten
| // TODO: Die Unterteilung ergibt irgendwie keinen Sinn, oder?
|===
