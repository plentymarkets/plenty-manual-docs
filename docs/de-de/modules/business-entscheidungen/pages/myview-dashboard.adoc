...
Im Dashboard stehen dir verschiedene Möglichkeiten zur Verfügung, um Kennzahlen oder andere wichtige Informationen darzustellen. Die folgenden Typen von Elementen lassen sich verwenden:
...
[#510]
==== Einstellungen zu Kacheln vornehmen
...
[#650]
=== Kombinierte Tabellen verwenden
...
Nachdem du <<#600, Tabellen>> und <<#650, kombinierte Tabellen>> auf dem Dashboard platziert hast, stehen dir weitere Optionen zur Verfügung, um die dargestellten Daten genauer einzusehen und bei bei Bedarf zu exportieren.
...
//TODO: Portlet zu Aufgaben anzeigen ergänzen, sobald Fix/Info kommt.
