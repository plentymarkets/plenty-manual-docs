...
| Wähle die Kennzahl, die du anlegen möchtest. Eine Liste mit verfügbaren Kennzahlen findest du auf der Handbuchseite <<business-entscheidungen/plenty-bi/kennzahlen#, Kennzahlen>>.
...
--
include::_textblocks/neues-dashboard-element.adoc[]
--
...
Interner Link: Ein interner Link öffnet ein Menü innerhalb des plentymarkets Backends. Gib dabei die URL des zu öffnenden Menüs beginnend mit einem */* ein. Der Link muss alles beinhalten, was nach dem Bestandteil *terra* in der URL des zu öffnenden Menüs angegeben ist. + *_Beispiel:_* Soll durch Klick auf den Button die Auftragsübersicht geöffnet werden, gib den Link */order/order-search ein*. +
...
image::business-entscheidungen/plenty-bi/assets/globales-zeitintervall.png[]
