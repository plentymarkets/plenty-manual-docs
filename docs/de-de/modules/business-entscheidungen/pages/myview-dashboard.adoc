...
Besonders bei der Einrichtung deiner ersten Dashboard-Ansicht gibt es einige Punkte zu beachten. Nim zuerst die vorbereitenden Einstellungen vor und befolge sorgfältig die Anleitungen in den folgenden Abschnitten:
