...
:description: Mit dem Datenformat-Creator orderProperties kannst du Rohdaten zu Auftragseigenschaften exportieren und in der Cloud speichern. Diese Seite erläutert die technischen Spezifikationen und verfügbaren Datenspalten des Datenformats.
