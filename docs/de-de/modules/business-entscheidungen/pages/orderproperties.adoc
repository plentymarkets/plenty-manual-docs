...
:position: 120
:url: business-entscheidungen/plenty-bi/reports/datenformate/orderproperties
:id: SKCMPG4
...
Weitere mögliche Werte sind in unserer link:https://developers.plentymarkets.com/rest-doc/order_order_property/details[Entwicklerdokumentation^]{nbsp}icon:external-link[] zu finden.
