...
:description: Erfahre, welche Berechnungen, Dimensionen und Filter dir für die Kennzahl Versandumsatz zur Verfügung stehen. Diese Seite dient lediglich als Referenz und setzt voraus, dass du bereits Grundkenntnisse über das plentyBI-Tool hast.
