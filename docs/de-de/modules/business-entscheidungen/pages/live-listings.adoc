= Listings (Live)
:keywords: Listings, Marktplatz-Listings, Listings Live, Listings live überprüfen, Listing Status, Listing Kennzahl, Business Intelligence, Statistik, Statistiken, Kennzahl, Kennzahlen, Dashboard
...
Wähle den Filter *Erfolgreich* mit dem Vergleichsoperator *Ist gleich* und die Option *Erfolgreich*, um nach Listings zu filtern, die erfolgreich veröffentlicht wurden. Nutze alternativ die Option *Nicht erfolgreich*, um gezielt nach fehlgeschlagenen Listings zu filtern.
