...
:kennzahl: die Kennzahl Nachrichten
:das-bedeutet: So erkennst du auf einen Blick, wann die Nachrichten erstellt wurden. Differenziert wird zusätzlich nach den Tags, die mit der Nachricht verknüpft sind, sowie dem Benutzer, der die Nachricht erstellt hat.
