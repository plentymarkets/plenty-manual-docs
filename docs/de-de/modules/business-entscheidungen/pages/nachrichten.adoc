...
Du entscheidest im Bereich xref:business-entscheidungen:nachrichten.adoc#300[Filter], um zu konkretisieren, nach welchen Kriterien die Nachrichten berechnet werden sollen.
