...
401 = Umbuchung +
Weitere mögliche Werte sind in unserer link:https://developers.plentymarkets.com/rest-doc/item_variation_stock/details#intake-stock[Entwicklerdokumentation^]{nbsp}icon:external-link[] zu finden.
