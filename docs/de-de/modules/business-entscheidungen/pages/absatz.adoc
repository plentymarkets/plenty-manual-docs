...
:kennzahl: Der Absatz
:das-bedeutet: So erkennst du auf einen Blick, welche Stückzahlen aufgeschlüsselt nach den Plugins, über die Aufträge in dein plentymarkets System gelangen, verkauft werden. Differenziert wird zusätzlich nach dem Erstellungsdatum der Aufträge.
