...
* Die alte Umsetzung der Zahlungsbedingungen ist nun link:https://forum.plentymarkets.com/t/ankuendigung-zahlungsbedingungen-reloaded-announcement-payment-terms-reloaded/606607[wie angekündigt^] nicht mehr verfügbar. Weitere Informationen findest du auf der Handbuchseite xref:auftraege:grundeinstellungen.adoc#[Aufträge verwalten].
