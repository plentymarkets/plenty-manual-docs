...
+
image:changelog:kataloge-pflichtfelder-warnmeldung.png[width=640, alt=Der Toggle für die Anzeige der Pflichtfelder ist aktiviert. Alle anderen Felder werden nicht angezeigt.]
