...
+
image:changelog/assets/plugin-deaktivieren-warnung.png[width=640, alt=Eine Warnung wird angezeigt, wenn man versucht das Plugin IO zu aktivieren, solange Ceres aktiv ist.]
