...
+
image:changelog/assets/prozesse-status-in-bearbeitung.png[width=640, alt=Die neue Option ist direkt unter dem Eintrag Pickliste automatisch schließen zu finden.]
