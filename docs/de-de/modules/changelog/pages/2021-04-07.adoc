...
* Zahlungsbedingungen können nun auch auf Dokumenten ausgegeben werden, wenn es sich bei der Zahlungsart des Auftrags um *Vorkasse* handelt. xref:auftraege:grundeinstellungen.adoc#[Weitere Informationen].
