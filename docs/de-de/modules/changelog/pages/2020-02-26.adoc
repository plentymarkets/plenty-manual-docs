...
+
image::changelog/assets/messenger-nachricht-kostenpflichtig.png[width=640, height=360, alt=Kostenpflichtige Nachrichten in Messenger.]
* Du kannst nun Tags pro Nachricht entfernen und hinzufügen.
+
image::changelog/assets/messenger-nachricht-tags.png[width=640, height=360, alt=Tag an einer Nachricht.]
+
Weitere Informationen zum Verwalten von Nachrichten mit Messenger findest du auf der Handbuchseite <<crm/kontakte-verwalten#1390, Kontakte verwalten>>.
...
+
image::changelog/assets/shopbuilder-kategorie-verknuepfen.png[width=640, height=360, alt=Ansicht nur für die aktuelle Kategorie aktivieren.]
+
Inhalte, die auf Unterkategorien vererbt werden, haben wir nun durch ein Icon im ShopBuilder hervorgehoben:
+
image::changelog/assets/shopbuilder-unterkategorie-icon.png[width=640, height=360, alt=Icon für verknüpfte Unterkategorien.]
...
+
image::changelog/assets/elasticsync-import.png[width=640, height=360, alt=Der Menüeintrag Import.]
...
+
image::changelog/assets/elasticsync-kurze-dateinamen.png[width=640, height=360, alt=Ein gekürzter Dateiname.]
