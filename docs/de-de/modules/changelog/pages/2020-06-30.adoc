...
hinzugefügt.
+
image:changelog/assets/elastischer-export-auftragsposition-lager.png[width=640, alt=Lager-Filter am Typ Auftragsposition.]
...
+
image:changelog/assets/testsystem-partnersystem-umwandeln.png[width=640, alt=Schaltfläche am Testsystem im Mein Konto-Bereich.]
