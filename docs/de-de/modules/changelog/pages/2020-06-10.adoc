...
+
An der Funktionalität und an den Werten hat sich nichts verändert. Weitere Informationen zu dieser Funktionalität findest du auf der Handbuchseite <<maerkte/ebay/ebay-einrichten#2600, eBay einrichten>>.
...
Domains können ab jetzt im Backend konfiguriert werden. Weitere Informationen dazu findest du auf der Handbuch <<business-entscheidungen/systemadministration/domains#50, Domains>>. +
SSL-Zertifikate können ab jetzt im Backend bestellt und verwaltet werden. Weitere Informationen dazu findest du auf der Handbuchseite <<business-entscheidungen/systemadministration/ssl-zertifikat_bestellen#, SSL-Zertifikate>> und dem Beitrag link:https://forum.plentymarkets.com/t/leitfaden-ssl-bestellung/214417[Leitfaden: SSL-Bestellung im Forum^]. +
FTP-Zugänge können ab jetzt im Backend eingerichtet werden. Weitere Informationen dazu findest du auf der Handbuchseite <<daten/ftpz-zugang#_ftp_zugang_einrichten, FTP-Zugang einrichten>>.
...
+
Weitere Informationen zum Erstellen von Katalogen und dem Übertragen der Daten zu Amazon findest du auf der Seite <<maerkte/amazon/variantendaten-exportieren#, Amazon-Variantenexport per Katalog einrichten>>. Wenn du noch keine Erfahrung mit Katalogen hast, kannst du dir auf der Seite <<daten/daten-exportieren/kataloge-verwalten#, Kataloge verwalten>> einen ersten Überblick verschaffen.
...
+
Weitere Informationen zu diesem Prozess findest du auf der Seite <<maerkte/otto/otto-market#1400, OTTO market>>.
+
[IMPORTANT]
======
