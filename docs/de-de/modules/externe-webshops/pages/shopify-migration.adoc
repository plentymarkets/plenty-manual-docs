...
*_Fall 3:_* Du hattest in der Vergangenheit eine aktive Verbindung zu Shopify. Zurzeit ist aber kein Plugin installiert. Wenn du die Daten dieser Verbindung migrieren möchtest, folge den Anweisungen des Migrationsassistenten, um das Plugin zu installieren. +
