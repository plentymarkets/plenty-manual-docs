...
. Aktiviere die Optionen für den Datenaustausch, die auch im Shopify-Plugin für diesen Mandanten aktiviert sind. <<#QVFOWWID>> zeigt, welche Einstellung im Shopify-Plugin welcher Einstellung in der plentymarkets App für Shopify entspricht. +
...
[cols="1a,1a"]
|===
| Einstellung in Shopify-Plugin | Einstellung in plentymarkets App für Shopify
