...
[#BL4N7F]
=== Mandanten verbinden und Datenaustausch aktivieren
...
. Aktiviere die gewünschten Optionen für den Datenaustausch. +
*_Wichtig:_* Preise, Bestand und Artikel können nur in eine Richtung gesendet werden. Welche Richtung du wählst hängt davon ab, ob du Artikeldaten in plentymarkets oder in Shopify pflegst. Verschiedene Szenarios findest du in den Tabs unterhalb dieser Beschreibung.
. Speichere die Einstellungen.

[tabs]
====
Nur Artikel in plentymarkets::
+
--
...
Artikel in Shopify und plentymarkets::
+
--
