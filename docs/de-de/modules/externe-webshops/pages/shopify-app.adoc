...
→ Dir wird eine Liste deiner plentymarkets Mandanten angezeigt.
. Wähle, welchen Mandanten du mit diesem Shopify-Konto verbinden möchtest. Aktiviere dazu den Toggle *Verbunden* ganz rechts. +
...
*_Wichtig:_* Preise, Bestand und Artikel können nur in eine Richtung gesendet werden. Welche Richtung du wählst, kommt darauf an, ob du Artikeldaten in plentymarkets oder in Shopify pflegst.
