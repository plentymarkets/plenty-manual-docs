...
. Aktiviere den plentymarkets Mandanten, den du mit diesem Shopify-Konto verbinden möchtest. Aktiviere dazu den Toggle *Verbunden* ganz rechts. +
...
*_Wichtig:_* Preise, Bestand und Artikel können nur in eine Richtung gesendet werden. Welche Richtung du wählst hängt davon ab, ob du Artikeldaten in plentymarkets oder in Shopify pflegst. Verschiedene Ausgangssituationen findest du in <<#QVFOWVID>>.
