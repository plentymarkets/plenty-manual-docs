...
[[tabelle-dsgvo]]
.Berücksichtigung der DSGVO beim Kontaktimport
[cols="1,2"]
|===
...
* <<#3873695972, Die Plugin-Bereitschaft prüfen.>>
* <<#6535986175, Varianten-Exportbedingungen prüfen.>>
...
* <<#7088931107, Ein Artikelexport-Cleanup programmieren.>>
...
. Öffne das Menü *Einrichtung » Märkte » Shopify App » Hilfe » Plugin-Bereitschaft*.
. Klicke auf *Prüfen*.
...
. Öffne das Menü *Einrichtung » Märkte » Shopify App » Hilfe »Artikelexport*.
. Wähle einen Webshop.
...
. Öffne das Menü *Einrichtung » Märkte » Shopify App » Hilfe » Warenbestand Export*
...
Wenn ein:e Kund:in dich mit der Shopify-Bestell-ID kontaktiert, kannst du diese ID verwenden, um die plentymarkets Auftrags-ID des Auftrags zu finden.

[.instruction]
plentymarkets Auftrags-ID finden:

. Öffne das Menü *Einrichtung » Märkte » Shopify App » Hilfe » Auftragsnummer Suche*.
...
. Öffne das Menü *Einrichtung » Märkte » Shopify App » Hilfe » Artikelexport Cleanup*.
