...
include::partial$checklist-variations.adoc[tag=checklist-number-of-variations]

include::partial$checklist-variations.adoc[tag=checklist-name-text-shopify]

include::partial$checklist-variations.adoc[tag=checklist-attributes-shopify]

include::partial$checklist-variations.adoc[tag=checklist-market-sku]

include::partial$checklist-variations.adoc[tag=checklist-market-client]
