...
Im Tab *Hilfe* des Shopify-Plugins hast kannst du die folgenden Funktionen nutzen:
...
*Tipp:* Du kannst Kontakte des Typs *Gast* in reguläre Kontakte umwandeln. Weitere Informationen dazu findest du auf der Handbuchseite xref:crm:schnellsuche.adoc#gastzugang-umwandeln[Schnellsuche].
