...
| Ereignis
| SpoccConnector \| Versandmeldung erfolgreich
...
Lege fest, was mit Aufträgen passiert, die nicht an SPoCC gemeldet werden konnten. Das sind neue Aufträge, bei denen die Aktion *SPoCCConnector order export???* nicht ausgelöst wurde.
...
Lege fest, was mit Aufträgen passiert, wenn eine Stornierungsanfrage eingeht. 
