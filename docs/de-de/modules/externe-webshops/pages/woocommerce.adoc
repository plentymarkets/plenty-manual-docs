...
*_Tipp:_* Wie du den niedrigsten Preis der letzten 30 Tage an deinen Varianten pflegst ist im xref:artikel:verzeichnis.adoc#340[Verzeichnis der Datenfelder der neuen Artikel-UI] beschrieben.
