...
material:check_box[] = Wenn du einen gültigen Slug-Wert für die Einstellung *Slug-Wert für Preishinweis 'Niedrigster Preis der letzten 30 Tage'* eingegeben hast, wird der niedrigste Preis der letzten 30 Tage zu WooCommerce exportiert.
...
*_Tipp:_* In unserem Beispiel wäre das der Wert `lowest30days`. +
