...
//Welcher Mehrwertsteuersatz für die Variante gespeichert ist, siehst du im Menü xref:artikel:verzeichnis.adoc#190[Artikel » Artikel-UI » [Variante öffnen\] » Element: Kosten » Dropdown-Liste: Umsatzsteuer].
