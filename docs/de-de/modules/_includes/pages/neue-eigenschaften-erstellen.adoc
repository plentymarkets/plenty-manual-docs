...
Eigenschaften können aber auch für die nähere Charakterisierung von xref:crm:kontakte-verwalten.adoc#950[Kontakte] oder xref:warenwirtschaft:lager-einrichten.adoc#850[Lagerorte] verwendet werden.
...
Eigenschaften können aber auch für die nähere Charakterisierung von xref:artikel:eigenschaften.adoc#500[Artikeln] oder xref:warenwirtschaft:lager-einrichten.adoc#850[Lagerorte] verwendet werden.
Klicke auf die Links, um mehr über diese andere Anwendungsfälle zu erfahren.
endif::crm[]
ifdef::stock[]
...
Eigenschaften können aber auch für die nähere Charakterisierung von xref:artikel:eigenschaften.adoc#500[Artikeln] oder xref:crm:kontakte-verwalten.adoc#950[Kontakte] verwendet werden.
Klicke auf die Links, um mehr über diese andere Anwendungsfälle zu erfahren.
endif::stock[]
