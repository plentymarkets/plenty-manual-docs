...
Eigenschaften können aber auch für die nähere Charakterisierung von xref:crm:vorbereitende-einstellungen.adoc#eigenschaften-einleitung[Kontakten] oder xref:warenwirtschaft:lager-einrichten.adoc#850[Lagerorten] verwendet werden.
