...
|xref:videos:mfn-auftraege-einstellungen-konfigurieren.adoc#video[Einstellungen konfigurieren (1:04)]

xref:videos:mfn-auftraege-einstellungen-aktivieren.adoc#video[Einstellungen aktivieren (3:35)]
