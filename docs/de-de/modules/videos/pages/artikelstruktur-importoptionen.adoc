...
|xref:videos:artikelstruktur-importoptionen-unterschied-artikel-varianten.adoc#video[Was ist der Unterschied zwischen Artikeln und Varianten? (0:20)]

xref:videos:artikelstruktur-importoptionen-artikel-importieren.adoc#video[Wie kann ich Artikel in plentymarkets importieren? (3:43)]
