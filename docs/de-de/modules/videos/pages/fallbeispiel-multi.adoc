...
|xref:videos:fallbeispiel-multi-picklistensuche.adoc#video[Picklistensuche und Artikelerfassung (1:24)]

xref:videos:fallbeispiel-multi-bestandsfehler.adoc#video[Bestandsfehler angeben (2:00)]

xref:videos:fallbeispiel-multi-seriennummer.adoc#video[Seriennummer erfassen (2:49)]

xref:videos:fallbeispiel-multi-dokumente.adoc#video[Dokumente drucken (3:32)]
