...
|===
|
|xref:videos:layout-vorlagen-importieren.adoc#video[Layout-Vorlagen importieren (0:45)]

xref:videos:layout-vorlagen-verknuepfen.adoc#video[Layout-Vorlagen mit Listings verknüpfen (1:27)]
