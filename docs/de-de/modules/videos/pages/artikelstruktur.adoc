...
|xref:videos:artikelstruktur-unterschied.adoc#video[Was ist der Unterschied zwischen Artikeln und Varianten? (0:20)]

xref:videos:artikelstruktur-importieren.adoc#video[Wie kann ich Artikeln in plentymarkets importieren? (3:43)]
