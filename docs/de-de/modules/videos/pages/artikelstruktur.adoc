...
|<<videos/artikel/artikelstruktur-unterschied#video, Was ist der Unterschied zwischen Artikeln und Varianten? (0:20)>>

<<videos/artikel/artikelstruktur-importieren#video, Wie kann ich Artikeln in plentymarkets importieren? (3:43)>>
