...
|xref:videos:analytics-konto-verknuepfung.adoc#video[Verknüpfung mit deinem eBay-Konto (0:47)]

xref:videos:analytics-konto-analysieren.adoc#video[Analysiere dein eBay-Konto als Ganzes (1:11)]

xref:videos:analytics-listings-analysieren.adoc#video[Analysiere ausgewählte Listings (1:52)]
