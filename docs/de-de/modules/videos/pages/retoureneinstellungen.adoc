...
|xref:videos:retoureneinstellungen-gruende.adoc#video[Gründe für Retouren anlegen (0:27)]

xref:videos:retoureneinstellungen-reparaturlager.adoc#video[Reparaturlager erstellen (1:43)]

xref:videos:retoureneinstellungen-retourenanlage-durch-kunden.adoc#video[Sollen Kunden Retouren selbstständig anlegen können? (2:24)]
