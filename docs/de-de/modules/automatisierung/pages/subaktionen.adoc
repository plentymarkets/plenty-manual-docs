...
<<table-sub-procedure-order>> erläutert die zusätzlichen Einstellungen der Subaktion. Informationen zu den allgemeinen Einstellungen für Subaktionen findest du in <<table-sub-procedures-general-settings>>.
