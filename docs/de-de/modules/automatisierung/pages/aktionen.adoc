...
Mit der Aktion *Hochgeladene Dokumente* können hochgeladene Dokumente deiner Wahl per Subaktion automatisch zum Beispiel gedruckt oder gespeichert werden. Diese Aktion eignet sich für nicht auftragsbezogene Dokumente.
