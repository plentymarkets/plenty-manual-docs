...
| **Retourengrund**
|Grund wählen, damit Retouren beim Erstellen diesen Rückgabegrund erhalten. Retourengründe erstellst du im Menü xref:auftraege:grundeinstellungen.adoc[Einrichtung » Aufträge » Auftragstypen » Retoure].
...
| **Artikelstatus**
|Einen Artikelstatus wählen, der im Prozess beim Erstellen der Retoure voreingestellt wird. Die Artikelstatus für Retouren werden im Menü xref:auftraege:grundeinstellungen.adoc[Einrichtung » Aufträge » Auftragstypen » Retoure] angelegt.

| **Artikelwert**
|Einen Prozentwert eingeben, um ihn retournierten Artikeln zuzuweisen. Nachdem eine Retoure angelegt wurde, wird der Wert auch im Tab **Übersicht** einer xref:auftraege:grundeinstellungen.adoc[Retoure] bei der Artikelposition angezeigt.
