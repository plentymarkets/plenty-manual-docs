...
| **Etiketten-Vorlage**
|xref:artikel:artikel-verwalten.adoc#760[Etiketten-Vorlage] aus der Dropdown-Liste wählen.
...
| **Etiketten-Vorlage**
|Eine xref:artikel:artikel-verwalten.adoc#760[Etiketten-Vorlage] aus der Dropdown-Liste wählen.
|====
...
*Box-Suche* = Wird für die xref:automatisierung:rollende-kommissionierung.adoc[rollende Kommissionierung] verwendet. Das Lagerpersonal scannt den Barcode eines Lagerorts. Daraufhin ruft plentymarkets den entsprechenden Auftrag auf.
...
Mit der Aktion **Exportdokument** wird ein xref:fulfillment:versand-vorbereiten.adoc#2950[DHL-Exportdokument] generiert. Dieses Exportdokument kann per gewählter Subaktion automatisch gedruckt, gespeichert und/oder zwischengespeichert werden.
...
Mit der Aktion *Hochgeladene Dokumente* können hochgeladene Dokumente deiner Wahl per Subaktion automatisch zum Beispiel gedruckt oder zwischengespeichert werden. Diese Aktion eignet sich für nicht auftragsbezogene Dokumente.
...
<<table-procedure-uploaded-docs>> erläutert die zusätzlichen Einstellungen der Aktion. Informationen zu den allgemeinen Einstellungen für Aktionen findest du in <<table-procedures-general-settings>>.

[[table-procedure-uploaded-docs]]
.Aktion *Hochgeladene Dokumente*
[cols="1,3"]
|====
|Einstellung |Erläuterung

| *Alle* (Standardeinstellung)
|Es werden alle hochgeladenen Dokumente gewählt und an die Subaktion weitergegeben. Momentan können lediglich Dateien im PDF-Format gewählt werden.

| *Auswahl*
|Wähle die gewünschten Dokumente, für die die Subaktion ausgeführt werden soll. Momentan können lediglich Dateien im PDF-Format gewählt werden.
...
| *Etikettenvorlage*
|Eine xref:artikel:artikel-verwalten.adoc#3300[Etikettenvorlage] aus der Dropdown-Liste wählen.
