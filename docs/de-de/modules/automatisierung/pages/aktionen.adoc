...
| **Retourengrund**
|Grund wählen, damit Retouren beim Erstellen diesen Rückgabegrund erhalten. Retourengründe erstellst du im Menü <<auftraege/auftraege-verwalten#410, Einrichtung » Aufträge » Auftragstypen » Retoure>>.
...
Mit der Aktion **Zahlungseingang anlegen** wird im Menü <<payment/beta-zahlungen-verwalten#, Aufträge » Zahlungsverkehr>> eine Zahlung mit Datum und Zahlungsart erstellt. Damit erhältst du einen Überblick und einen Nachweis über die Zahlungen, die per xref:payment:bankdaten-verwalten.adoc#220[SEPA-Lastschrift] in dein System kommen.
