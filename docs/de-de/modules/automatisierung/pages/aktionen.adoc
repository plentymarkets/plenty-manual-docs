...
:right-one: pass:quotes[*Aufträge > Fulfillment > Picklisten > Anzeigen*]
:right-two: pass:quotes[*Aufträge > Fulfillment > Picklisten > Bearbeiten*]
...
Mit der Aktion **Polling** wird eine xref:fulfillment:versand-center.adoc#polling-datei-erzeugen[Polling-Datei] im CSV-Format erzeugt, die für bestimmte Versanddienstleister benötigt wird. Per Subaktion kannst du diese Datei speichern.
...
:right-one: pass:quotes[*Aufträge > Versand > Retourenlabel > Anzeigen*]
...
Mit der Aktion **Versand-Center** wird ein xref:fulfillment:versand-center.adoc#[Versandauftrag] per Subaktion automatisch zum Beispiel gedruckt oder gespeichert.
...
:right-one: pass:quotes[*Artikel > Artikel > Variante > Lieferantendaten > Anzeigen*]
