...
| **Etiketten-Vorlage**
|xref:artikel:barcodes.adoc#800[Etiketten-Vorlage] aus der Dropdown-Liste wählen.
...
| **Etiketten-Vorlage**
|Eine xref:artikel:barcodes.adoc#800[Etiketten-Vorlage] aus der Dropdown-Liste wählen.
|====
...
| **Etikettenvorlage**
|Bereits im plentymarkets System angelegte xref:artikel:barcodes.adoc#800[Etikettenvorlage] wählen, die zum Druck der Artikeletiketten genutzt werden soll.
...
| *Etikettenvorlage*
|Eine xref:artikel:barcodes.adoc#800[Etikettenvorlage] aus der Dropdown-Liste wählen.
