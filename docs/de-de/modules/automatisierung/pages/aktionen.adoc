...
*_Hinweis:_* Mahnungen können nur aufsteigend gewählt werden, d.h. die Stufe 2 kann erst gewählt werden, wenn bereits eine erste Mahnung erfolgt ist usw. Außerdem muss eine aktuelle Rechnung für den Auftrag existieren, die nicht storniert wurde. Ansonsten kann keine Mahnung generiert werden.

| *Varianten-ID hinzufügen*
|Gib die Varianten-ID für die Mahnungsgebühr ein.
