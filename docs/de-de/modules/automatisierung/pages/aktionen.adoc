...
*_Hinweis:_* Es muss eine aktuelle Rechnung für den Auftrag existieren, die nicht storniert wurde.

| *Mahnung*
|Wähle die Mahnung aus der Dropdown-Liste, die du generieren möchtest. Es stehen die Optionen 1 - 4 zur Verfügung. +
*_Hinweis:_* Die Mahnungen können nur aufsteigend gewählt werden, d.h. Mahnung 2 kann erst gewählt werden, wenn bereits eine erste Mahnung erfolgt ist.
