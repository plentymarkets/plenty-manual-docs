...
Eigene Dokumente lädst du im Menü *Aufträge » Aufträge* herunter. Öffne dazu einen Auftrag und gehe in den Bereich *Dokumente*. Klicke oben auf *Dokument erstellen* (material:add[]) und wähle die Option *Externes Dokument* (material:file_download[]).
