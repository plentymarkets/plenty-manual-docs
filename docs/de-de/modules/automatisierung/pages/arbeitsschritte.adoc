...
| *Tags*
n grenzt du genau ein, welche Aufträge mit dem Arbeitsschritt *Auftragsabwicklung* bearbeitet werden.
...
Aktiviere zusätzlich eine der Optionen *Aufträge mit exakt diesen Tags* oder *Aufträge mit mindestens diesen Tags*, um gena zu bestimmen, wie nach Tags gefiltert werden soll.
