...
Dieses Kapitel beschreibt die Arbeitsschritte, die du für Prozesse einrichten kannst. Für einen Prozess kannst du beliebig viele Arbeitsschritte erstellen. 
...
Mit Filtern grenzt du genau ein, welche Aufträge mit dem Arbeitsschritt *Auftragsabwicklung* bearbeitet werden.
