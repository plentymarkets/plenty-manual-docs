...
. <<automatisierung/aktionsmanager#200, Allgemeine Einstellungen vornehmen>>
. <<automatisierung/aktionsmanager#300, Filtereinstellungen vornehmen >>
. <<automatisierung/aktionsmanager#400, Eine oder mehrere Aktionen auswählen>>
. <<automatisierung/aktionsmanager#500, Aktion aktivieren>>
...
| *Status*
|Den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> der Aufträge wählen, auf die die Aktion automatisch angewendet werden soll. Hier ist nur ein Status wählbar. Die Aktion wird dann zum gewählten Zeitpunkt auf alle Aufträge angewendet, die sich in exakt diesem Status befinden.
...
|Wähle eine E-Mail-Vorlage aus der Dropdown-Liste. Achte darauf, dass die gewählte Vorlage <<crm/e-mails-versenden#1200, korrekt eingestellt>> ist. Belasse die Auswahl auf *---*, wenn keine E-Mail-Vorlage versendet werden soll.

| *Ändere Auftragsstatus*
|Wähle den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>, in den die von der Aktion betroffenen Aufträge wechseln sollen.  Belasse die Auswahl auf *---*, wenn kein Statuswechsel stattfinden soll.
