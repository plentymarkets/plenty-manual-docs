...
*_Hinweis:_* Wenn der Menüpunkt *Einrichtung » Prozesse* nicht angezeigt wird, installiere das Plugin link:https://marketplace.plentymarkets.com/plugins/externe-tools/plentyBase_5053/[plentyBase^]{nbsp}icon:external-link[].
...
Du kannst Prozesse, z.B. aus dem link:https://forum.plentymarkets.com/c/suche-biete/prozess-basar[Prozessbasar, window="_blank"]{nbsp}icon:external-link[] oder aus dem plentymarkets Handbuch ganz einfach herunterladen und anschließend in deinem eigenen System importieren.
...
In der Kategorie link:https://forum.plentymarkets.com/c/suche-biete/prozess-basar[Prozesse, window="_blank"]{nbsp}icon:external-link[] des plentymarkets Forum findest du den plentymarkets Prozessbasar. Hier stellen engagierte Händler:innen ihre Prozesse zur Verfügung.
