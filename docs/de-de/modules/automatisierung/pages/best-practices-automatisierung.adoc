...
Die E-Mail wird an die Adresse des gewählten Mitarbeiters versendet. Damit eine E-Mail-Adresse hier wählbar ist, muss sie im Menü xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#42[Einrichtung » Einstellungen » Benutzer » Konten] beim Benutzer eingetragen sein. +
...
Weitere Information zu Gratis-Artikeln findest du auch auf der Handbuchseite xref:artikel:artikel-verwalten.adoc#4300[Artikel verwalten].
