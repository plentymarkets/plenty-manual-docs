...
Wenn du schon beim Auftragseingang über den Webshop eine Bestellbestätigung an deine Kunden versenden möchtest, empfehlen wir die in <<table-event-procedure-automatic-order-confirmationg>> beschriebene Ereignisaktion.
