...
Die HTML-Vorschau wird für die jeweilige Auftrags-ID als Eintrag in der Seitennavigation sichtbar.
//check with Isabela whether this is still the case:
...
| *Auftrags-ID*
|Gib optional eine Auftrags-ID ein, um eine Vorschau für diesen Auftrag zu generieren. Für jede gewählte Auftrags-ID wird dann ein separater Eintrag in der Seitennavigation angezeigt.
