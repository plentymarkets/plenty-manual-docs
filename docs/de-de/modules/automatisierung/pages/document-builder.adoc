...
//sind das alle Rechte, die benötigt werden?
...
//Info zum Dateinamen hinzufügen?

| *Tags*
|Zeigt die Tags der Vorlage an. +
*_Tipp:_* Sind mehrere Tags vorhanden, fahre mit der Maus über das angezeigte Tags, um alle weiteren Tags zu sehen.
...
// * Stornobeleg Mahnung vs. Mahnungsstorno +
* Stornobeleg Rechnung +
Bestellung: +
// * Bestellschein (UI) vs. Nachbestellung
* PO Lieferschein +
Alle Aufträge: +
* Benutzerdefinierter Auftrag
...
// *_Hinweis:_* Dieser Filter ist nur für die Dokumenttypen *PO Lieferschein* und *Nachbestellung*/Bestellung?? verfügbar.
...
[.instruction]
Aktuellen Filter speichern:name
...
//Weitere Infos zum Dokumentname geben?
...
Lege die Ausgabeeeinstellungen für deine Dokumentvorlagen fest. Gehe dazu vor wie folgt.

[.instruction]
Ausgabeeinstellungen festlegen:

. Öffne eine Vorlage.
. Klicke oben auf *Ausgabeeeinstellungen* (material:settings[]).
...
== Funktionen für einzelne Dokumente vornehmen

In der Übersicht des DocumentBuilders findest du am Ende jeder Zeile ein Kontextmenü (material:more_vert[]), das die Funktionen *Vorlage aktivieren*, *Vorlage kopieren*, *Vorlage exportieren* und *Vorlage löschen* für die jeweilige Dokumentenvorlage zur Verfügung stellt. Diese Funktionen sind ebenfalls in der Detailansicht einer Vorlage zu finden. In den folgenden Kapiteln werden diese Funktionen näher erläutert.
