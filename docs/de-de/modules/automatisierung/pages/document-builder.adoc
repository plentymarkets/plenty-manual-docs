...
Es können sowohl aktive als auch inaktive Vorlagen kopiert werden. Dies gilt ebenfalls für Standardvorlagen. Um eine Vorlage mit allen darin enthaltenen Einstellungen zu kopieren, gehe vor wie folgt.
...
Importiere Vorlagen aus einem anderen System mit nur wenigen Klicks, damit du sie im DocumentBuilder weiterverwenden kannst.
