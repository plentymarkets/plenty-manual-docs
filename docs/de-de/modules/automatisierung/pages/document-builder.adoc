...
| *Dokumentart*
|Wähle die Art des Dokuments aus der Dropdown-Liste.
...
| *Sprache*
|Wähle eine oder mehrere Sprachen aus der Dropdown-Liste.

| *Standort*
|Wähle einen oder mehrere Standorte aus der Dropdown-Liste.

| *Herkunft*
|Wähle eine oder mehrere Herkünfte aus der Dropdown-Liste. +
*_Hinweis:_* Es werden nur aktive Herkünfte angezeigt.
//Erklären, wie man Herkünfte aktiviert?

| *Zahlungsart*
|Wähle eine oder mehrere Zahlungsarten aus der Dropdown-Liste.

| *Lieferland*
|Wähle eine oder mehrere Lieferländer aus der Dropdown-Liste.

| *Netto / Brutto*
|Wähle Netto und/oder Brutto aus der Dropdown-Liste.

| *Kundenklasse*
|Wähle eine oder mehrere Kundenklassen aus der Dropdown-Liste.

| *Lager*
|Diese Einstellung ist nur für die Dokumenttypen *PO Lieferschein* und *Nachbestellung* verfügbar. Wähle hier ein oder mehrere Lager aus der Dropdown-Liste. Du kannst zwischen *Vertriebs-* und *Reparaturlagern* wählen.
// In UI erneut prüfen sobald sichtbar.
//Weitere Lager-Typen: Vorrat/Storage, Umschlag/Storage, Transit(?)/Transit, Verteiler/Distribution, Sonstiges/Other
...
* Systemstandard (die Systemsprache wird mit Dezimaltrennzeichen verwendet)
* Deutsch mit Dezimaltrennzeichen (z.B. 12.003,67)
* Deutsche ohne Dezimaltrennzeichen (z.B. 12003,67)
* Englisch mit Dezimaltrennzeichen (z.B. 12,003.67)
* Englisch ohne Dezimaltrennzeichen (z.B. 12003.67)

| *Datumsformat*
|Wähle, in welchem Format das Datum angezeigt werden soll. Dafür stehen dir die folgenden Optionen zur Verfügung. +
* Systemstandard (das Datumsformat der Systemsprache wird verwendet)
* Deutsch (DD.MM.YYYY)
* Britisch (DD-MM-YYYY)
* US (MM-DD-YYYY)
...
*_Tipp:_* Die HTML-Vorschau ist ebenfalls in den Einstellungen der Vorlage sichtbar. Klappe dort den Bereich *Vorlagenstruktur* aus (material:navigate_next[]), um die Vorschau zu sehen. Wenn du im Editor Änderungen an einer Vorlage vornimmst und diese speicherst, wird die HTML-Vorschau im Bereich *Vorlagenstruktur* automatisch neu generiert und aktualisiert.

| *Auftrags-ID*
|Gib optional eine Auftrags-ID ein.

|===

[TIP]
.Zwischen Bearbeitungsmodus und Vorschaumodus wechseln
====
Nutze die Umschaltfläche oben im Bearbeitungsmodus einer Vorlage, um zwischen dem Bearbeitungsmodus und dem HTML-Modus zu wechseln. Im HTML-Modus wird der zuletzt gespeicherte Stand der Vorlage angezeigt. Bei Bedarf kannst du ebenfalls eine *Auftrags-ID* eingeben, um die Vorschau mit den jeweiligen Auftragsinformationen zu sehen. Die gewählte Auftrags-ID wird dann ebenfalls für die PDF-Vorschau verwendet.
====
//nochmal anpassen, sobald implementiert
...
. Wähle eine Vorlage.
. Klicke auf *Importieren* (material:file_upload[]). +
→ Die Vorlage wird importiert.
//check import icon again
//Welche Art von Dokumenten können importiert werden? .pdf? Gibt es etwas zu beachten?
