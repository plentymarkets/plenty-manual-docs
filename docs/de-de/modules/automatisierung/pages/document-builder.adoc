...
Du kannst entscheiden, für welche Dokumenttypen du den DocumentBuilder verwenden möchtest und für welche Dokumenttypen die alten Einstellungen im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente* greifen sollen. Gehe dazu vor wie folgt.
...
////
TODO Add box containing : Das Benutzerdefinierte Auftragsdokument

Mit dem benutzerdefinierte Auftragdokument hast du die Möglichkeit, ein komplett anpassbares Dokument ohne Einschränkungen zu erstellen. Es kann für alle Auftrastypen verwendet werden (einschließlich Bestellwesen)
////
