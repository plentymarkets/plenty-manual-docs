...
//Gilt dies auch für den Filter? *_Hinweis:_* Es werden nur aktive Herkünfte angezeigt.
...
Barcode
Text
//Doku für Widgets verallgemeinern oder für jedes einzelne Widget alle Einstellungen dokumentieren? (Bläht die Seite wahrscheinlich nur unnötig auf?)
