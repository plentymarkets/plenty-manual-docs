...
* Systemstandard (die Systemsprache / die Auftragssprache??? wird mit Komma/Punkt?? als Dezimaltrennzeichen verwendet)
...
* Systemstandard (das Datumsformat der Systemsprache oder Auftragssprache??wird verwendet)
* dd.mm.yyyy
* dd-mm-yyyy
* mm-dd-yyyy
...
Date:
System default (format of system language / order language)????
dd.mm.yyyy
dd-mm-yyyy
mm-dd-yyyy
