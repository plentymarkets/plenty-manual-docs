...
Der Eintrag *PayPal Import* mit dem PayPal-Icon in der linken Navigation wird nur angezeigt, wenn das <<payment/payment-plugins/paypal#, PayPal-Plugin>> installiert ist. Dafür ist das PayPal-Plugin mindestens in Version 6.0.0 erforderlich. +
