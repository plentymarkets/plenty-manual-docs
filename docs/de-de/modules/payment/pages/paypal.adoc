...
======
Die Schritte zur Aktualisierung des PayPal-Plugins auf Version 6.0 und die Aktivierung von PayPal Checkout sind in diesem Click-through-Guide zusammengestellt. Die Screenshots helfen dir durch die einzelnen Schritte. Du kannst den Guide auch als link:URL[PDF herunterladen^].
======
--
Plugin-Version 5.X::
+
...
include::_includes:page$ausfuehrung-assistent-zahlungsart.adoc[]
...
|*PayPal Zahlungsarten-Buttons*
|Optional: Die Zahlungsarten-Buttons sind universell hinterlegbar, z.B. neben dem Warenkorb (Shopping cart). Sie geben Kund:innen die Möglichkeit, den Inhalt des gesamten Warenkorbs sofort zu kaufen, ohne den Umweg über die Kaufabwicklung zu machen. Hierbei wird direkt zur Zahlung weitergeleitet. Die Lieferadresse wird von PayPal bereitgestellt.
...
|Mit *My account: Additional payment information* verknüpfen, um Kund:innen im Mein-Konto-Bereich die Möglichkeit zu geben, nach nicht erfolgreicher Zahlung eine erneute Zahlung durchzuführen. Für PayPal wird die Schaltfläche *Jetzt zahlen* angezeigt. +
Mit *Order confirmation: Additional payment information* verknüpfen, um Kund:innen in der Bestellbestätigung die Möglichkeit zu geben, nach nicht erfolgreicher Zahlung eine erneute Zahlung durchzuführen. Für PayPal wird die Schaltfläche *Jetzt zahlen* angezeigt.
...
Beachte auch den Abschnitt xref:payment:paypal.adoc#50[Weitere Informationen zur PayPal PLUS Wall]. Dort werden neben zusätzlichen Informationen auch Beschränkungen beschrieben.
...
.Rückleitung zu plentymarkets ist nicht möglich
image::payment:paypal-plugin-fehlermeldung_fehler1.png[Plugin Fehlermeldung]
...
* Überprüfe die xref:payment:paypal.adoc#intable-paypal-plus-wall[Container-Verknüpfungen]. Diese sollten beim Durchlaufen des Assistenten automatisch erstellt werden, können aber auch manuell gesetzt werden.
