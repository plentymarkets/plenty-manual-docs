...
* Zahlungsarten sind abhängig vom Lieferland. So sind Kauf auf Rechnung und Lastschrift nur für Deutschland freigegeben. Beachte auch <<payment/payment-plugins/paypal#50, Weitere Informationen zur PayPal PLUS Wall>>.
