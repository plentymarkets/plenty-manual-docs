...
+
--
Wenn du auf Version 5.0 des PayPal-Plugins bist, sind hier keine weiteren Schritte erforderlich. Wenn du auf Version 6.0 updaten möchtest, wechsele in das Tab zu Version 6.0.
--
Plugoin-Version 6.0::
+
--
