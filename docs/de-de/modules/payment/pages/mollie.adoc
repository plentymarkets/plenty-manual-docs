...
| Falls du *Statuswechsel* gewählt hast, wähle aus der Dropdown-Liste dann den <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>, den du für stornierte Aufträge nutzt. Standardmäßig sind dies Status *8 - Storniert* und *8.1 - Storniert durch Kunden*.
...
|Wähle aus der Dropdown-Liste den Auftragsstatus aus, in den Aufträge mit Mollie-Zahlungsarten, bei denen es einen Fehler bei der Rückzahlung gab, geschoben werden sollen. Du könntest beispielsweise vorher einen eigenen <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> dafür anlegen. In der Auftragsbearbeitung siehst du dann schneller die Aufträge, bei denen eine weitere Bearbeitung erforderlich ist.
...
| *Aktion*
| *Auftrag > Status ändern*
|Wähle aus der Dropdown-Liste den Auftragsstatus aus, in den Aufträge mit Mollie-Zahlungsarten, bei denen die Meldung des Versands an Mollie nicht erfolgen konnte, geschoben werden sollen. Du könntest beispielsweise vorher einen eigenen <<auftraege/auftraege-verwalten#1200, Auftragsstatus>> dafür anlegen. In der Auftragsbearbeitung siehst du dann schneller die Aufträge, bei denen eine weitere Bearbeitung erforderlich ist.
