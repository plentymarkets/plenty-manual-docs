...
Auf dieser Handbuchseite erfährst du, wie du deine xref:payment:bankdaten-verwalten.adoc#10[Bankinformationen] und die <<payment/bankdaten-verwalten#63, Bankdaten deiner Kund:innen>> in plentymarkets speicherst und wie du xref:payment:bankdaten-verwalten.adoc#69[EBICS] und xref:payment:bankdaten-verwalten.adoc#220[SEPA] einrichtest.
