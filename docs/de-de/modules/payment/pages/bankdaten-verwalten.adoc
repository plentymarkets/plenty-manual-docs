...
Auf dieser Handbuchseite erfährst du, wie du deine <<#eigene-bankdaten, Bankdaten>> und die <<#bankdaten-kunden, Bankdaten deiner Kund:innen>> in plentymarkets speicherst und wie du <<#69, EBICS>> und <<#220, SEPA>> einrichtest.
