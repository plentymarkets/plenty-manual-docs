...
Verwende die Variable *Kontoinhaber (Stammdaten)* für E-Mail-Vorlagen, die du über den xref:crm:emailbuilder-uebersicht.adoc#[EmailBuilder] erstellst. +
...
Verwende die Variable *IBAN (Stammdaten)* für E-Mail-Vorlagen, die du über den xref:crm:emailbuilder-uebersicht.adoc#[EmailBuilder] erstellst. Die IBAN setzt sich zusammen aus der Länderkennung (DE für Deutschland), einer Prüfziffer sowie der bisherigen Bankleitzahl und Kontonummer. +
...
Verwende die Variable *Bankname (Stammdaten)* für E-Mail-Vorlagen, die du über den xref:crm:emailbuilder-uebersicht.adoc#[EmailBuilder] erstellst. Die IBAN setzt sich zusammen aus der Länderkennung (DE für Deutschland), einer Prüfziffer sowie der bisherigen Bankleitzahl und Kontonummer. +
...
Verwende die Variable *IBAN (Stammdaten)* für E-Mail-Vorlagen, die du über den xref:crm:emailbuilder-uebersicht.adoc#[EmailBuilder] erstellst. +
