...
Wenn du das unterschriebene SEPA-Lastschriftmandat eines Kunden erhalten hast, ist die nachfolgend beschriebene Einstellung erforderlich, um den SEPA-Zahlungsverkehr zu aktivieren und die pain008-Formate abzurufen.
