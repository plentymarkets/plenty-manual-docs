...
Wenn du das unterschriebene SEPA-Lastschriftmandat eines Kunden erhalten hast, ist die im Folgenden beschriebene Einstellung erforderlich, um den SEPA-Zahlungsverkehr zu aktivieren und die pain008-Formate abzurufen.
