...
Welche Rollen sollen die Ansicht sehen dürfen?
Du kannst den Zugriff auf jede Ansicht einzeln gewähren bzw. einschränken.

:rights-purpose: Zahlungen verwalten können
:right-one: pass:quotes[*Aufträge > Zahlungsverkehr > Betrachten*]
:right-two: pass:quotes[*Aufträge > Zahlungsverkehr > Bearbeiten*]
