...
Neben den Funktionen xref:payment:beta-zahlungen-verwalten.adoc#payments-myview[MyView] kannst du die Elemente in der Detailansicht nach deinen eigenen Bedürfnissen gestalten und anordnen.
