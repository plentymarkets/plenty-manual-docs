...
Es gibt zwei Möglichkeiten, Zahlungen von einem Auftrag zu lösen. Im Menü *Aufträge » Zahlungsverkehr* kannst du die Zuordnung der Zahlung entweder direkt in der <<#zahlung-loesen-uebersicht, Übersicht>> oder in der <<#zahlung-loesen-detailansicht, Detailansicht>> einer Zahlung aufheben.
