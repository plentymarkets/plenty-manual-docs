...
| **Betriebssysteme**
a|
* Android-Geräte mit OS-Version ab 5.1, ARM Prozessor und den Geräteklassen Small, Normal, Large und X-Large. Die DPI-Zahl eines mobilen Geräts kann z.B. link:http://dpi.lv/[hier^] ermittelt werden.
