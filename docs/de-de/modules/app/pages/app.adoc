...
Wofür möchtest du die plentymarkets App nutzen? Je nach Anwendungsfall unterscheidet sich die xref:app:installieren.adoc#100[Wahl der passenden Hardware]. Willst du beispielsweise Barcodes scannen und Kartenzahlungen annehmen, brauchst du andere Hardware als wenn du lediglich deine Geschäftszahlen im Blick behalten möchtest.
...
Die plentymarkets App funktioniert nur in Kombination mit link:https://www.plentymarkets.com/de/[einem gebuchten plentymarkets System^]. Das heißt, dass du dich in der App xref:app:installieren.adoc#1200[mit denselben Zugangsdaten anmeldest] wie in deinem plentymarkets System.

Sollen mehrere Mitarbeiter:innen die plentymarkets App benutzen, müssen sie ebenfalls Zugangsdaten erhalten. Lege zunächst fest, xref:app:installieren.adoc#600[in welchem Umfang deine Mitarbeiter:innen die App verwenden] dürfen.

[#500]
=== Die App personalisieren

Möchtest du z.B. bestimmen, in welcher Reihenfolge und in welcher Schriftgröße einzelne Informationen in der App dargestellt werden? Oder willst du anstatt des Standard-Hintergrunds die Farben deines eigenen Corporate Designs verwenden? xref:app:installieren.adoc#1800[Personalisiere die App] und richte sie nach deinen Wünschen ein!
...
* xref:app:best-practices.adoc#[Unternehmenskennzahlen einsehen]
