...
Die plentymarkets App stellt außerdem Funktionen für die mobile Warenwirtschaft sowie das Kassensystem plentyPOS bereit. Wenn du diese weiterführende Funktionen nutzen möchtest, empfehlen wir dir ein link:https://www.plentypos.de/[zusätzliches Hardware-Package^]{nbsp}icon:external-link[] zu buchen.
...
====
Die plentymarkets App ist in dem Sinne geschützt, dass Nutzer:innen sich <<app/installation#1200, mit Zugangsdaten in die App einloggen>> müssen. Da die App aber vertrauliche Geschäftsdaten enthalten kann, solltest du dir ein paar Gedanken zur Sicherheit machen. Dürfen Mitarbeiter:innen die App auch auf ihren privaten Smartphones nutzen? Werden Endgeräte mit einer Geheimzahl gesperrt? Verschaffe dir zunächst einen Überblick über die Datenschutzrichtlinien deiner Firma.
====

[#600]
== App-Zugang gewähren

Die App ist nur in Kombination mit link:https://www.plentymarkets.com/de/[einem gebuchten plentymarkets System^]{nbsp}icon:external-link[] funktionsfähig. Das heißt, dass Nutzer:innen sich mit den Zugangsdaten eines gebuchten plentymarkets Systems anmelden müssen.
...
Haben alle deine Mitarbeiter:innen bereits ein plentymarkets Konto? Falls nicht, logge dich in dein plentymarkets System ein und <<business-entscheidungen/benutzerkonten-zugaenge#10, erstelle die nötigen Konten>>.

Deine Mitarbeiter:innen werden sich später mit dem Benutzernamen und Passwort des Systems auch <<app/installation#1200, in der App einloggen>>.
...
Willst du selbst bestimmen, welche Funktionen und Menüs sichtbar sein sollen, empfehlen wir, einen Backend-Zugang zu erstellen.
====
...
*_Hinweis:_* *Admin*-Benutzer:innen verfügen immer über alle Berechtigungen. Somit ist es nicht möglich, die App-Berechtigungen für Admins anzupassen.
. Öffne das Tab *Mobile*.
. Aktiviere Funktionen oder Kennzahlen, die dem Benutzerkonto in der App zur Verfügung stehen sollen. Beachte dazu die Erläuterungen in <<table-app-rights>>.
...
|Welche <<app/funktionen#, App-Funktionen>> sollen deine Mitarbeiter:innen sehen können? Setze Häkchen und bestimme somit die genaue Menüpunkte, die für dieses Nutzerkonto sichtbar sein sollen.

| *Einbuchung*
|Sollen deine Mitarbeiter:innen beim <<app/funktionen/lagerverwaltung/einbuchen-umbuchen#, Einbuchen>> den Einkaufspreis sehen und bearbeiten können? Setze Häkchen, um die Berechtigungen zu vergeben. +
...
| *POS-Funktionen*
|Welche <<pos#, POS-Funktionen>> sollen deine Mitarbeiter:innen nutzen können? Setze Häkchen und bestimme somit die genauen Funktionen, die mit dem Backend-Benutzerkonto verwendet werden dürfen. +
...
|Welche <<app/funktionen/best-practices#, Geschäftskennzahlen>> sollen deine Mitarbeiter:innen sehen können? Setze Häkchen und bestimme somit die genauen Daten, die sichtbar sein sollen.
|====
...
| *Neue App-PIN*
a|include::_textblocks/benutzerrechte/app-pin.adoc[]
...
In deiner link:https://www.plentymarkets.com/de/produkt/preise/[plentymarkets Edition^]{nbsp}icon:external-link[] wird festgelegt, wie viele Benutzerkonten gleichzeitig in plentymarkets eingeloggt sein dürfen. Dieses Limit gilt für dein plentymarkets Backend und für die plentymarkets App.

Das kannst du tun, wenn du das Benutzerlimit erreichst:

* Fordere eingeloggte Nutzer:innen auf, sich manuell auszuloggen.
* <<business-entscheidungen/benutzerkonten-zugaenge#170, Logge Benutzerkonten über die Session-Verwaltung aus>>.
* <<business-entscheidungen/benutzerkonten-zugaenge#190, Erhöhe das Benutzerlimit deines plentymarkets Vertrags>>.
...
Die plentymarkets App ist nur in Kombination mit link:https://www.plentymarkets.com/de/[einem gebuchten plentymarkets System^]{nbsp}icon:external-link[] funktionsfähig. Das heißt, dass du bei der Anmeldung die Zugangsdaten deines gebuchten plentymarkets Systems eingeben musst.
...
| *Benutzer*
|Mit welchem Benutzerkonto möchtest du dich einloggen? Gib den <<business-entscheidungen/benutzerkonten-zugaenge#30, Benutzernamen deines Kontos>> ein.
...
| *Passwort*
|Gib das <<business-entscheidungen/benutzerkonten-zugaenge#30, Passwort deines Kontos>> ein.
|====
...
* Das Stiftsymbol (icon:pencil[role="blue"]) oben rechts. Tippe auf dieses Symbol, um <<app/funktionen/best-practices#, Geschäftszahlen wie Umsätze und Auftragsvolumen>> auf deiner Startseite einzurichten.

* Das Menüsymbol (icon:bars[role="blue"]) oben links. Tippe auf dieses Symbol, um in das Hauptmenü zu gelangen. Von hier aus kannst du deine <<app/funktionen/artikelsuche#, Artikel-, Kunden- und Auftragsdaten>> einsehen. Du kannst die App für deine <<app/funktionen/lagerverwaltung#, Warenwirtschaft im Lager nutzen>>. Oder du kannst in deinem <<pos#, stationären Laden kassieren>>.
...
* Das Benutzersymbol (icon:user[role="blue"]). Dieses Symbol zeigt an, welches Benutzerkonto gerade angemeldet ist. Tippe auf dieses Symbol, um den <<app/installation#1600, Bildschirm zu sperren>>, das <<app/installation#1700, das Benutzerkonto zu wechseln>> oder <<app/installation#1500, dich gänzlich auszuloggen>>. +
...
Im plentymarkets Backend kannst du Vorlagen für einige App-Funktionen erstellen. Du kannst beispielsweise bestimmen, wie deine <<app/funktionen/artikelsuche#, Artikel- und Auftragsdaten>> in der App dargestellt werden oder wie deine mobilen Picklisten aussehen sollen.
...
Scrolle nach oben und unten durch <<app/installation#1900, die neu erstellte Vorlage>>. Siehst du die beiden Überschriften? Jede Überschrift entspricht einer anderen Ansicht. Beispielsweise könnte ein Bereich bestimmen, wie Informationen in einer Liste von Suchergebnissen angezeigt werden, und der andere Bereich könnte die Detailansicht bestimmen.
...
* <<app/funktionen/artikelsuche#400, Artikeletiketten über die plentymarkets App auszudrucken>>
* <<pos/pos-einrichten#1000, Belege auf deinem lokalen Drucker anstatt auf einem Bondrucker auszudrucken>>
* link:https://marketplace.plentymarkets.com/plugins/integration/plentybaseitemcachepos_6313[weiterhin mit plentyPOS zu kassieren, auch wenn das Internet ausfällt^]{nbsp}icon:external-link[]
* link:https://marketplace.plentymarkets.com/plugins/integration/plentybasecustomerdisplaypos_6359[deinen Kunden Informationen über die POS-Transaktion auf einem Monitor zu zeigen^]{nbsp}icon:external-link[]
...
. Lade die link:https://marketplace.plentymarkets.com/plugins/integration/plentybase_5053[Installationsdateien für plentyBase^]{nbsp}icon:external-link[] auf deinen Rechner herunter.
. Installiere plentyBase auf deinem Rechner. Konfiguriere dabei die Einstellungen wie in der <<automatisierung/prozesse/plentybase-installieren#, Dokumentation zu plentyBase>> beschrieben. +
...
. Konfiguriere die Einstellungen wie in der <<automatisierung/prozesse/plentybase-installieren#, Dokumentation zu plentyBase>> beschrieben.
. Tippe auf das Häkchen oben rechts (icon:check[role="blue"]), um die Änderung zu bestätigen.

[#2100]
== App aktualisieren

Wartest du sehnsüchtig auf ein neues Feature? Wir informieren dich gerne über Änderungen an der Software. Versionen der plentymarkets App sind durch Versionsnummern gekennzeichnet. Änderungen werden zudem in einem Changelog veröffentlicht. link:https://forum.plentymarkets.com/c/changelog/changelog-app[Abonniere den Changelog^]{nbsp}icon:external-link[] und bleibe immer auf dem Laufenden.
...
--
Achte darauf, dass du die <<app/installation#1200, Basis-URL deines plentymarkets Systems>> richtig einträgst.
