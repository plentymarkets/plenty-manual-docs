...
Willst du selbst bestimmen, welche Funktionen und Menüs sichtbar sein sollen, empfehlen wir, Rollen für Benutzer zu erstellen, ohne eine der Optionen *Admin* oder *API-Nutzer* zu aktivieren. Diesen Rollen kannst du später die benötigten Rechte separat zuweisen.
====
