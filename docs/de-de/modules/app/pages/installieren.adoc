...
Die plentymarkets App stellt außerdem Funktionen für die mobile Warenwirtschaft sowie das Kassensystem plentyPOS bereit. Wenn du diese weiterführende Funktionen nutzen möchtest, empfehlen wir dir ein link:https://plentypos.plentymarkets.com/[zusätzliches Hardware-Paket^]{nbsp}icon:external-link[] zu buchen.
...
|Welche xref:app:funktionen.adoc#[App-Funktionen] sollen deine Mitarbeiter:innen sehen können? Setze Häkchen und bestimme somit die genaue Menüpunkte, die für dieses Nutzerkonto sichtbar sein sollen.
...
* Das Menüsymbol (icon:bars[role="blue"]) oben links. Tippe auf dieses Symbol, um in das Hauptmenü zu gelangen. Von hier aus kannst du deine <<app/funktionen/artikelsuche#, Artikel-, Kunden- und Auftragsdaten>> einsehen. Du kannst die App für deine xref:app:lagerverwaltung.adoc#[Warenwirtschaft im Lager nutzen]. Oder du kannst in deinem <<pos#, stationären Laden kassieren>>.
