...
Bevor du <<app/funktionen/lagerverwaltung/verräumen#300, mit dem Verräumen beginnen kannst>>, musst du einmalig ein paar Einstellungen in der plentymarkets App vornehmen. Diese Einstellungen bestimmen, welche Lagerorte für die Verräumung in Frage kommen und wie deine Artikel in der App dargestellt werden.
...
|Wo befinden sich deine Artikel, bevor sie verräumt werden? Wähle das passende xref:warenwirtschaft:lager-einrichten.adoc#500[Lagerort-Zwecke] ein- oder auszuschließen. +
...
*Lagerortvorschlag* = Lagerorte, die xref:warenwirtschaft:wareneingaenge-verwalten.adoc#200[mit einer Variante verknüpft] sind. +
