...
| *Artikeletikett*
|Willst du Artikeletiketten über die plentymarkets App drucken? Wähle das <<artikel/einstellungen/barcodes#800, Artikeletikett, das du für diesen Zweck gestaltet hast>>. +
...
* <<app/installation#2050, plentyBase herunterladen und mit der App verbinden>>
* <<artikel/einstellungen/barcodes#800, Etiketten mit Hilfe von Vorlagen gestalten>>
...
Neben der Möglichkeit, deine <<app/funktionen/artikelsuche#1100, Suchergebnisse mit Hilfe von Filtern einzugrenzen>>, kannst du auch deine am häufigsten verwendeten Suchkriterien speichern, damit du die Filterparameter nicht bei jeder Suche neu eingeben musst.
====
