...
Wenn du nach der Bestandszählung alle Bestandsabweichungen auf einmal prüfen möchtest, nutze den xref:daten:stock.adoc#[Stock]. Führe nach Abschluss der Inventur einen weiteren Export durch und vergleiche die Bestandsdaten.
