...
====
Rollen vom Typ *Admin* verfügen bereits über alle Rechte und die jeweiligen Konten müssen nicht angepasst werden. Alle anderen Konten hingegen verfügen nicht automatisch über Rechte.
====
