...
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Optionen *Mobile » Einbuchung » Bearbeiten* und *Mobile » Einbuchung » Betrachten*.
...
. Öffne die gewünschte Rolle.
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Mobile » Umbuchung » Betrachten*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
