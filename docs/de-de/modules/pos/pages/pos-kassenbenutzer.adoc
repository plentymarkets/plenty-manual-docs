...
:lang: de
:author: team-mobile
:keywords: POS Auftrag stornieren, Kassieren, plentyPOS personalisieren, POS Retoure, Einlage, Entnahme, Zwischenbericht, Tagesabschluss, Kassensturz, POS Kartenzahlung, Anzahlung, Rechnungskauf, POS Rechnung, POS Barzahlung, POS sperren, POS Favoriten, POS Benutzer wechseln
:position: 20
...
|Sprache
|Sprache wählen, in der plentyPOS dargestellt werden soll. Die Benutzeroberfläche von plentyPOS ist auf Deutsch und Englisch verfügbar.
...
Beachte beim Hinzufügen von Artikeln jedoch die folgenden Hinweise und Einschränkungen:

* Varianten, an denen <<warenwirtschaft/mhd-charge-verwalten#, Informationen zur Mindesthaltbarkeit oder eine Chargennummer>> gepflegt sind, können über die Artikelsuche nicht gefunden werden.

* <<artikel/einstellungen/eigenschaften#500, Varianten mit Bestelleigenschaften>> (ab App-Version 1.11.8 verwendbar) unterliegen in plentyPOS Einschränkungen. Gehe wie unten beschrieben vor>>, um diese Varianten trotzdem in plentyPOS sichtbar zu machen.
...
====
Kaufen Kund:innen in deinem Webshop Varianten mit Bestelleigenschaften und holen diese anschließend in deinem Ladengeschäft ab? Für diesen Anwendungsfall ist die oben beschriebene Einstellung nicht relevant. Bei diesen so genannten <<pos/pos-online-bestellungen#, Click & Collect-Aufträgen>> werden Bestelleigenschaften schon jetzt vollständig in plentyPOS berücksichtigt und angezeigt. Dies gilt auch für Retouren zu Click & Collect-Aufträgen, die du über plentyPOS anlegst, falls Kund:innen Varianten zurückgeben. +
...
.Auftrag stornieren
====
Du kannst einen POS-Auftrag direkt stornieren, nachdem du die Zahlung gebucht hast. Tippe dazu in der Ansicht *Auftrag erstellt* auf *Auftrag stornieren*. Bereits abgeschlossene Aufträge, die seit dem letzten Tagesabschluss über die Kasse erstellt wurden, stornierst du über das Menü <<pos/pos-kassenbenutzer#173, POS » Auftrag stornieren>>.
====
...
Wenn im plentymarkets Backend das Plugin link:https://marketplace.plentymarkets.com/plugins/payment/PosInvoice_5590[plentyPOS Kauf auf Rechnung^]{nbsp}icon:external-link[] aktiviert ist, kannst du auch Artikel auf Rechnung verkaufen. Über plentyPOS können aber keine neuen Kundendaten erfasst werden. Kund:innen können Artikel also nur auf Rechnung kaufen, wenn ihre Kundendaten im System gespeichert sind.
...
Mit plentyPOS kannst du unkompliziert Anzahlungen entgegennehmen. Dies ist zum Beispiel bei Artikeln mit hohen Verkaufspreisen oder bei Ware, die speziell für Kund:innen angefertigt wird, sinnvoll. Dazu muss im plentymarkets Backend das Plugin link:https://marketplace.plentymarkets.com/plugins/payment/PosInvoice_5590[plentyPOS Kauf auf Rechnung^]{nbsp}icon:external-link[] aktiviert sowie bereits ein Kontaktdatensatz für die betreffenden Kund:innen vorhanden sein.
...
====
Im Folgenden wird beschrieben, wie du Anzahlungen für Aufträge entgegennimmst, die ursprünglich direkt an der Kasse entstehen. Für Aufträge anderer Herkünfte oder <<pos/pos-kassenbenutzer#450, Click & Collect>> kann diese Methode nicht genutzt werden.
====
...
Manchmal ist es nötig, abgeschlossene Transaktionen zu finden und weiter zu bearbeiten. Beispielsweise ist es sinnvoll, den ursprünglichen Kaufvorgang zu finden, wenn Kund:innen bereits gekaufte Artikel <<pos/pos-kassenbenutzer#175, retournieren>> oder wenn Artikel <<pos/pos-online-bestellungen#, online bestellt und im Laden abgeholt>> werden.
...
Gib die Auftrags-ID oder Belegnummer in das Suchfeld ein. Tippe auf *Suchen*, um die Auftragsdaten abzurufen. Nun kannst du die <<pos/pos-kassenbenutzer#370, Retoure abschließen>> oder die <<pos/pos-online-bestellungen#, online bestellte Ware>> aushändigen.

[#520]
==== Auftrag automatisch abrufen

Wenn du Aufträge automatisch abrufen möchtest, müssen <<pos/pos-einrichten#120, Barcodes auf deinen Kaufbelegen>> vorhanden sein. Öffne zunächst den POS-Warenkorb oder die Auftragssuche.
...
Scanne den Barcode auf dem Kaufbeleg. Nun kannst du die <<pos/pos-kassenbenutzer#370, Retoure abschließen>> oder die <<pos/pos-online-bestellungen#, online bestellte Ware>> aushändigen.
...
**__Tipp:__** Wenn du mehr als einen Gutschein als Menge wählst, wird dieser Schritt übersprungen.
...
====
Über eine <<pos/pos-einrichten#70, Ereignisaktion>> kann der Beleg als Anhang per E-Mail an den Kontakt gesendet werden, sobald ein Beleg generiert wird. Bei POS-Aufträgen, die du im Offline-Modus abschließt, wird der Beleg jedoch erst versendet, wenn die POS-Aufträge hochgeladen werden.
====

[#137]
==== Kund:innen per Kundenkarte auswählen

Den Kontaktdatensatz für das Kassieren kannst du auch auswählen, wenn du Kundenkarten mit Barcodes scannst. Weitere Informationen zur Beschaffung von Kundenkarten findest du auf der Handbuchseite <<pos/pos-einrichten#990, plentyPOS einrichten>>.
...
====
Bei mehreren Artikeln wird die Rabattsumme auf alle <<artikel/artikel-verwalten#40, rabattfähigen Artikeln>> aufgeteilt. Ein Artikel ist _nicht-rabattfähig_ wenn im Tab *Global* die Option *Aktionsgutschein/POS-Rabatt* auf *Verboten* steht.
...
====
<<pos/pos-online-bestellungen#, Click & Collect-Aufträge>> entstehen nicht in plentyPOS selbst, sondern werden aus anderen Herkünften, wie z.B. dem Webshop, in plentyPOS geladen. Daher darfst du diese Aufträge nur im Backend deines plentymarkets Systems stornieren.
====
...
*_Hinweis:_* Hast du die Stornierung während des Offline-Modus durchgeführt, ist die Stornierung erst nach erfolgter Synchronisierung im plentymarkets Backend sichtbar. Diese findet automatisch im Hintergrund statt, sobald wieder eine Internetverbindung verfügbar ist.
...
====
Beachte bei den folgenden Anleitungen, dass die Erstattung von <<#385, Retourenbeträgen mittels Kartenterminal>> erst in App-Version 1.11.7 und höher möglich ist.
====

[#370]
=== Retoure mit Zuordnung zum Hauptauftrag buchen

Wenn du die Auftrags-ID oder die Belegnummer (externe Auftragsnummer) des ursprünglichen Hauptauftrags kennst, rufe diesen Hauptauftrag auf und wickele die Retoure über diesen Auftrag ab. Gehe wie unten beschrieben vor, um den Hauptauftrag zu öffnen und die Retourenartikel entweder zu <<#330, scannen>> oder <<#340, manuell zu erfassen>>.
...
. *_Optional:_* Füge eine <<pos/pos-kassenbenutzer#100, Notiz zur Retoure hinzu>>.
...
→ <<#350, Entferne die Artikel aus der Retoure, die nicht zurückgegeben werden sollen.>> +
...
. *_Optional:_* Wähle einen anderen Ziellagerort für den Artikel: +
 ...
 → Der Ziellagerort wird geändert. +
 *_Tipp:_* Über die Option *Ziellagerorte ändern* im Menü oben rechts änderst du die Ziellagerorte aller Retourenartikel gleichzeitig.
 . *_Optional:_* Passe <<pos/pos-kassenbenutzer#140, den Preis des Artikels an>>.
 . *_Optional:_* Füge eine <<pos/pos-kassenbenutzer#100, Notiz zur Retoure hinzu>>.
...
Ab Version 1.11.7 der plentymarkets App kannst du Retourenbeträge nicht nur als Gutschein oder in bar erstatten, sondern auch über ein angebundenes Kartenterminal auf die EC-Karten deiner Kund:innen. Diese Erstattungsart ist für Retouren <<#370, mit>> und <<#380, ohne>> Zuordnung zum Hauptauftrag verfügbar.
...
. Tippe im Menü *POS* auf *Retoure*. +
→ Die Retourenansicht wird geöffnet.
. *_Optional:_* <<pos/pos-kassenbenutzer#500, Finde den Auftrag>>. +
→ Die Auftragsdaten werden angezeigt. +
. Füge die Retourenartikel per Scan oder über die Artikelsuche hinzu. +
. *_Optional:_* Passe <<pos/pos-kassenbenutzer#140, die Artikelpreise an>>.
. *_Optional:_* Füge eine <<pos/pos-kassenbenutzer#100, Notiz zur Retoure hinzu>>.
. Wenn du alle Retourenartikel eingegeben hast, tippe auf den grün hinterlegten Pfeil. +
→ Die Gesamtsumme der Retoure wird angezeigt.
...
Wenn du mit plentyBase und Etikettendruckern arbeitest, kannst du in der Artikelsuche der plentymarkets App auch <<app/funktionen/artikelsuche#400, Artikeletiketten drucken>>.
...
**__Hinweis:__** Wenn der Menüpunkt ausgegraut ist, benötigst du zusätzliche <<pos/pos-einrichten#170, Berechtigungen>>, um Zwischenberichte zu erstellen. +
...
====
Tagesabschlussberichte werden im plentymarkets Backend gespeichert. Öffne das Menü <<auftraege/dokumentenarchiv#_archivierte_pdf_dokumente_suchen, Aufträge » Dokumentenarchiv>>. Filtere nach dem Dokumenttyp *Tagesabschluss*. In der Spalte *Datei* kann der Bericht als PDF-Datei heruntergeladen werden.
====
...
**__Hinweis:__** Wenn der Menüpunkt ausgegraut ist, benötigst du zusätzliche <<pos/pos-einrichten#170, Berechtigungen>>, um Tagesberichte zu erstellen. +
...
. **__Optional:__** Tippe auf **Kassensturzbericht drucken**, um den Bericht zu drucken.
