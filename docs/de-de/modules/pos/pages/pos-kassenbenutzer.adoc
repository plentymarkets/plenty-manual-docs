...
====
Tagesabschlussberichte werden im plentymarkets Backend gespeichert. Öffne das Menü <<auftraege/dokumentenarchiv#100, Aufträge » Dokumentenarchiv>>. Filtere nach dem Dokumenttyp *Tagesabschluss*. In der Spalte *Datei* kann der Bericht als PDF-Datei heruntergeladen werden.
====
