...
:lang: de
:author: team-mobile
:keywords: App Demo, Demo-Modus, plentyPOS Test, App Test, plentyPOS testen, plentymarkets App testen
...
.Empfohlene Hardware
====
Gerne können wir dir <<app/installation#400, Hardware für das Kassensystem plentyPOS empfehlen>>. Grundsätzlich werden jedoch Android-Geräte mit OS-Version ab 5.1 und iOS-Geräte mit OS-Version ab 11 unterstützt.
====
...
* <<pos/demo#500, Artikel zu erfassen>>
* <<pos/demo#1300, Gutscheine zu verkaufen und einzulösen>>
* <<pos/demo#2700, Diversartikel zu verkaufen>>
* <<pos/demo#2800, An Stammkund:innen zu verkaufen>>
====
...
a| image::pos/assets/tablet-ansicht-POS-warenkorb.png[]
a| image::pos/assets/handy-ansicht-POS-warenkorb.png[]
...
Genau wie bei jedem anderen Artikel, fügst du Geschenkgutscheine zum POS-Warenkorb hinzu indem du <<pos/demo#500, den Barcode scannst>>, ihn <<pos/demo#500, aus der Favoriten-Liste wählst>> oder indem du seine <<pos/demo#500, Artikelnummer manuell eingibst>>.
...
--
Kund:innen können für ihre Artikel mit Geschenkgutscheinen bezahlen. Nachdem du <<pos/demo#500, alle gewünschten Artikel wie gewohnt erfasst hast>>, akzeptierst du die Zahlung ganz oder teilweise mit einem Geschenkgutschein.
...
Nachdem du <<pos/demo#500, alle gewünschten Artikel wie gewohnt erfasst hast>>, ziehst du den Wert der Coupons von der zu zahlenden Summe ab.
...
Genau wie bei jedem anderen Artikel, erfasst du Dummy-Artikel indem du <<pos/demo#500, den Barcode scannst>>, ihn <<pos/demo#500, aus der Favoriten-Liste wählst>> oder indem du seine <<pos/demo#500, Artikelnummer manuell eingibst>>.
