...
Genau wie bei jedem anderen Artikel, fügst du Geschenkgutscheine zum POS-Warenkorb hinzu indem du xref:pos:demo.adoc#500[Artikelnummer manuell eingibst].
...
Genau wie bei jedem anderen Artikel, erfasst du Dummy-Artikel indem du xref:pos:demo.adoc#500[Artikelnummer manuell eingibst].
