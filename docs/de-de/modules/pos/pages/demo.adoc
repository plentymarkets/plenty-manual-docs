...
.Empfohlene Hardware
====
Gerne können wir dir xref:app:installation.adoc#400[Hardware für das Kassensystem plentyPOS empfehlen]. Grundsätzlich werden jedoch Android-Geräte mit OS-Version ab 6.0 und iOS-Geräte mit OS-Version ab 11 unterstützt.
====
