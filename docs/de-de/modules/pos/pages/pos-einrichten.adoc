...
Nachdem du Kassen gebucht hast, dauert es zunächst einige Minuten, bis der Buchungsprozess im Hintergrund abgeschlossen ist. Logge dich dann aus deinem plentymarkets System aus und wieder ein. Dieser Schritt ist auch notwendig, wenn du bereits Kassen eingerichtet hast und im Nachhinein eine oder mehrere neue Kassen hinzubuchst.
...
*_Hinweis:_* Existierende Kassen können nicht nachträglich manipulationssicher gemacht werden. Erstelle eine neue Kasse erstellen und nimm die vorherige Kasse außer Betrieb, um die Sicherheitseinrichtung in Betrieb zu nehmen.
|====
...
| *Land*
|Wäle das Land aus der Dropdown-Liste, in dem die Kasse eingesetzt wird. Die Standardeinstellung richtet sich nach der Option *Land* im Menü xref:willkommen:schnelleinstieg-basiseinstellungen.adoc#100[Einrichtung » Einstellungen » Stammdaten].
...
| *Mandant*
|Wähle den Mandant, der der Kasse zugeordet ist.
...
* Kontaktdatensätze verwaltest du im Backend deines plentymarkets Systems. xref:crm:kontakte-verwalten.adoc#100[Füge neue Kontakte hinzu] oder nutze die Suche im Menü *CRM » Kontakte*, um die Kontakt-IDs der Kund:innen einzusehen, für die du Kundenkarten drucken möchtest.
...
* [ ] Das Tool link:https://knowledge.plentymarkets.com/automatisierung/prozesse/plentybase-installieren[plentyBase^] muss auf deinem Rechner installiert sein und ausgeführt werden
* [ ] Die link:https://knowledge.plentymarkets.com/app/installation#2050[Verbindungsdaten für plentyBase^] müssen in der plentymarkets App gespeichert seind
