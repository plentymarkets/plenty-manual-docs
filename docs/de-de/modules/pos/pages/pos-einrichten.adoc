...
Das Kassensystem plentyPOS wird über die xref:app:installation.adoc#[plentymarkets App] bereitgestellt. Wirf einen Blick in unsere Dokumentation und lerne:

* welche xref:app:installation.adoc#400[Hardware-Voraussetzungen] für plentyPOS bestehen.
* wo du die kostenlose xref:app:installation.adoc#500[plentymarkets App herunterladen] kannst.
* wie du deinen Mitarbeiter:innen xref:app:installation.adoc#600[Zugang zur App] gewährst.
* wie du dich in die App xref:app:installation.adoc#1100[einloggst und zurechtfindest].
...
Anschließend richtest du die Kassen im plentymarkets Backend ein. Zunächst weist du die Kassen einem Mandanten zu, indem du die Kasse im Menü *Einrichtung » POS » Mandant » [Mandant wählen\] » [POS wählen\]* erstellst und weitere Einstellungen vornimmst. Gehe dazu wie unten beschrieben vor.
...
. Öffne das Menü *Einrichtung » POS » Mandant » [Mandant wählen\]*.
...
. Öffne das Menü *Einrichtung » POS » Mandant » [Mandant wählen\] » [POS wählen\]*.
. Öffne die Kasse.
...
Damit neues Kassenpersonal Zugriff auf plentyPOS erhält, erstelle zunächst im plentymarkets Backend xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#[Benutzerkonten] der Benutzerklasse *Backend* für diese Personen. Gehe dazu wie unten beschrieben vor.
...
:right-two: pass:quotes[*CRM > Kampagne > Code > Anzeigen*]
...
:right-six: pass:quotes[*Aufträge > Anzeigen*]
:right-seven: pass:quotes[*Aufträge > Erstellen*]
:right-eight: pass:quotes[*Warenbestände > Lager > Lagerort > Anzeigen*]
...
→ Eine Liste der verfügbaren Auftragsherkünfte wird angezeigt. Dabei wird jede verfügbare Kasse wird als separate Auftragsherkunft aufgelistet.
...
. Öffne das Menü *Einrichtung » Einstellungen » Benutzer » Konten » Benutzer öffnen*.
...
*_Hinweis:_* Beachte die Informationen im Bereich *Beschreibung* des Plugins.
...
====
Stelle für die Zahlungsart *11 » Barverkauf/EC-Karte* außerdem im Menü *Einrichtung » POS » Mandant » [Mandant wählen\] » [POS wählen\] » Tab: Zahlungsart* die Option *Ohne Anbindung* im Bereich *EC-Terminal* ein.
====
...
|Einrichtung » POS » Mandant » [Mandant wählen\] » [Kasse öffnen] » Tab: Beleg
|Identische Auftragspositionen
a|
* Einzeln darstellen
* Zusammenfassen
...
. *Speichere* (icon:save[role="darkGrey"]) die Einstellungen.
. Öffne das Menü *Einrichtung » POS » Mandant » [Mandant wählen\] » [Kasse öffnen] » Grundeinstellungen*.
...
2+^| *Einrichtung » POS » Mandant » [Mandant wählen\] » [Kasse öffnen]*

| *Preisabfrage wenn Artikelpreis 0*
|Aktiviere die Option.

2+^| *Einrichtung » Einstellungen » Benutzer » Konten » [Konto öffnen] » Tab: Mobile » POS-Funktionen*
...
Personen mit Admin-Rechten haben standardmäßig die Berechtigungen, Mehrzweckgutscheine zu erstellen. Benutzern der Benutzerklasse *Backend* müssen diese Berechtigungen separat erteilt werden.

:rights-purpose: Gutscheine verkaufen können
:right-one: pass:quotes[*CRM > Kampagne > Code > Anzeigen*]
