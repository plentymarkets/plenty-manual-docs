...
Mit dem mobilen Kassensystem plentyPOS integrierst du den stationären Handel mühelos in plentymarkets. Das Kassensystem plentyPOS wird über die xref:app:installation.adoc#[plentymarkets App] bereitgestellt.
...
====
.Kasse buchen
Um plentyPOS verwenden zu können, link:https://www.plentymarkets.com/de/produkt/preise/[buche zunächst eine oder mehrere Kassen^] für deine plentymarkets Edition. Informationen zu den Konditionen findest du direkt bei der Buchung oder auf der link:https://www.plentymarkets.com/de/produkt/module/point-of-sale/[plentyPOS Produktseite^]{nbsp}icon:external-link[].
====
...
. Installiere das Plugin link:https://marketplace.plentymarkets.com/pospaymentmethodrenaming_6813[plentyPOS Zahlungsarten^]{nbsp}icon:external-link[]. +
...
* link:https://marketplace.plentymarkets.com/plugins/payment/ingenicozvt_5140[Ingenico-Geräte über ZVT-Schnittstelle^]{nbsp}icon:external-link[]
* link:https://marketplace.plentymarkets.com/plugins/payment/sumup_5141[SumUp Air^]{nbsp}icon:external-link[]
* link:https://marketplace.plentymarkets.com/plugins/payment/VerifoneZVT_5504[Verifone-Geräte über ZVT-Schnittstelle^]{nbsp}icon:external-link[]
* link:https://marketplace.plentymarkets.com/zettle_54918[Zettle by PayPal^]{nbsp}icon:external-link[]
...
* link:https://marketplace.plentymarkets.com/plugins/payment/PosInvoice_5590[POS Kauf auf Rechnung^]{nbsp}icon:external-link[]
...
| **Land**
|Land aus der Dropdown-Liste wählen, in dem die Kasse eingesetzt wird. Standardeinstellung richtet sich nach der Option **Land** im Menü <<willkommen/schnelleinstieg/schnelleinstieg-basiseinstellungen#100, Einrichtung » Einstellungen » Stammdaten>>.
...
* Beschaffe dir link:http://lmgtfy.com/?q=Barcode-Karten+Druck[Barcode-Karten^]{nbsp}icon:external-link[] mit vorgefertigten Codes. Die meisten Anbieter erwarten eine CSV-Datei, die die einzelnen Codes enthält, die auf den Karten platziert werden sollen, sowie eine Layout-Vorlage im Photoshop- oder Adobe-Illustrator-Format für das Rahmendesign.
...
→ Die Installationsdatei lädst du im link:https://marketplace.plentymarkets.com/plugins/integration/plentyBase_5053[plentyMarketplace^]{nbsp}icon:external-link[] herunter.
