...
Nachdem du Kassen gebucht hast, dauert es zunächst einige Minuten, bis der Buchungsprozess im Hintergrund abgeschlossen ist. Logge dich dann aus deinem plentymarkets System aus und wieder ein.
