...
| *Einkaufspreis*
|Aktiviere (icon:check-square[role="blue"]) diese Option, um in der Kassieransicht den xref:artikel:import-export-anlage-verzeichnis.adoc#intable-ek-netto[Einkaufspreis] anzuzeigen.
