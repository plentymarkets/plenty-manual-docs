...
. *Speichere* (icon:save[role="darkGrey"]) die Einstellungen.
. Öffne das Menü *Einrichtung » Mandant » [Mandant wählen] » POS » [Kasse öffnen] » Grundeinstellungen*.
...
2+^| *Einrichtung » Mandant » [Mandant wählen] » POS » [Kasse öffnen]*
...
. Öffne das Menü *Einrichtung » Mandant » Standard » POS*.
