...
Option aktiviert = In der Kasse sind nur Varianten verfügbar, für die im Tab *Einstellungen* der Variante die Option xref:artikel:artikel-verwalten.adoc#230[Aktiv] aktiviert ist. +
