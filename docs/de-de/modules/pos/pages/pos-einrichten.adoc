...
Nimm nun im Tab *Grundeinstellungen* der neu erstellten Kasse die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<table-POS-basic-settings>>.
