...
Mit dem mobilen Kassensystem plentyPOS integrierst du den stationären Handel mühelos in plentymarkets. Das Kassensystem plentyPOS wird über die <<app/installation#, plentymarkets App>> bereitgestellt.
...
Das Kassensystem plentyPOS wird über die <<app/installation#, plentymarkets App>> bereitgestellt. Wirf einen Blick in unsere Dokumentation und lerne:

* welche <<app/installation#400, Hardware-Voraussetzungen>> für plentyPOS bestehen.
* wo du die kostenlose <<app/installation#500, plentymarkets App herunterladen>> kannst.
* wie du deinen Mitarbeiter:innen <<app/installation#600, Zugang zur App>> gewährst.
* wie du dich in die App <<app/installation#1100, einloggst und zurechtfindest>>.

plentyPOS ist für das Kassieren mit den Währungen Euro (EUR), Schweizer Franken (CHF) und Britische Pfund (GBP) vorbereitet. Du kannst die Kasse allerdings nur in der <<payment/waehrungen#30, Systemwährung>> betreiben. Die Systemwährung legst du im Menü *Einrichtung » Aufträge » Zahlung » Währungen* fest.
...
Option aktiviert = In der Kasse sind nur Varianten verfügbar, für die im Tab **Einstellungen** der Variante die Option <<artikel/artikel-verwalten#230, Aktiv>> aktiviert ist. +
...
Im Falle einer <<pos/pos-kassenbenutzer#175, Retoure>> oder eines <<pos/pos-online-bestellungen#, Click & Collect-Auftrags>> bringen Kund:innen typischerweise ihre Kaufbelege mit in den Laden. Wurde ein Barcode auf dem Beleg gedruckt, muss das Kassenpersonal lediglich <<pos/pos-kassenbenutzer#520, den Barcode scannen>>, um den entsprechenden Auftrag aufzurufen. +
...
====
Um die Rechteverwaltung für Kassenpersonal zu vereinfachen, erstelle eine <<business-entscheidungen/benutzerkonten-zugaenge#70, Rolle>> mit den Berechtigungen, die du Kassenpersonal zuweisen möchtest, und verknüpfe diese Rolle mit den Benutzerkonten des Kassenpersonals.
====

[#140]
=== Konto für Kassenpersonal erstellen

Damit neues Kassenpersonal Zugriff auf plentyPOS erhält, erstelle zunächst im plentymarkets Backend <<business-entscheidungen/benutzerkonten-zugaenge#, Benutzerkonten>> der Benutzerklasse **Backend** für diese Personen. Gehe dazu wie unten beschrieben vor.
...
Damit Kassenpersonal in plentyPOS Preise bearbeiten, Auftragspositionen umbenennen und/oder Rabatte gewähren können, musst du die Berechtigungen dazu zuweisen. Wie du Rollen einrichtest und Benutzern zuweist, erfährst du <<business-entscheidungen/benutzerkonten-zugaenge#70, hier>>. Dort schaltest du auch weitere App-Funktionen für Kassenpersonal frei.
...
| **TSE-Einheit**
|Erlaubt Kassenpersonal, das Menü *TSE-Einheit* in der plentymarkets App zu öffnen. In diesem Menü stehen <<pos/pos-rechtssicherheit#900, Informationen zum Status der technischen Sicherheitseinrichtung>> zur Verfügung. Zudem wird Kassenpersonal mit dieser Berechtigung erlaubt, <<pos/pos-rechtssicherheit#700, TSE-Exporte>> zu erstellen.
...
Beachte auch, dass Zahlungsarten in einem weiteren Schritt für Kundenklassen erlaubt werden müssen. Weitere Informationen findest du unter <<payment/zahlungsarten-verwalten#30, Zahlungsart in Kundenklasse erlauben>>.
...
Du möchtest das Versandprofil für eine größere Anzahl an Artikeln gleichzeitig aktivieren? Dann nutze die <<artikel/import-export-anlage/anlage/massenbearbeitung#100, Artikel-Gruppenfunktion>>.

[#100]
== Preise für Kassenaufträge verwalten

Um POS-Preise für Varianten zu hinterlegen, benötigst du mindestens einen <<artikel/einstellungen/preise#, Verkaufspreis>>, bei dem die POS-Herkunft der Kasse aktiviert ist. Verkaufspreise erstellst und verwaltest du zentral. Preise für Varianten hinterlegst du, indem du Varianten mit dem Verkaufspreis verknüpfst und einen Preis speicherst.
...
====
Abhängig von den gewählten Einstellungen kommt es zu unterschiedlichen Gesamtbeträgen. Dies wirkt sich beispielsweise auf die Berechnung des Umsatzes im Steuerbericht des <<pos/pos-kassenbenutzer#230, Tagesabschlusses>> aus. Beachte, dass sich die Abweichungen potenzieren, je mehr Artikel mit Rundungsbedarf pro Auftrag/Beleg verkauft werden.
====
...
Detaillierte Informationen und weitere Rechnungsbeispiele zum Rundungsverhalten findest du auch auf der Handbuchseite <<auftraege/buchhaltung#150, Buchhaltung>>.

[#95]
== Standardkunden für Kassenaufträge erstellen

Damit Kassenaufträge korrekt in plentymarkets gespeichert werden, muss jedem Auftrag ein Kontakt zugeordnet sein. Dazu erstellst du im plentymarkets Backend einen Kontakt vom Typ **Standardkunde**. Im Folgenden werden nur die Einstellungen werden beschrieben, die für das Erstellen des Standardkunden für Kassenaufträge relevant sind. Allgemeine Informationen zum Erstellen von Kontakten findest du auf der Handbuchseite <<crm/kontakte-verwalten#, Kontakte>>.
...
* Entscheide, <<auftraege/gutscheine#artikel-gutscheinzahlung-vorbereiten, welche Artikel aus deinem Sortiment>> per Gutschein bezahlbar sein sollen.
* <<auftraege/gutscheine#gutscheinartikel-erstellen, Erstelle Gutscheinartikel>> mit 0% MwSt., d.h. füge die kaufbaren Geschenkgutscheine deinem Sortiment hinzu.
* <<auftraege/gutscheine#kampagne-erstellen, Erstelle eine Kampagne>> für deine Gutscheine. Bestimme mit der Option *Gutscheinart*, ob es sich um Mehrzweckgutscheine oder Aktionsgutscheine handelt.
* <<auftraege/gutscheine#gutscheinartikel-mit-kampagne-verknuepfen, Verknüpfe deine Gutscheinartikel mit der Kampagne>>.
* *_Optional:_* <<pos/pos-einrichten#850, Generiere Gutschein-Codes>> oder speichere deine eigenen Gutschein-Codes im Backend.
...
| **Nutzung**
| **Einzelbestellungen**, <<auftraege/scheduler#, Abonnements>> oder beides wählen.
...
* Sofern noch nicht vorhanden, musst du eine <<pos/pos-einrichten#830, geeignete Kampagne>> in plentymarkets erstellen.
* Lege dir einen <<pos/pos-einrichten#2600, Gutscheinartikel mit flexiblem Wert>> für diese Art von Gutscheinen in plentymarkets an.
...
In den Kasseneinstellungen wählst du einen Standard-Reparaturlagerort für Retouren und legst in den Berechtigungen fest, wer Retouren durchführen darf. Wenn du Retourenbeträge nur in bar auszahlen möchtest, sind keine weiteren Einstellungen nötig, um Retouren über plentyPOS abzuwickeln. Beachte die <<pos/pos-einrichten#2000, Hinweise zu Retouren>>. Wenn du die Möglichkeit haben möchtest, den Retourenbetrag als Gutschein auszuzahlen, bereitest du außerdem <<pos/pos-einrichten#3100, Retourengutscheine>> vor.
...
| **Fiskalisierung**
| IP-Adresse der <<pos/pos-rechtssicherheit#500, technischen Sicherheitseinrichtung>>, die mit der Kasse gekoppelt ist.
...
(nur neue Kassen mit Standort Österreich)
|Wählen, um den <<pos/pos-rechtssicherheit#1600, Startbeleg  zu erstellen>> und so die manipulationssichere Sicherheitseinrichtung für die Kasse zu aktivieren. Nachdem der Startbeleg erstellt wurde, kann das Standortland der Kasse nicht mehr geändert werden.

| **Endbeleg erstellen** +
(nur Kassen mit Standort Österreich und aktivierter Sicherheitseinrichtung)
|Wählen, um <<pos/pos-rechtssicherheit#2300, den Endbeleg zu erstellen>> und so die manipulationssichere Sicherheitseinrichtung für die Kasse zu deaktivieren. Nachdem der Endbeleg erstellt wurde, kann die Kasse nicht mehr verwendet werden.
|====
...
Neben dem automatischen Versand von Kassenbelegen kannst du Bestandskund:innen einen weiteren Service anbieten. Kundenkarten mit Barcodes erlauben dir, den Barcode direkt beim <<pos/pos-kassenbenutzer#30, Kassiervorgang>> zu scannen. So wird automatisch ein Kontakt ausgewählt. Wie bei <<#2700, Gutscheinkarten>> wird der Kontakt anhand eines Barcodes auf der Kundenkarte gefunden. Je nach Vorgehensweise kann der Kontakt entweder über die Kontakt-ID oder die Kundennummer gefunden werden. <<table-pos-loyalty-cards>> erläutert beide Vorgehensweisen und beschreibt vorbereitende Schritte zur Erstellung der Kundenkarten.
...
* Kontaktdatensätze verwaltest du im Backend deines plentymarkets Systems. <<crm/kontakte-verwalten#100, Füge neue Kontakte hinzu>> oder nutze die Suche im Menü *CRM » Kontakte*, um die Kontakt-IDs der Kund:innen einzusehen, für die du Kundenkarten drucken möchtest.
...
→ Die Konfigurationsanleitung findest du auf der Handbuchseite <<automatisierung/prozesse/plentybase-installieren#, plentyBase>>. +
...
→ Wie du die plentyBase Verbindungsdaten in der App speicherst, erfährst du auf der Handbuchseite <<automatisierung/prozesse/plentybase-installieren#, plentyBase>>.
...
*_Empfehlung:_* Konfiguriere plentyBase so, dass plentyBase beim Starten des Rechners automatisch gestartet wird.
* Wurde der Drucker im plentymarkets Backend <<automatisierung/prozesse/drucker#, gespeichert und konfiguriert>>?
...
====
Um Etiketten drucken zu können, benötigst du das kostenlose Plugin plentyBase. plentyBase stellt eine Schnittstelle bereit, über die du aus dem plentymarkets Backend und/oder der plentymarkets App die Drucker nutzen kannst, die an den Computer angeschlossen sind. Wie du plentyBase installierst und konfigurierst erfährst du auf der Handbuchseite <<automatisierung/prozesse/plentybase-installieren#, plentyBase>>.
====
...
*_Hinweis:_* Bei Kassen mit Standort Österreich und aktivierter Sicherheitseinrichtung muss der <<pos/pos-rechtssicherheit#2300, Endbeleg in der App>> erstellt werden. Dadurch wird die Kasse automatisch gelöscht.
