...
Wie du Etikettenvorlagen erstellst und Artikeletiketten in der Artikelsuche der plentymarkets App druckst, erfährst du auf der Handbuchseite xref:app:artikelsuche#[Artikel-, Kunden- und Auftragssuche].
...
* xref:pos:pos-online-bestellungen#900[Online-Bestellungen (Click & Collect)] laden und kassieren
