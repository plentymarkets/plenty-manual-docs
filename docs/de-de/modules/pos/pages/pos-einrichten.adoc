...
include::partial$card-terminal-requirements.adoc[]

Bestimmte Kartenterminals können über kostenlose Plugins an plentyPOS angebunden werden. Aktuell unterstützt plentyPOS folgende Anbindungen:
