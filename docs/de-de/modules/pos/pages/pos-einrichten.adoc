...
Im Falle einer xref:pos:pos-kassenbenutzer.adoc#520[den Barcode scannen], um den entsprechenden Auftrag aufzurufen. +
...
| **TSE-Einheit**
|Erlaubt Kassenpersonal, das Menü *TSE-Einheit* in der plentymarkets App zu öffnen. In diesem Menü stehen xref:pos:pos-rechtssicherheit.adoc#700[TSE-Exporte] zu erstellen.
