...
Anschließend richtest du die Kassen im plentymarkets Backend ein. Zunächst weist du die Kassen einem Mandanten zu, indem du die Kasse im Menü *Einrichtung » Mandant » [Mandant wählen] » POS* erstellst und weitere Einstellungen vornimmst. Gehe dazu wie unten beschrieben vor.
