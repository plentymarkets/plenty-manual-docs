...
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Daten » POS » Kassenjournal » Betrachten*.
...
. Öffne die gewünschte Rolle.
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Daten » POS » IDEA-Export » Betrachten*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Klicke auf das Zahnrad (terra:execute[role="darkGrey"]), um den Export zu generieren. +
...
. Öffne die gewünschte Rolle.
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Daten » POS » TSE-Export » Betrachten*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Öffne die gewünschte Rolle.
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Daten » POS » DSFinV-K-Export » Betrachten*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
. Öffne die gewünschte Rolle.
. Klicke auf *Rechte*.
. Aktiviere (icon:check-square[role="blue"]) die Option *Daten » POS » DEP-Export » Betrachten*.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
