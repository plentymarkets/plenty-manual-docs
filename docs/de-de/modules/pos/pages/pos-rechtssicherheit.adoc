...
:right-one: pass:quotes[*Daten > POS > Protokolle*]
...
====
Möchtest du Kassenvorgänge nicht nur exportieren, sondern auch gezielt nach Einträgen im Kassenpersonal suchen, benötigst du als Backend-Benutzer:in zusätzlich das Recht *Aufträge > Anzeigen*.
====
