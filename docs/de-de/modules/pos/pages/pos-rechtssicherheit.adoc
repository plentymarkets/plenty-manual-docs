...
====
Möchtest du Kassenvorgänge nicht nur exportieren, sondern auch gezielt nach Einträgen im Kassenjournal suchen, benötigst du als Backend-Benutzer:in zusätzlich das Recht *Aufträge > Anzeigen*.
====
