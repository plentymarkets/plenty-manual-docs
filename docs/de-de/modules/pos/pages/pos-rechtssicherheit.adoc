...
Registrierkasse (*Einrichtung » POS » Mandant » [Mandant wählen\] » Kasse öffnen » Tab: Grundeinstellungen*): +

* Die Kassenidentifikationsnummer der plentyPOS Kasse. Die **Kassenidentifikationsnummer** findest du im Menü **Einrichtung » POS » Mandant » [Mandant wählen\] » Kasse öffnen » Tab: Grundeinstellungen**.
* Den **Benutzerschlüssel AES-256**, der im Menü **Einrichtung » POS » Mandant » [Mandant wählen\] » Kasse öffnen » Tab: Grundeinstellungen** angezeigt wird.
