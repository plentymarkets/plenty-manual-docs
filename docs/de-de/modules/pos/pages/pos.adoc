...
plentyPOS (*Point of Sale*) ist unser eigens entwickeltes Kassensystem, mit dem du den stationären Handel im Ladengeschäft mühelos abwickelst. Die Funktionalitäten von plentyPOS werden über die link:https://knowledge.plentymarkets.com/app[plentymarkets App^] bereitgestellt. 
...
* link:https://plentypos.plentymarkets.com/[Passende Hardware auswählen^]
...
** xref:pos:pos-online-bestellungen#[Online-Bestellungen an der Kasse abwickeln (Click & Collect)]
** xref:pos:pos-kassenbenutzer.adoc#180[Einlagen und Entnahmen buchen]
** xref:pos:pos-kassenbenutzer#210[Tagesabschluss, Zwischenbericht und Kassensturzbericht erstellen]
