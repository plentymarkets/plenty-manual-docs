...
plentyPOS (*Point of Sale*) ist unser eigens entwickeltes Kassensystem, mit dem du den stationären Handel im Ladengeschäft mühelos abwickelst. Die Funktionalitäten von plentyPOS werden über die link:https://knowledge.plentymarkets.com/de-de/manual/main/app/app.html[plentymarkets App^] bereitgestellt. 
