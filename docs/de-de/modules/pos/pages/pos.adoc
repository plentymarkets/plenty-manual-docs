...
:description: plentyPOS ist das von plentymarkets entwickelte Kassensystem. Die Funktionalitäten von plentyPOS werden über die plentymarkets App bereitgestellt.
