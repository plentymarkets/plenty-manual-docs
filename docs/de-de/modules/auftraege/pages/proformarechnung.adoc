...
====
Damit Angaben zu Zahlungsbedingungen (Valuta, Zahlungsziel, Skonto) auf Proformarechnungen angezeigt werden, müssen diese beim xref:auftraege:auftragsdokumente.adoc#intable-zahlungsbedingungen-dokumente.adoc[Einrichten der Dokumentenvorlage] für Proformarechnungen aktiviert werden.
====
