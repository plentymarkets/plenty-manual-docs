...
Da jeder Gutschein einer Kampagne angehört, muss zuerst eine Kampagne erstellt werden. Kampagnen erstellst du im Menü *Aufträge » Gutscheine*. Bereits erstellte Kampagnen enthalten neben dem Tab *Einstellungen* 2 weitere Tabs: <<#gutschein-codes-generieren, Codes>> und <<#gutscheinvorlage-einrichten, Vorlagen>>.
...
| *Nutzung*
| *Einzelbestellungen* oder xref:auftraege:abonnement-neu.adoc#[Abonnement] oder beides wählen.
...
Um Kampagnen zu suchen, wähle die Suchparameter im Menü *Aufträge » Gutscheine*. In der Standardeinstellung der Filter werden alle Kampagnen gesucht und angezeigt. In der xref:auftraege:order-search.adoc#[Auftragssuche] steht ein Suchfilter für Gutschein-Codes zur Verfügung.
...
Bevor du Gutscheine in deinem Webshop zum Verkauf anbieten kannst, muss die <<#kampagne-erstellen, Gutscheinkampagne>> mit der Gutscheinart *Mehrzweckgutschein* erstellt sein. Weitere Informationen findest du in <<#tabelle-einstellungen-gutscheinkampagne>>.
...
Beachte, dass du die xref:webshop:shop-builder.adoc#97[Bestellbestätigungsseite im ShopBuilder] angelegt und verknüpft hast.
...
====
Damit Gutschein-Codes per Ereignisaktion versendet werden können, benötigst du eine <<#kampagne-erstellen, Gutscheinkampagne>>. Diese musst du am Artikel mittels Freitextfeld hinterlegt haben.
====
