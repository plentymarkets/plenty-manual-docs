...
//MÖGLICHKEIT, PDF-DOKUMENTE ZUSAMMENZUFÜHREN HIER NOCH ERGÄNZEN?
...
// GUTSCHEINE WEITER NACH OBEN VERSCHIEBEN; IN UI NOCH FEHLERHAFTE DARSTELLUNG
=====
...
//TIPP HINZUFÜGEN: FILTEREINSTELLUNGEN ZURÜCKSETZEN
...
//KOMMT HIER NOCH EINE WEITERE GRUPPENFUNKTION HINZU (DOKUMENTE ALS PDF ZUSAMMENFÜHREN)?
...
. Klicke rechts in der Zeile des Dokuments, das du herunterladen möchtest auf *Herunterladen* (material:file_download[]). +
...
//TIPP HINZUFÜGEN, DASS MIT KLICK AUF DAS BURGER-MENU DIE SIDE NAV EIN- UND AUSGEBLENDET WERDEN KANN
