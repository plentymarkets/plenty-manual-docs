...
:right-three: pass:quotes[*Artikel > Variante > Preis > Anzeigen*]
:right-four: pass:quotes[*Artikel > Variante > Preis > Aktualisieren*]
:right-five: pass:quotes[*Aufträge > Auftragsposition > Deckungsbeitrag > Anzeigen*]
