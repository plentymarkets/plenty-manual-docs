...
:right-six: pass:quotes[*Artikel > Variante > Verkaufspreis > Lesen*]
:right-seven: pass:quotes[*Artikel > Variante > Verkaufspreis > Anzeigen (Show)*]
:right-eight: pass:quotes[*Artikel > Variante > Verkaufspreis > Aktualisieren*]
