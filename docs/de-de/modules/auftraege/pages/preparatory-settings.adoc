...
Im folgenden Abschnitt werden die Rechte für alle relevanten Bereiche aufgeführt. Entscheide hier selbst, welche Rechte für Nutzer:innen ohne Adminrechte vergeben werden sollen.
