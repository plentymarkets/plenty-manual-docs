...
| *Status ändern*
|Aufträge > Aktualisieren +
*_Hinweis:_* Kannst du bestimmte Status in der Auftragsübersicht, in den Auftragsdetails oder bei den Gruppen- und Menüfunktionen nicht sehen, benötigst du die jeweiligen Rechte für die *Setzbaren Auftragsstatus*. Bitte einen Admin darum, dir die notwendigen Rechte im Menü *Einrichtung » Einstellungen » Benutzer » Konten » [Konto wählen] » Tab: Berechtigungen* zuzuweisen.
