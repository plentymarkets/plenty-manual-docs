...
. Wählst du die Option *Für bestimmte Artikel*, nimm die Einstellungen vor. Beachte dazu die Erläuterungen in <<table-create-warranty>>.
...
. Öffne die Gewährleistung, die du abschließen möchtest.
...
//IN NEUER UI KANN MAN IN EINER GEWÄHRLEISTUNG KEINE GUTSCHRIFT ANLEGEN
[.instruction]
...
[[table-settings-credit-note]]
.Einstellungen für Gutschriften in Gewährleistungen
[cols="1,3"]
|===
