...
====
Mit der Gruppenfunktion *Nummernkreise öffnen* (material:edit[]) oder *Nummernkreise löschen* (material:delete[]) kannst du alle in der Übersicht gewählten (material:check_box[role=skyBlue]) Nummernkreise auf einmal öffnen oder löschen.
====
