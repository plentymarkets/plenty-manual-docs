...
. Suche anhand der Filtereinstellungen den Auftrag, für den eine Rechnung erzeugt werden soll.
...
. Gib ein Datum ein, das als Rechnungsdatum auf der Rechnung angezeigt wird.
. Gib optional einen Kommentar ein, der auf der Rechnung angezeigt wird.
...
. Wähle das Tab *Rechnungen erzeugen*.
