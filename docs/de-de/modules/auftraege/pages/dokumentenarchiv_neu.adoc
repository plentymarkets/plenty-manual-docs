...
** *...*Einzelne Dokumente herunterladen* (material:upload[] ganz rechts in der jeweiligen Dokumentzeile).
...
Nutze die *Suchfunktion* im Dokumentenarchiv, um alle archivierten Dokumente aufzulisten oder um gefilterte Suchen auszuführen. Die Ergebnisse der Suche werden in chronologischer Reihenfolge angezeigt.
...
. Öffnen das Menü *Daten » Dokumente » Dokumentenarchiv*.
. Wähle in der Navigation das Dokumentenarchiv aus.
. Führe ein gefilterte Suche aus, wie in <<#Nach-archivierten-Dokumenten-suchen>> beschrieben.
...
. Öffnen das Menü *Daten » Dokumente » Dokumentenarchiv*.
. Wähle in der Navigation das Dokumentenarchiv aus.
. Führe ein gefilterte Suche aus, wie in <<#Searching-for-archived-documents>> beschrieben.
...
| *Typ*
|Wähle einen Gutscheintyp aus der Dropdown-Liste aus, um nach Gutscheinen dieses Typs zu filtern. Verfügbare Gutscheintypen: +
Gutschein: Info info info +
Voucher: Info info info
...
. Öffne das Menü *Daten » Dokumente » Dokumentenarchiv*.
. Führe eine Suche aus, wie in <<#Searching-for-archived-coupons>> beschrieben.
