...
. Klicke oben links auf *Retourengrund erstellen*.
...
| *Bearbeiten*
|Zeigt am Ende der Zeile die Funktion zum Bearbeiten (material:edit[]) des Retourengrunds an. +
//Was kann man dort bearbeiten?

| *Löschen*
|Zeigt am Ende der Zeile die Funktion zum Löschen (material:delete[]) des Retourengrunds an. +
...
. Öffne das Menü *Einrichtung » Aufträge » Auftragstypen » Retoure*.
. Klicke oben links auf *Artikelstatus hinzufügen* (material:add[]).
. Wähle die *Sprache* aus der Dropdown-Liste.
...
→ Das Fenster *Spalten konfigurieren* wird geöffnet.
. Wähle die Spalten, die angezeigt werden sollen (material:done[]). Beachte dazu die Erläuterungen in <<table-item-status-columns>>.
. Ziehe (material:drag_indicator[]) die Spalten per Drag-and-drop an die gewünschte Stelle, bis sie in der für dich richtigen Reihenfolge angezeigt werden.
. Füge bei Bedarf Spalten hinzu oder wähle Spalten ab, wenn du sie nicht benötigst.
. Klicke auf *Bestätigen*. +
→ Die Einstellungen werden gespeichert.

[[table-item-status-columns]]
...
| *Bearbeiten*
|Zeigt am Ende der Zeile die Funktion zum Bearbeiten (material:edit[]) des Artikelstatus an. +
//Was kann man dort bearbeiten?

| *Löschen*
|Zeigt am Ende der Zeile die Funktion zum Löschen (material:delete[]) des Artikelstatus an. +
