...
//Wenn ein bestimmter Artikel nicht per Gutschein bezahlbar sein soll, öffne das Menü *Artikel » Artikel-UI » [Artikel öffnen] » Element: Einstellungen* und stelle die Option *Aktionsgutschein* auf *Verboten*.
