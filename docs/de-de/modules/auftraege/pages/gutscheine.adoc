...
| *Erlauben* = Gutscheine gelten auch für Artikel über xref:maerkte:maerkte.adoc#_preisportale_nutzen[Preisportale], d.h. für Artikel, die gleichzeitig auf anderen Marktplätzen angeboten werden.  +
...
Beachte, dass du diese Funktion ab link:https://marketplace.plentymarkets.com/ceres_4697[plentyShop LTS^]-Version *5* nutzen kannst. +
