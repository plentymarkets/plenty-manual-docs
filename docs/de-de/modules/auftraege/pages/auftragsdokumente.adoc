...
|Wie *Steuerrechtlicher Hinweis 1*. +
Dieser Hinweis wird bei einer B2B-Lieferung mit <<auftraege/buchhaltung#510, Reverse-Charge-Verfahren>> ausgegeben. Die Formulierung kann hier z.B. lauten *Reverse-Charge-Verfahren gem. Artikel 194 der MwStSystRL.*
