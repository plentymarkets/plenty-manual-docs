...
Dieses Kapitel beschreibt das Vorgänger-System zum xref:auftraege:document-builder.adoc[DocumentBuilder]. Bestehende Kund:innen, die Zugriff auf das Vorgänger-System haben, können es weiterhin für die Einrichtung und Verwaltung von Dokumentvorlagen nutzen.
