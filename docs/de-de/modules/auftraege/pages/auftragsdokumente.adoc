...
Das System der standortbezogenen Dokumente ist das Vorgänger-System zum xref:auftraege:document-builder.adoc[DocumentBuilder]. Bestehende Kund:innen, die noch Zugriff auf die standortbezogenen Dokumente haben, können sie weiterhin für die Einrichtung und Verwaltung von Dokumentvorlagen nutzen.


*_Hinweis:_* Die standortbezogenen Dokumente werden nicht mehr weiterentwickelt. Wir empfehlen deshalb, den xref:auftraege:document-builder.adoc[DocumentBuilder] zu nutzen.
