...
Bevor du mit dem DocumentBuilder arbeiten kannst, ist ein wenig Vorarbeit nötig. In den folgenden Kapiteln wird erklärt, wie du die notwendigen Rechte für Mitarbeiter:innen vergibst, und wie du Nummernkreise für Dokumenttypen festlegst.
