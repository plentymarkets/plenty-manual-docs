...
*_Wichtig:_* Der Dokumenttyp *Wareneingangsbeleg* ist nur nutzbar, wenn du die plentyWarehouse App nutzt. Weitere Informationen findest du auf der Handbuchseite xref:warenwirtschaft:booking-incoming-items.adoc#400[Wareneingänge verwalten].
