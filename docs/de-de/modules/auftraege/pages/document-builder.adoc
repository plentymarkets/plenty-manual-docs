...
====
Standardvorlagen sind so konfiguriert, dass sie als Fallback dienen, wenn keine andere Vorlage dieses Dokumententyps vorhanden ist. Standardvorlagen können daher nicht bearbeitet, deaktiviert oder gelöscht werden.
====
