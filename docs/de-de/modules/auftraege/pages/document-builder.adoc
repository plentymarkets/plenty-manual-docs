...
====
Für das Menü *Einrichtung » Dokumente » DocumentBuilder* steht dir die geführten Touren *DocumentBuilder-Grundeinstellungen* und *DocumentBuilder-Editor* zur Verfügung. Die Touren zeigt dir Schritt für Schritt die wichtigsten Funktionen. +
Du findest die Touren in der unteren linken Ecke des Menüs Einrichtung » Dokumente » DocumentBuilder. KIicke auf material:rocket_launch[] Geführte Touren, um die Tour zu starten.
====
...
Mit dem Wechsel zum DocumentBuilder wird auch die neue Logik im Hintergrund aktiviert und die Dokumente werden asynchron erstellt. Die asymmetrische Logik ermöglicht es dir, das plentysystem weiter zu nutzen, ohne dass du warten musst, bis die Erstellung der Dokumente abgeschlossen ist. +
...
Wenn z.B. eine Ereignisaktion für die Erstellung eines Dokuments und den Versand dieses Dokuments per E-Mail gibt, solltest du diese Ereignisaktion in zwei aufteilen. Dann wird die E-Mail nur versendet, wenn das Dokument verfügbar ist. +

- *Für Prozessen*: Die Erstellung von Dokumenten wird durch die Subaktionen *Drucken*, *Speichern* und *Generieren* angestoßen. +
...
Die Standardvorlagen sind ideal, um deine erste Vorlage zu erstellen, da sie dir eine Basis bieten, die du dann anpassen kannst.
Wir empfehlen dir, eine Standardvorlage zu duplizieren und sie dann im *Editor* nach deinen Wünschen zu bearbeiten.

[NOTE]
.Besonderheiten der Standardvorlagen
====
Standardvorlagen sind so konfiguriert, dass sie als Fallback dienen, wenn keine andere Vorlage dieses Dokumententyps vorhanden ist, so dass sie nicht bearbeitet, deaktiviert oder gelöscht werden können.
====
...
** <<#variablen-auftragsposition-summen-systemwaehrung, Auftragspositionssummen in Systemwährung>>
