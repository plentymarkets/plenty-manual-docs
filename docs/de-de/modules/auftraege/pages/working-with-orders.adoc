...
|Zeigt die Auftragsreferenzen an. Konfieguriere (material:settings[]) die Spalten der Tabelle bei Bedarf.
...
|material:warehouse[]
|Zeigt den Warenbestand des jeweiligen Auftrags an. Klappe die Zeilen der Varianten aus, um weitere Informationen zum Warenbestand sowie zu eventuellen Nachbestellungen zu sehen.
