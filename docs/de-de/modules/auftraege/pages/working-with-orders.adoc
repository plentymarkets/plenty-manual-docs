...
Die Funktion zum Teilen von Aufträgen findest du in der Toolbar eines geöffneten Auftrags im Menü *Aufträge » Aufträge (Testphase)*. Das Verhalten beim Teilen ist abhängig von deiner xref:auftraege:grundeinstellungen.adoc#intable-behaviour-after-splitting[Grundeinstellung] dafür. +
