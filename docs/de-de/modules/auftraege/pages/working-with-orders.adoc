...
Im Bereich *Messenger* siehst du alle zum Auftrag gehörigen Nachrichten. Du kannst Nachrichten xref:crm:messenger-testphase.adoc#intable-whisper-mode[flüstern], sodass sie nur intern sichtbar sind und _nicht_ für deine Kund:innen. Du kannst Nachrichten xref:crm:messenger-testphase.adoc#nachricht-erstellen[senden] und du kannst xref:crm:messenger-testphase.adoc#minuten-erfassen[Minuten für die Nachricht erfassen] und diese Minuten als Freiminuten oder bezahlte Minuten speichern. 
