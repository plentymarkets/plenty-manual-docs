...
*_Hinweis:_* Wählst du oben in den Adressangaben der Lieferadresse die Option *DHL Packstation* oder *DHL Postfiliale*, wird das Feld *DHL Packstation* bzw. *DHL Postfiliale* entsprechend sichtbar. Gib in diesem Fall die Adresse der Packstation bzw. der Postfiliale ein. +
Die folgenden Felder stehen dir zur Verfügung: +
