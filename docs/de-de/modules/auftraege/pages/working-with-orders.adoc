...
| *Status ändern*
|material:repeat_one[]
|Ermöglicht das Ändern des Status für einen Auftrag. Wähle einen anderen Status aus der Dropdown-Liste.
...
Die Funktion zum Teilen von Aufträgen findest du in der Toolbar eines geöffneten Auftrags im Menü *Aufträge » Aufträge*. Das Verhalten beim Teilen ist abhängig von deiner xref:auftraege:preparatory-settings.adoc#intable-behaviour-after-splitting[Grundeinstellung] dafür. +
