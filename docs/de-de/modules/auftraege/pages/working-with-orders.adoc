...
|material:warehouse[]
|Zeigt den Warenbestand sowie eventuelle Nachbestellungen eines Auftrags an. Klappe die Zeilen aus (material:chevron_right[]), um weitere Informationen zum Warenbestand des Lagers zu sehen.
