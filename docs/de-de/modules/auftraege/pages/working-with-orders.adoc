...
Im Bereich *Tickets* siehst du alle zum Auftrag existierenden Tickets. Die folgende Tabelle listet die Felder, die im Bereich *Tickets* des Auftrags verfügbar sind. Über *Spalten konfigurieren* (material:settings[]) kannst du die Spalten beliebig konfigurieren.
