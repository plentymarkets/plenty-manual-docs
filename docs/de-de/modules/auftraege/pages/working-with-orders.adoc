...
Alle in einem Auftrag verfügbaren Bereiche und deren Funktionen werden in den folgenden Unterkapiteln erläutert. Verwende den xref:design-order-view:editing-mode.adoc[Bearbeitungsmodus] und entscheide selbst, welche Felder dir in welchem Bereich angezeigt werden sollen. So kannst du deine Ansicht individuell gestalten und auf deine Bedürfnisse anpassen. Beachte, dass die verfügbaren Felder je nach Auftragstyp variieren können. +
...
* <<#overview, Übersicht>>
* <<#status-and-tags, Status und Tags>>
* <<#general, Allgemein>>
* <<#addresses, Adressen>>
* <<#order-items, Auftragspositionen>>
* <<#payment-terms, Zahlungsbedingungen>>
* <<#bank-data, Bankdaten>>
* <<#assigned-payments, Zugeordnete Zahlungen>>
* <<#order-references, Auftragsreferenzen>>
...
// Was wird für den Warenausgang angezeigt?
| *Warenausgang*
|Zeigt den Warenausgang an.
...
|===
|Einstellung |Erläuterung
//welche ID wird angezeigt?
| *Rechnung*
a|Zeigt die Rechnungsadresse sowie die ID an. Die Standardeinstellung enthält die folgenden Informationen: Name, Straße, PLZ und Ort, Land, E-Mail-Adresse sowie die ID. +
...
| *Lieferung*
a|Zeigt die Lieferadresse sowie die ID an. Die Standardeinstellung enthält die folgenden Informationen: Name, Straße, PLZ und Ort, Land, E-Mail-Adresse sowie die ID. +
Die folgenden Felder stehen dir zur Verfügung: +
...
//können Auftragspositionen nicht bearbeitet werden?
Im Bereich *Auftragspositionen* siehst du detaillierte Informationen zu den Auftragspositionen. Beachte, dass Auftragspositionen nicht bearbeitet werden können.
...
//Ist es das Datum des Imports?
| *Importiert*
|Zeigt das Datum des Imports an.
...
//ggf. anpassen - nochmal prüfen
| *Datum anzeigen*
|Zeigt das Datum an.

| *Kontextmenü* (material:more_vert)
|Klicke auf die weiteren Optionen (material:more_vert[]), um ein Dokument herunterzuladen (material:file_download[]).
|===
