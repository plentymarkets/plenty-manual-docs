...
| *Notiz*
|Gib Notizen ein.
// TODO: Sprintaufgabe: Retourengrund, Notiz, Artikelwert - ergänzen
...
Klicke auf icon:add_shopping_cart[set=material], um einen Artikel hinzuzufügen; 
...
// TODO: Rechts über Icon Mülleimer...
