...
Wenn du den DocumentBuilder öffnest (*Einrichtung » Dokumente » DocumentBuilder*), gelangst du als erstes in die Übersicht:
...
== Detailanleitungen zu den Funktionen in der Übersicht

In diesem Kapitel findest du Anleitungen zu den in <<#DocumentBuilder-Übersicht, Kapitel 1>> skizzierten *Funktionen in der DokumentBuilder-Übersicht*.


[TIP]
.Schnellzugriff auf andere DokumentBuilder-Themenbereiche:
====

Wenn du *zu einem anderen DokumentBuilder-Themenbereich* wechseln möchtest, klicke auf einen der folgenden Einträge:

* xref:auftraege:documentbuilder-vorbereitende-einstellungen.adoc[Vorbereitende Einstellungen vornehmen]
* xref:auftraege:documentbuilder-vorlage-erstellen.adoc[Vorlagen erstellen und Standardvorlagen verwenden]
...
. Lege den Dokumenttyp fest und wähle für die Vorlage einen Vorlagennamen sowie einen Dateinamen. +
Beachte dazu die Erläuterungen zu den Vorlageneinstellungen in xref:auftraege:documentbuilder-vorlage-erstellen.adoc#Tabelle-Vorlageneinstellungen[Tabelle - Vorlageneinstellungen].
