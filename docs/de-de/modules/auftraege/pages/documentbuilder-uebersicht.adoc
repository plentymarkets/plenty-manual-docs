...
Die DocumentBuilder-Übersicht ist wie im folgenden Bild aufgebaut: + 
...
|Zeigt an, das die Kopf-/Fußzeile der Vorlage eine globale Kopf-/Fußzeile ist und somit in anderen Vorlagen verwendet wird.
...
Wenn du Änderungen in einer deaktivierten Vorlagen vornimmst, werden die Änderungen nur für Dokumente übernommen, die nach der Aktivierung der Vorlage generiert werden.
====
