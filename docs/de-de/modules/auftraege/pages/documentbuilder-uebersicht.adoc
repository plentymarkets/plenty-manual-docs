...
[.instruction]
Um die Spalten zu konfigurieren, gehe vor wie folgt:
...
[.instruction]
Um Sucheinstellungen als Filter zu speichern, gehe vor wie folgt:
...
[.instruction]
Um einen im DocumentBuilder gespeicherten Filter anzuwenden, gehe vor wie folgt:
...
[.instruction]
Um eine Vorlage zu importieren, gehe vor wie folgt:
...
[.instruction]
Um eine Vorlage aus dem DocumentBuilder zu exportieren, gehe vor wie folgt:
