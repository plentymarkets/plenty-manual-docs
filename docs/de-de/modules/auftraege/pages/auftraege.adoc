= Aufträge (veraltetes Tool)
:keywords: Aufträge verwalten, Auftrag, Aufträge, Auftragsabwicklung
:author: team-order-core, team-docs-automation

[NOTE]
.Auftrags-UI wird bald abgeschaltet
======
Beachte, dass die alte Auftrags-UI bald abgeschaltet wird. Wir empfehlen dir daher, ab sofort die xref:auftraege:new-order-ui-beta.adoc#[neue Auftrags-UI] zu verwenden.
======
 ...
 * xref:auftraege:order-type-offer.adoc#[Auftrag]
