...
| *Kundennotizen*
|Du wirst weitergeleitet zum Bereich xref:crm:messenger-testphase.adoc#[Messenger] des Kontaktdatensatzes. Hier kannst du entweder eine *Neue Nachricht* (material:add[]) erstellen oder bereits vorhandene Nachrichten öffnen.
