...
======
Auf dieser Seite wird die Auftragsanlage über das Menü *Aufträge » Aufträge* beschrieben, da die Vorgehensweise über das Menü *Aufträge » Aufträge bearbeiten* veraltet ist.
======
