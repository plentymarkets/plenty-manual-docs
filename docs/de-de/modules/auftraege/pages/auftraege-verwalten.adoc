...
| *Kontakt*
|Wähle den Kontakt des Auftrags. Gib mindestens 3 Buschstaben ein, um Vorschläge zu sehen. Alle am Kontakt hinterlegten Daten werden automatisch hinzugefügt. +
...
In diesem Schritt werden die Auftragsdetails nicht angezeigt. Erst im dritten Schritt, der Überprüfung, sind die Auftragsdetails wieder verfügbar. *_Beachte_* allerdings, dass dort nur wenige Einstellungen bearbeitet werden können.
