...
|Gib optional einen Adresszusatz ein, wie z.B. Apartment 12a. Wenn unter *Straße* und *Hausnummer* kein Eintrag gemacht wurde, ist dies ein Pflichtfeld.
...
Die Artikeltabelle kann individuell gestaltet werden. Das bedeutet, dass du selbst entscheiden kannst, welche Informationen dir in den Tabellenspalten angezeigt werden. Gehe dafür folgendermaßen vor:
...
.Tabellenspalten Artikel hinzufügen
[cols="1,3"]
|===
|Einstellung |Erläuterung
...
|*Artikelname*
|Zeigt die am Artikel hinterlegte Beschreibung an. +
Diese Spalte ist eine Standardspalte.
...
| *Lager*
|Zeigt das Lager des Artikels an.
...
Diese Spalte wird standardmäßig angezeigt.
...
In der Tabelle des Warenkorbs kannst du sowohl die *Menge* als auch den *Verkaufspreis* anpassen. Sobald du die Angaben in einem der Felder änderst, müssen Aktualisierungen durchgeführt werden. Dies kannst du tun, indem du am jeweiligen Artikel auf *Verkaufspreis aktualisieren* (material:refresh[]) klickst. Oder du nutzt die Schaltfläche *Verkaufspreise aktualisieren* unterhalb des Warenkorbs. Erst nach der Aktualisierung kannst du in den nächsten Schritt der Auftragsanlage weitergehen.
...
| *Artikelname*
|Zeigt den Namen des Artikels an. Passe den Namen bei Bedarf an (material:edit[]).
...
| *Nettopreis*
|Zeigt den Nettopreis des Artikels an. +
...
| *Bruttopreis*
|Zeigt den Bruttopreis des Aritkels an. +
...
| *Lager*
|Zeigt das Lager des Artikels an. Wähle bei Bedarf ein anderes Lager aus der Dropdown-Liste.
...
Um die Eigenschaften zu bearbeiten oder weitere bereits bestehende Eigenschaften zu einer Auftragspositionen hinzuzufügen, klicke auf *Eigenschaften bearbeiten* (material:edit[]).
