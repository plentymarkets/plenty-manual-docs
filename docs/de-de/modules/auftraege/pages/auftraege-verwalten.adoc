...
[NOTE]
.Vorgehensweise für Auftragsanlage ist veraltet
======
Auf dieser Seite wird die Auftragsanlage über das Menü *Aufträge » Aufträge bearbeiten* beschrieben. Diese Vorgehensweise wird nur noch für kurze Zeit zur Verfügung stehen. Wir empfehlen dir daher, die Auftragsanlage über die neue Auftrags-UI im Menü *Aufträge » Aufträge (Testphase)* zu nutzen. Weitere Informationen dazu findest du auf der Seite xref:auftraege:manually-create-orders.adoc[Aufträge manuell anlegen].
======
...
. Navigiere zu material:shopping_cart[] *Aufträge* > *Neuer Auftrag [deprecated]*. +
