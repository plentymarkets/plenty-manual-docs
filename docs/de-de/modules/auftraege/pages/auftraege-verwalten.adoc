...
|*Herkunft*
|Wähle aus der Dropdown-Liste die Herkunft für diesen Auftrag aus. Vorausgewählt ist entweder die Herkunft aus den Kontaktdaten oder als nächste Option eine xref:auftraege:auftragsherkunft.adoc#[Herkünfte] angezeigt, die aktiv geschaltet sind.
...
Bevor du Retouren erfassen kannst, lege xref:auftraege:auftraege-verwalten.adoc#420[Artikelstatus für retournierte Artikel] an.
...
Kommt es nach erfolgter Zahlung, Warenausgang und Zustellung der Ware für eine oder alle Auftragspositionen zu einer xref:auftraege:auftraege-verwalten.adoc#700[Reparaturauftrag], lege die Gutschrift direkt im entsprechenden Retouren- oder Reparaturauftrag an.
====
...
Gewährleistungen sind xref:auftraege:auftraege-verwalten.adoc#500[Gutschrift].
...
====
Damit variable Benutzer:innen Aufträge öffnen können, müssen im Menü *Einrichtung » Aufträge » Einstellungen* die xref:auftraege:benutzerkonten-zugaenge.adoc#110[Berechtigung » Tab: Menü » Bereich: Aufträge] für die Bearbeitung von Aufträgen berechtigt sein.
====
...
Auf Dokumenten werden die Werte übernommen, die am dazugehörigen Auftrag hinterlegt sind. Beachte auch die xref:auftraege:dokument-angebot-erzeugen.adoc#[Angebot] ausgegeben. +
 *_Wichtig_*: Die Zahlungsbedingungen werden nur auf diese Dokumente übernommen, wenn es sich um einen Auftrag mit der xref:payment:vorkasse.adoc#[Zahlungsart Vorkasse] handelt.
...
Bei nicht erfolgreichem E-Mail-Versand prüfe die xref:crm:api-log.adoc#[Daten » API-Log] werden die Fehlermeldungen zum Vorgang *E-Mail* gespeichert.
