...
Bei nicht erfolgreichem E-Mail-Versand prüfe die xref:crm:e-mails-versenden.adoc#[Zugangsdaten]. Im Menü <<daten/api-log#, Daten » API-Log>> werden die Fehlermeldungen zum Vorgang *E-Mail* gespeichert.
...
Im Tab *Kunde* wird der xref:crm:kontakte-verwalten.adoc#[Kontaktdatensatz] angezeigt. Du kannst diese Informationen bearbeiten.
