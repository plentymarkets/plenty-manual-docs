...
In plentymarkets wird ein Auftrag automatisch angelegt, wenn Kund:innen Bestellungen in deinem Webshop oder auf einem angebundenen Marktplatz tätigen. Unterschiedliche Geschäftsvorfälle wie <<auftraege/auftraege-verwalten#300, Lieferaufträge>>, <<auftraege/auftraege-verwalten#400, Retouren>>, <<auftraege/auftraege-verwalten#500, Gutschriften>>, <<auftraege/auftraege-verwalten#600, Gewährleistungen>> und <<auftraege/auftraege-verwalten#700, Reparaturen>> werden mithilfe eigener Aufträge verschiedener Typen abgebildet, die immer mit dem Hauptauftrag verbunden sind. Über die <<auftraege/auftraege-verwalten#1400, Auftragsübersicht>> lassen sich Aufträge ungeachtet der <<auftraege/auftragsherkunft#, Auftragsherkunft>> öffnen und bearbeiten. Für viele Auftragstypen, wie zum Beispiel <<auftraege/auftraege-verwalten#300, Lieferaufträge>>, ist das Einrichten von <<automatisierung/ereignisaktionen#, Ereignisaktionen>> sinnvoll, um Vorgänge zu automatisieren. Einige Beispiele für die Nutzung von Ereignisaktionen für die Auftragsabwicklung werden in den folgenden Kapiteln erläutert. +
Aufträge, die nicht über den Webshop oder einen Marktplatz bei dir eingehen, legst du <<auftraege/auftraege-verwalten#200, manuell>> im System an. Das ist beispielsweise bei telefonischen oder E-Mail-Bestellungen sowie bei Barverkäufen der Fall.

Passe die <<auftraege/grundeinstellungen#, Grundeinstellungen>> im Menü *Einrichtung » Aufträge » Einstellungen* an, bevor du die ersten Aufträge in deinem plentymarkets System abwickelst. Speichere die Grundeinstellungen auch dann einmalig ab, wenn du die voreingestellten Werte nicht verändert hast.
...
* In der <<auftraege/auftraege-verwalten#240, Kontaktübersicht>>
* In den <<auftraege/auftraege-verwalten#210, Kontaktdaten>>
* In einem bestehenden <<auftraege/auftraege-verwalten#220, Auftrag>>
* Über einen <<auftraege/auftraege-verwalten#230, Barverkauf>>
...
|Wählst du eine <<auftraege/auftraege-verwalten#295, Auftragsvorlage>> als Standard-Auftragsvorlage, ist diese für den neuen Auftrag oder das Angebot standardmäßig vorausgewählt. Die Werte der ausgewählten Auftragsvorlage werden dann automatisch für den Auftrag oder das Angebot übernommen. Es können nur bereits angelegte Auftragsvorlagen ausgewählt werden. +
...
|Aktiviere diese Option, damit sie für die Artikelsuche vorausgewählt ist. Angezeigt werden in den Suchergebnissen dann nur <<artikel/webshop/checkliste-artikel-anzeige#100, aktivierte Artikel>>.
...
|Durch Aktivierung dieser Option erlaubst du, dass vor dem Abschließen des Auftrages im letzten Schritt <<auftraege/auftraege-verwalten#290, Übersicht>> der Auftragsanlage Steuersätze geändert werden dürfen. Die Steuersätze richten sich dabei nach der Lieferadresse des Auftrages. +
...
|*Zahlungsart*
|Wenn im Kontakt eine Zahlungsart definiert ist, zum Beispiel über eine <<ccrm/kontakte-verwalten#15, Kundenklasse>>, ist diese vorausgewählt. Ansonsten kannst du eine Zahlungsart eingeben und dann auswählen. Angeboten werden dir alle Zahlungsarten, die bereits in deinem plentymarkets-System integriert sind. +
Nutzt du eine <<auftraege/auftraege-verwalten#295, Auftragsvorlage>>, wird die Zahlungsart der Auftragsvorlage genommen, sobald du die Vorlage für den Auftrag auswählst. Danach ist die Zahlungsart manuell anpassbar.
...
Es ist ein Rabatt voreingetragen, wenn der Kontakt zu einer Kundenklasse gehört, in der die Option *Standardrabatt für manuelle Aufträge* mit einem Wert gefüllt ist. Du findest diese Option im Bereich <<crm/kontakte-verwalten#intable-kundenklasse-rabattart, Rabattart>> im Menü *Einrichtung » CRM » Kundenklassen*. Der voreingetragene Wert in den Auftragsdetails ist anpassbar.

|*Währung*
|Die <<payment/waehrungen#30, Systemwährung>> ist vorausgewählt. Über die Dropdown-Liste kannst du die Währung für den Auftrag anpassen.

|*Lager*
|Welche Optionen dir angezeigt werden, hängt von den Grundeinstellungen ab, die du für die <<auftraege/grundeinstellungen#intable-warehouse-assignment, Zuordnung von Lagern>> gewählt hast: +
...
|*Mandant*
|Wähle aus der Dropdown-Liste den Mandanten aus, für den dieser Auftrag gelten soll. Vorausgewählt ist entweder der Mandant aus den Kontaktdaten oder als nächste Option ein <<auftraege/auftraege-verwalten#intable-standard-mandant, Standard-Mandaten>>, wenn du diesen festgelegt hast.

|*Eigner*
|Wähle aus der Dropdown-Liste den Eigner für diesen Auftrag aus. Hast du einen <<auftraege/auftraege-verwalten#intable-standard-eigner, Standard-Eigner>> gesetzt, ist dieser vorausgewählt. Ansonsten werden dir in der Dropdown-Liste nur Eigner angezeigt, die das Benutzerrecht Aufträge zu erstellen und zu bearbeiten haben.

|*Herkunft*
|Wähle aus der Dropdown-Liste die Herkunft für diesen Auftrag aus. Vorausgewählt ist entweder die Herkunft aus den Kontaktdaten oder als nächste Option eine <<auftraege/auftraege-verwalten#intable-standard-herkunft, Standard-Herkunft>> , wenn du diese festgelegt hast. Darüber hinaus werden nur die <<auftraege/auftragsherkunft#, Herkünfte>> angezeigt, die aktiv geschaltet sind.
...
. Wähle aus der Dropdown-Liste *Lieferadresse* die Option *(icon:add[set=material]) Neue Lieferadresse hinzufügen*. +
→ Das Fenster *Neue Lieferadresse hinzufügen* öffnet sich.
. Wähle aus, ob es sich um die *Primäre* Lieferadresse handelt.
. Gib die Daten ein. Beachte hierzu <<tabelle-neue-lieferadresse>>.
...
Zusätzlich kannst du die Optionen *Nur aktive Artikel anzeigen*, *Nur vorrätige Artikel anzeigen*, *Nur Vertriebslager anzeigen* und *Nur Artikel mit gültigem Preis anzeigen* auswählen. Wenn wie oben beschrieben deine Lagereinstellung in den Grundeinstellungen *a) pro Auftrag kann ein Lager zugeordnet werden* ist, steht dir die Option *Nur Vertriebslager anzeigen* nicht zur Verfügung, weil du das Lager bereits vorher bestimmt hast. Zudem greifen bei der Suche die <<auftraege/auftraege-verwalten#250, Standardeinstellungen>>, die du vorher vorgenommen hast.

Wende die Suche (icon:search[set=material]) an, um die gewünschten Auftragspositionen zu finden und dem Auftrag hinzuzufügen.
...
|*Status*
|In dieser Spalte wird angezeigt, ob diese Variante im Webshop aktiv oder inaktiv ist. Informationen zur Aktivierung oder Deaktivierung einer Variante findest du auf der Handbuchseite <<artikel/webshop/checkliste-artikel-anzeige#100, Hast du die Variante aktiviert?>>. +
Diese Spalte ist eine Standardspalte.
...
|*Verkaufspreis*
|Der aus der <<auftraege/auftraege-verwalten#intable-item-search-price-selection, Preisauswahl>> gewählte Verkaufspreis für diesen Artikel wird angezeigt. +
Dies ist eine Standardspalte.

|[#intable-item-search-price-selection]*Preisauswahl*
|In einer Dropdown-Liste werden dir alle für diesen Auftrag ermittelten Verkaufspreise angezeigt. Du kannst einen der angezeigten Preise wählen, dieser wird dann als Grundlage für die weiteren Auftragsberechnungen genommen. Enthält der Preis einen Rabatt, wird dies hinter dem Preisnamen und dem Betrag angezeigt. Die Spalten *Kundenklassenrabatt* und *Kategorierabatt* zeigen den Prozentsatz des angwendeten Rabatts an. +
Eine manuelle Anpassung des Preises kannst du im <<auftraege/auftraege-verwalten#284, Warenkorb>> vornehmen. Wählst du einen anderen Verkaufspreis als den ersten ermittelten aus, muss der Verkaufspreis aktualisiert werden. Klicke dafür auf *Verkaufspreis aktualisieren* (icon:refresh[set=material]). Nach der Aktualisierung ist die Warenkorb-Schaltfläche (icon:add_shopping_cart[set=material]) wieder verfügbar und die Artikel können hinzugefügt werden. Dies gilt auch für Mengenänderungen. +
...
|*Verfügbarkeit*
|In dieser Spalte wird die Verfügbarkeit der Variante angezeigt. Das dargestellte Symbol hängt davon ab, welches du im Menü *Einrichtung » Artikel » Verfügbarkeit* vergeben hast. Weitere Informationen zu diesen Einstellungen findest du auf der Handbuchseite <<artikel/einstellungen/verfuegbarkeiten#, Verfügbarkeiten>>. +
Diese Spalte ist eine Standardspalte.
...
|*Warenkorb Icon*
|Durch Klick auf den diesen Warenkorb (icon:add_shopping_cart[set=material]) wird der Artikel in der ausgewählten *Menge* dem Warenkorb hinzugefügt. +
Diese Spalte ist eine Standardspalte.
...
. Suche (icon:search[set=material]) den gewünschten Artikel.
...
→ Bei Preis- und Mengenänderungen muss der Verkaufspreis durch klicken auf *Verkaufspreis aktualisieren* (icon:refresh[set=material]) aktualisiert werden.
. Füge die Artikel dem Auftrag hinzu, indem du am Ende der jeweiligen Zeile auf den Warenkorb (icon:add_shopping_cart[set=material]) klickst. +
→ Wenn ein Artikel erfolgreich hinzugefügt wurde, verändert das Warenkorb-Symbol (icon:add_shopping_cart[set=material]) kurzzeitig Größe und Farbe.
...
Je nachdem, welchen <<auftraege/auftraege-verwalten#intable-shopping-cart-type, Warenkorbtyp>> du in den Standardeinstellungen ausgewählt hast, öffnet sich entweder der seitliche Warenkorb oder die Ansicht springt direkt zur Warenkorbtabelle. Unabhängig vom Warenkorbtyp kannst du dort sowohl die *Menge* als auch den *Verkaufspreis* anpassen. Sobald du die Angaben in einem der Felder änderst, müssen Aktualisierungen durchgeführt werden. Dies kannst du entweder am jeweiligen Artikel machen durch Klicken auf *Verkaufspreis aktualisieren* (icon:refresh[set=plenty]). Oder du nutzt die Schaltfläche *Verkaufspreise aktualisieren* unter dem Warenkorb. Erst nach der Aktualisierung kannst du in den nächsten Schritt der Auftragsanlage weitergehen.
...
Zudem können Auftragspositionen im Warenkorb auch gelöscht werden. Klicke dafür auf *Löschen* (icon:delete[set=material]). Eine weitere Bearbeitungsmöglichkeit der Auftragspositionen im Warenkorb stellen die Eigenschaften dar. Beachte dafür das folgende Kapitel <<auftraege/auftraege-verwalten#287, Eigenschaften von Auftragspositionen>>.
...
Möchtest du Eigenschaften erstellen und bearbeiten oder bist noch nicht mit der Struktur von Eigenschaften vertraut, informiere dich im Handbuchkapitel <<artikel/einstellungen/eigenschaften#500, Eigenschaften>>.

Damit eine Eigenschaft an einer Auftragsposition gesetzt werden kann, muss sie in den Eigenschaftseinstellungen im Bereich *Optionen* als *Bestelleigenschaft* definiert werden. Lege unter <<artikel/einstellungen/eigenschaften#property-options, Optionen>> außerdem mögliche Aufpreise und Besteuerungen fest. Die hier hinterlegten Werte werden in die Auftragsberechnungen einbezogen.

Ist bereits eine Eigenschaft mit einer Auftragsposition verknüpft, wird diese an der dazugehörigen Auftragsposition angezeigt. Wie Eigenschaften angezeigt werden, hängt von deiner <<auftraege/auftraege-verwalten#intable-shopping-cart-type, Auswahl des Warenkorbtyps>> ab.
...
Um die Eigenschaften zu bearbeiten oder weitere bereits bestehende Eigenschaften zu einer Auftragspositionen hinzuzufügen, klicke auf icon:edit[set=material] unter *Auftragspositionseigenschaften*. Das gleiche Bearbeitungsfenster wie vom Warenkorb als Tabelle aus öffnet sich.
...
+
--
Die Eigenschaften werden in einer zweiten Tabellenzeile direkt unterhalb der dazugehörigen Auftragsposition angezeigt. Hier findest du Angaben zu *Name*, *Wert*, *Aufpreis* und *Ust. %* der Eigenschaft. *Ust. %*, also den hinterlegten Steuersatz, kannst du direkt in der Tabelle bearbeiten, wenn der Eigenschaftstyp dies zulässt. Zudem kannst du die Eigenschaften der Auftragspositionen *löschen* (icon:delete[set=material]). Gelöschte Eigenschaften werden dann für diesen Auftrag nicht berücksichtigt. +
Um die Eigenschaften zu bearbeiten oder weitere bereits bestehende Eigenschaften zu einer Auftragspositionen hinzuzufügen, klicke auf *Eigenschaften bearbeiten* (icon:edit[set=material]). Das gleiche Bearbeitungsfenster wie vom Warenkorb als Side cart aus öffnet sich.
...
Zudem hast du in diesem Fenster einige weitere Bearbeitungsmöglichkeiten. Durch Klicken auf *Löschen* (icon:delete[set=material]) entfernst du eine Eigenschaft von einer Auftragsposition. Diese Eigenschaft wird dann für diesen Auftrag nicht berücksichtigt. +
...
Wenn du die Eigenschaften auf Dokumenten ausgeben lassen möchtest, musst du dies in der Konfiguration der Eigenschaften einstellen. Stelle sicher, dass im Bereich <<artikel/einstellungen/eigenschaften#property-visibilities, Sichtbarkeiten>>
...
====
Im Menü *Einrichtung » Aufträge » Einstellungen* muss zwingend für die <<auftraege/grundeinstellungen#intable-warehouse-assignment, Zuordnung des Lagers>> die Option *b) pro Artikelposition kann ein Lager zugeordnet werden* ausgewählt werden.
====
...
Um den Hauptauftrag öffnen zu dürfen, müssen variable Benutzer:innen über die <<business-entscheidungen/benutzerkonten-zugaenge#90, Berechtigung>> für alle Lager der Lieferaufträge eines Hauptauftrags verfügen. Prüfe dazu die Einstellungen im Menü *Einrichtung » Einstellungen » Benutzer » Konten » Tab: Berechtigungen*.
...
Bevor du Retouren erfassen kannst, lege <<auftraege/auftraege-verwalten#410, Retourengründe>> und <<auftraege/auftraege-verwalten#420, Artikelstatus für retournierte Artikel>> an.

Der Standardstatus für Retouren ist Status 9. Jede Retoure, die erfasst wird, erhält automatisch diesen Status. Du kannst jedoch jederzeit im Menü *Einrichtung » Aufträge » Einstellungen* einen anderen Status als <<auftraege/grundeinstellungen#intable-default-status-return, Standard-Status Retoure>> festlegen.
...
Bevor Rücksendescheine erzeugt werden können, muss die Dokumentenvorlage <<auftraege/auftragsdokumente/ruecksendeschein-erzeugen#, Rücksendeschein>> im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente » Rücksendeschein* eingerichtet werden.
...
Bei einer Gutschrift bekommen deine Kund:innen einen Betrag zurückerstattet. Dies kann beispielsweise nach einer <<auftraege/auftraege-verwalten#400, Retoure>> der Fall sein. Bei der Gutschrift in plentymarkets handelt es sich also nicht um eine Art umgekehrte Rechnung, sondern um eine Rückzahlung. Gutschriftaufträge erzeugst du unter *Aufträge » Aufträge bearbeiten* aus einem Auftrag. Eine Gutschrift ist also immer einem Auftrag zugeordnet. Die in einem Gutschriftauftrag erzeugten Gutschriftbelege werden auch in Buchhaltungsexporten, wie dem *DATEV*-Export, berücksichtigt.

[#510]
=== Standardstatus für Gutschriften speichern

Bevor du eine Gutschrift anlegst, prüfe den <<auftraege/grundeinstellungen#intable-default-status-credit-note, Standard-Status für Gutschriften>> im Menü *Einrichtung » Aufträge » Einstellungen*. Passe den Standardstatus bei Bedarf an und speichere die Einstellungen.
...
Kommt es nach erfolgter Zahlung, Warenausgang und Zustellung der Ware für eine oder alle Auftragspositionen zu einer <<auftraege/auftraege-verwalten#400, Retoure>> oder im Folgenden zu einem <<auftraege/auftraege-verwalten#700, Reparaturauftrag>>, lege die Gutschrift direkt im entsprechenden Retouren- oder Reparaturauftrag an.
====
...
Nach dem Anlegen des Gutschriftauftrags muss ein Gutschriftbeleg direkt im Gutschriftauftrag erstellt werden. Vor dem ersten Erzeigen eines <<auftraege/auftragsdokumente/gutschriften-erzeugen#, Gutschriftbelegs>>, muss die Dokumentenvorlage im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente » Gutschrift* eingerichtet werden.
...
Vor dem ersten Erzeugen des Dokuments muss im Menü *Einrichtung » Mandant » [Mandant wählen] » Standorte » [Standort wählen] » Dokumente » Stornobeleg Gutschrift* zunächst die <<auftraege/auftragsdokumente#300, Vorlage>> für das Dokument *Stornobeleg Gutschrift* eingerichtet werden.
...
Gewährleistungen sind <<auftraege/auftraege-verwalten#400, Retouren>> relativ ähnlich, denn in beiden Fällen bekommst du Waren eines Auftrags im *Status 7* wieder zurückgesendet. Im Gegensatz zur Retoure erwarten Kund:innen bei einer Gewährleistung aber entweder eine neue Lieferung oder eine Rückerstattung des Rechnungsbetrags mittels einer <<auftraege/auftraege-verwalten#500, Gutschrift>>.
...
Wenn ein Gewährleistungsfall vorliegt, entscheidest du als Händler:in, ob du Käufer:innen die Kosten erstattest, den Artikel reparierst oder den Artikel austauschst. Soll ein Umtausch durchgeführt werden, lege eine *Gewährleistung* an. Möchtest du das Geld erstatten, lege eine <<auftraege/auftraege-verwalten#500, Gutschrift>> im Tab *Übersicht* der Gewährleistung an. Ob du die *Versandkosten* in einer Gewährleistung übernimmst oder nicht, wählst du in den <<auftraege/grundeinstellungen#intable-shipping-costs-in-warranty, Grundeinstellungen>> im Menü *Einrichtung » Aufträge » Einstellungen*.
...
Alle Gutschriften der ausgewählten Kundenklasse werden gesammelt in einer Sammelgutschrift abgelegt. Diese Sammelgutschrift ist wie Sammelaufträge auch nach Erstellung in der Auftragsübersicht bearbeitbar. Je nach Anwendungsfall empfehlen wir, eigene <<crm/kontakte-verwalten#15, Kundenklassen>> für Sammelgutschriften anzulegen.
...
| *[8]* Storniert
|Empfohlen, um zu kennzeichnen, dass ein Auftrag vom Typ Auftrag storniert wurde. Status 8 ist als Standard für stornierte Aufträge festgelegt. Du kannst die Standardfestlegung für stornierte Aufträge jedoch im Menü *Einrichtung » Aufträge » Einstellungen* ändern. Die Einstellung hierfür heißt <<auftraege/grundeinstellungen#intable-default-status-cancelled-orders, Status stornierter Aufträge>>. Wenn du einen anderen Status für Stornierungen festgelegt hast, kannst du Status 8 frei nutzen.

| *[8.1]* Storniert durch Kunden
|Empfohlen, um zu kennzeichnen, dass ein Auftrag durch die Kund:in storniert wurde.

| *[9]* Retoure
|Ist beim Anlegen eines Auftrags vom Typ Retoure automatisch vorausgewählt. Du kannst auch einen anderen <<auftraege/grundeinstellungen#intable-default-status-return, Status als Standard für Retouren>> festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.
...
| *[11]* Gutschrift
|Wird einem Auftrag vom Typ Gutschrift automatisch zugeordnet, wenn eine Gutschrift angelegt wird. Du kannst auch einen anderen <<auftraege/grundeinstellungen#intable-default-status-credit-note, Status als Standard für Gutschriften>> festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[11.1]* Gutschrift ausgezahlt
|Empfohlen, um zu kennzeichnen, dass die Gutschrift ausgezahlt wurde und abgeschlossen ist.

| *[12]* Reparatur
|Ist beim Anlegen eines Auftrags vom Typ Reparatur automatisch vorausgewählt. Du kannst auch einen anderen <<auftraege/grundeinstellungen#intable-default-status-repairs, Status als Standard für Reparaturen>> festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[13]* Sammelauftrag
|Wird einem Auftrag vom Typ Sammelauftrag automatisch zugeordnet, wenn er angelegt wird. Du kannst auch einen anderen <<auftraege/grundeinstellungen#intable-default-status-multi-order, Status als Standard für Sammelaufträge>> festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.

| *[14]* Sammelgutschrift
|Wird einem Auftrag vom Typ Sammelgutschrift automatisch zugeordnet, wenn er angelegt wird. Du kannst auch einen anderen <<auftraege/grundeinstellungen#intable-default-status-multi-credit-note, Status als Standard für Sammelgutschriften>> festlegen. Die Einstellung erfolgt im Menü *Einrichtung » Aufträge » Einstellungen*.
|====
...
. Klicke auf das *Lieferauftrag anlegen* (icon:execute[set=plenty]), um die Einstellungen auf die ausgewählten Status zu übertragen. +
...
| *Mahnstufe*
| <<automatisierung/aktionsmanager#intable-dunning-level-procedure-manager, Mahnstufen>> können per Aktionsmanager zugeordnet werden.
...
Im Menü *Aufträge » Aufträge bearbeiten* werden deine Aufträge in der oben beschriebenen <<auftraege/auftraege-verwalten#1400, Übersicht>> angezeigt. Wie oben erklärt, stehen dir bereits in der Übersicht einige Bearbeitungsmöglichkeiten zur Verfügung, um einen schnellen Zugriff auf oft genutzte Funktionen zu gewährleisten. Zudem siehst du so auf einen Blick die grundlegenden Informationen, die du zu einem Auftrag benötigst. +
...
Die Option *IP-Adresse des Käufers* wird im Menü <<webshop/webshop-einrichten/bestellvorgang#, Einrichtung » Mandant » [Mandant wählen] » Bestellvorgang » Einstellungen>> aktiviert bzw. deaktiviert.
...
- Wenn die Benutzer:in nicht <<business-entscheidungen/benutzerkonten-zugaenge#90, berechtigt>> ist, Aufträge zu löschen. +
- Nach dem Buchen des Warenausgangs. +
- Wenn ein Lieferauftrag angelegt wurde. +
Generell sollten Aufträge nicht gelöscht werden. Durch die Verknüpfung mit Artikeln, Versandeinstellungen und weiteren Funktionen, wie Stornierungen und Retouren, kann es nach dem Löschen zu Fehlern an den Verknüpfungspunkten kommen. Neu angelegte Aufträge können jedoch gelöscht werden.

| [#intable-splitting-orders]*Teilen*
|Teilt den Auftrag. Das Verhalten beim Teilen ist abhängig von deiner <<auftraege/grundeinstellungen#intable-behaviour-after-splitting, Grundeinstellung>> dafür. +
...
Möchtest du ein anderes <<auftraege/grundeinstellungen#intable-splitting-behaviour-shipping-costs, Verhalten der Versandkosten>> als den oben beschriebenen Standard, kannst du dieses in den Grundeinstellungen für Aufträge auswählen.
...
| *Bankdaten*
|Auf das *kleine Plus* klicken, um die <<payment/bankdaten-verwalten#63, Bankdaten des Kunden>> einzublenden und bei Bedarf zu bearbeiten.

| *Kundennotizen*
|Du wirst weitergeleitet zum Bereich <<crm/messenger#, Messenger>> des Kontaktdatensatzes. Hier kannst du entweder eine *Neue Nachricht* (icon:plus-square[role="green"]) erstellen oder bereits vorhandene Nachrichten einsehen.
...
_Tipp_: Lagerorte können Artikeln auch per <<automatisierung/ereignisaktionen#, Ereignisaktion>> zugeordnet werden.
...
Der Hinweis *Fehlendes Eignerrecht Aufträge* wird angezeigt, wenn der hinterlegte Eigner nicht die erforderlichen <<business-entscheidungen/benutzerkonten-zugaenge#40, Eignerrechte>> hat. Lege im Menü *Einrichtung » Einstellungen » Benutzer » Konten* fest, dass der Bereich Aufträge für diesen Benutzer als Eigner zur Verfügung stehen soll. +
Sollte der hinterlegte Eigner am Auftrag nicht als Benutzer in plentymarkets angelegt sein, wird der Hinweis *Unbekannter Benutzer* angezeigt. Lege ggf. ein <<business-entscheidungen/benutzerkonten-zugaenge#10, Benutzerkonto>> für diesen Benutzer an.
...
Wenn die Werte bereits an der Firma in den <<crm/kontakte-verwalten#300, Kundendaten>> hinterlegt sind, werden sie vom System automatisch übernommen und hier eingetragen. Die Kundendaten haben also Priorität. Ist in den Kundendaten nichts hinterlegt, wird als nächstes überprüft, ob die Zahlungsbedingungen in einer <<crm/kontakte-verwalten#15, Kundenklasse>> definiert sind. Falls ja, werden diese Daten übernommen und hier am Auftrag eingetragen. Sind die Werte weder in den Kundendaten noch in einer Kundenklasse hinterlegt, bleiben die Felder zu den Zahlungsbedingungen am Auftrag leer. +
...
Auf Dokumenten werden die Werte übernommen, die am dazugehörigen Auftrag hinterlegt sind. Beachte auch die <<auftraege/auftragsdokumente#intable-zahlungsbedingungen-anzeigen, Dokumenteneinstellungen>>. Die Zahlungsbedingungen werden auf den Auftragsdokumenten <<auftraege/auftragsdokumente/rechnungen-erzeugen#, Rechnung>>, <<auftraege/auftragsdokumente/proformarechnung-erzeugen#, Proformarechnung>>, <<auftraege/auftragsdokumente/auftragsbestaetigung-erzeugen#, Auftragsbestätigung>> und <<auftraege/auftragsdokumente/dokument-angebot-erzeugen#, Angebot>> ausgegeben. +
 *_Wichtig_*: Die Zahlungsbedingungen werden nur auf diese Dokumente übernommen, wenn es sich um einen Auftrag mit der <<payment/payment-plugins/kauf-auf-rechnung#, Zahlungsart Rechnung>> oder der <<payment/payment-plugins/vorkasse#, Zahlungsart Vorkasse>> handelt.
...
Weitere Informationen zum Verwalten von Zahlungen findest du auf der Handbuchseite <<payment/beta-zahlungen-verwalten#, Zahlungen verwalten>>.
...
Die Dokumente werden anhand von <<auftraege/auftragsdokumente#, Dokumentenvorlagen>> erstellt. Prüfe daher vor der Erstellung der Belege bzw. auch bei einer Fehlermeldung, ob du die Dokumentenvorlagen erstellt hast.

[TIP]
.Tipp: Dokumentenvorlagen kopieren
====
Wenn du bei der Einrichtung der <<auftraege/auftragsdokumente#300, Dokumentenvorlagen>> Zeit sparen möchtest, kopiere sie von einer bereits konfigurierten Dokumentenvorlage und passe sie nach Bedarf an.
====
...
Im Tab *Tickets* werden <<crm/ticketsystem-nutzen#, Tickets>> der Kund:in angezeigt. Du kannst diese Tickets direkt bearbeiten, ohne ins Ticketsystem zu wechseln.
...
. Klicke im Tab *Nachbestellung* des Auftrags auf einen *Warenkorb* (icon:add_shopping_cart[set=material]). +
...
Weitere Details zur Bearbeitung der Nachbestellung und wie du z.B. Teilmengen buchst findest du auf der Handbuchseite <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Nachbestellungen>>.

[#1650]
==== Variantenmengen einer Nachbestellung erhöhen

Bei noch offenen Nachbestellungen kannst du die Mengen für Varianten erhöhen. Dies ist für Werte möglich, für die bei der <<artikel/einstellungen/attribute#200, Mengenverteilung>> prozentuale Anteile hinterlegt wurden. Gehe wie folgt vor, um die Menge für Varianten zu erhöhen.
...
Beachte, dass eine Rechnung nur storniert werden kann, wenn keine Mahnung für den entsprechenden Auftrag existiert. In diesem Fall muss auch die Mahnung erst storniert werden. Nutze hierzu den <<auftraege/auftragsdokumente/mahnungen-erzeugen#400, Stornobeleg Mahnung>>.
...
. Klicke auf *Anwenden* (icon:execute[set=plenty]), um die Aktion auszuführen.

[TIP]
.Grundeinstellungen zur Auftragsbearbeitung durch variable Benutzer:innen
====
Damit variable Benutzer:innen Aufträge öffnen können, müssen im Menü *Einrichtung » Aufträge » Einstellungen* die <<auftraege/grundeinstellungen#200, Standard-Status>> für *Retouren* und *Gutschriften* gespeichert worden sein. In der Grundeinstellung ist dort kein Status voreingestellt.
Außerdem müssen diese Benutzer:innen für die Erstellung und Bearbeitung von Aufträgen im <<business-entscheidungen/benutzerkonten-zugaenge#110, Benutzerprofil>> unter *Berechtigung » Tab: Menü » Bereich: Aufträge* berechtigt werden. +
====
...
→ Achte darauf, dass du vorher eine <<crm/e-mails-versenden#1200, E-Mail-Vorlage>> erstellt hast, damit sie dir hier als Auswahl zur Verfügung steht.
. Klicke auf *Anwenden* (icon:execute[set=plenty]), um die Aktion auszuführen. +
