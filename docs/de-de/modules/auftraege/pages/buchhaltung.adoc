...
|Aktiviere diese Option, wenn die Steuerkonfiguration nur für digitale Artikel gelten soll. Beachte das Kapitel xref:buchhaltung:auftraege.adoc#600[Umsatzsteuer für digitale Artikel].
