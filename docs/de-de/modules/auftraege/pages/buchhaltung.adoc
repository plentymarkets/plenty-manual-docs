...
→ Mit der Funktion *Mehrwertsteuer-Standardsatz anwenden* (icon:add[]) kannst du das system veranlassen, die Standard-Mehrwertsteuersätze des jeweiligen Landes anzuwenden. +
