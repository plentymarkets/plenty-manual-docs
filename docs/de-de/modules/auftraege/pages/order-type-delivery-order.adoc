...
:keywords: Lieferauftrag, Lieferschein
...
//Hier anpassen: Auftrag öffnen, für den ein Lieferauftrag angelegt werden soll. Dann die Option "Für bestimmte Artikel" wählen?
...
//Hier anpassen: Auftrag öffnen, für den ein Lieferauftrag angelegt werden soll. Dann die Option "Für alle Artikel" wählen?
