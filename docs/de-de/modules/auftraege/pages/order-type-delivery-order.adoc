...
|Wähle für die Aufteilung von Aufträgen in Lieferaufträge eine der folgenden Optionen: +
...
| *Standard-Status beim Zurücksetzen des Warenausgangs*
|Wähle den *Standard-Status*, der beim Zurücksetzen des Warenausgangs automatisch eingestellt wird.
