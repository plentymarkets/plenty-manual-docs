...
|Die Lieferaufträge werden anhand des *Lager- und Netto-Warenbestands* der Auftragspositionen erstellt, wenn der Warenbestand größer ist als 0.

| *Lager- und Netto-Warenbestand >= Menge Auftragsposition*
|Die Lieferaufträge werden anhand des *Lager- und Netto-Warenbestands* erstellt, wenn der Warenbestand größer als oder gleich ist wie die Menge der Auftragsposition.
