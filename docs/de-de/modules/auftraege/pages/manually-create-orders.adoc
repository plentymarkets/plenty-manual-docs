...
*Aktuelle Ansicht* = Leitet dich zur aktuellen Ansicht des erstellten Auftrags. Dies ist die Standardeinstellung. +
...
Außerdem kannst du in dieser Tabelle die *Artikelbeschreibung* individuell anpassen. Die angepasste Artikelbeschreibung wird nur für diesen Auftrag übernommen. Das bedeutet, dass die angepasste Beschreibung für die Auftragsdaten und auch die Auftragsdokumente dieses Auftrags übernommen wird. Außerhalb dieses Auftrags bleibt die bereits im System hinterlegte Artikelbeschreibung bestehen. Es gibt eine Beschränkung von 1.500 Zeichen für die *Artikelbeschreibung*.
