...
Anders als du vielleicht vermutest, werden Aufträge nicht direkt im Menü *Aufträge* angelegt.
Wie du Aufträge im System anlegst, z.B. wenn eine Bestellung per Telefon getätigt wird, ist auf dieser Seite beschrieben. Die folgenden Möglichkeiten stehen dir für die Auftragsanlage zur Verfügung:
...
|*Zusatz (Name 4)*
|Gib optional Zusatzangaben zum Kontakt einn, wie z.B. z. Hd. Herrn Max Mustermann.
