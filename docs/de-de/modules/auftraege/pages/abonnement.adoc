...
|Wähle einen Standardstatus, der für Abonnements gelten soll. Dieser Status ist dann für neu angelegte Abonnements vorausgewählt, kann aber individuell angepasst werden. Dir stehen alle xref:auftraege:auftraege-verwalten.adoc#1200[Status], die du in deinem plentymarkets System festgelegt hast, zur Verfügung.
...
|Wenn du einen xref:auftraege:abonnement.adoc#intable-subscription-default-status[Standardstatus] eingestellt hast, ist dieser hier vorausgewählt. Darüber hinaus stehen dir hier alle xref:auftraege:auftraege-verwalten.adoc#1200[Status] zur Verfügung, die du in deinem plentymarkets System angelegt hast. Wähle den passenden Status manuell aus der Dropdown-Liste.
