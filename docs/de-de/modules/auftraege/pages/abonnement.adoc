...
In der Detailansicht eines ausgewählten Abonnements stehen dir neben den oben beschriebenen zudem die Funktionen xref:auftraege:abonnement.adoc#800[Abgeschlossene Aufträge], xref:auftraege:abonnement.adoc#900[Messenger] und die xref:auftraege:abonnement.adoc#1000[Auftragshistorie] zur Verfügung. Diese kannst du wahlweise über das Menü links oder im unteren Bereich der Detailansicht ansteuern.
