...
Zudem kannst du mit der Komponente *Gespeicherte Filter* (material:bookmarks[]) ausgewählte Filter im Menü speichern. Gespeicherte Filtersets können dann in dieser Komponente bei jedem Öffnen des Menüs gewählt werden, ähnlich wie Lesezeichen. Jede:r Benutzer:in kann eigene Filter festlegen.
