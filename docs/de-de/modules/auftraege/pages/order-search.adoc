...
// umbenennen in "Spaltenanzahl für Filter"

[TIP]
.Anordnung der Filter anpassen
======
Stelle im Bearbeitungsmodus anhand der Einstellung *Filter pro Zeile* selbst ein, in wie vielen Spalten deine Filter in der Suche angezeigt werden sollen.
======
