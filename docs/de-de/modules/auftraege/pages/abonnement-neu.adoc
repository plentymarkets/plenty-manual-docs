...
. Wenn du die Option *Für alle Auftragspositionen* wählst, beachte die Erläuterungen in Tabelle 1. 
. Wenn du die Option *Für bestimmte Auftragspositionen* wählst, beachte die Erläuterungen in Tabelle 2.
