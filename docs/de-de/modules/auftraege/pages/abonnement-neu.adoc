...
|Wähle einen Standardmandanten, wenn dieser beim Anlegen neuer Abonnements vorausgewählt sein soll.
...
Weitere Informationen zu Benutzerkonten und Zugriffsrechten findest du auf xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#116[dieser Seite].
...
====
Änderungen an Artikeln in der Ansicht des Abonnements gelten nur für das ausgewählte Abonnement. Für dauerhafte Änderungen an Artikeln müssen die Anpassungen im Menü *Artikel » Artikel-UI (Testphase)* oder *Einrichtung » Artikel* vorgenommen werden.
