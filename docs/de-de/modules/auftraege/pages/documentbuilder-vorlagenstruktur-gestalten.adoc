...
|[#intable-widget-code]*Code*
|Mit diesem Widget kann individuelles Styling wie z.B. fett gedruckte Mengen von Auftragspositionen umgesetzt, wie auch komplexere Darstellungen / Aufbereitung von Daten gemacht werden. +
