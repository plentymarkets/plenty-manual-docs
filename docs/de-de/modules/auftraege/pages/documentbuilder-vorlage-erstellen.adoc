...
. Gestalte für die Vorlage die Struktur und den Inhalt. Beachte dazu die Erläuterungen im Kapitel xref:auftraege:documentbuilder-vorlagenstruktur-gestalten.adoc[Vorlage im Editor gestalten].
...
Wenn du Änderungen in einer Vorlage vornimmst, werden die Änderungen nur für Dokumente übernommen, die nach dem Aktivieren der Vorlage generiert werden.
====
...
Für die Einstellung *Dokumenttyp* folgende Auswahlmöglichkeiten stehen zur Verfügung, aufgeteilt in vier Kategorien: 
