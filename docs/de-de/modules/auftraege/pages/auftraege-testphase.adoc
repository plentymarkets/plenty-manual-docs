...
Über den Portlets eines geöffneten Auftrags findest du die Optionen:
Speichern: icon:save[set=material] 
Sperren/Entsperren
Warenkorb Aufträge erstellen, 
Trichter Auftrag teilen.
...
////
nicht alle Portlets werden initial mit Daten geladen (Datenlast reduzieren) - nachfragen was das bedeutet
...
Das Portlet *Waren zurückbuchen* lässt sich öffnen, wenn du in einer *Retoure* auf *Waren zurückbuchen* gehst. Über icon:input[set=material] kannst du das Portlet öffnen. Es erscheint nach dem Anlegen auch links in der Seitennavigation. In einer Retoure ist das Icon icon:input[set=material] immer zu sehen. In einem Auftrag oder einer Garantie siehst du es nur dann, wenn ein versandter Artikel hinterlegt ist.
...
3 striche mit +; Warenkorb +; Spalten konfigurieren
//// 
