...
Neu dazu kommt auch icon:delete[set=material] rechts oben. Das Icon ist nur dann aktiv, wenn wirklich etwas gelöscht werden kann. Durch Klick auf das Icon ist der linke Eintrag weg und man ist zurück in der Suche.
...
|*USt. (%)*
|Die Umsatzsteuer in % wird angezeigt. +
Voreinstellt sind 19.00 %. In der Dropdown-Liste kannst du den Steuersatz ändern. 
