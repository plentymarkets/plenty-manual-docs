...
*_Hinweis:_* Die Suche wird nicht mehr direkt beim Öffnen ausgeführt. Auf Suchen klicken, um für den voreingestellten Zeitraum alle Aufträge anzuzeigen oder Suchergebnisse durch Filtereinstellungen weiter eingrenzen.
...
Die Namen der Portlets können individualisiert werden. Gib bei Titel einen neuen Namen für dein Portlet ein. 
Darunter: # Kacheln pro Zeile
. Wähle aus: Keine Einschränkung, Eine Kachel bis 6 Kacheln - je nach Wahl der Anzahl der Kacheln wird das Portlet dargestellt

Elemente aufklappen
Die möglichen Felder können per Drag&Drop dem Portlet hinzugefügt werden. Im Portlet kannst du sie löschen, um sie wieder zurück in den rechten Bereich zu schieben.
Artikelmenge
...
Oberhalb der Portlets werden neben Dashboard links weitere Tabs angezeigt, z.B. *Aufträge*, *Einrichtung*, *Kontakte*, und man kann schnell von einem zum anderen wechseln.
...
Über den Portlets eines geöffneten Auftrags sind die Icons
Speichern: icon:save[set=material] 
Sperren/Entsperren
Warenkorb Aufträge erstellen, Trichter Auftrag teilen.
...
Im Kontextmenü kannst du folgende Informationen sehen oder eingeben.
...
[#portlet-general]
=== Portlet Allgemein
Im Portlet *Allgemein* siehst du einen Überblick über deinen Auftrag.
...
4 Portlets links in der Seitennavigation: 
*Übersicht*
Empfänger
Pakete, darunter
...
Im Portlet *Zahlungsbedingungen* siehst du die Werte *Zahlungsziel (Tage)*, *Valuta (Tage)*, *Skonto (Tage)* und *Skonto (%)* werden die Zahlungsbedingungen gestaltet.
...
[#portlet-bank-data]
=== Portlet Bankdaten
Im Portlet *Bankdaten* kannst du über Icon + die Bankddaten eingeben, durch Klick auf + öffnet sich ein Fenster *Neue Bankdaten*. Dort kannst du die erforderlichen Daten eingeben. Felder mit Stern sind Pflichtfelder.
...
Icon Schieberegler, um das *SEPA-Lastschriftmandat* zu aktivieren.
Wenn das aktiviert ist, öffnet sich ein neuer Bereich darunter.

| *SEPA-Lastschriftmandat*
|angezeigt wird *SEPA-Lastschriftmandat erteilt am*.
Du kannst das Datum ändern duch Eingabe
...
Über + kannst du *Zahlung erstellen*. Über Zahnrad *Spalten konfigurieren*
...
[#portlet-documents]
=== Portlet Dokumente
Im Portlet *Dokument* siehst du *Alle Dokumente* und *Archvierte Dokumente*.
Über Icon Zahnrad Spalten konfigurieren
Icons Suchen, ? und *Gespeicherte Filter*.
...
| *Alle Dokumente*
|Im Ordner *Alle Dokumente* finden sich: je Symbol davor und Anzahl dahinter
...
| *Aktionen*
|Über die 3 Punkte Symbol Herunterladen
...
Portlet: Waren zurückbuchen
//// 
in Entwicklung, erklären lassen; siehe https://knowledge.plentymarkets.com/de-de/manual/main/warenwirtschaft/mhd-charge-verwalten.html und https://knowledge.plentymarkets.com/de-de/manual/main/warenwirtschaft/warenbestaende-verwalten.html#100 bzw. mdh_charge_verwalten.adoc

Neuer Eintrag in der Seitennavigation = Waren zurückbuchen 
Auftrag & Garantie: Only visible if a outgoing item is set, 
Retoure: always visible
...
| *Auftragsmenge* (display field)
|Die *Auftragsmenge* wird angezeigt.

| *Offene Menge* (display field)
...
|Die
(validation reverse cant be higher than "quantity in order" - "Open"
