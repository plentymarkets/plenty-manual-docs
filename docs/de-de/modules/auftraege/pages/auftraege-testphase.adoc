...
. Klicke oben auf icon:add[set=material] *Neue Ansicht erstellen ...*.
...
* NEU Attach storage locations und Detach storage locations
...
|Wähle den Tag oder die Tags des Auftrags aus der Dropdown-Liste (Mehr hinzufügen):
* Auftrags-Tag
* Lieferdatum: gesetzt
* Status: Geliefert
* Status: Offen
...
Über icon:more_vert[set=material] rechts öffnet sich jeweils das Kontextmenü Icon Stift Bearbeiten. Klicke auf Icon, um in einem Bearbeitungsfenster die Angaben anzupassen.
...
Über Icon Stift kannst du in Artikel bearbeiten. Dies wird dir in der Seitennavigation links eingerückt in blauer Schrift angezeigt.
...
Die Verfügbarkeit wird in 3 farbigen Strichen dargestellt.
...
Über Icon Stift kannst du den Nettopreis bearbeiten. Der Bruttopreis wird automatisch angepasst.

|*Bruttopreis*
|Der Bruttopreis wird angezeigt.
Über Icon Stift kannst du den Bruttopreis bearbeiten. Der Nettopreis wird automatisch angepasst.
...
|*USt. (%)*
|Die Umsatzsteuer in % wird angezeigt. Voreinstellt sind 19.00 %. Über Dropdown kannst du den Steuersatz ändern. 
...
// TODO: Überschrift und Unterkapitel
