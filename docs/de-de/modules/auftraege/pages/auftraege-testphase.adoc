...
////
Link auf Grundeinstellungen - die müssen zuerst beachtet werden, sind aber vermutlich weitgehend unverändert und eigene Seite.
Dort sind in Tabelle 1 die Möglichkeiten erklärt
////
...
// lt Übergabe muss Angebot neu geschrieben werden.
...
////
Hier ergänzen um über Kontakt, aus einem Auftrag, über Barverkauf
////
...
Offenes Schloss: Entsperrt
Geschlossenes Schloss:  Reversibel gesperrt.
...
////
alt: Gutschein-Code: Alle, eingelöst, verkauft 
////
...
Für alle Filter bei *Datum* gilt: 
*Ist gleich (=)*
*Ist kleiner-gleich (<=)*
*Ist größer-gleich (>=)*
*Ist zwischen ([])*
...
Wähle: Alle, Nicht gebucht, gebucht, Heute, Gestern
...
////
aus alter UI noch: Click&Collect, eBay Plus,
////
...
// TODO: Ablauf prüfen, Links prüfen
...
// Symbol Warenkorb mit + Symbol - Klicke auf den Warenkorb, um einen Artikel ?
...
In einem Auftrag findest du das Symbol *Neuer Auftrag* (icon:plus-square[role="green"]) im Portlet *Übersicht*. Gehe wie unten beschrieben vor, um einen neuen Auftrag über das Portlet *Übersicht* eines bestehenden Auftrags anzulegen. ...
...
. Wechsle in das Portlet *Allgemein*. ??
