...
// TODO: Filter beschreiben und Operatoren ergänzen
...
// TODO: für alle Auftragstypen sind die ersten Schritte gleich sowie die spätere Ansicht.
= Auftragstypen
...
// TODO: hier und so richtig?
| *Versandkosten*
|Wählen, ob die Versandkosten aus dem Hauptauftrag in die Gewährleistung übernommen werden sollen. Voreingestellt ist der Standardstatus, der im Menü *Einrichtung » Aufträge » Einstellungen* gespeichert wurde.
////
add the shipping costs to the basket (only for the request / not visible in the basket) if the option is yes
////
