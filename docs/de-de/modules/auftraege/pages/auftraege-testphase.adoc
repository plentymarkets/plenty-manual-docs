...
== Standardansicht
// TODO: dazu gilt grundeinstellungen
[[standard-view]]
.Ansicht: Standard
[cols="1,3"]
|====
...
|Die Standardeinstellung ist Letzer Status
...
|Die Standardeinstellung ist von 4 | in Versandvorbereitung bis 4 |.
...
[#portlet-overview]
Im Portlet *Übersicht* siehst du...
