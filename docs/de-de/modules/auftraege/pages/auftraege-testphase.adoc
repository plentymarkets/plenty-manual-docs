...
//// 
Prüfen, was geblieben ist (Funktionalität wird übernommen), was neu ist, alle Änderungen dokumentieren. Siehe Aufgaben in Themen/Veranwortung aus Übergabe.
...
*Warenkorb als Side cart* = Der Warenkorb wird seitlich als neues Fenster dargestellt, wenn man ihn öffnet. +
...
// TODO: siehe Seite: auftragstypen-testphase.adoc
...
Seitennavigation:
Über Icon 3 Striche lässt sich die Seitennavigation links auf- und zuklappen. Wenn sie geöffnet ist, wird der ausgewählte Auftrag mit icon:shopping_cart[set=material] davor in blauer Schrift angezeigt. Darunter stehen in schwarzer Schrift die Namen der Bereiche, zunächst mit den Standardtiteln. Wenn du die Titel anpasst, ändert sich die Benennung auch in der Seitennavigation.
...
Natürlich kannst du die Standardansichten jederzeit nach deinen Wünschen <<#ansicht-bearbeiten, anpassen>> und einzelne Felder ergänzen oder entfernen oder eine <<#ansicht-bearbeiten, neue Ansicht erstellen>>.
...
// TODO: über den Tabellen: Stift bearbeiten; runder Pfeil Daten aktualisieren; Zahnrad Spalten konfigurieren
// TODO: in Spalten konfigurieren: 4 Punkte Reihenfolge, Kästchen für Haken

NEU Ansicht test
Einstellungen aufklappen

Slider *Portlet eingeklappt*
Die Namen der Bereiche können individualisiert werden. Gib im Datenfeld Titel einen neuen Namen für deinen Bereich ein. 
Darunter: # Kacheln pro Zeile
. Wähle aus: Keine Einschränkung, Eine Kachel bis 6 Kacheln - je nachdem, wie viele Kacheln du wählst, wird der Bereich dargestellt

. Klappe Elemente auf.
Die enthaltenen Elemente = Bereiche können per Drag & Drop hinzugefügt werden. Im Bereich kannst du sie löschen, um sie wieder zurück in die Auswahl der Elemente zu schieben.
Artikelmenge
...
Dank eigener Portlets bist du nicht auf die vorgefertigten Einstellungen angewiesen. Du kannst stattdessen selbst entscheiden, welche Einstellungen ein Portlet enthalten soll. Du kannst die Portlets zudem anders benennen. In der Seitennavigation links werden dir die Bezeichnungen der Portlets angezeigt. Über icon:settings[set=material] kannst du die Spalten der Portlets konfigurieren.

[discrete]
==== Anwendungsbeispiel

Stell dir vor, du bist mit der Standardanordnung der globalen Einstellungen nicht zufrieden. Du würdest lieber die Herstellereinstellungen und die Zustände separat gruppieren. Ein solches Szenario kann mit eigenen Bereichen realisiert werden.
...
// TODO: Einleitung; Icons
Über den Bereichen eines geöffneten Auftrags findest du die Optionen:
Speichern: icon:save[set=material] 
Sperren/Entsperren
Warenkorb Aufträge erstellen: icon:shopping_cart[set=material] 
Trichter Auftrag teilen: icon:call_split[set=material]
// TODO: wie gestalten?
Über icon:shopping_cart[set=material] lassen sich folgende Auftragstypen anlegen:
* Gewährleistung: 
** Für alle Positionen
...
[#portlet-status-tags]
=== Portlet *Status und Tags*
Im Portlet *Status und Tags* siehst du...

[[table-portlet-status-tags]]
.Portlet: Status und Tags
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
|Wähle den Tag des Auftrags aus der Dropdown-Liste.
...
[#portlet-address]
=== Portlet Adressen
Im Portlet *Adressen* siehst du alle Informationen zu Rechnungs- und Lieferadresse.
Über icon:more_vert[set=material] rechts öffnet sich jeweils das Kontextmenü.

[[table-portlet-address]]
.Portlet: Adressen
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
[#portlet-general]
=== Bereich Allgemein
Im Bereich *Allgemein* siehst du einen Überblick über deinen Auftrag.

[[table-portlet-general]]
.Bereich: Allgemein
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
| *Versandprofil*
|Das Versandprofil...
Über icon:search[set=material] kannst du Versandprofil und Porto ermitteln. Es öffnet sich ein schwarz hinterlegter Bereich mit Information. Danach kann die Versandart per Dropdown-Liste gewählt werden.

| *Paketnummern*
|Gib eine Paketnummer ein. +
Durch Klick auf auf das Symbol icon öffnet sich das Versandcenter.
// TODO: 4 Symbole beschreiben
*Auftrag anmelden*
*Polling*
*Retoure anmelden*
*Auftrag zurücksetzen*

// TODO: abgleichen mit Versandcenter 2.0 - wie darstellen?
4 Bereiche links in der Seitennavigation: 
*Übersicht*
Empfänger
Pakete, darunter
ID, Bezeichnung, Gewichtt, Maße, Volumen, Anzahl der Artikel, Typ, Paketnummer, Erstellt:, Geändert:
Über blau hinterlegt Bestätigen
...
[#portlet-order-positions]
=== Portlet Auftragspositionen
Im Portlet *Auftragspositionen* siehst du alle für den Auftrag relevante Informationen von Menge bis Preise.
...
[#portlet-payment-terms]
=== Portlet Zahlungsbedingungen
Im Portlet *Zahlungsbedingungen* siehst du die Werte *Zahlungsziel (Tage)*, *Valuta (Tage)*, *Skonto (Tage)* und *Skonto (%)* werden die Zahlungsbedingungen dargestellt.
...
| *Skonto (%)*
|Das Skonto wird angezeigt. +

| *Valuta (Tage)*
|Die Valuta wird angezeigt. +
|====
...
[#portlet-bank-data]
=== Bereich Bankdaten
Im Bereich *Bankdaten* kannst du über Icon + die Bankddaten eingeben, durch Klick auf + öffnet sich ein Fenster *Neue Bankdaten*. Dort kannst du die erforderlichen Daten eingeben. Felder mit Stern sind Pflichtfelder.
...
// TODO: wie anordnen?
|Nutze icon:toggle_on[set=material, role=skyBlue], um das *SEPA-Lastschriftmandat* zu aktivieren.
Wenn es aktiviert ist, öffnet sich ein neuer Bereich darunter.
...
[#portlet-assigned-payments]
=== Zugeordnete Zahlungen
Im Portlet *Zugeordnete Zahlungen* siehst du...
Über + kannst du *Zahlung erstellen*. Über icon:settings[set=material] kannst du die *Spalten konfigurieren*

[[table-assigned-payments]]
.Bereichf: Zugeordnete Zahlungen
[cols="1,3"]
|====
|Einstellung|Erläuterung
...
Im Bereich *Auftragsreferenzen* siehst du...
...
[#portlet-documents]
=== Bereich: Dokumente
Im Bereich *Dokument* siehst du *Alle Dokumente* und *Archvierte Dokumente*.

Über icon:settings[set=material] und *Gespeicherte Filter*.
Über Dokument + kannst du ein neues *Dokument erstellen*.
Über icon:filter_alt[set=material] öffnet sich ein Pop-up Fenster
Erstellt am Symbol Kalender
Aktualisiert am Symbol Kalender
Datum anzeigen am Symbol Kalender
Über icon:search[set=material] kann die Suche ausgeführt werden.
...
| *Alle Dokumente*
|Im Ordner *Alle Dokumente* finden sich: je Symbol Dokument davor und Anzahl dahinter
// TODO: wie darstellen? Verweis wohin?
* Rechnung
* Externe Rechnung
* Lieferschein
* Mahnschreiben
...
| *Aktionen*
|Über icon:more_vert[set=material] kommt Symbol Herunterladen icon:download[set=material]
|====


[#portlet-history]
=== Bereich: Historie
Im Bereich *Historie* siehst du alle ...
...
3 striche mit +; Warenkorb +;
//// 

Bereich Allgemein: Dort muss das Datum gewählt werden. 
Dann speichern. Das Pop-up Fenster für die Bestätigung *Waren zurückbuchen* öffnet sich. Wenn bestätigt ist oben das Icon Input sichtbar. Es ist genauso aufgebaut wie die anderen Auftragstypen. Übericon:settings[set=material] kannst du die Spalten konfigurieren.
...
2+^| *Artikel*
// TODO: Die Standard-Reihenfolge ändert sich evt.
| *Menge*
...
Rechts am Rand kannst du über icon:add_shopping_cart[set=material] Artikel zum Warenkorb hinzufügen.

2+^| *Warenkorb*
// TODO: Reihenfolge siehe oben.
| *reverse* (display field)
|Die
(validation: reverse cannot be higher than open quantity
...
| *Menge im Auftrag* (display field)
|Die

| *Charge* (display field)
|Die

| *Mindesthaltbarkeitsdatum (MHD)* (display field)
|Die

| *Artikel-ID* (display field)
|Die *Artikel-ID* wird angezeigt.

| *Varianten-ID* (display field)
|Die *Varianten-ID* wird angezeigt.

| *Variantenname* (display field)
...
|Wähle aus, welchen Typ von Warenkorb du in der Auftragserstellung nutzen möchtest. Standardmäßig ist der *Side cart* ausgewählt. Die Funktionen im Warenkorb sind bei beiden Typen gleich. +
*Warenkorb als Side cart* = Der Warenkorb wird seitlich als Fenster dargestellt, wenn man ihn öffnet. +
*Warenkorb als Tabelle (unterhalb der Suchergebnisse)* = Der Warenkorb wird als Tabelle unterhalb der Artikeltabelle (generiert durch die Artikelsuche) dargestellt.
...
. Klicke auf die Symbol Filter-Einstellungen
