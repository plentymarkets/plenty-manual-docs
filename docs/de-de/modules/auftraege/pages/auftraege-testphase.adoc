...
// TODO: Übersicht aus Aufträge verwalten - Schritte durchgehen und einfügen
[#250]
...
Im Portlet *Allgemein* siehst du allgemeine Informationen zum Auftrag.
...
Die Standardeinstellung für für Herkunft ist Manuelle Eingabe.
