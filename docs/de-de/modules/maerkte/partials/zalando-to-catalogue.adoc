...
Du benötigst Eigenschaftren für die unten aufgeführten Pflichtangaben von {market}.
...
Wenn die folgenden Angaben nicht über Attribute an deinen Varianten gespeichert sind, erstelle auch für diese Angaben Eigenschaften:
