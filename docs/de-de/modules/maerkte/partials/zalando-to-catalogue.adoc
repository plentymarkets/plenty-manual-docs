...
Für bestimmte Pflichtfelder von {market} gibt es in plentymarkets keine geeigneten Datenfelder. Für diese Eigenschaften benötigst du deshalb Eigenschaften.
...
//tag::zalando-catalogue-creation[]
...
//end::zalando-catalogue-creation[]
