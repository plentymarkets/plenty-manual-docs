...
Wenn du für diese Angaben noch keine passenden Eigenschaften hast, erstelle diese Eigenschaften jetzt im Menü *Einrichtung » Einstellungen » Eigenschaften » Konfiguration*.
