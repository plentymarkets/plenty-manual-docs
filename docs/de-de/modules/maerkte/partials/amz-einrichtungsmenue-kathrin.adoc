...
| Wählen, ob ausstehende Aufträge von Amazon importiert werden sollen. Wenn die Option aktiviert ist, werden ausstehenden Aufträge alle 15 Minuten importiert.
