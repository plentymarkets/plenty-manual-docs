...
material:toggle_off[role="darkGrey"] (Standardeinstellung) = Ausstehende Aufträge werden nicht importiert. Es wird also kein Warenbestand reserviert.
...
*_Empfehlung:_* Aktiviere diese Einstellung, wenn du selbst keine Rabattkampagnen auf Amazon-Plattformen anbietest.
...
[.collapseBox]
.Du verkaufst schon auf Amazon und möchtest deine Artikel jetzt über plentymarkets auf Amazon verkaufen?
--
...
| *HTML-Tags erlauben*
| material:toggle_off[role="darkGrey"] (Standardeinstellung) = HTML-Tags werden aus Artikelbeschreibungen entfernt. +
material:toggle_on[role="blue"] = HTML-Tags werden nicht aus Artikelbeschreibungen entfernt. +
...
Die Bestände der gewählten Lager werden summiert und zu Amazon übermittelt. Dabei werden auch die Einstellungen für Bestandspuffer und Maximalbestand berücksichtigt. So können pro Amazon-Konto und Amazon-Channel gezielt die Bestände bestimmter Lager angeboten werden. +

*_Wichtig:_* Wenn du für die Einstellung *Lagerauswahl* die Option *Lager wählen* einstellst, hier aber kein Lager wählst, wird der Artikel nicht exportiert, da kein Bestand ermittelt werden kann.
