...
| nein
| Die interne Artikelbeschreibung. Diese Beschreibung wird nicht auf Conrad angezeigt. +

| Angebotspreis
| ja
| Der Verkaufspreis des Artikels. +

* *Verkaufspreis » [Verkaufspreis für Conrad wählen]*
...
| nein
| _Dieses Datenfeld wird automatisch mit UPDATE verknüpft, damit Artikel auf Conrad aktualisiert werden._
...
| Logistikklasse
| nein
| Bei Conrad werden die Versandkosten eines Artikels anhand der Logistikklasse berechnet.
