...
*_Hinweis:_* Channels sind die einzelnen Verkaufskanäle (Länder) von Amazon, auf denen du deine Artikel anbietest. Welche Channels verfügbar sind, hängt von der gewählten Region ab.
...
* *VCS Lite* = Du nutzt VCS. Rechnungen für Amazon-Aufträge werden automatisch von plentymarkets erzeugt und zu Amazon übertragen. Die Umsatzsteuer wird von Amazon berechnet. Siehe <<#3150, VCS plentymarkets nutzen>>. +
*_Hinweis:_* In Amazon Seller Central muss VCS aktiviert sein. +
* *VCS* = Du nutzt VCS. Rechnungen für Amazon-Aufträge werden von Amazon erzeugt. +
