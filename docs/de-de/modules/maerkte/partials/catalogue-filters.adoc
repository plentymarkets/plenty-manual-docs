...
→ Nur die Datensätze werden exportiert, auf die alle hinzugefügten Filter zutreffen. +
*_Tipp:_* Die Zahl neben dem Wort *Filter* zeigt an, wie viele Filter aktiv sind. Die Template-Filter werden mitgezählt.
