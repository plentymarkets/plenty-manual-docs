...
//tag::produkttyp-note[]
*_Hinweis_*: Eine Übersicht der Amazon-Produkttypen kannst du link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/amazon-product-types-new.csv[hier^] herunterladen.
