...
* Beispiel-Code für das Tab link:https://raw.githubusercontent.com/plentymarkets/manual/master/de/maerkte/ebay/assets/ebay-Main.html[Mainframe^]{nbsp}icon:external-link[]

* Beispiel-Code für das Tab link:https://raw.githubusercontent.com/plentymarkets/manual/master/de/maerkte/ebay/assets/ebay-html.html[HTML-Struktur^]{nbsp}icon:external-link[]

* Beispiel-Code für das Tab link:https://raw.githubusercontent.com/plentymarkets/manual/master/de/maerkte/ebay/assets/ebay-C.html[CSS^]{nbsp}icon:external-link[]
...
| Soll der Grundpreis angezeigt werden? Wenn ja, an welcher Stelle? Der link:https://www.ebay.de/help/selling/selling/preis-fr-artikel-festlegen?id=4133[Grundpreis^]{nbsp}icon:external-link[] muss bei Listings vom Typ *Festpreis* oder Listings mit *Sofort-Kaufen*-Option angegeben werden, die nach *Gewicht* oder *Volumen* angeboten werden. Werte für *Einheiten* werden am Artikel eingestellt und automatisch an eBay übertragen.
