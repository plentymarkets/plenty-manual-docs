...
Nutze Layout-Vorlagen, um Listings mit einem Layout zu versehen. Der Vorteil einer solchen Vorlage ist, dass du in der eigentlichen Artikelbeschreibung ausschließlich Fließtext verwendest, ohne Designelemente zu benötigen. Layout-Vorlagen senken also den Pflegeaufwand der Artikelbeschreibung. Weiterhin werden grundlegende und übergreifende Informationen wie Impressum und Versandabwicklung in der Layout-Vorlage abgelegt. Bei Anpassung der Layout-Vorlage werden alle damit verknüpften Listings geändert. Du kannst beliebig viele Layout-Vorlagen in plentymarkets erstellen.
...
//tag::import-layout[]
Du kannst Layout-Vorlagen außerhalb von plentymarkets erstellen oder bearbeiten und diese Layout-Vorlagen dann in plentymarkets zu importieren. 

*_Hinweis:_* Du kannst Layout-Vorlagen nur als ZIP-Dateien in dein plentymarkets System importieren.
...
| *Zustand*
| Zustand des Artikels wählen.

| *Garantie*
| Garantie wählen.

| *Zahlungskonditionen*
| Zahlungskonditionen für das Listing wählen.

| *Zahlungsarten*
| Eine oder mehrere Zahlungsarten wählen, die du für das Listing anbieten willst.

| *Lieferkosten*
| Lieferkosten für den Artikel im Format `0,00` eingeben.

| *Separate Lieferkosten für jeden einzelnen Artikel*
| Häkchen setzen, wenn für jeden Artikel separat Lieferkosten gezahlt werden sollen.

| *Lieferkonditionen*
| Lieferkonditionen für das Listing wählen.

| *Packungsgröße*
| Packungsgröße wählen.

| *Verfügbarkeit*
| Verfügbarkeit des Listings wählen

| *Zusatzoptionen*
| *_Mögliche Optionen:_* *Promo-Paket klein*, +
*Promo-Paket mittel*, +
*Promo-Paket groß*, +
*Startseite*

| *Erhöhungsschritt*
| Erhöhungsschritt im Format `0,00` eingeben. +
Der Erhöhungsschritt legt fest, in welchen Schritten Käufer:innen bei Auktionen bieten müssen.

| *Anzahl Reaktivierungen*
| Wählen, wie oft das Listing nach Ablauf neu gestartet werden soll.

| *Reaktivierung bis Ausverkauf*
| Häkchen setzen, wenn das Listing so lang neu gestartet werden soll, bis es ausverkauft ist.

| *Alternative Sprache verwenden*
| Häkchen setzen, wenn eine alternative Sprache verwendet werden soll.

| *Mit Template verknüpfen*
| Template wählen, das für das Listing verwendet werden soll.
|===
