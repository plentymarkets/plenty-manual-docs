...
--
Im Menü *Daten » Log* kannst du bei Bedarf nachvollziehen, wann und durch welche:n Benutzer:in Aufträge entsperrt wurden. <<#list-log-filters>> zeigt, welche Filter du verwenden kannst, um Entsperrvorgänge im Log zu finden.
