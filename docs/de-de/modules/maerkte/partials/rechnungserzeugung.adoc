...
* Amazon lehnt Rechnungen ab, wenn die Rechnungsnummer Leerzeichen enthalten. Dein xref:auftraege:auftragsdokumente.adoc#1800[Nummernkreis für Rechnungen] darf also keine Leerzeichen enthalten.
