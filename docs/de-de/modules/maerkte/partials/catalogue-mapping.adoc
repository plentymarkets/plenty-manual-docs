...
* Freitextfelder und Merkmale können über Kataloge nicht exportiert werden. Verwende stattdessen xref:artikel:eigenschaften.adoc#500[Eigenschaften].
...
Bei komplexen Zuordnungen wird immer der Wert des Marktplatzes exportiert. Nur wenn du doch einen eigenen Wert zuordnest, wird dieser eigene Wert exportiert.
