...
*_Tipp:_* Du brauchst mehr Informationen zu den plentymarkets Datenfeldern? Alle Datenfelder sind auf der Handbuchseite für das Standardformat xref:daten:katalog-artikel.adoc#[Artikel (neu)] beschrieben.
