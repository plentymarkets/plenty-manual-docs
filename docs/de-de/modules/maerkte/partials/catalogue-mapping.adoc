...
. Gib einen Wert bei *Comparative value* ein. +
→ Comparatives values können bei den meisten plentymarkets Datenfeldern, aber nicht bei allen plentymarkets Datenfeldern, eingegeben werden.
