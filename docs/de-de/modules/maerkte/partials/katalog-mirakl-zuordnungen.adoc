...
ifdef::conrad[]
*_Beispiel:_* Für das Marktplatz-Datenfeld *Produktbild 1* wird das Bild der Variante mit der niedrigsten Position exportiert.
...
ifdef::voelkner[]
*_Beispiel:_* Für das Marktplatz-Datenfeld *Produktbild 1 URL* wird das Bild der Variante mit der niedrigsten Position exportiert.
