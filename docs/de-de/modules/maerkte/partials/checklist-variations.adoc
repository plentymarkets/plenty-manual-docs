...
*_Wichtig:_* Die Prüfung der Zeichenlänge führt OTTO Market durch. Prüfe deshalb die Log-Meldungen im Market Status (OTTO Reports), wenn Variantendaten nicht wie erwartet auf OTTO Market veröffentlich werden.
