...
Erstelle zuerst bei link:{registration-url}[{market}^]{nbsp}icon:external-link[] ein Mitgliedskonto. Nach der Registrierung erhältst du Zugangsdaten für {market}. Diese Zugangsdaten benötigst du, um {market} in plentymarkets einzurichten.
