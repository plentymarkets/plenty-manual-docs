...
====
Die Schnittstelle zu GALERIA wird über ein Plugin integriert. Um das GALERIA-Plugin nutzen zu können, lade das link:https://marketplace.plentymarkets.com/plugins/channels/marktplaetze/XXXX_XXXX[Plugin im plentyMarketplace^] herunter.
====
...
Um GALERIA in plentymarkets nutzen zu können, installiere zunächst das link:XXXX[GALERIA-Plugin^] in deinem plentymarkets System. Das Plugin erhältst du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^].
