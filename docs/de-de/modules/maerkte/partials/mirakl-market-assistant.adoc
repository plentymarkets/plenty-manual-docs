...
*Rabatt Startzeit* +
*Rabatt Endzeit*
| Optional kannst du zeitlich begrenzte Rabattpreise an Voelkner übermitteln.

Voraussetzungen für den korrekten Export von Rabattpreisen:
...
. Du hast eine Eigenschaft des Typs *Datum* für das Startdatum erstellt. Nenne diese Eigenschaft zum Beispiel *Voelkner Rabatt Startzeit*.
. Du hast eine Eigenschaft des Typs *Datum* für das Enddatum erstellt. Nenne diese Eigenschaft zum Beispiel *Voelkner Rabatt Endzeit*.
* Du hast im Assistenten die folgenden Zuordnungen vorgenommen:
