...
| Soll für alle Varianten ohne Bestandsbindung dieselbe Bestandsmenge exportiert werden?
...
Varianten ohne Bestandsbindung sind Varianten, bei denen für die Einstellung *Beschränkung* eine der folgenden Optionen eingestellt ist:
...
*_Wichtig:_* Du kannst nur eine Menge festlegen, wenn die Option *Bestandsmenge für Varianten ohne Bestandsbindung ersetzen* aktiviert ist. +
Wenn du "0" eingibst, werden Varianten ohne Bestandsbindung nicht exportiert.
|======
--
