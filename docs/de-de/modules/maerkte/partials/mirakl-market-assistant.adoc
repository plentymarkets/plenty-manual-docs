...
* Gib für jeden Aktionspreis denselben Wert für die Einstellung *Ab Menge* ein wie den Verkaufspreisen für die Staffelung.

[.instruction]
Rabattpreis für Variante festlegen:

. Verknüpfe den Verkaufspreis des Typs *Aktionspreis* mit der Variante.
. Wähle einen Preis für den Rabattpreis.
