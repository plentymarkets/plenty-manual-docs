...
ifdef::voelkner[]
| *Rabatt Startzeit*
| Ordne eine Eigenschaft des Typs *Datum* zu. Über diese Eigenschaft legst du fest, wann <<discount-prices, Rabattzeiträume>> starten.

| *Rabatt Endzeit*
| Ordne eine Eigenschaft des Typs *Datum* zu. Über diese Eigenschaft legst du fest, wann <<discount-prices, Rabattzeiträume>> enden.
endif::voelkner[]
