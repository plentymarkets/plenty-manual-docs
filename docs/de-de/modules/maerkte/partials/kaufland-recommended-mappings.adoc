...
Bei *id_warehouse* wählst du also zunächst das Kaufland-Lager und ordnest dann eine Eigenschaft zu. +
...
| id_shipping_group
| ja
a| Hier ordnest du deinen Kaufland-Versandgruppen Versandprofile aus plentymarkets zu. Für dieses Datenfeld nimmst du eine komplexe Zuordnung vor. Das bedeutet, das du für das Datenfeld des Marktplatzes verschiedene Werte zur Auswahl hast. Diese Werte ordnest du deinen in plentymarkets gespeicherten Artikeldaten zu. Bei *id_shipping_group* wählst du zunächst die Kaufland-Versandgruppe und ordnest dann das passende plentymarkets Versandprofil zu. +
