...
[TIP]
.Bei Länge, Breite und Höhe Maßeinheit als eigenen Wert angeben
====
...
* *Variante » Länge*, _Größeneinheit angeben_
* *Variante » Breite*, _Größeneinheit angeben_
* *Variante » Höhe*, _Größeneinheit angeben_

Bei diesen Datenfeldern wird nur der Wert und nicht die Größeneinheit zu Kaufland übertragen. Damit deine Varianten fehlerfrei zu Kaufland exportiert werden können, muss jedoch die Maßeinheit angegeben werden. Deshalb solltest du die Maßeinheit zusätzlich als *eigenen Wert* angeben.

[.instruction]
Maßeinheit als eigenen Wert angeben:
...
. Gib die Maßeinheit im Datenfeld *Eigener Wert* ein. +
→ Die Maßeinheit kannst du zum Beispiel als *mm*, *cm*, oder *m* angeben, je nachdem, welche Maßeinheit du übertragen willst.
