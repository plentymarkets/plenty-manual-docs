...
ifdef::mirakl-priority[]
*_Hinweis:_* Die Priorität von *Mirakl Connector* muss niedriger sein als die Priorität des Marktplatz-Plugins. So ist sichergestellt, dass beide Plugins fehlerfrei funktionieren.
endif::mirakl-priority[]
