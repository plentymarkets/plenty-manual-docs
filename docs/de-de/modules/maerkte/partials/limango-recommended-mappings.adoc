...
| Produktname +
(_Pflichtfeld für bestimmte Kategorien_)
...
*_Beispiel:_* Du bietest ein Kleid in den Farben Hellgrün und Dunkelgrün an. Beide Varianten werden angezeigt, wenn Kund:innen auf dem Marktplatz nach grünen Kleidern suchen.
...
.Was ist das?
--
Wenn sich dein Lager außerhalb Deutschlands befindet, sind Informationen zur Intrastat-Meldung erforderlich. +
