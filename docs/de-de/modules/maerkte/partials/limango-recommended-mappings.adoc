...
*_Tipp:_* Beim Export werden die Datenfelder *Produktname* und *Farbwert* miteinander kombiniert. Zwischen den beiden Datenfeldern wird automatisch das Wort `in` eingefügt. +
