...
→ Die Herkunft ist aktiviert.
ifdef::marktkauf[]
*_Tipp:_* Wenn du deine Artikel auch auf dem Marktplatz Marktkauf anbieten willst, dann wiederhole die Einstellungen für die Herkunft *Marktkauf* mit der ID *171.00*.
endif::marktkauf[]
ifdef::idealo-direkt[]
