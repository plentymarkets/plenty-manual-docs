Wenn du mit dem Assistenten {catalogue-assistant-name} den ersten Katalog für {market} erstellt hast, wird in deinem plentymarkets System die Eigenschaft *{property-name}* erstellt.
