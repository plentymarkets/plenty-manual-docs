...
Der plentymarkets Support hat dein Konto mit deinem zDirect-Konto verknüpft? Dann kann es jetzt weitergehen. Du durchläufst nun den Assistenten *Kontoeinstellungen - Zalando* zum zweiten Mal.
