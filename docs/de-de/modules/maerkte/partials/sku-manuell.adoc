...
TIP: Hier werden nur die wichtigsten Einstellungen für den Import beschrieben. Du arbeitest zum ersten Mal mit dem Import-Tool? Dann mache dich zuerst xref:daten:ElasticSync.adoc#[mit dem Prinzip des Datenimports in plentymarkets vertraut].
