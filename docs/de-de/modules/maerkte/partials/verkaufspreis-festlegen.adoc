...
ifdef::emag[]
eMAG erwartet den Verkaufspreis als Nettopreis. Zusammen mit dem Nettopreis wird die MwSt.-ID erwartet, damit der Bruttopreis korrekt berechnet werden kann.
endif::emag[]
