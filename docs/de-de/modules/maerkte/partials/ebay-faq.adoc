...
--
Für den Vorgang muss das Plugin xref:maerkte:ebay-OAuth2.adoc#[eBay OAuth2] in deinem System installiert und eingerichtet sein. Das Plugin wird für alle Calls benötigt, die über die neuen APIs von eBay laufen. Diese neuen APIs basieren auf der neuen Authentifizierungsmethode OAuth2 statt auf der bisherigen Auth-n-Auth-Methode. Die neue Authentifizierungsmethode wird für immer mehr essentielle Abläufe benötigt. Deshalb solltest du das Plugin eBay OAuth2 schon bei der Einrichtung installieren.
--
