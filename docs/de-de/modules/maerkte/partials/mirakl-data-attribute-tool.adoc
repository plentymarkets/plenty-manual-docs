...
Wahrscheinlich ist dein plentyShop gesperrt. Entsperre den plentimage::images/mirakl-data-attribute-tool-dfedd.png[]yShop im Menü *Einrichtung » Mandant » Standard » Webshop » Shop sperren*. Vergiss nicht, den plentyShop danach wieder zu sperren.
