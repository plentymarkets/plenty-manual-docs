...
* Ordne im Schritt *Zuordnung der Angebots-Eigenschaften* des Assistenten die folgenden Datenfelder zu:
...
[tabs]
====
Aktionspreis für Verkaufspreis::
+
--
[.instruction]
Aktionspreis für Verkaufspreis festlegen:
...
--
 
Aktionspreise für Staffelpreise::
+
--
