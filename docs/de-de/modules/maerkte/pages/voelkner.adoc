...
Du möchtest günstigere Preise anbieten, wenn Kund:innen mehrere Exemplare desselben Artikels kaufen? Dann lege zusätzlich zum Verkaufspreis auch Staffelpreise fest. Einen Verkaufspreis definierst du als Staffelpreise, indem du für die Verkaufspreis-Einstellung *Ab Menge* eine Zahl größer 1 eingibst.

Staffelpreise müssen also die folgenden Einstellungen haben:

* *Herkunft* Völkner und Mirakl
* *Ab Menge* größer 1

Beim Speichern der Preise an der Variante musst du Folgendes beachten:

* Je höher die Einstellung *Ab Menge*, desto niedriger der Preis
