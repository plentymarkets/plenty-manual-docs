...
link:https://flubit.com/[Flubit^]{nbsp}icon:external-link[] ist ein auf das Vereinigte Königreich beschränkter Online-Marktplatz, der keine Provision von Händler:innen verlangt.

[#100]
== Bei Flubit registrieren

Registriere dich zunächst als Verkäufer:in bei link:https://sellers.skucloud.co.uk/start-selling[WeFlubit^]{nbsp}icon:external-link[], der zentralen Flubit-Anlaufstelle für Verkäufer:innen.
