...
Criteo ist ein personalisiertes Retargeting-Unternehmen, das mit Internethändler:innen zusammenarbeitet, um Kund:innen, die die Website der Werbetreibenden bereits besucht haben, personalisierte Online-Werbeanzeigen zu bieten. Um Criteo in plentymarkets einzurichten, registriere dich zunächst bei link:https://www.criteo.com/de/[Criteo^]{nbsp}icon:external-link[].

[#old-export]
== _Möglichkeit 1:_ Exportformat Criteo-Plugin _(veraltet)_
