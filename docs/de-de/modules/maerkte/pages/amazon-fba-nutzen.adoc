...
Als du dein Amazon-Konto in plentymarkets eingerichtet hast, hast du wahrscheinlich schon alle erfoderlichen FBA-Einstellungen vorgenommen. Falls du FBA später einrichtest oder eine Einstellung ändern möchtest, findest du hier noch mal Erläuterungen zu den Einstellungen.

include::partial$amz-einrichtungsmenue-kathrin.adoc[tag=amazon-fba-settings]
// TODO: LINK ANPASSEN!
|===
...
. Nimm die Einstellungen im Bereich *Multi-Channel* vor. Beachte dabei die Erläuterungen in <<#amazon-multi-channel>>.
. Speichere (terra:save[]) die Einstellungen.
...
include::partial$amz-einrichtungsmenue-kathrin.adoc[tag=amazon-multi-channel-settings]
// TODO: LINK ANPASSEN!
