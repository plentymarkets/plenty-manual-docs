 ...
 *_Ausnahme:_* Bei Berichten aus Nordamerika fehlen die Adressen von Kund:innen. Aus diesen Berichten werden deshalb unvollständige Aufträge mit dem Status [1] erstellt.
