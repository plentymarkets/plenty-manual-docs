...
| Ermöglicht es Amazon FBA-Aufträge (Region Nordamerika), in denen Adressdaten fehlen, durch einen Tag zu markieren. Durch das Tag werden fehlende Adressdaten mit dem Platzhalter „N/A“ versehen.
