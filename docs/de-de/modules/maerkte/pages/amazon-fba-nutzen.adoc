...
Die farbigen Punkte zeigen den jeweiligen Sendungsstatus an: +
Grün: Die Sendung befindet sich im Status *RECEIVING* oder *CLOSED*. Die Anzahl der erhaltenen Artikel entspricht hier der Anzahl der versendeten Artikel. +
Gelb: Die Sendung befindet sich im Status *WORKING*, *SHIPPED*, *IN_TRANSIT*, *DELIVERED* oder *CHECKED_IN*. Es wird keine Anzahl von Artikeln angezeigt. +
Rot: Die Sendung befindet sich im Status *RECEIVING* oder *CLOSED*. Die Anzahl der erhaltenen Artikel ist hier geringer als die Anzahl der versendeten Artikel.
