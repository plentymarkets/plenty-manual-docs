...
Eine xref:auftraege:paketinhaltsliste-testphase.adoc#[Paketinhaltsliste] gibt Auskunft über den Inhalt von Paletten, Paketen und Artikeln. Die Paketinhaltsliste sorgt dafür, dass Amazon weiß, welche Artikel sich in den Paketen befinden, die Amazon für dich lagert und versendet.
...
. Packe den Auftrag anhand der xref:auftraege:paketinhaltsliste-testphase.adoc#[Paketinhaltsliste].
