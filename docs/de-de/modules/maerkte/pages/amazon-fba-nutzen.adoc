...
| Ermöglicht es Amazon FBA-Aufträge, in denen einzelne Adressdaten fehlen, durch einen Tag zu markieren. Fehlende Adressdaten in getaggten FBA-Aufträgen ersetzt das System durch den Wert „N/A“.
