...
. Nimm die Einstellungen im Bereich *Amazon* vor. Beachte dazu die Erläuterungen in <<artikelverfügbarkeit-amazon>> im Kapitel xref:maerkte:varianten-vorbereiten.adoc#700[Variantenverfügbarkeit einstellen].
. Speichere (terra:save[]) die Einstellungen.
