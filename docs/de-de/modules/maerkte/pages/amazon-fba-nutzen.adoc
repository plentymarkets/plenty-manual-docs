...
Als du dein Amazon-Konto in plentymarkets eingerichtet hast, hast du wahrscheinlich schon alle erfoderlichen FBA-Einstellungen vorgenommen. Falls du FBA später einrichtest oder eine Einstellung ändern möchtest, findest du hier noch einmal Erläuterungen zu den Einstellungen.
...
| *Status*
| xref:auftraege:order-statuses.adoc#[Status] wählen, der Aufträgen zugewiesen werden soll, die von Amazon importiert werden.
...
| *Unvollständige FBA-Aufträge (fehlende Adressdaten) durch einen Tag markieren*
| Ermöglicht es Amazon FBA-Aufträge, in denen einzelne Adressdaten fehlen, durch einen Tag zu markieren. Fehlende Adressdaten werden in getaggten FBA-Aufträgen durch den Wert „N/A“ ersetzt.
...
| *Tag für Aufträge mit unvollständigen Adressdaten*
| Ermöglicht es Amazon FBA-Aufträge (Region North America) durch einen Tag zu markieren, in denen Adressdaten fehlen. Versieht fehlende Adressdaten mit dem Platzhalter „N/A“.
|===
...
Eine xref:fulfillment:paketinhaltsliste-testphase.adoc[Paketinhaltsliste] gibt Auskunft über den Inhalt von Paletten, Paketen und Artikeln. Die Paketinhaltsliste sorgt dafür, dass Amazon weiß, welche Artikel sich in den Paketen befinden, die Amazon für dich lagert und versendet.
...
. Packe den Auftrag anhand der xref:fulfillment:paketinhaltsliste-testphase.adoc[Paketinhaltsliste].
