...
include::partial$amz-neues-einrichtungsmenue.adoc[tag=amazon-fba-settings]
|===
...
include::partial$amz-neues-einrichtungsmenue.adoc[tag=amazon-multi-channel-settings]
|===
