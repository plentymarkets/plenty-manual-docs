...
[NOTE]
.Alte Paketinhaltsliste vs. Paketinhaltsliste 2.0
======
Die bestehende Paketinhaltsliste wird in Zukunft durch die Paketinhaltsliste 2.0 (Testphase) abgelöst. Solange die beiden Menüs parallel zur Verfügung stehen, kannst du auf dieser Handbuchseite zwischen den Versionen wechseln. Beachte dazu die verfügbaren Tabs *Paketinhaltsliste* und *Paketinhaltsliste 2.0* in den Kapiteln xref:maerkte:amazon-fba-nutzen.adoc#170[Paketinhaltsliste öffnen] und xref:maerkte:amazon-fba-nutzen.adoc#180[FBA-Inbound-Auftrag bei Amazon anmelden].
======
...
+
--
Eine xref:fulfillment:package-content-list-2-0.adoc#[Paketinhaltsliste] gibt Auskunft über den Inhalt von Paletten, Paketen und Artikeln. Die Paketinhaltsliste 2.0 sorgt dafür, dass Amazon weiß, welche Artikel sich in den Paketen befinden, die Amazon für dich lagert und versendet.
...
======
Du kannst die Paketinhaltsliste auch über das Menü *Aufträge » Paketinhaltsliste 2.0* öffnen und abarbeiten. Die Schaltfläche *Anmelden* wird aber nur angezeigt, wenn du die Paketinhaltsliste über das Menü *Waren » Amazon FBA Inbound* öffnest und du alle Pakete und Paletten geschlossen hast. Die Schaltfläche *Anmelden* benötigst du, wenn du die gepackten Pakete bei Amazon anmelden möchtest.
======
...
. Packe den Auftrag anhand der xref:fulfillment:package-content-list-2-0.adoc#[Paketinhaltsliste].
--
====
