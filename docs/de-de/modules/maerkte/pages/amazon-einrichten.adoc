...
* *Bericht herunterladen* (material:file-download[]):  Der Bericht wird heruntergeladen. +
...
* *Bericht überspringen* (material:skip-next[]): Der Bericht wird übersprungen. Wenn du einen Bericht überspringst, wird er zunächst nicht verarbeitet. Du kannst den Bericht dann auch nicht herunterladen. +
