...
Im Menü *Einrichtung » Märkte » Amazon » Berichte » Berichte anfordern* kannst du die Erstellung von Amazon-Berichten anfordern.

*_Hinweise zum Anfordern von Berichten:_*

* Der Zeitraum, über den du Berichte anfordern willst, darf maximal eine Woche sein.

* Berichte können nicht beliebig oft angefordert werden. Einige Berichtstypen können beispielsweise nur 2- oder 5-mal pro Woche angefordert werden.

[.instruction]
Bericht anfordern:

. Öffne das Menü *Einrichtung » Märkte » Amazon » Berichte » Berichte anfordern*.
...
*_Hinweis:_* Berichte können nicht beliebig oft angefordert werden. Wenn du den Berichtstyp gewählt hast, wird dir darunter angezeigt, wie oft pro Woche du einen Bericht dieses Typs anfordern kannst. 
|===
