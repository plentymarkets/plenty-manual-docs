...
In dem Menü kannst du außerdem:

* die Amazon-Berichte zurücksetzen oder überspringen. So kannst du festlegen, welche Berichte zuerst verarbeitet werden sollen oder auch die Auslastung deines Systems reduzieren, indem du Berichte überspringst.
...
[cols="1,3a"]
|===
| Einstellung/Spalte | Erläuterung

| material:search[]
| Führt eine neue Suche aus. +
*_Wichtig:_* Die Liste ist leer, wenn du das Menü öffnest. Die Berichte werden erst angezeigt, wenn du eine Suche ausführst.
...
Das kann zum Beispiel hilfreich sein, falls einmal Daten in deinen Amazon-Berichten fehlen und du deshalb einen neuen Bericht anfordern möchtest.
...
[IMPORTANT]
.Leere Berichte können nicht erstellt werden
====
Falls für den angeforderten Zeitraum des Berichts keine Daten vorliegen, erstellt Amazon auch keinen Bericht. Derzeit kann plentymarkets leider keine Rückmeldung darüber geben, dass ein Bericht nicht generiert werden konnte.
====
