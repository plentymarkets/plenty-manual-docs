...
* Der Zeitraum, über den du Berichte anfordern willst, sollte so klein wie möglich sein, da die Verarbeitung sehr großer Berichte aufgrund der Datenmenge lang dauern kann.
