...
*_Tipp:_* Wurden Aufträge von Amazon in dein System importiert, die du nicht mit plentymarkets eingestellt hast? Oder Aufträge, für die in plentymarkets noch keine Artikel gespeichert sin? Bei diesen Aufträgen kannst du manuell die Artikel zuordnen und den Status einstellen.
====
