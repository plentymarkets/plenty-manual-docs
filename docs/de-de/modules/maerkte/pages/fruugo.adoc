...
* Für Fruugo-Artikeltyp *Media* wird die im Artikel enthaltene *ISBN* beim Export gezogen. +
...
Diese Optionen findest du im Menü *Artikel » Variante » Tab: Einstellungen » Abschnitt: Verfügbarkeit » Einstellung: Mandant*. Wenn diese Optionen eingesetzt werden und der Warenbestand 0 ist, wird die Variante für das Plugin unsichtbar.
