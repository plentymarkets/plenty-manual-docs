...
Shopping.com ist ein internationaler Produkt- und Preisvergleichsdienst. Um Shopping.com in plentymarkets einzurichten, musst du dich zunächst bei link:https://de.shopping.com/[Shopping.com^]{nbsp}icon:external-link[] registrieren.

[#old-export]
== _Möglichkeit 1:_ Exportformat ShoppingCOM-Plugin _(veraltet)_
