...
[TIP]
.Zweiter Lieferauftrag für Artikel, die versendet werden sollen
====
Erstelle einen zweiten Lieferauftrag, der die Auftragspositionen enthält, die versendet (und nicht storniert) werden sollen.
====
