...
* Richte die Schnittstelle zu Zalando wie auf dieser Seite beschrieben in deinem plentymarkets System ein.
...
[#link-zDirect]
=== Konto mit deinem zDirect-Konto verknüpfen lassen

Du hast den Assistenten zum ersten mal durchlaufen und abgeschlossen. Lass nun dein Zalando-Konto freischalten. link:https://forum.plentymarkets.com/t/sammelthema-aktivierung-neuer-zalando-konten/600409[Melde dich in diesem Forum-Thread, um unseren Support zu bitten, die Freischaltung deines Kontos vorzunehmen.]
