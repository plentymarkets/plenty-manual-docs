...
*_Hinweis:_* Deine Variante wird auf Zalando nicht gelöscht, wenn du die Verfügbarkeit entfernst und den Zeitstempel für Marktplatzexporte aktualisierst, sondern lediglich als nicht mehr auf Lager angezeigt.
