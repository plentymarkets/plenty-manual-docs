...
. Nimm die Einstellungen gemäß <<#basic-settings-zalando>> vor.
...
Nutze optional die in <<#table-reference-types>> aufgeführten Filter, um die Suchergebnisse weiter einzugrenzen:
