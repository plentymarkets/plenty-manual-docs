...
a| Zalando Fulfillment Solutions ist ein Service, bei dem Zalando deine Artikel an Kund:innen versendet. Du sendest deine Artikel an Zalando und Zalando übernimmt dann die Lagerung und den Versand deiner Artikel an Kund:innen. +
...
| *Lager zuordnen*
a| Hier ordnest du den Zalando-Standorten (Ländern) Lager aus plentymarkets zu. In jedem Land, das zur Auswahl steht, gibt es ein Zalando Fulfillment-Lager, in dem deine Artikel gelagert werden können. Du ordnest also den Zalando-Lagern Lager in plentymarkets zu. So hast du eine Übersicht darüber, an welchen Zalando-Standorten deine Artikel gerade gelagert werden. Die Bestände aus den Zalando-Standorten werden an deine plentymarkets Lager übertragen. +

Wähle zuerst das plentymarkets Lager, in das standardmäßig Bestände von Zalando übertragen werden sollen. +

Darunter kannst du außerdem den verschiedenen Zalando-Standorten (Ländern) einzelne Lager aus plentymarkets zuordnen. +

*_Beispiel:_* Du kannst zum Beispiel das Lager *Zalando Deutschland* erstellen und den Zalando-Standort *Deutschland* zuordnen, um eine Übersicht darüber zu erhalten, welche Artikel in Deutschland gelagert werden. +

Klicke auf (material:add[]), um eine weitere Zuordnung hinzuzufügen. +

Wenn du keine weiteren Lager zuordnest, werden die Bestände aus allen Zalando-Standorten gesammelt in das oben gewählte plentymarkets Standard-Lager übertragen. +
