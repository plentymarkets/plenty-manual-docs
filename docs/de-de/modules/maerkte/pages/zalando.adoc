...
. <<#more-setup, Nimm die weiteren Einstellungen vor.>>
...
[#add-countries]
== Weiteren Verkaufskanal hinzufügen
...
* Du sendest dein:er Zalando-Ansprechpartner:in die neue API-Route mit der Zusatzinformation, dass alle anderen Daten vom ersten Verkaufskanal übernommen werden sollen. +
...
* Erstelle einen neuen Verkaufspreis oder aktiviere die Herkunft des Verkaufskanals in einem Verkaufspreis für das Land, den es bereits in deinem System gibt.
* Wenn du Österreich, Belgien oder Schweiz neu aktiviert hast, erlaube die Zahlungsart in den gewünschten Kundenklassen.
* Bereite die Auftragsdokumente für den Verkaufskanal vor.
* Aktiviere die Verfügbarkeit für das neue Land an den Varianten, die du auf dem Verkaufskanal anbieten möchtest.
