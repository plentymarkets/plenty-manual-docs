...
| Zustand
| * Im Tab *Global* des Artikels muss im Bereich *Grundeinstellungen* der *Zustand API* gespeichert sein. Beim Export der Angebotsdaten wird der Zustand API automatisch übertragen.

Die plentymarkets Zustände werden wie folgt den bol.com-Zuständen zugeordnet:
