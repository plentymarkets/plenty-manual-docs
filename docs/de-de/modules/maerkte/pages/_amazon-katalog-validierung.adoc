...
:position: 0
:url: maerkte/amazon/katalogexport-pruefen
:id: 307GEZD
...
include::../_textblocks/instructions/BI-catalogue-variationvalidation.adoc[]
...
include::../_textblocks/instructions/BI-catalogue-stockinformation.adoc[]
