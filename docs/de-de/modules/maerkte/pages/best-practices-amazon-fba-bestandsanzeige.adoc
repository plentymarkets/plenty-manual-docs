...
:id: 1X9TX72
:description: In diesem Best Practice erfährst du, wie du den FBA-Gesamtwarenbestand eines Artikels für EU und UK getrennt in deinem plentymarkets System anzeigen kannst. Das heißt, dass du an einem Artikel zwei Lager darstellen kannst, eines für EU und eines für UK.
