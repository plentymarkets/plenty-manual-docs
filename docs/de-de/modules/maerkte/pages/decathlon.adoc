...
Für jede Produktkategorie auf Decathlon gibt es ein eigenes Katalog-Format. In jedem Format werden unterschiedliche Artikeldaten exportiert, je nachdem, welche Informationen Decathlon für eine Produktkategorie benötigt.
...
Artikeldaten werden über Kataloge zu Decathlon exportiert. Um deine Artikel zu {market} zu exportieren, erstellst du im Menü *Daten » Kataloge* einen Katalog. Verknüpfe dann im Katalog die von Decathlon vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Wenn du den Katalog aktivierst hast, werden die Katalogdaten in regelmäßigen Abständen automatisch zu {market} exportiert.
