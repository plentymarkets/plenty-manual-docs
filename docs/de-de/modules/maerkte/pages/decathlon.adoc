...
*_Tipp:_* Wähle hier einen Status, in dem du sicherstellen kannst, dass der Auftrag nicht verschickt wird. Aufträge, die bereits verschickt wurden, können nicht mehr storniert werden.
