...
[#mytoys-versandprofil]
=== Versandprofil erstellen

Erstelle als Nächstes ein Versandprofil für myToys.

[.collapseBox]
.Was ist ein Versandprofil?
--
In einem Versandprofil stellst du Versandmöglichkeiten ein, die deine Kund:innen in der Kaufabwicklung wählen können oder die der Webshop bestimmten Auftragsarten automatisch zuweist. Zum Beispiel kannst du deinen Kund:innen einen günstigen Standardversand und einen Expressversand gegen Aufpreis anbieten.
--
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen in <<#tabelle-versandprofil>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
→ Das Tab *Portotabelle* wird angezeigt.
. Gib in der Portotabelle für Deutschland bei *Pauschales Porto* den Wert *0.00* EUR ein.
. *Speichere* (icon:save[role="green"]) die Einstellungen.

[.collapseBox]
.Einstellungen für Versandprofile
--
[[tabelle-versandprofil]]
...
|Wähle einen Versanddienstleister aus der Dropdown-Liste.
...
| *Kategorie*
|Wähle eine Kategorie aus der Dropdown-Liste. Die Kategorie ermöglicht eine zusätzliche Priorisierung der Versandprofile im Warenkorb. Standardmäßig ist immer Kategorie *1* eingestellt, d.h. alle Versandprofile werden gleichwertig angezeigt. Weitere Informationen sowie ein Beispiel findest du auf der Handbuchseite xref:fulfillment:versand-vorbereiten.adoc#1300[Versand vorbereiten].
...
Weitere Informationen findest du auf der Handbuchseite xref:fulfillment:versand-vorbereiten.adoc#1100[Versand vorbereiten].
...
| *Konto*
|Diese Einstellung ist für eBay und deshalb für dein myToys-Versandprofil nicht relevant.
...
| *Treueprogramm*
|Diese Einstellung ist nur für Amazon und eBay Plus und deshalb für dein myToys-Versandprofil nicht relevant.
|====
--

[discrete]
==== Versandprofil freigeben

Das Versandprofil muss anschließend mit der *Artikel-Gruppenfunktion* für alle Artikel freigegeben werden, die du auf myToys verkaufen willst.

[.instruction]
Versandprofil freigeben:

. Öffne das Menü *Artikel » Artikel bearbeiten*.
. Setze ein Häkchen bei allen Artikeln, die du auf myToys verkaufen willst.
. Klicke auf *Artikel-Gruppenfunktion*.
. Setze im Bereich *Versand* ein Häkchen bei *Versandkonfiguration*.
. Wähle für die Einstellung *Versandkonfiguration* das Versandprofil, das du eben für myToys erstellt hast.
. Klicke auf icon:execute[set=plenty, role="darkGrey"] *Ausführen*, um die Einstellungen an den Artikeln vorzunehmen.
...
Eine Variante wurde schon an myToys übertragen, du möchtest diese Variante aber nicht weiter bei myToys listen? Dann reicht es nicht aus, die Variante vom Export auszuschließen. Stattdessen muss die Variante einmalig als inaktiv übertragen werden. Gehe dazu wie folgt vor:

* Entferne im Tab *Verfügbarkeit* der Variante die Marktplatzverfügbarkeit *myToys*. +
* Damit die Variante als inaktiv übertragen wird, muss im Tab *Eigenschaften* der Variante die Eigenschaft *myToys Kategoriegruppe* verknüpft bleiben.
*_Wichtig:_* Wenn du die Verfügbarkeit später wieder aktivierst, wird die Variante erst mit dem nächsten nächtlichen Artikelexport auf {market} reaktiviert.
...
* Ordne mindestens die *Pflichtfelder* zu. Um nur die Marktplatz-Datenfelder anzuzeigen, die Pflicht sind, klicke in der Symbolleiste auf icon:more_vert[set=material]. Aktiviere dann die Umschaltfläche (icon:toggle-on[role="green"]) *Nur Pflichtfelder anzeigen*. +
...
. Lade die PDF-Vorlage für Lieferscheine von {market} auf deinen Rechner herunter:
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys-20220303/myToys-01-Lieferschein-Vorlage-20220303.pdf[PDF-Vorlage herunterladen (Stand: 03.03.2022)]
...
[.instruction]
Vorlage für Rücksendescheine hochladen:

. Lade die Vorlage für Rücksendescheine von {market} auf deinen Rechner herunter. Du kannst die Vorlage als PDF oder als DOCX herunterladen:
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys-20220303/myToys-retourenschein-mit-gruenden-20220303.pdf[PDF-Vorlage mit Retourengründen herunterladen (Stand: 03.03.2022)]
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys-20220303/myToys-retourenschein-mit-gruenden-20220303.docx[DOCX-Vorlage mit Retourengründen herunterladen (Stand: 03.03.2022)] +
  *_Wichtig:_* Speichere diese Vorlage als PDF-Datei, nachdem du sie fertig bearbeitet hast.
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys-20220303/myToys-retourenschein-ohne-gruenden-20220303.pdf[PDF-Vorlage ohne Retourengründe herunterladen (Stand: 03.03.2022)]
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/myToys-20220303/myToys-retourenschein-ohne-gruenden-20220303.docx[DOCX-Vorlage ohne Retourengründe herunterladen (Stand: 03.03.2022)] +
  *_Wichtig:_* Speichere diese Vorlage als PDF-Datei, nachdem du sie fertig bearbeitet hast.
...
. Klicke auf *Vorlage hochladen* (icon:save[set=plenty]). +
→ Die Vorlage wird hochgeladen. +
*_Tipp:_* Passe im selben Menü auch gleich die Vorlage für {market}-Rücksendescheine an. Wie das geht, ist im nächsten Kapitel beschrieben.

[#1150-1]
==== Vorlage für Rücksendescheine anpassen

Rücksendescheine für {market}-Aufträge müssen zusätzlich zum {market}-Logo die folgenden Angaben enthalten:

* EAN
* Externe Auftragsnummer
* Externe Kundennummer

Außerdem dürfen auf {market}-Rücksendescheinen keine Preise angezeigt werden.

Damit diese Vorgaben auf den Rücksendescheinen berücksichtigt werden, passt du die Vorlage für Rücksendescheine wie unten beschrieben an.
...
. Speichere (icon:save[set=plenty]) die Einstellungen. +
→ Die nötigen Angaben werden auf Rücksendescheinen angezeigt.

[[table-return-notes]]
.Einstellungen für {market}-Rücksendescheine
[cols="2,3a"]
|===
|Einstellung |Option
