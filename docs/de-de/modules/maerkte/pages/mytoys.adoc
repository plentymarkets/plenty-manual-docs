...
[TIP]
.Umgang mit Rechnungen bei MyToys
====
Rechnungen werden von MyToys erstellt und an deine Kund:innen versendet. Da MyToys nur Sammelrechnungen erstellt, kannst du diese nicht importieren. Für die Buchhaltung benötigst du jedoch die Rechnungen von MyToys. +
Damit Rechnungen für MyToys dennoch in deinem Export für die Buchhaltung enthalten sind, musst du deshalb eigene Rechnungen für MyToys erstellen. Dann verbuchst du die Rechnungen von MyToys mit den selbst erstellten Rechnungen.
====
...
Gehe wie unten beschrieben vor, um eine xref:auftraege:auftragsdokumente.adoc#1700[PDF-Vorlage] für Rücksendescheine für {market} in plentymarkets hochzuladen.
