...
. Nimm weitere Einstellungen gemäß der Tabelle auf der Seite xref:artikel:preise.adoc#400[Verkaufspreise und Preiskalkulation] vor.
. Speichere (icon:save[set=plenty]) die Einstellungen.
...
. Wähle das *Amazon-Konto*, das für Amazon B2B freigeschaltet ist.
. Nimm weitere Einstellungen gemäß der Seite xref:artikel:preise.adoc#400[Verkaufspreise und Preiskalkulation] vor.
. Speichere (icon:save[set=plenty]) die Einstellungen.
