...
3. Schließe den Assistenten wie gewohnt ab.
4. Überprüfe, ob in deinem METRO-Dashboard ein Angebot für den betreffenden Artikel vorhanden ist. +
*_Hinweis:_* Du kannst ein Angebot auch manuell über das METRO-Dashboard erstellen.
6. Stelle sicher, dass die SKU im Artikel auf beiden Systemen gleich ist. +
*_Hinweis:_* Du kannst SKU-Bulk-Zuordnungen auf METRO erstellen, indem Du *Angebote verwalten* öffnest. Für weitere Informationen wende dich an deinen METRO-Support.
--
