= Amazon: MFN nutzen
:keywords: Amazon MFN, MFN
:description: Multi-Channel in plentymarkets: Eigener Versand von Amazon-Aufträgen mit MFN.
:page-aliases: amazon-mfn-nutzen.adoc
:author: team-plenty-channel
:description: Auf dieser Seite erfährst du, wie du Amazon MFN in plentymarkets einrichtest. MFN bedeutet Händlerversand - du lagerst und versendest deine Artikel selbst.

include::page$amazon-fulfillment.adoc[tag=amazon-mfn-description]

[.collapseBox]
.Ablauf von MFN-Aufträgen
--
include::page$amazon-fulfillment.adoc[tag=amazon-mfn-workflow]
--

include::partial$amz-einrichtungsmenue.adoc[tag=amazon-mfn-video]
...
Gehe wie unten beschrieben vor, um Amazon MFN in deinem plentymarkets System einzurichten.


[#60]
=== Lager für Amazon FBA erstellen

Erstelle zunächst Lager, die für Amazon Fulfillment-Aufträge verwendet werden sollen. Dabei musst du für jedes Amazon-Logistiklager, an das du Waren sendest, auch ein Lager in plentymarkets erstellt werden. Nur so bleibt die komplette Funktionalität der Warenwirtschaft auch beim FBA-Programm erhalten und du behältst die Lagerbestände bei Amazon über dein plentymarkets System im Blick.
...
Klicke dazu auf die Schaltfläche *Bestätigung stornieren*. Der Auftrag erhält nach der erfolgreichen Stornierung wieder den Status _In Arbeit_.
...
. Klicke auf den Auftrag. +
→ Die Optionen für die Auftragsbearbeitung werden angezeigt.
. Klicke auf *Bestätigung stornieren*. +
...
====
Amazon generiert Berichte nur einmal täglich. Artikel werden aber nach bis zu 2 Tagen versendet. Deshalb sind FBA-Aufträge erst mit einer zeitlichen Verzögerung in deinem System verfügbar. Die von Amazon generierte Auftragsbestätigung ist in der Regel zwei Tage nach Versand der Ware in deinem System verfügbar, also insgesamt bis zu 4 Tage nach Bestellung der Ware durch Käufer:innen. Die Lieferpünktlichkeit wird davon jedoch nicht berührt und erfolgt in der von Amazon gewohnten Schnelligkeit.
====

[#30]
=== FBA-Outbound-Teillieferungen

Amazon FBA-Teillieferungen werden von Amazon veranlasst, wenn sich die von Amazon Outbound-Auftrag versendete Ware in unterschiedlichen Amazon-Lagern befindet. Bei den Kund:innen kommen nach Bestellung also mehrere Pakete zu einem getätigten Auftrag an.
