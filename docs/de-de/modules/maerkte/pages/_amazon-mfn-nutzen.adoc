...
include::amazon-fulfillment.adoc[tag=amazon-mfn-description]

[.collapseBox]
.Ablauf von MFN-Aufträgen
--
include::amazon-fulfillment.adoc[tag=amazon-mfn-workflow]
--

include::../_textblocks/instructions/amz-einrichtungsmenue.adoc[tag=amazon-mfn-video]
