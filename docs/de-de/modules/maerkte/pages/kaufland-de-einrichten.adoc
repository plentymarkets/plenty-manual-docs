...
| *Angebotsabgleich*
a| Aktivieren, wenn Angebote zu Kaufland übertragen und auf Kaufland aktualisiert werden sollen. Angebote werden stündlich und täglich bei Kaufland.de aktualisiert. +
