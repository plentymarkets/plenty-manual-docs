...
{market} verlangt bestimmte Pflichtangaben. Das bedeutet, dass nur Varianten an den Marktplatz exportiert werden, für die diese Angaben gespeichert sind. Für einen funktionierenden Export zu {market} muss die Variante die folgenden Kriterien erfüllen:
