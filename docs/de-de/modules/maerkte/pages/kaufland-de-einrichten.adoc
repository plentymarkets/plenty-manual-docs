...
Mit dem Export über Kataloge machst du deinen Artikelexport zukunftssicher und flexibel. Mit dem Katalogexport werden Artikeldaten über ein Katalog-Format zu Kaufland exportiert. Kataloge erstellst du im Menü *Daten » Kataloge*.
...
Artikeldaten werden über ein Marktplatz-Format zu Kaufland exportiert. Um deine Artikel zu {market} zu exportieren, erstellst du im Menü *Daten » Kataloge* ein Katalog-Format. Verknüpfe dann im eben erstellten Format die von Kaufland vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Wenn du den Katalog aktiviert hast, werden die Katalogdaten einmal täglich automatisch zu {market} exportiert.

Für jede Produktkategorie auf Kaufland gibt es ein eigenes Katalog-Format. In jedem Format werden unterschiedliche Artikeldaten exportiert, je nachdem, welche Informationen Kaufland für eine Produktkategorie benötigt. In dem Format für *Lebensmittel* müssen beispielsweise andere Artikeldaten verknüpft werden als in dem Format für *Auto & Motorrad*. Du musst also für jede Produktkategorie von Kaufland, in der du Artikel verkaufen möchtest, ein eigenes Katalog-Format erstellen.

// Template-Name prüfen
:catalogue-template-name: Kaufland
