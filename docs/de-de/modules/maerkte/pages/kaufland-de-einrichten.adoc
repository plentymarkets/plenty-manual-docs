...
| *Mehr* (material:more_vert[])
| Hier klicken, um weitere Aktionen anzuzeigen. +

[cols="1,3a"]
!===
2+! *Artikeleinstellungen* (material:settings[])

! *Artikel aktualisieren* (material:refresh[])
...
! *Artikelvorschau* (material:preview[])
...
! *Artikel zu Kaufland.de übertragen* (material:playlist_play[])
! Produktdatei zu Kaufland.de übertragen.

2+! *Angebotseinstellungen* (material:settings[])

! *Angebote aktualisieren* (material:refresh[])
! Erstellt eine Angebotsdatei. Diese kann über *Vorschau der Angebote* (material:preview[]) angesehen werden.

! *Vorschau der Angebote* (material:preview[])
! Vorschau der Angebotsdatei anzeigen.

! *Angebote zu Kaufland.de übertragen* (material:playlist_play[])
