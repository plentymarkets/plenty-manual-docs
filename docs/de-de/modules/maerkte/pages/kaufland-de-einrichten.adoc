...
Artikeldaten werden über einen Katalog zu Kaufland exportiert. Kataloge für Kaufland erstellst du mit dem Assistenten *Kaufland - Kataloge erstellen* im Menü *Einrichtung » Assistenten » Omni-Channel*. Verknüpfe anschließend im eben erstellten Katalog die von Kaufland vorgegebenen Felder mit in plentymarkets gespeicherten Artikeldaten. Wenn du den Katalog aktiviert hast, werden die Artikeldaten einmal täglich automatisch zu {market} exportiert.

Für jede Produktkategorie auf Kaufland gibt es ein eigenes Katalog-Format. In jedem Format werden unterschiedliche Artikeldaten exportiert, je nachdem, welche Informationen Kaufland für eine Produktkategorie benötigt. In dem Format für *Lebensmittel* müssen beispielsweise andere Artikeldaten verknüpft werden als in dem Format für *Auto & Motorrad*. Du musst also für jede Produktkategorie von Kaufland, in der du Artikel verkaufen möchtest, einen eigenen Katalog erstellen.
...
* *Wie soll der Katalog für diese Kaufland-Kategorie heißen? Der Name wird im Menü Daten » Kataloge angezeigt und nicht zu Kaufland exportiert.*
...
* *Wähle eine Kaufland-Länderplattform.*
Hier wählst du die Kaufland-Länderplattform, für die ein Katalog erstellt werden soll. Die Artikeldaten in diesem Katalog werden nur an diese Länderplattform exportiert. Du kannst also für verschiedene Länder verschiedene Kataloge mit unterschiedlichen Artikeldaten erstellen. +
Die verfügbaren Länderplattformen werden in Länder-Codes angegeben, zum Beispiel *DE* für *Deutschland*. +
*_Hinweis:_* Momentan ist nur die Länderplattform *Deutschland (DE)* verfügbar.

* *Wähle eine Kaufland-Produktkategorie.*
Hier wählst du die Produktkategorie, für die ein Katalog erstellt werden soll. Für jede Produktkategorie, in der du deine Artikel auf Kaufland anbieten möchtest, muss ein eigener Katalog erstellt werden. Du erstellst also zum Beispiel verschiedene Kataloge für die Kategorien *Lebensmittel* und *Auto & Motorrad*. 
--
