...
| *_Hinweis:_* Diese Einstellung ist nur nach der Umstellung relevant, mit der mehrere Konten für Kaufland eingerichtet werden können. +
Diese Option ist für das erste Konto automatisch aktiviert. So ist sichergestellt, dass Aufträge, die vor der Umstellung auf Kaufland generiert wurden, in deinem plentymarkets System verarbeitet werden können. +
Mit dieser Einstellung werden alle Einstellungen deines Kaufland-Kontos auf das erste neue Konto übertragen. Das bedeutet, dass nach der Umstellung auf mehrere Konten automatisch ein Konto mit deinen alten Einstellungen erstellt wird. +
Wenn du eine Konfiguration für ein neues Konto erstellst, ist standardmäßig *Nein* eingestellt.
...
| *Versandbestätigungen senden über*
| Bisher wurden Versandbestätigungen über einen stündlichen Cron an Kaufland gesendet. Dieser Cron wird aber Anfang Juni 2022 abgeschaltet. Richte deshalb jetzt die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> ein und stelle die Option dann auf *Ereignisaktion*.

[cols="1,3"]
!===
! *stündlichen Cron*
! Der stündliche Cron wird Anfang Juni 2022 abgeschaltet. Richte deshalb jetzt die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> ein. Stelle die Option *Versandbestätigungen senden über* dann auf *Ereignisaktion*.

! *Ereignisaktion* +
(empfohlen)
! Versandbestätigungen werden über die Ereignisaktion <<#shipping-confirmation, Versandbestätigung an Kaufland.de senden>> gesendet.
!===
...
* *_Wichtig:_* Diese Ereignisaktion ist nur aktiv, wenn die Einstellung *Versandbestätigungen senden über* auf die Option *Ereignisaktion* gestellt ist. Diese Einstellung findest du im Menü *Einrichtung » Märkte » Kaufland.de » Einstellungen*.
