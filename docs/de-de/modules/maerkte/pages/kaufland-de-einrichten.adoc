...
* *_Wichtig:_* Diese Ereignisaktion ist nur aktiviert, wenn die Einstellung *Versandbestätigungen senden über* auf die Option *Ereignisaktion* gestellt ist. Diese Einstellung findest du im Menü *Einrichtung » Märkte » Kaufland.de » Einstellungen*.
