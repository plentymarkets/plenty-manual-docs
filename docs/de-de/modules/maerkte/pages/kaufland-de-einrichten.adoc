...
| *Ja* = Aufträge werden entweder als bezahlt importiert. +
...
*_Hinweis:_* Wenn du die Kaufland-Versandgruppen aktualisierst, wird die Seite neu geladen. Nicht gespeicherte Änderungen gehen dadurch verloren. Speichere also zuerst alle Änderungen, bevor du die Kaufland-Versandgruppen aktualisierst. +
