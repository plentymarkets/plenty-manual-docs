...
Stelle jedoch sicher, dass du alle Varianten, die du auf Kaufland verkaufen möchtest, mit einem Kaufland-Katalog verknüpft hast, bevor du diese Einstellung deaktivierst. Wenn die Variante nicht mit einem Kaufland-Katalog verknüpft ist, wird sie nicht zu Kaufland exportiert.
