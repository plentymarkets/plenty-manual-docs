...
| Wählen, welcher Text als Kommentar an deinen Artikeln auf Kaufland angezeigt werden soll. +
...
| Beliebigen Text eingeben. Der eingegebene Text wird bei jedem Angebot auf Kaufland angezeigt.
