...
====
Du möchtest Artikeldaten an Kaufland übertragen, für die es im Katalog des Marktplatzes kein Datenfeld gibt? In den Kaufland-Katalogen hast du die Möglichkeit, eigene Datenfelder zu erstellen und mit den in plentymarkets gespeicherten Artikeldaten verknüpfen. Wie das geht, ist <<#eigene-datenfelder-zuordnen, hier>> beschrieben.
====
