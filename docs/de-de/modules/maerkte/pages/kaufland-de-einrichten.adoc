...
====
Momentan kann es passieren, dass der Auftragsimport für Aufträge der Marktplätze CZ (Tschechien) und SK (Slowakei) nicht funktioniert. Deshalb muss der Auftragsimport manuell angestoßen werden. Dazu müssen die Einstellungen für Kaufland neu gespeichert werden. Führe dazu die folgenden Schritte aus:
...
*_Hinweis:_* Beachte, dass der Marktplatz Kaufland CZ (Tschechien) noch nicht eröffnet wurde. Das heißt, dass auch noch keine Aufträge auf dem Marktplatz generiert werden.
====
...
Beachte jedoch, dass Kaufland den Marktplatz in Tschechien noch nicht eröffnet hat. Du kannst deine Artikel dort bereits listen, jedoch noch nicht verkaufen.
====
...
*_Hinweis:_* Aus rechtlichen Gründen wird die Zahlungsart auf Rechnungen für Kaufland als *Zahlung über real.de* angezeigt.
