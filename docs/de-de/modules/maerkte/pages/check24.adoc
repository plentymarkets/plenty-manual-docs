...
====
Nachdem du Check24 in plentymarkets eingerichtet hast, findet der Datenaustausch in den folgenden Intervallen statt: +
...
====
Für Check24 gibt es die Katalog-Formate *Check24*, *Check24 Offer* und *Check24 Fashion*. +
Das Format *Check24 Offer* enthält Angebotsdaten. +
Das Katalog-Format *Check24* enthält Produktdaten. +
Das Katalog-Format *Check24 Fashion* ist veraltet, da es die Fashion-Kategorie auf Check24 nicht mehr gibt. Es sollte nur in Ausnahmefällen und in Absprache mit Check24 genutzt werden. +
