...
Du kannst bei CHECK24 zwischen Angebots- und Produktdaten unterscheiden. Dafür sieht CHECK24 drei unterschiedliche Exportformate vor – den Angebotsdaten-Export *CHECK24 Offer*, den Produktdaten-Export *CHECK24* und den Artikeldaten-Export *CHECK24 Furniture*.

Das Sortiment bei CHECK24 umfasst unter anderem die folgenden Produktekategorien: Möbel, Kinder-Möbel, Garten-Möbel, Beleuchtung, Heimtextilien, Dekoration, ausgewähltes Outdoorspielzeug, Bestecke, Teller.
...
Du kannst Kataloge über zwei Varianten exportieren:

* Variante 1: *CHECK24 Offer* und *„*CHECK24*
* Variante 2: *CHECK24 Furniture*
 
*_Tipp:_* Der Furniture-Katalog enthält die meisten Attribute. Durch den Furniture-Katalog kann CHECK24 deine Produkte am ausführlichsten für deine Kunden darstellen.
...
Wenn du dich für die Kombination *CHECK24 Offer* und *CHECK24* entscheidest, musst du zwei URLs erzeugen. Damit CHECK24 alle Produktinformationen abrufen kann übergibst du beide URLs an CHECK24. Um die URL aus dem Katalog-Format *CHECK24 Offer* zu übergeben speicherst du die URL in deinem CHECK24-Konto. Die URL aus dem Katalog-Format *CHECK24* schickst du deinem CHECK24-Ansprechpartner per E-Mail.
