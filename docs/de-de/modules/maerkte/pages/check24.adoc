...
Bevor du CHECK24 in plentymarkets einrichtest, musst du dich bei link:https://mc.moebel.CHECK24.de/register[CHECK24^] registrieren.
...
Zusätzlich zum Angebots- und Produktexport, gibt es den Katalog *CHECK24-Furniture*. Das Katalog-Format *CHECK24-Furniture* enthält Artikeldaten für die CHECK24-Kategorie _Möbel_.
In dem Katalog-Format kannst du die folgenden Produktekategorien anbieten: Erwachsenen-Möbel, Kinder-Möbel, Garten-Möbel, Beleuchtung, Heimtextilien, Dekoration, ausgewähltes Outdoorspielzeug, Bestecke, Teller.
...
Die Schnittstelle zwischen Plentymarkets und CHECK24 kann aktuell Versandbestätigungen übermitteln. Dazu musst du eine automatische E-Mail erstellen und den automatischen E-Mail-Versand einrichten. Die E-Mail schickst du an die angezeigte Alias-E-Mail-Adresse. 

=== Automatischen E-Mail-Versand einrichten

Um den automatischen Email-Versand einzurichten, gehe vor wie folgt:
...
4. Im Dropdown-Menü _Ereignis_, stelle _Warenausgang gebucht_ ein.
5. Klicke auf _Filter_.
...
== Abschließende Informationen für dein Onbording bei CHECK24

Um dein Onboarding erfolgreich abzuschließen, benötigt CHECK24 deine Antworten auf die folgenden Fragen. Bitte sende deine Antworten an deinen Ansprechpartner bei CHECK24.

=== Fragen

1. Welche Preise übermittelst du CHECK24 (Shop-Preise, Shop-Preise und Provision etc.)?
2. Wird der Feed künftig erweitert?
3. Welche Artikel sind deine Bestseller (erstellt das CHECK24-Content-Team zuerst)?
4. Handelt es sich um einen echten Bestand im Feed?
5. Wie oft wird der Feed aktualisiert?
6. Wie häufig werden Bestellungen abgerufen?
