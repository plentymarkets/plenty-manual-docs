...
*_Hinweis:_* Zusätzlich zu den beiden oben genannten Katalog-Formaten gibt es auch das Format *Check24 Fashion*. Da es die Fashion-Kategorie bei Check24 jedoch nicht mehr gibt, ist das Format veraltet und sollte deshalb nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden.
...
* *Check24 Fashion*: Dieses Katalog-Format ist veraltet, da es die Fashion-Kategorie auf Check24 nicht mehr gibt. Es sollte nur in Ausnahmefällen und in Absprache mit Check24 genutzt werden.
...
*_Hinweis:_* Zusätzlich zu dem Exportformat *Check24DE-Plugin* gibt es das Exportformat *Check24DE Fashion*. Dieses Exportformat ist jedoch veraltet, da es die Fashion-Kategorie auf Check24 nicht mehr gibt. Das Exportformat *Check24DE Fashion* sollte deshalb nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden.
...
*_Hinweis:_* Das Exportformat *Check24DE Fashion* erstellst du auf die gleiche Weise. Beachte aber, dass dieses Exportformat veraltet ist und nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden sollte.
...
. Nimm die Formateinstellungen vor. Beachte dazu die Erläuterungen in <<#einstellungen-artikelexport-check24>> bzw. für *Check24DE Fashion* in <<#einstellungen-artikelexport-check24-fashion>>. +
...
*_Hinweis:_* Das Exportformat *Check24DE Fashion* ist veraltet, da es die Fashion-Kategorie auf Check24 nicht mehr gibt. Deshalb sollte dieses Exportformat nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden.

Die folgende Tabelle enthält Informationen zu den Einstellungen für *Check24DE Fashion*.
...
| *Vorschautext*
| Wählen, welcher Text als Vorschautext übertragen werden soll. +
...
[discrete]
==== Check24DE: Verfügbare Spalten der Exportdatei *Check24DE Fashion*
...
[.collapseBox]
.Verfügbare Spalten der Exportdatei für das Exportformat *Check24DE Fashion*
--
[[spalten-exportdatei-check24]]
.Verfügbare Spalten der Exportdatei
[cols="1,3a"]
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Produktname*
...
* eine Zeichenkette gemäß "Parent-SKU"-"Attributswert-ID", wenn ein Farb-Attribut an der Variante gespeichert ist
...
| Kategorie-Pfad +
(Pflichtangabe)
| * Kategoriepfad der Standard-Kategorie des Mandanten, der in den Einstellungen gewählt wurde 

_oder_ 

* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Kategorie-Pfad*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Kurzbeschreibung*

*_Hinweis:_* Merkmale werden bevorzugt.
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Ausführliche Beschreibung*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *EAN*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *MPNR*

*_Hinweis:_* Merkmale werden bevorzugt.

| SKU
| * *SKU* der Variante für Check24.de mit Account-ID *0*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *UPC*

*_Hinweis:_* Merkmale werden bevorzugt.

| Bild-URL #1 - #20
| * URL-Pfad der Artikelbilder entsprechend der Formateinstellung *Bild* +
Wenn Farbvariationen vorliegen, werden nur die Bilder, die mit der jeweiligen Variante verknüpft sind, übertragen. Ansonsten werden alle Bilder exportiert.
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Größe*

*_Hinweis:_* Attribute werden bevorzugt.
...
| Marke +
(Pflichtangabe)
| * *Herstellername* des Artikels 

_oder_

* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Marke* 

*_Hinweis:_* Der *Externe Name* unter *Einrichtung » Artikel » Hersteller* wird bevorzugt, wenn vorhanden.
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Material*
...
| Absatzhöhe
| * Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Absatzhöhe*

*_Hinweis:_* Am Artikel sowohl das Maß als auch die Maßeinheit als Merkmalwert eintragen. Beispiel: "2 cm"
...
| Schafthöhe
| * Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Schafthöhe*

*_Hinweis:_* Am Artikel sowohl das Maß als auch die Maßeinheit als Merkmalwert eintragen. Beispiel: "5 cm"

| Schaftweite
| * Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Schaftweite*

*_Hinweis:_* Am Artikel sowohl das Maß als auch die Maßeinheit als Merkmalwert eintragen. Beispiel: "5 cm"

| Weite
| * Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Weite*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Muster*
...
* Merkmal des Typs *Text* oder *Auswahl* mit der *Check24 Fashion-Merkmal*-Verknüpfung *Herstellerfarbe*
...
Angebote sind auf Check24 nur sichtbar, wenn es für eine Variante mindestens ein aktives Angebot gibt. Wenn also eine Variante nicht mehr im Angebotsexport enthalten ist oder mit dem Bestand *0* an Check24 übertragen wird, wird zu dieser Variante auch kein Angebot mehr auf Check24 angezeigt. Check24 empfiehlt, Varianten, die dauerhaft nicht mehr verfügbar sind, aus dem Angebotsexport zu entfernen, statt sie mit dem Bestand *0* zu übertragen. Um Varianten aus dem Angebotsexport zu entfernen, deaktiviere wie unten beschrieben die Verfügbarkeit des Marktplatzes in der Variante.
