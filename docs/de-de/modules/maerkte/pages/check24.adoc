...
Für den Angebotsexport wird das Format *Check24 Offer* verwendet. +
Für den Produktexport werden die Formate *Check24* und *Check24 Fashion* verwendet. Diese Formate sind jedoch veraltet und sollten nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden.
