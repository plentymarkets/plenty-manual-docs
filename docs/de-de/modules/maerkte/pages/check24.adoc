...
=== Automatischen E-Mail-Versan einrichten
...
2. Füge eine Ereignisaktion hinzu.
3. Nenne das Ereignis _Warenausgang gebucht_.
4. Klicke auf Filter.
5. Setze ein Häckchen bei _Check24_.
6. Klicke im Feld _Aktionen_ auf das Plus-Icon.
7. Unter E-Mail versenden, klicke auf das Plus-Icon.

Du hast den Auftrag eingerichtet eine Versandbestätigung an den Kunden zu versenden.
