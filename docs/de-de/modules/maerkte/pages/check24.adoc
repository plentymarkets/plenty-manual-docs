...
=== _Möglichkeit 1:_ Artikelexport mit zwei Datenfeeds _(empfohlene Methode)_

Bei der Testbestellung benötigt CHECK24 deine automatisch generierten E-Mails (Eingangs-, Versand-, Stornobestätigung). Die Versandbestätigung sollte einen Trackinglink enthalten. Wenn du bei der Testbestellung keinen Trackinglink oder eine Sendungsnummer vorliegen hast, kannst du CHECK24 die Sendnungsinformationen einer anderen Bestellung zukommen lassen.

*_Hinweis:_* Die Bestellung bitte nicht verschicken! Sobald CHECK24 alle E-Mails erhalten und von eine Rückmeldung von dir erhalten hat, wird die Bestellung aus dem System entfernt.

Schicke CHECK24 zwei Datenfeeds – CHECK24 Offer und CHECK24 Furniture.
...
Wenn du dich für zwei Feeds entscheidest hinterlege den Link zum Angebotsfeed im CHECK24-Portal. Schicke den zweiten Feedlink an deinen CHECK24-Ansprechpartner. CHECK24 wird den zweiten Link dann für dich hinterlegen.
