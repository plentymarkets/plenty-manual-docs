...
[discrete]
==== Unterscheidung zwischen Angebotsexport und Produktexport bei Check24

Bei Check24 wird zwischen Angebotsdaten und Produktdaten unterschieden. Deswegen gibt es bei Check24 zwei verschiedene Exporte: den Angebotsexport und den Produktexport. Für den Angebotsexport wird das Format *Check24 Offer* verwendet. Für den Produktexport werden die Formate *Check24* und *Check24 Fashion* verwendet. Diese Formate sind jedoch veraltet und sollten nur in Ausnahmefällen und in Absprache mit Check24 verwendet werden.
...
Du kannst bei Check24 nur _eine_ URL speichern. Um sicherzustellen, dass alle Daten an Check24 übertragen werden, die für den Verkauf deiner Artikel benötigt werden, solltest du deshalb die URL des _Angebotsexports_ (Katalog-Format *Check24 Offer*) bei Check24 speichern. +
Wenn du trotzdem die Formate *Check24* und *Check24 Fashion* verwenden möchtest, dann kontaktiere deine Ansprechpartner:innen bei Check24. Sie können die URL für diese Formate für dich bei Check24 hinterlegen.
...
====
Für Check24 gibt es die Katalog-Formate *Check24*, *Check24 Fashion* und *Check24 Offer*. +
Das Format *Check24 Offer* enthält Angebotsdaten, die benötigt werden, um deine Artikel auf Check24 zu verkaufen. Um deine Artikeldaten an Check24 zu übertragen, solltest du deshalb das Katalog-Format *Check24 Offer* verwenden. +
Die Katalog-Formate *Check24* und *Check24 Fashion* enthalten Produktdaten. Diese Formate sind jedoch veraltet und sollten nur in Ausnahmefällen und in Absprache mit Check24 genutzt werden.
====
...
--
*_Hinweis:_* Das Katalog-Format *Check24* ist veraltet und sollte nur in Ausnahmefällen verwendet werden. Wenn du das Format dennoch verwenden willst, wende dich an Check24. Die URL für dieses Katalog-Format muss von deinen Ansprechpartner:innen in deinem Konto bei Check24 gespeichert werden.
...
--
*_Hinweis:_* Wir empfehlen, das Katalog-Format *Check24 Offer* für den Artikeldatenexport zu verwenden.
...
*_Hinweis:_* Du musst die URL des Katalog-Formats *Check24 Offer* bei Check24 speichern. Dieses Katalog-Format enthält die Daten, die Check24 benötigt, damit deine Artikel auf Check24 verkauft werden können.
