...
Nachdem du das Plugin installiert und eingerichtet hast, stehen die in <<#datenaustausch>> gelisteten automatisierten Abläufe bereit:
...
| Auftragsimport
| stündlich +
*_Hinweis:_* Aufträge werden mit dem *Status [5] Freigabe Versand* importiert. Als Rechnungsadresse wird immer Check24 übermittelt. Die Adresse von Kund:innen dient nur als Lieferadresse.
|====
////
...
--
include::_textblocks/catalogues/recommended-mappings/check24fashion-recommended-mappings.adoc[]
--
