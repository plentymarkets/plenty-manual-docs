...
[#500]
=== _Möglichkeit 2:_ Elastischer Export _(alte Methode)_
...
.Verfügbare Spalten der Exportdatei *Check24DE-Plugin*
[cols="1,3a"]
|===
...
[[spalten-exportdatei-check24]]
.Verfügbare Spalten der Exportdatei *Check24DE Fashion*
[cols="1,3a"]
|===
| Spaltenbezeichnung | Erläuterung
