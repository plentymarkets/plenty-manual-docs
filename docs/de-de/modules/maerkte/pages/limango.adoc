...
Um limango in plentymarkets nutzen zu können, installiere zunächst das link:https://marketplace.plentymarkets.com/limango_7023[limango-Plugin^] in deinem plentymarkets System. Dieses und andere Plugins findest du im link:https://marketplace.plentymarkets.com/[plentyMarketplace^]{nbsp}icon:external-link[].
...
| Material +
(Pflichtangabe bei Produkten mit mind. 80 % Textilanteil)
