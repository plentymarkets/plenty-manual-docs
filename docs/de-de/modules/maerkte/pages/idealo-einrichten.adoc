...
Wenn du eine Variante, die in plentymarkets Bestand hat, nicht mehr auf idealo verkaufen möchtest, musst du an der Variante die Verfügbarkeit für den Marktplatz entfernen.
