...
:market: dem idealo Preisvergleich
...
[#catalogue-export]
=== _Möglichkeit 1:_ Katalogexport
...
Wenn du den Katalog aktivierst hast, werden die Artikeldaten in regelmäßigen Abständen automatisch zu idealo exportiert.
