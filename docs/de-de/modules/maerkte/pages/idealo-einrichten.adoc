...
| *Ereignis*
| Ereignis wählen, zum Beispiel *Statuswechsel*. Wähle hier den im xref:maerkte:idealo-einrichten.adoc#intable-status-cancellation-by-buyer[Assistenten festgelegten Status] für Aufträge, für die Kund:innen eine Stornierung angefragt haben.
|
