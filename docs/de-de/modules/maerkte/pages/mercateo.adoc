...
====
Die Integration von Mercateo wird zum 16.01.2023 abgeschaltet. Das heißt, dass plentymarkets den Marktplatz dann nicht mehr unterstützt. Du kannst deine Artikel also nicht mehr mit plentymarkets auf Mercateo verkaufen und es werden keine Mercateo-Aufträge mehr in dein System importiert. Weitere Informationen hierzu findest du im link:https://forum.plentymarkets.com/t/abschaltung-einiger-marktplatzintegrationen-zum-16-01-2023/701086[Forum^].
====
