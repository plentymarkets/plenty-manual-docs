...
*_Hinweis:_* Wenn Amazon eine neue Version der Flatfile veröffentlicht, muss auch ein neuer Katalog erstellt werden. Die gute Nachricht ist: Du kannst den Katalog mit der alten Flatfile-Version einfach und schnell <<daten/daten-exportieren/kataloge-verwalten#80, kopieren und anpassen>>.
...
* Richte die Amazon-Konten ein, die du benötigst. Wie das geht, ist auf der Handbuchseite <<maerkte/amazon/amazon-einrichten#, Amazon einrichten>> beschrieben.
* Bereite deine Varianten für den Export zu Amazon vor. Die nötigen Informationen dazu findest du auf der Seite <<maerkte/amazon/varianten-vorbereiten#, Varianten vorbereiten>>.
...
*_Hinweis:_* Erstelle <<crm/kontakte-verwalten#15, die nötigen Kundenklassen>> im Voraus, falls sie nicht schon in deinem plentymarkets System vorhanden sind.
--
...
*_Hinweis:_* Nur Flatfiles für die Plattformen werden angezeigt, die für das Amazon-Benutzerkonto aktiviert sind, das du in Schritt 1 gewählt hast. Aktiviere bei Bedarf <<maerkte/amazon/amazon-einrichten#300, weitere Plattformen für das Amazon-Benutzerkonto>>.

| *Amazon-Plattform* +
(wird nach Wählen einer Flatfile eingeblendet)
| Amazon-Plattform aus der Dropdown-Liste wählen. +
*_Hinweis:_* Nur Amazon-Plattformen werden angezeigt, die für das Amazon-Benutzerkonto aktiviert sind, das du in Schritt 1 gewählt hast. Aktiviere bei Bedarf <<maerkte/amazon/amazon-einrichten#300, weitere Plattformen für das Amazon-Benutzerkonto>>.
