...
*_Hinweis:_* Wenn Amazon eine neue Version der Flatfile veröffentlicht, muss auch ein neuer Katalog erstellt werden. Die gute Nachricht ist: Du kannst den Katalog mit der alten Flatfile-Version einfach und schnell xref:daten:kataloge-verwalten.adoc#80[kopieren und anpassen].
...
* Bevor du deinen ersten Amazon-Katalog erstellst, mache dich damit vertraut, xref:daten:kataloge-verwalten.adoc#[wie Kataloge in plentymarkets funktionieren].
...
*_Hinweis:_* Erstelle xref:crm:kontakte-verwalten.adoc#15[die nötigen Kundenklassen] im Voraus, falls sie nicht schon in deinem plentymarkets System vorhanden sind.
--
...
* xref:maerkte:faq-sammlung.adoc#[Liste der FAQs und Lösungen]
