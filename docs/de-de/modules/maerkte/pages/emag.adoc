...
[#JRFA6MUV]
== Ablauf der Produktveröffentlichung


Wer das Produkt als erstes auf dem {market}-Marktplatz listet ist Eigentümerin. Nur Eigentümer:innen dürfen die Artikeldaten dieses Produkts aktualisieren.

[#JRFF5MUV]
== Ablauf bei neuen Produkten

*_Szenario 1:_* Du möchtest ein Produkt auf {market} listen, das noch niemand sonst auf dem Marktplatz anbietet.
...
*_Szenario 2:_* Du möchtest ein Produkt auf {market} listen, das schon auf dem Marktplatz angeboten wird.
