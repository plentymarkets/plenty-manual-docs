...
image::assets/rewe-aktionspreis-beispiel.png[]
--
====
...
Richte <<automatisierung/ereignisaktionen#, Ereignisaktionen>> ein, um den Auftragsstatus bei REWE automatisch zu aktualisieren, wenn bestimmte Ereignisse eintreten. Folgende Ereignisaktionen können eingerichtet werden:
