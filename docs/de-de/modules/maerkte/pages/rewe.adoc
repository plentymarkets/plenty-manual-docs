...
'''
*Verkaufspreis anlegen* = Erstellt einen neuen Verkaufspreis und ordnet diesen Verkaufspreis dem Datenfeld zu. Automatisch erstellte Verkaufspreise können im Menü xref:artikel:preise.adoc#400[Einrichtung » Artikel » Verkaufspreise] geprüft und bearbeitet werden.
