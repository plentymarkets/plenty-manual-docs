...
Wir empfehlen dir, dein Etsy-Konto zusätzlich für <<#konto-freischalten, OAuth2 zu authentifizieren>>. OAuth2 ist eine neue Authentifizierungsmethode und wird die alte Authentifizierung in Zukunft ersetzen.
...
Im Menü *Einrichtung » Märkte » Etsy » OAuth2* muss zunächst die Schnittstelle freigeschaltet werden. Damit gibst du plentymarkets Zugriff auf dein Etsy-Konto und ermöglichst den Datenaustausch zwischen plentymarkets und Etsy.

[IMPORTANT]
.OAuth2-Authentifizierung bald zwingend notwendig
====
Die neue Authentifizierungsmethode OAuth2 wird für immer mehr essenzielle Abläufe bei Etsy benötigt und wird in Zukunft die alte Authentifizierung komplett ersetzen. Wir empfehlen dir deshalb, jetzt schon dein Etsy-Konto für OAuth2 zu authentifizieren.
====
