...
====
Die neue Authentifizierungsmethode OAuth2 wird für immer mehr essenzielle Abläufe bei Etsy benötigt und wird in Zukunft die alte Authentifizierung komplett ersetzen. Die Umstellung wird voraussichtlich am 16.01.2023 erfolgen. Wir empfehlen dir deshalb, jetzt schon dein Etsy-Konto für OAuth2 zu authentifizieren.
====
...
*_Hinweis:_* Ab dem 16.01.2023 werden die alten Ereignisaktionen für Etsy aufgrund einer notwendigen Umstellung nicht mehr funktionieren. Die hier aufgeführte Ereignisaktion wird dann durch die Ereignisaktion *Versandbestätigung an Etsy senden (neu)* ersetzt. Als Vorbereitung empfehlen wir dir deshalb, jetzt schon zusätzlich die Ereignisaktion *Versandbestätigung an Etsy senden (neu)* einzurichten. Die alte Ereignisaktion wird bis zur Umstellung am 16.01.2023 noch wie gewohnt funktionieren.
|
|===
