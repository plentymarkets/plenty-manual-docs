...
Authentifiziere anschließend im Menü *Einrichtung » Märkte » Etsy » OAuth2* dein Etsy-Konto für OAuth2. Die Authentifizierung wird benötigt, damit Daten zwischen plentymarkets und Etsy ausgetauscht werden können.
