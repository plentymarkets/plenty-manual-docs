...
====
Bevor du Etsy in plentymarkets einrichtest, muss bei Etsy im Menü *Shop-Manager » Artikel » [Artikel öffnen]* die Einstellung *Erneuerungsoptionen* auf *Manuell* gestellt werden.
====
