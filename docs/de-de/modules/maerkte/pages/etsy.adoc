...
* Stelle bei Etsy im Menü *Shop-Manager » Artikel » [Artikel öffnen]* die Einstellung *Erneuerungsoptionen* auf *Manuell*. Die Einrichtung von Etsy in plentymarkets funktioniert sonst nicht korrekt.
...
====
Bevor du Etsy in plentymarkets einrichtest, muss bei Etsy im Menü *Shop-Manager » Artikel » [Artikel öffnen]* die Einstellung *Erneuerungsoptionen* auf *Manuell* gestellt werden. Die Einrichtung von Etsy in plentymarkets funktioniert sonst nicht korrekt.
====
...
Du listest eine Variante schon auf Etsy? Dann speichere die Etsy Listing-ID als SKU für die Herkunft *Etsy*. Varianten werden dann beim Export den schon auf Etsy gelisteten Varianten zugewiesen. Überverkäufe werden so verhindert. +
...
:rights-purpose: Etsy nutzen können
...
Der Begriff "Etsy" ist ein Markenzeichen von Etsy, Inc. plentymarkets verwendet die Etsy-API. Die Integration wurde jedoch von Etsy weder befürwortet noch zertifiziert.
