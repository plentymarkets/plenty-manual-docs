...
[IMPORTANT]
.Etsy-Assistent wird zur Einrichtung von Etsy nicht benötigt
====
Du musst den Assistenten *Etsy 2.0 Migration* nicht durchlaufen, wenn du Etsy in plentymarkets einrichten willst. +
Der Assistent wurde für die Umstellung auf Etsy 2.0 im September 2019 benötigt und diente dazu, SKUs zu migrieren. Da Etsy aber jetzt die neue Logik verwendet, brauchst du den Assistenten nicht, wenn du den Marktplatz in deinem plentymarkets System einrichten willst.
====
