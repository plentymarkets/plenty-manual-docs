...
====
Die Integration von Yatego wird zum 15.03.2023 abgeschaltet. Das heißt, dass plentymarkets den Marktplatz dann nicht mehr unterstützt. Du kannst deine Artikel also nicht mehr mit plentymarkets auf Yatego verkaufen und es werden keine Yatego-Aufträge mehr in dein System importiert. Weitere Informationen hierzu findest du im link:https://forum.plentymarkets.com/t/abschaltung-einiger-marktplatzintegrationen-zum-15-03-2023-deactivation-of-several-market-integrations-on-15-03-2023/707657[Forum^].
====
