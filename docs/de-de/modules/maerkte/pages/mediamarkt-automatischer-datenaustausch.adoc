...
xref:maerkte:mediamarkt-einrichten.adoc#[icon:long-arrow-left[] Mediamarkt einrichten]
xref:maerkte:automatisierte-auftragsabwicklung.adoc#[Automatisierte Auftragsabwicklung einrichten icon:long-arrow-right[]]
