...
* <<#100-0, _Möglichkeit 2:_ Exportformat BasicPriceSearchEngine-Plugin _(alte Methode)_>>
...
[#100-0]
=== _Möglichkeit 2:_ Exportformat BasicPriceSearchEngine-Plugin _(alte Methode)_
