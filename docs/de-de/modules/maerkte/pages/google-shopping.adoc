...
|sale_price
|Ein Preis vom Typ *Aktionspreis*, abhängig von der Formateinstellung *Angebotspreis*. Der sale_price wird in der Exportdatei nur ausgegeben, wenn er niedriger ist als der *Verkaufspreis*.
