...
Zu lange Beschreibungen werden abgeschnitten. Das Abschneiden wird im Log protokolliert.
...
*Benutzerhandbuch* +
usw.)
| Für alle Media-Asset-Datenfelder außer *Bilder* können nur URLs zu Dateien exportiert werden. Alle URLs im Bereich **Media assets** dürfen maximal 2083 Zeichen enthalten. Zu lange URLs werden entfernt. Das Entfernen wird im Log protokolliert.
