...
'''
*Eigenschaft erstellen* = Erstellt eine Eigenschaft und ordnet diese Eigenschaft dem Marktplatz-Datenfeld zu. Diese automatisch erstellte Eigenschaft wird im Menü <<artikel/einstellungen/eigenschaften#, Einrichtung » Einstellungen » Eigenschaften » Konfiguration>> gespeichert.
...
'''
*Verkaufspreis erstellen* = Erstellt einen neuen Verkaufspreis und ordnet diesen Verkaufspreis dem Marktplatz-Datenfeld zu. Dieser automatisch erstellte Verkaufspreis kann im Menü <<artikel/einstellungen/preise#400, Einrichtung » Artikel » Verkaufspreise>> geprüft und bearbeitet werden.
...
| Aktuelle Informationen zu den OTTO Market-Attributen findest du in der Kategorienliste von OTTO Market link:https://og2gether-my.sharepoint.com/:x:/g/personal/micha_saake_otto_de/EXg5Id8bTxNKuV8mRkQ1wrsBNFuBrjP8iQJINZjcezvjdg?rtime=3FovyUEf2Ug[in der Registerkarte "Attributsliste"^]{nbsp}icon:external-link[]
...
| *Kategorie*
| Aktuelle Informationen zu den OTTO Market-Attributen findest du in der Kategorieliste von OTTO Market link:https://og2gether-my.sharepoint.com/:x:/g/personal/micha_saake_otto_de/EXg5Id8bTxNKuV8mRkQ1wrsBNFuBrjP8iQJINZjcezvjdg?rtime=ueiZ-kgf2Ug[in der Registerkarte "Übersicht Kategorien"^]{nbsp}icon:external-link[]
...
* Bestand mehrerer Lager exportieren:
  . Ordne das plentymarkets Datenfeld *Bestand » [Lager wählen]* zu.
  . Klicke auf *Ausweich-Datenfeld hinzufügen* (icon:link[role="yellow"]) und ordne über das plentymarkets Datenfeld *Bestand » [Lager wählen]* ein weiteres Lager zu. Du kannst mehrere Ausweich-Datenfelder angeben. +
