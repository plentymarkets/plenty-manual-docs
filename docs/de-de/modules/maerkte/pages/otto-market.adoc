...
| OTTO Market kann nur die Währung EURO verarbeiten. Deshalb werden diese Datenfelder automatisch mit dem Wert "EUR" befüllt.

| Grundpreisangaben
| OTTO berechnet den Grundpreis von Varianten über die folgenden Marktplatz-Datenfelder:
...
| *Ereignis*
| Ereignis wählen, z.B. *Statuswechsel: [5] Freigabe Versand* +
...
| Ereignis wählen, zum Beispiel *[8.1] Storniert durch Kunden* +
