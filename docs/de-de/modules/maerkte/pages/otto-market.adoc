...
[#hinweise-verkauf]
=== Hinweise zum Verkauf auf OTTO Market

Beachte folgende Hinweise, wenn du deine Artikel auf OTTO Market verkaufen möchtest:

* Ware darf nur nach Absprache mit OTTO aus ausländischen Lagern verschickt werden. Ohne Absprache darf Ware außerdem nur an Endkund:innen aus Deutschland verschickt werden.
