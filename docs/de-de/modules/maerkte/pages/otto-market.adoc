...
* Ware darf nur nach Absprache mit OTTO aus ausländischen Lagern verschickt werden. Ohne Absprache darf Ware außerdem nur an Endkund:innen in Deutschland verschickt werden.
