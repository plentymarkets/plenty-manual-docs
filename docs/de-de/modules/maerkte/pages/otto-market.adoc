...
include::images$otto-unitprice-variation-setting.png[]
...
include::images$otto-unitprice-mappings.png[] +
...
include::images$otto-unitprice-iso.png[]

_oder_

* Eigenschaft mit den von OTTO Market erlaubten Werten (ISO-Codes) +
include::images$otto-unitprice-mappings-salesprice.png[] +
...
include::images$otto-unitprice-content.png[]
