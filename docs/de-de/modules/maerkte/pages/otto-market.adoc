...
*Herstellergarantie* +
usw.)
| Für Media-Asset-Datenfelder können nur Dateien als URL-Links zugeordnet werden.

*_Empfohlene Zuordnungen:_*

 * *Bild » Varianten Bilder » Einzelbild*
  ** *Bildinformation:* *Vollbild-URL* wählen
  ** *Bildposition:* Position des Bilds wählen
...
* Eigenschaft des Typs *Zeichenkette*, in der die URL zur Datei gespeichert wird.

*_Hintergrund:_* Ob du Bilder oder Eigenschaften zuordnest hängt davon ab, ob du für deine Bilder konsequent die Positionen nutzt. Wenn zum Beispiel alle deine Produktdatenblätter die Postion 200 haben, kannst du das plentymarkets Datenfeld *Bild » Varianten Bilder » Einzelbild* zuordnen und die Position 200 wählen.
