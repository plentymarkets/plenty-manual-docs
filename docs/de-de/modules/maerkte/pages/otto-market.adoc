...
* Ware darf nur nach Absprache mit OTTO aus ausländischen Lagern verschickt werden. Ohne Absprache sind nur Warenlieferungen an Endkunden aus Deutschland erlaubt.
