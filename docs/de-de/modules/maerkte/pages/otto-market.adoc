...
. Die MOIN wird in dein plentymarkets System importiert und an der Variate gespeichert. Du findest sie im Menü *Artikel » Artikel bearbeiten » [Artikel öffnen] » [Variante öffnen] » Tab: Einstellungen » Bereich: ASIN/ePID*.
