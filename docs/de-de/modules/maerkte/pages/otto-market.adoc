...
Nachdem du einen Katalog zum ersten Mal exportiert hast, kannst du eine Vorschau des Katalogs herunterladen. Die Vorschau enthält die ersten 5 Zeilen der Exportdatei.
...
→ Die Datei wird heruntergeladen. Sie enthält die ersten 5 Zeilen der Exportdatei.
