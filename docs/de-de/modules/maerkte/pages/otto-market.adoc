...
Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um OTTO Market über die Stornierung von Aufträgen zu informieren. Es kann aus verschiedenen Gründen erforderlich sein, Aufträge zu stornieren. Wenn zum Beispiel Kund:innen den Auftrag stornieren, wähle *Status [8.1] Storniert durch Kunden*.
...
Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um OTTO Market zu informieren, wenn du Retouren annimmst.
...
Richte eine <<automatisierung/ereignisaktionen#, Ereignisaktion>> ein, um OTTO Market zu informieren, wenn du Retouren ablehnst.
