...
* Du verwendest noch den alten Export, möchtest aber wechseln? xref:page$zalando-switch-to-catalogue.adoc[Dann mache dich mit den nötigen Schritten für einen Wechsel vertraut.]
====
