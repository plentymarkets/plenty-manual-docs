...
* Du verwendest noch den alten Export, möchtest aber wechseln? xref:partial$zalando-switch-to-catalogue.adoc[Dann mache dich mit den nötigen Schritten für einen Wechsel vertraut.]
====
...
| *Schritt 7*
| <<#assistant-2, Durchlaufe den Assistenten, um den Kanal zu aktivieren und die Einstellungen für Preise und Bestände zu speichern.>>
|===
--
====
