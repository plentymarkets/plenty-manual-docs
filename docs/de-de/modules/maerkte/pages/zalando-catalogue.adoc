...
[NOTE]
.Lieber den alten Artikelexport?
====

Auf dieser Seite erfährst du, wie du deine Artikeldaten per Katalogexport zu Zalando exportierst. Dieser Export befindet sich noch in der Beta-Phase. Du richtest Zalando zum ersten Mal in deinem plentymarkets System ein? Dann empfehlen wir dir trotzdem, den Katalogexport zu wählen. 
...
//Switch to catalogue
include::partial$zalando-instruction-move-to-catalogue.adoc[]
