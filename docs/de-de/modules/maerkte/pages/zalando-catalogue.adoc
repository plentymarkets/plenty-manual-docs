...
| *Katalog nutzen*
| Aktiviere die Option (icon:toggle-on[role="blue"]), um deine Artikeldaten per Katalog an Zalando zu exportieren.
...
* Du verkaufst schon auf Zalando und möchtest auf den Katalogexport wechseln? Dann aktiviere die Option, nachdem du die nötigen Kataloge eingerichtet hast.
