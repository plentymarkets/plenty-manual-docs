...
*_Beispiel:_* Für einen Artikel mit einem Bestand von 50 und einem Bestandspuffer von 10 wird der Bestandswert 40 übertragen. Weitere Informationen findest du auf der Handbuchseite xref:warenwirtschaft:warenbestaende-verwalten.adoc#[Warenbestände verwalten].
...
Gehe wie im Folgenden beschrieben vor, um eine xref:auftraege:auftragsdokumente.adoc#170[PDF-Vorlage] für Lieferscheine für Neckermann zu erstellen.
