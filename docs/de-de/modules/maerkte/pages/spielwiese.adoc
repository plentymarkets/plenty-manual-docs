...
ifdef::voelkner[]
| Datenfelder für Angebotspreise: +
*Rabatt Startzeit* +
*Rabatt Endzeit*

| Optional kannst du zeitlich begrenzte Angebotspreise an Voelkner übermitteln.
...
* Du hast im Katalog die folgenden Zuordnungen vorgenommen:
