...
*_Hinweis:_* Wenn hier keine Zahl eingegeben wird, wird automatisch der Wert *1* übertragen. Das bedeutet, dass die maximale Bestellmenge auf Netto dann *1* ist und Kund:innen nicht mehr als einen Artikel in den Warenkorb legen können.
