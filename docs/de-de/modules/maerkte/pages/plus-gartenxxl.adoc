...
:referrer-option: pass:quotes[Optionen *Netto* mit der ID *154* und *plus.de* mit der ID *131*]
...
. Speichere (icon:save[set=plenty]) die Einstellungen.
. Füge im Bereich Auswahl nacheinander die Auswahlwerte *ja* und *nein* hinzu und Speichere (icon:save[set=plenty]) die Einstellungen.
