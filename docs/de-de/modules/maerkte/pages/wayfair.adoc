...
* Im Kapitel <<#WOEJONNF, Troubleshooting: Häufige Probleme>> findest du Ideen
...
Richte xref:automatisierung:ereignisaktionen.adoc#[Ereignisaktionen] ein, um Wayfair automatisch über Änderungen des Auftragsstatus zu informieren. Für Wayfair sind die folgenden Ereignisaktionen stehen verfügbar:
