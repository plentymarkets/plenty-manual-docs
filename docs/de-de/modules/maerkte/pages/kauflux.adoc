...
* <<#old-export, _Möglichkeit 2:_ Exportformat KaufluxDE-Plugin _(alte Methode)_>>
...
[#old-export]
=== _Möglichkeit 2:_ Exportformat KaufluxDE-Plugin _(alte Methode)_
...
. Wähle im Schritt *Automatischer Versand* bei *Neue Bestellung über Kauflux* die zuvor erstellte E-Mail-Vorlage.
. Speichere (terra:save[]) die Einstellungen.
