...
======
Hast du deine Werte in einer CSV-Datei vorliegen, kannst du mehrere Channels auf einmal verknüpfen. Verwendest du hingegen den Eigenen Wert, benötigst du eine Zuordnung pro Verknüpfung an eine Plattform.
======
--
====
