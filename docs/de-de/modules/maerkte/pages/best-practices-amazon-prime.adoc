...
:id: HVTSBI0
:description: In diesem Best Practice erfährst du, wie ein Amazon Prime-Auftrag abläuft und welche Einstellungen du bei Prime-Aufträgen beachten musst.
...
- *Error:InvalidShipFromAddress* bedeutet, dass im Menü *Einrichtung » Aufträge » Versand » Dienstleister » Einstellungen » [Lager aufklappen]* nicht alle notwendigen Daten für das Lager gespeichert wurden. Welche Daten für ein Lager hinterlegt sein müssen, ist <<#180, hier>> beschrieben.
