...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#200[Artikel » Artikel-UI » [Variante öffnen\] » Element: Versand » Dropdown-Liste: Kommissionierung]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#200[Artikel » Artikel-UI » [Variante öffnen\] » Element: Versand » Dropdown-Liste: Kommissionierung]
