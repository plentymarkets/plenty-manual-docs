...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#180[Artikel » Artikel-UI » [Variante öffnen\] » Element: Inhalt/Dimensionen » Option: Grundpreis anzeigen]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#180[Artikel » Artikel-UI » [Variante öffnen\] » Element: Inhalt/Dimensionen » Option: Grundpreis anzeigen]
