...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:artikel-verwalten.adoc#290[Artikel » Artikel bearbeiten » [Variante öffnen\] » Tab: Einstellungen » Bereich: Versand » Packstücke (linke Dropdown-Liste)]

//ToDo - neue Artikel-UI
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#200[Artikel » Artikel-UI » [Variante öffnen\] » Element: Versand » Eingabefeld: Packstücke: Anzahl]
...
Entspricht der Option im Menü: xref:artikel:artikel-verwalten.adoc#290[Artikel » Artikel bearbeiten » [Variante öffnen\] » Tab: Einstellungen » Bereich: Versand » Packstücke (linke Dropdown-Liste)]

//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#200[Artikel » Artikel-UI » [Variante öffnen\] » Element: Versand » Eingabefeld: Packstücke: Anzahl]
