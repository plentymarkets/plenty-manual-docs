...
UI steht für [.underline]##U##ser [.underline]##I##nterface (Deutsch: Benutzeroberfläche).
...
Das folgende Video verschafft dir schnelle Orientierung in die verschiedenen Bereiche der neuen Artikel Benutzeroberfläche, darunter die Artikelsuche, Menüstruktur, MyView – die personalisierte ansicht und das eigene Portlet.
