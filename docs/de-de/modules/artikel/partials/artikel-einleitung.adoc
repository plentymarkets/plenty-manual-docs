...
//tag::pim-preamble[]
Dieses Kapitel beschreibt die neue Benutzeroberfläche im Bereich Artikel.
...
== Einführung in die neue Artikel-Benutzeroberfläche

Dieses Kapitel beschreibt die neue Artikel-UI.
...
== Die neue Artikel-Benutzeroberfläche
