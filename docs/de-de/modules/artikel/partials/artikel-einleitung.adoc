...
Im folgenden Video erhältst du einen ersten Überblick über die neue Benutzeroberfläche und Funktionen, darunter die Artikelsuche, Menüstruktur, personalisierte Ansichten, die Suche und mehr.
