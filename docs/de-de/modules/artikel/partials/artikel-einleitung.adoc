...
Daraufhin kannst du deine Ware auf diversen <<maerkte#, Marktplätzen>>, im eigenen <<webshop#, plentyShop>> und im xref:pos:pos.adoc#[stationären Laden] verkaufen.
...
a|image::artikel:thumbnail-eigenschaften-manuell.png[]
