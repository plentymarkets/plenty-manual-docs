...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#170[Artikel » Artikel-UI » [Variante öffnen\] » Element: Einstellungen » Eingabefeld: Variantennummer]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#170[Artikel » Artikel-UI » [Variante öffnen\] » Element: Einstellungen » Eingabefeld: Variantennummer]
