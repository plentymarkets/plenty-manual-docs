...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#70[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Multi-Channel » Eingabefeld: eBay Kategorie 1 & 2]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#70[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Multi-Channel » Eingabefeld: eBay Kategorie 1 & 2]
