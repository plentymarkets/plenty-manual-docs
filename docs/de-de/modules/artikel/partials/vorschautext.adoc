...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#50[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Texte » Eingabefeld: Vorschautext]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#50[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Texte » Eingabefeld: Vorschautext]
