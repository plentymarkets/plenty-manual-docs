...
* *Artikel* (terra:document[]) = Warengruppen, die dazu dienen, Produkte übersichtlich zu gruppieren. xref:artikel:kategorien.adoc#200[Neu angelegte Kategorien] haben standardmäßig den Typ *Artikel*. +
