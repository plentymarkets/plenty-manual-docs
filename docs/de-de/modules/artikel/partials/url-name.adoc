...
Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:kategorien.adoc#intable-url[Artikel » Kategorien » Tab: Einstellungen » Eingabefeld: URL-Name]
...
Entspricht der Option im Menü: xref:artikel:kategorien.adoc#700[Artikel » Kategorien » [Kategorie öffnen] » Tab: Einstellungen » Eingabefeld: URL-Name]
