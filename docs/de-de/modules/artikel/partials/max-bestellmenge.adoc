...
//Das Ergebnis des Imports findest du im Backend im Menü: xref:artikel:verzeichnis.adoc#60[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Einstellungen » Eingabefeld: Max. Bestellmenge]
...
//ToDo - neue Artikel-UI
//Entspricht der Option im Menü: xref:artikel:verzeichnis.adoc#60[Artikel » Artikel-UI » [Artikel öffnen\] » Element: Einstellungen » Eingabefeld: Max. Bestellmenge]
