...
|Beispiel-URL
|`https://*cdn01.plentysystems.com/1abcd2e3fghi*/item/images/118/full/118-Relaxsessel-Rio.jpg`
...
[#300]
=== Eigene CDN-Domain einrichten: plentysystems Domain

In dieser Anleitung lernst du, wie du eine eigene CDN-Domain einrichtest, wenn deine Domain von plentysystems gehostet wird.
...
[.instruction]
Eine von plentysystems gehostete Domain:
...
* Zuerst erzeugst du DNS-Einträge in plentysystems.
* Danach speicherst du diese DNS-Einträge innerhalb von 72 Stunden bei deinem Domain-Provider.


[TIP]
.Von plentysystems gehostete Domain?
====
Wird deine Domain von plentysystems gehostet?
...
====
Die in plentysystems erstellten DNS-Einträge müssen innerhalb von 72 Stunden beim Domain-Provider hinterlegt werden.
...
. Kopiere die in plentysystems angezeigten DNS-Einstellungen in die dafür vorgesehenen Felder des Domain-Providers.
...
Ältere Systeme haben einen eigenen xref:daten:ftpz-zugang.adoc#[FTP-Server].
