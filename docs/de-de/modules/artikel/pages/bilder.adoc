...
.Einstellungen für den Import und Export von Artikelbildern
[cols="1,3"]
|====
...
.Einstellungen für Platzhalterbilder
[cols="1,3"]
|====
|Einstellung |Erläuterung

| *Platzhalterbild-URL*
a|Dieses Platzhalterbild erscheint, wenn _Artikelbilder_ nicht angezeigt werden können.
...
a|Dieses Platzhalterbild erscheint, wenn _Vorschaubilder_ nicht angezeigt werden können.
...
.Einstellungen für Attributbilder
[cols="1,3"]
|====
|Einstellung |Erläuterung
...
. Nimm die Einstellungen für jede Bildgröße vor. Beachte <<table-image-sizes>>.
. Speichere (icon:save[set=plenty, role="darkGrey"]) die Einstellungen.
...
<<table-domain-image-URLs>> vergleicht die Standard-CDN-Domain und eine eigene CDN-Domain.

[[table-domain-image-URLs]]
.Standard-Domain vs. eigene Domain
[cols="1,3,3"]
|====
...
=== Eigene CDN-Domain einrichten

Wer hostet deine Domain? Wie du vorgehst, hängt davon ab, ob deine Domain von <<artikel/einstellungen/bilder#300, plentymarkets>> oder von einem <<artikel/einstellungen/bilder#400, externen Provider>> gehostet wird.
...
Wenn deine Domain von einem externen Provider gehostet wird, dann erzeugst du zuerst DNS-Einträge in plentymarkets.
...
** link:https://docs.aws.amazon.com/acm/latest/userguide/setup-caa.html[AWS: Weitere Informationen zum Thema^]{nbsp}icon:external-link[]
** link:https://www.ionos.de/hilfe/domains/caa-records-konfigurieren/caa-record-hinzufuegen-aendern-oder-loeschen/[IONOS: Weitere Informationen zum Thema^]{nbsp}icon:external-link[]
====
...
[#600]
== Bilder per FTP-Server hochladen

Jedes plentymarkets System hat einen eigenen <<daten/ftpz-zugang#, FTP-Server>>.
