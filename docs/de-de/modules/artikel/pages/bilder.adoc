...
Wer hostet deine Domain? Wie du vorgehst, hängt davon ab, ob deine Domain von xref:artikel:bilder.adoc#300[plentymarkets] oder von einem xref:artikel:bilder.adoc#400[externen Provider] gehostet wird.
...
Jedes plentymarkets System hat einen eigenen xref:daten:ftpz-zugang.adoc#[FTP-Server].
