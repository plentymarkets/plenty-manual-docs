...
. Nachdem du die Suche ausgeführt hast, klicke auf eine Zeile in der Ergebnisliste, um die xref:artikel:detailansicht.adoc#[Detailansicht] zu öffnen.
...
* Der erweiterte Suchmodus unterstützt xref:artikel:suchen.adoc#intable-erweiterte-elemente[Operatoren].
////
...
image::artikel:filter-verbinden.png[]
...
Dieser Filter schränkt die Suchergebnisse so ein, dass sie nur Standardartikel, xref:artikel:multipacks-pakete-sets.adoc#[Setartikel oder Multipacks] enthalten.

*_Was ist mit Artikelpaketen?_*
Es ist auch möglich, nach Artikelpaketen oder einzelnen Paketbestandteilen zu suchen.
Verwende dazu den Filter xref:artikel:suchen.adoc#intable-paket[Paket].
...
|[#intable-paket]*Paket*
|Möchtest du nach xref:artikel:multipacks-pakete-sets.adoc#[Artikelpaketen] oder einzelnen Paketbestandteilen suchen?
...
Die Suchergebnisse enthalten nur Produkte, die xref:artikel:artikel-verwalten.adoc#310[mit diesem Lieferanten verknüpft] sind.

*_Voraussetzung_*: Hast du bereits xref:crm:kontakte-verwalten.adoc#100[Lieferantendatensätze in plentymarkets angelegt]?
...
Die Suchergebnisse enthalten nur Produkte, die xref:artikel:artikel-verwalten.adoc#350[mit dieser Herkunft verknüpft] sind.
|====
...
Weitere Informationen zur xref:artikel:detailansicht.adoc#[Navigation und Detailansicht].
...
Hast du bereits einen xref:artikel:suchen.adoc#500[Artikeldatensatz geöffnet]?
