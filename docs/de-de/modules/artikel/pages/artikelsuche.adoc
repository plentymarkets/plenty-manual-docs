...
! *IN*
!
Die Suchergebnisse liefern nur Produkte, die mit einem dieser xref:artikel:artikel-verwalten.adoc#268[Tags] verknüpft sind.

! *NOT IN*
!
Die Suchergebnisse liefern nur Produkte, die _nicht_ mit einem dieser xref:artikel:artikel-verwalten.adoc#268[Tags] verknüpft sind.

!===

| *Verfügbarkeit*
|Wähle eine oder mehrere Verfügbarkeitsstufen aus der Dropdown-Liste aus (icon:check-square[role="blue"]).
Die Suchergebnisse liefern nur Produkte, die mit einer dieser xref:artikel:artikel-verwalten.adoc#200[Verfügbarkeitsstufen] verknüpft sind.
...
Die Suchergebnisse liefern nur Produkte, die mit einer dieser xref:artikel:artikel-verwalten.adoc#350[Herkünfte] verknüpft sind.

| *Aktiv*
|Möchtest du nach xref:artikel:artikel-verwalten.adoc#intable-aktiv[aktiven Artikeln] suchen?
...
! *IN*
!
Die Suchergebnisse liefern nur Produkte, die mit einem dieser xref:artikel:artikel-verwalten.adoc#310[Lieferanten] verknüpft sind.

! *NOT IN*
!
Die Suchergebnisse liefern nur Produkte, die _nicht_ mit einem dieser xref:artikel:artikel-verwalten.adoc#310[Lieferanten] verknüpft sind.

!===

| *Verkaufspreise*
|Wähle einen oder mehrere Verkaufspreise aus der Dropdown-Liste aus (icon:check-square[role="blue"]).
Die Suchergebnisse liefern nur Produkte, die mit einem dieser xref:artikel:artikel-verwalten.adoc#240[Verkaufspreise] verknüpft sind.
...
! *IN*
!
Die Suchergebnisse liefern nur Produkte, die mit einem dieser xref:artikel:artikel-verwalten.adoc#360[Mandanten] verknüpft sind.

! *NOT IN*
!
Die Suchergebnisse liefern nur Produkte, die _nicht_ mit einem dieser xref:artikel:artikel-verwalten.adoc#360[Mandanten] verknüpft sind.
...
* *Ist ein Paket* = Die Suchergebnisse umfassen nur Artikel und Varianten, die den _Hauptartikel eines Artikelpakets_ darstellen.
* *Ist ein Bestandteil* = Die Suchergebnisse umfassen nur Artikel und Varianten, die _Bestandteile eines Artikelpakets_ sind.

| *Hersteller*
|Wähle einen oder mehrere Hersteller aus der Dropdown-Liste aus (icon:check-square[role="blue"]).
Die Suchergebnisse liefern nur Produkte, die mit einem dieser xref:artikel:artikel-verwalten.adoc#_grundeinstellungen[Hersteller] verknüpft sind.
...
Beispiel: Produkte, die _nicht_ mit einem bestimmten Mandanten verknüpft sind.
...
[.collapseBox]
.*Kann ich das Layout meiner Produktdatensätze anpassen?*
--
