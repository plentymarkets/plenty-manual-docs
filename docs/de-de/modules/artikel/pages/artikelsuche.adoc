...
Schau dir zunächst die Beispielartikel an, um dich mit der Artikelstruktur in plentymarkets vertraut zu machen.
...
======
. Öffne das Menü *Artikel » Artikel-UI » [Artikel 132 öffnen] » [Variante 1065 öffnen] » Element: Kategorien*.
