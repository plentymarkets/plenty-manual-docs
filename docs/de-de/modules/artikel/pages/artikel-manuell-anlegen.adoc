...
====
Diese Dropdown-Liste gibt an, welche Art von Artikel du erstellen möchtest.
Hier wird die Erstellung von Standard-Artikeln, d.h. ganz normalen Artikeln und Varianten beschrieben.
Ausführlichere Informationen zu den verschiedenen Typen findest du im xref:artikel:artikel-manuell-anlegen.adoc#700[FAQ-Bereich].
