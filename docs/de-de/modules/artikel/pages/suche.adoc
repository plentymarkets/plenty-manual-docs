...
*_Wie sieht es mit Artikelpaketen aus?_:* Es ist auch möglich, nach Artikelpaketen oder einzelnen Paketbestandteilen zu suchen. Verwende dazu den Filter xref:artikel:suche.adoc#intable-paket[Paket].
...
*_Hinweis_*: Diese Liste enthält nur die xref:artikel:hersteller.adoc#[Herstellerdatensätze], die du bereits in plentymarkets gespeichert hast.
...
*_Hinweis_*: Diese Listen enthalten nur die xref:artikel:attribute.adoc#[Attribute und Attributwerte], die du bereits in plentymarkets gespeichert hast.
...
* *Ja* = Die Suchergebnisse enthalten nur Artikel, die Teil eines Listings oder einer Auktion sind, d.h. Artikel mit einem xref:artikel:suche.adoc#800[gelben Listing-Symbol] (icon:listings_show[set=plenty, role="yellow"]).
* *Nein* = Die Suchergebnisse enthalten nur Artikel, die nicht Teil eines Listings oder einer Auktion sind, d.h. Artikel mit einem xref:artikel:suche.adoc#800[grauen Listing-Symbol] (icon:listings_show[set=plenty, role="darkGrey"]).
...
|icon:eye[role="blue"]
|Klicke auf *Sichtbar im Webshop* (icon:eye[role="blue"]), um die xref:artikel:webshop.adoc#[Darstellung des Artikels im plentyShop] zu prüfen. Wird das Symbol durchgestrichen, ist der Artikel *Unsichtbar im Webshop* (icon:item_webshop_invisible[set=plenty, role="blue"]).
...
|Klicke auf *Neues Listing* (icon:listing_create[set=plenty, role="green"]), um diesen Artikel in einem xref:maerkte:ebay-einrichten.adoc#3400[Listing oder Auktion auf eBay], xref:maerkte:hood.adoc#2300[Hood] oder xref:maerkte:ricardo-ch.adoc#1900[ricardo] zu verkaufen.

|icon:order_note_create[set=plenty, role="green"]
|Klicke auf *Notiz hinzufügen* (icon:order_note_create[set=plenty, role="green"]), um eine xref:artikel:artikel-verwalten.adoc#2090[Notiz für die Variante] zu schreiben.
|====
...
Artikel beinhalten immer eine oder mehrere Varianten. Beim Öffnen eines Artikels wird immer die erste Variante, d.h. die xref:artikel:struktur.adoc#600[Hauptvariante], automatisch mit geöffnet. Aber wie kommst du an die weiteren Untervarianten des Artikels ran? Gehe wie unten beschrieben vor, um die einzelnen Varianten eines Artikels zu suchen.
