...
Lerne, nach Artikeldaten im plentymarkets Backend zu suchen und schau dir die Beispielartikel an, die mit neuen Systemen geliefert werden.
...
→ Die <<artikel/einleitung/suche#600, Suchergebnisse>> werden in der Übersicht rechts angezeigt.

--
Artikel einer Kategorie suchen::
+
--
Es ist auch möglich, Artikeln einer bestimmten <<artikel/artikel-verwalten#300, Kategorie>> zu suchen.
...
Gehe wie unten beschrieben vor, um gezielt die Artikel eines <<artikel/artikel-verwalten#360, Mandanten>> abzurufen.
...
*_Hinweis_*: Es werden nur die Artikeldaten berücksichtigt, die <<artikel/anwendungsfaelle/suchverhalten#200, für den Suchindex aktiviert>> wurden.

*_Artikelbeschreibung durchsuchen_*: Möchtest du nach Artikeln suchen, deren Beschreibung ein bestimmtes Stichwort enthält? Gib das Stichwort in dieses Suchfeld ein und wähle die Option <<artikel/einleitung/suche#intable-beschreibung, In Beschreibung>> (icon:check-square[role="blue"]) weiter unten.
...
|Wähle diese Option (icon:check-square[role="blue"]), um nach einem Stichwort in der Artikelbeschreibung zu suchen. Gib das Stichwort in das Feld <<artikel/einleitung/suche#intable-artikeldaten, Artikeldaten>> weiter oben ein.

*_Hinweis_*: Es werden nur die Artikeldaten berücksichtigt, die <<artikel/anwendungsfaelle/suchverhalten#200, für den erweiterten Suchindex aktiviert>> wurden.
...
|[#intable-aktiv]*Aktiv*
a|Möchtest du nur nach <<artikel/artikel-verwalten#intable-aktiv, aktiven Artikeln>> suchen, d.h. nach Artikeln, die verkaufsfertig sind?
...
| *Shop-Aktion*
|Dieser Filter schränkt die Suchergebnisse auf Artikel ein, die Teil einer <<artikel/webshop/shop-aktionen#, Shop-Aktion>> sind.
...
Du kannst das <<artikel/anwendungsfaelle/suchverhalten#, vordefinierte Suchverhalten an deine Bedürfnisse anpassen>>.
...
Hast du die <<artikel/einleitung/suche#100, Suchoptionen in der Spalte links>> verwendet, werden dir die Suchergebnisse in einer Übersicht rechts angezeigt.
Klicke direkt auf einen Artikel in der Übersicht, um den Artikeldatensatz zu öffnen und <<artikel/artikel-verwalten#, weiter zu bearbeiten>>.
...
|icon:eye[role="blue"]
|Klicke auf *Sichtbar im Webshop* (icon:eye[role="blue"]), um die <<artikel/webshop#, Darstellung des Artikels im plentyShop>> zu prüfen. Wird das Symbol durchgestrichen, ist der Artikel *Unsichtbar im Webshop* (icon:item_webshop_invisible[set=plenty, role="blue"]).
