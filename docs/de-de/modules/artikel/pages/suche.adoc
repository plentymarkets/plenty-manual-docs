...
* *Nein* = Die Suchergebnisse enthalten nur Artikel, die _nicht_ Teil eines Listings oder einer Auktion sind, d.h. Artikel mit einem xref:artikel:suche.adoc#800[grauen Listing-Symbol] (icon:listings_show[set=plenty]).
