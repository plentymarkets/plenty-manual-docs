...
====
Diese Seite setzt voraus, dass du bereits xref:artikel:einleitung.adoc#[Grundkenntnisse über die Artikelverwaltung] in plentysystems hast.
...
| *ID*
|Die Artikel-ID ist eine eindeutige, fortlaufende Zahl, die plentysystems zur exklusiven Zuordnung jedes Artikels benötigt. Wird dieses Feld freigelassen, vergibt plentysystems automatisch die nächste freie ID.
