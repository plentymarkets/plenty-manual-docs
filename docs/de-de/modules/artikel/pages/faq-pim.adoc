...
Mein Mitarbeiter soll ausschließlich Zugriff auf die Artikeldaten haben (am besten da auch nur Beschreibungen und Bilder).

[#200]
== Preise

Verkaufspreise - Bedingungen - something like that

Aufträge manuell und Checkliste für die Verkaufspreise
