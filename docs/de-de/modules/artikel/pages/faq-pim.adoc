...
[.collapseBox]
.*Kann ich einschränken, welche Artikeldaten meine Mitarbeiter bearbeiten können? Sie sollen keine sensiblen Daten ändern können.*
--
...
Eher nicht.
Neue plentymarkets Systeme werden nicht mehr mit einem FTP-Server ausgeliefert.
Einige Bestandskunden verfügen bereits über einen FTP-Server, den sie bis zur endgültigen Abschaffung von FTP weiter nutzen können.

[discrete]
==== Alternativer Workflow für das Hochladen von Bildern
...
Ja.
Allgemein gesagt ermöglicht die REST-API-Schnittstelle externen Aufrufen, Daten an das plentymarkets System zu senden oder Daten von dem System abzurufen.
...
TIP: Es gibt keine direkte Möglichkeit, Artikeldaten von Amazon ins plentymarkets System zu übertragen.
...
. Nutze das Import-Tool, um die Daten in plentymarkets zu übertragen.
.. Stelle dabei sicher, dass die Importdatei alle Pflichtfelder für neue Artikel und Varianten enthält.
.. Ordne dabei die Informationen in deiner Datei zu den entsprechenden Datenfeldern in plentymarkets.
...
xref:ebay:ebay-einrichten.adoc#11000[Weitere Informationen zur Nutzung des eBay-Import-Tools].
...
Theoretisch könntest du manuell ein Werbegeschenk zu Bestellungen über einem bestimmten Warenwert hinzufügen.
Es ist jedoch viel effizienter, wenn du diesen Vorgang mit Hilfe einer Ereignisaktion automatisierst.
...
Ja.
Jedes Mal, wenn du einen Artikel mit einer Seriennummer verkaufst, kann plentymarkets protokollieren, welches Exemplar verkauft wurde.
Mit anderen Worten kann plentymarkets festhalten, welche Seriennummer welcher Bestellung entspricht.
