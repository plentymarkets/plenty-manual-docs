...
Einige Märkte, wie z.B. xref:maerkte:varianten-vorbereiten.adoc#1350[Amazon] und xref:maerkte:ebay-einrichten.adoc#6100[eBay], verlangen, dass du _deine eigenen_ Attributwerte mit _ihren Attributwerten_ verknüpfst.
