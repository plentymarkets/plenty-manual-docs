...
Jedes Mal, wenn du einen <<artikel/import-export-anlage/anlage/neue-artikel#, neuen Artikel oder eine neue Variante anlegst>>, erhält diese automatisch eine Variantennummer.
