...
*_Hinweis_*: Stelle sicher, dass du auch einen <<artikel/einstellungen/hersteller#150, externen Namen für deine Hersteller>> gespeichert hast.
...
Stelle sicher, dass du den <<artikel/einstellungen/hersteller#150, externen Herstellernamen>> gepflegt hast.
