...
xref:automatisierung:prozesse-einrichten.adoc#[Erstelle einen Kommissionierungsprozess], mit dem dein Lagermitarbeiter Artikel pickt und deren Seriennummern scannt. Verwende dazu die <<automatisierung/prozesse/aktionen#420, Aktion "Seriennummer">> zusammen mit der <<automatisierung/prozesse/subaktionen#260, Subaktion "Seriennummern erfassen">>.
