...
. Öffne das Menü *Artikel » Artikel-UI » [Variante öffnen] » Element: Bestand* und prüfe, ob die Variante vorrätig ist.
...
* Öffne das Menü *Artikel » Artikel-UI » [Variante öffnen] » Element: Mandant (Shop)* und klicke auf *Temporär verfügbar machen*.
