...
Deine Varianten können mit beliebig vielen Tags verknüpft werden.
Die Tags helfen dir, z.B. den Überblick über deine Varianten im Backend zu behalten oder deine Varianten mit Schlagwörtern im Frontend zu versehen.
xref:artikel:markierungen.adoc#650[Weitere Informationen zu den Anwendungsbeispielen].
