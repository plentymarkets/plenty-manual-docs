...
Du kannst auch xref:artikel:suche.adoc#intable-tags[gezielt nach Varianten im Backend suchen], die ein bestimmtes Tag haben.
* *_Schlagworte im plentyShop_*: du entscheidest, welche Tags xref:willkommen:tags.adoc#intable-mandant[für Kunden im plentyShop sichtbar] sein sollen und welche nicht.
* *_Weitere Datentypen_*: du kannst Tags sogar auch verwenden, um xref:willkommen:tags.adoc#[andere Datentypen hervorzuheben], z.B. Kunden, Aufträge, Tickets usw.
