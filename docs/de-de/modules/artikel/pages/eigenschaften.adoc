...
* Eigenschaften charakterisieren _spezifische Varianten_.
...
|
* Merkmale charakterisieren _ganze Artikel_.
...
Diese Handbuchseite führt dich Schritt für Schritt durch die _manuelle Anlage_ von Eigenschaften:
...
Ja.
Eigenschaften können auch für die nähere Charakterisierung von xref:crm:kontakte-verwalten.adoc#950[Kontakte] oder xref:warenwirtschaft:lager-einrichten.adoc#850[Lagerorte] verwendet werden.
...
* In plentymarkets werden personalisierte Artikel mit Hilfe von _Bestelleigenschaften_ zum Verkauf angeboten.
