...
Wie viele Varianteneigenschaften du erstellen und verknüpfen kannst, hängt davon ab, welche plentysystems Edition du gebucht hast.
...
|???
|===
[.small]#1: Maximum Anzahl an Eigenschaften vom Bereich "Artikel", die in plentysystems erstellt werden können# +
