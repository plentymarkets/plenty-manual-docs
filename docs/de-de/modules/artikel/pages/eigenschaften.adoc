...
* xref:artikel:eigenschaften.adoc#100[Merkmale] charakterisieren _ganze Artikel_.
...
* xref:artikel:eigenschaften.adoc#500[Eigenschaften] charakterisieren _spezifische Varianten_.
...
Du kannst Eigenschaften entweder manuell erstellen oder sie mit Hilfe einer CSV-Datei importieren.
...
. xref:artikel:eigenschaften.adoc#600[Erstelle Eigenschaften] wie WLAN oder Bluetooth.
. xref:artikel:eigenschaften.adoc#1200[Gruppiere die Eigenschaften].
Zum Beispiel, um den Überblick in deinem plentymarkets-Backend zu behalten.
. xref:artikel:eigenschaften.adoc#1400[Verknüpfe die Eigenschaften] mit den passenden Varianten. Zum Beispiel, verknüpfe die Bluetooth-Eigenschaft mit deinen Bluetooth-fähigen Produkten.
...
plentymarkets enthält ein xref:daten:ElasticSync.adoc#[Import-Tool], mit dem du Eigenschaften importieren kannst.
...
. Erstelle Eigenschaften wie WLAN oder Bluetooth und gruppiere sie.
Verwende dazu die Import-Typen xref:daten:elasticSync-eigenschaften-auswahlwerte.adoc#[Auswahlwerte].
...
Verwende dazu den xref:daten:elasticSync-artikel.adoc#2410[Import-Typ Artikel].
--
====
...
Andererseits kommen Eigenschaftsgruppen zum Einsatz, wenn du xref:artikel:personalisierte-artikel.adoc#[personalisierte Artikel] in deinem plentyShop verkaufst.
...
Wie deine Eigenschaften im xref:webshop:shop-builder.adoc#[ShopBuilder] konfiguriert hast. Dieses Video bietet eine kurze Demonstration.
...
Ja.
Eigenschaften können auch für die nähere Charakterisierung von xref:crm:lager-einrichten.adoc#850[Lagerorte] verwendet werden.
