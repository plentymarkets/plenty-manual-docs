...
Zum Beispiel solltest du xref:artikel:vererbung.adoc#[vererbt] werden können.
...
*_Anwendungsfall_*: Die Markierungen siehst du, wenn du deine xref:artikel:suche.adoc#100[gezielt nach Artikeln suchen], die eine bestimmte Markierung oder Kombination von Markierungen haben.
