...
Vielmehr empfehlen wir dir, zuerst den neuen Artikel _ohne Attribute_ anzulegen. Anschließend empfehlen wir dir, Attribute auszuwählen, während du <<artikel/import-export-anlage/anlage/neue-artikel#400, die benötigten Varianten erstellst>>.
