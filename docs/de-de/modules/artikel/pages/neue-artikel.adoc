...
Diese Variante ist die xref:artikel:struktur.adoc#600[Hauptvariante] und sie ist fest mit dem Artikel verbunden.
...
|
|Hier siehst du eine Liste der xref:artikel:attribute.adoc#[Attribute], die du in plentymarkets bereits angelegt hast.

*_Empfehlung_*: Es ist technisch möglich, Attribute hier auszuwählen. Wir empfehlen dies jedoch nicht.
Vielmehr empfehlen wir dir, zuerst den neuen Artikel _ohne Attribute_ anzulegen. Anschließend empfehlen wir dir, Attribute auszuwählen, während du xref:artikel:neue-artikel.adoc#400[die benötigten Varianten erstellst].

Warum? Verknüpfst du Attribute bereits bei der Artikelanlage, müssen _alle folgenden Varianten_ zwangsläufig aus den gleichen Attributen erzeugt werden. Dies ist nicht der Fall, wenn du Attribute erst bei der Variantenanlage verknüpfst.
...
|
a|Hier siehst du eine Liste der xref:artikel:preise.adoc#[Verkaufspreise], die du in plentymarkets bereits angelegt hast.
Du kannst hier einen _Bruttopreis_ für die Hauptvariante speichern:
...
Mit anderen Worten: Kunden kaufen nicht nur ein T-Shirt, sondern _eine bestimmte Variante_ eines T-Shirts, z.B. in der Farbe rot und der Größe S.
...
Es können bis zu 4000 Kombinationen _pro Durchlauf_ erstellt werden.
