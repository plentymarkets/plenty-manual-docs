...
//ToDo - GIF for the variation group function
...
|Soll plentymarkets den Lagerbestand der gewählten Varianten überwachen?
...
|Entspricht dem Button *Temporär verfügbar machen* im Menü xref:artikel:verzeichnis.adoc#290[Artikel » Artikel-UI » [Variante öffnen\] » Element: Mandant (Shop)].

*_Hintergund-Info_*: plentymarkets kann Varianten automatisch aus dem plentyShop entfernen, wenn sie nicht mehr vorrätig sind.
...
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Listen Sichtbarkeitsautomatik » Immer unsichtbar in Artikelauflistung].

| *In Artikelauflistung sichtbar, wenn positiver Netto-Warenbestand*
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Listen Sichtbarkeitsautomatik » In Artikelauflistung sichtbar, wenn positiver Netto-Warenbestand].

| *In Artikelauflistung unsichtbar, wenn negativer Netto-Warenbestand*
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Listen Sichtbarkeitsautomatik » In Artikelauflistung unsichtbar, wenn negativer Netto-Warenbestand].

| *Lieferbar, wenn positiver Netto-Warenbestand*
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Mandanten Verfügbarkeitsautomatik » Lieferbar, wenn positiver Netto-Warenbestand].
...
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Mandanten Verfügbarkeitsautomatik » Nicht lieferbar, wenn negativer Netto-Warenbestand].

| *Sichtbar, wenn positiver Netto-Warenbestand*
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Mandanten Sichtbarkeitsautomatik » Sichtbar, wenn positiver Netto-Warenbestand].

| *Unsichtbar, wenn negativer Netto-Warenbestand*
|Entspricht der Option xref:artikel:verzeichnis.adoc#220[Artikel » Artikel-UI » [Variante öffnen\] » Element: Verfügbarkeit und Sichtbarkeit » Mandanten Sichtbarkeitsautomatik » Unsichtbar, wenn negativer Netto-Warenbestand].
...
. In der oberen Symbolleiste, klicke auf icon:ellipsis-v[role="darkGrey"] und dann auf terra:copy[role="yellow"] *Artikel kopieren*. +
