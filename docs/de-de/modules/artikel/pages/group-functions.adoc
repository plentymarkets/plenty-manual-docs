...
*_Zusätzliche Einstellungen_*: Je nach Eigenschaftstyp musst du noch zusätzliche Informationen im Menü *Artikel » Artikel-UI » [Variante öffnen] » Linke Navigation: Eigenschaften* eingeben. Handelt es sich bei der Eigenschaft z.B. um ein Gewicht oder eine Länge, dann muss der numerische Wert noch eingegeben werden.
