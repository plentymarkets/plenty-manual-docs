...
plentymarkets ermöglicht es dir, viele Informationen für jede xref:artikel:struktur.adoc#250[Variante] separat zu pflegen.
...
Um dies zu verhindern, wird die erste Variante deines Artikels als _Hauptvariante_ definiert.
//Die Hauptvariante unterscheidet sich von den anderen Varianten dadurch, dass ihre Daten weitergegeben, also vererbt werden.
...
[TIP]
.Praxisbeispiele für die Hauptvariante
====
