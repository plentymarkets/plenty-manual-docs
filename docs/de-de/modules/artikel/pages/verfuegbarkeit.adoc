...
+
--
Wenn du die Verfügbarkeit für _nur wenige Varianten_ speichern möchtest, dann empfiehlt es sich, dies manuell zu tun.
...
+
--
Wenn du die Verfügbarkeit für _viele Varianten_ speichern möchtest, dann empfiehlt es sich, dies per Import zu tun.
...
+
--
Wenn du die Verfügbarkeit für _viele Varianten_ speichern möchtest, dann empfiehlt es sich, dies per Varianten-Gruppenfunktion oder Stapelverarbeitung zu tun.
...
. Aktiviere _rechts_ die Option mit den Symbolen 1-10 (icon:check-square[role="blue"]) und wähle die passende Verfügbarkeitsstufe (icon:dot-circle-o[role="blue"]).
