...
* xref:artikel:detailansicht.adoc#100[durch Produktdatensätze zu navigieren]
...
Nachdem du das Menü *Artikel » Neue Artikel-UI* geöffnet und xref:artikel:suchen.adoc#[eine Suche ausgeführt] hast, siehst du die Ergebnisse in einer Übersicht.
