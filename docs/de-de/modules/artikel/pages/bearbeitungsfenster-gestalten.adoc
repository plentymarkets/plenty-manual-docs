...
Wenn du <<artikel/einleitung/suche#100, nach Artikeln suchst>>, werden dir die Suchergebnisse in einer Übersicht angezeigt.
...
* welche <<willkommen/system-personalisieren#160, Spalten in der Artikelübersicht>> angezeigt werden sollen.
* ob die Artikelinformationen in <<willkommen/system-personalisieren#170, aufsteigender oder absteigender Reihenfolge>> angezeigt werden sollen.
====
