...
Hier wird die Erstellung von Multipack-Artikeln beschrieben.
Ausführlichere Informationen zu den verschiedenen Typen findest du im xref:artikel:multipack-paket-set.adoc#250[FAQ-Bereich].
