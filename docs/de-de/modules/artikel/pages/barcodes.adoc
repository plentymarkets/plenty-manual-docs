...
|Sprache
|Gib Koordinaten ein, um <<artikel/einstellungen/barcodes#930, die ausgewählte Sprache>> auf dem Etikett anzuzeigen.
...
|Lagerort
2+<|Gib Koordinaten ein, um den <<warenwirtschaft/wareneingaenge-verwalten#200, vorgeschlagenen Lagerort der Variante>> auf dem Etikett anzuzeigen. +
...
<<artikel/einstellungen/barcodes#1000, Erzeuge danach ein Etikett>> für den Lagerortvorschlag, indem du auf das Etikettensymbol (icon:barcode[role="blue"]) weiter rechts klickst.
...
2+<|<<artikel/artikel-verwalten#70, Freitextfeld>> wählen, damit der Text auf dem Etikett angezeigt wird.
