...
Ist als Preistyp *Verkaufspreis* eingestellt, wird der Betrag dieses Preises nur dann von der Variante gezogen, wenn in der Auftragsposition kein Preis hinterlegt ist; ansonsten wird der Preis aus der Auftragsposition genommen. +
