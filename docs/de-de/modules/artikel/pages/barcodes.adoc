...
Willst du zum Beispiel Barcodes auf deinen Artikel-Etiketten darstellen, dann xref:artikel:barcodes.adoc#1000[druckst sie aus].
...
TIP: Um GTINs für mehrere Varianten gleichzeitig zu generieren, nutze die xref:artikel:massenbearbeitung.adoc#600[Varianten-Stapelverarbeitung].
...
Dann erstelle xref:automatisierung:aktionen.adoc#150[die Aktion Artikeletikett] hinzu.
