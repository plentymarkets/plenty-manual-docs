...
* xref:artikel:hersteller.adoc#100[Erstelle zuerst die nötigen Herstellerdatensätze] manuell oder per Import.
* Füge dann xref:artikel:hersteller.adoc#300[Provisionsmodelle] bei Bedarf hinzu.
* Gib schließlich an, wer jedes deiner Artikel herstellt. Dies geschieht indem du deine xref:artikel:hersteller.adoc#400[Artikel mit Hersteller verknüpfst].
* Sollen deine Kunden im plentyShop gezielt nach Produkten des Herstellers suchen können?
Passe die xref:artikel:hersteller.adoc#450[plentyShop-Einstellungen] bei Bedarf an.
