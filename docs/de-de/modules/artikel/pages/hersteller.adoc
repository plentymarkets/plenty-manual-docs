...
|
include::partial$eu-verantwortlicher-name.adoc[]

| *EU-Verantwortlicher Straße*
|
include::partial$eu-verantwortlicher-strasse.adoc[]

| *EU-Verantwortlicher Haus-Nr.*
|
include::partial$eu-verantwortlicher-haus-nr.adoc[]

| *EU-Verantwortlicher PLZ*
|
include::partial$eu-verantwortlicher-plz.adoc[]

| *EU-Verantwortlicher Ort*
|
include::partial$eu-verantwortlicher-ort.adoc[]

| *EU-Verantwortlicher Land*
|
include::partial$eu-verantwortlicher-land.adoc[]

| *EU-Verantwortlicher E-Mail*
|
include::partial$eu-verantwortlicher-email.adoc[]
