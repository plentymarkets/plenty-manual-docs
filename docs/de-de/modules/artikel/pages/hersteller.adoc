...
Die Idee ist ganz einfach. Anstatt Herstellerinformationen in plentymarkets manuell zu speichern, xref:daten:elasticSync-hersteller.adoc#[trägst du die gleiche Informationen in eine CSV-Datei ein] und importierst diese Datei dann in dein System.
...
====
Vielleicht hast du schon mal bemerkt, dass du xref:crm:kontakt-erstellen.adco#kontakt-erstellen[Herstellerdatensätze im CRM-Bereich erstellen] kannst.
Sei aber vorsichtig.
...
* xref:artikel:massenbearbeitung.adoc#100[Verwende die Gruppenfunktion], um den Hersteller manuell für mehrere bestehende Artikel gleichzeitig anzugeben.
