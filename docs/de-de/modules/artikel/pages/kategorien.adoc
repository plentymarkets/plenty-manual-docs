...
+
--
Wenn du nur wenige Kategorien anlegen oder bearbeiten willst, empfiehlt sich die manuelle Vorgehensweise.
...
+
--
Wenn du eine Vielzahl an Kategorien anlegen oder bearbeiten willst, dann ist es wahrscheinlich am schnellsten, deine Kategoriedaten zu importieren.
...
|icon:lang_multilingual[set=plenty, role="darkGrey"]
...
|icon:settings_transfer[set=plenty, role="darkGrey"]
...
| icon:ticket_folder_move[set=plenty, role="darkGrey"] *Kategorie verschieben*
...
| icon:copy[set=plenty, role="darkGrey"] *Kategorie kopieren*
...
| icon:item_plus[set=plenty, role="darkGrey"] *Neuen Artikel erstellen*
...
. Öffne das Menü *Artikel » Kategorien*.
. Öffne die Kategorie, für die du eine Sprachvariante erstellen möchtest.
. Klicke auf das Symbol *Multilingualität* (icon:lang_multilingual[set=plenty, role="darkGrey"]). +
