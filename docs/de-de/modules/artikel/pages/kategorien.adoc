...
Als xref:webshop:shop-builder.adoc#_kategorie_navigation[Teil der Webshop-Einrichtung] entscheidest du, wie viele Kategorieebenen in der Kopfleiste deines plentyShops angezeigt werden sollen.
====
...
Hast du dir schon einen xref:artikel:kategorien.adoc#100[sinnvollen Kategoriestruktur] überlegt? Dann bist du jetzt bereit, die Haupt- und Unterkategorien zu erstellen, die deine Produkte gruppieren werden.
...
TIP: Es ist technisch auch möglich, Artikeln und Kategorien gleichzeitig zu erstellen.
Eine neue Kategorie kann also direkt bei der xref:artikel:neue-artikel.adoc#200[manuellen Artikelerstellung] mit angelegt werden.
...
TIP: Es ist technisch auch möglich, Artikeln und Kategorien gleichzeitig zu erstellen.
Eine neue Kategorie kann also direkt bei der xref:daten:elasticSync-artikel.adoc#1150[Artikelerstellung] mit angelegt werden.
Diese Methode kann dir viel Zeit sparen, aber sie kann auch dazu führen, dass du den Überblick über deine Kategoriestruktur verlierst.

--
plentyShop und ShopBuilder::
+
--
...
Wenn du also das ShopBuilder-Tool zur Erstellung deines plentyShops verwendest, willst du vielleicht auch xref:webshop:shop-builder.adoc#20[ShopBuilder zur Erstellung deiner Kategorien] verwenden.
...
* xref:artikel:kategorien.adoc#intable-anwendungsfall[wofür möchtest du die Kategorie verwenden]?
* xref:artikel:kategorien.adoc#intable-url[wie soll die URL lauten]?
* xref:artikel:kategorien.adoc#intable-metadaten[hat die Kategorie SEO-relevante Metadaten]?
* xref:artikel:kategorien.adoc#intable-login[soll die Kategorie nur für eingeloggte Personen sichtbar sein]?

[TIP]
.Warum sehe ich manche Einstellungen nicht?
====
Welche Einstellungen angezeigt werden hängt vom xref:artikel:kategorien.adoc#intable-anwendungsfall[Anwendungsbereich der Kategorie ab].
...
Gibt es _Unterkategorien_ unterhalb dieser Kategorie? Dann gilt noch folgendes:
...
. Öffne die xref:webshop:shop-builder.adoc#55[Editor-Ansicht der Kategorie].
...
| icon:ticket_folder_move[set=plenty] *Kategorie verschieben*
...
| icon:copy[set=plenty] *Kategorie kopieren*
...
| icon:item_plus[set=plenty] *Neuen Artikel erstellen*
...
====
Manchmal ist es sinnvoll Artikel in mehrere Kategorien zu führen. Zusätzliche Kategorien können xref:artikel:import.adoc#700[kommasepariert in Import-Dateien] angegeben werden.
====
...
include::page$checkliste-kategorien-anzeige.adoc[tag=systemeinstellungen]
...
include::page$checkliste-kategorien-anzeige.adoc[tag=ebenentiefe]
...
. Öffne das Menü *Artikel » Kategorien*.
. Öffne die Kategorie, für die du eine Sprachvariante erstellen möchtest.
. Klicke auf das Symbol *Multilingualität* (icon:lang_multilingual[set=plenty]). +
