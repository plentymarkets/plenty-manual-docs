...
*_Wichtig:_* In der Liste stehen nur Tags zur Verfügung, die zuvor im Menü *Einrichtung » Einstellungen » Tags* erstellt wurden. Weitere Informationen findest du auf der Handbuchseite <<willkommen/allgemeine-funktionen/tags#, Tags>>.
...
Weitere Informationen zum Erstellen von Ereignisaktionen findest du im Kapitel <<crm/ticketsystem-nutzen#2900, E-Mail-Vorlage automatisch versenden>> auf der Handbuchseite <<crm/ticketsystem-nutzen#, Ticketsystem>>.