...
|link:https://marketplace.plentymarkets.com/plugins/payment[Zahlungsarten^] und Klassen wählen, für die das Versandprofil *nicht* gelten soll.
...
* xref:crm:vorbereitende-einstellungen.adoc#kundenklasse-erstellen[Klasse erstellen]
