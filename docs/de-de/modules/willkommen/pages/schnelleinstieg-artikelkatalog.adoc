...
Definiere Bedingungen für Artikelpreise und Sonderpreise. Möchtest du beispielsweise deine Artikel in deinem Webshop günstiger anbieten als auf Amazon? Kein Problem! In diesem Schritt bestimmst du die Konditionen für einzelne Marktplätze, Klassen, Lieferländer usw.
