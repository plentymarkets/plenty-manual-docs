...
IMPORTANT: Hast du schon Plugins dem System hinzugefügt? Noch nicht? Dann geht's hier zurück zum Schnelleinstieg zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-plugins#, Plugins dem System hinzufügen>>.
...
Im Schritt <<willkommen/schnelleinstieg-basiseinstellungen, Basiseinstellungen>> wurde beschrieben, wie du die E-Mail-Vorlagen für den automatischen Versand gestaltest. +
...
====
Für die korrekte Funktionsweise der nachfolgend beschriebenen Ereignisaktionen musst du zuerst die Vorlage für das Dokument *Rechnung* vollständig einrichten. Eine Anleitung hierzu findest du auf der Handbuchseite <<auftraege/auftragsdokumente#, Auftragsdokumente>>.
====
...
* <<crm/e-mails-versenden#, E-Mails>>
* <<automatisierung/ereignisaktionen#, Ereignisaktionen>>
* <<automatisierung/aktionsmanager#, Aktionsmanager>>
* <<automatisierung/best-practices-automatisierung#, Best Practices: Ereignisaktionen und Aktionsmanager>>
* <<automatisierung/prozesse/prozesse-einrichten#, Prozesse einrichten>>

TIP: Weiter zu den <<willkommen/schnelleinstieg/schnelleinstieg-letzte-schritte#, letzten Schritten>>
