= Warenbestand buchen
:lang: de
:keywords: Ware, Bestand, Warenbestand, Warenbestand buchen, Wareneingang, Artikeldaten, Artikel hinzufügen, Warenbestand korrigieren, Warenbestandskorrektur
:position: 90
:url: willkommen/schnelleinstieg/schnelleinstieg-warenbestand
:id: ZTYZTPX
:author: team-stock

IMPORTANT: Hast du schon deinen Artikelkatalog aufgebaut? Noch nicht? Dann geht's hier zurück zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-artikelkatalog#, Artikelkatalog aufbauen>>.

Alle neuen Wareneingänge müssen in die Warenwirtschaft eingepflegt werden. Je nachdem, ob du nur einen oder mehrere Artikel einpflegen möchtest, bietet sich die Eingabe in verschiedenen Menüs an. Weitere Wege außer dem hier aufgeführten findest du auf der Handbuchseite <<warenwirtschaft/wareneingaenge-verwalten#, Neuer Wareneingang>>.
...
TIP: Weiter zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-webshop#, plentyShop gestalten>>
