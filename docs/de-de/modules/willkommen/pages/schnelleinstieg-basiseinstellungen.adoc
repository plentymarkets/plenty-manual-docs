...
Weitere Informationen zu den Template-Variablen findest du weiter unten auf dieser Seite in den Kapiteln <<willkommen/schnelleinstieg/schnelleinstieg-basiseinstellungen#600, Beispiel: E-Mail-Vorlage anpassen>> und xref:willkommen:schnelleinstieg-basiseinstellungen.adoc#700[Template-Variablen und Template-Funktionen einfügen].
