...
:docinfo1:
:url: willkommen/schnelleinstieg/schnelleinstieg-auftragsabwicklung
:id: C0B259C
:author: team-order-payment

IMPORTANT: Hast du schon deinen plentyShop gestaltet? Noch nicht? Dann geht's hier zurück zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-webshop#, plentyShop LTS-Webshop gestalten>>.
...
Eine vollständige Erklärung der Lageroptionen und findest du unter <<auftraege/grundeinstellungen#intable-warehouse-selection, Automatische Lagerauswahl>>.
...
Eine vollständige Erklärung aller Einstellungen im Menü *Einrichtung » Aufträge » Einstellungen* findest du im Handbuchabschnitt <<auftraege/grundeinstellungen#, Grundeinstellungen>>.
...
* Auftragsdokumente im Tab *Belege* manuell erstellen, soweit du die Dokumentenerzeugung nicht mit <<automatisierung/ereignisaktionen#, Ereignisaktionen>> automatisiert hast.
...
* <<auftraege/auftraege-verwalten#, Aufträge verwalten>>
* <<auftraege/grundeinstellungen#, Grundeinstellungen für Aufträge>>
* <<auftraege/auftraege-verwalten#, Auftragstypen>>
* <<auftraege/auftraege-verwalten#200, Manuelle Auftragsanlage>>
* <<auftraege/auftraege-verwalten#1200, Auftragsstatus>>
* <<auftraege/auftragsdokumente#, Auftragsdokumente>>
* <<auftraege/auftragsherkunft#, Auftragsherkunft>>

TIP: Weiter zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-maerkte#, Märkte anbinden>>.
