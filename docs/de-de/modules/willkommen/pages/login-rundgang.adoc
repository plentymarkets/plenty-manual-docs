...
* *Einrichtung* = In diesem Menü konfigurierst du die Tools und Funktionen in deinem plentymarkets System. Wirf einen Blick auf unsere xref:willkommen:schnelleinstieg.adoc#[Schnelleinstieg]. Diese Hilfsmittel führen neue Benutzer:innen durch die Ersteinrichtung des Systems.
