...
IMPORTANT: Hast du schon Warenbestand gebucht? Noch nicht? Dann geht's hier zurück zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-warenbestand#, Warenbestand buchen>>.
...
* Shop-Aktionen: Listen mit Neuheiten, Sonderangeboten, etc. werden in plentyShop LTS mithilfe von *Tags* abgebildet. Weitere Informationen findest du im Handbuch unter <<artikel/artikel-verwalten#150, Artikel mit Tags versehen>>.
...
| *Canonical*
|Ggf. die URL einer Kategorie eingeben, die den gleichen Inhalt enthält, um *<<omni-channel/online-shop/webshop-einrichten/cms-syntax#110, Duplicate Content>>* zu verhindern.
...
|Stellt eine Checkbox zur Verfügung, mit welcher Kunden und Kundinnen zustimmen können, dass ihre Versandinformationen an den Versandienstleister weitergeleitet werden. Die Anzeige der Checkbox im Webshop ist abhängig davon, ob ein Versandprofil ausgewählt ist, für das die Option <<fulfillment/versand-vorbereiten#1000, Einwilligung zur Datenübermittlung>> aktiv ist.
...
* <<webshop/ceres-einrichten#, plentyShop LTS einrichten>>
* <<webshop/io-einrichten#, IO einrichten>>
* <<webshop/shop-builder#, ShopBuilder einrichten>>
* <<webshop/best-practices#, plentyShop LTS Best Practices>>


TIP: Weiter zum Thema <<willkommen/schnelleinstieg/schnelleinstieg-auftragsabwicklung#, Auftragsabwicklung vorbereiten>>
