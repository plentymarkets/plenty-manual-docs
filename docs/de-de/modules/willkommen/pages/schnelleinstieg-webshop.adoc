...
Im Menü *Einrichtung » Mandant » Global » E-Mail-Konten* im Assistenten *E-Mail-Konten* im Schritt *Automatischer Versand* stehen dir verschiedene Ereignisse zur Verfügung, die mit einer E-Mail-Vorlage verknüpft werden können. Wähle aus der Dropdown-Liste die E-Mail-Vorlage, die du zuvor im Menü *CRM » EmailBuilder* xref:willkommen:schnelleinstieg-basiseinstellungen.adoc#500[erstellt] hast. Dadurch wird bei Eintritt des Ereignisses die E-Mail-Vorlage automatisch an die Kund:in versendet.
...
.Erläuterungen zu einigen Ereignissen im Menü *Einrichtung » Mandant » Global » E-Mail-Konten* im Assistenten *E-Mail-Konten* im Schritt *Automatischer Versand*
[cols="1,3"]
|====
