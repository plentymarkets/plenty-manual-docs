...
|Wo befinden sich deine Artikel, bevor sie verräumt werden? Tippe auf die gewünschten <<warenwirtschaft/lager-verwalten#intable-zweck, Lagerort-Zwecke>>, um sie beim Verräumen ein- oder auszuschließen. +
...
*Lagerortvorschläge* = Lagerorte, die <<warenwirtschaft/wareneingaenge-verwalten#200, mit einer Variante verknüpft>> sind. +
...
| *Zweck*
|Mithilfe dieser Option kannst du Lagerorte mit bestimmten <<warenwirtschaft/lager-verwalten#intable-zweck, Zwecken>> von den vorgeschlagenen Ziellagerorten ausschließen. +
