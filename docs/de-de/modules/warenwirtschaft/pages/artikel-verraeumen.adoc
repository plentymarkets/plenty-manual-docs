...
:position: 40
:id: A5QIHYV
:url: warenwirtschaft/plentywarehouse/artikel-verraeumen
...
. Tippe auf *Verräumen* (image:warenwirtschaft:icon_reshelving.png[width=14, height=14]).
...
|Wo befinden sich deine Artikel, bevor sie verräumt werden? Tippe auf die gewünschten xref:warenwirtschaft:lager-verwalten.adoc#intable-zweck[Lagerort-Zwecke], um sie beim Verräumen ein- oder auszuschließen. +
...
*Aktiviert* (icon:toggle-on[role="green"]) = Alle Zielllagerorte _müssen_ über ihr Etikett gescannt werden, um für das Verräumen erfasst zu werden. Eine manuelle Auswahl von Lagerorten über die Suche ist nicht möglich. +
...
*Lagerortvorschläge* = Lagerorte, die xref:warenwirtschaft:wareneingaenge-verwalten.adoc#200[mit einer Variante verknüpft] sind. +
...
| *Zweck*
|Mithilfe dieser Option kannst du Lagerorte mit bestimmten xref:warenwirtschaft:lager-verwalten.adoc#intable-zweck[Zwecken] von den vorgeschlagenen Ziellagerorten ausschließen. +
...
Bevor das Verräumen mit plentyWarehouse durchgeführt wird, muss sichergestellt sein, dass alle Benutzer:innen über die entsprechenden Berechtigungen verfügen. Nur so können die Artikel korrekt verräumt werden und die Bestandsänderungen im plentymarkets Backend gespeichert werden.

:rights-purpose: Artikel in plentyWarehouse verräumen können
:right-one: pass:quotes[*Artikel > Artikel > Variante > Lagerdaten > Anzeigen*]
