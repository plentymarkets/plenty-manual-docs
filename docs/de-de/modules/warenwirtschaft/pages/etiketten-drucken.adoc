...
Für bestimmte Aufgaben im Lager sollten deine Artikel und Lagerorte mit Etiketten ausgestattet sein. Diese Etiketten enthalten einen Barcode, in dem alle wichtigen Daten gespeichert sind. Über den Handscanner kann das Lagerpersonal während der xref:warenwirtschaft:artikel-verraeumen.adoc#[Verräumen] Artikel und Lagerorte zeitsparend und fehlerfrei identifzieren.
...
. Tippe auf *plentyBase* (image:warenwirtschaft:icon_plentybase.png[width=14, height=14]).
...
* [ ] Hast du eine xref:artikel:barcodes.adoc#800[Vorlage für Artikeletiketten] erstellt?
...
. xref:warenwirtschaft:installation-und-ersteinrichtung.adoc#300[Logge dich in plentyWarehouse ein].
. Suche nach einem xref:warenwirtschaft:artikel-und-lagerorte.adoc#400[Lagerort]. +
