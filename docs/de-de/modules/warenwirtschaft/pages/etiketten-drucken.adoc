...
Vergib nun Berechtigungen, damit die Funktionen zum Drucken von Etiketten für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist.
