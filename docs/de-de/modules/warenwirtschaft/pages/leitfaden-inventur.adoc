...
* Wie du einen Export der Warenbewegungen in einem Katalog erstellst, erfährst du auf der Handbuchseite des Formats xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen].
...
Um festzuhalten, welche Artikelmengen vor der Inventur systemseitig auf Lager waren, sollten diese exportiert werden. Dies geschieht über unseren xref:daten:dateiexport.adoc#[Katalog] und das Exportformat xref:daten:katalog-warenbestaende.adoc#[Warenbestände].
Lege die exportierte Datei anschließend bei dir zur späteren Kontrolle und Dokumentation ab.
...
====
Aktuell beinhalten Zählprotokolle nur Daten zu Inventuren, die mit der xref:warenwirtschaft:plentywarehouse.adoc#[plentyWarehouse App] durchgeführt werden. Inventuren, die mit der xref:app:inventur.adoc#[plentymarkets App] oder lediglich durch den xref:warenwirtschaft:inventur-vornehmen.adoc#[Export und Import von Warenbeständen] vorgenommen werden, können also nicht mithilfe des Zählprotokolls dokumentiert werden.
====
...
Erstelle einen Export mit dem Katalogformat xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen] und filtere dabei nach dem xref:daten:katalog-warenbewegungen.adoc#30[Datumsbereich] und dem xref:daten:katalog-warenbewegungen.adoc#30[Grund] für die Warenbewegung (ID 302), um nur die Warenbewegungen zu exportieren, die während und durch die Inventur entstanden sind. Wenn du ebenfalls den Filter für die xref:daten:katalog-warenbewegungen.adoc#30[Summe der Warenbewegungen] pro Variante nutzt, dann erhältst du beim Export nur eine Datenzeile pro Variante.
...
Das Export-Format xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen] vereinfacht dir die Auswertung der Inventur. Der Katalog mit diesem Format ermöglicht es, Abweichungen zwischen Zählung und vorherigem Bestand im System pro Variante sowie Abweichungen auf einzelnen Lagerorten festzustellen. +
Beachte die nachfolgend beschriebenen Kriterien, um Abweichungen bei Warenbeständen nach der Inventur festzustellen.

[#1600]
=== Kriterium 1: Sind die Bestände eines Artikels vor und nach der Inventur identisch?

Um zu prüfen, ob die Bestände eines Artikels vor und nach der Inventur identisch sind, erstelle einen Katalog mit dem Format xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen]. Exportiere dir damit alle Warenbewegungen (gruppiert pro Variante), die im Zeitraum der Inventur für den Warenbewegungsgrund *Korrektur durch Inventur* durchgeführt wurden.

Um pro Variante zu gruppieren, nutze im Katalog den Filter xref:daten:katalog-warenbewegungen.adoc#30[Summe der Warenbewegungen]. Wähle über einen weiteren Filter zusätzlich auch den xref:daten:katalog-warenbewegungen.adoc#30[Datumsbereich], in dem die Inventur stattgefunden hat.
Um nur die Warenbewegungen zu exportieren, die mit der Inventur zu tun haben, setze außerdem den Filter für den xref:daten:katalog-warenbewegungen.adoc#20[Grund] *Warenkorrektur durch Inventur* mit der ID `302`.
...
*_Beachte:_* Die Liste zeigt allerdings nicht, ob bei einem Lagerort für einen Artikel 5 Stück mehr gezählt wurden und bei einem anderen Lagerort 3 Stück weniger, denn die Summe ist 0. Die Liste dient somit nur dem Gesamtüberblick der Abweichungen, berücksichtigt Abweichungen auf einzelnen Lagerorten aber nicht.
...
Um Abweichungen von Artikeln auf einzelnen Lagerorten sehen zu können, erstelle einen Katalog mit dem Format xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen]. Exportiere dir damit alle Warenbewegungen, die im Zeitraum der Inventur für den Warenbewegungsgrund *Korrektur durch Inventur* durchgeführt wurden.

Nutze dafür zunächst den Filter für den xref:daten:katalog-warenbewegungen.adoc#30[Datumsbereich], in dem die Inventur stattgefunden hat. Um nur die Warenbewegungen zu erhalten, die mit der Inventur zu tun haben, verwende außerdem den Filter für den xref:daten:katalog-warenbewegungen.adoc#20[Grund] *Korrektur durch Inventur* mit der ID `302`.
