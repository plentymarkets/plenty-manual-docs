...
Erstelle einen Export mit dem Katalogformat xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen] und filtere dabei nach dem xref:daten:katalog-warenbewegungen.adoc#30[Datumsbereich] und dem xref:daten:katalog-warenbewegungen.adoc#30[Grund] für die Warenbewegung (ID 302). So werden nur die Warenbewegungen exportiert, die während und durch die Inventur entstanden sind. Wenn du ebenfalls den Filter für die xref:daten:katalog-warenbewegungen.adoc#30[Summe der Warenbewegungen] pro Variante nutzt, enthält der Export nur eine Datenzeile pro Variante.
...
Das Katalogformat xref:daten:katalog-warenbewegungen.adoc#[Warenbewegungen] vereinfacht die Auswertung der Inventurergebnisse. Der Katalog mit diesem Format ermöglicht es, Abweichungen zwischen Zählung und vorherigem Bestand im System pro Variante sowie Abweichungen auf einzelnen Lagerorten festzustellen. +
...
Um nur die Warenbewegungen zu exportieren, die mit der Inventur zu tun haben, setze außerdem den Filter für den xref:daten:katalog-warenbewegungen.adoc#30[Grund] *Warenkorrektur durch Inventur* mit der ID `302`.
...
Nutze dafür zunächst den Filter für den xref:daten:katalog-warenbewegungen.adoc#30[Datumsbereich], in dem die Inventur stattgefunden hat. Um nur die Warenbewegungen zu erhalten, die mit der Inventur zu tun haben, verwende außerdem den Filter für den xref:daten:katalog-warenbewegungen.adoc#30[Grund] *Korrektur durch Inventur* mit der ID `302`.
