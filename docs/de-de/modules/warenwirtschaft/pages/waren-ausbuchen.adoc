...
Eine weitere Möglichkeit, die Paketnummern zu importieren, ist per xref:fulfillment:dokumente-erzeugen.adoc#paketnummern-csv-datei[CSV-Datei].
...
Was reservierter Bestand ist und wann dein System Bestand reserviert, erfährst du unter **xref:warenwirtschaft:warenbestaende-verwalten.adoc#[Warenbestände verwalten]**.
...
Wie du Retouren anlegst und Warenbestand zurückbuchst, erfährst du ausführlich unter **xref:auftraege:auftraege-verwalten.adoc#400[Retoure]**.
...
Wie du Gewährleistungen anlegst, erfährst du ausführlich unter **xref:auftraege:auftraege-verwalten.adoc#600[Gewährleistung]**.
