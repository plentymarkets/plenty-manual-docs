...
Beim Öffnen des Menüs *Waren » Bestellwesen » Bestellung* werden dir alle Umbuchungen und xref:warenwirtschaft:nachbestellungen-vornehmen.adoc#[Nachbestellungen] in einer Übersichtstabelle angezeigt. Wende die Suche (icon:search[set=material]) an, um die angezeigten Umbuchungen und Nachbestellungen eingrenzen.
