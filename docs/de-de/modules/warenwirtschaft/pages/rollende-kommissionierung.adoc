...
Du kannst die rollende Kommissionierung mit plentyWarehouse in den bestehenden xref:automatisierung:prozesse-einrichten.adoc#[Auftragsabwicklungsprozess] deines Unternehmens integrieren. Ergänze dazu deinen bestehenden Prozess im plentymarkets Backend um die folgende Aktion und Subaktion.
...
//|Diese Einstellung bestimmt genauer, nach welchem Kriterium Aufträge in die rollende Kommissionierung einbezogen werden sollen. +
//*Auftrags-ID* = +
//*Erstellungsdatum* = 
...
|[#intable-target-status]*Zielstatus*
...
Für solche Fälle werden dir in der Ansicht des jeweiligen Artikels Shortcuts angezeigt, mit denen du diese Aktionen schnell durchführen kannst. <<table-box-picking-shortcuts>> enthält weitere Informationen zu den verfügbaren Shortcuts.
...
* wie viele Aufträge kommmissioniert wurden
...
Tippe auf icon:done[set=material], um die rollende Kommissionierung abzuschließen.
