...
Vergib nun weitere Berechtigungen, damit die Funktion zur Rollenden Kommissionierung für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist. Vergib optional auch die Berechtigunge für die Anzeige von Auftragsinformationen und Auftragsnotizen.

:rights-purpose: die Funktion *Rollende Kommissionierung* in plentyWarehouse nutzen können

:right-one: pass:quotes[*plentyWarehouse > Rollende Kommissionierung*]
...
*_Tipp:_* Die xref:auftraege:auftraege-verwalten.adoc#1200[Status] in dieser Dropdown-Liste verwaltest du im Backend deines plentymarkets System unter *Einrichtung » Aufträge » Auftragsstatus*.
...
|material:chat[]
| Öffnet die Ansicht zur Eingabe einer Auftragsnotiz. Nutze diese Funktion, um einen Kommentar zu speichern, der in der späteren Abwicklung am Auftrag, in dem der Artikel vorhanden ist, im Backend deines plentymarkets System einsehbar ist.
