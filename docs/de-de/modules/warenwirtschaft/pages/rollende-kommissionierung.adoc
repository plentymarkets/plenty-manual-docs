...
//TODO: Settings Menü beschreiben; Screenshot
...
//TODO: Update: RollKo starten; Screenshot
...
* Den ersten Artikel ans Ende der Liste schieben, z.B. wenn dieser Artikel später gepickt werden soll. --> ja, mit Shortcut



* Den ersten Artikel gänzlich von der Liste entfernen, z.B. wenn der Artikel zur Zeit nicht vorrätig ist. In diesem Fall werden alle Aufträge, die diesen Artikel enthalten, in einen <<#700, Fehlerstatus>> gesetzt. --> Shortcut rotes X, dann kann man optional eine Auftragsnotiz eingeben. 
* Eine Notiz hinterlegen. Die Notiz wird an allen Aufträge, die diesen Artikel enthalten, hinterlegt. --> geht beides nur wenn man schon auf den Lagerort getippt hat. Sprechblasen Shortcut; Shortcuts siehe Screenshot
====
