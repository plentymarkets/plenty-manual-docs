...
Vergib nun weitere Berechtigungen, damit die Funktion zur Rollenden Kommissionierung für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist. Vergib optional auch die Berechtigungen zum Anzeigen von Auftragsinformationen.
