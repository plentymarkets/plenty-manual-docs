...
*Auftrags-ID* = Aufträge werden beginnend mit der niedrigsten Auftrags-ID einbezogen. +
*Erstellungsdatum* = Aufträge werden beginnnend mit dem ältesten Erstellungsdatum einbezogen. +
*Zahlungseingang* = Aufträge werden beginnend mit dem ältesten Zahlungsdatum einbezogen. *_Hinweis:_* Stelle wie gewohnt sicher, dass du nur Aufträge kommissionierst und somit für den Versand vorbereitest, die vollständig bezahlt sind.

2+^| Bereich *Status*

| [#intable-soucrce-status]*Quellstatus*
