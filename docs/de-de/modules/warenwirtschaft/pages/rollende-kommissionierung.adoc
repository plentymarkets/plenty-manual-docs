...
Bevor die rollende Kommissionierung mit plentyWarehouse durchgeführt wird, muss sichergestellt sein, dass alle Benutzer:innen ohne Admin-Konto über die entsprechenden Berechtigungen verfügen. Nur so können die Aufträge korrekt kommissioniert werden.

:rights-purpose: die rollende Kommissionierung in plentyWarehouse verwenden können
:right-one: pass:quotes[*Artikel > Artikel > Artikelbild > Arikelbildname > Lesen*]
:right-two: pass:quotes[*Aufträge > Lesen*]
:right-three: pass:quotes[*Aufträge > Aktualisieren*]
:right-four: pass:quotes[*Kommentare > Lesen*]
