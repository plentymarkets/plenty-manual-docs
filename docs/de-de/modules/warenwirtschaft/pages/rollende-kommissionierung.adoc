...
Kommissionierwagen werden pro Lager angelegt und bei der Einrichtung mit einem Barcode versehen. Somit sind sie selbst streng genommen zwar keine Lagerorte, aber durch den Barcode scan- und nachverfolgbar, sodass sie anschließend durch die plentyWarehouse App erkannt werden können.
