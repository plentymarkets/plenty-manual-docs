...
Barcodes legst du im Menü <<artikel/artikel-verwalten#630, Einrichtung » Artikel » Barcode>> an und anschließend xref:artikel:artikel-verwalten.adoc#250[verknüpfst du Barcodes] mit deinen Varianten.
