...
Barcodes legst du im Menü <<artikel/artikel-verwalten#630, Einrichtung » Artikel » Barcode>> an und anschließend <<artikel/artikel-verwalten#250, verknüpfst du Barcodes>> mit deinen Varianten.
...
| **Bestellen**
| **Ja** = Erlaubt Nachbestellungen aus der Bestandssuche heraus anzulegen. Die Artikel müssen für das Anlegen von Nachbestellungen mit Lieferant:innen verknüpft sein. Die Nachbestellung wird über **Bestellung erstellen** über der Ergebnisliste eingeblendet. Im Kapitel <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen/vornehmen#, Nachbestellungen anlegen>> wird die genaue Vorgehensweise in Schritten erklärt. +
...
Weitere Details zum Meldebestand sowie Nachbestellungen findest du auf der Handbuchseite <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#, Waren nachbestellen>>. +
...
Ware kann auch über die plentymarkets App umgebucht werden. Wie das geht und welche Einstellungen du im Voraus konfigurieren musst, erfährst du auf der Handbuchseite <<app/funktionen/lagerverwaltung/einbuchen-umbuchen#, Ware einbuchen und umbuchen>>.
...
Weitere Infos zum Auftragsstatus findest du <<auftraege/auftraege-verwalten#1200, hier>>.
====
...
icon:map-signs[] *_Oder_*: Klicke auf *Import hinzufügen*, um einen Import vom Typ Artikel, Warenbestand oder Wareneingang zu erstellen. Weitere Informationen zum Erstellen eines Imports findest du auf der Seite <<daten/daten-importieren/ElasticSync#1210, Import-Tool nutzen>>.
...
Du kannst Warenbestandsdaten importieren oder exportieren und so z.B. eine Inventur vornehmen. Das Datenformat <<daten/export-import/datenformate/stock#, Stock>> enthält die meisten Daten über deine Warenbestände. Datenformate, die im Zusammenhang mit deinen Beständen nützlich sein können, sind:

* <<daten/export-import/datenformate/stock#, Stock>>,
* <<daten/export-import/datenformate/variationsupplier#, VariationSupplier>>,
* <<daten/export-import/datenformate/variationwarehouse#, VariationWarehouse>> und
* <<daten/export-import/datenformate/warehouse#, Warehouse>>

Alle Datenformate und eine allgemeine Beschreibung des Datenexports und Datenimports findest du im Thema <<daten#, Datenaustausch>>.
