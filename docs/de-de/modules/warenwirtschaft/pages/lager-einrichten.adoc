...
icon:check-square[role="blue"] = Ja. Die Position der Dimension wird für den Laufweg berücksichtigt.

icon:square-o[role="darkGrey"] = Nein. Die Position der Dimension wird _nicht_ für den Laufweg berücksichtigt.

| *Im Namen anzeigen*
|Soll diese Dimension im Namen des Lagerorts angezeigt werden?

icon:check-square[role="blue"] = Ja. Die Dimension wird im Namen des Lagerorts angezeigt.

icon:square-o[role="darkGrey"] = Nein. Die Dimension wird _nicht_ im Namen des Lagerorts angezeigt.
