...
Box-Regale dienen als Zwischenlager für <<glossar#_s, Sammelkommissionierungen>>. Box-Regale stehen nur in xref:automatisierung:aktionen.adoc#140[Prozessen] zur Verfügung.
