...
! Wähle aus, in welchem Farbschema die plentyWarehouse App auf deinem Gerät dargestellt werden soll. Das blaue Farbschema namens *plentymarkets* ist standardmäßig vorausgewählt. Du kannst jederzeit stattdessen das rote Farbschema *plentymarkets Classic* auswählen.
