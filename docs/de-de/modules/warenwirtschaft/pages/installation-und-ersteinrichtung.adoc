d= Installation und Ersteinrichtung
:author: team-app-bi
...
! *Kamera des Geräts zum Scannen nutzen*
...
! Wenn du diese Option aktivierst, wird im Tab *Bestand* der Artikeldetailansicht und am Artikel selbst ein Button (material:iso[role="red"]) angezeigt, mit dem du den Bestand korrigieren kannst. Wie du diese Option nutzt, um Bestandskorrekturen vorzunehmen, erfährst du auf der Handbuchseite xref:warenwirtschaft:artikel-und-lagerorte.adoc#700[Artikel und Lagerorte].
