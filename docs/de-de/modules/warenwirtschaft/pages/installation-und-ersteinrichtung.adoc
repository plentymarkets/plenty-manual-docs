...
Die plentyWarehouse App funktioniert nur in Kombination mit link:https://www.plentymarkets.com/de/[einem bereits gebuchten plentymarkets System^]{nbsp}icon:external-link[]. Nutzer:innen melden sich in plentyWarehouse ganz einfach mit ihren gewohnten Zugangsdaten zum plentymarkets System an.
...
* image:warenwirtschaft:icon_inspect_storage_location.png[width=14, height=14] xref:warenwirtschaft:artikel-und-lagerorte.adoc#400[Lagerort inspizieren]
...
|Über diesen Menüpunkt richtest du die Verbindung zu xref:automatisierung:etiketten-drucken.adoc#[Artikel oder Lagerorte drucken] möchtest.
