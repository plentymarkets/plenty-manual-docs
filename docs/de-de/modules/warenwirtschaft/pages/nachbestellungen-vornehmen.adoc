...
Im Menü *Aufträge » Aufträge* findest du die neue Auftrags-UI, die sich aktuell in der beta-Phase befindet. Wie du dort Nachbestellungen aus einem Auftrag heraus anlegst, ist im Folgenden beschrieben.
