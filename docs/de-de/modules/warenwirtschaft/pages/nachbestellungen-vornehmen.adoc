...
*Aktiver Benutzer vorausgewählt*: Die Benutzer:in, der die Nachbestellung im plentysystems Backend anlegt, wird im Feld *Eigner* vorausgewählt. +
...
Tags sind Kennzeichnungen, die du zentral in deinem System erstellst und anschließend für verschiedene Bereiche nutzen kannst. Wie du Nachbestellungen mit Tags versiehst und welche Benutzerrechte notwendig sind, ist nachfolgend beschrieben.
...
Möchtest du zuverlässig benachrichtigt werden, sobald es Zeit wird, einzelne Varianten nachzubestellen, solltest du in deinem System für jede Variante einen Meldebestand pflegen. Der Meldebestand zeigt an, bei welcher Menge einer Variante eine Nachbestellung veranlasst werden sollte.
...
Benutzer:innen vom Typ *Backend* xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#105[sehen nur bestimmte Bereiche und Menüs] in plentysystems. Sie können also nur eingeschränkt im System arbeiten. Sollen Mitarbeiter:innen mit dem Zugang *Backend* Nachbestellungen erstellen und abwickeln, benötigen diese Mitarbeiter:innen mindestens die folgenden Rechte:
...
In Kapitel 3 wurden die verschiedenen Wege beschrieben, wie du eine Nachbestellung in deinem System anlegen kannst. Du kannst nun weitere nachzubestellende Artikel in Form von Auftragspositionen hinzufügen. Wende die Suche (material:search[]) an, um die gewünschten Artikel zu finden und hinzuzufügen.
...
====
Pflegst du keine separaten Lager und Lagerorte für deine Artikel in deinem System, werden die Artikel beim Einbuchen auf den im System standardmäßig vorhandenen Standard-Lagerort gebucht.
====
