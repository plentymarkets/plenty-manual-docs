...
Die Option *Titel* aktivieren, wenn die im Menüpunkt *Adressen* des xref:crm:kontakte-verwalten.adoc#100[Kontakts] gespeicherte Titel vor dem Namen des Kontakts positioniert werden soll. +
Die Option *Ansprechpartner* aktivieren, wenn die am xref:crm:kontakte-verwalten.adoc#100[Kontakt] gespeicherten Daten zum Ansprechpartner zusätzlich in Rechnungs- und Lieferanschriften ausgegeben werden soll.
...
* Gesamtsumme Warenbezugskosten = Die Gesamtsumme der Warenbzugskosten wird angezeigt. Grau bedeutet, dass die Gesamtsumme der Warenbezugskosten bei Null liegt. Rot bedeutet, dass die Warenbezuskosten über Null liegen.
...
Beim Öffnen des Menüs *Waren » Bestellwesen » Bestellung* werden dir alle Nachbestellungen und xref:warenwirtschaft:umbuchungen-vornehmen.adoc#[Umbuchungen] in einer Übersichtstabelle angezeigt. Wende die Suche (icon:search[set=material]) an, um die angezeigten Umbuchungen und Nachbestellungen eingrenzen.
...
Genauere Informationen zu diesen Einstellungsmöglichkeiten findest du auf der Handbuchseite xref:automatisierung:ereignisaktionen.adoc#100[Neue Ereignisaktion anlegen].
