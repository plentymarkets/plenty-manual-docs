...
In deinem System sind bestimmte Auftragsstatus voreingestellt. Diese voreingestellten Status stehen dir auch für die Nachbestellungen zur Verfügung. Du kannst aber auch beliebig viele individuelle Status für verschiedene Verwendungszwecke anlegen. Das Anlegen neuer Status wird im dazugehörigen Kapitel auf der Handbuchseite xref:auftraege:order-statuses.adoc#[Auftragsstatus verwenden] beschrieben.
