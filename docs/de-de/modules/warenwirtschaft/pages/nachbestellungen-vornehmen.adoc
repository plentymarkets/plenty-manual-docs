...
Im Menü *Waren » Bestellwesen » Bestellung* nimmst du nicht nur <<warenwirtschaft/umbuchungen-vornehmen#, Umbuchungen>> vor, sondern legst auch Nachbestellungen an. Über Nachbestellungen bildest du die Bestellung von Waren bei deinen Lieferant:innen ab.
...
|Aktiviere diese Option, damit sie für die Artikelsuche in der Nachbestellung vorausgewählt ist. Aktiviere diese Option, damit sie für die Artikelsuche vorausgewählt ist. Angezeigt werden in den Suchergebnissen dann nur <<artikel/webshop/checkliste-artikel-anzeige#100, aktivierte Artikel>>.
...
Unter der Schriftartengruppe *Erweiterte Alphabete* kannst du zwischen den Optionen *East Asian*, *Arabic*, *Cyrillic* wählen, wenn du Dokumentenvorlagen für <<daten/interne-IDs#10, Sprachen>> wie Chinesisch oder Russisch einrichtest.
...
*Attributwerte*: Wähle für die Attributwerte aus, ob sie in der zuvor gewählten Sprache angezeigt werden, oder ob die im Feld <<artikel/einstellungen/attribute#100, interner Name>> vergebene Bezeichnung für das Nachbestellungsdokument verwendet wird.
...
Weitere Informationen zum Umgang mit Dokumentenvorlagen, zum Beispiel zur Verknüpfung einer PDF-Vorlage, findest du auf der Handbuchseite zum Thema <<auftraege/auftragsdokumente#1700, Auftragsdokumente>>.

[#150]
=== Versand des Bestellscheins vorbereiten
Nachdem du im vorherigen Schritt die Dokumentenvorlage für den Bestellschein eingerichtet hast, solltest du im Folgenden noch Einstellungen zum Versand des Dokuments vornehmen, damit dein Lieferant die Nachbestellung auch erhält. Hierfür richtest du zunächst eine E-Mail-Vorlage ein, die den Bestellschein als PDF-Anhang enthält. Die grundlegenden Schritte zur Einrichtung der E-Mail-Vorlage werden im Folgenden beschrieben. Weitere Informationen zu E-Mail-Vorlagen findest du auf der Handbuchseite <<crm/e-mails-versenden#1200, E-Mail-Vorlage erstellen>>.
...
====
Ein statischer Meldebestand lässt sich nur eingeben, wenn der Variante ein Lager zugeordnet ist. Wenn kein Lager zugeordnet ist, füge zunächst das <<artikel/artikel-verwalten#312, Lager hinzu>>.
====
...
Benutzer:innen vom Typ *Backend* <<business-entscheidungen/benutzerkonten-zugaenge#105, sehen nur bestimmte Bereiche und Menüs>> in plentymarkets. Sie können also nur eingeschränkt im System arbeiten. Sollen Mitarbeiter:innen mit dem Zugang *Backend* Nachbestellungen erstellen und abwickeln, benötigen diese Mitarbeiter:innen mindestens die folgenden Rechte:
...
Weitere Informationen zum Messenger allgemein findest du auf der Handbuchseite <<crm/messenger#, Messenger>>.
...
|Wenn du diese Option wählst, werden in in den Suchergebnissen nur <<artikel/webshop/checkliste-artikel-anzeige#100, aktivierte Artikel>> angezeigt.
...
Im Feld *Einkaufspreis* kannst du den voreingetragenen Einkaufspreis ändern oder gewährten Rabatt eingeben, falls deine Lieferant:in dir beispielsweise kurzfristig einen veränderten Preis zugesagt hat. Im Feld *Artikelname* kannst du die Bezeichnung für den Artikel anpassen. Die Änderungen gelten nur für die Nachbestellung, in der sie vorgenommen wurden. Möchtest du die <<artikel/einstellungen#, Artikeleinstellungen>> generell anpassen, kannst du dies im Menü *Artikel » Artikel bearbeiten* im entsprechenden Tab machen.
...
.E-Mail Vorlage einrichten
====
Vor der Nutzung des E-Mail-Service für die Abwicklung der Nachbestellung musst du im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Vorlagen* eine E-Mail-Vorlage für diesen Zweck erstellen. Weitere Informationen findest du auf der Handbuchseite <<crm/e-mails-versenden#1200, E-Mails>>.
====
...
Es werden keine Datumsangaben kopiert, diese kannst du in der neuen Nachbestellung setzen. Auch der *Eigner* wird nicht kopiert. Es wird der aktuelle Benutzer, der die Nachbestellung kopiert, als Eigner gesetzt. Der *Status* wird auf den selbst gewählten <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#120, Standardstatus für Nachbestellungen>> gesetzt.

Darüber hinaus ist das Verhalten der neuen Nachbestellung das gleiche wie das anderer Nachbestellungen auch. Sie bleibt wie gewohnt bearbeitbar, bis die Bestellung <<warenwirtschaft/nachbestellungen-verwalten/nachbestellungen-vornehmen#1000, abgeschlossen>> wird.


[#1100]
== Nachbestellung suchen

Beim Öffnen des Menüs *Waren » Bestellwesen » Bestellung* werden dir alle Nachbestellungen und <<warenwirtschaft/umbuchungen-vornehmen#, Umbuchungen>> in einer Übersichtstabelle angezeigt. Wende die Suche (icon:search[set=material]) an, um die angezeigten Umbuchungen und Nachbestellungen eingrenzen.
