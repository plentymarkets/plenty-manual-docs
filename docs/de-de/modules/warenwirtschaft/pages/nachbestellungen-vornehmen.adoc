...
====
Eine Mindestabnahme lässt sich nur eingeben, wenn der Variante eine Lieferant:in zugeordnet ist. Wenn keine Lieferant:in zugeordnet ist, füge zunächst eine <<artikel/artikel-verwalten#310, Lieferant:in hinzu>>.
====
