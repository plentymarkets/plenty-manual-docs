...
Vergib nun weitere Berechtigungen, damit die Funktion zur Inventur für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist.

:rights-purpose: die Funktion Inventur in plentyWarehouse nutzen können
