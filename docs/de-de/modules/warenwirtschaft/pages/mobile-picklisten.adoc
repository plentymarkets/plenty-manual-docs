...
| *Mandant*
| Filtert alle vorhandenen Picklisten nach ihrem xref:glossar:glossar.adoc#mandant[Mandanten].

| *Lager*
| Filtert alle vorhandenen Picklisten nach ihrem xref:glossar:glossar.adoc#lager[Lager].
