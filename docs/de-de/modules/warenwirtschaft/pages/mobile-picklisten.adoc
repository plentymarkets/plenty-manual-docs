...
:description: Mit der plentyWarehouse App kann dein Lagerpersonal Picklisten, die in deinem plentymarkets System erstellt wurden, bequem auf mobilen Geräten suchen, öffnen und bearbeiten.
...
Bevor Picklisten mit plentyWarehouse abgearbeitet werden, muss sichergestellt sein, dass alle Benutzer:innen ohne Admin-Konto über die entsprechenden Berechtigungen verfügen. Nur so können die Artikel korrekt gepickt werden und die Picklisten korrekt abgeschlossen werden.

:rights-purpose: Picklisten in plentyWarehouse abarbeiten können
:right-one: pass:quotes[*Aufträge > Fulfillment > Pickliste > Lesen*]
:right-two: pass:quotes[*Aufträge > Fulfillment > Pickliste > Aktualisieren*]
...
Vergib nun weitere Berechtigungen, damit die Funktion für mobile Picklisten für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist.

:rights-purpose: die Funktion Picklisten in plentyWarehouse nutzen können
...
====
Werden Artikelbilder, die du in deinem plentymarkets System gespeichert hast, nicht in der Artikelliste angezeigt? Stelle in diesem Fall sicher, dass du im plentymarkets Backend die betreffenden xref:artikel:import-export-anlage-verzeichnis.adoc#94[Bilder mit den passenden Varianten verknüpft] hast.
====
