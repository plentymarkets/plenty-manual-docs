...
|Tippe auf diese Option, um festzulegen, in welcher Reihenfolge die Bestandteile des Artikelnamens angezeigt werden. Tippe und halte (material:drag_handle[]) für jeden Bestandteil, um die Reihenfolge der angezeigten Bestandteile anzupassen.
