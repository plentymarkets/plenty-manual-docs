...
Sobald du eine Pickliste geöffnet hast, wird dir direkt die Liste der Artikel angezeigt, die gepickt werden müssen. 
Für jeden Artikel ist unter anderem der Lagerort angegeben, auf dem er sich befindet, sowie die Menge des Artikels, die gepickt werden muss.
