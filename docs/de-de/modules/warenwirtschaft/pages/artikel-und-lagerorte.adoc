...
Wenn du Lagerorte <<#600, suchst>>, wird für jeden Eintrag in der Ergebnisliste ein Shortcut angezeigt. Dieser erlaubt dir, direkt ein Etikett für den Lagerort zu drucken. Tippe beim Eintrag für den gewünschten Lagerort auf icon:print[set=material], um den Druckvorgang für Lagerort-Etiketten zu starten.
