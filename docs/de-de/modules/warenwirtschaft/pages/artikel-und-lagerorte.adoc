...
. Tippe unten auf *Einstellungen* (icon:settings[set=material]). +
→ Das Einstellungsmenü öffnet sich.
. Tippe auf *Lagerort inspizieren* (image:warenwirtschaft:icon_inspect_storage_location.png[width=14, height=14]).
...
| *Zweck*
|Verwende die Umschaltflächen, um festzulegen, welche xref:warenwirtschaft:lager-verwalten.adoc#intable-zweck[Zwecke] beim Suchen von Lagerorten zur Filterung auswählbar sein sollen. +
