...
:rights-purpose: die Artikelsuche verwenden können
:right-one: pass:quotes[*Einrichtung > Tag > Tag > Lesen*]
...
Vergib nun Berechtigungen, damit die Funktion zur Artikelsuche für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist. Vergib optional auch die Berechtigungen für das <<#intable-assign-barcode, Hinzufügen von Barcodes>>.

:rights-purpose: die Funktion *Artikelsuche* in plentyWarehouse nutzen können
...
Vergib nun weitere Berechtigungen, damit die Funktion *Lagerort inspizieren* für die entsprechenden Benutzer:innen der plentyWarehouse App sicht- und nutzbar ist.

:rights-purpose: die Funktion *Lagerort inspizieren* in plentyWarehouse nutzen können
...
Für die Suche nach Lagerorten in plentyWarehouse muss sichergestellt sein, dass Benutzer:innen ohne Admin-Konto über die entsprechenden Berechtigungen verfügen. Nur so können Suchergebnisse angezeigt und die Lagerorte inspiziert werden.

:rights-purpose: Lagerorte in plentyWarehouse suchen und inspizieren können
:right-one: pass:quotes[*Warenbestände > Lager > Lagerort > Lesen*]
