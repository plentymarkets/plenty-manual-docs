...
// TODO: hier noch die Variablenliste, die man sich für den Betreff einblenden lassen kann, erwähnen.
...
*_Beispiel:_* Wenn du im Betreff deiner Vorlage den Versanddienstleister anzeigen möchtest, setzt du die entsprechende twig expression wie folgt in den xref:crm:emailbuilder-mit-dem-emailbuilder-arbeiten.adoc#betreff-aendern[Betreff] deiner Vorlage ein: `&#123;&#8288;&#123;order.formattedShipping.providerName&#125;&#8288;&#125;`.

Code-Beispiele für den Betreff findest du auf der Handbuchseite xref:crm:emailbuilder-code-beispiele.adoc#code-beispiele-betreff[Code-Beispiele].
