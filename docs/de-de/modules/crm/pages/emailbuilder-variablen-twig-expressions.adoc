...
| `Auftragseingangsdatum und Uhrzeit`
...
Mögliche Werte: *Lagerware*, *Produktionsware*, *Colli*, *Bestellware*.
...
| `Status des retournierten Artikels`
...
| `Vorname und Nachname des Lieferanten`
...
// TODO: Link auf entsprechende Handbuchseite hier reinpacken.
...
| `Gesamtrechnungsbetrag abzgl. Verkaufsgutschein`
|
...
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *HTML*. Klappe den Bereich *AGB* auf und speichere den Text.
| `globals.legalInformation.termsConditions.html \| raw`
| - 

| `Allgemeine Geschäftsbedingungen im reinen Textformat`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *Text*. Klappe den Bereich *AGB* auf und speichere den Text.
| `globals.legalInformation.termsConditions.plain`
| - 

| `Datenschutzerklärung im HTML-Format`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *HTML*. Klappe den Bereich *Datenschutzerklärung* auf und speichere den Text.
| `globals.legalInformation.privacyPolicy.html \| raw`
| $PrivacyPolicyHTML

| `Datenschutzerklärung im reinen Textformat`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *Text*. Klappe den Bereich *Datenschutzerklärung* auf und speichere den Text.
| `globals.legalInformation.privacyPolicy.plain`
| $PrivacyPolicyText

| `Impressum im HTML-Format`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *HTML*. Klappe den Bereich *Impressum* auf und speichere den Text.
| `globals.legalInformation.legalDisclosure.html \| raw`
| $LegalDisclosureHTML

| `Impressum im reinen Textformat`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *Text*. Klappe den Bereich *Impressum* auf und speichere den Text.
| `globals.legalInformation.legalDisclosure.plain`
| $LegalDisclosureText

| `Widerrufsformular im HTML-Format`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *HTML*. Klappe den Bereich *Widerrufsformular* auf und speichere den Text.
| `globals.legalInformation.withdrawalForm.html \| raw`
| $WithdrawalFormHTML

| `Widerrufsformular im reinen Textformat`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *Text*. Klappe den Bereich *Widerrufsformular* auf und speichere den Text.
| `globals.legalInformation.withdrawalForm.plain`
| $WithdrawalFormText

| `Widerrufsrecht im HTML-Format`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *HTML*. Klappe den Bereich *Widerrufsrecht* auf und speichere den Text.
| `globals.legalInformation.cancellationRights.html \| raw`
| $CancellationRightsHTML

| `Widerrufsrecht im reinen Textformat`
|Der Text wird im Menü *Einrichtung » plentyShop » [Shop wählen] » Rechtliches* gespeichert. +
Wähle oben aus den Dropdown-Listen die gewünschte Sprache und den Ausgabetyp *Text*. Klappe den Bereich *Widerrufsrecht* auf und speichere den Text.
...
| `URL zum Abmelden des Newsletters`
|Gibt die URL zum Abmelden des xref:crm:newsletter-versenden.adoc#[Newsletters] aus.
