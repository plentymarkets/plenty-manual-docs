...
image::crm:praxisbeispiel-buttons-emailbuilder.png[width=640, height=360]
...
image::crm:praxisbeispiel-button-alte-vorlagen-einstellungen.png[width=640, height=360]
