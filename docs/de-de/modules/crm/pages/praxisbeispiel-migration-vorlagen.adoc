...
Nachdem die Migration auch <<#box-migration-dates, in deinem System>> erfolgt ist, ist es wichtig, dass du zunächst den Inhalt der migrierten Vorlagen im Menü *CRM » EmailBuilder* prüfst. Öffne dazu die Vorschau der jeweiligen Vorlagen (material:preview[]).
