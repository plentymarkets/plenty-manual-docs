...
Nachdem die Migration auch <<box-migration-dates, in deinem System>> erfolgt ist, ist es wichtig, dass du zunächst den Inhalt der migrierten Vorlagen im Menü *CRM » EmailBuilder (Testphase)* prüfst.
...
* [ ] Hast du in deinem plentymarkets System alle Stellen geprüft, in denen du E-Mail-Vorlagen verknüpft hast?
