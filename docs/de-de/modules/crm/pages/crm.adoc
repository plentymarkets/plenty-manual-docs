...
Alle E-Mails, die über plentysystems versendet werden, basieren auf E-Mail-Vorlagen. Erfahre, wie du mit dem xref:crm:emailbuilder.adoc#[EmailBuilder] deine Vorlagen schnell und intuitiv erstellst.
