...
<<#table-missing-areas-contact-data-record>> listet die Rechte auf, die in der xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#70[Rolle] aktiviert werden müssen, wenn eine Person ohne Adminrechte Bereiche im Kontaktdatensatz nicht sehen kann.
...
<<#table-missing-buttons-contact-data-record>> listet die Rechte auf, die in der xref:business-entscheidungen:benutzerkonten-zugaenge.adoc#70[Rolle] aktiviert werden müssen, wenn eine Person ohne Adminrechte Schaltflächen und/oder Funktionen innerhalb bestimmter Bereiche im Kontaktdatensatz nicht sehen kann.
