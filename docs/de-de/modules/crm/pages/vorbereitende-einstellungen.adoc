...
*_Tipp:_* Wenn du mehrere Zahlungsarten auf einmal aktivieren möchtest, aktiviere (material:check_box[]) die Option *Alle auswählen*. Einzelne Zahlungsarten entfernst du aus der Liste mit einem Klick auf material:close[] neben der Zahlungsart. 
