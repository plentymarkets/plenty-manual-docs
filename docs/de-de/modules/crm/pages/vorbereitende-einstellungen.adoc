...
:keywords: Adress-Layout, Adresslayout, Adresslayout Dokumente, Kundenklasse, Kontaktklasse, Klasse, Kundentyp, Typ, Klasse erstellen, Kontaktklasse erstellen, Typ erstellen, Eigenschaften für Kontakt erstellen, Kundeneigenschaften, Kunden Eigenschaften auf Dokumenten, Tags für Kontakte, Tags für Kunden, Kontakttags, Kunden-Tags, Rabattsystem, Rabatt auf Kundenklasse, Kundenklassenrabatt, Rabatt auf Klasse, Klassenrabatt, Rabattstaffel auf Nettowarenwert, Rabatt auf Zahlungsart, Verkaufspreis als Rabatt, manueller Rabatt für Kunden, manueller Rabatt für Kontakte, Rabatt für Kunden gewähren
...
* <<#kundenklasse-erstellen, Klasse erstellen>>
...
====
Das Einrichten des Rabattsystems in plentysystems ist optional. Lies dir die Möglichkeiten zur Rabattierung in den folgenden Unterkapiteln durch und entscheide dann, ob du Rabattierungen, beispielsweise über die Klassen, erlauben möchtest.
====
