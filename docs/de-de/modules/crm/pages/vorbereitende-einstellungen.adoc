...
Datensätze aus Gastbestellungen erhalten die selbe Kundenklasse wie B2C-Kontakte nach der Anmeldung, sofern eine B2C-Kundenklasse in deinem System vorhanden ist. +
Wenn keine Kundenklassen in deinem System vorhanden sind, erhalten Datensätze die Kundenklasse mit der ID 0.
====
