...
*_Tipp:_* Wenn du mehrere Zahlungsarten auf einmal aktivieren möchtest, halte die cmd-Taste bzw. die Strg-Taste gedrückt und wähle mit der Maus die gewünschten Zahlungsarten aus der Liste.
