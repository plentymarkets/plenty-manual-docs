...
** <<#ansichten-freigeben-bereiche-schaltflaechen, Ansichten für bestimmte Bereiche und Schaltflächen im Kontaktdatensatz freigeben>>
...
[#ansichten-freigeben-bereiche-schaltflaechen]
=== Ansichten für bestimmte Bereiche und Schaltflächen im Kontaktdatensatz freigeben
...
| Firmen, xref:xref:crm:kontakt-bearbeiten.adoc#firma-noch-nicht-verknuepft[Verknüpfung zum Kontakt erstellen], xref:crm:kontakt-bearbeiten.adoc#verknuepfung-firma-loeschen[Verknüpfung zur Firma löschen] 
|CRM > Firma > Erstellen +
