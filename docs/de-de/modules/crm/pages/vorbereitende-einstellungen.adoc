...
Zusätzlich zur Vergabe von automatischen Rabatten hast du die Möglichkeit, einzelnen oder allen Artikelpositionen eines Auftrags manuell einen Rabatt zuzuweisen. Du kannst manuelle Rabatte in 2 verschiedenen Ansichten eingeben: in der Listenansicht der xref:auftraege:order-search.adoc[Auftragssuche] und im Bearbeitungsfenster eines xref:auftraege:order-type-order.adoc#[Auftrags].
