...
|Gib die ID des Kontakts ein, an den Sammelrechnungen bei xref:auftraege:order-type-multi-order.adoc#[Sammelaufträgen] geschickt werden sollen. Die Sammelaufträge werden kundenklassenspezifisch angelegt und die Rechnung wird an den Kontakt gesendet.
