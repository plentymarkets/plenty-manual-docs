...
* <<#rechte-vergeben, Rechte für Personen ohne Adminrechte vergeben>>
...
=== Rechte für das Adress-Layout Personen ohne Adminrechte vergeben
...
Wenn Personen ohne Adminrechte bestimmte xref:crm:kontakt-bearbeiten.adoc#erlaeuterungen-einzelne-bereiche[Bereiche im Kontaktdatensatz] und/oder Schaltflächen und Funktionen in diesen Bereichen nicht sehen können, prüfe die Rechte im Menü *Einrichtung » Kontoverwaltung » Rollen*.
