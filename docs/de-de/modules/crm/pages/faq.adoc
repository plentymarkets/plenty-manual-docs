...
[.collapseBox]
.plenty migriert die alten E-Mail-Vorlagen aus meinem System auf die neue Version des EmailBuilders. Was bedeutet das und muss ich nach der Migration irgendetwas tun?
--
Wie in diesem Forumsbeitrag (ADD LINK) angekündigt, werden Vorlagen, die du in der Vergangenheit im Menü *Einrichtung » Mandant » [Mandant wählen] » E-Mail » Vorlagen* erstellt hast, automatisch in den neuen EmailBuilder migriert.
--
