...
. Klicke auf der linken Seite auf icon:add[set=material] *Neue Firma*.
...
Klicke in der Zeile des gespeicherten Filters auf icon:star_border[set=material] *Als Standard festlegen*. Wenn du einen anderen Filter als Standard festlegen möchtest, deaktiviere den aktuell gewählten Standardfilter mit einem Klick auf icon:star[set=material] *Nicht als Standard verwenden*.
...
. Klicke auf *Kontaktverknüpfung erstellen* (icon:person_add[set=material]). +
