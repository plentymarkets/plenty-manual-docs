...
Die oben aufgeführten Zahlungsbedingungen werden automatisch in den Auftrag sowie in die xref:auftraege:kontakte-verwalten.adoc#intable-kundenklasse-zahlungsziel[Kundenklasse] noch keine Werte hinterlegt sind, die übernommen werden können.
--
