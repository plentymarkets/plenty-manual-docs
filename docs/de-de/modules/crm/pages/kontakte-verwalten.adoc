...
====
Klicke auf *Neuer Auftrag (Beta)*, um die neue Auftragsanlage zu verwenden. Weitere Informationen findest du auf der Handbuchseite xref:auftraege:manually-create-orders.adoc#[Aufträge manuell anlegen] im Kapitel xref:auftraege:manually-create-orders.adoc#create-order-via-contact[Auftrag oder Angebot über Kontakte anlegen].
====
...
Wie du für den Kontakt individuell ein Angebot anlegst, ist im Kapitel xref:auftraege:manually-create-orders.adoc#create-order-via-contact[Auftrag oder Angebot über Kontakte anlegen] beschrieben.
