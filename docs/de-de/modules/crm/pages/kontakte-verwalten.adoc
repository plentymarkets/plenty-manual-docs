...
*_Wichtig:_* Erst nach dem Aktivieren dieser Option können die pain.008-Formate für den xref:payment:bankdaten-verwalten.adoc#220[SEPA-Zahlungsverkehr] abgerufen werden.
