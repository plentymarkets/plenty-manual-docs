...
Im Menü *Einrichtung » CRM* nimmst du vorbereitende Einstellungen wie das Erstellen von xref:crm:kontakte-verwalten.adoc#25[Rabatte] für deine Kontakte ein.
...
Die Zahlungsbedingungen werden in den xref:auftraege:kontakte-verwalten.adoc#300[Kontakt bearbeiten], dort ist ein Beispiel zu den Zahlungsbedingungen aufgeführt.
...
In plentymarkets hast du mehrere Möglichkeiten der Rabattierung. Du kannst deinen Kontakten einen xref:crm:kontakte-verwalten.adoc#30[manuelle Rabatte] eingeben. Nimm die gewünschten Einstellungen für die Rabattarten im Menü *Einrichtung » CRM » Kundenklassen* vor. Wie du die Rabatte gewährst, ist in den folgenden Unterkapiteln beschrieben.
...
Zusätzlich zur Vergabe von automatischen Rabatten hast du die Möglichkeit, einzelnen oder allen Artikelpositionen eines Auftrags manuell einen Rabatt zuzuweisen. Du kannst manuelle Rabatte in 2 verschiedenen Ansichten eingeben: in der Listenansicht der xref:auftraege:auftraege-verwalten.adoc#1530[Auftrags].
...
Weitere Informationen zum nachträglichen Verknüpfen des Kontakts mit einer Firma und zum Erstellen einer neuen Firma findest du in den Kapiteln xref:crm:kontakte-verwalten.adoc#220[Firma erstellen].
...
Wie du eine neue Firma erstellst, ist im Kapitel xref:crm:kontakte-verwalten.adoc#230[Firma bearbeiten] beschrieben.
...
Die folgenden Unterkapitel beschreiben, wie du Eigenschaften xref:crm:kontakte-verwalten.adoc#970[verknüpfst>>, <<#eigenschaften-suchen, suchst>> und <<#eigenschaften-loeschen, löschst>> und wie du Eigenschaften <<#eigenschaften-gruppieren, gruppierst>> sowie Eigenschaften <<#eigenschaften-importieren, importierst>> und <<#eigenschaften-exportieren, exportierst].
...
====
Klicke auf *Neuer Auftrag (Beta)*, um die neue Auftragsanlage zu verwenden. Weitere Informationen findest du auf der Handbuchseite xref:auftraege:auftraege-verwalten.adoc#240[beta: Auftrag oder Angebot aus der Kontaktübersicht anlegen].
====
...
Weitere Informationen findest du auf der Handbuchseite xref:auftraege:auftraege-verwalten.adoc#800[Auftragstyp Sammelauftrag nutzen].
