...
====
Klicke auf *Neuer Auftrag (Beta)*, um die neue Auftragsanlage zu verwenden. Weitere Informationen findest du auf der Handbuchseite xref:auftraege:auftraege-verwalten.adoc[Aufträge verwalten] im Kapitel <<auftraege/auftraege-verwalten#240, beta: Auftrag oder Angebot aus der Kontaktübersicht anlegen>>.
====
