...
|Wähle einen Typ. Standardmäßig stehen die Typen *Kunde*, *Handelsvertreter*, *Lieferant*, *Partner*, *Hersteller* und *Interessent* zur Auswahl. <<crm/kontakte-verwalten#20, Eigene Typen>> erstellst du im Menü *Einrichtung » CRM » Typen*. +
...
- Die Zahlungsart <<payment/payment-plugins/kauf-auf-rechnung#, Kauf auf Rechnung>> muss in deinem plentymarkets System eingerichtet sein, damit diese Zahlungsart im Auftrag zur Verfügung steht. +
...
icon:map-signs[] *_Oder:_* Klicke in das Feld und gib die ersten 3 Buchstaben des Tag-Namens ein. Weitere Informationen zu Tags findest du im Kapitel <<crm/kontakte-verwalten#150, Tags für Kontakte erstellen>>.

2+|[#intable-kontakt-bearbeiten-firma]*Firma*

|[#intable-kontakt-bearbeiten-firma-name]*Name*
|Gib den Namen der bereits <<crm/kontakte-verwalten#220, erstellten>> Firma in das Vorschlagsfeld ein, um diese Firma dem Kontakt zuzuordnen. Oder klicke in das Feld und gib die ersten 3 Buchstaben des Firmennamens ein. +
...
Die folgenden Unterkapitel beschreiben, wie du Eigenschaften <<crm/kontakte-verwalten#960, erstellst>>, mit dem Kontakt <<crm/kontakte-verwalten#970, verknüpfst>>, <<#eigenschaften-suchen, suchst>> und <<#eigenschaften-loeschen, löschst>> und wie du Eigenschaften <<#eigenschaften-gruppieren, gruppierst>> sowie Eigenschaften <<#eigenschaften-importieren, importierst>> und <<#eigenschaften-exportieren, exportierst>>.
...
|Das Zahlungsziel des Auftrags. Damit es hier angezeigt werden kann, muss es in den <<auftraege/auftraege-verwalten#intable-zahlungsbedingungen-auftrag, Zahlungsbedingungen>> am Auftrag hinterlegt sein und eine Rechnung muss erstellt worden sein. +
Diese Spalte ist eine Standardspalte.
...
Importiere oder aktualisiere die Daten deiner Kontakte inklusive Adressoptionen, Kontaktoptionen und Firmendaten über das Import-Tool. Weitere Informationen findest du auf der Handbuchseite <<daten/daten-importieren/ElasticSync#, Import-Tool nutzen>>.
