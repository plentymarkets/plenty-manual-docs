...
.DHL Packstation: Welche Informationen trage ich in welche Felder ein? (Quelle: DHL Website)
image::crm:kontakt-erstellen-dhl-packstation.png[width=320, height=180]

[[image-dhl-postfiliale-paketshop]]
.DHL Postfiliale/Paketshop: Welche Informationen trage ich in welche Felder ein? (Quelle: DHL Website)
