...
<<crm/kontakte/kontakt-erstellen#, icon:long-arrow-left[] Kontakt erstellen>>
...
Weitere Informationen findest du auf der Handbuchseite xref:auftraege:auftraege-verwalten.adoc#[Aufträge verwalten] im Kapitel <<auftraege/auftraege-verwalten#240, beta: Auftrag oder Angebot aus der Kontaktübersicht anlegen>>.
