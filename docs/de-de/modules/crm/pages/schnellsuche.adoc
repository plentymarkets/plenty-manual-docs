...
→ Klicke auf *Neue Nachricht* (material:add[]). Die Stoppuhr oben rechts startet automatisch, sobald die Nachricht geöffnet wird. Klicke neben dem Feld *Minuten* auf *Kostenpflichtig* (material:toggle_off[] terra:pay_cash[]), um die Zeit abzurechnen. +
