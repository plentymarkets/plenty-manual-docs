...
Das Hinzufügen von Kommentaren funktioniert nach dem gleichen Prinzip wie das Hinzufügen von xref:crm:system-personalisieren.adoc#40[Grußformel] wird automatisch in Kommentaren der Benutzer:in eingefügt.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen auf der Handbuchseite xref:crm:e-mails-versenden.adoc#1200[E-Mail-Vorlage erstellen].
...
Weitere Informationen zur Kundenkommunikation im Ticketsystem findest du in den Kapiteln xref:crm:ticketsystem-nutzen.adoc#2800[E-Mail-Vorlage manuell versenden].
...
| *Typ*
|Tickettyp wählen, um eine Vorlage für diesen Typ zu erstellen. Tickettypen werden im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* im Tab xref:crm:ticketsystem-nutzen.adoc#800[Typen &amp; Status] erstellt.

| *Status*
|Ticketstatus wählen, um eine Vorlage für diesen Status zu erstellen. Ticketstatus werden im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* im Tab xref:crm:ticketsystem-nutzen.adoc#900[Typen &amp; Status] erstellt.
...
Im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* können xref:crm:ticketsystem-nutzen.adoc#900[Status] bearbeitet und neue hinzugefügt werden.
...
| *Typ*
|Zeigt den Typ an. Tickettypen werden im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* im Tab xref:crm:ticketsystem-nutzen.adoc#800[Typen &amp; Status] erstellt.

| *Status*
|Zeigt den Status an. Ticketstatus werden im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* im Tab xref:crm:ticketsystem-nutzen.adoc#900[Typen &amp; Status] erstellt.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel xref:willkommen:system-personalisieren.adoc#[Dein System personalisieren].
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
