...
Eigner aktivierst du im Menü *Einrichtung » Einstellungen » Benutzer » Konten » [Benutzer öffnen]* im Tab *Eigner*. Aktiviere für alle Benutzer:innen, die als Eigner:innen im Ticketsystem verfügbar sein soll, die Option *Ticket*. Beachte dazu auch die Handbuchseite <<business-entscheidungen/benutzerkonten-zugaenge#40, Benutzer:innenkonten und Zugänge>>.
...
| *Eigner*
|Eigner wählen, um eine Vorlage für diesen Eigner zu erstellen. Ob eine Benutzer:in als Eigner:in im Ticketsystem gewählt werden kann, wird im <<business-entscheidungen/benutzerkonten-zugaenge#40, Benutzer:innenkonto>> festgelegt.
