...
Speichere für Eigner, die das Ticketsystem nutzen sollen, im Benutzer:innenkonto in den Tabs *Signatur* und *Grußformel* Signaturdaten. Die Signatur wird mit vorangestellter Grußformel in E-Mails ausgegeben. Die Grußformel wird zusätzlich in Nachrichten und Kommentaren im Ticketsystem automatisch an den Text angehängt. Weitere Informationen findest du auf der Handbuchseite <<willkommen/system-personalisieren#, Dein System personalisieren>>.
...
Wenn du im Menü *CRM » Ticketsystem* im Tab *Tickets* über <<willkommen/system-personalisieren#160, Ansicht einrichten>> die Option *Statusgruppe* aktiviert hast, siehst du direkt nach dem Erstellen eines Tickets in der Ticketübersicht, in welchem Status sich das Ticket befindet. Die Statusgruppe wird ebenfalls im Ticket neben *Tags anzeigen/verbergen* angezeigt.
...
| *Rolle*
|Rolle des Eigners aus der Dropdown-Liste wählen. Zur Auswahl stehen die im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* im Tab *Rollen* hinzugefügten <<crm/ticketsystem-nutzen#700, Rollen>>. +
...
|Nachrichten sind blau gekennzeichnet und für die Kund:innen sichtbar. Wenn ein Ticket *vertraulich* ist, können keine Nachrichten geschrieben werden. Weitere Informationen findest du im Kapitel <<crm/ticketsystem-nutzen#2400, Nachricht hinzufügen>>.

| *Kommentar hinzufügen*
|Kommentare sind rot gekennzeichnet und für die Kund:innen _nicht_ sichtbar. Kommentare dienen der internen Kommunikation. Weitere Informationen findest du im Kapitel <<crm/ticketsystem-nutzen#2500, Kommentar hinzufügen>>.
...
|Erstellt aus dem Ticket heraus eine neue Karte auf dem aus der Dropdown-Liste gewählten Board. Der Karte kann außerdem ein Präfix hinzugefügt werden. <<willkommen/system-personalisieren#350, Boards>> erstellst du im Menü *plentymarkets Logo (Start) » Boards*.
...
. Wähle die zuvor im Menü *Einrichtung » CRM » Ticketsystem » Vorlagen* erstellte <<crm/ticketsystem-nutzen#3100, Vorlage>> aus der Dropdown-Liste.
...
====
Wenn du mehrere <<crm/ticketsystem-nutzen#2100, E-Mail-Konten>> im Menü *Einrichtung » CRM » Ticketsystem » E-Mail-Konten* eingerichtet hast, wird für den Versand einer Antwortnachricht auf ein Formularticket das E-Mail-Konto verwendet, das du zuerst eingerichtet haben.
====

[#2400]
== Nachricht hinzufügen

Nachrichten sind für die externe Kommunikation gedacht, d.h. für die Kommunikation mit deinen Kund:innen. Klicke zum Erstellen einer neuen Nachricht auf *Nachricht hinzufügen* und gib anschließend im Fenster *Nachricht* den Nachrichtentext im Textfeld ein. In der Symbolleiste stehen dir Formatierungsmöglichkeiten zur Verfügung. Eine im Benutzer:innenkonto gespeicherte <<willkommen/system-personalisieren#40, Grußformel>> wird automatisch in Nachrichten der Benutzer:in eingefügt.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen auf der Handbuchseite <<crm/e-mails-versenden#, E-Mails>> im Kapitel <<crm/e-mails-versenden#1200, E-Mail-Vorlage erstellen>>.
...
| `$SignatureHTML`
|Folgende Aussage ist nur gültig, wenn <<crm/ticketsystem-nutzen#2900, E-Mail-Vorlagen über eine Ereignisaktion>> versendet werden: Zeigt die Grußformel und die Signatur an, die in den Einstellungen des Benutzer:innenkontos gespeichert sind. +
...
image::crm/assets/crm-ticketsystem-ereignisaktion-automatische-antwort.png[width=640, height=360, alt=Beispiel einer Ereignisaktion "Automatische Antwort an Kunden"]

Wichtig ist hierbei, dass du die in plentymarkets vorhandenen Template-Variablen in die E-Mail-Vorlagen einfügst wie in Kapitel <<crm/ticketsystem-nutzen#2900, E-Mail-Vorlage manuell versenden>> beschrieben.
...
Weitere Beispiele zum Einrichten von Ereignisaktionen im Bereich Aufträge findest du auf der Handbuchseite <<automatisierung/ereignisaktionen#, Ereignisaktionen>>.
...
*Persönlich* = Die Vorlage steht der Benutzer:in zur Verfügung, der die Vorlage erstellt hat. Weitere Informationen findest du im Kapitel <<crm/ticketsystem-nutzen#3200, Persönliche Ticketvorlage erstellen>>. +
...
*FAQ* = Auf *Bearbeiten* klicken. Das Fenster *FAQ auswählen* wird geöffnet. <<crm/ticketsystem-nutzen#2700, FAQ>> wählen, die bei Verwendung der Vorlage eingegeben wird. Auf *Übernehmen* klicken. +
...
Im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* können <<crm/ticketsystem-nutzen#800, Typen>> und <<crm/ticketsystem-nutzen#900, Status>> bearbeitet und neue hinzugefügt werden.

| *Statusgruppe*
|Eine, mehrere oder alle Optionen aus der Dropdown-Liste wählen. +
Im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* können <<crm/ticketsystem-nutzen#1000, Statusgruppen>> bearbeitet und neue erstellt werden.
...
| *Kundenklasse*
|Kundenklasse wählen, um nur Tickets von Kund:innen dieser Kundenklasse zu suchen. <<crm/kontakte-verwalten#15, Kundenklassen>> werden im Menü *Einrichtung » CRM » Kundenklassen* erstellt.
...
| *Rolle*
|Eine, mehrere Rollen oder alle Optionen aus der Dropdown-Liste wählen. <<crm/ticketsystem-nutzen#700, Rollen>> werden im Menü *Einrichtung » CRM » Ticketsystem » Einstellungen* erstellt.
...
Per Aktionsmanager im Menü *Einrichtung » CRM » Ticketsystem » Aktionen* kann an das Ticket erinnert werden. Ein Beispiel, wie man eine Aktion einrichtet sowie Filter und Uhrzeit wählt, ist im Kapitel <<crm/ticketsystem-nutzen#3000, Tickets automatisch löschen>> beschrieben.
...
| *Ordner*
|Zeigt den Ordner an. Ordner werden im Menü *Einrichtung » CRM » Ticketsystem* im Tab <<crm/ticketsystem-nutzen#4500,Ordner>> erstellt.
...
| *Kunde*
|Zeigt die ID und den Namen der Person an. Personen werden teilweise <<crm/ticketsystem-nutzen#2100, automatisch zugeordnet>>, z.B. beim automatischen Erstellen von Tickets aus E-Mails.
...
Im Tab *Kunde* des Tickets im Menü *CRM » Ticketsystem* sind die <<crm/kontakte-verwalten#300, Kontaktdaten>> enthalten wie sie auch im Menü *CRM » Kontakte » [Kontakt öffnen]* angezeigt werden. Du kannst den Kontaktdatensatz hier auch bearbeiten. Dieses Tab ist nur sichtbar, wenn das Ticket mit einem Kontakt verknüpft ist.
...
Wenn du im Menü *CRM » Ticketsystem* im Tab *Tickets* über <<willkommen/system-personalisieren#160, Ansicht einrichten>> die Option *Anhang* aktiviert hast, siehst du direkt in der Ticketübersicht, welches Ticket einen Anhang hat.
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/system-personalisieren#210, Aufgabe erstellen>> auf der Handbuchseite <<willkommen/system-personalisieren#, Dein System personalisieren>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen. +
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen im Kapitel <<willkommen/system-personalisieren#220, Aufgaben suchen>> auf der Handbuchseite <<willkommen/system-personalisieren#, Dein System personalisieren>>.
. Klicke auf *Suchen* (icon:search[role="blue"]).
...
. Nimm die gewünschten Einstellungen vor. Beachte dazu die Erläuterungen zu den *Filtern* in <<#table-search-ticket>> im Kapitel <<crm/ticketsystem-nutzen#3400, Ticket suchen>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
...
Beachte die Stichworte, die zu einer Zuordnung führen, und die Schreibweisen in <<#table-assignment-ticket-system>>. Groß- und Kleinbuchstaben spielen keine Rolle. Prüfe dazu auch die <<crm/e-mails-versenden#1200, E-Mail-Vorlagen>>, die du im Ticketsystem verwendest, und korrigiere bzw. ergänze je nach Bedarf Template-Variablen.
...
Beachte dazu auch die Erläuterung zu der Einstellung *Verfahren* in <<#table-set-up-email-account>> im Kapitel <<crm/ticketsystem-nutzen#2100, E-Mail-Konto einrichten>>.
====
...
Weitere Informationen findest du auf der Handbuchseite <<business-entscheidungen/plenty-bi/statistiken#, Statistik>>. Dort wird auch beschrieben, wie du Statistiken erstellst und auswertest.
