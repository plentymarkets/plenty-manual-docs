...
====
Die im Benutzerkonto eingegebene Signatur hat Priorität gegenüber der Signatur, die im Menü xref:crm:e-mails-versenden.adoc#600[Einrichtung » Mandant » [Mandant wählen] » E-Mail » Signatur] gespeichert ist. +
...
Mit Formularen kannst du Kontaktformulare in deinen plentyShop einbinden, damit Interessent:innen und Kund:innen mit dir in Kontakt treten können. Besucher:innen deines plentyShops füllen die Formulare aus und diese werden dann als Ticket erstellt. 
...
→ Jedes Mal, wenn ein:e Besucher:in ein Formular in deinem plentyShop ausgefüllt und abgeschickt wird, wird ein Ticket in deinem plentyShop erstellt.


[IMPORTANT]
.Zuordnung ausschließlich anhand von E-Mail-Adressen
====
Kontaktformulare werden ausschließlich anhand der E-Mail-Adresse der Kund:innen zugeordnet. Eine E-Mail-Adresse in Kontaktformularen muss vom im dafür vorgesehenen Feld *E-Mail* eingegeben sein, ansonsten erkennt dein plentymarkets System nicht, dass es sich bei der Information um die E-Mail-Adresse handelt. E-Mail-Adressen, die in anderen Feldern, z.B. Nachricht oder Sonstiges eingegeben werden, werden _nicht_ für die Zuordnung berücksichtigt und werden auch _nicht_ für eine Antwort verwendet.
====
