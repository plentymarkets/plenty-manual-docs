...
In diesem Kapitel ist beschrieben, wie du die E-Mail-Weiterleitung für den Messenger bei Gmail einrichtest.
...
. Klicke in der Leiste oben auf *Weiterleitung & POP/IMAP* und dann auf *Weiterleitungsadresse hinzufügen*. +
