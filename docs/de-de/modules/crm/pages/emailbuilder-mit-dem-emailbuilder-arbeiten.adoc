...
|[#intable-template-settings-exclude-from-email-service]*Vorlage in E-Mail-Auswahl ausblenden*
...
Im Bereich *Allgemeine Einstellungen* der Vorlage wählst du einen Eigner, den Mandanten und den Header und Footer, falls noch nicht geschehen. Dort kannst du auch bis zu 4 dynamische Anhänge wählen und die Felder *Antwort an*, *CC* und *BCC* befüllen. Zudem kannst du die <<#intable-template-settings-exclude-from-email-service, Vorlage auch in der Auswahl für den E-Mail-Service ausblenden>>.
