...
// TODO: Screenshot muss in EN noch ausgetauscht werden.
...
====
Wenn du später mehrere Vorlagen zur selben Zeit bearbeitest, kannst du über die Navigation auf der linken Seiten zwischen den einzelnen Vorlagen hin- und herwechseln. Die Vorlage, die du gerade geöffnet hast, ist blau hinterlegt. +
Außerdem wird angezeigt, in welchem Bereich der Vorlage du dich gerade befindest: Wenn in der Navigation auf der linken Seite unterhalb der Vorlage der Bereich material:edit[] *Bearbeiten (_Sprache_)* blau hinterlegt ist, befindest du dich im Editor der Vorlage. Wenn material:translate[] *Spracheinstellungen* blau hinterlegt ist, befindest du dich gerade in den sprachabhängigen Einstellungen der Vorlage.
...
// TODO: Screenshot auch in EN erneuern.
...
*_Hinweis:_* Wenn du die Vorlage nicht innerhalb eines Ordners erstellen möchtest, klicke auf der Startseite des Menüs *CRM » EmailBuilder (Testphase)* direkt unten links auf material:add[] *Hinzufügen* material:play_arrow[] und wähle dann material:description[] *Vorlage*. Die Vorlage wird dann auf der ersten Ebene erstellt, ohne dass sie zu einem Ordner gehört.
...
Mit einem Klick auf material:css[] in der Toolbar ganz oben kannst du das <<#intable-template-settings-custom-styles, benutzerdefinierte Styling>> deiner Vorlage anpassen.
...
Sobald die Standardvorlage erstellt ist, siehst du im Editor den vorausgefüllten Inhalt. Den Inhalt kannst du mit einem Klick auf material:edit[] anpassen. +
In der Toolbar siehst du den vorausgefüllten Betreff. Den Betreff kannst du mit einem Klick auf material:translate[] ganz oben rechts anpassen. Dort wählst du auch bis zu 3 statische Anhänge, die du an die E-Mail-Vorlage anhängen möchtest. +
Im Bereich *Einstellungen* wählst du einen Eigner, den Mandanten und den Header und Footer, falls noch nicht geschehen. Dort kannst du auch bis zu 3 dynamische Anhänge wählen und die Felder *Antwort an*, *CC* und *BCC* befüllen.

*_Hinweis:_* Wenn du die Standardvorlage nicht innerhalb eines Ordners erstellen möchtest, klicke auf der Startseite des Menüs *CRM » EmailBuilder (Testphase)* direkt unten links auf material:add[] *Hinzufügen* material:play_arrow[] und wähle dann material:description[] *Vorlage*. Die Vorlage wird dann auf der ersten Ebene erstellt, ohne dass sie zu einem Ordner gehört.
...
Angenommen, du hast eine Versandbestätigung in deutscher Sprache verfasst und Widgets und Variablen eingefügt  und möchtest diese Versandbestätigung auch in französischer Sprache für deine französischsprachigen Kund:innen erstellen. Dann ist der schnellste Weg, die Vorlage zu kopieren und anschließend die Übersetzung anzupassen. Wie du dazu vorgehen musst, ist im Kapitel <<#vorlage-kopieren, Vorlage kopieren>> beschrieben.
