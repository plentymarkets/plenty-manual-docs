...
====
Beachte den xref:crm:emailbuilder-uebersicht.adoc#[neuen EmailBuilder-Handbuchbereich] mit den unterschiedlichen Unterseiten, um die Menge an Informationen zum EmailBuilder übersichtlicher aufzurufen.
====
