...
In der Symbolleiste siehst du den vorausgefüllten Betreff. Den Betreff kannst du mit einem Klick auf material:translate[] ganz oben rechts anpassen. Dort wählst du auch bis zu 3 statische Anhänge, die du an die E-Mail-Vorlage anhängen möchtest. +
