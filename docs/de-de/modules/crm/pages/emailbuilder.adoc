...
Im Menü *Einrichtung » Mandant » Global » E-Mail-Konten* im Assistentenschritt *Messenger-Integration* legst du fest, ob alle gesendeten E-Mails sowie Anhänge im xref:crm:messenger-testphase.adoc#[Messenger] gesammelt werden sollen. Du entscheidest außerdem, in welchem Posteingang die E-Mails gesammelt werden und welchen Tag die Konversationen erhalten sollen.
