...
In diesem Kapitel zeigen wir dir anhand eines Beispiels, wie du komplexe Vorlagen im Expertenmodus kannst.

Im Folgenden zeigen wir dir, wie du eine Auftragsbestätigung im Expertenmodus erstellst. 
// TODO: Du benötigst dafür den Ordner Hilfsordner, eine Basisvorlage, ....

Erstelle am besten einen Ordner mit dem Namen *Hilfsvorlagen* und erstelle darin eine Vorlage im Expertenmodus und nenne sie Basisvorlage. Die Basisvorlage bildet sozusagen das Grundgerüst für deine Vorlage.
...
// TODO: screenshot vom order item widget einfügen.

Im nächsten Schritt erweitern wir die Basisvorlage mit dem Text für die Auftragsbestätigung.
In unserem Beispiel hat die Basisvorlage in DE die ID 103.
