...
. Nimm die gewünschten Änderungen in der Vorlage vor.
...
// TODO: (bei Klick auf Variable wird automatisch die passende twig expression in Zwischenablage kopiert - dann einfügen)
