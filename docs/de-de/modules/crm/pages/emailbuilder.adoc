...
|Wähle für das Zahlenformat die deutsche oder die englische Schreibweise. +
Die deutsche Schreibweise zeigt Zahlenformate zum Beispiel folgendermaßen an: 1,25 oder 1.000,25. Die englische Schreibweise zeigt Zahlenformate zum Beispiel folgendermaßen an: 1.25 oder 1,000.25. 
