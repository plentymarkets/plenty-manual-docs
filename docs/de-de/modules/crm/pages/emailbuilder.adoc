...
////
TODO: Screenshot erneuern, nachdem alles korrekt umbenannt wurde. Englische Benennung der png Datei!
////
...
. Klicke unten links auf material:add[] *Hinzufügen* material:play_arrow[] > material:folder[] *Ordner* +
...
[TIP]
Wenn du alle Einstellungen wie im Folgenden beschrieben vorgenommen hast – also Unterordner, Vorlagen, Header und Footer erstellt hast –, kannst du den Hauptordner mit einem Klick auf material:chevron_right[] material:[] _Name des Ordners_ öffnen. Dort siehst du dann auf einen Blick alle Unterordner, Vorlagen, Header und Footer, die du direkt unter dem Hauptordner erstellt hast.
...
. Wähle (material:check_mark[role=skyBlue]) im Bereich *Einstellungen* den Eigner und den Mandant.
...
2+^| *Sprachabhängige Einstellungen* (material:translate[])

| material:translate[]
|Mit einem Klick auf material:translate[] oben rechts im Bereich *Einstellungen* öffnen sich die sprachabhängigen Einstellungen.
...
// TODO: dieses Kapitel muss auch überarbeitet werden, nachdem die neue Suche eingebaut ist.
