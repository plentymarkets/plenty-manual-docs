...
Erfahre in den folgenden Unterkapiteln, welche Variablen dir zur Verfügung stehen und wie die dazugehörigen twig expressions lauten, die du im Code-Widget und im Betreff der Vorlage einfügen kannst.
...
Möchtest du wissen, welche Variablen für die einzelnen Kategorien und Unterkategorien zur Verfügung stehen und wie die twig expressions lauten, die du im Code-Widget verwenden kannst? Dann klappe einfach die folgenden Bereiche auf (icon:expand_more[set=material]).
