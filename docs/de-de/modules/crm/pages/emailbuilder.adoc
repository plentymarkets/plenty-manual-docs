...
*** <<#variablen-auftrag-auftragspositionen-barcode, Barcode>>
...
// ** <<#variablen-auftrag-eigenschaften, Eigenschaften>>
...
// ** <<#variablen-kontakt-adressoptionen, Adressoptionen>>
...
// TODO: hier müssen dann noch weitere unterkategorien ergänzt werden: Allgemein, Barcode, Eigenschaften, Freitextfelder, Verfügbarkeiten

////
#variablen-auftrag-auftragspositionen-allgemein
#variablen-auftrag-auftragspositionen-barcode
#variablen-auftrag-auftragspositionen-eigenschaften, Eigenschaften
#variablen-auftrag-auftragspositionen-freitextfelder, Freitextfelder
#variablen-auftrag-auftragspositionen-verfuegbarkeiten, Verfügbarkeiten
////
...
// TODO: Einleitung und ggf. Tabelle ergänzen

////
TODO: prüfen, ob es die jetzt noch gibt oder ob die jetzt Bestellmerkmale heißen.

[#variablen-auftrag-eigenschaften]
==== Variablen: Auftrag / Eigenschaften
...
====== Variablen: Auftrag / Lieferadresse / Daten der Lieferadresse
...
// TODO: Variablen ausschneiden und hier einfügen

|====

[#variablen-auftrag-lieferadresse-optionen]
====== Variablen: Auftrag / Lieferadresse / Optionen der Lieferadresse
...
// TODO: Auftrag Lagername fehlt noch.
...
====== Variablen: Auftrag / Rechnungsadresse / Daten der Rechnungsadresse
...
====== Variablen: Auftrag / Rechnungsadresse / Optionen der Rechnungsadresse
...
// TODO: Gesamtrabatt brutto und Gesamtrabatt netto fehlen 
...
// TODO: Transaktions-ID der Zahlung fehlt an dieser Stelle
...
===== Variablen: Auftrag / Auftragspositionen (nur für Artikellisten-Widget) / Eigenschaften
...
[#variablen-kontakt-adressoptionen]
==== Variablen: Kontakt / Adressoptionen

[[table-variables-contact-address-options]]
.Variablen in der Unterkategorie *Kontakt / Adressoptionen*
[cols="1,2,3"]
|====
|Name der Variable |Erläuterung |Twig expression
...
[[table-variables-contact-delivery-address]]
...
[[table-variables-contact-invoice-address]]
...
// TODO: Tabelle ist komplett, außer Erklärung und twig für E-Mail-Absender.
...
// TODO: E-Mail-Absender / erklärung und twig noch ergänzen.
...
Klicke auf einen der folgenden Links, um direkt in das entsprechenden Unterkapitel mit dem Code-Beispiel weitergeleitet zu werden:
