...
| TODO: Erklärung hinzufügen / welche Variable muss in der Vorlage enthalten sein und in welcher Kategorie findet man die Variable
...
// TODO: Gibt es bei "Benachrichtigung bei verfügbarem Artikel" keine spezielle Variable?
