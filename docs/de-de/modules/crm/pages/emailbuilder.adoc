...
// Die Variable `Auftrag im Webshop aufrufen` muss in der Vorlage enthalten sein. +
// *_Hinweis:_* Du findest die Variable in der Kategorie <<#variablen-auftrag, Auftrag>>. +
