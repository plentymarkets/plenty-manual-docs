...
`hh` steht für die Stunde, `ii` für die Minuten, `ss` für die Sekunden und `a` für die Markierung AM (Ante meridiem). Standardmäßig ist das Zeitformat `HH:ii` vorausgewählt. +
Verfügbare Formate:
