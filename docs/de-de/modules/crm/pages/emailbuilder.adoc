...
// TODO: hier ein Bild dieser Ansicht mit Sprache(n) und Betreff verlinken, das unterhalb der Tabelle angezeigt werden soll. 
...
In diesem Bereich nimmst du die sprachabhängigen Einstellungen vor.
...
|[#intable-template-settings-subject]*Betreff*
|Hier siehst du den Betreff der Vorlage. Du kannst den Betreff anpassen, wenn gewünscht. 
...
|Hier kannst du das CSS-Styling deiner Vorlage anpassen. <<#beispiele-benutzerdefiniertes-styling, In der aufklappbaren Box unterhalb dieser Tabelle>> findest du einige gängige Beispiele, wie du das Styling deiner Vorlage anpassen kannst. +
...
--
In diesem Bereich findest du einige gängige Beispiele, um das Styling deiner Vorlage anzupassen.
...
[TIP]
Nimm _vor dem Kopieren_ der Vorlage auch die Einstellungen im Bereich <<#intable-general-template-settings, Einstellungen>> vor. Der Vorteil bei dieser Reihenfolge ist, dass du so auch die Einstellungen selbst und nicht nur den Inhalt der Vorlage kopierst udn diese nicht erneut für die anderen Vorlagen vornehmen musst.
