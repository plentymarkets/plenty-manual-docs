...
|Klicke auf material:more_vert[] und dann auf material:preview[] und wähle *Vorschau HTML* oder *Vorschau reiner Text*. Die Vorschau wird in einem separaten Fenster geöffnet.
