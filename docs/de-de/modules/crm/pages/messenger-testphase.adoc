...
* <<#kontextmenue-als-gelesen-ungelesen-markieren, Konversation als gelesen / ungelesen markieren>>
* <<#kontextmenue-tags, Tags einer Konversation zuweisen>>
* <<#kontextmenue-als-erledigt-nicht-erledigt-markieren, Konversation als erledigt / nicht erledigt markieren>>
...
[#kontextmenue-als-erledigt-nicht-erledigt-markieren]
...
. Klicke auf icon:done_all[set=material] *Als erledigt markieren*. +
→ Am Zeilenanfang der Konversation wird das Symbol icon:done_all[set=material] angezeigt.
...
. Klicke auf icon:remove_done[set=material] *Als nicht erledigt markieren*. +
→ Am Zeilenanfang der Konversation wird das Symbol icon:done_all[set=material] entfernt.
...
// Screenshot von der Glocke im Backend oben rechts hinzufügen / Text anpassen, da UI angepasst wurde.
