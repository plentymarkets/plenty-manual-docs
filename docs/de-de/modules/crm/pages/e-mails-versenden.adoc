...
====
Eine Übersicht zur CMS-Syntax, die du noch in den "alten" E-Mail-Vorlagen verwenden kannst, findest du in diesem xref:webshop:cms-syntax.adoc#[Handbuchbereich].
==== 
...
*_Hinweis:_* Wenn du möchtest, dass dein:e Kund:in über diese E-Mail in die Auftragsabwicklung in deinem Webshop gelangen kann, um den Status der Bestellung einzusehen, musst du die Template-Funktion `{%Link_Checkout()%}` in die E-Mail-Vorlage, die du für dieses automatische Ereignis wählst, einfügen.
