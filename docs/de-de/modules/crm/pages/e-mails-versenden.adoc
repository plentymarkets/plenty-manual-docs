...
. Wähle im Schritt *Automatischer Versand* in der Zeile des Ereignisses die E-Mail-Vorlage aus der Dropdown-Liste. Beachte dazu die Erläuterungen in <<#table-events-automatic-email-dispatch>>.
. *Speichere* (icon:save[role="green"]) die Einstellungen.
