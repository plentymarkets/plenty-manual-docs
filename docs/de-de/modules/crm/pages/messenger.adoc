...
. Suche (icon:search[role="blue"]) den Kontakt anhand der Filtereinstellungen wie auf der Handbuchseite xref:crm:kontakte-verwalten.adoc#200[Kontakt suchen] beschrieben. +
