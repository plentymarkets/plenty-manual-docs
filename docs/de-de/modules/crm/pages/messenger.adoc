...
. Öffne das Kontextmenü mit einem Klick auf icon:more_vert[set=material] ganz rechts in der Zeile des Kontakts und wähle icon:message[set=material] *Messenger*. +
...
|Mit einem Klick auf icon:edit[set=material] änderst du die Sichtbarkeiten. Du kannst bereits ausgewählte Empfänger:innen entfernen und neue Empfänger:innen hinzufügen. +
...
| *Löschen*
|Mit einem Klick auf icon:delete[set=material] löschst du den gesamten Nachrichtenverlauf. +
...
| *Tags bearbeiten*
|Mit einem Klick auf *Tags bearbeiten* (icon:edit[set=material]) direkt an der Nachricht löschst du bestehende Tags oder fügst neue Tags hinzu. +
Ein Klick auf *Tags speichern* (icon:save[set=material]) speichert die Änderung an den Tags.
...
Mit einem Klick auf icon:delete[set=material] an der geöffneten Nachricht löschst du den gesamten Nachrichtenverlauf. +
*_Wichtig:_* Beim Löschen werden die Hauptnachricht und alle zugehörigen Nachrichten gelöscht.
