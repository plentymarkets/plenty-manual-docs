...
image::crm:crm-messenger-stoppuhr.png[width=640, height=360, alt=Neue Nachricht im Messenger erstellen]
...
image::crm:messenger-nachricht-bearbeiten.png[width=640, height=360, alt=Nachricht im Messenger bearbeiten]
