...
// TODO: müssen wir den Titel der Seite ändern? Kontakte und Gastbestellungen bearbeiten? Frage gilt auch für die Seiten "Kontakt suchen" und "Kontakt erstellen".

// TODO: auf der gesamten Seite müsste Kontaktdatensatz durch Datensatz ersetzt werden, oder? Bzw. eine Ergänzung "Kontaktdatensatz / Datensatz der Gastbestellung", oder?

// TODO: Beispiel: Sobald du einen Kontakt oder Gastdatensatz/Datensatz aus einer Gastbestellung erstellt hast, ...
...
Wenn du einen Datensatz im Menü *CRM » Kontakte* öffnest, stehen dir – je nachdem, ob es sich bei dem Datensatz um einen Kontakt oder eine Gastbestellung handelt – unterschiedliche Funktionen in der Symbolleiste zur Verfügung. <<#table-toolbar-contact>> listet die verfügbaren Funktionen in der Symbolleiste eines Kontakts auf. <<#table-toolbar-guest>> listet die verfügbaren Funktionen in der Symbolleiste einer Gastbestellung auf.
...
. Klicke in der oberen Zeile auf *Alle Daten dieses Kontakts herunterladen* (material:download[]). +
...
// TODO: ausführliches Kapitel zu Newsletter-Opt-in ergänzen und oben in der Tabelle verlinken.
...
* Bei einer Gastbestellung über den plentyShop besteht der gespeicherte Datensatz lediglich aus der Adresse und dem zugehörigen Auftrag; eine Kontakt-ID wird _nicht_ vergeben, jedoch wird das Symbol material:badge[] in der Übersicht in der Spalte *Gast* angezeigt.

* Bei einer Gastbestellung über einen Marktplatz wird eine Kontakt-ID vergeben und das Symbol material:badge[] wird in der Übersicht in der Spalte *Gast* angezeigt.
...
. Klicke in die Zeile des Datensatzes. +
→ Der Datensatz wird geöffnet.
. Klicke in der oberen Zeile auf *Gast in Kontakt umwandeln* (material:sync_alt[]). +
→ Ein Fenster mit einer Sicherheitsabfrage wird angezeigt. +
...
====
plentyShop-Gastbestellungen erhalten das Symbol material:badge[] in der Übersicht in der Spalte *Gast*, jedoch _keine_ Kontakt-ID. Marktplatz-Gastbestellungen erhalten das Symbol material:badge[] in der Übersicht in der Spalte *Gast* und zusätzlich eine Kontakt-ID.

*_Hinweise zum Umwandeln einer Gastbestellung in einen Kontaktdatensatz:_*

* Das Umwandeln einer plentyShop-Gastbestellung ist nur im Menü *CRM » Kontakte* möglich.
...
// TODO: Hinweis in der Box oben prüfen. Wie verhält sich das jetzt? Bleibt der Weg über die Kontaktoptionen, wenn es eine Bestellung über einen Marktplatz ist?

// TODO: Das Kapitel, das in der Box erwähnt wird, sollte dann auch nach hier oben verschoben werden, oder?
...
Du hast jedoch die Möglichkeit, den Datensatz zu anonymisieren. Wie du dazu vorgehst, ist im Kapitel xref:crm:kontakt-bearbeiten.adoc#datensatz-anonymisieren[Datensatz anonymisieren] beschrieben.
====
...
.Gruppenfunktion
image::crm:kontakte-gruppenfunktion-uebersicht.png[width=640, height=360, alt=Gruppenfunktion]
...
Gastbestellungen erkennst du generell an dem Symbol material:badge[] in der Übersicht in der Spalte *Gast*.
...
// plentyShop-Gastbestellungen können daher _nicht_ über das Menü *CRM » Kontakte* gefunden werden, weil sie faktisch keine Kontakte sind. Die Daten aus der plentyShop-Gastbestellung können nur über die Adressdaten im Menü *CRM » Schnellsuche* gefunden und dort auch nur in einen regulären Kontaktdatensatz umgewandelt werden.

Gastbestellungen, die über einen Marktplatz in dein System kommen, erhalten eine Kontakt-ID. Du kannst eine Marktplatz-Gastbestellung im Kontaktdatensatz im Menü *CRM » Kontakte* in einen regulären Kontaktdatensatz umwandeln. Gehe dazu wie im Folgenden beschrieben vor.
...
Weitere Informationen zum Umwandeln von plentyShop- und Marktplatz-Gastbestellungen in reguläre Kontaktdatensätze findest du im Kapitel xref:crm:kontakt-bearbeiten.adoc#gastzugang-umwandeln[plentyShop- und Marktplatz-Gastbestellung in Kontaktdatensatz umwandeln].
