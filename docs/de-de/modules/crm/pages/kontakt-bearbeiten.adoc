...
. Klicke in der oberen Zeile auf *Alle Daten aus diesem Datensatz herunterladen* (material:download[]). +
...
* Das Umwandeln einer Marktplatz-Gastbestellung ist über den Kontaktdatensatz selbst im Menü *CRM » Kontakte* möglich. Wie du dazu vorgehst, ist im Kapitel xref:crm:kontakt-bearbeiten.adoc#gastzugang-in-regulaeren-zugang-umwandeln[Gastbestellung in regulären Kontaktdatensatz umwandeln] beschrieben.
====
