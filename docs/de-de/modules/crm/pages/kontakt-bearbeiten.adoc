...
Hier siehst du alle zum Kontakt gehörigen Nachrichten. Mit einem Klick auf *Neue Nachricht* (material:add[]) öffnet sich der Messenger und du kannst eine Nachricht erstellen. Im Empfängerfeld ist die Kontakt-ID bereits vorausgefüllt. Du kannst weitere Empfänger:innen eingeben.
