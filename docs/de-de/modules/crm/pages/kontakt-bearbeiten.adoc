...
* Das Umwandeln einer Marktplatz-Gastbestellung ist über den Kontaktdatensatz selbst im Menü *CRM » Kontakte* möglich. Wie du dazu vorgehst, ist im Kapitel xref:crm:kontakt-bearbeiten.adoc#gastzugang-in-regulaeren-zugang-umwandeln[Gastbestellung in regulären Kontaktdatensatz umwandeln] auf der Seite xref:crm:kontakt-bearbeiten.adoc#[Kontakt bearbeiten] beschrieben.
====

// TODO: Hinweis in der Box oben prüfen. Wie verhält sich das jetzt? Bleibt der Weg über die Kontaktoptionen, wenn es eine Bestellung über einen Marktplatz ist oder geht das auch über den Knopf in der Toolbar?

// TODO: Das Kapitel, das in der Box erwähnt wird (Gastbestellung in regulären Kontaktdatensatz umwandeln), sollte dann auch nach hier oben verschoben werden, oder?
