...
*Gastzugang* = Die Bestellung kam über einen Marktplatz in dein System oder der Kontakt hat sich über deinen Webshop als Gast angemeldet und bestellt. +
*_Hinweis:_* Wenn der Datensatz ein Gast ist und eine ID hat, ist die Bestellung über einen Marktplatz in dein System gekommen. Wenn der Datensatz ein Gast ist und keine ID hat, ist die Bestellung über deinen plentyShop ins System gekommen.
...
Um DSGVO-konform zu arbeiten, wird bei Gastbestellungen, die über deinen plentyShop LTS in dein System kommen, _kein_ Kontaktdatensatz mit einer Kontakt-ID erstellt. plentyShop-Gastbestellungen können daher _nicht_ über das Menü *CRM » Kontakte* gefunden werden, da sie faktisch kein Kontakt sind. Die Daten aus der plentyShop-Gastbestellung können nur über die Adressdaten im Menü *CRM » Schnellsuche* gefunden und dort auch nur in einen regulären Kontaktdatensatz umgewandelt werden.

Gastbestellungen, die über einen Marktplatz in dein System kommen, erhalten eine Kontakt-ID. Daher kannst du Marktplatz-Gastbestellungen auch im Kontaktdatensatz im Menü *CRM » Kontakte* in einen regulären Kontaktdatensatz umwandeln. Gehe dazu wie im Folgenden beschrieben vor.
...
→ Das Symbol icon:done[set=material] verschwindet in der Übersicht in der Spalte *Gast*. Der Gast wurde in einen Kontaktdatensatz umgewandelt. +
