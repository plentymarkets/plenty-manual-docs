...
Mit einem Klick auf *Spalten konfigurieren* (icon:settings[set=material]) oben rechts entscheidest du, welche Spalten im Bereich *Aufträge* angezeigt werden. Klicke auf icon:drag_indicator[set=material], um die Reihenfolge der Spalten per Drag-and-drop zu verschieben. Die folgenden Spalten sind verfügbar:
...
Mit einem Klick auf *Spalten konfigurieren* (icon:settings[set=material]) oben rechts entscheidest du, welche Spalten im Bereich *Adressen* angezeigt werden. Klicke auf icon:drag_indicator[set=material], um die Reihenfolge der Spalten per Drag-and-drop zu verschieben. Die folgenden Spalten sind verfügbar:
...
| *Speichern*
|Mit einem Klick auf icon:save[set=material] werden die Änderungen gespeichert.

| *Löschen*
|Mit einem Klick auf icon:delete[set=material] erscheint eine Sicherheitsabfrage, die du bestätigen musst, um die Adresse zu löschen.

| *Neu laden*
|Mit einem Klick auf icon:refresh[set=material] wird der Datensatz aktualisiert.

| *Rechnungsadresse ableiten*
|Diese Funktion ist nur verfügbar, wenn es sich um einen bestehenden und keinen neuen Adressdatensatz handelt. +
Mit einem Klick auf icon:credit_note[set=plenty] wird eine neue Rechnungsadresse auf Basis der aktuell gewählten Adresse erstellt. Um eine neue Adresse mit einer neuen ID zu erstellen, müssen Änderungen an der neuen Rechnungsadresse vorgenommen werden.

| *Lieferadresse ableiten*
|Diese Funktion ist nur verfügbar, wenn es sich um einen bestehenden und keinen neuen Adressdatensatz handelt. +
Mit einem Klick auf icon:delivery_note[set=plenty] wird eine neue Lieferadresse auf Basis der aktuell gewählten Adresse erstellt. Um eine neue Adresse mit einer neuen ID zu erstellen, müssen Änderungen an der neuen Lieferadresse vorgenommen werden.
...
Mit einem Klick auf *Spalten konfigurieren* (icon:settings[set=material]) oben rechts entscheidest du, welche Spalten im Bereich *Firma* angezeigt werden. Klicke auf icon:drag_indicator[set=material], um die Reihenfolge der Spalten per Drag-and-drop zu verschieben. Die folgenden Spalten sind verfügbar:
...
. Verschiebe (icon:drag_indicator[set=material]) die Spalten so, dass sie in der Reihenfolge angezeigt werden, in der du sie benötigst.
...
Mit einem Klick auf *Spalten konfigurieren* (icon:settings[set=material]) entscheidest du, welche Spalten im Bereich *Tickets* angezeigt werden. Klicke auf icon:drag_indicator[set=material], um die Reihenfolge der Spalten per Drag-and-drop zu verschieben. Die folgenden Spalten sind verfügbar:
