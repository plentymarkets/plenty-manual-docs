...
Wenn du keine eigene <<#ansicht-bearbeiten, Ansicht erstellen>> zum Bearbeiten eines Kontaktdatensatzes möchtest, kannst du einfach eine der vorhandenen Standardvorlagen in deinem System verwenden.
