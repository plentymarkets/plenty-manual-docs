...
Der Bereich *Kundennotizen* dient ausschließlich für die interne Kommunikation. Alle Notizen, die du hier erstellst, sind also nur intern sichtbar und können _nicht_ von deinen Kontakten eingesehen werden.

Im Messenger steht dir die Gruppe *Kundennotizen* zur Verfügung, in der du alle an den Kontaktdatensätzen gespeicherten Kundennotizen einsehen kannst. Weitere Informationen zu den Gruppen im Messenger findest du auf dieser xref:crm:messenger.adoc#gruppen-verwalten[Handbuchseite].
