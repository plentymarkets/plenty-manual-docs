...
Im Messenger steht dir die Gruppe *Kundennotizen* zur Verfügung, in der du alle an den Kontaktdatensätzen gespeicherten Kundennotizen einsehen kannst. Weitere Informationen zu den Gruppen im Messenger findest du auf dieser link:crm:messenger.adoc#gruppen-verwalten[Handbuchseite].
