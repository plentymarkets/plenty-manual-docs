...
// TODO: auf der gesamten Seite müsste Kontaktdatensatz durch Datensatz ersetzt werden, oder? Bzw. eine Ergänzung "Kontaktdatensatz oder Datensatz der Gastbestellung", oder?

// TODO: Beispiel: Sobald du einen Kontakt oder Gastdatensatz erstellt hast, ...

// TODO: Contact summary und Guest summary portlets erklären.
...
Wenn du einen Datensatz im Menü *CRM » Kontakte* öffnest, stehen dir – je nachdem, ob es sich bei dem Datensatz um einen Kontakt oder eine Gastbestellung handelt – die folgenden Funktionen in der Symbolleiste zur Verfügung:

*Kontakt*

* *Speichern* (material:save[])
* *Alle Daten herunterladen* (material:download[])
* *Datensatz anonymisieren* (icon:user-secret[])
* *Kontakt als vCard herunterladen* (material:contact_mail[])
* *Newsletter-Opt-in-E-Mail senden* (material:outgoing_mail[])
...
* *Speichern* (material:save[])
* *Alle Daten herunterladen* (material:download[])
* *Gast in Kontakt umwandeln* (material:sync_alt[])
* *Löschen* (material:delete[])
