...
====
Bei allen Systemen, die ab Dezember 2022 gebucht wurden (beta: ab 15.12.2022 / early: ab 21.12.2022 / stable: ab 28.12.2022), sind die oben genannten 3 Standardansichten _nicht_ vorhanden, sondern nur die Vorlage *Starter-UI*. Die Starter-UI beinhaltet die folgenden Bereiche und Felder:
