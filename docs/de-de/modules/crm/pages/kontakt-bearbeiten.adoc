...
Klicke auf den Link und beachte die Erläuterungen auf der Seite *Kontakt erstellen*, wenn die Lieferadresse eine xref:crm:kontakt-erstellen.adoc#dhl-packstation-dhl-postfiliale[DHL Packstation oder DHL Postfiliale] ist.
