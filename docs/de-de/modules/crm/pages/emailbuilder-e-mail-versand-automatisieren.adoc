...
Über den E-Mail-Service kannst du ganz gezielt E-Mail-Vorlagen manuell versenden.

//  und bereits versendete E-Mail-Vorlagen in der Historie ansehen.
// Historie: nur über den Auftrag selbst, über alle anderen Bereiche ist Historie nicht verfügbar.
