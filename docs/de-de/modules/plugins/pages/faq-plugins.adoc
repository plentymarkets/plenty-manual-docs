...
In diesem Abschnitt werden häufige Fragen zu Plugins rund um PHP 8.

[qanda]
Sind die Plugins, die ich nutze, mit PHP 8 kompatibel?::
    Öffne dein Plugin-Set und prüfe die Spalte *PHP 8*. Wenn dort ein Haken gesetzt ist, ist das Plugin mit PHP 8 kompatibel. Beachte, dass diese Angabe vom Entwickler des Plugins selbst zu Verfügung gestellt wird. Beachte auch die Listen für Plugins link:https://forum.plentymarkets.com/t/liste-der-mit-php8-kompatiblen-plentymarkets-plugins-stand-18-05-2022-php8-compatible-plugin-versions/679787[von plentysystems^] und link:https://forum.plentymarkets.com/t/liste-der-mit-php8-kompatiblen-non-plentymarkets-plugins-php8-compatible-non-plentymarkets-plugins/680277[Drittanbietern^] im Forum.
...
Ich habe alle bisher genannten Punkte geprüft, das Plugin funktioniert aber immer noch nicht richtig. Gibt es noch etwas, das ich tun kann?::
    Eventuell wurde das Plugin nicht vollständig installiert. Du kannst die Installation erneut durchführen, indem du das Plugin reparierst. Öffne dazu das Plugin-Set. Klicke dann in der Zeile des Plugins, das du löschen möchtest, auf weitere Aktionen (icon:more_vert[set=material]). Klicke auf icon:construction[set=material] *Reparieren* und bestätige die Abfrage. +
