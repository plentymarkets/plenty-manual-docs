...
Du solltest ein Plugin dann deaktivieren, wenn du es nur vorübergehend nicht nutzen möchtest. Anders als beim Löschen eines Plugins, bleibt beim Deaktivieren die xref:plugins:installierte-plugins-konfigurieren.adoc#lokale-vs-globale-konfiguration[lokale Konfiguration] des Plugin erhalten.
