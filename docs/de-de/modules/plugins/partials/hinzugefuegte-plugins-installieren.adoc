...
Wie du Plugins installieren kannst erfährst du auf der Seite xref:hinzugefuegte-plugins-installieren.adoc[Hinzugefügte Plugins in Plugin-Sets installieren].
====