...
[NOTE]
.Entfernt in Plugin Build 2
====
Ab dem 25. Juli 2022 wird ein neuer Bereitstellungsprozess (Plugin Build 2) schrittweise auf allen plentymakets Systemen veröffentlicht. Im neuen Bereitstellungsprozess werden Git-Plugins, die über einen Branch installiert sind, automatisch beim Bereitstellen auf den neusten Stand aktualisiert.

Sobald dein System auf Plugin Build 2 umgestellt ist, werden Aktionen zum Pullen von Branches aus der UI entfernt.
====

include::partial$git-branch-pullen.adoc[]
...
include::partial$git-commit-wechseln.adoc[]