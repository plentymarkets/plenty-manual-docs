= Container_ItemViewManualSelectionList5
:keywords: Container_ItemViewManualSelectionList5
:index: false

//  auto generated content Thu, 06 Jul 2017 00:16:39 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList5 aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList5( array $_itemIDList  , int $ItemViewManualSelectionList5_EachRow  ) : string

----

== Template ItemViewManualSelectionList5
...
=== ItemViewManualSelectionList5Item
