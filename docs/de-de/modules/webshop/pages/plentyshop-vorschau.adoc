...
:description: Mit der plentyShop-Vorschau kannst du dir deinen Shop in einem Zustand ansehen, auf den deine Kund:innen keinen Zugriff haben. So kannst du z.B. ein neues Design testen bevor du es öffentlich machst.
:id: BKON8DD
