...
Mit der plentyShop-Vorschau kannst du dir deinen Shop in einem Zustand ansehen, auf den deine Kund:innen keinen Zugriff haben. So kannst du z.B. ein neues Design testen und es erst veröffentlichen, wenn du zufrieden bist.
