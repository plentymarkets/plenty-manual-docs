= Container_ItemViewLiveShopping2
:lang: de
:keywords: Container_ItemViewLiveShopping2
:position: 10085

//  auto generated content Thu, 06 Jul 2017 00:13:28 +0200
== Kurzbeschreibung

Gibt das Template ItemViewLiveShopping2 aus. Mit diesem Template wird eine Live-Shopping-Ansicht dargestellt.
...
Container_ItemViewLiveShopping2() : string

----

== Template ItemViewLiveShopping2
...
* $LiveShoppingEndTime — Beinhaltet die Endzeit des Live-Shopping-Angebots.
* $LiveShoppingPercentRemaining — Beinhaltet die Restmenge des Artikels im Live-Shopping in Prozent.
* $LiveShoppingPercentSold — Beinhaltet den bereits verkauften Prozentsatz des Live-Shopping-Artikels.
...
* $LiveShoppingQuantitySold — Beinhaltet die bereits verkaufte Menge des Live-Shopping-Artikels.
* $LiveShoppingStartTime — Beinhaltet die Startzeit des Live-Shopping-Angebots.
