= Container_ItemViewManualSelectionList
:keywords: Container_ItemViewManualSelectionList
:index: false

//  auto generated content Thu, 06 Jul 2017 00:16:06 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList( array $_itemIDList  , int $ItemViewManualSelectionList_EachRow  ) : string

----

== Template ItemViewManualSelectionList
...
=== ItemViewManualSelectionListItem
