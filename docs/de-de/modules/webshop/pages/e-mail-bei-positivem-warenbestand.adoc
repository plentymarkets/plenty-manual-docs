...
. Lege eine neue <<crm/e-mails-versenden#1200, E-Mail-Vorlage>> im HTML-Format an.
...
. Wähle bei der Option *Benachrichtigung bei verfügbarem Artikel* die E-Mail-Vorlage aus der Dropdown-Liste.
