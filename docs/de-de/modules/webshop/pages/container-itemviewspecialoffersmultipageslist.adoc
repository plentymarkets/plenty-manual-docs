= Container_ItemViewSpecialOffersMultiPagesList
:keywords: Container_ItemViewSpecialOffersMultiPagesList
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:18:16 +0200
== Kurzbeschreibung

Gibt das Template ItemViewSpecialOffersMultiPagesList aus. Mit diesem Template wird eine mehrseitige Liste der Artikel im Angebot dargestellt.
...
Container_ItemViewSpecialOffersMultiPagesList(
int $ItemViewSpecialOffersMultiPagesList_EachRow  ,
int $ItemViewSpecialOffersMultiPagesList_DefaultItemSorting  ,
int $ItemViewSpecialOffersMultiPagesList_Limit  ,
int $ItemViewSpecialOffersMultiPagesList_OnlyOfCurrentCategory
) : string

----

== Template ItemViewSpecialOffersMultiPagesList
...
BrowseNextButton( string $ItemViewSpecialOffersMultiPagesList_BrowseNextButtonName  ) : string
...
BrowsePreviousButton( string $ItemViewSpecialOffersMultiPagesList_BrowsePreviousButtonName  ) : string
...
=== ItemViewSpecialOffersMultiPagesListItem
