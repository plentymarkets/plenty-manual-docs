= Container_ItemViewRandomList
:keywords: Container_ItemViewRandomList
:index: false

//  auto generated content Thu, 06 Jul 2017 00:15:28 +0200
== Kurzbeschreibung

Gibt das Template ItemViewRandomList aus. Mit diesem Template wird eine Liste zufälliger Artikel dargestellt.
...
Container_ItemViewRandomList(
int $ItemViewRandomList_EachRow  ,
int $ItemViewRandomList_Limit  ,
int $ItemViewRandomList_OnlyOfCurrentCategory
) : string

----

== Template ItemViewRandomList
