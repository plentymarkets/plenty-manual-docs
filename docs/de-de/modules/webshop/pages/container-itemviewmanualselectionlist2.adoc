= Container_ItemViewManualSelectionList2
:keywords: Container_ItemViewManualSelectionList2
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:16:14 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList2 aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList2( array $_itemIDList  , int $ItemViewManualSelectionList2_EachRow  ) : string

----

== Template ItemViewManualSelectionList2
...
=== ItemViewManualSelectionList2Item
