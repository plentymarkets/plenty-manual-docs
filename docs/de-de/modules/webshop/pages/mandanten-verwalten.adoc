...
|Wähle die Kundenklasse aus, die für deine B2C-Kund:innen im Shop vorausgewählt sein soll. Eine Standardkundenklasse für B2B-Kund:innen kannst du im plentyShop-Assistenten vergeben.
