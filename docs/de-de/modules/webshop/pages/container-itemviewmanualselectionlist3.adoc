= Container_ItemViewManualSelectionList3
:keywords: Container_ItemViewManualSelectionList3
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:16:23 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList3 aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList3( array $_itemIDList  , int $ItemViewManualSelectionList3_EachRow  ) : string

----

== Template ItemViewManualSelectionList3
...
=== ItemViewManualSelectionList3Item
