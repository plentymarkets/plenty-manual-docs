...
//  auto generated content Thu, 06 Jul 2017 00:18:00 +0200
== Kurzbeschreibung

Gibt das Template ItemViewSpecialOffersList aus. Mit diesem Template wird eine Liste der Artikel im Angebot dargestellt.
...
Container_ItemViewSpecialOffersList(
int $ItemViewSpecialOffersList_EachRow  ,
...
== Template ItemViewSpecialOffersList
