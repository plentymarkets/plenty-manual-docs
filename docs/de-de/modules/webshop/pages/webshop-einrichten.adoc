...
im Menü xref:webshop:cms.adoc#webdesign-webdesign-bearbeiten[CMS » Webdesign » Einstellungen » Design-Einstellungen » Tab: Mandanten]
...
====
Wenn du Template-Variablen oder -Funktionen in dein Design eingefügt hast, veröffentlichst du dein Design im Menü xref:webshop:cms.adoc#webdesign-benutzeroberflaeche[CMS » Webdesign] neu.
====
