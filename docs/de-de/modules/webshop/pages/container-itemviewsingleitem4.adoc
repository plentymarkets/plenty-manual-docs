= Container_ItemViewSingleItem4
:keywords: Container_ItemViewSingleItem4
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:11:42 +0200
== Kurzbeschreibung

Gibt das Template ItemViewSingleItem4 aus. Mit diesem Template wird Einzelartikelansicht dargestellt.
...
Container_ItemViewSingleItem4( int $CurrentItemId  ) : string

----

== Template ItemViewSingleItem4
