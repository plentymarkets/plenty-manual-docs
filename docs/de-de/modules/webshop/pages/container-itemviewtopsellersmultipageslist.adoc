= Container_ItemViewTopSellersMultiPagesList
:keywords: Container_ItemViewTopSellersMultiPagesList
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:15:58 +0200
== Kurzbeschreibung

Gibt das Template ItemViewTopSellersMultiPagesList aus. Mit diesem Template wird eine mehrseitige Liste meistverkaufter Artikel dargestellt.
...
Container_ItemViewTopSellersMultiPagesList(
int $ItemViewTopSellersMultiPagesList_EachRow  ,
int $ItemViewTopSellersMultiPagesList_DefaultItemSorting  ,
int $ItemViewTopSellersMultiPagesList_Limit  ,
int $ItemViewTopSellersMultiPagesList_OnlyOfCurrentCategory
) : string

----

== Template ItemViewTopSellersMultiPagesList
...
BrowseNextButton( string $ItemViewTopSellersMultiPagesList_BrowseNextButtonName  ) : string
...
BrowsePreviousButton( string $ItemViewTopSellersMultiPagesList_BrowsePreviousButtonName  ) : string
...
* $Subcategoryselect — Beinhaltet eine Dropdown-Liste der Unterkategorien der nächsten Ebene.

=== ItemViewTopSellersMultiPagesListItem
