= Container_ItemViewLatestItemsMultiPagesList
:lang: de
:keywords: Container_ItemViewLatestItemsMultiPagesList
:position: 10080

//  auto generated content Thu, 06 Jul 2017 00:19:11 +0200
== Kurzbeschreibung

Gibt das Template ItemViewLatestItemsMultiPagesList aus. Mit diesem Template wird eine mehrseitige Liste der neuesten Artikel dargestellt.
...
== Template ItemViewLatestItemsMultiPagesList
...
BrowseNextButton( string $ItemViewLatestItemsMultiPagesList_BrowseNextButtonName  ) : string
...
BrowsePreviousButton( string $ItemViewLatestItemsMultiPagesList_BrowsePreviousButtonName  ) : string
...
=== ItemViewLatestItemsMultiPagesListItem
