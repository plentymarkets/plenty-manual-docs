= Container_ItemViewTopSellersList2
:keywords: Container_ItemViewTopSellersList2
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:15:50 +0200
== Kurzbeschreibung

Gibt das Template ItemViewTopSellersList2 aus. Mit diesem Template wird eine Liste meistverkaufter Artikel dargestellt.
...
Container_ItemViewTopSellersList2(
int $ItemViewTopSellersList2_EachRow  ,
...
== Template ItemViewTopSellersList2
