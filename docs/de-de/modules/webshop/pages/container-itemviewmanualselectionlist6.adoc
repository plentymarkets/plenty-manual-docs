= Container_ItemViewManualSelectionList6
:keywords: Container_ItemViewManualSelectionList6
:page-index: false

//  auto generated content Thu, 06 Jul 2017 00:16:46 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList6 aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList6( array $_itemIDList  , int $ItemViewManualSelectionList6_EachRow  ) : string

----

== Template ItemViewManualSelectionList6
...
=== ItemViewManualSelectionList6Item
