= Container_ItemViewSingleItem
:lang: de
:keywords: Container_ItemViewSingleItem
:position: 10094

//  auto generated content Thu, 06 Jul 2017 00:10:39 +0200
== Kurzbeschreibung

Gibt das Template ItemViewSingleItem aus. Mit diesem Template wird Einzelartikelansicht dargestellt.
...
Container_ItemViewSingleItem( int $CurrentItemId  ) : string

----

== Template ItemViewSingleItem
