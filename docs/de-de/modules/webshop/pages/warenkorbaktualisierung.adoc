...
* xref:webshop:basketitemslist.adoc[POST /rest/checkout/basketitemslist/]
* xref:webshop:basketitemslist.adoc[GET /rest/checkout/basketitemslist/]
* xref:webshop:container_itemviewbasketpreviewlist.adoc[GET /rest/itemview/container_itemviewbasketpreviewlist/]
