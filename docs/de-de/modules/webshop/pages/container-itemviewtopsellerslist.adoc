...
//  auto generated content Thu, 06 Jul 2017 00:15:42 +0200
== Kurzbeschreibung

Gibt das Template ItemViewTopSellersList aus. Mit diesem Template wird eine Liste meistverkaufter Artikel dargestellt.
...
Container_ItemViewTopSellersList(
int $ItemViewTopSellersList_EachRow  ,
...
== Template ItemViewTopSellersList
