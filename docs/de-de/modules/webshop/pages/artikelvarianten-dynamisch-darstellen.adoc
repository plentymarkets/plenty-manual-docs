...
Im Menü xref:artikel:artikel-verwalten.adoc#660[Einrichtung » Artikel » Bilder] hinterlegst du Maximalwerte für die Breite und Höhe von xref:artikel:artikel-verwalten.adoc#450[Artikelattributbildern]. Die Werte werden in Pixeln angegeben.
