= Container_ItemViewLatestItemsMultiPagesList2
:keywords: Container_ItemViewLatestItemsMultiPagesList2
:index: false

//  auto generated content Thu, 06 Jul 2017 00:19:24 +0200
== Kurzbeschreibung

Gibt das Template ItemViewLatestItemsMultiPagesList2 aus. Mit diesem Template wird eine mehrseitige Liste der neuesten Artikel dargestellt.
...
== Template ItemViewLatestItemsMultiPagesList2
...
BrowseNextButton( string $ItemViewLatestItemsMultiPagesList2_BrowseNextButtonName  ) : string
...
BrowsePreviousButton( string $ItemViewLatestItemsMultiPagesList2_BrowsePreviousButtonName  ) : string
...
=== ItemViewLatestItemsMultiPagesList2Item
