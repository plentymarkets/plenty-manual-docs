...
| *Erscheinungsbild*
|Farbgebung aus der Dropdown-Liste wählen. Diese bestimmt die Farbe der Navigationspfeile und -punkte sowie die Überschrift. Du legst die verfügbaren Farboptionen im Menü <<#design, Design>> fest.
