...
image::webshop/assets/ShopBuilder-UI1.png[]
...
|Öffnet die <<webshop/shop-builder#kategorie-verknuepfen, Verknüpfungsoberfläche>> für plentyShop LTS. Hier verknüpfst du die von dir angelegten Kategorien damit diese korrekt vom Plugin *plentyShop LTS* übernommen werden.
...
Hier kannst du <<webshop/shop-builder#inhalte-erstellen, neue Inhalte erstellen>>, <<webshop/shop-builder#inhalte-aktivieren, Inhalte aktivieren>>, <<webshop/shop-builder#sichtbarkeit, sichtbar schalten>>, <<webshop/shop-builder#inhalt-duplizieren, kopieren>>, und vieles mehr.   
...
- Imhalte vom Typ *Artikelset* verwendest du für <<artikel/anwendungsfaelle/multipacks-pakete-sets#3000, Sets>>, die verschiedene Artikel beinhalten.
====
...
. Wähle den <<webshop/shop-builder#content-typen, Content-Typen>>, den du für deinen Inhalt verwenden willst. +
...
→ Bei *Artikelkategorien* wird das Fenster <<webshop/shop-builder#sichtbarkeit, Inhalt aktivieren>> geöffnet. +
...
include::./_textblocks/widget-settings/lazy-loading.adoc[]
...
Dieses Widget stellt <<willkommen/allgemeine-funktionen/tags#, Tags>>, die mit Varianten verknüpft wurden, auf der Artikelansicht dar. 
...
Dieses Widget stellt die Darstellung für Staffelpreise auf der Artikeleinzelansicht zur Verfügung. Klicke auf icon:cog[role="darkGrey"] *Einstellungen*, um die Widget-Einstellungen zu öffnen. Um Staffelpreise nutzen zu können, musst du <<artikel/einstellungen/preise#, Staffelpreise>> konfiguriert haben. +
...
Dieses Widget stellt die Checkbox zur Verfügung, mit der deine Kund:innen einwilligen können, dass ihre Versandinformationen an den jeweiligen Versanddiensleister weitergegeben werden dürfen. Die Checkbox wird nur dann im Webshop angezeigt, wenn ein Versandprofil ausgewählt ist, für das die Option <<fulfillment/versand-vorbereiten#1000, Einwilligung zur Datenübermittlung>> aktiv ist. Klicke auf icon:cog[role="darkGrey"] *Einstellungen*, um die Widget-Einstellungen zu öffnen. +
