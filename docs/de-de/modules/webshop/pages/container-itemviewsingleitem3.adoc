= Container_ItemViewSingleItem3
:keywords: Container_ItemViewSingleItem3
:index: false

//  auto generated content Thu, 06 Jul 2017 00:11:21 +0200
== Kurzbeschreibung

Gibt das Template ItemViewSingleItem3 aus. Mit diesem Template wird Einzelartikelansicht dargestellt.
...
Container_ItemViewSingleItem3( int $CurrentItemId  ) : string

----

== Template ItemViewSingleItem3
