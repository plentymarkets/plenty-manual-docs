= Container_ItemViewManualSelectionList4
:keywords: Container_ItemViewManualSelectionList4
:index: false

//  auto generated content Thu, 06 Jul 2017 00:16:31 +0200
== Kurzbeschreibung

Gibt das Template ItemViewManualSelectionList4 aus. Mit diesem Template wird eine Liste von manuell zusammengestellten Artikeln dargestellt.
...
Container_ItemViewManualSelectionList4( array $_itemIDList  , int $ItemViewManualSelectionList4_EachRow  ) : string

----

== Template ItemViewManualSelectionList4
...
=== ItemViewManualSelectionList4Item
