...
Gib die Texte für die *Widerrufsbelehrung*, das *Widerrufsformular*, die *Datenschutzerklärung* und das *Impressum* analog in den gewünschten Sprachen ein. Alternativ lädst du für das Widerrufsformular eine PDF-Datei hoch. Die Texte werden in plentyShop auf den zugehörigen Seiten angezeigt. +
...
Hier nimmst du Einstellungen vor, die den Header deines plentyShops betreffen. Der Header ist der obere Bereich einer Seite. Du kannst für jede Seite einen individuellen Header mit dem ShopBuilder xref:webshop:shop-builder.adoc#shopbuilder-intro[ShopBuilder] erstellen.
...
Wähle eine Kategorie im Kategoriebaum auf der linken Seite aus.
...
Einstellung: Firmenlogo
Datei wählen, mit dem ...-Menü
Datei Hochladen
oder 
Auf eine Dateizeile klicken und *wählen* klicken.


Achte auf die Sichtbarkeit des Headers, eventuell musst du das Firmenlogo in mehr als einem Header-Inhalt austauschen
