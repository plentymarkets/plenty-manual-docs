...
====
Unsere Assistenten helfen dir bei der Einrichtung deines plentyShops. Durchlaufe den Integrationen-Assistenten unter *Einrichtung » Assistenten » Grundeinrichtung » Integrationen*, um plentyShop LTS zu installieren. Durchlaufe danach den Assistenten unter *Einrichtung » Plugins » (Plugin-Set wählen) » plentyShop LTS* um deinen plentyShop nach deinen Vorstellungen aufzusetzen. 
====
