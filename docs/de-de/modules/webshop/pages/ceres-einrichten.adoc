...
Hier nimmst du Einstellungen vor, die den Header deines plentyShops betreffen. 
...
Klicke im Menü *Meine Dateien* auf die Zeile der Bilddatei, die du als Logo auswählen möchtest.
Klicke auf die *Wählen*-Schaltfläche. +
+
Achte auf die Sichtbarkeit des Headers. Je nachdem, wie viele unterschiedliche Header du im Einsatz hast,  musst du das Firmenlogo in mehr als einem Header-Inhalt austauschen.
