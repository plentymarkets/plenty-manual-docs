...
Der plentyShop LTS-Assistent führt dich bequem durch die Grundeinrichtung deines plentyShops. Du musst nicht alle Einstellungen sofort treffen. Im Schritt *Auswahl der Einstellungen* kannst du Einstellungsbereiche ausblenden, um möglichst schnell einen funktionierenden plentyShop aufzusetzen.
...
[#header]
=== Einstellungen für den Header vornehmen

Hier nimmst du Einstellungen vor, die den Header deines plentyShops betreffen. Der Header ist der obere Bereich einer Seite. Du kannst für jede Seite einen individuellen Header mit dem ShopBuilder xref:webshop:shop-builder.adoc#10[ShopBuilder] erstellen.
...
. Öffne in der Detailansicht der Seite den Tab *Header*.
...
Wie bediene ich den ShopBuilder und was kann ich damit machen?::
    In unserem link:https://www.youtube.com/watch?v=s_9DCTlF_qg[Livestream^] am 17.04.2020 haben wir euch das Arbeiten mit dem ShopBuilder vom ersten Schritt bis zum fertigen, voll funktionstüchtigen plentyShop vorgestellt. Zudem zeigt der Live-Mitschnitt viele neue Funktionen von Ceres 5, wie beispielsweise Artikelsets und neue Widgets für die Suche. Wenn du nicht weißt, wo du anfangen sollst, dann ist dieser Live-Mitschnitt das Richtige für dich!