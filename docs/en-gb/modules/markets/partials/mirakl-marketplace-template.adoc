...
For further information on properties, refer to the xref:item:properties.adoc#500[Characteristics and properties] page.
...
| For each shipping profile in plentymarkets, enter the corresponding ID of the shipping service provider. To find the abbreviations, go to *Information » Shipping* in Mirakl.
...
ifeval::["{marketplace}" == "Conrad"]
include::partial$catalogue-mirakl-conrad-mapping.adoc[]
...
Set up an xref:automation:event-procedures.adoc#[event procedure] to automatically update the order status on {marketplace} whenever specific events occur. You can set up the following event procedures:

// Welche Ereignisaktionen es gibt hängt vom Marktplatz ab. Hier die gängigsten. Bei Bedarf anpassen!

ifeval::["{marketplace}" == "Conrad"]
include::automation:page$mirakl-conrad.adoc[tag=summary]
endif::[]

ifeval::["{marketplace}" == "Voelkner"]
include::automation:page$mirakl-voelkner.adoc[tag=summary]
endif::[]
...
ifeval::["{marketplace}" == "Conrad"]
include::automation:page$mirakl-conrad.adoc[tag=instructions]
endif::[]

ifeval::["{marketplace}" == "Voelkner"]
include::automation:page$mirakl-voelkner.adoc[tag=instructions]
endif::[]
