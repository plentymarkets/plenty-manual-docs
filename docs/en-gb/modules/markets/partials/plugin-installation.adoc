...
*_Note:_* The priority of the *Mirakl Connector* plugin must be lower than the priority of the marketplace plugin. This is to ensure a proper functionality of both plugins.
