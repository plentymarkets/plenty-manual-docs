...
ifdef::kaufland[]
*_Note:_* If you want to offer your items on all Kaufland country platforms, then only activate the availability
*Kaufland*. If you only want to offer your items on specific country platforms, then only activate those availabilities.
endif::kaufland[]
