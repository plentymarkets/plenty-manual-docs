...
====
With catalogues, you can no longer export free text fields or characteristics. Instead, use xref:item:properties.adoc#500[properties].
====
...
*_Tip:_* Need more information about the plentymarkets data fields? All data fields are described on the manual page for the standard format xref:data:catalogues-item.adoc#[Item (new)].
