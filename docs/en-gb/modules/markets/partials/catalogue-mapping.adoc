...
*_Tip:_* Need more information about the plentymarkets data fields? Then head over to the manual page for the standard format xref:data:item.adoc#[Item (new)]. +
