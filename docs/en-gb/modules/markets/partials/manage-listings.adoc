...
* *Auction:* Auctions are possible on the marketplaces eBay, Hood and ricardo. *Auction* type listings start at a predefined price, then customers bid on the item.
...
*_Tip:_* Item names are entered in the xref:item:managing-items.adoc#50[texts] tab of the item.
|====
...
image::markets:EN-Settings-Listings-Layout-Templates-02.png[]

__Image 1: Linking listings to different layout templates__

* Example code for the tab link:https://raw.githubusercontent.com/plentymarkets/plenty-manual-docs/main/docs/en-gb/modules/markets/examples/Main.html[Mainframe^]

* Example code for the tab link:https://raw.githubusercontent.com/plentymarkets/plenty-manual-docs/main/docs/en-gb/modules/markets/examples/html.html[HTML-Struktur^]

* Example code for the tab link:https://raw.githubusercontent.com/plentymarkets/plenty-manual-docs/main/docs/en-gb/modules/markets/examples/C.html[CSS^]
...
| *Update eBay options*
| Select one, several, or *ALL* of the following options: *Title*, *Subtitle*, *Properties*, *Category*, *Item details*, *Additional options*, *Duration*, *Shipping information/Custom policies*, *Description*, *Images*, *Quantity, price, and variations*, *Renew variations*, *Parts compatibility listing*, *eBay Plus*. +
