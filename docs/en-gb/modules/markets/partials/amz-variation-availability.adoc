...
*_Note_*: You can download an overview of Amazon product types link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/amazon-product-types-new.csv[here^].
