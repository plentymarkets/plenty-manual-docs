...
image::market:otto-faq-no-invoice.png[]
...
Find more information on the catalogue mappings for the marketplace data field *Stock* <<markets/otto/otto-market#905, here>>
[/details]
--
...
TIP: An item _cannot_ be deleted on OTTO Market, neither by plentymarkets nor by OTTO. It is only possible to mark the item as *not available* at OTTO Market. Therefore, you should always make sure that the correct data fields are mapped in the catalogue prior to transferring your items.
