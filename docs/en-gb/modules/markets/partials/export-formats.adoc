...
ifdef::awin,basic-price-search-engine,beezup,belboon,econda,KUPONA,mybestbrands,shopzilla[]
*_Note:_* For {price-search-engine}, no order referrer is preconfigured in your plentymarkets system. Therefore, you have to <<#create-order-referrer, create the order referrer for {price-search-engine} manually>> in the *Setup » Orders » Order referrer* menu.
endif::awin,basic-price-search-engine,beezup,belboon,econda,KUPONA,mybestbrands,shopzilla[]
...
ifndef::preview[This option does not affect this format.]
...
ifndef::description[This option does not affect this format.]
...
| *Barcode*
|
ifdef::barcode[This option does not affect this format.]
ifndef::barcode[]
...
| *Image*
a|
ifdef::first-image[Select *First image*.]
ifdef::select-image[]
...
ifndef::first-image,select-image[This option does not affect this format.]
...
ifndef::energy[This option does not affect this format.]

| *Stock buffer*
|
ifdef::buffer[The stock buffer for variations with limitation to the net stock.]
ifndef::buffer[This option does not affect this format.]

| *Stock for variations without stock limitation*
|
ifdef::stock-limit[The stock for variations without stock limitation.]
ifndef::stock-limit[This option does not affect this format.]

| *Stock for variations with no stock administration*
|
ifdef::nostock[The stock for variations without stock administration.]
ifndef::nostock[This option does not affect this format.]
...
| *Offer price*
|
ifdef::offerprice[Activate to transfer the offer price.]
ifndef::offerprice[This option does not affect this format.]

| *RRP*
|
ifdef::rrp[Activate to transfer the RRP.]
ifndef::rrp[This option does not affect this format.]
...
ifndef::shipping[This option does not affect this format.]

| *VAT note*
|
ifdef::vat[Enter a text. This amount includes the VAT but does not include shipping.]
ifndef::vat[This option does not affect this format.]
...
ifndef::overwrite-activate,overwrite[This option does not affect this format.]
|===
