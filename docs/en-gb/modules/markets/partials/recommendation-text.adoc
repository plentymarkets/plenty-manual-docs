...
// * Need more informationen on the plentymarkets data fields recommended in this list? Check out the manual page for the default catalogue format xref:data:catalogue-item.adoc#[Item (new)].
