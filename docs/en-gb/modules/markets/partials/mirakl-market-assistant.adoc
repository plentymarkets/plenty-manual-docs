...
ifdef::mediamarkt[]
* *Order invoice import/export* = Invoices are sent to Mediamarkt with an event procedure. As such, do _not_ activate this option. +
endif::mediamarkt[]
ifdef::voelkner[]
* *Order invoice import/export* = Invoices are sent to Völkner with an event procedure. As such, do _not_ activate this option. +
endif::voelkner[]
ifdef::conrad[]
* *Order invoice import/export* = Conrad creates the invoices. Activate to import these invoices into plentymarkets. +
endif::conrad[]
