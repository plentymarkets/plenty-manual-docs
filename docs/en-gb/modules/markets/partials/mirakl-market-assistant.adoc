...
| Do you want to export the same stock quantity for all variations without stock limitation?
...
*_Important:_* You can only specify a quantity when the option *Replace stock amount for items not limited to stock* is active. +
If you enter "0", variations without stock limitations are not exported.
|======
--
