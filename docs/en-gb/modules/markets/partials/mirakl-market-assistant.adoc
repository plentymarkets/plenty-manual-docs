...
ifdef::mediamarkt,voelkner[*Order invoice import/export* = Invoices are sent to {market} with an event procedure. As such, do _not_ activate this option.] +
ifdef::conrad[*Order invoice import/export* = Conrad creates the invoices. Activate to import these invoices into plentymarkets.] +
