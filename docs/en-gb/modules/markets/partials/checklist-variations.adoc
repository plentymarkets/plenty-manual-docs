...
*_Important:_* The character limits are checked by OTTO Market. As such, check the log messages in the Market Status (OTTO Reports) if variation data is not published on OTTO Market as expected.
