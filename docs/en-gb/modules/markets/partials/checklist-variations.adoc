...
. On the left in the side navigation, click on the view *Filters* (icon:filter_alt[set=material]). +
*_Tip:_* The number next to the word *Filter* shows how many filters have been set. The template filters are included in this number. +
