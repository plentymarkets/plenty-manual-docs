...
| For each shipping profile in plentymarkets, enter the corresponding ID of the shipping service provider. You can find the abbreviations in the Mirakl menu *{mirakl-menu-shipping}*.
