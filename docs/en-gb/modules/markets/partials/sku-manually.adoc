...
TIP: Only the most important settings for the import are described here. Is this your first time working with the import tool? Then get familiar with xref:data:ElasticSync.adoc#[how data imports work in plentymarkets first].
...
*Setup » plentyShop » (Select client) » Client Settings » Option: Plenty ID*
endif::sku-client[]
ifdef::sku-others[]
