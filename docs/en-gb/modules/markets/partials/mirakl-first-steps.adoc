...
First, become a link:{registration-url}[{market}^]{nbsp}icon:external-link[] and create a {market} account. After registering, you will receive login details from {market}. You need these login details to set up {market} in plentymarkets.
