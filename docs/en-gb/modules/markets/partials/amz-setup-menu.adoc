...
. First, click on the button *Allow access*. +
→ Here you allow plentymarkets access to your Amazon account, so that data can be exchanged between Amazon and plentymarkets. You are forwarded to Amazon and have to enter the access data of your seller account. After having logged into Amazon, a page showing the data plentymarkets will have access to is displayed. On this page, click on *Confirm* to complete the authorization. +
→ In plentymarkets, the window *Complete authorization* opens. Click on *Complete* to continue setting up your account.
...
Watch this video tutorial for further information about Amazon MFN:
...
|Select the xref:orders:managing-orders.adoc#1200[order status] for returns that were successfully reported to Amazon.

| *Status for untransmitted returns*
|Select the xref:orders:managing-orders.adoc#1200[order status] for returns that were not reported to Amazon.
