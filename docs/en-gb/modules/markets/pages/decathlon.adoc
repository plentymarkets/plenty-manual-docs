...
To deactivate an offer on Decathlon, a stock of zero is exported to Decathlon for the respective variation. Zero is exported if the variation has an active SKU for Decathlon and at least one of the following cases apply to the variation:
