...
| *Activate FBD* toggle 
| If *Activate FBD* toggle is *ON*, please note that the stock and order fulfllment will be managed by Decathlon. The assigned Warehouse will be used to sync your stock (Decathlon &rarr; plentysystems)

| De-*Activate FBD* toggle
| Disabling this option will change the behaviour of all Decathlon related imports and exports. Proceed if your are certain that this is matching your agreement with Decathlon.
