...
First, register with link:https://www.ricardo.ch/de/registration/step1[ricardo.ch^]{nbsp}icon:external-link[]. After you have finished the registration, use the access data to set up your ricardo.ch account in plentymarkets. Please note that the ricardo.ch website is currently only available in German and French.
