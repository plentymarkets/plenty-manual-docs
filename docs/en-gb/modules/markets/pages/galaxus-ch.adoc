...
Examples: +
*-* List of ingredients (must list all ingredients contained in a grocery) +
...
following successful registration with stiftung ear. It consists of a country code and an eight-characters-long sequence of digits. +
e.g. “DE12345678”
