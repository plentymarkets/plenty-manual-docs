= Setting up Amazon variation export
:keywords: Amazon, Export Amazon, Amazon Export, exporting item data to Amazon, exporting variation data to Amazon
:description: Export your variation data to the market Amazon. Learn which settings you need to carry out if you do not transfer your items to Amazon via catalogues.
