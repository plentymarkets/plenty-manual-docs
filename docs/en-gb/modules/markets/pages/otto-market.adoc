...
:referrer-option: pass:quotes[option *OTTO Market* with the ID *160.1*]
...
'''
*Creating a sales price* = Creates a sales price and maps this sales price to the marketplace data field. You can check and edit this sales price in the xref:item:prices.adoc#400[Setup » Item » Sales prices] menu.
...
image::market:otto-unitprice-iso.png[]

_or_

* Property with the values that are allowed by OTTO Market (ISO codes)

image::market:otto-unitprice-mappings-salesprice.png[]
...
image::market:otto-unitprice-content.png[]
