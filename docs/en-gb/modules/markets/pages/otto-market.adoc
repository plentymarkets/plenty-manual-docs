...
| *Produktbeschreibung*
| The product description can contain up to 2000 characters. Descriptions that are too long will be truncated. The truncation is logged in the log.
...
*_Note:_* The minimum dimensions for images uploaded to OTTO Market are 500 x 1000 pixels. All URLs in the **Media assets** area can contain up to 2083 characters. URLs that are too long are removed. The removal is logged in the log.
