...
| Category group +
related attributes
| OTTO Market publishes current information in the category list “Kategorienliste”. Open the link:https://og2gether-my.sharepoint.com/:x:/g/personal/patrick_knubbe_otto_de/EWrsFhxTI3tErqUHyyR6cmkBoCj3ESDcgccFfLT_SO4n-Q?rtime=TLDZhVRQ20g[tab "Attributsliste" (attribute list)^]. This document is only available in German.
...
| *Category*
| OTTO Market publishes current information in the category list “Kategorienliste”. Open the link:https://og2gether-my.sharepoint.com/:x:/g/personal/patrick_knubbe_otto_de/EWrsFhxTI3tErqUHyyR6cmkBoCj3ESDcgccFfLT_SO4n-Q?rtime=TLDZhVRQ20g[tab "Übersicht Kategorien" (category overview)^]. This document is only available in German.
...
*_Note:_* The minimum dimensions for images uploaded to OTTO Market are 500 x 1000 pixels. All URLs in the **Media assets** area can contain up to 2083 characters.
