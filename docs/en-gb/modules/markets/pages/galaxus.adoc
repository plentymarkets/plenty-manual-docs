...
Your company is based in Germany and you delivery to Galaxus end customers in Switzerland.
...
* Your VAT ID for Switzerland is saved in the location *Switzerland*.

| Workflow of order import
...
* Orders with invoice addresses in Switzerland and delivery addresses in the EU are imported as net orders. +
*_Exception:_* You have fiscal representation in Switzerland.
...
* Statuses for rejecting partial cancellation requests and cancellation requests must be set by the user. Go to *Setup » Markets » Galaxus » Order import » Order status configuration*. If no option is selected, the status *[5] Cleared for shipping* is automatically set.
...
or input field selection under: *System » Markets » Galaxus » Item export » Product Data » input field mappings*
...
*_Export invoices for merchants without fiscal representation must contain the following information:_*
...
*_The following information is not allowed on invoices:_*
...
. Go to *Setup » Client » [Select client] » Locations »Location: Switzerland » Documents » Invoice*.
...
[.instruction]
Adjusting PDF template for invoices:

. Go to *Setup » Client » [Open standard client] » Locations » Location: Switzerland » Documents » Invoice » Tab: Template*.
...
* You activated the option *I use Galaxus EU hub and have fiscal representation in Switzerland* in the menu *Setup » Markets » Galaxus » Order import*.
* Your have created the location *Switzerland* and saved your VAT ID for Switzerland.


*_Export invoices for merchants with fiscal representation must contain the following information:_*
...
. Go to *Setup » Client » Standard » Locations » Location: Switzerland » Documents » Delivery note » Tab: Template*.
. Scroll down to the area *Optional elements below stock unit table*.
. Carry out the settings described in <table-delivery-notes>.
...
* Statuses for rejecting partial cancellation requests and cancellation requests must be set. Go to *Setup » Markets » Galaxus » Order import » Order status configuration* to do so. If no option is selected, the status *[5] Cleared for shipping* is automatically set.

* After splitting an order, the plugin can inform Galaxus about each of these orders without any additional user input.
