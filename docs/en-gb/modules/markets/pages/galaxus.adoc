...
| *Item » Edit Item » [Open item] » Tab: Texte » Name 1 (de) or Name 2,3* +
Can be selected in the Elastic Export configuration for this format.

| *ProductTitle_EN, _(Text100)_*
| *Item » Edit Item » [Open item] » Tab: Texte » Name 1 (en) or Name 2,3* +
Can be selected in the Elastic Export configuration for this format.

| *ProductTitle_FR, _(Text100)_*
| *Item » Edit Item » [Open item] » Tab: Texte » Name 1 (fr) or Name 2,3* +
Can be selected in the Elastic Export configuration for this format.

| *ProductTitle_IT, _(Text100)_*
| *Item » Edit Item » [Open item] » Tab: Texte » Name 1 (it) or Name 2,3* +
Can be selected in the Elastic Export configuration for this format.
