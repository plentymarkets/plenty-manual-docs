...
* Go to *Order » Overview » Item » Edit » Delivery date* to enter the delivery date for Galaxus orders. If no delivery date is saved, a delivery date is calculated based on the following formula: +
