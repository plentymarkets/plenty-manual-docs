...
. Click on the drop-down list *Payment method* of this field.
  ...
  * Select the option *GalaxusDE Direct Checkout*.
...
* In the menu *Setup » Markets » GalaxusDE » Order import*, you activated the option *I use Galaxus EU hub and have fiscal representation in Switzerland*.
