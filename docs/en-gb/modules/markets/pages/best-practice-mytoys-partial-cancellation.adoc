= Best practice: Reporting partial cancellations to MyToys
:author: team-plenty-channel
:keywords: MyToys, partial cancellation, cancellation, MyToys cancellation, cancelation, cancel orders
:description:

One or more order items of an order, but not the whole order, should be cancelled? This best practice teaches you how to inform MyToys that one or more order items should be cancelled.
