...
====
The integration of Shopgate will be deactivated on 31 December 2023. This means that plentysystems will no longer support the market. As such, you will no longer be able to sell your items on the market with plentysystems. Further information is available in the link:https://forum.plentymarkets.com/t/abschaltung-einiger-verkaufskanaele-zum-31-12-2023-deactivation-of-several-sales-channels-on-31-12-2023/736679[forum^].
====
