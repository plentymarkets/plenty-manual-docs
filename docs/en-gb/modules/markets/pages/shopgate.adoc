...
First register with link:https://www.shopgate.com/en/[Shopgate^]{nbsp}icon:external-link[] in order to set up the interface to Shopgate in your plentymarkets system. After registering, you will receive login details from Shopgate.
