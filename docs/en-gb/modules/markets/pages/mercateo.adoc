...
====
The integration of Mercateo will be deactivated on 16 January 2023. This means that plentymarkets will no longer support the market. You cannot sell your items on Mercateo with plentymarkets and Mercateo orders will no longer be imported into your system. Further information is available in the link:https://forum.plentymarkets.com/t/abschaltung-einiger-marktplatzintegrationen-zum-16-01-2023/701086[forum^].
====
