...
| Select a status. If no shipping confirmation could be sent to Kaufland.de, the order is moved to this status.
...
* *Status change > [Select a status, for example [7] Shipped]*
...
* *Status change > [4] In preparation for shipping*

_or_

* *Status change > [5] Cleared for shipping* +
|
| *Filter 1*
| *Order > Order type*
| *Order*
