...
Unlike other marketplaces, you cannot send returns to Kaufland with an event procedure via plentymarkets yet. Process returns for Kaufland directly in your Kaufland.de seller account.
