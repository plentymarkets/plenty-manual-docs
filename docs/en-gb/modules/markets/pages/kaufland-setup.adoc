...
| Select which text should be displayed with your items on Kaufland. +
...
| Enter text. The entered text is displayed with every offer on Kaufland.
...
*_Important:_* If you change the shipping groups on Kaufland, then you can update them in plentymarkets by clicking ob *Update shipping groups*. +
...
| *Match warehouses*
a| Warehouses located outside the EU have to be linked with a Kaufland warehouse. Use the setting *Match warehouses* for this. Here, all of your warehouses of the type *Sales* are listed. Select your warehouses and link each of them to the correspondent Kaufland warehouse. This way, the stock of your warehouses is linked to the Kaufland warehouses. +
