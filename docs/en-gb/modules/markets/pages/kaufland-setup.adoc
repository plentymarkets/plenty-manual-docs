...
| Select a status. If no shipping confirmation could be sent to Kaufland, the order is moved to this status. If necessary, create a xref:orders:order-statuses.adoc#create-status[new status]. +
