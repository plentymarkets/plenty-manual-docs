...
*_Note:_* The fields *Min. delivery time (in working days)* and *Max. delivery time (in working days)* are deprecated and will be removed from the menu. This means that you do not have to enter anything into these fields. However, make sure to enter values into the *Handling time (in working days)* fields.
|===
