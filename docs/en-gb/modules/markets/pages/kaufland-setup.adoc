...
| Here you select the product category that you want to create a catalogue for. You have to create a separate catalogue for each Kaufland product category that you want to offer your items in. +
