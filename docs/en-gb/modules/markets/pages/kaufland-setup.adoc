...
. Carry out the settings. Pay attention to the explanations given in <<#settings-kaufland>>.
...
*_Important:_* You have to assign each of your shipping service providers to one of the shipping service providers from the drop-down list.
...
| Select whether item availabilities should be transferred to Kaufland.
