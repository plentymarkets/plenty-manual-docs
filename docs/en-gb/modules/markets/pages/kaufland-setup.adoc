...
Catalogue formats provide you with a long-term and flexible way to export your item data. Item data is exported to Kaufland using catalogue formats. Go to *Data » Catalogues* to create catalogues.
...
Item data is exported to Kaufland using a marketplace format. To export your items to {market}, create a catalogue in the *Data » Catalogue* menu. Link the Kaufland data fields with item data saved in plentymarkets in the marketplace format afterwards. After you activate the catalogue, the catalogue data is automatically exported to {market} in regular intervals.
