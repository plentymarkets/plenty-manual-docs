...
Before setting up Netto eStores in your plentymarkets system, you have to register with Netto eStores. Contact data for the registration: +

Kooperation@netto-online.de

Contact data for the registration with Marktkauf: +
...
After you have set up the market in plentymarkets, the automatic processes described in <<#data-exchange-netto>> become available.
...
| _Mapping shipping service providers_
| Map your shipping service providers in plentymarkets to the shipping service providers from Netto.

Your plentymarkets shipping service providers are listed as options on the left-hand side. For each plentymarkets shipping service provider, select a Netto shipping service provider from the drop-down list.
...
[IMPORTANT]
.The old item data export will be deactivated - use catalogues instead
--
The old item data export for Netto and Marktkauf will prospectively be deactivated on 28.01.2024. If you are in the process of setting up the item data export, we recommend that your use <<#catalogue-export, a catalogue>> for the export. To do so, go to *Data » Catalogues* and create a catalogue (export type *Netto / Marktkauf*).
--
...
Item data is exported to {market} using catalogues.
...
Set up an xref:automation:event-procedures.adoc#[event procedure] to automatically send shipping confirmations to Netto eStores and Marktkauf when the outgoing items have been booked. The shipping confirmation is automatically sent to Netto eStores and Marktkauf when the order changes its status to *[7] Outgoing items booked*. After that, Netto eStores informs the buyer about the shipment of the item.
...
| *Filter 2*
| *Order > Referrer*
| *Netto*, *GartenXXL.de*, *GartenXXL.at*, and *Marktkauf*
...
Set up an xref:automation:event-procedures.adoc#[event procedure] to automatically send cancellations to Netto eStores and Marktkauf.
...
Set up an xref:automation:event-procedures.adoc#[event procedure] to automatically send returns to Netto eStores and Marktkauf.
