...
You can download the checklist as PDF file here: link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/netto-order-documents/Checkliste_Produktpflege.pdf[Checkliste Produktpflege^]{nbsp}icon:external-link[] (Currently only available in German.)
...
You need specific delivery notes and return slips for Netto Marken-Discount. This chapter describes how you set up xref:orders:order-documents.adoc#170[PDF templates] for delivery notes and return slips. This information is structured as follows:
...
For delivery notes for Netto Marken-Discount orders, the PDF template that Netto Marken-Discount provides has to be used. Proceed as described below to upload a xref:orders:order-documents.adoc#170[PDF template] for delivery notes to plentymarkets.

[.instruction]
Uploading a PDF template for delivery notes:

. Download the PDF template for Netto Marken-Discount delivery notes and save it on your computer:
  ** *_Alternative 1:_* link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/netto-order-documents/netto_pdf_Lieferscheinrohling.pdf[Download PDF template without sender address line]
  ** *_Alternative 2:_* link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/netto-order-documents/netto_pdf_Lieferscheinrohling_mit_Absenderadresszeile.pdf[Download PDF template with sender address line] +
*_Tip:_* The header of this PDF template already contains the sender information `Netto Digital - NeS GmbH, Wissollstrasse 5-43, 45478 Mülheim a.d. Ruhr` required by Netto.
...
. Adjust the layout of the delivery notes based on Netto Marken-Discount’s requirements. You can find information on how to do this in the xref:orders:order-documents.adoc#170[Orders] area of the manual.
...
For return slips for Netto Marken-Discount orders, the PDF template that Netto Marken-Discount provides has to be used. Proceed as described below to upload a xref:orders:order-documents.adoc#170[PDF template] for return slips to plentymarkets.

[.instruction]
Uploading a PDF template for return slips:

. Download the PDF template for Netto Marken-Discount return slips and save it on your computer.
  ** link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/netto-order-documents/netto_pdf_Lieferscheinrohling.pdf[Download PDF template]
...
. Click on *Upload template* (icon:save[role="green"]). +
→ The template is uploaded.
. Adjust the layout of the return slips based on Netto Marken-Discount’s requirements. You can find information on how to do this in the xref:orders:order-documents.adoc#170[Orders] area of the manual.
