...
After you set up the market in plentymarkets, the automatic processes described in <<#data-exchange-netto>> become available.
...
| Map your plentymarkets shipping service providers to Netto's shipping service providers.

Your plentymarkets shipping service providers are listed as options on the right. Form the drop-down list on the left, select a suitable Netto shipping service provider for each plentymarkets shipping service provider.
...
[IMPORTANT]
.Old item data export will be deactivated - use catalogues instead
--
The old item data export for Netto and Marktkauf will prospectively be deactivated on 28 January 2024. Therefore, we highly recommend to use the <<#catalogue-export, catalogue export>> instead.
--
...
.Old item data export will be deactivated - use catalogues instead
--
The old item data export for Netto will prospectively be deactivated on 28 January 2024. Therefore, we highly recommend to use the <<#catalogue-export, catalogue export>> instead.
--
...
Set up an xref:automation:event-procedures.adoc#[event procedure] to automatically send shipping confirmations to Netto eStores and Marktkauf when the outgoing items are booked. The shipping confirmation is automatically sent to Netto eStores and Marktkauf when the order changes its status to *[7] Outgoing items booked*. After that, Netto eStores informs the buyer about the shipment of the item.
