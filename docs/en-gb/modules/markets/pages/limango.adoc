...
Creating layout templates for order documents in plentymarkets is described in the xref:orders:order-documents.adoc#170[ Orders] area of the manual. On this page, we only describe how to upload the PDF template and set up the delivery note document for the specific requirements of the market:
