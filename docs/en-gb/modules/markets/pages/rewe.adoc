...
'''
*Creating a sales price* = Creates a sales price and maps this sales price to the data field. You can check and edit automatically created sales prices in the xref:en:prices.adoc#400[Setup » Item » Sales prices] menu.
