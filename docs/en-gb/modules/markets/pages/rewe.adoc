...
image::rewe-promotion-price-example.png[]
--
====
'''
...
'''
*Creating a sales price* = Creates a sales price and maps this sales price to the data field. You can check and edit automatically created sales prices in the xref:en:prices.adoc#[Setup » Item » Sales prices] menu.
...
'''
*Create barcode* = Creates a barcode *REWE* and maps this barcode to the data field. If a barcode with the name *REWE* already exists in the system, that barcode is mapped instead. You can check and edit automatically created barcodes in the xref:en:barcodes.adoc#100[Setup » Item » Barcodes] menu.
--
