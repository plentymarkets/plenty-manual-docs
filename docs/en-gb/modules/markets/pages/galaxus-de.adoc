...
`In the event of a return, please use the returns process in your customer account on galaxus.de.`

`Orders placed via galaxus.de are subject to the General Terms and Conditions of Galaxus Deutschland GmbH.
If you have any questions or queries, please contact Galaxus customer service: marketplace@galaxus.de`
|===
