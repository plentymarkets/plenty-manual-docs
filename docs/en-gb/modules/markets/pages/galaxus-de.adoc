...
In the menu *Client » Settings* there is a setting named _Client_. By default, this setting applies to the default client. You can change this setting and select a specific client. Consequently, the export process will adhere to the setting you have configured for the client. As a seller, you can configure categories for any client.
