...
Please refer to the Digitex Galaxus documentation, for detailed information on what invoices should look like:
https://confdg.atlassian.net/wiki/spaces/PH/pages/169097168914/What+should+my+invoice+look+like
...
. Click on the drop-down list Payment has already been made directly to Galaxus Deutschland GmbH.
  .. In the event of a return, we kindly ask you to use the return process in your customer account on galaxus.de.
  .. Orders placed via galaxus.de are subject to the General Terms and Conditions of Galaxus Deutschland GmbH.
  .. In case of questions or uncertainties, the Galaxus customer care team will be happy to help: marketplace@galaxus.de.
...
`In the event of a return, please use the _returns_ process in your customer account on galaxus.de.`

`Orders placed via galaxus.de are subject to the Galaxus Deutschland GmbH General Terms and Conditions.
If you have any questions or queries, please contact the Galaxus customer service at marketplace@galaxus.de`
|===
