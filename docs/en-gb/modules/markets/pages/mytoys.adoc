...
{market} delivery notes must contain the {market} logo. Proceed as described below to upload a xref:orders:order-documents.adoc#170[PDF template] for delivery notes for {market} to plentymarkets.
...
Proceed as described below to upload a xref:orders:order-documents.adoc#170[PDF template] for return slips for {market} in plentymarkets.
