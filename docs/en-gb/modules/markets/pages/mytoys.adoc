...
. Click on icon:execute[set=plenty, role="darkGrey"] *Execute* to apply the settings to the items.
...
--
image::maerkte:mytoys-lieferschein-20220303.png[]
--
...
--
image::maerkte:myToys-retourenschein-20220303.png[]
--
