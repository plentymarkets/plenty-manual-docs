...
econda offers a controlling solution for analyzing and improving online stores comprehensively.

[#old-export]
== _Alternative 1:_ Export format EcondaDE-Plugin _(deprecated)_
