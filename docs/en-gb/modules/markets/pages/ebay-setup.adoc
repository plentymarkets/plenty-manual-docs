...
====
Due to an adjustment on the part of eBay, processes relating to eBay business policies will soon not work any longer without OAuth2. Therefore you have to authenticate your eBay accounts for OAuth2 if you have not already done so.
====
...
| Select a status. If no refund could be issued, then the order is moved to this status. If necessary, create a xref:orders:managing-orders.adoc#1230[new status]. +
