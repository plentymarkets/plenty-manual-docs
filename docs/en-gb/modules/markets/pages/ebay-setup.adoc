...
For specific products, such as electrical devices and furniture, recycling fees (eco participation fees) can be defined on eBay. The recycling fees are included in the item’s sales price, but they are displayed separately. On eBay, the recycling fee is displayed below the listing’s sales price on the listing’s page. +
...
[[ebay-return-policy]]
.Settings for eBay return policies
[cols="1,3a"]
|====
| Setting | Explanation
