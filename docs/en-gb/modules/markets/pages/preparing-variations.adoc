...
* Is this your first time working with properties? Then read up on the xref:item:properties.adoc#10[principles of properties first].
...
xref:item:managing-items.adoc#390[Attributes] also have to be linked before your items can be transferred to Amazon. It is also possible to link attributes for several languages.
