...
|sale_price
|A price of the type *special offer*, according to the setting *Offer price*. The sale_price will only be included in the export file if it is lower than the *sales price*.
