...
The coloured dots show the respective shipment status: +
green: The shipment has the status *RECEIVING* or *CLOSED*. Here, the number of received items equals the number of shipped items. +
yellow: The shipment has the status *WORKING*, *SHIPPED*, *IN_TRANSIT*, *DELIVERED* or *CHECKED_IN*. No number of items is shown here. +
red: The shipment has the status *RECEIVING* or *CLOSED*. Here, the number of received items is lower than the number of shipped items.
