...
A xref:orders:package-content-list-test-phase.adoc#[packet content list] lists the content of pallets, packages and items. The package content list informs Amazon about what items are in the packages that it stores and ships for you.
...
. Pick and pack the order based on the xref:orders:package-content-list-test-phase.adoc#[package content list].
