...
. Carry out the settings in the *Amazon* area. Pay attention to the explanations given in the chapter xref:markets:preparing-variations.html#700[Setting the variation availability].
. Save (terra:save[]) the settings.
