...
You can use *tags* to organise eBay feedback in plentymarkets.
...
Afterwards, link the tags to your eBay feedback.
...
:right-one: pass:quotes[*Setup > Markets > eBay > Feedback > Read*]
:right-two: pass:quotes[*CRM > Ticket > Read*]
