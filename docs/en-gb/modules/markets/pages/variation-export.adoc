...
*_Note:_* If Amazon releases a new version of the flatfile, a new catalogue needs to be created. The good news is: You can xref:data:marketplace-export.adoc#190[copy and edit] the catalogue with the old flatfile version with a few convenient clicks.
