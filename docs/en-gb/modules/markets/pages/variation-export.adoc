...
*_Note:_* If Amazon releases a new version of the flatfile, a new catalogue needs to be created. The good news is: You can xref:data:managing-catalogues.adoc#80[copy and edit] the catalogue with the old flatfile version with a few convenient clicks.
...
* Before you create your first Amazon catalogue, familiarise yourself with xref:data:managing-catalogues.adoc#[how catalogues are used in plentymarkets].
...
*_Note:_* Create xref:crm:managing-contacts.adoc#15[the necessary customer classes] in advance if they do not already exist in your plentymarkets system.
--
