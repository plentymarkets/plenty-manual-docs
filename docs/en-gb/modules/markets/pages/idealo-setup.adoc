...
:description: Learn how to set up the price search engine idealo in your plentymarkets system.
:author: team-plenty-channel

:idealo:

On this page, you will find information about the settings you need to carry out in order to set up the price comparison portal idealo in plentymarkets. Learn how to set up the interface, how to export items to idealo Checkout and how to define sales prices.
...
*_Note:_* This does _not_ apply to the <<#catalogue-export, catalogue export>>. If you use the catalogue export to transfer item data to idealo, then all changes in item data will automatically be transferred.
...
*_Note:_* The idealo assistant currently still contains settings for idealo Checkout. However, those settings are without function as idealo Checkout was closed at the end of 2022.
