...
Item data is exported to {market} using catalogue formats. Catalogues are created with the assistant *myToys - Catalogues*.
...
| *Select a catalogue generator.*
| In this step, you select the catalogue generator that should be used to create catalogues. +

* *Catalogue generator*: If you want to export the created catalogues to MyToys, we recommend to use the catalogue generator.

* *Catalogue generator BETA*: Note that you can currently only use the catalogue generator BETA to create catalogues, but not export those catalogues.  +

*_Tip:_* Use the BETA generator to give us feedback and to check if all fields are available in the catalogue. Once the feature has been fully developed, it will be possible to export catalogues created with the BETA generator.

| *myToys category*
| Afterwards, select the myToys product category. The items in this catalogue will then be listed in this product category on MyToys.

| *myToys catalogue name*
| Enter a name for the catalogue. +
The name will only be visible in the back end of your plentymarkets system.
|======
--
...
--
image::markets:MyToys_example-delivery-return-slip.png[]
--
...
. Download the PDF template for {market} delivery notes to your computer:
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/MyToys_2023/MyToys_Liefer_Retourenschein_leer.pdf[Download PDF template (as of 15/02/2023)]
...
Proceed as described below to upload a xref:orders:order-documents.adoc#1700[PDF template] for return slips for {market} to plentymarkets.
...
. Download the template for {market} return slips to your computer.
  * link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/MyToys_2023/MyToys_Liefer_Retourenschein_leer.pdf[Download PDF template (as of 15/02/2023)]
