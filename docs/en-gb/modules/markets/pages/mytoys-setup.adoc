...
| *Product export cron*
| Activate in order to activate the item export for catalogues which were created using the old catalogue generator. +
*_Note:_* Item data is exported once or twice a day. The export also triggers the price update for the variations included.

| *V2: product export cron*
| Activate in order to activate the item export for catalogues which were created using the *catalogue generator V2*. +
*_Note:_* Item data is exported once or twice a day. The export also triggers the price update for the variations included.
...
A variation has already been exported to myToys, but you do not want to offer this variation on myToys any longer? Then carry out one of the following steps in order to not export a variation to MyToys any longer:

* In the *Availability* tab of the variation, de-select the market availability *myToys*. The variation will then not be exported to MyToys any longer. +

_or_

* In the variation’s *Properties* tab, remove the property *myToys category group*. The variation will then not be released in this category on MyToys any longer.
...
The catalogue generator V2 will replace the old catalogue generator in the future. We therefore recommend that you start using the *catalogue generator V2* now.

* *Catalogue generator*

* *Catalogue generator V2* +

*_Tip:_* Catalogues which were created using the catalogue generator V2 are loaded faster, always contain the latest MyToys data fields, and are updated regularly.
