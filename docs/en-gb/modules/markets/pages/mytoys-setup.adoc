...
[#mytoys-shipping-profile]
=== Creating a shipping profile

Next, create a shipping profile for myToys.

[.collapseBox]
.What is a shipping profile?
--
The individual shipping profiles are different shipping methods which your customers can choose later on during checkout or which are assigned automatically to certain types of orders by the online shop. For example, you can offer your customers a cheap standard delivery and a more expensive express delivery.
--
...
. Carry out the desired settings. Pay attention to the explanations given in <<#table-shipping-profile>>.
. *Save* (icon:save[role="green"]) the settings. +
→ The *Table of shipping charges* tab is displayed.
. In the table of shipping charges for Germany, enter the value *0.00* EUR for *flat rate shipping charge*.
. *Save* (icon:save[role="green"]) the settings.

[.collapseBox]
.Settings for shipping profiles
--
[[table-shipping-profile]]
...
| *Category*
|Select a category from the drop-down list. The category is another way to prioritise shipping profiles in the shopping cart. Category *1* is selected by default. This means that all of the shipping profiles are given the same priority. For further information, refer to the xref:fulfilment:preparing-the-shipment.adoc#1300[Preparing the shipment] page of the manual.
...
For further information, refer to the xref:fulfilment:preparing-the-shipment.adoc#1100[Preparing the shipment] page of the manual.
...
*_Important:_* It is required that the plugins link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[plentyShop LTS^] and link:https://marketplace.plentymarkets.com/en/plugins/templates/IO_4696[IO^] are installed.
...
| *Alternative email*
|This setting is only visible if the option *Transfer alternative* or *Transfer if available, otherwise transfer alternative* was selected in the drop-down list *Transfer email and telephone number*. Enter an alternative email address that should be transferred to the service provider.

| *Alternative telephone number*
|This setting is only visible if the option *Transfer alternative* or *Transfer if available, otherwise transfer alternative* was selected in the drop-down list *Transfer email and telephone number*. Enter an alternative telephone number that should be transferred to the service provider.
...
| *Account*
|This is an eBay setting and therefore not relevant for myToys.
...
| *Loyalty program*
|This setting is for Amazon and eBay and therefore not relevant for myToys.
|====
--
...
Afterwards, activate the shipping profile for all items that you want to sell on myToys. To do so, use the *Item group function*.

[.instruction]
Activating the shipping profile:

. Go to *Item » Edit item*.
. Place a check mark next to all items that you want to sell on myToys.
. Click on *Item group function*.
. In the *Shipping* section, place a check mark next to *Shipping configuration*.
. For the setting *Shipping configuration*, select the shipping profile that you created for myToys.
