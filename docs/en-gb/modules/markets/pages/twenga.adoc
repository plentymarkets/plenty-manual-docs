...
Twenga.com is an international shopping platform that offers comprehensive price comparisons. In order to set up Twenga.com in plentymarkets, you have to register with link:https://www.twenga-solutions.com/en/[Twenga^]{nbsp}icon:external-link[] first.

[#old-export]
== _Alternative 1:_ Export format TwengaCOM-Plugin _(deprecated)_
