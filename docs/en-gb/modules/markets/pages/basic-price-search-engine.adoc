...
:description: Use the export format Basic Price Search Engine to export item data to price search engines. You can map item data that is expected by most price search engines.
:url-export:
:page-aliases: .adoc
:basic-price-search-engine:
