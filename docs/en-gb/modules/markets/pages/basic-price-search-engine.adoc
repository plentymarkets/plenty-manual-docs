...
[#100-0]
== _Alternative 1:_ Export format BasicPriceSearchEngine-Plugin _(old method)_
...
* Check the page xref:data:export-marketplace-formats#, Using marketplace formats>> to find out more about the format settings.
