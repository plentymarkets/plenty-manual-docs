...
:description: Learn how to set up the market Yatego in plentymarkets to start selling your items on Yatego.

[IMPORTANT]
.Market integration will be deactivated
====
The integration of Yatego will be deactivated on 15 March 2023. This means that plentymarkets will no longer support the market. You cannot sell your items on Yatego with plentymarkets and Yatego orders will no longer be imported into your system. Further information is available in the link:https://forum.plentymarkets.com/t/abschaltung-einiger-marktplatzintegrationen-zum-15-03-2023-deactivation-of-several-market-integrations-on-15-03-2023/707657[forum^].
====
...
The *web token* can be found in plentymarkets in the *Setup » System settings » API » Data* menu in the *web token* area.
====
