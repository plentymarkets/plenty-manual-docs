...
====
The integration of Yatego will be deactivated on 15 March 2023. This means that plentymarkets will no longer support the market. You cannot sell your items on Yatego with plentymarkets and Yatego orders will no longer be imported into your system.
====
