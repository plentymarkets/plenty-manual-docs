...
In order to set up the kelkoo plugin in plentymarkets, you have to register with link:https://www.kelkoogroup.com/merchants/[kelkoo^] first.
...
| *Product URL*
|Choose the URL that you wish to transfer to kelkoo. You can choose between the item’s URL and the variation’s URL. URLs of variations can only be transferred in combination with the plentyShop LTS store.
