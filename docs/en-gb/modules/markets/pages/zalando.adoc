...
[#150]
== Steps after the registration

You have signed a contract with Zalando. Great. What happens now?

* Contact our support team in the forum thread link:https://forum.plentymarkets.com/t/sammelthread-anfrage-des-csv-formulars-zum-abgleich-der-artikel-silhouetten/669460[Request CSV form for matching items and silhouettes^]{nbsp}icon:external-link[].
* Our support team will provide you with a CSV file. This file contains the following information:
  ...
  *_Tip:_* Zalando sends your silhouettes to this FTP server for import into your system. plentymarkets imports the silhouettes every Wednesday. 
