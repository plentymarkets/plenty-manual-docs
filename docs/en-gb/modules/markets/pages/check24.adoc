...
If the variation has stock again, then it will also be offered on Check24 after the next item data export.

However, if you do not want to sell a variation which has stock in plentymarkets on Check24, then you have to delete the availability for the market. 
