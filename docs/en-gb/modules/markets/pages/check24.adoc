...
Check24 retrieves item data via URL. You will find this URL in your Check24 catalogue in the *Data » Catalogues* menu. After you created the catalogue, you have to <<#url-check24-catalogue, copy the URL and save it at Check24>> so that item data can be exported to Check24.
