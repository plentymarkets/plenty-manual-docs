...
Item data is exported to Check24 via a catalogue using the marketplace format *Check24*. To export your items to Check24, create catalogues in the *Data » Catalogue* menu. Link the Check24 data fields with item data saved in plentymarkets in the marketplace format afterwards.
...
====
For Check24, there are the catalogue formats *Check24*, *Check24 Offer*, and *Check24 Fashion*. +
The catalogue format *Check24 Offer* contains offer data. +
The catalogue format *Check24* contains product data. +
The catalogue format *Check24 Fashion* is deprecated, as the fashion category is not in use any longer on Check24. It should only be used as an exception and in consultation with Check24. +
...
. Under *Download settings* in the *Options for public link* section, click on *Copy URL* (icon:content_copy[set=material]).
