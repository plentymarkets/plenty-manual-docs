...
IMPORTANT: This page only describes how you set up the Fruugo order interface. To export item and stock data, you also need the plugin link:https://marketplace.plentymarkets.com/en/fruugo_6875[Fruugo].
