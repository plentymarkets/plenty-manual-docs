...
|link:mailto:gudrun.croce@neckermann.at[gudrun.croce@neckermann.at^]{nbsp}icon:external-link[]
|====
...
Proceed as follows to create a xref:orders:order-documents.adoc#170[PDF template] for delivery notes for Neckermann.
