...
====
The integration of Neckermann.at will be deactivated on 15 March 2023. This means that plentymarkets will no longer support the market. You cannot sell your items on Neckermann.at with plentymarkets and Neckermann.at orders will no longer be imported into your system.
====
