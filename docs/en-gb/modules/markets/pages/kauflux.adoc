...
https://marketplace.plentymarkets.com/en/plugins/sales/marktplaetze/elasticexportkaufluxde_4737[Kauflux^]
====
...
[#old-export]
=== _Alternative 1:_ Export format KaufluxDE-Plugin_(old method)_
