...
The *Setup » Markets » Conrad » Settings* menu provides an overview of your Conrad accounts. <<tabelle-konto-uebersicht>> lists the columns and available actions in the account overview.
