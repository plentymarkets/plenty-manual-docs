...
:description: Set up the item data export to BeezUP in your plentymarkets system. BeezUp is a tool for managing and improving the way your items are presented in price comparison portals, on markets and with affiliate services.
