...
.Amazon platforms
====
With plentymarkets, you can sell on the Amazon platforms Amazon.de, Amazon.ae, Amazon.ca, Amazon.co.uk, Amazon.com, Amazon.com.mx, Amazon.es, Amazon.fr, Amazon.it, Amazon.nl, Amazon.pl, Amazon.se, and Amazon.tr.
====
...
This chapter describes the settings that need to be configured in order to exchange data between your plentymarkets system and Amazon. You will learn how to manually import Amazon orders with a CSV file, how to send shipping confirmations to Amazon, how to synchronise FBA stock, and how to reset order reports from Amazon.

[#1900]
=== Importing Amazon orders

Go to *Setup » Markets » Amazon » Data exchange » Order import* to set up the import of Amazon orders. In this menu, orders can be imported manually with a CSV file.
...
However, note that you cannot skip reports which are already being processed in the background. +
