...
* *Download report* (material:file-download[]): The report is downloaded. +
...
* *Skip report* (material:skip-next[]): The report is skipped. If you skip a report, it will not be processed. It is not possible to download the report if it was skipped. +
