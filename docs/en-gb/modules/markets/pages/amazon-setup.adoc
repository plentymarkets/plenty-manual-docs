...
* The timeframe of the requested report should be as short as possible, as processing big reports can take more time due to the amount of data.
...
*_Note:_* The number of requests is limited. After you selected a report type, you will see how often per day you can request it below the report.
|===
