...
* In the Etsy back end, go to *Shop-Manager » Listings » [Open listing]* and set the setting *Renewal options* to *Manual*. Otherwise, the the setup of Etsy will not work correctly.
...
====
Prior to setting up Etsy in plentymarkets, you have to set the setting *Renewal options* to *Manual* in the *Shop-Manager » Listings » [Open listing]* menu of the Etsy back end. Otherwise, the setup of Etsy will not work correctly.
====
...
* Orders are always assigned to the default client (store).
...
*_Troubleshooting:_* Are you redirected to the start page of your plentyShop? +
  ** Your plentyShop is probably locked. Go to *Setup » Client » Settings » Online store » Lock store* to unlock your plentyShop. Remember to lock the plentyShop again once you have completed the authentication.
...
The term “Etsy” is a trademark of Etsy, Inc. The plentymarkets integration of Etsy uses the Etsy API. However, the integration is not endorsed or certified by Etsy, Inc.