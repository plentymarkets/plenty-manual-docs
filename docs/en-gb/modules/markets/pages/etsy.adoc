...
[IMPORTANT]
.Etsy assistant not required for setup
====
You do not have to go through the *Etsy 2.0 Migration* assistant if you want to set up Etsy in plentymarkets. +
The assistant was required when Etsy 2.0 was set up in September 2019 and was needed to migrate SKUs. However, Etsy now uses the new logic and you do not need the assistant any longer if you want to set up Etsy in your plentymarkets system.
====
