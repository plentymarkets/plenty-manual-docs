...
====
Due to a change in the Etsy API, the new authentication method OAuth2 will replace the old authentication method in the near future. The expected date for the switch is 16 January 2023. We therefore recommend to already authenticate your Etsy account for OAuth2 now.
====
...
*_Note:_* The old event procedures for Etsy will no longer work after 16 January 2023 due to a necessary switch. The event procedure listed here will be replaced by the event procedure *Send payment confirmation to Etsy (new)*. As a preparation, we therefore recommend to already additionally set up the event procedure *Send payment confirmation to Etsy (new)* now. The old event procedure will work as usual until 16 January 2023.
|
|===
...
*_Note:_* The old event procedures for Etsy will no longer work after 16 January 2023 due to a necessary switch. The event procedure listed here will be replaced by the event procedure *Send shipping confirmation to Etsy (new)*. As a preparation, we therefore recommend to already additionally set up the event procedure *Send shipping confirmation to Etsy (new)* now. The old event procedure will work as usual until 16 January 2023.
|
|===
