...
[#250a]
=== _Old authentication method:_ Activating your Etsy account
...
NOTE: The authentication in the *Setup » Markets » Etsy » Authentication* menu is deprecated. The new authentication method OAuth2 will replace the old authentication in the near future. We therefore recommend to additionally already <<#activate-account, authenticate your Etsy account for OAuth2 now>>.
...
[#activate-account]
=== _New authentication method:_ Activating your Etsy account
...
[IMPORTANT]
.OAuth2 authentication will become mandatory
====
Due to a switch of the Etsy API, the new authentication method OAuth2 will replace the old authentication method in the near future. The expected date for the switch is 16 January 2023. We therefore recommend to already authenticate your Etsy account for OAuth2 now.
====
