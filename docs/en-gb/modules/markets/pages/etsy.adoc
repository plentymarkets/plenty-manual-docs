...
[IMPORTANT]
.Set up new event procedures for Etsy
====
Due to a necessary switch, the old event procedures for Etsy will no longer work after 16 January 2023. The event procedure listed below (*Send payment confirmation to Etsy (deprecated)*) will be replaced by the event procedure *Send payment confirmation to Etsy (new)*. As a preparation, we therefore recommend to already additionally set up the event procedure *Send payment confirmation to Etsy (new)* now. The old event procedure will work as usual until 16 January 2023.
====
...
| *Procedure*
| *Plugin > Send payment confirmation to Etsy (deprecated)*
|
|===
...
.Set up new event procedures for Etsy
====
Due to a necessary switch, the old event procedures for Etsy will no longer work after 16 January 2023. The event procedure listed below (*Send shipping confirmation to Etsy (deprecated)*) will be replaced by the event procedure *Send shipping confirmation to Etsy (new)*. As a preparation, we therefore recommend to already additionally set up the event procedure *Send shipping confirmation to Etsy (new)* now. The old event procedure will work as usual until 16 January 2023.
====
...
| *Procedure*
| *Plugin > Send shipping confirmation to Etsy (deprecated)*
|
|===
