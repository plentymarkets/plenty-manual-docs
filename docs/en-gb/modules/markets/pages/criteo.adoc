...
Criteo is a personalized retargeting company that works with Internet retailers to serve personalized online display advertisements to consumers who have previously visited the advertiser's website. In order to set up Criteo in plentymarkets, first register with link:https://www.criteo.com/[Criteo^].

[#old-export]
== _Alternative 1:_ Export format Criteo-Plugin _(deprecated)_
...
Visit the link:https://support.criteo.com/hc/en-us/articles/207571095-Criteo-Product-Feed-specification[Criteo website^] for additional information on the Criteo product feed specifications.
