...
The plentymarkets app includes an item search function, which is described on this page. First, xref:app:item-search.adoc#300[search for items] later.
...
| *Item label*
|Do you want to use the plentymarkets app to print item labels? Choose the xref:item:barcodes.adoc#800[item label that you’ve designed for this purpose]. +
...
Tap on the boxes (icon:cubes[role="blue"]) to see stock information. Then tap on the three dots (icon:ellipsis-h[role="blue"]) if you want to xref:app:item-search.adoc#400[print the item label].
====
...
The plentymarkets app includes a customer search function, which is described on this page. First, xref:app:item-search.adoc#700[search for customers] later.
...
Keep in mind that this area will only include information if you’ve saved xref:crm:managing-contacts.adoc#90[company information in the customer data record].
...
The plentymarkets app includes an order search function, which is described on this page. First, xref:app:item-search.adoc#1000[search for orders] later.
