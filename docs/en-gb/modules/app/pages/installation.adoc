...
include::partial$hardware-mobile-inventory.adoc[]
...
| *Visible functions*
|Which xref:app:functions.adoc#[app functions] should your employees see? Place check marks to specify which exact menus this back end user should see.
...
* The menu icon (icon:bars[role="blue"]) in the top left corner. Tap on this symbol to access the main menu. From here, you can view your <<app/functions/item-search#, item, customer and order data>>. You can use the app as an xref:app:warehouse-management.adoc#[inventory management system]. Or you can <<pos#, ring up customers in your brick and mortar store>>.
...
→ You will see a list of people who have xref:app:installation.adoc#900[an app PIN].
...
. Configure the settings as described in the xref:automation:installing-plentybase.adoc#[plentyBase documentation].
