...
* The menu icon (icon:bars[role="blue"]) in the top left corner. Tap on this symbol to access the main menu. From here, you can view your <<app/functions/item-search#, item, customer and order data>>. You can use the app as an xref:app:warehouse-management.adoc#[inventory management system]. Or you can xref:pos:pos.adoc#[ring up customers in your brick and mortar store].
