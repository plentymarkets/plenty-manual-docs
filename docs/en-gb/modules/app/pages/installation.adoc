...
→ You will remain logged in until you either xref:app:installation.adoc#1600[lock] your user account. That means that you can open and close the app without having to log in again.
...
* The menu icon (icon:bars[role="blue"]) in the top left corner. Tap on this symbol to access the main menu. From here, you can view your xref:app:warehouse-management.adoc#[inventory management system>>. Or you can <<pos#, ring up customers in your brick and mortar store].
...
* The user icon (icon:user[role="blue"]). This symbol shows who is currently logged in. Tap on this symbol to xref:app:installation.adoc#1500[log out of the app altogether]. +
