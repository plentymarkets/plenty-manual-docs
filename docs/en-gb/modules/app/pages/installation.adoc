...
Do all of your employees have a plentymarkets account? If not, log into your plentymarkets system and xref:business-decisions:user-accounts-access.adoc#10[create the necessary accounts].
...
* xref:business-decisions:user-accounts-access.adoc#190[Increase the user limit of your plentymarkets contract].
...
--
Make sure that you’ve correctly entered the xref:app:installation.adoc#1200[base URL for your plentymarkets system].
Enter the domain without https:// or http://. If you don’t know the URL, log into your plentysystems back end. Then, move the cursor over the shop symbol with your plentyID on the upper right. The URL is listed in the second line of the tooltip that is displayed. +
