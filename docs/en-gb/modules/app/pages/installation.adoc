...
Do all of your employees have a plentysystems account? If not, log into plentysystems and xref:business-decisions:user-accounts-access.adoc#07[create the necessary accounts].
