...
:description: In addition to using the functionality in the plentysystems back end, you can also take stock using the plentymarkets app. This page shows you how it’s done.
...
The stock information for storage location 1 in plentysystems is 10 x item A, 10 x item B and 2 x item C. During stocktaking, 10 x item A and 10 x item B is scanned. Item C is not scanned. +
