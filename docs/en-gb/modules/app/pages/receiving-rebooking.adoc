...
. Click on *Rights*.
. Activate (icon:check-square[role="blue"]) the options *Mobile » Incoming items » Edit* and *Mobile » Incoming items » See*.
...
. Open the desired role.
. Click on *Rights*.
. Activate (icon:check-square[role="blue"]) the option *Mobile » Rebooking » See*.
. *Save* (icon:save[role="green"]) the settings.
