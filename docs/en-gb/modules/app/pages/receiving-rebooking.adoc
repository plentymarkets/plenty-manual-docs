...
Did you know that you can not only book in and redistribute items in the xref:app:working-with-redistributions.adoc#[plentymarkets back end], but also in the plentymarkets app?
