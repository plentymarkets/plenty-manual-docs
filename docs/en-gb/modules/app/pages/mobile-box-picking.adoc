...
====
*Admin* roles and the accounts linked to them are allowed to work with any function. You do not need to make any changes to their account settings. All other accounts do not automatically have rights.
====
