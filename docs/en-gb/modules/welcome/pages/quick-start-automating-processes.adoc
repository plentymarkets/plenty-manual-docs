...
:keywords: set up automation, procedure manager, processes, automatically sending emails
:author: team-docs-automation
:description: Learn how to automate processes via event procedures and processes.
