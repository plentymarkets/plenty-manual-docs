...
* *Setup* = This menu is where you configure the tools and functions in your plentymarkets system. Take a look at our xref:welcome:quick-start.adoc#[quick start]. These resources are designed help new users set up their systems.
