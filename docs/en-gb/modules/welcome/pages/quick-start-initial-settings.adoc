...
For further information about template variables, refer to the chapters <<welcome/quick-start/quick-start-initial-settings#600, Example: Customising the email template>> and xref:welcome:quick-start-initial-settings.adoc#700[Inserting template variables and template functions] further down on this page.
