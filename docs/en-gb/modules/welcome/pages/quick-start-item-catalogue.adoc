...
* xref:item:managing-items.adoc#155[Editing multiple items]
* xref:item:managing-items.adoc#330[Editing multiple variations]
* xref:item:combining-products.adoc#[Managing multipacks, item bundles and sets]
...
TIP: Continue with xref:welcome:quick-start-stock.adoc#[Booking stock].
