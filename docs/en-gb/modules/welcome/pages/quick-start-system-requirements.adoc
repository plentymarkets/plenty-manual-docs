...
In addition, the xref:stock-management:plentywarehouse.adoc#[plentyWarehouse app (beta)] is available. It contains up-to-date and improved functions for mobile stock management. 
