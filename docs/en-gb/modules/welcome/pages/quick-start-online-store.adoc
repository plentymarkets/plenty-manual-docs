...
Set up a default country of delivery, a default shipping method, a default shipping profile and a default payment method. These are preselected for non-registered visitors of your webshop. You can only use *plugin payment methods* in your plentyShop LTS webshop, which you can download from the link:https://marketplace.plentymarkets.com/plugins/payment[plentyMarketplace^].
...
The *Automatic despatch* step of the *Email accounts* assistant contains various events you can link with an email template. You can find the assistant in the *Setup » Client » Global » Email accounts* menu. Select the email template that you have previously created in the *Setup » Client » [Select client] » Email » Templates* or *CRM » EmailBuilder* menu from the drop-down list. This ensures that the email template is automatically sent to your customer once the event occurs.
...
. In the *Automatic despatch* step in the row of the event, select the email template that you previously set up from the drop-down list. Pay attention to the information given in <<table-events-automatic-emails>>.
. Finalise the assistant.

[[table-events-automatic-emails]]
.Explanations for several events in the *Setup » Client » Global » Email accounts* » Assistant: *Email accounts* » Step: *Automatic despatch* menu
[cols="1,3"]
|====
|Setting |Explanation
...
| *Item name*
| *Select Name 1*, *Name 2* or *Name 3*. Texts for these fields are saved in the xref:item:import-export-create-directory.adoc#50[texts] tab of the item. If you select *Name 2* or *Name 3*, but did not save a name in the text field, *Name 1* will be used as item name.
...
* Store specials: lists with new items, special offers, etc. are integrated into plentyShop LTS via *tags*. For further information, refer to the xref:item:flags.adoc#600[Adding tags to items] chapter of the manual.
...
*Item ID* = Activate to display the item's ID. +
*Item text* = Activate to display the item description. The item description will not be displayed if you did not enter an *item text* in the item’s xref:item:import-export-create-directory.adoc#50[texts] tab. +
...
. Place the widget you want to include on your homepage by dragging it onto the preview area of the editor. Pay attention to the information given in <<table-elements-shop-builder>>.
. *Save* the settings.
...
| *Tabs*
|Provides a structure widget for grouping widgets as tabs. Click *Edit* to change the <<260, colour>> of the widget, add *new tabs* to the widget and to change the titles of the tabs.
...
|Provides an overview over the items in the shopping cart. Click *Edit* to select the <<#260, appearance>> of the widget.

| *Coupon input*
|Provides the input field for customers to redeem their coupon codes. Click *Edit* to select the <<#260, appearance>> of the widget.
...
| *Account settings*
|Provides a widget with which customers can change their email address and their password. Click *Edit* to change the <<#260, appearance>> of the buttons and enter  *Text* you want to display between the widget title and the account settings.

| *Bank details*
|Provides a widget with which customers can add and edit their bank details. Click *Edit* to change the <<#260, appearance>> of the button and enter a *Text* you want to display between the widget title and the bank details.

| *Order history*
|Provides a list of past orders of your customers. The order history contains information pertaining to the *order ID*, the *totals*, the *order date*, the *shipping date*, and the *status*. Click *Edit* to change the <<#260, appearance>> of the widget and enter a *Text* you want to display between the widget title and the order history. You can also determine how many *orders per page* are displayed, if you want to *allow customers to change the payment method* and if you want to *allow returns*. This widget is limited to 1 per page.

| *Return history*
|Provides a list of past returns of your customers. The return history includes information pertaining to the *return ID*, the *order ID*, the *return date* and the *payment method*. Customers can download relevant files, such as the order confirmation, in the column *return documents*. Click *Edit* to change the <<#260, appearance>> of the widget and enter a *Text* you want to display between the widget title and the return history. This widget is limited to 1 per page.

| *Logout button*
|Provides the button with which your customers can log out from your webshop. Click *Edit* to determine the <<#260, colour>> of the *logout *button and the *button size*.
...
TIP: Continue to xref:welcome:quick-start-preparing-order-processing.adoc#[preparing order processing].
