...
The *Automatic despatch* step of the *Email accounts* assistant contains various events you can link with an email template. You can find the assistant in the *Setup » Assistants » Basic setup* menu. Select the email template that you have previously created in the *Setup » Client » [Select client] » Email » Templates* or *CRM » EmailBuilder* menu from the drop-down list. This ensures that the email template is automatically sent to your customer once the event occurs.
...
.Explanations for several events in the *Setup » Assistants » Basic setup* » Assistant: *Email accounts* » Step: *Automatic despatch* menu
[cols="1,3"]
|====
|Setting |Explanation
