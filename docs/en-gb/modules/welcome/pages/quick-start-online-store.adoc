...
. In the row of the event, select the email template that you previously set up from the drop-down list. Pay attention to the information given in <<table-events-automatic-emails>>.
. *Save* the settings.
