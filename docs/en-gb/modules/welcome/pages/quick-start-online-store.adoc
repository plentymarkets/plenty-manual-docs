...
IMPORTANT: Have you already booked stock? Not yet? Return to xref:welcome:quick-start-booking-stock.adoc#[Booking stock].
...
| *Item name*
| *Select Name 1*, *Name 2* or *Name 3*. Texts for these fields are saved in the xref:item:managing-items.adoc#50[Texts] tab of the item. If you select *Name 2* or *Name 3*, but did not save a name in the text field, *Name 1* will be used as item name.
...
* Store specials: lists with new items, special offers, etc. are integrated into plentyShop LTS via *tags*. For further information, refer to the xref:item:managing-items.adoc#150[Adding tags to items] chapter of the manual.
...
*Item ID* = Activate to display the item's ID. +
*Item text* = Activate to display the item description. The item description will not be displayed if you did not enter an *item text* in the item’s xref:item:managing-items.adoc#50[texts] tab. +
...
* xref:online-store:best-practices.adoc#[plentyShop LTS Best Practices]


TIP: Continue to xref:welcome:quick-start-order-processing.adoc#[preparing order processing].
