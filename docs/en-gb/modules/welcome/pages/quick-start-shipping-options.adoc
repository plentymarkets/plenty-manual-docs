...
For further information, refer to the xref:fulfilment:plugin-dhl-shipping-versenden.adoc#[*DHL Shipping (Versenden)* page]. In the user guide, all settings are described that you need to carry out in order to send your items via the interface for DHL Shipping.
