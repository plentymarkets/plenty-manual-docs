...
|The xref:online-store:web-design.adoc#[store CSS] will be loaded in the editor.

| *Standard*
|A simple standard CSS will be loaded in the editor. The background colour is white.

| *User-defined*
|The simple standard CSS will be displayed in an editing window and can be customised with the xref:online-store:cms-syntax.adoc#[syntax editor]. +
