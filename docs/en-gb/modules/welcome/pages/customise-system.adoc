...
In the *General* tab you reset user specific configurations. For more information see <<#table-general>>.

[.instruction]
Carrying out general settings:

. Hover your cursor at the plentymarkets logo at the top left of the screen. +
→ a dropdown menu expands.
. Click on *Personal settings*. +
→ The personal settings opens in the *Shortcuts* tab.
. Click on the *General* tab.
. Carry out the settings. See <<#table-general>>.
. *Save* (material:save[]) the settings.
...
. Click on *Personal settings*. +
→ The personal settings opens in the *Shortcuts* tab.
. Carry out the settings. See <<#tabelle-shortcuts>>
. *Save* (material:save[]) the settings.
...
Users without *Administrator* rights can only access limited areas and menus in the plentymarkets back end. Thus, their access to the system is limited. Should a coworker see the menu *plentymarkets Logo (Start) » Tasks* a person with *Administrator* rights needs to assign a fitting role.
...
[discrete]
[#260]
=== Assigning user rights for standard users

Users without *Administrator* rights can only access limited areas and menus in the plentymarkets back end. Thus, their access to the system is limited. If users of this type should be able to see the *plentymarkets logo (Start) » Calendar* menu, a user of the type *Administrator* has to assign a role with the activated visibility *Start » Calendar* to the standard user.

[.instruction]
Assigning roles to standard users:

. Open the menu  *Setup » Account management » Accounts*.
. Use the search function (material:search[]) and open the account that should be edited.
. Assign the appropriate role under *Assigned roles*. +
→ Or: create a role with *Start » Calendar* visibility in the simple mode in before.
. *Save* (material:save[]) the settings.
...
Proceed as described below to create an appointment. Depending on your access rights that are set according to <<#table-create-appointment>>, you can also create appointments for other users. You can only create appointments for users for which you have write permissions. You cannot select users for which you do not have write permissions.
...
The option *Calendar* has to be activated in the *Owner* tab of the user account. You need to know the settings for the user in order to carry out the configuration. The settings are saved in the user's *Calendar* tab.
