...
For further information about creating event procedures, refer to the chapter xref:crm:using-the-ticket-system.adoc#2900[Automatically sending email template] on the xref:crm:using-the-ticket-system.adoc#[Ticket system] page of the manual.