...
Events with the severities *Error*, *Critical*, *Alert* and *Emergency* are logged automatically. You can activate logging of other events for a limited time if and needed.
