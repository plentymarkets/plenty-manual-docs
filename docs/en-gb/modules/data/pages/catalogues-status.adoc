...
* *User* = The export was started by a user. Point your cursor to the name of the user to also show the user ID.
* *Cron* = The export was automatically started by a cron.
