...
| *Main warehouse ID*
|
include::item:partial$main-warehouse.adoc[tag=catalogue-id]

| *Main warehouse name*
|
include::item:partial$main-warehouse.adoc[tag=catalogue-name]
...
| *Pallet type ID*
|
include::item:partial$pallet-type.adoc[tag=catalogue-id]

| *Pallet type name*
|
include::item:partial$pallet-type.adoc[tag=catalogue-name]
...
|The UUID of the xref:item:prices.adoc#1000[price calculation] that is linked to the variation.
...
| *Vat*
|
include::item:partial$vat.adoc[tag=catalogue-name]

| *VAT ID*
|
include::item:partial$vat.adoc[tag=catalogue-id]
...
| *Referrer ID*
|
Specifies the IDs of the sales channels that the variation is linked to.
You can find the list of order referrer IDs in the menu *Setup » Orders » Order referrer*.

Corresponds to the option in the menu: xref:item:directory.adoc#280[Item » Items » [Open variation\] » Element: Sales channels]
...
The timestamps indicate when specific events occurred.
For example:
...
| *Tag Id*
|
Specifies the IDs of the tags that are linked to the variation.
You can find the list of tag IDs in the menu *Setup » Settings » Tags*.

Corresponds to the option in the menu: xref:item:directory.adoc#210[Item » Items » [Open variation\] » Element: Tags]
...
Further information about xref:item:inheritance.adoc#[inheritance].
