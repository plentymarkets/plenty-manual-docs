...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: MOIN » Column: Value]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: MOIN » Column: Country]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: MOIN » Column: ID]

| *Link position*
|
The position of the MOIN.

Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: MOIN » Column: Position]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ePID » Column: Value]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ePID » Column: Country]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ePID » Column: ID]

| *Link position*
|
The position of the ePID.

Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ePID » Column: Position]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ASIN » Column: Value]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ASIN » Column: Country]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ASIN » Column: ID]

| *Link position*
|
The position of the ASIN.

Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#260[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN » Type: ASIN » Column: Position]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#250[Item » Items » [Open variation\] » Element: Barcodes » Column: Code]

| *Barcode name*
|
The name of the barcode.

Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#250[Item » Items » [Open variation\] » Element: Barcodes » Column: Name]
...
Corresponds to the option in the menu: xref:item:import-export-create-directory.adoc#250[Item » Items » [Open variation\] » Element: Barcodes]
...
Corresponds to the option in the menu: *Item » Items » [Open variation\] » Element: SKU*
...
This causes the actual monetary price, which is saved in the variation data record, to be exported.
...
It's calculated based on the item's content, unit and price.
...
Limits the export to items that are available for _at least one_ of these markets.
...
Limits the export to variations with one of these availability levels.
...
Limits the export to items with this Amazon product type.
...
Limits the export to variations that are linked to _all_ of these categories.
...
Limits the export to variations that are linked to _at least one_ of these categories.
...
Limits the export to items that were manufactured by one of these companies.

|[#intable-market-and]*Visible for markets*
|Select one or more marketplaces from the drop-down list.
Limits the export to items that are available for _all_ of these markets.
...
Limits the export to variations that are available for _at least one_ of the selected clients.
...
|Select one or more clients from the drop-down list.
Limits the export to variations that are available for _all_ of these clients.
