...
//This folder corresponds to the country option *All* in the menu *Item » Item UI » [Open variation] » Element: ASIN/ePID/MOIN*.
====
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#230[Item » Item UI » [Open variation\] » Element: ASIN/ePID/MOIN]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#260[Item » Item UI » [Open variation\] » Element: Barcodes]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#240[Item » Item UI » [Open variation\] » Element: SKU]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#30[Item » Item UI » [Open item\] » Stock » Column: Physical stock]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#30[Item » Item UI » [Open item\] » Stock » Column: Net stock]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#30[Item » Item UI » [Open item\] » Stock » Column: Reserved stock]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#30[Item » Item UI » [Open item\] » Stock » Column: Reorder level Δ]
...
//ToDo - neue Artikel-UI
//Since no value is entered into the menu *Item » Item UI » [Open variation] » Properties*, no value is exported.
...
//ToDo - neue Artikel-UI
//The value saved in the menu *Item » Item UI » [Open variation] » Properties » Column: Value* will be exported.

| *HTML*; +
*Text*
|The text saved in the menu *Item » Edit item » [Open variation] » Tab: Texts* will be exported.
//ToDo - neue Artikel-UI
//The text saved in the menu *Item » Item UI » [Open variation] » Properties* will be exported.
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#40[Item » Item UI » [Open item\] » Images » Details » Entry field: Position]
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#340[Item » Item UI » [Open variation\] » Element: Sales prices]
