...
//This folder corresponds to the country option *All* in the menu *Item » Items » [Open variation] » Element: ASIN/ePID/MOIN*.
====
...
//ToDo - neue Artikel-UI
//Corresponds to the option in the menu: xref:item:directory.adoc#230[Item » Items » [Open variation\] » Element: ASIN/ePID/MOIN]
