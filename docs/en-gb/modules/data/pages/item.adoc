...
Corresponds to the option in the menu: <<item/managing-items#260, Item » Edit item » [Open variation] » Tab: Settings » Area: ASIN/ePID/MOIN>>
...
Corresponds to the option in the menu: <<item/managing-items#250, Item » Edit item » [Open variation] » Tab: Settings » Area: Barcode>>
...
Possible workaround: Export the data with the tools xref:data:item.adoc#1200[FormatDesigner] and xref:data:elastic-export.adoc#700[Elastic Export] instead.
...
Corresponds to the option in the menu: <<item/settings/categories#800, Item » Category » [Open category] » Tab: Description 1>>
...
Corresponds to the option in the menu: <<item/managing-items#370, Item » Edit item » [Open variation] » Tab: Availability » Area: SKU>>
...
Corresponds to the option in the menu: <<item/managing-items#95, Item » Edit item » [Open item] » Tab: Stock » Column: Phy>>
...
Corresponds to the option in the menu: <<item/managing-items#95, Item » Edit item » [Open item] » Tab: Stock » Column: Net>>
...
Corresponds to the option in the menu: <<item/managing-items#95, Item » Edit item » [Open item] » Tab: Stock » Column: RS>>
...
Corresponds to the option in the menu: <<item/managing-items#95, Item » Edit item » [Open item] » Tab: Stock » Column: RLΔ>>
...
| *Is main variation*
|Indicates whether the variation is a xref:item:structure.adoc#600[main variation].
...
|Specifies the ID of the corresponding xref:item:structure.adoc#600[main variation].
...
We recommend using the data field <<data/exporting-data/catalogues-item#140, Shipping costs » Net>> instead.
...
. Save (icon:save[set=plenty]) the settings and download the file (icon:file_download[set=material]).
...
Export the data with the tools xref:data:item.adoc#1600[FormatDesigner] and xref:data:elastic-export.adoc#700[Elastic Export] instead.
|====
...
Corresponds to the option in the menu: <<item/managing-items#90, Item » Edit item » [Open item] » Tab: Images » Option: Position>>
...
We recommend using this field over the field <<data/exporting-data/catalogues-item#110, Variation » Default shipping costs>>.
...
This folder lists the xref:item:prices.adoc#[sales prices] that you’ve already configured in the menu *Setup » Item » Sales prices*.
When you add a sales price to the catalogue, xref:item:managing-items.adoc#240[the actual monetary price], which is saved in the variation data record, will be exported.

Corresponds to the option in the menu: <<item/managing-items#240, Item » Edit item » [Open variation] » Tab: Settings » Area: Sales prices>>
...
|Limits the export to variations that are either the xref:item:structure.adoc#600[main variation] or a sub-variation.
