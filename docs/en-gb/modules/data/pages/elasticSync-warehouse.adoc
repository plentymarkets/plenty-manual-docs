...
====
Now and then, the data of storage locations has to be adjusted. How to export warehouse data, adjust the data accordingly and import it back into the system is explained step by step in <<data/importing-data/elasticsync-best-practices/best-practices-elasticsync-storage-locations#, this practical example>>.
====
...
For further information on the terms dimensions, levels and storage locations, refer to the link:https://knowledge.plentymarkets.com/en/stock-management/setting-up-a-warehouse[Setting up a warehouse^]{nbsp}icon:external-link[] page of the manual.
...
You can find the result of the import in the back end menu: <<stock-management/setting-up-a-warehouse#1500, Setup » Stock » Warehouse » [select warehouse] » Storage locations>>.
...
|`box`
|box (for <<app/functions/warehouse-management/mobile-box-picking#, mobile box picking>>)
|====

You can find the result of the import in the back end menu: <<stock-management/setting-up-a-warehouse#intable-purpose, Setup » Stock » Warehouse » [select warehouse] » Storage locations>>.
...
You can find the result of the import in the back end menu: <<stock-management/setting-up-a-warehouse#intable-status, Setup » Stock » Warehouse » [select warehouse] » Storage locations>>.
...
You can find the result of the import in the back end menu: <<stock-management/setting-up-a-warehouse#100, Setup » Stock » Warehouse » [select warehouse] » Storage locations>>.
...
You can find the result of the import in the back end menu: <<stock-management/new-incoming-items#intable-storage-location-type, Item » Edit item » [open item] » Tab: ID of a variation » Tab: Warehouse » column: Storage location type>>.
...
You can find the result of the import in the back end menu: <<stock-management/setting-up-a-warehouse#intable-notes, Setup » Stock » Warehouse » [select warehouse] » Storage locations » [select storage location]>>.
