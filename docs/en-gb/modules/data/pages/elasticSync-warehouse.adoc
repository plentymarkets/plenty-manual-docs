...
You can find the result of the import in the back end menu: xref:stock-management:new-incoming-items.adoc#intable-storage-location-type[Item » Edit item » [open item] » Tab: ID of a variation » Tab: Warehouse » column: Storage location type].
