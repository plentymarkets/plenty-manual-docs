...
28 order statuses are set in the system but you can define additional statuses. Available for this are 19 statuses with 4 decimal places each. Go to the *Setup » Orders » Order status* menu to edit the statuses For more information go to the section xref:orders:order-statuses.adoc#[Using order statuses] of the manual.
