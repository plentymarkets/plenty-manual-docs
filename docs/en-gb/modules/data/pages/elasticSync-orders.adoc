...
This option is useful if you want to _update existing orders_. +
...
|*Order item*
| Which column of your CSV file lists the order items? Choose this column here. Then select what exactly it is about. You can choose between *Order item IDs*, *External item IDs* or *External token IDs*.
|===
...
|Setting |Explanation
|*Variation*
| Which column of your CSV file lists the variation IDs? Choose this column here. Then select what exactly it is about. Then select whether your CSV file contains *Marketplace SKUs*, *External variation IDs*, *Variation numbers*, *Manufacturer variation number*, *Barcode: GTIN 13*, *Barcode: GTIN 128*, *Barcode: UPC* or *Barcode: ISBN*. +
If you choose this matching field, the information stored in the system about this variation is loaded and added to the order. In this way, data is supplemented.
|===
...
This links the tag to the order.
...
You can find the result of the import in the backend in the menu *Orders » Orders (Test phase) » [Open order] » Status and tags* .
...
You can find the result of the import in the back end menu *Orders » Edit orders » _open order_ » tab: Settings » field: Status* as well as in the order overview.

[#2060]
==== Owner ID (plentymarkets user ID)

To which owner should the order be assigned? Enter the owner ID into your CSV file. +
You can find the owner IDs in the back end menu *Setup » Settings » User » Accounts*. Make sure that the assigned owner has the required user rights for the area *Orders*.
...
You can find the plentyID of the client in the *Setup » plentyShop » (Select client) » Client Settings* menu.
...
It is assumed by default that the name is entered in the system language. You can assign names to items in the *Item » [Open item] » Item tab: Texts » Field: Name*.

*_Default value_*: No default value

*_Permitted import values_*: Alpha-numeric

You can find the result of the import in the order items table in the back end menu *Orders » Edit orders » [Open order] » Tab: Overview* in the *Item table* and in the order overview.
...
You can find the result of the import  in the back end menu *Orders » Edit orders » [Open order] » Tab: Settings » Field: Currency* as well as in the order overview.
...
You can find the result of the import  in the back end menu in the order items table in the *Orders » Edit orders* menu.The total gross value is displayed in the *Orders » Edit orders » Tab: Overview » Field: Net value of items* menu.
...
Is there a percentual discount for the order item? Then enter 1 into your CSV file. If there is no percentual rebate, enter 0 into your CSV file.

*_Default value_*: No default value

You can find the result of the import

 in the back end menu in the order items table in the *Orders » Edit orders* menu.[#2300]
...
You can find the address ID in the menu *CRM » Contacts » [Open contact] » area: Details » Field: addresses* If you want to import a new address, use the mapping fields for xref:data:elasticSync-orders.adoc#2420[Address].
...
Enter the surname of the contact you want to assign to the order into your CSV file. Select in the mapping whether this is the *Invoice address* or the *Delivery address*.
...
Enter the postal code of the contact you want to assign to the order into your CSV file. Select in the mapping whether this is the *Invoice address* or the *Delivery address*.
...
The list of all countries for which states/provinces are available, including the IDs of the states/provinces: link:https://cdn02.plentymarkets.com/pmsbpnokwu6a/frontend/ElasticSync_BestPractice/Allgemein/Bundeslaender-Bundesstaaten-Provinzen.pdf[PDF file including a list of states and provinces]
...
You can find the pallet ID in the back end menu *Orders » Package content list*.
...
Decide, whether the shipping package is closed or not. Select in the mapping what kind of shipping package it is.
...
In this example CSV file, you can see the order item in the first row. The order property can be seen in the second line. +
