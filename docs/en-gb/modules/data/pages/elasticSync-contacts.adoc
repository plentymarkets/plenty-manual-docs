...
:description: Import tool: Contacts, companies and addresses can be imported in plentymarkets. This page serves as a reference and lists the available matching and mapping fields.
:author: team-crm
...
[TIP]
xref:data:internal-IDs.adoc#40[This page of the manual] lists the ISO codes used in plentymarkets.
