...
:description: Import tool: Contacts, companies and addresses can be imported in plentymarkets. This page serves a reference and lists the available matching and mapping fields.
:author: team-crm
