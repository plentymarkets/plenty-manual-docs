...
:position: 400
:url: data/exporting-data/catalogues-stock-movements
:id: JJUAVGJ
:author: team-stock
...
In order to only export specific stock movement data, you can select filters and thus narrow down the data. How to add filters is described in xref:data:managing-catalogues.adoc#257[this chapter].
