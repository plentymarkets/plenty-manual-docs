...
:description: Older systems have an FTP server, which can be used to make images accessible in the online store. This page teaches you how to set up FTP access.
:author: team-cloud
