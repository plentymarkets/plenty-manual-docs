...
* If variation data is imported with variation IDs that do not yet exist in plentysystems, then new variations will be created with these variation IDs.
...
The 1:n problem, i.e. one to n, occurs when several characteristics were defined for one variation. The following characteristics can be allocated to a variation multiple times in plentysystems:
