...
NOTE: However, not all types of data can currently be exported using catalogues. Until standard formats are available for all types of data, you can still use the xref:data:FormatDesigner.adoc#[ Formatdesigner].
 ...
 *_Note_*: xref:data:catalogue-formats.adoc#[Available format types]
