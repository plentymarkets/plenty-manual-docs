...
* <<#optional-recalculate, Recalculate numerical values during export (material:calculate[] *Formula*)>>
...
→ The catalogue overview opens.
. Open the catalogue.
. In the navigation to the left, click on *Filter* (material:filter_alt[]). +
