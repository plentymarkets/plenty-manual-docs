...
| *Active*
|Limits the export to variations that are either xref:item:import-export-create-directory.adoc#intable-active[active or inactive].
...
| *Client*
|Limits the export to items that are available for a specific client.
...
| *Image*
|Limits the export to items, which have xref:item:import-export-create-directory.html#90[an image saved] for them.

| *Item type*
|Limits the export to a specific xref:item:new-item.adoc#intable-type[type of item].

| *Manufacturer*
|Limits the export to items that were xref:item:manufacturers.adoc#[manufactured by a specific company].

| *Markets*
|Limits the export to items that are available for xref:item:import-export-create-directory.adoc#45[a specific market].
...
| *Prices*
a|Limits the export to items with xref:item:import-export-create-directory.html#240[a specific price].
...
|*Order status*
|Limits the export to orders with the selected xref:orders:order-statuses.adoc#[order statuses].
...
| *Change order status*
|If a status is selected, then all of the exported orders will be changed to this xref:orders:order-statuses.adoc#[order status].
|====
...
|*Order status*
|Limits the export to purchase orders with the selected xref:orders:order-statuses.adoc#[order statuses].
_This filter is a required field._
...
|*Order status*
|Limits the export to order items of orders with the selected xref:orders:order-statuses.adoc#[order statuses].
_This filter is a required field._
