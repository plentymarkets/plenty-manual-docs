...
This page of the manual lists practical examples on how to create a catalogue for the export of orders and order items. If you are not yet familiar with the catalogues, refer to the manual page xref:data:managing-catalogues.adoc#[Managing catalogues] first. There, you get all the general information you need for creating and managing catalogues.
...
While you're at it, also check the xref:data:managing-catalogues.adoc#260[catalogue export] into your workflow.
...
If needed, change the xref:data:managing-catalogues.adoc#162[Export keys]. Save (icon:save[set=material]) the catalogue after you added the data fields.
...
When you are done with all the changes and saving the catalogue, you can use the xref:data:managing-catalogues.adoc#260[export].
