...
:description: Facets and facet values can be imported into plentymarkets. This page serves as a reference and lists the available matching and mapping fields.
:author: team-item
