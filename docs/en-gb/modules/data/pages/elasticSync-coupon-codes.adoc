...
:description: Import tool: Coupon codes can be imported in plentymarkets. This page serves as a reference and lists the available matching and mapping fields.
:author: team-crm
