...
You can find the result of the import in the back end menu xref:stock-management:managing-incoming-items.adoc#500[Stock » Incoming items » [Open incoming items data record\] » Tab: Item].
