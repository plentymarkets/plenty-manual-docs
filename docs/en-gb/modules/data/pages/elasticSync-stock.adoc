...
You can find the result of the import in the back end menu xref:stock-management:managing-incoming-items.adoc#500[Stock » Incoming items » [perform search] » [select incoming items data record] » tab: Item].
