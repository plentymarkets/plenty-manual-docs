...
:position: 60
:url: data/exporting-data/FormatDesigner/format-types/purchase-order
...
This is only a reference page and presumes that you already have basic knowledge about the xref:data:elastic-export.adoc#[Elastic export].
