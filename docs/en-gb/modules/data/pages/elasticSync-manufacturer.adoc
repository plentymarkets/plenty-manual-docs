...
:description: Manufacturer data records can be imported into plentymarkets. This page serves as a reference and lists the available matching and mapping fields.
:author: team-item
...
====
Imagine you’re new to plentymarkets and you want to import all of your manufacturer data at once. How would that work? Take a look at ##xref:data:best-practices-elasticsync-categories.adoc#[this practical example]##, which guides you through the process step-by-step.
====
////
