...
Use the marketplace formats of the catalogue to export variation and stock information to markets and price portals.
...
include::partial$catalogues-first-contact.adoc[]
...
include::page$exporting-standard-formats.adoc[tag=table-format-settings]

2+^| Export settings

include::page$exporting-standard-formats.adoc[tag=table-export-settings]
|====
