...
Use the marketplace formats of the catalogue to export variation and stock information to many markets and price portals.plentymarkets is working on moving all markets to catalogue formats.

On this page, find out how to use catalogues to export variation data to markets. Only the general workflow is explained.

More detailed information about how you create an structure a catalogue can be found on the manual pages of the individual xref:markets:markets.adoc#[markets].
...
[#properties]
=== Excursion: Properties instead of characteristics
...
== Switching from old exports to catalogue export

For some markets, you can either use an old export or a catalogue format. Find out how to switch here.

. Analyse which characteristics and free text fields you currently use for exporting data to the market. Characteristics and free text fields cannot be used for the catalogue export. So create properties for all data that you still need. +
...
--
 
Regularly occuring file export::
+
--
