...
//https://dev.azure.com/plentymarkets/plentymarkets/_boards/board/t/CRM%20and%20Goods%20-%20PIM%20Stock/Backlog%20items/?workitem=5794
...
* xref:data:managing-catalogues.adoc#260[Further information about the export]
* xref:data:managing-catalogues.adoc#255[Alternative: Export a preview]
