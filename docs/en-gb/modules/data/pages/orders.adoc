...
|methodofPaymentId
|ID of the payment method as described on the <<data/internal-IDs#65, Internal IDs in plentymarkets>> manual page.
...
|typeID
|ID of the order type as described on the <<data/internal-IDs#80, Internal IDs in plentymarkets>> manual page.
