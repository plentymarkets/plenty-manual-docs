...
Use xref:data:managing-catalogues.adoc#40[catalogues with marketplace formats] to export variation data to markets and other sales channels. Currently, you can use catalogues to transfer data to the markets Etsy, Metro, OTTO Market and Amazon.

| *Default formats*
| You want to export specific data such as order or item data from your plentymarkets system? Use xref:data:managing-catalogues.adoc#110[catalogues with a standard format] to export such data. +
*_Note_*: The standard formats will be transferred to the catalogue step by step. At the moment, the formats xref:data:catalogues-warehouses.adoc#[Warehouses] are available.
|====
...
xref:item:properties.adoc#500[Properties of the Item section] allow you to save data for variations for which no default data fields are available in the plentymarkets back end. In the following, you will find some examples on how to use properties.
...
* *Navigation*: Here you can switch between the different sections. Access the xref:data:managing-catalogues.adoc#257[filters] in order to narrow down data.
...
* *Mapped plentymarkets data fields*: Shows all data fields that have been mapped to the data fields of the marketplace for the export. Furthermore, you can add xref:data:managing-catalogues.adoc#80[fallback data fields] that are exported in case the mapped data field could not be found or is empty.
//end::catalogue-menu[]
...
image::data:combined-mappings.png[]
...
xref:data:catalogues-item.adoc#[This page] provides information about the plentymarkets data fields and how to use them.
 ...
 *_Note_*: At the moment, the formats xref:data:catalogues-warehouses.adoc#[Warehouses] are available.
