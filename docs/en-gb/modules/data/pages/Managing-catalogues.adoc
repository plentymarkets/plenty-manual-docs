...
* *_You want to export item data to markets?_*
  ** To do so, you need a catalogue with marketplace formats. An introduction to marketplace formats lives on the manual page xref:data:marketplace-export.adoc#[Catalogues: Marketplace export].
  ** Check out the xref:markets:markets.adoc#[manual pages for a sales channel] to find out how to create catalogues for individual markets.
