...
.What is a source?
--
In CSV files, each column is a source. TXT files are structured differently. However, it's easier to also imagine the data in TXT files as columns.
--
...
*_Important:_* When you cancel a running import, the records that were already imported are not deleted. If necessary, delete these records yourself.

[tabs]
====
Cancelling an asynchronous import::
+
--
