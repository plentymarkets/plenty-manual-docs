...
! *FTP*
!  *_Important:_* Since 21/07/2022, plentymarkets FTP servers are no longer supported. As such, only use this option if the import file is saved on an external FTP server.
