...
material:check_box_outline_blank[] = All data of the file is reimported during the import process. +
...
! *FTP*
! *_From 21.07.2022, plentymarkets FTP servers will no longer be supported._* +

However, you can still use your own FTP servers. As such, only use this option if you have your own FTP server.
...
. Click on *Add mapping* (material:add[role=green]). +
...
. In the *File name* column, click on *Upload file* (material:upload[]). +
...
. In the row of the backup that you want to import, click on *Restore backup* (material:open_in_browser[]) on the right. +
...
At the top left of the toolbar, click on *Status* (material:playlist_play[]).
. Click on the import. +
→ The detail view opens.
