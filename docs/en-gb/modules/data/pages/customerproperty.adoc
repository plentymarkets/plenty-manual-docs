...
The data format *CustomerProperty* is used to export the customer properties saved in the xref:crm:managing-contacts.adoc#4000[Setup » CRM » Properties] menu. Create and export the data format in the *Data » Dynamic export* menu. The xref:data:exporting-data.adoc#[Exporting data] page of the manual describes how you export the data format.
