...
This manual page explains the first step. Here you'll learn how to xref:data:FormatDesigner.adoc#100[create data formats>> and <<data/exporting-data/FormatDesigner/format-types# which types of data] you can export.
