...
:description: FormatDesigner: Learn how to set up the FormatDesigner plugin einrichtest, how to create data formats and the data you can export.
:author: team-plenty-channel

include::partial$formatdesigner-export-intro.adoc[]

This manual page explains the first step. Here you'll learn how to xref:data:FormatDesigner.adoc#50[set up the FormatDesigner plugin], how to xref:data:FormatDesigner.adoc#100[create data formats] and xref:data:format-types.adoc#[which types of data] you can export.

The second step, i.e. the actual export, is done in the menu *Data » Elastic export*. You can find further information about the second step on the xref:data:elastic-export.adoc#[elastic export] manual page.
...
Refer to the xref:plugins:plugins.adoc#[plugin chapter] for basic information about adding plugins to your plentymarkets system.
...
To familiarise yourself with the use of the FormatDesigner, see the practical example xref:data:best-practices-elasticexport-dropshipping.adoc#[Drop shipping and Elastic export].
