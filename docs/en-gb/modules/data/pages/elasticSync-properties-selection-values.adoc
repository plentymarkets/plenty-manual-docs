...
:description: Do you have properties of the type Selection or Multi-selection? The unique thing about these two property types is that they have individual values that are available for selection. Such selection values can be imported into plentysystems. This page serves as a reference and lists the available matching and mapping fields.
:author: team-item
...
This field tells plentysystems which property the values are being created for.
...
This field tells plentysystems which selection value the names are being deleted for.
