...
You can find the result of the import in the back end menu: <<markets/ebay/ebay-setup#1600, Setup » Markets » eBay » Parts compatibility listing »  parts compatibility listing\] » Area: List »  list\] » Column: K-Type-No.>>
