...
You can find the result of the import in the back end menu: xref:markets:ebay-setup.adoc#1600[Setup » Markets » eBay » Parts compatibility listing » [Open parts compatibility listing] » Area: Basic settings » Setting: eBay platform]
...
You can find the result of the import in the back end menu: xref:markets:ebay-setup.adoc#1600[Setup » Markets » eBay » Parts compatibility listing » [Open parts compatibility listing] » Area: Basic settings » Setting: Name]
...
You can find the result of the import in the back end menu: xref:markets:ebay-setup.adoc#1600[Setup » Markets » eBay » Parts compatibility listing » [Open parts compatibility listing] » Area: Basic settings » Setting: Type]
...
Enter the eBay K-Type number in the CSV file. eBay assigns a unique K-Type number to each version of a vehicle. The K-Type number gives eBay all necessary details regarding a vehicle, i.e. make, model, type, year and engine. You can find K-Type numbers in the link:https://www.ebay.co.uk/pages/help/sell/contextual/master-vehicle-list-manually.html[eBay master vehicle list ^]{nbsp}icon:external-link[].
...
You can find the result of the import in the back end menu: xref:markets:ebay-setup.adoc#1600[Setup » Markets » eBay » Parts compatibility listing » [Open parts compatibility listing] » Area: List » [Open list] » Column: Platform]
...
You can find the result of the import in the back end menu: xref:markets:ebay-setup.adoc#1600[Setup » Markets » eBay » Parts compatibility listing » [Open parts compatibility listing] » Area: List » [Open list] » Column: Compatibility notes]
