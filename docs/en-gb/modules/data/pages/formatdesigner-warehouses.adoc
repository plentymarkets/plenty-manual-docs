...
:description: FormatDesigner: Warehouse data can be exported out of plentysystems. This page serves as a reference and lists the available data fields.
:page-aliases: warehouses.adoc
:author: team-stock
