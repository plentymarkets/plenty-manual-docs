...
|
include::item:partial$eu-responsible-name.adoc[]

| *manufacturerResponsibleStreet*
|
include::item:partial$eu-responsible-street.adoc[]

| *manufacturerResponsibleHouseNo*
|
include::item:partial$eu-responsible-house-no.adoc[]

| *manufacturerResponsiblePostCode*
|
include::item:partial$eu-responsible-postcode.adoc[]

| *manufacturerResponsibleTown*
|
include::item:partial$eu-responsible-town.adoc[]

| *manufacturerResponsibleCountry*
|
include::item:partial$eu-responsible-country.adoc[]

| *manufacturerResponsibleEmail*
|
include::item:partial$eu-responsible-email.adoc[]
