...
|The xref:crm:preparatory-settings.html#properties-introduction[customer properties] that are saved in the system. One field is displayed per characteristic. +
