...
You can find the result of the import in the back end menu xref:stock-management:setting-up-a-warehouse.adoc#1500[Stock » Incoming items » [perform search] » [select incoming items data record] » tab: Item].
...
You can find the result of the import in the back end menu xref:stock-management:managing-stocks.adoc#intable-purchase-price[Stock » Incoming items » [perform search] » [select incoming items data record] » tab: Item].
...
You can find the result of the import in the back end menu xref:stock-management:managing-bbd-batch.adoc#100[Stock » Incoming items » [perform search] » [select incoming items data record] » tab: Item].
