...
:description: Properties and property groups can be imported into plentysystems. This page serves as a reference and lists the available matching and mapping fields.
:author: team-item
...
*_Background info_*: Every new property automatically receives an ID, which can not be changed. The ID is used to uniquely identify the property. Because the ID is unique, it’s a good way to check whether the imported data record already exists in plentysystems.
...
*_Background info_*: Every new property group automatically receives an ID, which can not be changed. The ID is used to uniquely identify the group. Because the ID is unique, it’s a good way to check whether the imported data record already exists in plentysystems.
...
Write the text in your system’s default language.
