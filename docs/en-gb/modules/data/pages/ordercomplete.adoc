...
| **OrderValuta**
|Valuta is the time period that starts when the invoice is created but ends before the payment due time period begins.
For further information, refer to xref:crm:companies.adoc#create-company[Companies].
|
