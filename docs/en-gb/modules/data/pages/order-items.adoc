...
:position: 50
:url: data/exporting-data/FormatDesigner/format-types/order-items
...
|referrerId
|ID of the order referrer as described on the <<data/internal-IDs#90, Internal IDs in plentymarkets>> manual page.
...
|Order property ID
|ID of the <<item/settings/properties#500, order property>> of the order item

|Order property value
|Value of the <<item/settings/properties#500#500, order property>> of the order item

|Order property group ID
|<<item/settings/properties#500#500, Order property>> group ID of the order item
|====
