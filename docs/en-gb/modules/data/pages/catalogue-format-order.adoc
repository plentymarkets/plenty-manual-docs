...
Find more information on addresses in general in the manual chapter xref:crm:managing-contacts.adoc#590[Managing addresses].
...
Find more information on contacts in general in the manual chapter xref:crm:managing-contacts.adoc#90[Managing contacts and companies].
...
Find more information on types in general in the manual chapter xref:crm:managing-contacts.adoc#20[Creating a type].
...
Find more information on customer classes in general in the manual chapter xref:crm:managing-contacts.adoc#15[Creating a customer class].
...
Find more information on contacts and debtor accounts in the manual chapter xref:crm:managing-contacts.adoc#intable-edit-contact-debtor-account[Editing a contact].
