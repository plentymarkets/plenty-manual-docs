...
====
The statistics module described on this page will not be developed further. This means that no new functionalities will be added in the future. To process your business data, you can already use the newly introduced xref:business-decisions:myview-dashboard.adoc#[dashboard]. The dashboard is part of the xref:business-decisions:plenty-bi.adoc#[plentyBI] module and provides you with even more flexibility for evaluating your statistics.
====
