...
You can restore a previous catalogue version via the further actions or in the view of a catalogue. The last 100 versions of a catalogue are available.
...
*_Tip:_* The last 100 versions of a catalogue are available.
. Click on *Restore*. +
...
. Go to *Data » Catalogues*. +
→ The catalogue overview opens.
. Click on *Restore deleted catalogue* (material:undo[]). +
→ A window opens.
