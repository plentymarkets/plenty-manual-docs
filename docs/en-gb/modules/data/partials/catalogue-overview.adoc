...
| Export one or more catalogues that you selected in the first column of the list. (xref:data:catalogues-manage.adoc#290[How?]) +
...
! Restore an earlier version of the catalogue. The last 100 versions of a catalogue are available.
