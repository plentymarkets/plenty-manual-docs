...
|102.02
|Kaufland CZ +
*_Note:_* Kaufland has not launched the market yet. You can already list your items on *Kaufland CZ*, but not sell them there yet.

|102.03
|Kaufland SK +
*_Note:_* Kaufland has not launched the market yet. You can already list your items on Kaufland SK, but not sell them there yet.
...
|147
|Flubit +
*_Note:_* This order referrer is deprecated and no longer in use.
