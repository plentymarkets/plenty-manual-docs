...
====
Download the example import, unzip the file and xref:data:ElasticSync.adoc#1640[import the JSON file into your plentymarkets system].
...
If you haven’t already done so, download the example import, unzip the file and xref:data:ElasticSync.adoc#1640[import the JSON file into your plentymarkets system].
