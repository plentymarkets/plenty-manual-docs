...
//tag::first-page[]
* *_You want to export data from plentymarkets to a CSV, JSON, TXT or XML file?
...
* xref:data:catalogue-manage.adoc#190[Copy catalogues]
* xref:data:catalogue-manage.adoc#210[Delete catalogues]
* xref:data:catalogue-manage.adoc#250[Restore a previous catalogue version]
* xref:data:catalogue-manage.adoc#240[Restore a deleted catalogue]
* xref:data:catalogue-manage.adoc#270[Export catalogues]
* xref:data:catalogue-manage.adoc#280[Import catalogues]
* xref:data:catalogue-manage.adoc#catalogue-rights[Assign rights for back end users]
--
//end::faq-manage[]
