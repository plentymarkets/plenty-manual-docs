...
| Copy one or more catalogues that you selected in the first column of the list. (xref:data:catalogues-manage.html#190[How?])

| material:file_download[]
| Export one or more catalogues that you selected in the first column of the list. (xref:data:catalogues-manage.html#270[How?]) +
...
| Import a catalogue. (xref:data:catalogues-manage.html#280[How?]) +
...
| material:history[]
| Restore a previous version of one or more catalogues. (xref:data:catalogues-manage.html#250[How?])

_or_

Restore a deleted catalogue. (xref:data:catalogues-manage.html#240[How?])

| material:delete[]
| Delete a catalogue. (xref:data:catalogues-manage.html#240[How?])
