...
* set up xref:fulfilment:preparing-the-shipment.adoc#100[countries of delivery]
* create a xref:fulfilment:preparing-the-shipment.adoc#400[region]
* create the xref:fulfilment:preparing-the-shipment.adoc#800[shipping service provider] *DPD Shipping UK*
* create a xref:fulfilment:preparing-the-shipment.adoc#1500[table of shipping charges] for *DPD Shipping UK*
...
Once you have xref:plugins:installing-added-plugins.adoc#installing-plugins[installed the plugin in a plugin set], the plugin is visible in the *Setup » Orders » Shipping* menu.
