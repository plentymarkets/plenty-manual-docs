...
As an alternative, you can download the plugin from link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[].
====
...
As an alternative, download the plugin from link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlwunschpaket_5435[plentyMarketplace^]{nbsp}icon:external-link[] and install it in a plugin set. +
...
When registering an international Warenpost shipment to an non-EU country, the CN22 form will automatically be generated on the label.

For further information, refer to the link:https://www.dhl.de/en/geschaeftskunden/paket/leistungen-und-services/warenpost-international.html[DHL website^]{nbsp}icon:external-link[].
