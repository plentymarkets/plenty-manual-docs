...
====
You need a plugin to link plentymarkets to DHL Shipping (Versenden). Visit the link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlshipping_4871[plentyMarketplace^]{nbsp}icon:external-link[] to download the DHL Shipping (Versenden) plugin. +
Two DHL Shipping assistants that allow an easy setup are then available in the *Setup » Assistants » Plugins* menu in the relevant plugin set.
...
* create a xref:fulfilment:preparing-the-shipment.adoc#1500[table of shipping charges] for *DHL Shipping (Versenden)* +
...
As soon as you have xref:plugins:installing-added-plugins.adoc#installing-plugins[installed] the plugin in a plugin set, the *DHL Shipping: Basic settings* and the *DHL Shipping: Settings combination* assistants are available in the *Setup » Assistants » Plugins* menu in the relevant plugin set. The *Shipping settings* assistant is available in your plentymarkets system by default. You can find it in the *Setup » Assistants » Integration* menu.
...
<<#dhl-products-services, Here>> you can find the services that correspond to the products.
