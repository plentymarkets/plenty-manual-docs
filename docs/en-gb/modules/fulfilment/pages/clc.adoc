...
In order to set up the interface for CLC in your plentymarkets system, you have to be registered with link:https://www.tietjegroup.com/en/kontakt/[CLC^]. Simply write an email to link:kontakt@clc.tietjegroup.com[kontakt@clc.tietjegroup.com].
