...
Besides the convenient option to import package numbers into your system via the xref:fulfilment:generating-documents.adoc#manually-import-package-numbers[manually>> or with the help of a <<fulfilment/generating-documents#package-numbers-barcode-scanner#, barcode scanner].
