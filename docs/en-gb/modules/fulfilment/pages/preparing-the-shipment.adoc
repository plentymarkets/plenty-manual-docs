...
:keywords: shipping service provider, fulfilment service provider, fulfilment, shipping countries, country of delivery, region, regions, shipping profile, table of shipping charges, shipping package, shipping costs, tracking URL, cbc logistics, parcel.ONE, DHL Versenden, DHL plentymarkets Import, DHL enclosed return label, DHL Retoure Online, DHL Supply Chain, DHL UK, DPD Cloud Webservice, My DPD Business, DPD Print, GLS Germany, Hermes 2-Mann-Handling, Iloxx, UK Mail, NetDespatch, Swiss Post, UPS, DHL Fulfillment, IDS Logistik, iLOPACK, country selection
...
| *Warehouse*
|Select which warehouse the country of delivery should be assigned to. This warehouse is automatically selected for orders from this country. Select *ALL* if the country of delivery should be assigned to all of the warehouses. In this case, the warehouse with the lowest ID is automatically selected for the orders. Also pay attention to the xref:orders:basic-settings.adoc#[warehouse settings] in the *Setup » Orders » Settings* menu.
...
. Go to *Setup » Orders » Shipping » Shipping service provider » Settings*.
. Enter shipper data for your warehouses.
. *Save* (icon:save[role="green"]) the settings.
...
Go to *Setup » Orders » Order status* and set up 2 xref:orders:order-statuses.adoc#[order statuses] for the orders transferred to DHL Fulfillment. In the following, you find 2 examples:
...
| *Reasons for return*
|Link the xref:orders:order-type-return.adoc#[reasons for return] that you created in the *Setup » Orders » Order types » Return* menu with the return reasons given by DHL Fulfillment.
|====
