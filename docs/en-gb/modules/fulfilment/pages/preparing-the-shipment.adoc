...
| *Warehouse*
|Select which warehouse the country of delivery should be assigned to. This warehouse is automatically selected for orders from this country. Select *ALL* if the country of delivery should be assigned to all of the warehouses. In this case, the warehouse with the lowest ID is automatically selected for the orders. Also pay attention to the xref:orders:managing-orders.adoc#[warehouse settings] in the *Setup » Orders » Settings* menu.
...
| *Category*
|Select a category from the drop-down list. The category is another way to prioritise shipping profiles in the shopping cart. Category *1* is selected by default. This means that all of the shipping profiles are given the same priority. Further information can be found in the chapter <<#1300, Tips and tricks: Category>>.
...
Further information can be found in the chapter <<#1100, Tips and tricks: Extra shipping charges>>.
...
*_Important:_* Installing the cash on delivery plugin is required. You can find the plugin in the link:https://marketplace.plentymarkets.com/en/plugins/payment/cashondelivery_5255[plentyMarketplace^].
...
*_Important:_* It is required that the plugins link:https://marketplace.plentymarkets.com/en/plugins/templates/Ceres_4697[Ceres^] and link:https://marketplace.plentymarkets.com/en/plugins/templates/IO_4696[IO^] are installed.
...
*_Important:_* You need to have set up at least 2 accounts, otherwise this option is not visible. Further information can be found in the chapter xref:fulfilment:preparing-the-shipment.adoc#1200[Tips and tricks: Shipping costs for orders placed on eBay].
...
| *Loyalty program*
|Select one or more loyalty programs. You can use the loyalty programs with xref:markets:ebay-setup.adoc#6600[eBay Plus] or xref:markets:best-practices-amazon-prime.adoc#150[Amazon]. +
...
Example: *Amazon Prime*. Here, you can select an Amazon Prime service. These services are only visible when you have created the shipping profile with shipping service provider DHL or DPD previously. This does _not_ refer to the plugins DHL Shipping and DPD Shipping. +
...
|xref:fulfilment:preparing-the-shipment.adoc#2600[PARCEL.ONE]
|For sellers within Germany. Shipping: international.
...
Proceed as follows to set up the interface to link:https://www.dhl.de/content/dam/dhlde/downloads/pdf/geschaeftskunden/dhl-easylog-versandsoftware-infoblatt-en-022016.pdf[DHL Easylog^] in plentymarkets.
...
Proceed as follows to set up the interface to link:https://www.dhl.com/de-en/home/our-divisions/freight.html[DHL Freight^] in plentymarkets.
...
Carry out the settings in the link:https://www.dhl-geschaeftskundenportal.de/webcenter/portal/gkpExternal/gkpPortalMainNav/homeExt?_afrLoop=927107339074311&_adf.ctrl-state=16wgprdxk0_38#\![DHL business customer portal^].
...
Proceed as follows to set up the interface to link:https://www.dhl.de/content/dam/images/pdf/GK/Services/dhl-retoure-mit-label-beigefuegt-infoblatt-en-092021.pdf[DHL Retoure with enclosed return label^] in plentymarkets.
...
+
--
The plugin *DHL Retoure Online* is available free of charge in the link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlretoureonline_6714[plentyMarketplace^]. Install the plugin in a plugin set. The *DHL Retoure Online* assistant is visible in the *Setup » Assistants » Plugins* menu in the relevant plugin set. For further information, refer to the xref:fulfilment:plugin-dhl-retoure-online.adoc#[DHL Retoure Online] page.
...
Proceed as follows to set up the interface to link:https://www.dhl.de/en/geschaeftskunden/paket/leistungen-und-services/retoure.html[DHL Retoure Online^] in plentymarkets.
...
For further information, refer to the xref:fulfilment:plugin-dhl-shipping-versenden.adoc#[DHL Shipping (Versenden)] page. The plugin *DHL Shipping (Versenden)* is available in the link:https://marketplace.plentymarkets.com/en/plugins/integration/DHLShipping_4871[plentyMarketplace^].
...
Proceed as follows to set up the interface to link:https://www.dhl.com/de-en/home/our-divisions/supply-chain.html[DHL Supply Chain^] in plentymarkets.
...
Proceed as follows to set up the interface to link:https://www.dhl.com/gb-en/home.html[DHL UK^] in plentymarkets.
...
Visit the link:https://marketplace.plentymarkets.com/en/plugins/integration/dhlwunschpaket_5435[plentyMarketplace^] to download the plugin free of charge and to integrate the DHL Preferred Delivery services in your plentyShop. After you have successfully installed the plugin, an assistant is available to help you set up the services in an easy way.
...
Proceed as follows to set up the interface to link:https://esolutions.dpd.com/entwickler/dpd-cloud-webservice.aspx[DPD Cloud Webservice (My DPDBusiness)^] in plentymarkets.
...
[.collapseBox]
.DPD Cloud Webservice log entries (old)
--
This box provides information about the log entries in the *Data » API log (deprecated)* menu that relate to DPD Cloud Webservice. Click on the **Shipping centre API log** tab and select the **DPDCloudWebservice** process.
...
Before setting up the interface to DPD Print in plentymarkets, register with link:https://www.dpd.com/group/en/[DPD^]. DPD customers can use the DPD Print program to easily create DPD parcel labels.

How you set up shipping service providers and shipping profiles and which additional settings you have to carry out and may carry out, is described in the chapters from xref:fulfilment:preparing-the-shipment.adoc#100[Setting up countries of delivery] through xref:fulfilment:preparing-the-shipment.adoc#2400[Retrieving the log]. The settings described there are the basic requirements in order to carry out the settings that are specific for each shipping service provider. Therefore, first carry out the settings in the chapters mentioned above. Afterwards, continue with this chapter.

Proceed as follows to set up the interface to link:https://www.dpd.com/nl_en/business_customers/help_en_tools/labelprint_tools/delisprint[DPD Print^] in plentymarkets.
...
| *Flex/Predict active*
|Select the option to register the fee-based notification service link:https://www.dpd.com/de/en/empfangen[Predict^] (formerly FlexDelivery) with DPD. If this option is chosen, the CSV file exported from plentymarkets contains the additional information *PRO*.
|====
...
Visit the link:https://marketplace.plentymarkets.com/en/plugins/integration/dpdshippinguk_5121[plentyMarketplace^] to download the DPD Shipping UK plugin free of charge and to be able to use the interface to DPD Shipping UK.
...
Visit the link:https://marketplace.plentymarkets.com/en/plugins/integration/dpdshippingservices_6320[plentyMarketplace^] to download the DPD Shipping Services plugin free of charge and to be able to use the interface to DPD Shipping Services. After you have successfully installed the plugin, an assistant is available to help you set up the interface in an easy way.
...
During the order process, customers should be able to request that their items are assembled for them. You can offer customers such a service with link:https://www.hermesworld.com/en/about-us/hermes-group/hermes-einrichtungs-service/[Hermes Two-Man Handling^]. In order to use this service, create an order characteristic. Create an order characteristic with the options *Yes* and *No*. Depending on which *Characteristic type* you select, you are able to configure the options that your customers later selects in your online shop.

[TIP]
.Interface for existing customers only
====
The interface to Hermes Two-Man Handling can only be used by existing customers. New customers are asked to contact link:https://www.hermesworld.com/de/unsere-dienstleistungen/distribution/2-mann-handling/2-mann-handling/[Hermes Einrichtungs Service GmbH & Co.KG^].
====
...
====
Hermes switches off the ProfiPaketService interface by 21 February 2021. Therefore, use *Hermes Shipping Interface* instead. Download the plugin free of charge on link:https://marketplace.plentymarkets.com/en/plugins/integration/hermesshippinginterface_5437[plentyMarketplace^].
====
...
Proceed as follows to set up the interface to link:https://www.iloxx.de/home.aspx[Iloxx^] in plentymarkets.
...
Proceed as follows to set up the interface to link:https://www.parcelforce.com/[Parcelforce Worldwide^] in plentymarkets.
...
Proceed as follows to set up the interface to link:https://parcel.one/[PARCEL.ONE^] in plentymarkets.
...
Before setting up the interface to Swiss Post in plentymarkets, register with link:https://www.post.ch/en[Swiss Post^].
...
Proceed as follows to set up link:https://www.ukmail.com/[UK Mail^] via the integrated link:http://www.netdespatch.com/[NetDespatch^] interface in your plentymarkets system.
...
Proceed as follows to set up the interface to link:https://wwwapps.ups.com/doapp/signup?loc=en_DE[UPS^] in plentymarkets.
...
Set up link:https://www.dhl.de/en/geschaeftskunden/paket/leistungen-und-services/fulfillment.html[DHL Fulfilment^] in your plentymarkets system. To do so, proceed as described below.
...
Before setting up the interface to link:https://www.ids-logistik.de/de/[IDS Logistik^] in plentymarkets, register with IDS Logistik.
...
Note that you can only see the *Amazon Prime* area in tab *Table of shipping charges* of the shipping profile when the shipping profile has been created with shipping service provider DHL or DPD. This does _not_ refer to the plugins DHL Shipping and DPD Shipping.