...
How you edit, add or delete shipping packages is described on the xref:fulfilment:shipping-centre-2-0.adoc#[Using the shipping centre] page of the manual.
