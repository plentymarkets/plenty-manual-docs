...
======
For some of the shipping service providers, specific settings become visible in this area of your plentymarkets back end after you saved and reloaded the table of shipping charges. +
_Example:_ *Amazon Prime*. Here, you can select an *Amazon Prime service*. These services are only visible when you have created the shipping profile with shipping service provider DHL or DPD previously. This does _not_ refer to the plugins DHL Shipping and DPD Shipping. +
_Example:_ *Amazon shipping settings*. Here, you can select a transport service and a shipping service.
======
