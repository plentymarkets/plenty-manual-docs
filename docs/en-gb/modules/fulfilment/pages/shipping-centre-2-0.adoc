...
======
As an alternative to the order summary of one day in the *Orders » Shipping centre 2.0* menu, you can also carry out an xref:data:orders.adoc#[Orders].
======
...
If you want to shipping packages from the shipping centre 2.0, the xref:orders:package-content-list.adoc#[package content list] will open in a new tab. 
...
Further information can be found in the <<#orders, Orders>> section in the xref:orders:managing-orders.adoc#300[Working with delivery orders] chapter.
...
Refer to the *Data » Log* menu when searching for errors. Entries are saved in this menu for 4 weeks. For further information, refer to the xref:data:datalog.adoc#[Data log] manual page.
--
