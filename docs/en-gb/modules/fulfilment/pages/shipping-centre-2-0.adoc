...
At the end of the line of the package, click on *Delete package* (material:delete[]) to delete individual packages. A window opens and you need to confirm your decision.  
