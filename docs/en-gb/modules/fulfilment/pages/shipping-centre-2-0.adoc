...
. Click on *Edit orders* (terra:edit[]) in the toolbar on the top. +
...
. Click on *Register orders* (terra:outgoing_items[]) in the toolbar on the top. +
...
. Click on *Polling* (terra:file_extension_csv[]) in the toolbar on the top.
...
. Click on *Register returns* (terra:order_return[]) in the toolbar on the top. +
...
. Click on *Summary* (terra:order_note[]) in the toolbar on the top.
. Select the service provider from the drop-down list. +
...
. Click on *Download shipping labels* (terra:order_open[]) in the toolbar on the top. +
...
. Click on *Download return labels* (terra:order_return_slip[]) in the toolbar on the top. +
→ The PDF file is generated and you can save it to your computer. +
...
. Click on *Reset orders* (terra:reset[]) in the toolbar on the top. +
...
. Click on *Register order* (terra:outgoing_items[]) in the toolbar on the top. +
...
→ The orders that correspond to the search criteria entered are shown in the overview.
. Open the order.
. Click on *Reset order* (terra:reset[]) in the toolbar on the top. +
...
→ The orders that correspond to the search criteria entered are shown in the overview.
. Open the order.
. Click in the toolbar on the top on *Register return* (terra:order_return[]). +
