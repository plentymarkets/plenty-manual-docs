...
The other available coupon variety is the <<#promotional-coupon, promotional coupon>>. The other available coupon type in plentysystems is the <<#voucher, voucher>>. +
