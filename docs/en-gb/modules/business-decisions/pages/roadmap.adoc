...
|Completed
||link:https://forum.plentymarkets.com/t/ankuendigung-shopbooster-bleibt-dauerhaft-kostenlos-und-wird-verpflichtend-announcement-shopbooster-remains-permanently-free-of-charge-and-becomes-mandatory/706114[Post in the forum^]

|*plentyShop* +
*Google Analytics plugin update* +
Update Universal Analytics to Google Analytics 4.
|Completed
|link:https://forum.plentymarkets.com/t/google-analytics-plugin-jetzt-ga4-kompatibel-google-analytics-plugin-now-ga4-compatible/718601[Post in the forum^]
