...
For further information, refer to the xref:business-decisions:marketplacevariationvalidation.adoc#[variationValidation#, variationValidation] page of the manual.
