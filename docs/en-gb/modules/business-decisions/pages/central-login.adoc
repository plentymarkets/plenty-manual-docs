...
====
You can customise the central login URL so that your PID and user name is already filled in. For example: the URL *https://account.plentysystems.com/login?pid=1234&user=abc* has the PID *1234* and user name *abc* prefilled. You can take this URL and modify it for your system. 
====
