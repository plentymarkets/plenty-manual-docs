...
====
From the 21st February 2024 on the URLs *plentymarkets-cloud-de.com* and *plentymarkets-cloud-ie.com* will redirct to *account.plentysystems.com*. Until then, administrators and non-administrators can still use the old login. This means you will only need one URL to log into your system.
====

[TIP]
.Customised central login URl with PID and user name
====
You can customise the central login URL so that your PID and/or user name is already filled in. For example: the URL *https://account.plentysystems.com/login?pid=1234&user=abc* has the PID *1234* and user name *abc* prefilled. You can take this URL and modify it for your system, fill on both parameters or just one of them. 
====
...
image::central-login-account-en.png[width=480,height=480]
