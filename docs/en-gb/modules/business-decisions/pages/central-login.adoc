= Central login
:keywords: central login, login, plentysystems, MFA, multi factor authentication, time zone, language, change password, new password
...
//====
//From the *28th February 2024* on the URLs *plentymarkets-cloud-de.com* and *plentymarkets-cloud-ie.com* will redirct to *account.plentysystems.com*. Until then, administrators and non-administrators can still use the old login. This means you will only need one URL to log into your system.
//====

[TIP]
.Customised central login URl with PID and user name
====
You can customise the central login URL so that your PID and/or user name is already filled in. For example: the URL *\https://account.plentysystems.com/login?pid=1234&user=abc* has the PID *1234* and user name *abc* prefilled. You can take this URL and modify it for your system, fill out both parameters or just the PID. 
====
...
image::EN-system-overview.png[width=840,height=680]
...
* the xref:version-cycle.adoc[system version,window=_blank]
...
With *search for plenty ID* (material:public) you can search for a specific system by entering the plenty ID. Besides that you can sort the system either descending or ascending by plenty ID.
 To do so, click on material:arrow_downward[].

[#300]
== Account settings

In the menu *account settings* you can carry out the settings that apply for your plentysystems account as well as every connected system. The account settings are separated into the two menus *Account* and *Security*.

[#330]
=== Account

In the *Account settings » Account menu* you can enter the name and surname for your plentysystems account as well as the time zone, language and email address of your plentysystems account.
...
|*Profile picture*
|Profile picture that is shown in every system that is linked to your plentysystems account.

|*Email*
|Email address of your plentysystems account. You can change the email address by clicking on material:edit[].
...
You can add and change your profile picture in the account settings of the central login. The profile picture will be used in every system that is linked to your account.

[.instruction]
Proceed as follows to add profile picture to your plentsystems account:

. Open the *Login » Account settings » Account* menu.
. Hover with the cursor on the empty profile picture (material:account_circle[]).
...
When you upload a profile picture you can zoom into the profile picture by using the slider beneath it. If you click in the profile picture and hold you can adjust the profile picture within the circular frame.

image:central-login-adjusting-profile-picture-en.gif[height=450,width=700]
...
. Log into a system via the central login. +
. Open the *Login » Account settings » Security* menu. +
Or: if you logged in via PID, user name and password, click on the profile picture oin the top right, then click on *plentysystems account* in the drop down list. +
...
--
The login session of the central login ends after 24 hours, meaning you will be automatically logged out after 24 hours of your login. The login session will also be terminated if you are inactive for 6 hours or longer. The login session is tracked in all currently open browser tabs. That means that you will be logged out of the system in all tabs in which the system in question is currently open no later thatn 24 hours after first opening the system.
--
