...
[WARNING]
.Login via plenty ID, user account name and password not possible as administrator
====
As an administrator, you can only log in to the central login via e-mail address. This is due to if you forget your password, you will not be able to reset it yourself and will be locked out of the system.
====
...
image::central-login-account-en.png[width=680,height=680]
...
image::central-login-security-en.png[width=680,height=680]
