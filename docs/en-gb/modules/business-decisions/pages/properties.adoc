= properties
:description: plentyBI: Use the properties data format creator to export the properties available in your system and save this data in the cloud.
:author: team-item
...
|VARCHAR NOT NULL
|property ID
|ID of the property, as specified in the xref:item:properties.adoc#600[property’s settings]. +
*_Pattern_*: plentyID-propertyID

|prop_cast
|VARCHAR
|property cast
|Property type, as specified in the xref:item:properties.adoc#600[property’s settings], e.g. longText, selection, shortText, etc.

|prop_type
|VARCHAR
|property type
|Section in which the property is used, as specified in the xref:item:properties.adoc#600[property’s settings], e.g. item, contact, etc.

|prop_position
|INTEGER
|property position
|The property’s position number, as specified in the xref:item:properties.adoc#600[property’s settings].

|prop_name
|VARCHAR
|property name
|The property’s name, as specified in the xref:item:properties.adoc#600[property’s settings].
