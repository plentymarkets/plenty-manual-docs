...
:description: plentyBI: Use the marketplaceStockMovement data format creator to export stock information that was exported to specific markets, and save this data in the cloud.
...
| INTEGER NOT NULL
| plenty ID
| The ID of the plentysystems system
