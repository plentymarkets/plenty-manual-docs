...
| *Time interval*
| This setting narrows down the values of the selected *Period*. Thus, the time interval always has to be shorter than the selected *Period*. +
*_Example:I_* If you have selected the current month as *Period* and the option *Week* as *Time interval*, only the value for the current week will be displayed on the row.
