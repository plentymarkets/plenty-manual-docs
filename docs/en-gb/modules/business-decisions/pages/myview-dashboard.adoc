= Dashboard
:lang: en
:keywords: BI dashboard, business intelligence, create key figures, visualise key figures, reporting, tile, tiles, pie chart, pie charts, line graph, line graphs, bar chart, bar charts, heat map, heat maps, gauge chart, gauge charts, tree map
:position: 10
