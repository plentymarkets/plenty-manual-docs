...
. Activate the option *Expand side navigation* and/or *Hide from side navigation*. Pay attention to the information provided in <<table-dashboard-navigation>>. +
*_Note:_* These options are only visible to admin users and can only be carried out by them.
. *Save* (icon:save[set=plenty]) the settings.

[[table-dashboard-navigation]]
[width="100%"]
[cols="1,3"]
|====
|Setting |Explanation
