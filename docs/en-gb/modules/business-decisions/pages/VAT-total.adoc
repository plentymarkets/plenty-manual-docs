...
:key-figure: The VAT total
:this-means: This way, you can see at a glance how high the VAT amount is broken down by plugins that create orders in your plentymarkets system. A further differentiation is made according to the creation date of the orders.
