...
:description: Learn more about SSL certificates, what prerequisites for booking there are, and how to order and renew a SSL certificate.
:author: team-cloud
...
In other words, the domain must be listed as a primary domain in the menu *Setup » Settings » Hosting » Domains*.
...
image::business-decisions:cname-entry-en.png[]
...
You order the SSL certificate for your main domain, i.e. the domain that is listed as the primary domain in the menu *Setup » Settings » Hosting » Domains*.
If you want to set up an SSL certificate for a different domain, you will have to xref:business-decisions:domains.adoc#210a[set this domain as your main domain] first.
