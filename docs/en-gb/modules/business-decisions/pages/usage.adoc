...
Since this key figure measures your use of the change history, you will only see data if you have xref:data:change-history.adoc#1100[activated the change history for your system].
