...
:description: To know how much the change history costs, you first need to know how much it’s used. With the help of the free key figure Service usage, you can view your usage any time.
:author: team-item
//zuletzt bearbeitet am 01.09.2022
