...
====
Do you want to use this key figure to calculate the precise return rate? Then it is mandatory to set the filter for the order type *Return* when creating the key figure configuration. If you don’t set this filter, credit notes will be considered for the calculation as well. This leads to inaccurate results.
====
