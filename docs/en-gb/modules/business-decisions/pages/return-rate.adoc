...
plentymarkets calculates the return rate by dividing the total number of returns by the total number of all the order types *_that are not_* credit notes and returns: +
