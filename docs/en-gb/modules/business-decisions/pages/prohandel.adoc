...
|Item import
|Daily
|The import is based on the previously selected xref:business-decisions:prohandel.adoc#70[import settings].
...
* add xref:item:managing-items.adoc#50[meta data].
* specify where your products should be sold, i.e. select xref:item:managing-items.adoc#340[clients].
