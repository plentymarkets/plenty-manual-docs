...
The link:https://marketplace.plentymarkets.com/en/prohandel_54913[Prohandel plugin] is available on plentyMarketplace.
...
*_Note_*:
Don't confuse this timestamp with the second date for incoming goods.
