= Sales volume
:keywords: sales volume, sales, quantity, quantities, quantities sold, numbers, numbers sold, gross sales volume, net sales volume, gross sales, net sales, Business Intelligence, BI, statistics, key figure, key figures, Dashboard, raw data, report, reports, KPI, KPIs, Key Performance Indicator
:id: MSSWL41
