...
:position: 1100
:url: business-decisions/plenty-bi/key-figures/sales-volume
:id: MSSWL41
...
By choosing a <<business-decisions/plenty-bi/key-figures/sales-volume#100, calculation type>>, you decide whether to calculate with gross sales volume or the net sales volume.
In addition, select a <<business-decisions/plenty-bi/key-figures/sales-volume#200, dimension>> to determine how the result is grouped.
Set <<business-decisions/plenty-bi/key-figures/sales-volume#300, filters>> to specify the criteria for the calculation of the sales volume.
...
:key-figure: Sales volume
:this-means: This way, you can see at a glance how many items are sold broken down by which delivery country. A further differentiation is made according to the creation date of the orders.
...
:key-figure: Revenue
:this-means: This way, you can see at a glance how many items are sold broken down by order referrer. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: Sales volume
:this-means: This way, you can see at a glance how many items are sold broken down by warehouse. A further differentiation is made according to the date on which the order items of an order were shipped.
...
:key-figure: Sales volume
:this-means: This way, you can see at a glance how many items are sold broken down by client. A further differentiation is made according to the date on which the order items of an order were shipped.
...
_Note_ that the quantity of order items in credit notes and returns are subtracted from the sales volume when you selected these order types in this filter.
...
[[table-key-fies-operators-warehouse]]
[cols="1,1,3"]
|====
| Relational operator | Sign | Explanation
