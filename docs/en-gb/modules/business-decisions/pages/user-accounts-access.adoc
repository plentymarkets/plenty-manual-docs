...
If the number of user accounts has been reached or exceeded, admin users can access the session management menu by clicking on the error message that is shown when they attempt to log in.
