...
plentymarkets calculates the average number of order items by summing up the quantity of order items of the order.
...
:key-figure: The average number of order items
:this-means: This way, you can see at a glance how many order items are sold on average broken down by plugins that create orders in your plentymarkets system. A further differentiation is made according to the creation date of the orders.
