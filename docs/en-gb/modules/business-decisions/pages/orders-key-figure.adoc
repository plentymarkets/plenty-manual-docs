...
In addition, select a xref:business-decisions:orders.adoc#100[dimension] to determine how the result is grouped.
Set xref:business-decisions:orders.adoc#200[filters] to specify the criteria for the calculation of the sales volume.
