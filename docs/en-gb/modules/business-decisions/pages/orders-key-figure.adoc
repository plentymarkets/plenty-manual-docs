= Orders
:keywords: orders, number of orders, quantity, quantity of orders, Business Intelligence, BI, statistics, key figure, key figures, Dashboard, raw data, report, reports, KPI, KPIs, Key Performance Indicator
:id: D2IR751
...
include::partial$date-outgoing-items-dimension.adoc[]
