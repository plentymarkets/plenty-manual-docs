= propertyRelations
:description: plentyBI: Use the propertyRelations data format creator to export the links between properties and other data in your system and save this data in the cloud.
:author: team-item
...
|The property link’s value. For example, if the property is linked to a variation, then the value is found xref:item:managing-items.adoc#4800[within the item data record].
