...
:description: plentyBI: Use the itemVariationSuppliers data format creator to export the links between suppliers and variations and save this data in the cloud.
:author: team-item
