...
By choosing a <<#100, calculation type>>, you decide whether to calculate with the number of messages or the sum of minutes. In addition, select a <<#200, dimension>> and <<#300, filters>> to specify the criteria of the messages.
