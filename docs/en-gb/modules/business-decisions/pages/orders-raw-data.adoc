...
|order status
|Status of the order in decimal format. Depending on the statuses set up in the system, numbers with up to 4 decimal places are exported. You can find the IDs of the standard statuses on the xref:data:internal-IDs.adoc#120[Internal IDs in plentymarkets] page of the manual.
