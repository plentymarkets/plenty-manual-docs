...
|xref:videos:setting-up-and-managing-storage-locations-create-warehouse.adoc#video[Create a new warehouse (0:56)]

xref:videos:setting-up-and-managing-storage-locations-create-dimensions.adoc#video[Create dimensions (2:12)]

xref:videos:setting-up-and-managing-storage-locations-create-storage-locations.adoc#video[Create storage locations (3:33)]

xref:videos:setting-up-and-managing-storage-locations-print-labels.adoc#video[Printing labels (4:45)]
|===
//end::einleitung[]
