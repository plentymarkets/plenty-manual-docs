...
:lang: en
:position: 10020
:url: videos/items/mandatory-settings
:id: COJUJTF
:author: none
...
|xref:videos:mandatory-settings-mandatory.adoc#video[Mandatory settings (0:19)]

xref:videos:mandatory-settings-important.adoc#video[Important settings (1:36)]
