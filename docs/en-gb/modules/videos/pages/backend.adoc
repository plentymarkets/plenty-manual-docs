...
:position: 10010
:url: videos/pos/setting-up-pos/backend
:id: PMHHTWQ
:author: team-mobile
...
|<<videos/pos/setting-up-pos/backend-location#video, Tell plentymarkets where your store is located (0:33)>>

<<videos/pos/setting-up-pos/backend-items#video, Pick the items that you'll sell (1:15)>>

<<videos/pos/setting-up-pos/backend-payment#video, Decide how customers will pay for their purchases (2:26)>>

<<videos/pos/setting-up-pos/backend-cashiers#video, Grant cashiers access to your POS system (3:44)>>

<<videos/pos/setting-up-pos/backend-customers#video, Create a dummy data record for walk-in customers (4:19)>>

<<videos/pos/setting-up-pos/backend-shipping#video, Create a shipping profile for walk-in customers (4:51)>>

<<videos/pos/setting-up-pos/backend-stock#video, Tell plentymarkets to automatically lower your stock levels (5:46)>>
