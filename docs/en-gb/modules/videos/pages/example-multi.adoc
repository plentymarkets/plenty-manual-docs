...
:position: 100120
:url: videos/automation/processes/example-multi
:id: CKHECHX
:author: team-mobile
...
|<<videos/automation/processes/example-multi-finding#video, Finding pick lists and scanning items (1:32)>>

<<videos/automation/processes/example-multi-removing#video, Removing orders from the process (2:01)>>

<<videos/automation/processes/example-multi-registering#video, Registering serial numbers (2:55)>>

<<videos/automation/processes/example-multi-printing#video, Printing documents (4:00)>>
