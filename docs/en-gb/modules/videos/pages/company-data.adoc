...
|xref:videos:company-data-document-templates.adoc#video[Document templates (0:09)]

xref:videos:company-data-email-signature.adoc#video[Email signature (1:05)]

xref:videos:company-data-bank-master-data.adoc#video[Bank and master data (2:29)]
