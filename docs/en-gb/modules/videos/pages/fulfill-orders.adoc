...
:position: 10020
:url: videos/automation/event-procedures/fulfill-orders
:id: NXITHSU
...
|<<videos/automation/event-procedures/fulfill-orders-link#video, Linking event procedures together (0:54)>>

<<videos/automation/event-procedures/fulfill-orders-problem#video, The problem with "one big event procedure" (1:49)>>

<<videos/automation/event-procedures/fulfill-orders-reaction#video, Setting off the chain reaction (2:42)>>
