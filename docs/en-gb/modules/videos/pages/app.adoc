...
:position: 10020
:url: videos/pos/setting-up-pos/app
:id: LESVFSR
:author: team-mobile
...
|<<videos/pos/setting-up-pos/app-login#video, Logging into the app for the first time (0:43)>>

<<videos/pos/setting-up-pos/app-linking#video, Linking your POS system to the app (1:29)>>

<<videos/pos/setting-up-pos/app-printers#video, Working with multiple printers (3:08)>>

<<videos/pos/setting-up-pos/app-customising#video, Customising the app (3:53)>>
