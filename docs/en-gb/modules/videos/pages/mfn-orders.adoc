...
|xref:videos:mfn-orders-configure-settings.adoc#video[Configuring the MFN settings (0:48)]

xref:videos:mfn-orders-activate-settings.adoc#video[Activating the MFN settings (3:49)]
