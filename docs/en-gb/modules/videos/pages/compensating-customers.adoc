...
:position: 10060
:url: videos/order-processing/returns-and-cancellations/compensating-customers
:id: YH4RCHJ
...
|<<videos/order-processing/returns-and-cancellations/compensating-customers-monetary-refund#video, Issuing a monetary refund (0:17)>>

<<videos/order-processing/returns-and-cancellations/compensating-customers-defective-item#video, Exchanging a defective item for a new one (2:58)>>

<<videos/order-processing/returns-and-cancellations/compensating-customers-repair#video, Repairing a defective item (3:51)>>
