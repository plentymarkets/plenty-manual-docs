...
|xref:videos:inheritance-text-fields.adoc#video[Text fields (1:38)]

xref:videos:inheritance-drop-downs.adoc#video[Drop-down menus (2:31)]

xref:videos:inheritance-checkboxes.adoc#video[Checkboxes (3:09)]

xref:videos:inheritance-1-n.adoc#video[Text fields with 1:n links (4:03)]
