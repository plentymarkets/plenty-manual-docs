...
:position: 10040
:url: videos/pos/working-with-app/z-report
:id: ARB9KKK
:author: team-mobile
...
|<<videos/pos/working-with-app/z-report-z#video, Creating a Z report (0:19)>>

<<videos/pos/working-with-app/z-report-receipt#video, Viewing an electronic copy (0:55)>>

<<videos/pos/working-with-app/z-report-x#video, Creating an X report (1:30)>>
