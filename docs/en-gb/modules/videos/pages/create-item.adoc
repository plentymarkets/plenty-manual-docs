...
|<<videos/items/create-item-name#video, Naming items (0:58)>>

<<videos/items/create-item-content#video, Specifying the content (1:57)>>

<<videos/items/create-item-prices#video, Prices (2:36)>>

<<videos/items/create-item-categories#video, Linking categories (2:56)>>
