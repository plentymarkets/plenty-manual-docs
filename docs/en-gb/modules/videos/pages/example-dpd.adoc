...
:lang: en
:position: 10040
:url: videos/order-processing/shipping/example-dpd
:id: 1V2MSAW
...
|xref:videos:example-dpd-where.adoc#video[Where do you ship packages? (0:47)]

xref:videos:example-dpd-service-providers.adoc#video[Which service providers do you use? (1:29)]

xref:videos:example-dpd-costs.adoc#video[How much does delivery cost? (2:48)]
