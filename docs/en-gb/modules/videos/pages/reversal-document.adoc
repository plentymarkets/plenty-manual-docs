...
|xref:videos:reversal-document-locked-orders.adoc#video[Why are some orders locked? (0:22)]

xref:videos:reversal-document-invoices.adoc#video[When should you create invoices? (0:40)]
