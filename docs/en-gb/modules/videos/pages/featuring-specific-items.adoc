...
:position: 10030
:url: videos/online-store/featuring-items
:id: FXCXGR
:author: team-webshop
...
<<videos/online-store/featuring-specific-items-category#video, Customising your category pages (2:50)>>

<<videos/online-store/featuring-specific-items-product-information#video, Controlling which product information is displayed (3:28)>>
|===
//end::einleitung[]
