...
//tag::einleitung[]
include::online-store:partial$plentyshop-renaming.adoc[]
...
|xref:videos:featuring-specific-items-homepage#video[Displaying items on your store's homepage (0:33)]
