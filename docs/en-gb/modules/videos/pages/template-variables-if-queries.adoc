...
|xref:videos:template-variables-if-queries-part1.adoc#video[Template variables (0:43)]

xref:videos:template-variables-if-queries-part2.adoc#video[If query (2:05)]
