...
|xref:videos:item-structure-import-options-first-part.adoc#video[Item structure (0:18)]

xref:videos:item-structure-import-options-second-part.adoc#video[Import options (2:48)]
