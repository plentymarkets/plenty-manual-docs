...
So just navigate to the menu Setup » Markets » eBay » Accounts and click on the plus icon to link your eBay account with plentymarkets.
...
Just navigate to the menu Setup » Item » Sales prices and open whichever price you want to use for eBay.
