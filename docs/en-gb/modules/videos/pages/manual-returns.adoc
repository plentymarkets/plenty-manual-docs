...
:position: 10040
:url: videos/order-processing/returns-and-cancellations/manual-returns
:id: KVXNJIT
...
|<<videos/order-processing/returns-and-cancellations/manual-returns-creation#video, Creating a return (0:09)>>

<<videos/order-processing/returns-and-cancellations/manual-returns-slip#video, Generating a return slip (1:06)>>

<<videos/order-processing/returns-and-cancellations/manual-returns-statuses#video, Selecting item statuses (1:50)>>

<<videos/order-processing/returns-and-cancellations/manual-returns-stock#video, Adding items to your stock (2:19)>>
