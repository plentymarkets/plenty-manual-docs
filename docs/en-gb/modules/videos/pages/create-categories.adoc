...
:position: 10080
:url: videos/items/create-categories
:id: XRQBMGH
:author: none
...
|<<videos/items/create-categories-categories#video, Creating categories (1:08)>>

<<videos/items/create-categories-grouping#video, Grouping items (5:20)>>

<<videos/items/create-categories-content#video, Displaying content (6:53)>>
