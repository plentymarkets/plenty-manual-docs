...
|<<videos/pos/setting-up-pos/card-terminals-plugins#video, Use plugins to directly link certain types of terminals (0:14)>>

<<videos/pos/setting-up-pos/card-terminals-connection#video, Establish a connection in the plentymarkets app (1:16)>>

<<videos/pos/setting-up-pos/card-terminals-no-plugin#video, Link terminals without downloading a plugin (2:58)>>
