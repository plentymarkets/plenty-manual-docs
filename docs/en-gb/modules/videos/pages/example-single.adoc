...
:position: 100130
:url: videos/automation/processes/example-single
:id: XEPFNRO
:author: team-mobile
...
|<<videos/automation/processes/example-single-finding#video, Finding orders and scanning items (1:45)>>

<<videos/automation/processes/example-single-removing#video, Removing orders from the process (2:16)>>

<<videos/automation/processes/example-single-registering#video, Registering serial numbers (3:08)>>

<<videos/automation/processes/example-single-printing#video, Printing documents (4:13)>>
