...
:position:50
:url: videos/order-processing/processing-orders/partial-deliveries
:id: 51I9OYE
...
<<videos/order-processing/processing-orders/partial-deliveries-settings#video, Configuring the basic settings (1:58)>>

<<videos/order-processing/processing-orders/partial-deliveries-creation#video, Creating delivery orders (3:18)>>
