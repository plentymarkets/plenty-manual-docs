...
//  auto generated content Thu, 06 Jul 2017 00:15:24 +0200
== Short description

Returns the template ItemViewRandomList. This template is used to display a list of randomly selected items.
