= Container_ItemViewFurtherItemsList2
:lang: en
// include::{includedir}/_header.adoc[]
:keywords: Container_ItemViewFurtherItemsList2
:position: 10063

//  auto generated content Thu, 06 Jul 2017 00:20:05 +0200
== Short description

Returns the template ItemViewFurtherItemsList2. This template allows you to change the layout of the items of an item list. This is achieved by applying a different template.
