...
//  auto generated content Thu, 06 Jul 2017 00:15:07 +0200
== Short description

Returns the template ItemViewCrossSellingItemsList2. This template is used to display a list of cross-selling items.
