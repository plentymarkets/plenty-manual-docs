...
//  auto generated content Thu, 06 Jul 2017 00:18:35 +0200
== Short description

Returns the template ItemViewLatestItemsList2. This template is used to display a list of the latest items.
