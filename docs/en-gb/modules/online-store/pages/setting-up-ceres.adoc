...
| *B2B customer class*
|Enter the ID for the default customer class for business customers. For further information, refer to the xref:crm:managing-contacs.adoc#15[Creating a customer class] chapter of the manual.
...
* Store specials: Lists with new items, special offers, etc. are set up in plentyShop LTS via tags. For further information about setting up tags, refer to the xref:welcome:managing-items.adoc#150[Adding tags to items] chapter of the manual.
