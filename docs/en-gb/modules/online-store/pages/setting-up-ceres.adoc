...
link:https://www.plentymarkets.eu/blog/Volle-Kraft-voraus-ShopBooster-bringt-deinen-Ceres-Shop-auf-Hochtouren/b-2125/[ShopBooster^] is an additional module, via which online shop content of plentyShops are written into the cache in order to achieve better loading times. The ShopBooster is available for Ceres versions 2.14 and higher.
