...
//  auto generated content Thu, 06 Jul 2017 00:16:42 +0200
== Short description

Returns the template ItemViewManualSelectionList6. This template is used to display a list of manually selected items.
