...
//  auto generated content Thu, 06 Jul 2017 00:20:22 +0200
== Short description

Returns the template ItemViewFurtherItemsList4. This template allows you to change the layout of the items of an item list. This is achieved by applying a different template.
