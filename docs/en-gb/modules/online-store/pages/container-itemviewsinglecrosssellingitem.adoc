...
//  auto generated content Thu, 06 Jul 2017 00:12:36 +0200
== Short description

Returns the template ItemViewSingleCrossSellingItem. This template is used to display a single item view of a cross-selling item.
