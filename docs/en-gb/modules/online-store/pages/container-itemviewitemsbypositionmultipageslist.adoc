...
//  auto generated content Thu, 06 Jul 2017 00:19:49 +0200
== Short description

Returns the template ItemViewItemsByPositionMultiPagesList. This template is used to display a multi-page list of items sorted in descending order by item position.
