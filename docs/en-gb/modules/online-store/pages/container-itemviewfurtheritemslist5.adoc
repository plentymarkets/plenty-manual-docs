= Container_ItemViewFurtherItemsList5
:lang: en
// include::{includedir}/_header.adoc[]
:keywords: Container_ItemViewFurtherItemsList5
:position: 10066

//  auto generated content Thu, 06 Jul 2017 00:20:31 +0200
== Short description

Returns the template ItemViewFurtherItemsList5. This template allows you to change the layout of the items of an item list. This is achieved by applying a different template.
