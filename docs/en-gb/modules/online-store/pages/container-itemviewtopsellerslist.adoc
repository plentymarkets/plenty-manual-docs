...
//  auto generated content Thu, 06 Jul 2017 00:15:37 +0200
== Short description

Returns the ItemViewTopSellersList template. This template is used to display a list of top-selling items.
