...
//  auto generated content Thu, 06 Jul 2017 00:18:04 +0200
== Short description

Returns the ItemViewSpecialOffersList2 template. This template is used to display a list of special offer items.
