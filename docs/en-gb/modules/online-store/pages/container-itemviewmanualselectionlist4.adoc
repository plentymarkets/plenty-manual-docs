...
//  auto generated content Thu, 06 Jul 2017 00:16:26 +0200
== Short description

Returns the template ItemViewManualSelectionList4. This template is used to display a list of manually selected items.
