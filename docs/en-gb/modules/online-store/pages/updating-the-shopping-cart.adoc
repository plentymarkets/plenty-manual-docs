...
* xref:omni-channel:basketitemslist.adoc[POST /rest/checkout/basketitemslist/]
* xref:omni-channel:basketitemslist.adoc[GET /rest/checkout/basketitemslist/]
* xref:omni-channel:container_itemviewbasketpreviewlist.adoc[GET /rest/itemview/container_itemviewbasketpreviewlist/]
