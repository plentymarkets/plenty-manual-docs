...
//  auto generated content Thu, 06 Jul 2017 00:19:34 +0200
== Short description

Returns the template ItemViewItemsByPositionList. This template is used to display a list of items sorted in descending order by item position.
