...
//  auto generated content Thu, 06 Jul 2017 00:19:07 +0200
== Short description

Returns the template ItemViewLatestItemsMultiPagesList. This template is used to display a multi-page list of the latest items.
