...
//  auto generated content Thu, 06 Jul 2017 00:16:57 +0200
== Short description

Returns the template ItemViewLastSeenList2. This template is used to display a list of the last viewed items.
