= Container_ItemViewFurtherItemsList3
:lang: en
// include::{includedir}/_header.adoc[]
:keywords: Container_ItemViewFurtherItemsList3
:position: 10064

//  auto generated content Thu, 06 Jul 2017 00:20:14 +0200
== Short description

Returns the template ItemViewFurtherItemsList3. This template allows you to change the layout of the items of an item list. This is achieved by applying a different template.
