...
//  auto generated content Thu, 06 Jul 2017 00:15:54 +0200
== Short description

Returns the ItemViewTopSellersMultiPagesList template. This template is used to display a multi-page list of top-selling items.
