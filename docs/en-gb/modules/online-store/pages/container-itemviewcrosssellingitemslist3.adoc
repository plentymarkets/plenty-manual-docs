...
//  auto generated content Thu, 06 Jul 2017 00:15:16 +0200
== Short description

Returns the template ItemViewCrossSellingItemsList3. This template is used to display a list of cross-selling items.
