...
//  auto generated content Thu, 06 Jul 2017 00:18:20 +0200
== Short description

Returns the template ItemViewLatestItemsList. This template is used to display a list of the latest items.
