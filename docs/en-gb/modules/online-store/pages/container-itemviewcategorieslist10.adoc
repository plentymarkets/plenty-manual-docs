...
//  auto generated content Thu, 06 Jul 2017 00:14:50 +0200
== Short description

Returns the template ItemViewCategoriesList10. This template is used to display items of a category.
