...
//  auto generated content Thu, 06 Jul 2017 00:18:12 +0200
== Short description

Returns the ItemViewSpecialOffersMultiPagesList template. This template is used to display a multi-page list of special offer items.
