...
//  auto generated content Thu, 06 Jul 2017 00:19:19 +0200
== Short description

Returns the template ItemViewLatestItemsMultiPagesList2. This template is used to display a multi-page list of the latest items.
