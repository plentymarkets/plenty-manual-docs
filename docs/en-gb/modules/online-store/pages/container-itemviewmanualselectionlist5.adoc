...
//  auto generated content Thu, 06 Jul 2017 00:16:34 +0200
== Short description

Returns the template ItemViewManualSelectionList5. This template is used to display a list of manually selected items.
