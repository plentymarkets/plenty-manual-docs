...
//  auto generated content Thu, 06 Jul 2017 00:15:45 +0200
== Short description

Returns the ItemViewTopSellersList2 template. This template is used to display a list of top-selling items.
