...
//  auto generated content Thu, 06 Jul 2017 00:16:50 +0200
== Short description

Returns the template ItemViewLastSeenList. This template is used to display a list of the last viewed items.
