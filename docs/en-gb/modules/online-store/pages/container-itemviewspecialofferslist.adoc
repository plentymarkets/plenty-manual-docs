...
//  auto generated content Thu, 06 Jul 2017 00:17:56 +0200
== Short description

Returns the ItemViewSpecialOffersList template. This template is used to display a list of special offer items.
