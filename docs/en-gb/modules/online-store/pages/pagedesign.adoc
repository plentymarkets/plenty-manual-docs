...
* $CancellationRights — Contains the online store's cancellation rights as saved in the *Setup » plentyShop » (Select client) » Legal* menu.
...
* $GeneralTermsAndConditions — Contains the online store's terms and conditions as saved in the *Setup » plentyShop » (Select client) » Legal* menu.
...
* $LegalDisclosure — Contains the online store's legal disclosure as saved in the *Setup » plentyShop » (Select client) » Legal* menu.
...
* $PrivacyPolicy — Contains the online store's privacy policy as saved in the *Setup » plentyShop » (Select client) » Legal* menu.
