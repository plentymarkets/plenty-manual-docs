...
Add this plugin to your plentymarkets system xref:plugins:adding-plugins-system.adoc#[as described on this page]. Afterwards, you need to xref:plugins:installing-added-plugins.adoc#[install the plugin]. +
