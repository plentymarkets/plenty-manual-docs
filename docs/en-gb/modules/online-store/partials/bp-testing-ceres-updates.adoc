...
If the external plugins are functioning correctly under the new plentyShop LTS version, you can either xref:plugins:plugins.adoc#70[activate] the plugin set copy for the relevant client or *Update* the original plugin set, as detailed above.
