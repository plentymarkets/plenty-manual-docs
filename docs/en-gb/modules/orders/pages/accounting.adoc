...
*_Important_*: You need to save this tax note in your xref:orders:order-documents.adoc#intable-tax-note-three[document template for invoices] in advance. Enter the note in the document field *Tax note 3*. If you have document templates for different languages, you have to add hints separately to each of the templates.
|====
