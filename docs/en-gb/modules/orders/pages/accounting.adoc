...
The VAT number is automatically checked during the order process in your store. You can manually check the VAT number of customers who bought your items on other markets. For further information about the VAT number check, refer to the xref:main@manual:crm:managing-contacts.adoc#5500[Checking the VAT number] chapter of the manual. +
