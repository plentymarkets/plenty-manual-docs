...
======
As the order creation via the *Orders » Editing orders* menu is deprecated, this page explains how to create orders via the *Orders » Orders* menu.
======
...
In the *Orders » Orders* menu, you can create new orders or offers in the order overview as well as in the detail view of an order. To do so, proceed as follows.
