...
In the *Orders » Orders (Test phase)* menu, you can create new orders or offers in the order overview as well as in the detail view of an order. To do so, proceed as follows. Note that orders can only be opened in the list view.
