...
|The delivery orders are created according to the different *Warehouses and the net stock* if the stock is bigger than or equals the quantity of order items.
