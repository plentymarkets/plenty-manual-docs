...
|The delivery orders are created according to the *Warehouse stock and the net stock* of the order items if the stock is bigger than 0.

| *Warehouse stock and net stock >= order item quantity*
|The delivery orders are created according to the *Warehouse stock and the net stock* if the stock is bigger than or equals the order item quantity.
