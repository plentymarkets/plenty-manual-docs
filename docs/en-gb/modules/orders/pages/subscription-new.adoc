...
. If you select the option *For all order items*, see the explanations in Table 1.
. If you select the option *For specific order items*, see the explanations in Table 2.
. *Save* (icon:save[role="green"]) the settings. +
→ The subscription is created.


.Table 1. All order items
[cols="1,3"]
|====
|Setting|Explanation
