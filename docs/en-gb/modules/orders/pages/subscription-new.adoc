...
====
The item changes only apply to the subscriptions they were made in. For permanent changes to items, the adaptations need to be carried out either in the *Item » Items (Test phase)* or the *Setup » Item* menu.
