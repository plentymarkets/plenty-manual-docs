...
Subscriptions can be edited with these user rights. To allow users without admin rights to create new subscriptions, the following rights have to be granted _additionally_.
