...
** ...*export multiple selected documents as a ZIP file* (material:upload[] in the left section of tool bar),
** ...*download individual documents* (material:upload[] on the far right side of the document row).
