...
.Deprecated UI
======
The order management in the *Orders » Edit orders* menu is deprecated and will no longer be supported. Thus, we recommend to manage your orders from now on via the *Orders » Orders* menu. For further information, see the xref:orders:new-order-ui-beta.adoc[Orders] page.
======
