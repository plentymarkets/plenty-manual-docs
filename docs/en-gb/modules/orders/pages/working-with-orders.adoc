...
.Coupon documents
======
Documents of the type *Coupon* are not coupons that have been redeemed in the order, but coupons that have been sold with this order. Via the context menu (material:more_vert[]), you can *Recreate* (material:restore_page[]) a coupon.
======
