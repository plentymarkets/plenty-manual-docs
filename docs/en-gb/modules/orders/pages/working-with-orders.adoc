...
Orders that were not generated in the online store or on a market can be created xref:orders:manually-create-orders.adoc#[manually] in your system. This can be the required for orders via telephone, email or cash sales.
