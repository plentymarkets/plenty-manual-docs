...
| *Change status*
|material:repeat_one[]
|Changes the status of the selected orders. The current status is already preselected. Select another status from the drop-down list.
...
In the *Tickets* area, you can see all existing tickets of the customer. The following table lists the fields that are available in the *Tickets* area of the order. Via *Configure columns* (material:settings[]), you can configure the columns as desired.
