...
In the *Tickets* area, you can see all existing tickets of the order. The following table lists the fields that are available in the *Tickets* area of the order. Via *Configure columns* (material:settings[]), you can configure the columns as desired.
