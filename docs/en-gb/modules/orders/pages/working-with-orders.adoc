...
*_Note:*_ The following areas will be loaded and opened when you first open the order: _Overview_, *Status and tags*, *Addresses*, *General*, *Order items*, *Payment terms*, *Assigned payments*, *Documents*, *History*, *Notes*, *Messenger*. +
