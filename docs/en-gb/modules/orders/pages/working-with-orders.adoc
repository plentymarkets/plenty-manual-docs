...
Click on the already created message to open the conversation in the messenger. You can carry out further settings there. In case you want to add a new message, click on *New message* (material:add[]) at the top right. Afterwards, you will be directed to the Messenger in order to create the new message. For further information, refer to the xref:crm:messenger-testphase.adoc#[Messenger] page.
