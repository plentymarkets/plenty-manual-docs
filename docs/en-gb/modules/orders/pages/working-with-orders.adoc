...
In the editing mode (terra:design_inline_edit[role="darkGrey"]) of the order overview, you can determine *default group functions* that become directly visible when selecting orders.
 All remaining group functions will automatically be added to the context menu (material:more_vert[]).
