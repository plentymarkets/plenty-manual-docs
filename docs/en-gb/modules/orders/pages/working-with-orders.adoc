...
| *Expand*
|Allows you to expand the order item field to show the item properties. +
This is an optional column.
...
| *Length (mm)*
|Shows the length of the order item in millimetres.

| *Width (mm)*
|Shows the width of the order item in millimetres.
...
|Shows the total net profit margin.
...
| *Payment due (days)*
|Enter the payment due in days.

| *Early payment discount (days)*
|Displays the early payment discount in days.
|===
