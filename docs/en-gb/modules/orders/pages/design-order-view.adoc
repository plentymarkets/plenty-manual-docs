...
** For all items: The maximum amount of all items is automatically added to the shopping cart.
** For specific items: The table of the shopping cart will be empty at first, which means that the desired items have to be added manually.
...
The table columns in the order overview can be configured for both levels. When opening the *Orders » Orders (Test phase)* menu for the first time, the default view of the table is shown. By clicking on *Configure columns* (material:settings[]) on the right, the options *Order table* and *Order item table* are displayed. In the *Configure columns* window, you can select the columns that you want to be displayed and also define the order in which they are shown.
...
=== Configuring table columns for orders
...
| *Order type*
|Displays the type of the order. +
This is a default column.
...
| *Client*
|Displays the client that was used to create the order. +
This is a default column.
...
| *Location*
|Displays the location of the client that was used to create the order. +
This is a default column.

| *Location ID*
|Displays the location ID of the client that was used to create the order. +
This is an optional column.

| *Item quantity*
|Displays the amount of items in the order. +
This is a default column.

| *Net order value*
|Displays the total net sum of the order in the order currency. +
This is a default column.

| *Gross order value*
|Displays the total gross sum of the order in the order currency. +
This is a default column.

| *VAT*
|Displays the VAT that is applied for this order. +
This is a default column.

| *Status*
|Displays the processing status of the order. +
This is a default column.

| *Outgoing items booked on*
|Displays the date on which the outgoing items have been booked. +
This is a default column.

| *Order date*
|Displays the date on which the order was registered in the system. +
This is a default column.

| *Payment method*
|Displays the payment method that was selected for this order. +
This is a default column.

| *Invoice number*
|In case an invoice has already been created for the order, the invoice number is displayed. +
This is a default column.
...
| *Payment date*
|Displays the date on which the last payment for the order was received. +
This is a default column.
...
| *Country of delivery*
|Displays the country to which the order will be delivered. The displayed delivery country is taken from the given delivery address. +
This is a default column.

| *Delivery date*
|Displays the estimated delivery date of the order. +
This is a default column.

| *Source*
|Displays how the order was created, e.g. manually or via REST. +
This is a default column.

| *Owner*
|Displays the order’s owner. +
This is an optional column.

| *Referrer ID*
|Displays the ID of the referrer that was used to create the order. +
This is an optional column.

| *Referrer*
|Displays the referrer of the order, e.g. *Client (store)* or *Manual entry*. The xref:orders:order-referrer.adoc#[order referrer] is the sales channel via which the order is generated. +
This is a default column.

| *Warehouse*
|Displays the main warehouse of the order.  +
This is a default column.

| *Warehouse ID*
|Displays the ID of the main warehouse. +
This is an optional column.

| *Shipping costs*
|Displays the shipping costs of the order. +
This is a default column.
...
| *Reference*
|Displays the ID of the referenced order. By clicking on the ID the referenced order opens. +
This is a default column.
...
| *Tags*
|Displays the tags that are assigned to this order. +
This is an optional column.

| *Shipping profile*
|Displays the shipping profile. +
This is a default column.

| *Shipping service provider*
|Displays the shipping service provider. +
This is an optional column.

|*Actions*
|Displays further actions (material:more_vert[]) that are available for this order.
|===
...
| *Item ID*
|Displays the item ID of this order item. You can open the item by clicking on the ID. +
This is a default column.

| *Variation number*
|Displays the variation number of this order item. +
This is a default column.

| *Variation name*
|Displays the variation name of this order item. +
This is a default column.

| *Variation ID*
|Displays the variation ID of this order item. You can open the variation by clicking on the ID. +
This is a default column.

| *Item name*
|Displays the item name of this order item. +
This is an optional column.
...
| *Net price*
|Displays the net price of this order item. +
This is a default column.

| *Regular net price*
|Displays the regular net price of this order item. +
This is an optional column.

| *Gross price*
|Displays the gross price of the order item. +
This is a default column.

| *Discount [%]*
|Displays the discount that was selected for this order item. +
This is a default column.
...
|Displays the total net amount of the order item. +
This is a default column.

| *Total amount of the order (gross)*
|Displays the total gross amount of the order item. +
This is a default column.

| *Warehouse*
|Displays the warehouse of the order item. +
This is a default column.

| *VAT [%]*
|Displays the VAT rate of the order item in percent. +
This is a default column.

| *External item ID*
|Displays the external item ID. +
This is an optional column.

| *External order item ID*
|Displays the external order item ID transferred by the market. +
This is an optional column.

| *Property ID*
|Displays the ID of the property. +
This is an optional column.

| *Storage locations*
|Displays the storage locations of this order item. +
This is an optional column.

| *Net profit margin*
|Displays the net profit margin of the order item. +
This is an optional column.

| *Note*
|Displays a note for the order item. +
This is a default column.

| *Return reason*
|Displays the return reason of the order item in case of a return. +
This is a default column.

| *Remaining item value [%]*
|Displays the remaining item value in %. +
This is a default column.

| *Item status*
|Displays the item status of this order item. +
This is a default column.

| *Reorder ID*
|Displays the ID of the reorder. You can open the reorder by clicking on the ID. +
This is a default column.
|===
...
*_Note:_* If you want to edit the properties of order items, open the desired order, go to the *Order items* area and click on *Edit* (material:edit[]).
