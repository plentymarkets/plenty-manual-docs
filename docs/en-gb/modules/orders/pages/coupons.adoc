...
:author: team-crm
:description: Learn how to manage coupons and coupon campaigns in plentymarkets. Moreover, find out how to generate coupon codes and send emails.
...
//If you want to prevent an item from being paid for with a coupon, then go to *Item » Items » [Open item] » Element: Settings* and set the option *Promotional coupon* to *Not permitted*.
