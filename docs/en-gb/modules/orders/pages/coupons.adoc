...
Because each coupon belongs to a campaign, you have to create a campaign first. Go to *Orders » Coupons* to create a campaign. Once you have created a campaign, 2 other tabs are displayed apart from the *Settings* tab: xref:orders:coupons.adoc#set-up-coupon-template[Templates].
...
| *Customer classes*
| Select the xref:crm:managing-contacts.adoc#15[customer classes] that are allowed to redeem the coupon. You need to select at least one customer class.

| *Customer types*
| Select the xref:crm:managing-contacts.adoc#20[customer types] that are allowed to redeem the coupon. You need to select at least one customer type.
...
| *Coupon variety*
|Refer to the explanations in <<#table-settings-coupon-campaign>> and to the xref:orders:coupons.adoc#example-calculation-coupons[example] below the table for further information about the coupon varieties *Promotional coupon* and *Multipurpose coupon*.
