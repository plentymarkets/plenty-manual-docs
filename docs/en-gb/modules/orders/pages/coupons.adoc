...
Before you sell coupons in your online shop, you first need to create a xref:orders:coupons#create-campaign.adoc[coupon campaign] and set the coupon variety to *Multipurpose coupon*. For further information, refer to <<#table-settings-coupon-campaign>>.
