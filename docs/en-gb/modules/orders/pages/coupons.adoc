...
| *Allow* = Allow whether coupons can also be redeemed for items coming from xref:markets:markets.adoc#_using_price_search_engines[price search engines], i.e. items that are also offered on other marketplaces.  +
