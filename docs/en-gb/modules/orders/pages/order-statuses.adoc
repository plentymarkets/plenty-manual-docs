...
Additionally, you can decide how the order statuses are displayed in your plentymarkets system. Use the toggle button *Show status ID in status name* to decide whether only the given status name or whether the status ID is displayed additionally.
