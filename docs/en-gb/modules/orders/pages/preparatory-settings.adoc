...
| *Change status*
|Orders > Update +
*_Note:_* In case you cannot see certain statuses in the order overview, in the order details or in group or menu functions, you need the respective rights for the *Selectable order statuses*. Ask an admin to grant you the required rights in the *Setup » Settings » User » Accounts » [select account] » Tab: Rights* menu.
