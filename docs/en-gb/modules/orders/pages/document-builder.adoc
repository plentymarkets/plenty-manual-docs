...
:keywords: documents template, document template, template, documents, templates, generate documents, documentbuilder, document builder, DocumentBuilder, documentBuilder, Widgets, code widget, widgets
...
|In this widget you can implement individual styling such as bold quantities of order items or more complex representations of data. +
Click on terra:placeholder_show_list[role="darkGrey"] to open the list of variables on the left side of the screen. Use the search function to find the variables or find the appropriate variables by expanding the individual areas (material:chevron_right[]). Click on the variable you want to insert. The variable is inserted at the point where you place the cursor. +
