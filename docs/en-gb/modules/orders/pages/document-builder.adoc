...
** <<#variables-order-item-totals-foreign-currency, order item totals in foreign currency>>
** <<#variable-order-item-property, property of the order item>>
** <<#variables-order-item-totals-system-currency, order item totals in system currency>>
