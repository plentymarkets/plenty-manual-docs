...
Free text fields have to be defined beforehand in the menu *xref:item:managing-items.adoc#70[Setup » Item » Free text fields]*. After defining the free text fields, link them to their corresponding items and enter values for the fields. Use the menu <<item/managing-items#170, *Item » Edit item » Default Item » Fields*>>.
