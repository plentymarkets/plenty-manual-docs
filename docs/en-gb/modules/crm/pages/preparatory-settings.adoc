...
|Do you want to use this layout as standard layout? If so, activate the toggle button (material:toggle_on[role=skyBlue]). In the overview on the left side, the standard address layout is marked with an asterisk.
