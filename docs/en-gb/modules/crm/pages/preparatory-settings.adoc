...
*_Tip:_* If you want to activate multiple payment methods all at once, Wenn du mehrere Zahlungsarten auf einmal aktivieren möchtest, hold down the cmd key and select the desired payment methods from the list using the mouse.
