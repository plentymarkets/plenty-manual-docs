...
*_Tip:_* If you want to activate multiple payment methods all at once, hold down the cmd key or control key and select the desired payment methods from the list using the mouse.
