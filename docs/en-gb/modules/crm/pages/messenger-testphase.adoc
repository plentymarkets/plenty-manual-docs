...
Search the <<#search-conversation, conversation>> that contains the message you want to reply to. Click on the message to reply to it. When replying to an existing message, you can see all recipients that will receive this message. You can add more recipients. If desired, select a template from the drop-down list *Template* and a template language.
