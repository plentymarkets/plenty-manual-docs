...
.Notifications about new messages in your plentymarkets Backend
...
The only difference compared to <<#create-message, creating a message>> is that you can show and hide the subject line when replying to an existing message by clicking on the symbol material:more_vert[] (see <<#image-messenger-reply-to-message>>). 
