...
When the subject is activated (icon:toggle_on[set=material, role=skyBlue]), you can adjust the subject. If you have _not_ activated the subject (icon:toggle_off[set=material, role=darkGrey]), the *Subject* field is not visible when replying to the message.
