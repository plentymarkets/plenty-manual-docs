...
|The column icon:notifications[set=material, role=darkGrey] shows with the symbol icon:done[set=material, role=darkGrey] whether you have <<#subscribe-conversation, subscribed for>> the conversation.
...
In the navigation on the left side of the messenger, you can find the folder icon:3p[set=material, role=darkGrey] *My messages* below the folder icon:inbox[set=material, role=darkGrey] *Inbox*. You can see all conversations here that you <<#subscribe-conversations, subscribed for>>. 
