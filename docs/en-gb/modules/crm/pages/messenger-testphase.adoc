...
. Enter the subject of the message in the *Subject* field.
. Enter the message in the text field.
. Click on icon:visibility_on[set=material, role=darkGrey] (*Whisper mode*) to be able to bill the message. +
*_Note:_* The symbol icon:visiblity_off[set=material, role=skyBlue] shows you that a message is whispered.
