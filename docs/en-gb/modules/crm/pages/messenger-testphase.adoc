...
|In the *Priority* column, the star symbols show the priority of the conversation. Right next to the title bar, click on material:arrow_upward[] or material:arrow_downwar[] to sort the table in ascending or descending order by the priority. +
