...
====
We recommend to use the default template *Messenger default* for the Messenger. This template is already available in your system in the *CRM » EmailBuilder* menu in the *Default templates* folder. You can, of course, adjust this template according to your needs.
...
If you do _not_ want to use the default template for the messenger in this step, but a custom email template, make sure that the email template that you create in the *CRM » EmailBuilder* menu, contains at least the following variables:
