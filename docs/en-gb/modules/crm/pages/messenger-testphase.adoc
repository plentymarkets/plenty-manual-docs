...
====
In the *CRM » EmailBuilder (Test phase)* menu, you can find the *Messenger* folder that contains a default template for the messenger. You can, of course, adjust this template according to your needs. The template contains the following variables:
