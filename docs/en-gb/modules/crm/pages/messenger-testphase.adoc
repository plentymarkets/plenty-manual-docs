...
If you open the *CRM » Messenger (Test phase)* menu, you can see the number of new messages by means of the number next to the symbol material:notifications[]. Click on material:notifications[] to open the notification window.
