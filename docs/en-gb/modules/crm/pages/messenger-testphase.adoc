...
* *Navigation*: Here you can navigate through different parts of the menu. The currently selected area (blue background) is displayed in the main window on the right. Click on material:menu[role=darkGrey] to expand or collapse the navigation bar. +
...
** *Overview*: When you start a search, you’ll see the results in an overview. The overview provides information about the conversations found at a glance. You see, for example, the email addresses of the senders, the subject, the date when the message was received, the assigned tags and by means of the icon material:attach_file[role=darkGrey], you can see whether the message has an attachment. +
...
In this step, activate the Messenger service for this inbox. If the button is blue (material:toggle_on[role=skyBlue]), the service is activated. If the button is grey (material:toggle_off[role=darkGrey]), the service has _not_ been activated yet.
...
To be able to send messages with the messenger, the live mode in the *Email accounts* assistant in the *Login details* step has to be activated (material:check_box[role=skyBlue]).

Setting the test mode to *inactive* can be done in this step without having to leave the assistant. To do so, select (material:check_box[role=skyBlue]) the option *Activate live mode*.
...
. Click in the top left on material:add[role=darkGrey] *New message*.
...
. Click on *Add attachments* (material:attach_file[role=darkGrey]) to add attachments to the message.
. Click on *Assign tags to message* (material:local_offer[role=darkGrey]) to assign tags for the message.
. Select further options, if needed, by clicking on material:more_vert[role=darkGrey]. Note <<#table-create-new-message>>.
...
|[#intable-add-attachments]*Add attachments* (material:attach_file[role=darkGrey])
|Click on material:attach_file[role=darkGrey] to add attachments to your message. Select as many attachments as you like from your computer. +
The following file types can be sent as an attachment: bmp, csv, gif, jpeg, json, pdf, png, tiff, txt, xlsx, zip.

|[#intable-whisper-mode]*Whisper mode* (material:visibility[role=darkGrey] / material:visibility_off[role=skyBlue])
|You can whisper messages to make these messages only visible for internal purposes but _not_ for your contacts. To do so, click on *Whisper mode* (material:visibility[role=darkGrey]). +
...
|[#intable-assign-tags-message]*Assign tags to message* (material:local_offer[role=darkGrey])
|Click on material:local_offer[role=darkGrey] to search for tags and select already existing tags for the message (material:check_box[role=skyBlue]), add new tags (material:add[role=darkGrey]) and edit existing tags (material:edit[role=darkGrey]). +
...
|[#intable-bill-message]*Bill message* (material:more_vert[role=darkGrey])
|You can always bill a message as long as it is a <<#intable-whisper-mode, whispered message>>. Click on material:more_vert[role=darkGrey] first. If you then activate the button *Bill message* (material:toggle_on[role=skyBlue]), this message will be billed. The button changes from material:forward_to_inbox[role=skyBlue] *SEND* to material:visibility_off[role=skyBlue] *BILL AND SEND*. +
...
|You can start a timer for every message. Click on material:more_vert[role=darkGrey] first. If you activate the *Timer* button (material:toggle_on[role=skyBlue]), the timer next to the material:forward_to_inbox[role=skyBlue] *SEND* button will start running automatically. +
Click on material:pause_circle[role=darkGrey] to stop the timer and on material:play_circle[role=darkGrey] to start the timer again.

|[#intable-manage-inboxes]*Manage inboxes* (material:more_vert[role=darkGrey])
|Click on material:more_vert[role=darkGrey] first and afterwards on material:edit[role=darkGrey] *Manage inboxes*. You will be redirected to the *Setup » Assistants » Basic setup* menu. Here, you can edit the inboxes via the available *Messenger configuration* <<#complete-assistant, assistants>>.

|[#intable-send]*SEND*
|By clicking on material:forward_to_inbox[role=skyBlue] *SEND*, the message will be sent. +
*_Note:_* If you bill the message, the button changes to material:visibility_off[role=skyBlue] *BILL AND SEND*. If you whisper the message, this button is changed to material:visibility_off[role=skyBlue] *WHISPER*.
...
Open all conversations in a list or select filters (material:tune[role=darkGrey]) to narrow down the search results in the Messenger overview.
...
. Go to *CRM » Messenger (Test phase)*. +
* *_Option 1:_* Click on material:search[role=darkGrey] to see a list of all conversations.
...
* *_Option 3:_* Click on material:tune[role=darkGrey] to narrow down the search results with filters.
...
|Enter a date or select the dates from the calendars (material:today[role=darkGrey]) to search for conversations within a certain time period.
...
. Click on *SAVE*. +
→ The filter now appears under *Saved filters* (material:bookmarks[role=darkGrey]).

[TIP]
Use drag-and-drop to arrange the filters in a specific order by clicking on *Move* (material:drag_indicator[role=darkGrey]). Click on material:delete[role=darkGrey] to delete a filter.
...
In the line of the saved filter, click on material:star[role=darkGrey] *Set as default*. If you want to set another filter as default filter, deactivate the currently selected default filter by clicking on material:star_outline[role=darkGrey] *Do not use as default*.

[#configure-columns]
== Configuring columns

By clicking on material:settings[role=darkGrey] on the top right, you can have the following columns displayed in the overview of the Messenger:
...
|Opens the available relations that are linked with the conversation by clicking on material:chevron_right[role=darkGrey].

|[#intable-overview-selection]*Selection*
|Shows the checkbox for the <<#group-function, group function>> (material:check_box_outline_blank[role=darkGrey]) in the overview.
...
|Right next to the title bar, click on material:arrow_upward[role=darkGrey] or material:arrow_downward[role=darkGrey] to sort the table in ascending or descending order by the ID.
...
* material:person[role=darkGrey] _Name of the contact (contact ID)_ 
* material:shopping_cart[role=darkGrey] _Order ID_
...
* material:mail[role=darkGrey] _Email address_
* material:credit_card[role=darkGrey] _Payment ID_
* subscribers of the conversation.

In the line of the conversation, click on material:chevron_right[role=darkGrey] to see all available relations at a glance. Click on material:expand_more[role=darkGrey] to close the relation area again. +
...
|Shows the date and the time when the conversation was created. Right next to the title bar, click on material:arrow_upward[role=darkGrey] or material:arrow_downward[role=darkGrey] to sort the table in ascending or descending order by the date.

|[#intable-overview-updated-at]*Updated at*
|Shows the date and the time when the conversation was updated. Right next to the title bar, click on material:arrow_upward[role=darkGrey] or material:arrow_downward[role=darkGrey] to sort the table in ascending or descending order by the date.
...
|The symbol material:attach_file[role=darkGrey] in the *Number of attachments* (material:attach_file[role=darkGrey]) column shows whether the conversation has attachments. When you hover with your cursor over the symbol, you can see how many attachments the conversation has. Right next to the title bar, click on material:arrow_upward[role=darkGrey] to sort the table by the number of attachments.

|[#intable-overview-billed-messages]*Billed messages*
|The symbol material:credit_card[role=darkGrey] in the column *Billed messages* (material:credit_card[role=darkGrey]) shows whether the conversation has billed messages. When you hover with your cursor over the symbol, you can see the number of billed messages. Right next to the title bar, click on material:arrow_upward[role=darkGrey] to sort the table by the number of billed messages.

|[#intable-overview-billed-minutes]*Billed minutes*
|The symbol material:av_timer[role=darkGrey] in the column *Billed minutes* (material:av_timer[role=darkGrey]) shows whether the conversation has billed minutes. When you hover with your cursor over the symbol, you can see the number of billed minutes. Right next to the title bar, click on material:arrow_upward[role=darkGrey] to sort the table by the number of billed minutes.

|[#intable-overview-subscribed]*Subscribed*
|The column material:notifications[role=darkGrey] shows with the symbol material:done[role=darkGrey] whether you have <<#subscribe-for-conversation, subscribed for>> the conversation.
...
Click on the button *Configure columns* (material:settings[role=darkGrey]) on the top right to deactivate the columns that are already shown in the overview.
...
The only difference to <<#create-message, creating a message>> is that you can show and hide the subject line when replying to an existing message by clicking on the symbol material:more_vert[role=darkGrey] (see <<#image-messenger-reply-to-message>>). 

[[image-messenger-reply-to-message]]
.Replying to a message
image::crm:messenger-reply-to-message.png[width=640, height=360]

You can adjust the subject, when the option *Subject* is activated (material:toggle_on[role=skyBlue]). If you have _not_ activated the option *Subject* (material:toggle_off[role=darkGrey]), the *Subject* field is not visible when replying to the message.
...
It is possible to change the view in the Messenger from a table to a list. To do so, click on *Change view* (material:list[role=darkGrey]) in the top right of the overview. +
...
The following functions are available in the Messenger overview when clicking in the line of the conversation on material:more_vert[role=darkGrey].
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to mark as read, click on material:more_vert[role=darkGrey].
. Click on material:mark_email_read[role=darkGrey] *Mark conversation as read*. +
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to mark as unread, click on material:more_vert[role=darkGrey].
. Click on material:mark_email_unread[role=darkGrey] *Mark conversation as unread*. +
...
. Go to *CRM » Messenger (Test phase)*.
. Click in the line of the conversation on material:more_vert[role=darkGrey].
. Click on material:local_offer[role=darkGrey] *Assign tags to conversation* to see a list of all tags that you have already <<#tags-messenger, created>> for the areas *Messages* and *Messages (billable)*. +
...
. Go to *CRM » Messenger (Test phase)*.
. Click in the line of the conversation on material:more_vert[role=darkGrey].
. Click on material:local_offer[role=darkGrey] *Assign tags to conversation*.
. Click on material:add[role=darkGrey] *Add tag* to create a new tag. +
...
. Click in the line of the conversation on material:more_vert[role=darkGrey].
. Click on material:local_offer[role=darkGrey] *Assign tags to conversation*.
. Click on material:edit[role=darkGrey] *Edit tag* to edit an existing tag. +
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to mark as done, click on material:more_vert[role=darkGrey].
. Click on material:circle[role=darkGrey] *Mark conversation as done*. +
→ At the beginning of the conversation’s line, the symbol material:circle[role=green] is shown.
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to mark as not done, click on material:more_vert[role=darkGrey].
. Click on material:radio_button_unchecked[role=darkGrey] *Mark conversation as not done*. +
→ At the beginning of the conversation’s line, the symbol material:circle[role=green] is removed.
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to subscribe for, click on material:more_vert[role=darkGrey].
. Click on material:notifications_active[role=darkGrey] *Subscribe for conversation*. +
→ The column material:notifications[role=darkGrey] *Subscribed* does not show the symbol material:done[role=darkGrey] any longer.
...
. Go to *CRM » Messenger (Test phase)*.
. Click in the line of the conversation that you want to unsubscribe from on material:more_vert[role=darkGrey].
. Click on material:notifications_off[role=darkGrey] *Unsubscribe from conversation*. +
→ The column material:notifications[role=darkGrey] *Subscribed* does not show the symbol material:done[role=darkGrey] any longer.
...
. Go to *CRM » Messenger (Test phase)*.
. In the line of the conversation that you want to delete, click on material:more_vert[role=darkGrey].
. Click on material:delete[role=darkGrey] *Delete*. +
...
. Enter the subject of the message in the *Subject* field.
. Enter the message in the text field.
. Click on material:visibility[role=darkGrey] to whisper the message. +
*_Note:_* Only whispered messages can be billed. The symbol material:visibility_off[role=skyBlue] shows you that a message is whispered.
. Click on material:local_offer[role=darkGrey] to assign tags for the message. +
...
. Click on material:more_vert[role=darkGrey].
. Activate the button *Bill message* (material:toggle_on[role=skyBlue]).
. Click on material:visibility_off[role=skyBlue] *BILL AND SEND*. +
...
. Activate the field *Bill minutes* (material:check_box[role=skyBlue]).
. Click on *Confirm*.
...
Once you selected a message within a conversation, you can display the messages’ content in plain text format by clicking on material:chevron_right[role=darkGrey] at the beginning of the message. This way, you are able to see a preview of the message content already without <<#open-single-message, opening>> the entire message.

[#open-single-message]
=== Opening a message

To open a message, you can either directly click on the message. Or you open the context menu in the line of the message by clicking on material:more_vert[role=darkGrey] and then on material:open_in_new[role=darkGrey] *Open message*.
...
. Click on material:local_offer[role=darkGrey] *Assign tags to message* to see a list of all tags that you have already <<#tags-messenger, created>> for the areas *Messages* and *Messages (billable)*. +
*_Tip:_* If you have created a lot of tags for the *Messages* or *Messages (billable)* areas, enter the name of the tag in the search field *Search for tag*.
...
. Open the message by clicking in the line of the message.
. Click on material:more_vert[role=darkGrey].
. Click on material:attach_file[role=darkGrey] *Attachments*.
. Click on one attachment or on material:file_download[role=darkGrey] *Download all files*. +
...
In the navigation on the left side of the messenger, you can find the folder material:mark_chat_unread[role=darkGrey] *New messages* below the folder material:inbox[role=darkGrey] *Inbox*.
...
|The symbol material:attach_file[] in the *Number of attachments* (material:attach_file[role=darkGrey]) column shows whether the conversation has attachments. When you hover with your cursor over the symbol, you can see how many attachments the conversation has. Right next to the title bar, click on material:arrow_upward[role=darkGrey] to sort the table by the number of attachments.
...
In the navigation on the left side of the messenger, you can find the folder material:3p[role=darkGrey] *My messages* below the folder material:inbox[role=darkGrey] *Inbox*. You can see all conversations here that you <<#subscribe-for-conversation, subscribed for>>. 
...
In the navigation on the left side of the Messenger, you can find the folder material:delete[role=darkGrey] *Trash*. Here you can find all <<#context-menu-delete-conversation, deleted conversations>> and all<<#delete-single-message, deleted messages>>.
