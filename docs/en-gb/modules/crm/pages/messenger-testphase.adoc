...
In this step, activate the Messenger service for this inbox. If the button is blue (material:toggle_on[role=skyBlue]), the service is activated. If the button is grey (material:toggle_off[]), the service is _not_ activated.
