...
All emails that are sent with plentysystems are based on email templates. Use the xref:crm:emailbuilder.adoc#[EmailBuilder] to create your templates quickly and intuitively.
