...
. Select a language from the list.
. At the end of the *Content* line, click on material:edit[].
. Enter the text block’s content in the editor. +
*_Tip:_* Use the usual formatting options of the editor, if desired, or click on *Source code* at the top left to enter HTML code for the text block.
...
. Adjust the settings. Note <<#table-emailbuilder-create-template>> and <<#image-emailbuilder-template>>.
. *Save* (material:save[]) the settings.
...
|In the tab of the corresponding language, click on material:more_vert[] and then on material:content_copy[] *Copy* to copy the content and the language settings of the template for another language. +
...
|In the tab of the corresponding language, click on material:more_vert[] and then on material:delete[] *Delete*. After you have confirmed your decision, the template will be deleted.
...
| *Email meta data*
|Here you can save meta tags in the `<head> element`. +
For general information about meta tags, refer to this link:https://www.w3schools.com/tags/tag_meta.asp[page^].
