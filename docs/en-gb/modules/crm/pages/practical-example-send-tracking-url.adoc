...
Now create an email template that contains the variable for the tracking URL. You can also use one of the xref:crm:emailbuilder-work-with-emailbuilder.adoc#use-default-templates[available default templates] and xref:crm:emailbuilder-work-with-emailbuilder.adoc#edit-template[adjust] it afterwards. +
...
. Select a xref:crm:emailbuilder-work-with-emailbuilder.adoc#template-header-footer[header and footer] each from the drop-down lists.
. Click on *SAVE*. +
...
* xref:crm:emailbuilder-overview.adoc#[EmailBuilder]
