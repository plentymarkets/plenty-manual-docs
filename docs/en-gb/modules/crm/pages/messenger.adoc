...
. Go to *CRM » Contacts*.
. Search (icon:search[role="blue"]) the contact(s) by means of the filter settings as described on the user manual page xref:crm:managing-contacts.adoc#[Contacts] in the xref:crm:managing-contacts.adoc#200[Searching for a contact] chapter. +
