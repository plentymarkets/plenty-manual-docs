...
You can find the *Email accounts* assistant in the *Setup » Client » Global » Email accounts* menu. For further information about collecting the emails, refer to the xref:crm:emailbuilder-preparatory-settings.adoc#email-messenger-integration[Messenger integration] chapter on the xref:crm:emailbuilder-preparatory-settings.adoc#[EmailBuilder: Carrying out the preparatory settings] page.
...
|Select a template from the list. The list shows all templates that you created in the xref:crm:emailbuilder-overview.adoc#[EmailBuilder]. +
...
For further information, refer to the xref:crm:emailbuilder-preparatory-settings.adoc#email-messenger-integration[EmailBuilder] page.
