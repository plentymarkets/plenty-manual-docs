...
On this page, you can find questions and answers about the CRM area. 
...
If the address is linked with an order, you _cannot_ delete this address. This is related to the legal retention period.

To avoid that “old” addresses of your contacts are used by mistake when creating an order, the new address has to be set as primary invoice and delivery address. Once this setting has been carried out, this new primary address will be shown by default both when creating a new order in your plentymarkets back end and in your online shop.
--
...
== GDPR / Anonymising and deleting data
...
* Click onicon:user-secret[] (*Anonymise data record*) in the upper line.
