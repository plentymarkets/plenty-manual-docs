...
You can find a practical example with instructions which settings to check after the migration of the old email templates on the user manual page xref:crm:practical-example-migratoin-templates.adoc#[EmailBuilder: Todo after the migration of the old email templates]. +
...
--
Go to *Setup » Assistants » Basic setup* and open the *Email accounts* assistant. Go to the *Login details* step. You can find in the area *Would you like to activate the live mode?* the checkbox *Activate live mode*.
