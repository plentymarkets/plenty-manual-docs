...
This page of the manual describes which settings you need to carry out to send newsletters with plentymarkets. Send your newsletters e.g. with the xref:crm:sending-newsletters.adoc#100[newsletter service integrated in plentymarkets], via the integrated interface to xref:crm:sending-newsletters.adoc#1700[CleverReach] or via other email marketing and newsletter plugins available in the link:https://marketplace.plentymarkets.com/en/plugins/integration[plentyMarketplace^]{nbsp}icon:external-link[].
