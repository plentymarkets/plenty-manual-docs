...
This page of the manual describes which settings you need to carry out to send newsletters with plentymarkets. Send your newsletters e.g. with the xref:crm:sending-newsletters.adoc#1700[CleverReach] or via other email marketing and newsletter plugins available in the link:https://marketplace.plentymarkets.com/en/plugins/integration[plentyMarketplace^]{nbsp}icon:external-link[].
...
Further information can be found in the xref:crm:sending-emails.adoc#[Emails] page of the manual.
|====
...
The previous chapters describe how to manage individual email addresses. If you want to edit several email addresses at once, it is recommended that you work with the xref:data:elasticSync-newsletter-recipient.adoc#[Newsletter recipient].

You can also export email addresses. To do so, create an xref:data:elastic-export.adoc#[Elastic export].
...
| *Customer class*
| Select a xref:crm:managing-contacts.adoc#15[customer class] to filter customers who belong to this class.
