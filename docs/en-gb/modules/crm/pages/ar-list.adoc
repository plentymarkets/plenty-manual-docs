...
By clicking on *Open messenger* material:ticket_message[], you are redirected to the *Messenger* area in the contact data record of the customer you selected. +
This is a default column.
