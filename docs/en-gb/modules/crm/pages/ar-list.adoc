...
You can set default settings for xref:crm:ar-list.adoc#filter[search filters] of the AR list in the *Setup » CRM » Settings* menu. Note <<#table-default-settings-filters-ar-list>>.
