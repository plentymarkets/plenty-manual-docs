...
====
To make the AR list visible for users without admin rights, you have to activate the option. To do so, go to *Setup » Account management » Roles* and select in the xref:business-decisions:user-accounts-access.adoc#106[simple mode] the option *CRM > AR list > See*. Afterwards, you have to xref:business-decisions:user-accounts-access.adoc#110[assign] this role in the user account.
====
