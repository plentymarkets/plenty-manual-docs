...
====
The functions in the *Setup » Client » [Select client] » Email* menu will not be developed further. You can still see and use the function. However, no new features or extensions will be implemented. We recommend that you use the EmailBuilder. For further information, refer to the xref:crm:emailbuilder.adoc#[EmailBuilder] page.
====
