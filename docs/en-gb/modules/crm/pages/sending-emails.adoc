...
You can adapt your email templates to the design of your online shop, e.g. by inserting your company logo in the HTML design. First, you have to upload the logo to the webspace. After you created the email template, you insert the xref:crm:sending-emails.adoc#1100[link] the design with this email template.
...
Now create the email template as described in the following chapters. Afterwards, you insert the xref:crm:sending-emails.adoc#1100[link] the design with the email template.
...
An xref:crm:using-the-ticket-system.adoc#2100[Ticket system] page of the manual.

[#2000]
=== Sending coupons via email

You can send coupons and coupon codes via email. Simply attach them to emails as PDF files. For further information, refer to the chapters xref:orders:coupons.adoc#[Coupons] page of the manual.
