...
You can adapt your email templates to the design of your online shop, e.g. by inserting your company logo in the HTML design. First, you have to upload the logo to the webspace. After you created the email template, you insert the <<crm/sending-emails#1750#, logo in the HTML design>> and xref:crm:sending-emails.adoc#1100[link] the design with this email template.
...
====
To see a CMS syntax overview that you can still use in the "old" email templates, refer to this xref:online-store:cms-syntax.adoc#[section of the manual].
==== 
