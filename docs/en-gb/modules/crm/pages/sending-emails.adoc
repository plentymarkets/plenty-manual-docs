...
All emails that are sent with plentymarkets are based on email templates. Go to *Setup » Client » [Select client] » Email » Templates* to manage email templates. Create as many email templates as desired. In case of certain events, e.g. when a contact subscribes to your newsletter, your plentymarkets system automatically creates emails from these templates and sends them to your contacts. You determine the time when the emails are to be sent automatically.
