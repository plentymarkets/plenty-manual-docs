...
====
Click on *New order (beta)* to generate orders with the new logic. For further information, refer to the <<orders/managing-orders#245, beta: Creating an order or an offer in the contact overview>> chapter on the xref:orders:managing-orders.adoc[Managing orders] page.
====
