...
====
The *CRM » Contacts (deprecated)* menu will not be developed any further. You can still see and use this menu. However, no new features or extensions will be implemented. We recommend using the new menu *CRM » Contacts*. For further information, refer to the xref:crm:contacts.adoc#[Contacts] page and this link:XXX[forum thread^].
====
