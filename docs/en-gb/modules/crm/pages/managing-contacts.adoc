...
To do so, click on *Edit view* (terra:design_inline_edit[]) in the top right.

[discrete]
===== Editing single components

Afterwards, you can edit (icon:pencil[]) or delete (terra:trash[]) the individual components. When you edit the component, you can see in the *Elements* area on the right side which elements have not been used yet and are therefore still available. Elements that are already in use are disabled and cannot be used a second time.
...
Click on *Save view* (icon:save[]) to save the view under the current name. By doing so, you can save as many different views as you like. When you want to manually create a contact data record the next time, you can open your preferred view via the drop-down list in the top right and start creating a new contact. Also via this drop-down list, you can create a new view by clicking on terra:add[role=green] *Create new preset*.
...
|Click on *Invoice address* (terra:credit_note[role=blue]) to select this option. +
By clicking on terra:copy[] *Derive new invoice address*, a new invoice address based on the currently selected address is created. In order to create a new address with a new ID, changes have to be made to the data of the new invoice address.

|[#intable-edit-address-add-invoice-address-type]*Add invoice address type*
|Click on *Invoice address* (terra:credit_note[role=blue]) to select this option. +
By clicking onterra:add[] *Add invoice address type*, the type *Invoice address* is added to the address. The ID does not change. +
...
|Click on *Invoice address* (terra:credit_note[role=blue]) to select this option. +
By clicking on terra:delete[] *Delete invoice address type*, the type *Invoice address* is deleted from the address. +
...
|Click on *Invoice address* (terra:credit_note[role=blue]) to select this option. +
By clicking on terra:flag_star[] *Define as primary invoice address*, the currently selected invoice address is set as primary invoice address. The ID does not change. +
If the *Invoice address* type is not selected, this option is deactivated. +
*_Note:_* If the invoice address has already been defined as primary, this setting can be undone by clicking on terra:flag_star[] *Reset primary invoice address*.
...
|Click on *Delivery address* (terra:delivery_note[role=blue]) to select this option. +
By clicking on terra:copy[] *Derive new delivery address*, a new delivery address based on the currently selected address is created. In order to create a new address with a new ID, changes have to be made to the data of the new delivery address.

|[#intable-edit-address-add-delivery-address-type]*Add delivery address type*
|Click on *Delivery address* (terra:delivery_note[role=blue]) to select this option. +
By clicking on terra:add[] *Add delivery address type*, the type *Delivery address* is added to the address. The ID does not change. +
...
|Click on *Delivery address* (terra:delivery_note[role=blue]) to select this option. +
By clicking on terra:delete[] *Delete delivery address type*, the type *Delivery address* is deleted from the address. +
...
|Click on *Delivery address* (terra:delivery_note[role=blue]) to select this option. +
By clicking on terra:flag_star[] *Define as primary delivery address*, the currently selected delivery address is set as primary delivery address. The ID does not change. +
*_Note:_* If the *Delivery address* type is not selected, this option is deactivated. +
If the delivery address has already been defined as primary, this setting can be undone by clicking on terra:flag_star[] *Reset primary delivery address*.
