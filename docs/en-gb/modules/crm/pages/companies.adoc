...
. Go to *CRM » Companies*.
. Click on the left side on material:add[] *New company*.
...
Click in the company data record in the *Linked contacts* area in the top right on *Configure columns* material:settings[], select the desired columns and click on *Confirm*. The following columns are available:
...
→ The companies that correspond to the search criteria entered are shown.
. Click in the line of the company.
. Click in the *Linked contacts* area on *Link contacts* (material:more_vert[]). +
→ A new window opens.
...
→ The companies that correspond to the search criteria entered are shown.
. Click in the line of the company.
. Click in the *Linked contacts* area in the line of the contact on material:more_vert[]. +
→ A new window opens.
. Click on material:delete[] *Delete contact link*. +
...
→ The companies that correspond to the search criteria entered are shown.
. Click in the line of the company.
. Click on the top in the toolbar on *Delete* (material:delete[]). +
