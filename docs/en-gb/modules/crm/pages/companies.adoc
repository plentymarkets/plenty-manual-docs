...
** *Detail view*: When you open a company, its details are displayed in the main window on the right. The detail view of a company is divided into the areas *Company details*, *Linked contacts*, *Supplier details*, *Messenger* and *Orders*. +
The *Messenger* area shows all conversation of all contacts that are linked with this company. The *Orders* area shows all orders of all contacts that are linked with this company.
...
For the following areas, you can specify which columns should be displayed there:

* <<#columns-company-overview, Company overview>>
* <<#columns-linked-contacts, Linked contacts>> area in the company data record
* <<#columns-messenger, Messenger>> area in the company data record
* <<#columns-orders, Orders>> area in the company data record

[#columns-company-overview]
=== Company overview

Click in the company overview in the top right on *Configure columns* (material:settings[]) and activate (material:check_box[role=skyBlue]) the columns that you want to see in the overview. +
You can also deactivate (material:check_box_outline_blank[]) activated columns again. +
Click on material:drag_indicator[] and hold down the symbol to change the order of the columns with drag-and-drop. The following columns are available:
...
Click in the company data record in the *Linked contacts* area in the top right on *Configure columns* (material:settings[]) and activate (material:check_box[role=skyBlue]) the columns that you want to see in the overview. +
You can also deactivate (material:check_box_outline_blank[]) activated columns again. +
Click on material:drag_indicator[] and hold down the symbol to change the order of the columns with drag-and-drop. The following columns are available:
...
[#columns-messenger]
=== Messenger in the company data record

The *Messenger* area shows all conversation of all contacts that are linked with this company.

Click in the company data record in the *Messenger* area in the top right on *Configure columns* (material:settings[]) and activate (material:check_box[role=skyBlue]) the columns that you want to see in this overview. +
You can also deactivate (material:check_box_outline_blank[]) activated columns again. +
Click on material:drag_indicator[] and hold down the symbol to change the order of the columns with drag-and-drop. The following columns are available:
...
You can create a new message in the *Messenger* area of the company data record. In this case, no contact is preselected. The search in the recipients fields only displays contacts that are linked with this company. 

For further information, refer to the xref:crm:messenger.adoc#[Messenger] page.

[#columns-orders]
=== Orders in the company data record

The *Orders* area shows all orders of all contacts that are linked with this company. +
Adding new orders is _not_ possible via the company data record. This area is therefore only intended to provide information and an overview.

Click in the company data record in the *Orders* area in the top right on *Configure columns* (material:settings[]) and activate (material:check_box[role=skyBlue]) the columns that you want to see in this overview. +
You can also deactivate (material:check_box_outline_blank[]) activated columns again. +
Click on material:drag_indicator[] and hold down the symbol to change the order of the columns with drag-and-drop. The following columns are available:
...
*_Note:_* Enter at least 3 letters of the name. Your system then suggests contacts that have already been saved.
...
[#delete-company]
== Deleting a single company

If you don’t need a company data record any longer, you can delete it any time. The contact data records that are linked with the company will _not_ be deleted. Only the assignment of the company to the contact and the company itself will be removed when deleting the company.

*_Note:_* The link to the company will also be removed in the contact data record in the *CRM » Contacts* menu.

If you want to delete multiple companies at the same time, note the explanations in the <<#delete-multiple-companies, Deleting multiple companies>> chapter.
...
Instead of deleting every company individually, you can save time and delete multiple contacts at the same time by using the group function. Once you selected (material:check_box[role=skyBlue]) at least one company in the overview, the material:more_vert[] button becomes visible. Behind this button, you can find the option to delete the selected companies.

[.instruction]
Deleting multiple companies at the same time:

. Go to *CRM » Companies*.
. Search the companies that you want to delete by means of the filter settings as described in the <<#search-company, Searching for a company>> chapter. +
→ The companies that correspond to the search criteria entered are shown.
. Select (material:check_box[role=skyBlue]) the companies that you want to delete.
. In the toolbar at the top, click on material:more_vert[] and then on *Delete* (material:delete[]). +
→ A window appears and you need to confirm your decision.
. Click on *Delete*. +
→ The companies are deleted and removed from the overview.
