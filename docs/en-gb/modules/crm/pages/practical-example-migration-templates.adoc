...
After the migration has been carried out also <<#box-migration-dates, in your system>>, it’s important that you check the content of the migrated templates in the *CRM » EmailBuilder* menu. To do so, open the preview of the corresponding templates (material:preview[]).
