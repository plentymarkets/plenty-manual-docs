...
* xref:crm:emailbuilder.adoc#automatic-email-despatch[Automatic despatch] in the *Setup » Client » Global » Email accounts* menu » Assistant: *Email accounts* » Step: *Automatic despatch*
