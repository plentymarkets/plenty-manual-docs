...
For further information, refer to the <<orders/managing-orders#240, beta: Creating an order or an offer in the contact overview>> chapter on the xref:orders:managing-orders.adoc#[Managing orders] page.
