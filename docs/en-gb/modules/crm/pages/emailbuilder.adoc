...
In the *Email accounts* assistant in the *Setup » Client » Global » Email accounts* menu, save the login details of a mailbox in the *Login details* step so that plentymarkets emails such as order or shipping confirmations can be sent from this email address. +
