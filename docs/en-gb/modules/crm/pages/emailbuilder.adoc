...
.Important: Add header and footer in the corresponding language
====
If you created a template in multiple languages, remember to create also the header and footer in these languages and to link them with the template. Otherwise, the template cannot be sent.
====
