...
In case of certain events, e.g. if a new order is placed in your plentyShop or when a contact subscribes to a newsletter, your plentymarkets system <<#automate-email-despatch, automatically creates emails from these templates>> and sends them to your contacts.
...
Now structure the content of your email by inserting variables via the widgets. How to proceed is described in the following chapter xref:crm:insert-widget.adoc#[Inserting a widget into a template].
