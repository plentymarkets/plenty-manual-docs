...
====
If you create a template in <<#add-language, multiple languages>>, remember to create also the header and footer in these languages and to link them with the template. Otherwise, the template cannot be sent.
====
...
////
[TIP]
.More twig expressions for the item list widget
====
