...
.Multipart format
====
The email templates in the EmailBuilder use the multipart format which has the advantage that the emails are sent in an HTML and in a text version at the same time.
====
...
. In the bottom left corner, click on material:add[] *Add* material:play_arrow[] > material:folder[] *Folder*. +
...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[] > material:folder[] *Folder*. +
→ The *Create new folder* window opens.
...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[] > material:web_asset[] *Header*. +
→ The *Create new header* window opens.
. Enter a name for the header.
. Click on *Save*. +
→ The header template is created.
. Click on *Add* (material:add[]) to add a language. +
→ A new window opens.
. Select a language from the list. +
→ The window *New name* opens.
. Enter the header template’s subject.
. Click on *Save*.
. In the *Settings* area, select (material:check_mark[role=skyBlue]) the owner and the client.
...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[] > material:video_label[] *Footer*. +
...
====
If you later edit multiple templates in the editor at the same time, you can use the navigation on the left to switch between the individual templates. The template that is currently opened is highlighted in blue. +
If you are in the editor of an template and want to switch to another template without having saved the changes beforehand, a message will be displayed.
====
...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[] > material:description[] *Template*. +
...
*_Note:_* If you do not want to create the template within a folder, directly click on material:add[] *Add* in the bottom left and select material:play_arrow[] material:description[]Template* afterwards. The template will then be created on the first level and does not belong to a folder.
...
|Click on material:add[] (*Add*) to select the language of the template.
...
|Click on material:preview[] and select *Preview HTML* or *Preview plain text*.

|[#intable-template-settings-copy]*Copy*
|Click on material:more_vert[] and then on material:copy_content[] *Copy* to copy the content and the settings of the template to another language. +
...
|Click on material:more_vert[] and then on material:delete[] *Delete* to delete the template.
...
--
In this area, you can find some common examples about how to adjust the styling of your template.
...
*_Template width:_* Enter `max-width:` followed by the desired width in pixel, e.g. `max-width:1200px`. +
...
Besides the content of the email template, the template name and the subject are already filled in in a default template. This means that you only have to select the header and footer and fill the fields *Reply to* and, if needed, also *CC* and *BCC*.
...
[TIP]
_Before copying the template_, carry out the settings in the <<#intable-general-template-settings, Settings>> area. The advantage of this sequence is that you also copy the settings and not only the template content. Thus, you don’t need to carry out the settings for the other templates again.
...
→ A new window opens.
. Click on material:copy_content[] *Copy*. +
→ A new window opens.
