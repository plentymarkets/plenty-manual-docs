...
====
In the item list widget, you can also use the twig expressions listed in the following. Note that these values are only available as twig expressions and can therefore _not_ be found in the list of available variables for the item list widget in the EmailBuilder.
