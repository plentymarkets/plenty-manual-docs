...
Let’s assume you have created a shipping confirmation in English and inserted widgets and variables. You now want to create this shipping confirmation also in French for your French-speaking customers. The quickest way is to copy the template and adjust the translation afterwards. How to proceed in this case is described in the <<#copy-template, Copying a template>> chapter.
