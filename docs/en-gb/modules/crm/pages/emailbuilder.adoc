...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[]. 
. Click on material:folder[] *Folder*. +
→ The *Create new folder* window opens.
...
→ A new window opens.
. Click on material:add[] *Add* material:play_arrow[].
. Click on material:video_label[] *Footer*. +
...
*_Note:_* If you do not want to create the template within a folder, click on the start page of the *CRM » EmailBuilder (Test phase)* menu in the bottom left on material:add[] *Add* material:play_arrow[] and click on material:description[] *Template* afterwards. The template will then be created on the first level and does not belong to a folder.
...
*_Note:_* If you do not want to create the default template within a folder, click on the start page of the *CRM » EmailBuilder (Test phase)* menu in the bottom left on material:add[] *Add* material:play_arrow[] and click on material:description[] *Template* afterwards. The template will then be created on the first level and does not belong to a folder.
