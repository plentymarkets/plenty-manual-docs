...
Once you selected (material:check_box[]) at least one contact in the overview, the different buttons become visible. <<#table-contact-group-functions>> lists the elements from the group functions as well as their explanations.
