...
[IMPORTANT]
.Default view “Starter UI” available in all new systems as of December 2022
====
...
====
If the address is linked with an order, you cannot delete the address. An error message appears. However, the relation between address and contact will be removed in the background.
====
