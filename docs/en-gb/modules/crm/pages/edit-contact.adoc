...
You can use various filters to retrieve specific information about your contact's account balance. Set these filters (material:tune[]) in the account balance overview of a contact and click on material:search[]. You can combine several filters. The filter settings are explained in the table below.
