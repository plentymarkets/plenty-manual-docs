...
*_Note:_* The list shows all users (owners) that have a xref:business-decisions:user-accounts-access.adoc#70[role] assigned in which the setting *See* or *Edit* is xref:business-decisions:user-rights-access.adoc#40[activated] for the right *CRM* or *CRM » Contacts*.
