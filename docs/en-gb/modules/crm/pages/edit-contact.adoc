...
|Shows the customer’s payment overview balance. +
...
Once you selected (material:check_box[role=skyBlue]) at least one contact in the overview, the different buttons become visible. <<#table-contact-group-function>> lists the elements from the group functions as well as their explanations.
