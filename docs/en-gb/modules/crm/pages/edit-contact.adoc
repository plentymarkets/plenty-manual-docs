...
In the icon:pay_ec[set=plenty] *Bank details* area, you can see all bank data records that you opened in the <<#bank-details, Bank details>> area for this contact. Click on material:credit_card[] *New* to easily and quickly create a new bank data record for this contact.
