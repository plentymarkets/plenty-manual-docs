...
Click on the link and note the explanations on the *Creating a contact* page, if the delivery address is a xref:crm:create-contact.adoc#dhl-packstation-dhl-post-office[DHL Packstation or DHL post office].
