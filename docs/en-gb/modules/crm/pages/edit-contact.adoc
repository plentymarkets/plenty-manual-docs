...
When you click on the button (icon:toggle_off[set=material, role=red]), the contact is blocked. This means that the contact is _blocked_ for the selected client and is _not_ able to log into your plentyShop.
