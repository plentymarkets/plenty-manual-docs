...
//*_Note_*: If you select contacts here and do _not enter a value_, the values that have been saved so far are _deleted_ for the selected contacts. You can find a detailed description on how to save the payment due date using the group function in this <<#group-function-payment-due-date, chapter>>.
