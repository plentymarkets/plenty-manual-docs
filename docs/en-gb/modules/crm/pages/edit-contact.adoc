...
Click on *Configure columns* (icon:settings[set=material]) on the top right and decide which columns to show in the *Orders* area. Click on icon:drag_indicator[set=material] to change the order of the columns with drag-and-drop. The following columns are available:
...
Click on *Configure columns* (icon:settings[set=material]) on the top right and decide which columns to show in the *Addresses* area. Click on icon:drag_indicator[set=material] to change the order of the columns with drag-and-drop. The following columns are available:
...
| *Delete*
|By clicking on icon:delete[set=material], a window with a security question appears. You need to confirm your decision to delete the address.

| *Reload*
|Click on icon:refresh[set=material] to update the data record.

| *Derive new invoice address*
|This function is only available if it is an existing address data record. +
By clicking on icon:credit_note[set=plenty], a new invoice address based on the currently selected address is created. The drop-down list *Invoice address* changes to *Yes*. The drop-down list *Delivery address* changes to *No*. +
...
|This function is only available if it is an existing address data record. +
By clicking on icon:delivery_note[set=plenty], a new delivery address based on the currently selected address is created. The drop-down list *Delivery address* changes to *Yes*. The drop-down list *Invoice address* changes to *No*. +
...
Click on *Configure columns* (icon:settings[set=material]) on the top right and decide which columns to show in the *Company* area. Click on icon:drag_indicator[set=material] to change the order of the columns with drag-and-drop. The following columns are available:
...
. Move (icon:drag_indicator[set=material]) the columns so they are displayed in the order you need them in.
...
Click on *Configure columns* (icon:settings[set=material]) to decide which columns to show in the *Tickets* area. Click on icon:drag_indicator[set=material] to change the order of the columns with drag-and-drop. The following columns are available:
