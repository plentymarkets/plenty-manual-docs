...
:right-one: pass:quotes[*CRM > Contact > Read*]

include::_includes:partial$rights.adoc[]

For further information about the rights for the *CRM » Contacts* menu for users without admin rights, refer to the xref:crm:preparatory-settings.adoc#assign-rights[Carrying out the preparatory settings] page.
...
* *_Option 1:_* Click on material:search[] (*Search*) to get a list of all data records.
...
*_Important:_* Users without admin rights only can select clients they have an access rights for. These access rights can be xref:business-decisions:user-accounts-access.adoc#100[activated] in the Setup » Account management » Roles menu.
