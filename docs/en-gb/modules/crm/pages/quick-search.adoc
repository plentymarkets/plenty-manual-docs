...
*_Note:_* Click on the arrows (icon:sort[]) next to the ID in the overview to sort the data records found in ascending or descending order according to their ID.
