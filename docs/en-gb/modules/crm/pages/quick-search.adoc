...
When you start a search, your selected filters are displayed up top as chips. You can save these filters to apply them again more quickly and easily in the future.
...
| *MESSENGER*
|Opens the *Messenger*. +
Click on material:add[] *New message* right next to *MESSENGER* to open the messenger for creating a new message in a new window. The contact ID is already preselected in the recipient field. +
You can xref:crm:messenger-testphase.adoc#intable-whisper-mode[whisper] the message, xref:crm:messenger-testphase.adoc#create-message[send] the message or xref:crm:messenger-testphase.adoc#capture-minutes[capture minutes for the message] and determine whether they are free minutes or paid minutes. +
