...
You can whisper the message, xref:crm:messenger-testphase.adoc#create-message[send] the message or xref:crm:messenger-testphase.adoc#capture-minutes[capture minutes for the message] and determine whether they are free minutes or paid minutes. +
