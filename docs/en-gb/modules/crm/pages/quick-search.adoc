...
Use the quick search to get an overview of all information that is saved for a contact or an address data record of a guest order. Learn on this page of the manual how to xref:crm:download-all-data.adoc#[download all data of a contact or guest order] and how to xref:crm:anonymise-data-record.adoc#[anonymise data records] in compliance with GDPR.
...
Further information about converting plentyShop guest orders into regular contact data records can be found in the xref:convert-guest-account:convert-guest-account.adoc#[Converting a guest account into a contact data record] chapter.
====
