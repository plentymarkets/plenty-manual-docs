...
Click on material:add[] *New message* right next to *MESSENGER* to open the editing window for creating a new message further down in this view. The stop watch in the bottom right of the Messenger area starts automatically once you open the message.  Click on material:more_vert[] and activate (material:toggle_on[role=skyBlue]) the option *Capture minutes* to capture the minutes for this message. + 
When you click on *CAPTURE MINUTES*, you can decide whether it is about *Free minutes* or *Paid minutes*. +
*_Note:_* For further information, refer to the xref:crm:messenger-testphase.adoc#[Messenger] page.+
