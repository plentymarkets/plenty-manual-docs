...
For further information about the rights for the *CRM » Contacts* menu for back end users, refer to the xref:crm:managing-contacts.adoc#50[Contacts] page.
...
*_Note:_* If this is already a contact, the field is not available.
