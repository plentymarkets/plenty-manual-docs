...
Click on material:add[] *New message* right next to *MESSENGER* to open the editing window for creating a new message further down in this view. The stop watch in the top right corner of the Messenger area starts automatically once you open the message. Next to *Minutes* field, click on *Billable* (material:toggle_off[] terra:pay_cash[]) to bill the minutes. +
