...
hen opening the *Stock » Reorder management » Purchase order* menu, all existing redistributions and xref:stock-management:working-with-reorders.adoc#[reorders] are displayed. Carry out a search (icon:search[set=material]) to limit the search results to the required redistributions and reorders.
...
For more detailed information on setting up event procedures, refer to the xref:basics:event-procedures.adoc#[Event procedures] page of the manual. +
