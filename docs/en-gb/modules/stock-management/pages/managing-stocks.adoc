...
You can set up barcodes in the xref:item:managing-items.adoc#630[Setup » Item » Barcode] menu and then you need to xref:item:managing-items.adoc#250[link the barcode with your variation].
