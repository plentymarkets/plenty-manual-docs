...
:description: On this page you will learn which stock data plentymarkets provides to you, how and where to get an overview of your stocks as well as how to create a reorder.
:author: team-stock
...
You can also redistribute stock using the plentymarkets app. Refer to the xref:app:receiving-rebooking.adoc#[Receiving goods and redistributing stock] page of the manual to learn how it's done and which settings you'll need to configure in advance.
...
All data formats available in plentymarkets as well as a general description on how to export or import data from or into plentymarkets can be found on the xref:data:data.adoc#[data] manual page.
