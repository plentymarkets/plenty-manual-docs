...
:description: Who supplies you with your products? This page teaches you how to manage a list of suppliers in your plentymarkets system.
:author: team-stock
...
This page teaches you how to manage a list of suppliers in your plentymarkets system.
...
Enter the contact information for each of your suppliers into plentymarkets.
