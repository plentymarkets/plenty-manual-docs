...
The following sub-chapters describe how to xref:stock-management:setting-up-a-warehouse.adoc#950[link>>, <<#group-properties, group>> and <<#search-property, search>> and how to <<#delete-property, delete>>, <<#import-properties, import>> and <<#export-properties, export] properties.
