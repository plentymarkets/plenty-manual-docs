= Printing labels
:author: team-mobile
:keywords: plentyWarehouse item labels, plentyWarehouse storage location labels, storage location labels
:id: A5QKZMB
...
. Tap on *plentyBase* (image:stock-management:icon_plentybase.png[width=14, height=14]).
