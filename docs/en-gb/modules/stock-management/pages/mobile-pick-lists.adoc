...
Now, assign rights so that the function for mobile pick lists is visible and usable for the respective users of the plentyWarehouse app.

:rights-purpose: use the *Pick lists* function in plentyWarehouse
