...
| *Client*
| Filters all available pick lists by their xref:glossary:glossary.adoc#client[client].

| *Warehouse*
| Filters all available pick lists by their xref:glossary:glossary.adoc#warehouse[warehouse].
