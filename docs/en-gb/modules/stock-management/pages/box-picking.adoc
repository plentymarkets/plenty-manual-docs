...
|material:chat[]
| Opens a window for entering an order note. Use this function to save a comment with the order that contains this item. Later, you can open those orders in the back end of your plentymarkets system and access the comment.
...
|material:cancel[]
| Removes the item from the item list. Use this function in case the required item is not available at the storage location. Optionally, you can add a comment in this step. The comment will be saved as an order note with the order that contains this item. You can access these order notes in the back end of your plentymarkets system later. In addition, the status of the order will be changed to the error status.
