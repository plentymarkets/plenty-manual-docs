...
In the *Orders » Orders* menu you will find the new Order UI that is currently in the beta phase. To reorder variations from a specific order in this menu, proceed as follows.
