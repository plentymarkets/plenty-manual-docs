...
. Use *Attach files* to attach a file, if required.
. Click on *Send* (icon:envelope-o[role="purple"]).
. Decide whether this is part of a service and needs to be billed by selecting *Billable* and entering the corresponding minutes.
...
|Select from the drop-down list whether the items should be added to an existing reorder or a new reorder should be created instead.
