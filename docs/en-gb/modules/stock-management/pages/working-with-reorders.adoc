...
In chapter 3, several methods for creating a reorder in your plentymarkets system have been described. Now, you can enter further variations to the reorder by adding order items. Carry out a search (material:search[]) to find the required order items and to add them to the reorder.
...
When opening the *Stock » Reorder management » Purchase order* menu, all existing reorders and xref:stock-management:working-with-redistributions.adoc#[redistributions] are displayed. Carry out a search (material:search[]) to limit the search results to the required redistributions.
