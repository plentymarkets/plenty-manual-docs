...
A certain number of statuses is saved in your system by default. Those default order statuses can also be used for reorders. However, you can also create a number of individual statuses for particular uses. Creating new order statuses is described in detail in the respective chapter on the xref:orders:managing-orders.adoc#1200[Managing orders] page of the manual.
