...
:author: team-mobile
:keywords: plentyWarehouse app, plentyWarehouse setup, plentyWarehouse login, plentyWarehouse hardware requirements, plentyWarehouse system requirements, plentyWarehouse settings, mobile warehouse management, mobile stock management
:id: B6QIHYV
:icons: font
...
* Click here to link:https://play.google.com/store/apps/details?id=com.plentysystems.plentywarehouse&hl=en[download plentyWarehouse on Google Play Store^] {nbsp}icon:external-link[].

[#300]
== Logging into plentyWarehouse

The plentyWarehouse app only works in combination with an already link:https://www.plentymarkets.com//[booked plentymarkets system^].{nbsp}icon:external-link[]. Users simply use their regular login details for the plentymarkets system to log into plentyWarehouse.
