...
* image:stock-management:icon_pick-lists.png[width=14, height=14]
...
*Use device camera for scanning*: Are you using the plentyWarehouse app on an Android smartphone? This setting allows you to use the built-in camera of the device to scan barcodes and QR codes. If this option is activated, the scanner icon (image:stock-management:icon_barcode.png[width=14, height=14]) is displayed at the upper margin of the screen while you are using functions that require scanning codes. Tap on this symbol to open the camera and start the scanning process.
|====
