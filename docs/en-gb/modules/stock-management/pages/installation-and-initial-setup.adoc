...
The plentyWarehouse app only works in combination with an already link:https://www.plentymarkets.com//[booked system^]. Users simply use their regular login details for the system to log into plentyWarehouse.
