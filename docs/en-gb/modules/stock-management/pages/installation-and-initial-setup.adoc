...
To adjust the text to speech function to your requirements, use the setting *Item information* to determine which item information should be included in the text to speech output. If you do not adjust this setting, the option *Variation number* is preselected by default. Alternatively, select one of the options *Item name*, *Variation name* or *Variation ID*. If no item information should be included in the text to speech output, select the option *No selection*. +
