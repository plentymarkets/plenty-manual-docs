...
The values entered here are considered for markets such as xref:markets:shopgate.adoc#[Shopgate]. The buffer entered here takes priority over the buffer values entered for the particular market. +
...
If you pay for the incoming items in a currency other than your xref:payment:currencies.adoc#20[exchange rate] will be entered automatically.
