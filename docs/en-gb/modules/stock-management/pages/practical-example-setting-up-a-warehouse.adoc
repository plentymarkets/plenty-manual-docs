...
image::stock-management/assets/storage-buildings-1-and-2.png[]

.Front view of racks
image::stock-management/assets/two-racks.png[]
...
.Dimension settings
image::stock-management/assets/preview-storage-location-name.png[]
...
image::stock-management/assets/add-storage-location.png[]

.Determining the warehouse structure
image::stock-management/assets/overview-dimensions.png[]

.Preview storage locations
image::stock-management/assets/preview-storage-locations.png[]
...
image::stock-management/assets/overview-storage-locations.png[]

.Update view
image::stock-management/assets/update-button.png[]
...
image::stock-management/assets/storage-buildings-pick-path.png[]

.Possible pick path; front view of warehouse racks
image::stock-management/assets/pick-path-example-1.png[]
...
.Possible pick path; front view of warehouse racks
image::stock-management/assets/pick-path-example-2.png[]
...
image::stock-management/assets/highlighted-storage-locations.png[]
