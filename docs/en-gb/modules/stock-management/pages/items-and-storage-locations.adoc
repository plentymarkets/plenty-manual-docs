...
:rights-purpose: use the item search
:right-one: pass:quotes[*Setup > Tag > Tag > Read*]
...
Now, assign rights so that the item search function is visible and usable for the respective users of the plentyWarehouse app. If needed, also assign the rights for <<#intable-assign-barcode, adding barcodes>>.

:rights-purpose: use the Item search function in plentyWarehouse
...
Now, assign rights so that the function *Inspect storage location* is visible and usable for the respective users of the plentyWarehouse app.

:rights-purpose: use the Inspect storage location function in plentyWarehouse
