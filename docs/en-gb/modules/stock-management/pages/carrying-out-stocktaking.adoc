...
Before stocktaking is carried out in plentyWarehouse, make sure that all users without roles of the type *Administrator* have been assigned the appropriate rights. Otherwise, the counted stock cannot be registered and saved correctly both in the plentyWarehouse app and in the plentymarkets back end.
