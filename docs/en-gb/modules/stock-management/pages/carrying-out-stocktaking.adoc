...
Now, assign rights so that the function for stocktaking is visible and usable for the respective users of the plentyWarehouse app.

:rights-purpose: use the *Stocktaking* function in plentyWarehouse
