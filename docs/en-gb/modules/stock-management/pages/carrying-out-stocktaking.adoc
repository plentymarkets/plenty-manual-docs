...
:description: In addition to using the functionality in the plentymarkets back end, you can also take stock with the plentyWarehouse app. This page teaches you how it's done.
