...
Before items are reshelved in plentyWarehouse, make sure that all users without roles of the type *Administrator* have been assigned the appropriate rights. Otherwise, items cannot be reshelved correctly and the stock changes cannot be saved in the plentymarkets back end.
