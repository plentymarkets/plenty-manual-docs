...
:right-three: pass:quotes[*plentyWarehouse > Incoming items > Purchase price > See*] (depending on the use case)
:right-three: pass:quotes[*plentyWarehouse > Incoming items > Purchase price > Edit*] (depending on the use case)
:right-five: pass:quotes[*plentyWarehouse > Incoming items > Procurement costs > See*] (depending on the use case)
:right-six: pass:quotes[*plentyWarehouse > Incoming items > Procurement costs > Edit*] (depending on the use case)
