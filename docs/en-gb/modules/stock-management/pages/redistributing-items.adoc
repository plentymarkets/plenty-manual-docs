...
:description: In addition to redistributing items in the plentysystems back end, you can also do so with the plentyWarehouse app. This page shows you how it's done. This page shows you how it’s done.

include::partial$note-requirements.adoc[]

In addition to redistributing items in the xref:stock-management:working-with-redistributions.adoc#[plentysystems back end], you can also do so with the plentyWarehouse app. plentyWarehouse allows you to register items on your mobile device directly in your warehouse. You can also select source and target storage locations and thus redistribute items quickly and easily.

[#150]
== Assigning rights for the redistribution

Before items are redistributed in plentyWarehouse, make sure that all users without roles of the type *Administrator* have been assigned the appropriate rights. Otherwise, the redistribution cannot be carried out correctly and the stock changes cannot be saved in the plentysystems back end.
