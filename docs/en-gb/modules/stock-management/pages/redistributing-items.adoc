...
:description: In addition to redistributing items in the plentymarkets back end, you can also do so with the plentyWarehouse app. This page teaches you how it's done.
...
| *Show net stock*
|Activate this option to display the respective xref:glossary:glossary.adoc#net-stock[net stock] when redistributing items.
