...
:description: In addition to redistributing items in the plentymarkets back end, you can also do so with the plentyWarehouse app. This page shows you how it's done.
