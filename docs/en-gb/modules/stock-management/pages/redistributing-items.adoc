...
Before items are redistributed in plentyWarehouse, make sure that all users without roles of the type *Administrator* have been assigned the appropriate rights. Otherwise, the redistribution cannot be carried out correctly and the stock changes cannot be saved in the plentymarkets back end.
