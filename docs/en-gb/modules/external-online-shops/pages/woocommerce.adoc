...
:description: Multi-Channel in plentymarkets: Set up the interface to WooCommerce in your plentymarkets system.
...
. Use the installation guide on ink:https://wordpress.org/plugins/woocommerce-germanized/[WooCommerce] to install and set up the *Germanized* plugin.
