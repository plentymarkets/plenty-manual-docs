...
NOTE: You do not need to migrate all connections in the same session. However, note the instructions regarding event procedures if you only migrate some of your connections now.
