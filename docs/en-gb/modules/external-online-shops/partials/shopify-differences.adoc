...
| For whom?
|
* For customers who currently do not have a Shopify connection set up in plentymarkets.
...
|
* Used by most existing customers who already have a connection to Shopify.
...
| Functionality
| * You can export unit prices with the app. Apart from that, app and plugin have the same functions.
| * You can export unit prices with the app. Apart from that, app and plugin have the same functions.
