...
ifdef::item[]
This description xref:item:properties.adoc#1500[can be made visible to customers] in the plentyShop. It depends on how you design the layout with ShopBuilder.
