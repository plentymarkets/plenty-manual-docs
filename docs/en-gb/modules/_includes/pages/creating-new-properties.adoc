...
But properties can also be used to characterise xref:crm:setting-up-a-warehouse.adoc#850[storage locations].
...
But properties can also be used to characterise xref:item:setting-up-a-warehouse.adoc#850[storage locations].
Click on the links to learn more about these other use cases.
endif::crm[]
ifdef::stock[]
...
But properties can also be used to characterise xref:item:managing-contacts.adoc#950[contacts].
Click on the links to learn more about these other use cases.
endif::stock[]
...
//xref:item:personalised-items.adoc#100[enter a personal text] that should be printed on a t-shirt.
...
! *Order property*
!Select this option (icon:check-square[role="blue"]) if the property should enable customers to xref:item:personalised-items.adoc#[personalise their orders].
For example:
