Make sure the payment method is allowed in the xref:crm:preparing-the-shipment.adoc#1800[shipping profiles]. For this, you should consider first for which customer classes and shipping profiles the payment method should be allowed. This can be set individually.
