...
*_Note_*: This list only includes groups that have already been created. If you haven’t created any xref:item:properties.adoc#1200[property groups] yet, then you won’t see any group names here either.
