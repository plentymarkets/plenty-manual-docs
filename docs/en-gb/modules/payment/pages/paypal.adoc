...
First check whether the  link:https://marketplace.plentymarkets.com/paypal_4690[latest PayPal version]{nbsp}icon:external-link[] is installed and deployed in your plentymarkets system. How to update plugins is explained in the manual chapter xref:plugins:updating-installed-plugins.adoc#[Updating installed plugins].
