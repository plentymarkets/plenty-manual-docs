...
On this page of the manual, you learn how to save your xref:payment:managing-bank-details.adoc#10[own bank details] and your <<payment/managing-bank-details#63, customers' bank details>> as well as how to set up xref:payment:managing-bank-details.adoc#70[EBICS] and xref:payment:managing-bank-details.adoc#200[SEPA].
...
You can save the customer's bank details in the *Settings* tab of a customer's data record or delete them again as needed. Bank details are needed, e.g. for the payment method xref:payment:managing-payment-methods.adoc#40[debit]. There is also an xref:payment:beta-managing-payments.adoc#intable-import-customer-bank-data[import function] for bank details in plentymarkets. Contact a legal adviser for information about the current laws in your own country as well as in other countries of delivery.
...
For further information, refer to the xref:crm:managing-contacts.adoc#[Managing contacts ] page of the manual. Specifically, refer to the chapter xref:crm:managing-contacts.adoc#510[Carrying out the group function].
