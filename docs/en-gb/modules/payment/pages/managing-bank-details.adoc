...
EBICS is integrated in your system using the EBICS plugin. To do so, download the EBICS plugin from the link:https://marketplace.plentymarkets.com/en/ebics_5098[plentyMarketplace^]. To set up EBICS, you have to carry out a few basic settings in your plentymarkets system. These settings are described in the following sub-chapters.
