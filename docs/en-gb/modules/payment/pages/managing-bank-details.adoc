...
On this page of the manual, you learn how to save your <<#own-bank-details, own bank details>> and <<#bank-details-customer, your customers’ bank details>> as well as how to set up <<#69, EBICS>> and <<#220, SEPA>>.
