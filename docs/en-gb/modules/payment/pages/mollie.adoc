...
Make sure that the order items which are to be refunded are contained in the credit note order. You can find more information about credit note orders in general in the chapter xref:orders:order-type-credit-note.adoc#500[Order type: Credit note] of the manual.
