...
Make sure that the payment method is allowed in the xref:crm:managing-contacts.adoc#15[customer classes] For this, you should consider first for which customer classes the payment method should be allowed. This can be set individually.
