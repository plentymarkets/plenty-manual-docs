...
The entry *PayPal import* with the PayPal icon in the navigation on the left is only displayed when the xref:payment:paypal.adocl#[PayPal plugin] is installed. To use this function, you need at least version 6.0.0 of the PayPal plugin. +
