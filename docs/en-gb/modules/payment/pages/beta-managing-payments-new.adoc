...
. Go to *Orders » Payments*.
. Search (material:search[]) the desired payment as described in the <<#20, Searching for payments>> chapter.
. Click on the context menu (material:more_vert) and then on *Detach payment* (material:money_off[]) in the row of the payment you want to detach from an order. +
...
. Go to *Orders » Payments*.
. Click on the context menu (material:more_vert) and then on *Detach payment* (material:delete[]) in the row of the payment you want to detach from an order. +
