...
After creating TSE exports in the plentymarkets app, all created TSE export files are available to you in the plentymarkets back end. In case of an inspection carried out by tax authorities, go to *Data » POS » TSE export* to access the export files and download them in a standard format.
...
→ *_Or:_* Select individual export files in the list and click on *Download selected exports*. +
...
. Go to *Data » POS » DSFinV-K export*.
...
→ As soon as the export has been created, it is displayed in the *Data » POS » DSFinV-K export* menu with the status *Finished*.
. Click on *Download*. +
...
* Go to the **Setup » POS » [Select client] » Open POS » Tab: Basic settings** to find the **User key AES-256**.
