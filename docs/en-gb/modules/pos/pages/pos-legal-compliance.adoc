...
:right-one: pass:quotes[*Data > POS > Protocols*]
...
====
If you are a back end user and do not only want to export POS transactions but also search for specific entries in the cash journal, you need the additional right *Orders > Show*.
====
