...
====
You can activate the shipping profile for a large number of items simultaneously. To do so, use the xref:item:managing-items.adoc#155[item group function].
====
