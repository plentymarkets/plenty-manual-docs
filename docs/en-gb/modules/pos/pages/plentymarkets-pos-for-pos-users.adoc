...
.Requirements
====
This page assumes that you've already xref:app:quick-start-system-requirements.adoc#200[this manual page].
====
...
Sometimes it’s necessary to find previous transactions and continue working with them. For example, it makes sense to find the original transaction when customers xref:pos:pos-online-orders.adoc#[buy items online and pick them up in the store].
...
Enter the order ID or the receipt number into the search field. Tap *Search* to access the order data. Now you can xref:pos:pos-online-orders.adoc#[items that were purchased online].
...
Scan the barcode on the receipt. Now you can xref:pos:pos-online-orders.adoc#[items that were purchased online].
