...
====
Z reports are saved in the plentymarkets back end. Go to xref:orders:document-archive.adoc#100[Orders » Document archive]. Filter by the document type *Z report*. You can download the report as a PDF file from the *File* column.
====
