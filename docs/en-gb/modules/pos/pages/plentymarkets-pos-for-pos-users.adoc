...
. Tap on the menu symbol at the top left of the screen. +
...
Enter the domain without https:// or http://. If you don’t know the URL, log into your plentysystems back end. Then, move the cursor over the shop symbol with your plentyID on the upper right. The URL is listed in the second line of the tooltip that is displayed. +
...
. Tap on the user icon at the top right of the app. +
...
. Tap on the user icon at the top right of the app. +
→ A list of the real names of the users with an app PIN is shown.
. Tap on the *Lock* icon at the bottom left of the window. +
...
*_Tip:_* You can change to a different user account even if access to the app is locked. Tap on a different user account in the list to change users.
...
. Tap on the user account icon at the top right of the app. +
→ A list of the real names of the users with an app PIN is shown.
. Tap on the *Logout* icon at the bottom right of the window. +
→ The *Logout* window is displayed. +
icon:map-signs[] *_Or:_* Tap on the menu icon at the top left corner of the app and then *Log out*. +
...
. Tap on the green check mark to add an item to the shopping cart. +
...
. Tap on the camera icon to scan the label. +
*_Note:_* Items with best before dates, batches or both are not found. +
...
*_Tip:_* Tap on *Show order* to view the order details.
. Tap on *New order* to continue with ringing up the next customer at the POS.
...
. Tap on *Payment received/Complete payment* to complete the payment. +
...
*_Tip:_* Tap on *Show order* to view the order details.
. Tap on *New order* to create a new POS order.
...
. Tap on the green arrow at the bottom of the POS shopping cart. +
→ A summary of the order and the available payment methods are displayed.
. Tap on *Gift card / discount*.
...
. Tap on the button for the payment method you received. +
...
*_Tip:_* Tap on the *Payment* bar to view details of the payments you already booked. +
...
. Tap on the button for the payment method you received for the down payment.
...
Enter the order ID or the receipt number into the search field. Tap on *Search* to access the order data. Now you can xref:pos:plentymarkets-pos-for-pos-users.adoc#370[finalise the return] or hand over the xref:pos:pos-online-orders.adoc#[items that were purchased online].
...
. Tap on the *X* in the top right corner or tap the screen outside the window to return to the POS shopping cart. +
...
. Enter the note text.
. Tap on the check mark to save the note to the order. +
→ The note is displayed in the list of notes and is imported to plentymarkets.
. Tap on *X* to close the window and return to the shopping cart view.
...
. Tap on the receipt you want to load. +
...
→ Additional options are displayed.
. Tap on the preferred setting. Pay attention to the explanations given in <<table-POS-user-edit-order-items>>.
...
====
xref:pos:pos-online-orders.adoc#[Click & Collect orders] are not created in plentyPOS but are loaded into plentyPOS from other referrers, such as your online shop. Thus, you can only cancel those orders in the back end of your plentymarkets system.
====
...
icon:map-signs[] *_Or:_* Tap on the order to open the order details. Tap on the *Cancellation* icon in the detailed view.
...
. Tap on *Complete and pay out cash* or *Complete and create coupon*. +
...
*_Tip:_* When you open the order, a recycling bin is shown on the right of the order item. Tap on this recycling bin to remove those order items that the customer does not want to return.
...
. *_Optional:_* Select a different target storage location for the item: +
  ...
  .. Tap on a target storage location. +
...
→ Additional options are displayed.
. Tap on *Change single price* to change the single price of the order item or *Change total price* to change the total price of the order item. +
...
. After you have added all returned items, tap the green arrow at the bottom of the POS shopping cart. +
→ The total amount of the return is displayed.
. Tap on *Select refund method*.
. Tap on *Refund via card terminal*.
...
. Tap on *Deposits and withdrawals*. +
...
. Tap on *Deposit* to save the deposit. +
→ The current cash on hand is updated. +
→ A receipt for the deposit is printed. +
→ The receipt is imported to plentymarkets and saved in the *Data » Documents » Document archive* menu.  
...
. Tap on *Withdrawal* to save the withdrawal. +
→ The current cash on hand is updated. +
...
====
Z reports are saved in the plentymarkets back end. Go to xref:orders:document-archive.adoc#100[*Data » Documents » Document archive*]. Filter by the document type *Z report*. You can download the report as a PDF file from the *File* column.
====
...
. Tap on the green return arrow to jump to the next denomination.
