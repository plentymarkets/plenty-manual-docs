...
|Select if the xref:glossary:glossary.adoc#grand-total[grand total] should be included in the z report. +
...
|Select if discount codes redeemed in connection with xref:glossary:glossary.adoc#promotional-coupon[promotional coupons] should be listed individually on the z report. +
...
For further information about creating label templates and printing the labels in the item search of the plentymarkets app, refer to the xref:app:item-search.adoc#[Searching for items, customers and orders] page of the manual.
