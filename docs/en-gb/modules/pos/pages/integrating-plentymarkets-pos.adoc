...
| *Country*
|Select the country in which the POS will be used from the drop-down list. The default setting is based on the option *Country* in the xref:welcome:quick-start-initial-settings.adoc#100[Setup » Settings » Master data] menu.
