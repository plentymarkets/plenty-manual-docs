...
Afterwards, you carry out the settings for the points of sale in the plentymarkets back end. First, you assign a POS to a client by creating a POS in the *System » System settings » Client » [Select client] » POS* menu and carrying out further settings. Proceed as described below.
