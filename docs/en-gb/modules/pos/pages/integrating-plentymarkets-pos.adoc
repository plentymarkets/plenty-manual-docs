...
In case of a xref:pos:plentymarkets-pos-for-pos-users.adoc#520[scan the barcode] to access the corresponding order. +
...
| **TSE unit**
|Allows POS users to open the *TSE unit* menu in the plentymarkets app. This menu displays xref:pos:pos-legal-compliance.adoc#700[TSE exports].
