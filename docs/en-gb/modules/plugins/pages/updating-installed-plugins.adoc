...
:keywords: plugin, plug in, plug-in, extension, update, git, branch, commit
...
Marketplace plugins cannot be downgraded to an older version. If you want to use an older version of the plugin, you have to xref:/plugins:removing-installed-plugins.adoc#deleting-plugin-from-plugin-set[delete] and then <<plugins/installing-added-plugins, reinstall>> it.
