...
After installing and deploying a plugin, I can no longer log into my system. How can I access my back end again?::
    Log in using the <<welcome/login-tour#70, safe mode>>. Then <<removing-installed-plugins#deactivating-plugins, deactivate>> the plugin. You should be able to log in normally again.
