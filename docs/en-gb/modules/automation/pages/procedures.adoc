...
| **Label template**
|Select a xref:item:barcodes.adoc#800[label template] from the drop-down list.
...
| **Label template**
|Select a xref:item:barcodes.adoc#800[label template] that you have already saved in the system that should be used for printing item labels.
