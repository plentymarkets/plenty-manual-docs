...
You can upload your own documents in the *Orders » Orders* menu. To do so, open an order and go to the *Documents* area. At the top, click on *Create document* (material:add[]) and select the option *External document* (material:file_download[]).
