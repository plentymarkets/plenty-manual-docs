...
**Storage location of procedure settings** = The combination of **Warehouse** and **Storage location** set here (see above) will be used. +
**Storage location from order** = The order items are reversed to the warehouses saved with the order.
...
*_Important_:* If you selected **XML**, you cannot select the option **Combine** for the **Transaction files** setting because this combination would result in errors.
