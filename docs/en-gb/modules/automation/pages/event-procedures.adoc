...
_Important:_ This option is only displayed if the correct xref:orders:basic-settings.adoc#320[assignment of warehouses] has been carried out beforehand.
