...
It is also xref:item:manufacturers.adoc#450[relevant for the search function in the plentyShop].
...
You can find the result of the import in the back end menu: xref:item:manufacturers.adoc#100[Setup » Item » Manufacturers » Tab: Settings » Entry field: External name]
endif::import[]
...
Corresponds to the option in the menu: xref:item:manufacturers.adoc#[Setup » Item » Manufacturers » [Open manufacturer] » Entry field: External name]
