...
Corresponds to the option in the menu: xref:item:managing-items.adoc#40[Item » Edit item » [Open item\] » Tab: Global » Area: Basic settings » Entry field: Max. order quantity]
endif::export[]
