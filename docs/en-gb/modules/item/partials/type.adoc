...
* *Item* (terra:document[role="darkGrey"]) = Product groups that help you structure your merchandise clearly. xref:item:categories.adoc#300[New categories] are given the type *Item* by default. +
