...
Corresponds to the option in the menu: xref:item:managing-items.adoc#45[Item » Edit item » [Open item] » Tab: Multi-Channel » Area: Amazon » Drop-down list: FBA Fulfillment]
endif::export[]
