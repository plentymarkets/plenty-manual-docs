...
You can find the result of the import in the back end menu: xref:item:categories.adoc#intable-url[Item » Category » Tab: Settings » Entry field: URL name]
...
Corresponds to the option in the menu: xref:item:categories.adoc#700[Item » Category » [Open category\] » Tab: Settings » Entry field: URL name]
