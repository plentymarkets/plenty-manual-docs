...
*_Relationship to other settings:_* Check your settings for the xref:online-store:setting-up-ceres.adoc#90[item view and category view in the plentyShop LTS plugin]. The option *Show variations by type* can affect the option *Groupable in item lists* and vice versa.
