...
You can find the result of the import in the back end menu: xref:item:managing-items.adoc#290[Item » Edit item » [Open variation] » Tab: Settings » Area: Shipping » Packing units (right drop-down list)]
endif::import[]
...
Corresponds to the option in the menu: xref:item:managing-items.adoc#290[Item » Edit item » [Open variation] » Tab: Settings » Area: Shipping » Packing units (right drop-down list)]
endif::export[]
