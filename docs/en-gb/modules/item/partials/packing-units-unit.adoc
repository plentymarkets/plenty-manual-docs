...
You can find the result of the import in the back end menu: xref:item:directory.adoc#200[Item » Items » [Open variation\] » Element: Shipping » Drop-down list: Packing unit]
endif::import[]
...
Corresponds to the option in the menu: xref:item:directory.adoc#200[Item » Items » [Open variation\] » Element: Shipping » Drop-down list: Packing unit]
endif::export[]
