...
You can find the result of the import in the back end menu: xref:item:categories.adoc#intable-meta-keywords[Item » Category » Tab: Settings » Entry field: Meta keywords]
endif::import[]

ifdef::export,catalogue[]
The category’s keywords.

Corresponds to the option in the menu: xref:item:categories.adoc#700[Item » Category » [Open category\] » Tab: Settings » Entry field: Meta keywords]
