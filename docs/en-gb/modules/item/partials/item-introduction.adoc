...
This chapter describes the new PIM UI. The plentysystems PIM allows you to manage all item data centrally. By introducing the new article user interface, plentysystems provides a new menu for managing your article data. You can then sell your goods on various xref:maerkte:maerkte.adoc#[marketplaces], as well as in your own xref:webshop:webshop.adoc#[plentyShop] and in xref:pos:pos.adoc#[stationary trade].

Whenever you need to change item data, such as the product description or the sales price, you can change the data centrally in plentysystems. Your updates will show in all your sales channels.
//end::pim-preamble[]
