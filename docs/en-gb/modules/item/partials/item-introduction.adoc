...
//tag::acronyms[]
The acronym *PIM* stands for **P**roduct **I**nformation **M**anagement. +
The acronym *UI* stands for **U**ser **I**nterface.
//end::acronyms[]

====

This chapter describes the new article PIM UI. The plentysystems PIM allows you to manage all item data centrally. By introducing the new article user interface, plentysystems provides a new menu for managing your article data.

You can then sell your goods on various xref:maerkte:maerkte.adoc#[marketplaces], as well as in your own xref:webshop:webshop.adoc#[plentyShop] and in xref:pos:pos.adoc#[stationary trade].

If you want to change item data, such as the product description or the sales price, you only need to make the change in plentysystems to display the new data in all sales channels.
//end::pim-preamble[]
...
== Working with the item UI

On the following page, you will learn to navigate the user interface to:
