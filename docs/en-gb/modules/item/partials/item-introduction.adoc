...
This chapter describes the new PIM UI. The plentysystems PIM allows you to manage all item data centrally. By introducing the new article user interface, plentysystems provides a new menu for managing your article data.
