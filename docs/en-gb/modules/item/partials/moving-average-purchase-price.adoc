...
You can find the result of the import in the back end menu: xref:item:managing-items.adoc#280[Item » Edit item » [Open variation\] » Tab: Settings » Area: Costs » Entry field: Moving average purchase price (net)]
endif::import[]

ifdef::export[]
The net moving average purchase price.

Corresponds to the option in the menu: xref:item:managing-items.adoc#280[Item » Edit item » [Open variation\] » Tab: Settings » Area: Costs » Entry field: Moving average purchase price (net)]
endif::export[]
