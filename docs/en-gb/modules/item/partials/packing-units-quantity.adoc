...
You can find the result of the import in the back end menu: xref:item:managing-items.adoc#290[Item » Edit item » [Open variation] » Tab: Settings » Area: Shipping » Packing units (left drop-down list)]
endif::import[]

ifdef::export,catalogue[]
Specifies the number of packing units if the item consists of multiple packages.

Corresponds to the option in the menu: xref:item:managing-items.adoc#290[Item » Edit item » [Open variation] » Tab: Settings » Area: Shipping » Packing units (left drop-down list)]
