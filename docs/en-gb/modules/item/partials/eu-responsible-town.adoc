ifdef::manual[]
Enter the town of the manufacturer's EU-responsible person.
...
ifdef::import[]
Enter the town of the manufacturer's EU-responsible person into the CSV file.
...
You can find the result of the import in the back end menu: xref:item:manufacturers.adoc#100[Setup » Item » Manufacturers » Tab: Settings » Entry field: EU Responsible Town]
endif::import[]

ifdef::export,catalogue[]
The town of the manufacturer's EU-responsible person.

Corresponds to the option in the menu: xref:item:manufacturers.adoc#[Setup » Item » Manufacturers » [Open manufacturer\] » Entry field: EU Responsible Town]
