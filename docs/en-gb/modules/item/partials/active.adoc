...
You can find the result of the import in the back end menu: xref:item:managing-items.adoc#200[Item » Edit item » [Open variation] » Tab: Settings » Area: Availability » Checkbox: Active]
endif::import[]
...
Corresponds to the option in the menu: xref:item:managing-items.adoc#200[Item » Edit item » [Open variation] » Tab: Settings » Area: Availability » Checkbox: Active]
endif::export[]
...
*_Back end search_*: inactive variations are _not_ found with the xref:item:search.adoc#100[default search settings].
