...
* *Exclude from pick list* = This option is well-suited, e.g. for variations that do not have barcodes and thus can not be processed with xref:orders:pick-list.adoc#[normal pick lists]. +
...
*_Note_*: This option is well-suited, e.g. for variations that do not have barcodes and thus can not be processed with xref:orders:pick-list.adoc#[normal pick lists].
