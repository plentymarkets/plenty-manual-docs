...
*_Additional settings_*: Depending on the type of property, you might need to enter additional information in the menu *Item » Item UI » [Open variation] » Left navigation: Properties*. For example, if the property is something like a weight or a length, then it will be necessary to enter a numeric value.
