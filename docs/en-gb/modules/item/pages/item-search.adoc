...
* The advanced search mode supports xref:item:search.adoc#intable-advanced-elements[operators].
////
...
Further information about the xref:item:detail-view.adoc#[navigation and detail view].
...
Have you already xref:item:search.adoc#500[opened an item data record]?
