...
In other words, _when_ the variation is visible or purchasable.

Note that there is also the xref:item:managing-items.adoc#340[Tab: Availability], which you’ll use to specify _where_ the variation is available.
...
* Are you removing the property from a _sub-variation_, which has the inheritance function activated? Then the inheritance function will be deactivated. The remaining properties will no longer be inherited. Rather, they will be saved directly for the sub-variation.
