...
You’ll need to save settings in this tab if you’re preparing items to be sold on marketplaces like xref:markets:amazon.adoc#[Amazon], xref:markets:ebay-setup.adoc#[eBay] or <<markets/neckermann/neckermann-at-setup#, Neckermann.at>>.
