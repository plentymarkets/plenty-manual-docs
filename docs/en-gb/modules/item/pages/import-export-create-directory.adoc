...
In the **Warehouse** tab of a variation, you select warehouses for the product and enter xref:stock-management:new-incoming-items.adoc#200[warehouse information], i.e. reorder level and maximum stock.
