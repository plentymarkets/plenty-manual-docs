...
So if you want to use ShopBuilder to create your plentyShop, then you might also want to xref:online-store:shop-builder.adoc#create-category[use ShopBuilder to create your categories] too.
