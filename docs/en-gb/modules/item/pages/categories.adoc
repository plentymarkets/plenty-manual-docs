...
xref:online-store:shop-builder.adoc#_category_navigation[While setting up your plentyShop], you'll decide how many category levels should be displayed in the header.
====
...
Have you already thought up a xref:item:categories.adoc#100[meaningful category structure]? Then you’re ready to create the main categories and sub-categories that will group your products.
...
In other words, you can create a new category while xref:item:new-item.adoc#200[manually creating an item].
...
TIP: It’s technically possible to create items and categories at the same time.
In other words, you can create a new category while xref:data:elasticSync-item.adoc#1150[creating an item].
This method can save you a lot of time but it might also cause you to lose track of your category structure.
...
So if you want to use ShopBuilder to create your plentyShop, then you might also want to xref:online-store:shop-builder.adoc#20[use ShopBuilder to create your categories] too.
...
* xref:item:categories.adoc#intable-use-case[what do you want to use the category for]?
* xref:item:categories.adoc#intable-url[what should the URL be]?
* xref:item:categories.adoc#intable-meta-data[does the category have any meta data that is relevant for SEO]?
* xref:item:categories.adoc#intable-login[should people only be able to see the category if they’ve logged in]?

[TIP]
.Why don’t I see some of the settings?
====
The settings will differ slightly depending on xref:item:categories.adoc#intable-use-case[what you want to use the category for].
...
Are there _sub-categories_ underneath this category? Then the following also applies:
...
. Open the category’s xref:online-store:shop-builder.adoc#55[editor view].
...
====
Sometimes it makes sense to list an item in several different categories. You can xref:item:import.adoc#700[comma-separated in the import files].
====
...
include::page$checklist-categories-visibility.adoc[tag=systemeinstellungen]
...
include::page$checklist-categories-visibility.adoc[tag=ebenentiefe]
