...
People with back end user rights can only work with properties if an admin has granted them access:

. Find someone who has administrator rights for the plentymarkets system.
. This person will open the menu *Setup » Settings » User » Rights » User » [Open user account]*.
. In the column *Authorisations*, this person will grant the necessary rights under *Setup » Property* (icon:check-square[role="blue"]).
