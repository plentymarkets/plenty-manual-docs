...
You can either create properties manually or you can import them with a CSV file.
...
. xref:item:properties.adoc#600[Create properties] like Wi-Fi or Bluetooth.
. xref:item:properties.adoc#1200[Group the properties].
For example, to keep track of the properties in your plentymarkets back end.
. xref:item:properties.adoc#1400[Link the properties] to the appropriate variations. For example, link the Bluetooth property to your Bluetooth compliant products.
...
You can do this with the import types xref:data:elasticSync-properties-selection-values.adoc#[Selection values].
...
How your properties are displayed in the xref:online-store:shop-builder.adoc#[ShopBuilder]. This video provides a short demonstration (German only).
...
Yes.
Properties can also be used to characterise xref:crm:setting-up-a-warehouse.adoc#850[storage locations].
