...
* *No* = The search results will only include items that are not part of a listing or an auction, i.e. items with a xref:item:search.adoc#800[grey listing symbol] (icon:listings_show[set=plenty, role="darkGrey"]).
