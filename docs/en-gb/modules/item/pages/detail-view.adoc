...
* xref:item:detail-view.adoc#100[navigate through product data records]
...
Once you’ve opened the menu *Item » New item UI* and xref:item:search.adoc#[started a search], you’ll see the results in an overview.
