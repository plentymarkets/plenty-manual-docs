...
Some markets, such as xref:markets:preparing-variations.adoc#1350[Amazon] and xref:markets:ebay-setup.adoc#6100[eBay], require you to link _your own_ attribute values with _their attribute values_.
...
plentymarkets has an xref:data:ElasticSync.adoc#[import tool], which you can use to import attributes.
The idea is simple.
...
====
* Use the format type xref:data:attributes.adoc#[Attribute] to export information about the attributes and attribute values.
