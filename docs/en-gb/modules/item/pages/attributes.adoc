...
Some markets, such as xref:markets:ebay-setup.adoc#6100[eBay], require you to link _your own_ attribute values with _their attribute values_.
...
* Use the format type xref:data:item.adoc#900[Item / VariationAttributeValues] to see which attribute values are linked with a specific variation.
====
