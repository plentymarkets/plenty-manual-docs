...
* *_Keywords in the plentyShop_*: you decide which tags should be <<welcome/general-functions/tags#intable-client, visible to customers in the plentyShop>> and which should not.
* *_Other types of data_*: you can even use tags to <<welcome/general-functions/tags#, highlight other types of data>>, e.g. customers, orders, tickets, etc.
