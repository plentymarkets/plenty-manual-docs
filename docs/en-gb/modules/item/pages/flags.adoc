...
. xref:item:flags.adoc#500[Create] the necessary tags, e.g. "bestseller backpacks".
During the process, select (icon:check-square[role="blue"]) the availability *Variation* and the appropriate clients.
. xref:item:flags.adoc#600[Link] the tag to the appropriate variations, e.g. to the 6 most popular backpacks.

---

*_Item list in the plentyShop_*:

. Go to *CMS » ShopBuilder » [Open item category] » [Open content]*.
...
Example: Enter the ID of the tag "bestseller backpacks".
