...
//. Go to *Item » Item UI*.
//. Click on *Filter* (icon:tune[set=material, role="darkGrey"]) and select the appropriate combination of flags from the drop-down lists xref:item:item-search.adoc#100[Flag 1 and 2].
...
//. Select the columns *Flag 1* and *Flag 2* (icon:check-square[role="blue"]).
//. Move your cursor over the symbol icon:drag_indicator[set=material, role="darkGrey"]. +
