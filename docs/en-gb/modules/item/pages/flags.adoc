...
* *_Keywords in the plentyShop_*: you decide which tags should be xref:welcome:tags.adoc#intable-client[visible to customers in the plentyShop] and which should not.
* *_Other types of data_*: you can even use tags to xref:welcome:tags.adoc#[highlight other types of data], e.g. customers, orders, tickets, etc.
