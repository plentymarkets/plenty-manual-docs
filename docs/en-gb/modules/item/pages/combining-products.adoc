...
* The set function is compatible with link:https://marketplace.plentymarkets.com/en/plugins/sales/online-shops/ceres_4697[plentyShop LTS] version 5.0 and higher.
Lower versions of plentyShop LTS do not support the set function.
