...
For example, that you’ve already created a xref:item:preparing-the-shipment.adoc#1000[shipping profiles] for your items, etc.
====
...
An item bundle is made up of various components. Each component has its own key figures, such as a xref:item:managing-items.adoc#280[purchase price]. But how do these key figures come together for the entire bundle?
...
* save xref:item:managing-items.adoc#268[tags]
* etc.
