...
For example, you should know the xref:item:inheritance.adoc#[inherited].
...
*_Use case_*: You’ll see the flags when you look at your xref:item:search.adoc#100[search for items] that have a specific flag or combination of flags.
