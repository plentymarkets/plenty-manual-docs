...
====
Maybe you noticed that it’s possible to xref:crm:managing-contacts.adoc#90[create manufacturer data records in the CRM menu].
But be careful.
...
* Specify the manufacturer xref:item:managing-items.adoc#40[in an existing item’s Global tab].
...
* Do you want to import your items? Then xref:data:elasticSync-item.adoc#2260[specify each item’s manufacturer in the CSV file] that you will import.
