...
| *EU Responsible Name*
|
include::partial$eu-responsible-name.adoc[]

| *EU Responsible Street*
|
include::partial$eu-responsible-street.adoc[]

| *EU Responsible House No.*
|
include::partial$eu-responsible-house-no.adoc[]

| *EU Responsible Postcode*
|
include::partial$eu-responsible-postcode.adoc[]

| *EU Responsible Town*
|
include::partial$eu-responsible-town.adoc[]

| *EU Responsible Country*
|
include::partial$eu-responsible-country.adoc[]

| *EU Responsible Email*
|
include::partial$eu-responsible-email.adoc[]
