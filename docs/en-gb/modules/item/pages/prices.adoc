...
. In a line, click on icon:ellipsis-v[role="darkGrey"] and then on icon:sell[set=material, role="darkGrey"] *Lowest price »* icon:pencil[role="darkGrey"] *Set manually*. +
...
. Open the menu *Item » Item UI » [Open variation] » Element: Sales prices*.
. In a line, click on icon:ellipsis-v[role="darkGrey"] and then on icon:sell[set=material, role="darkGrey"] *Lowest price »* icon:calculate_acquisition_pricepng[set=plenty, role="darkGrey"] *Enable automatic detection*. +
