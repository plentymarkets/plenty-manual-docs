...
include::import-export-create:page$import-export-create-directory.adoc[tag=apply-price-calculation]
...
include::import-export-create:page$mass-processing.adoc[tag=variation-group-function]
...
include::import-export-create:page$mass-processing.adoc[tag=variation-batch-processing]
