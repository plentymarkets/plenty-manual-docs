...
IMPORTANT: Currently, the lowest price can only be saved in the plentymarkets back end.
Starting with link:https://marketplace.plentymarkets.com/ceres_4697[plentyShop LTS version 5.0.51^], it will also be possible to display this value in the webshop.

[.instruction]
Manual entry:

. Open the menu *Item » Item UI » [Open variation] » Element: Sales prices*.
. In a line, click on icon:ellipsis-v[role="darkGrey"] and then on icon:sell[set=material, role="darkGrey"] *Lowest price* icon:arrow_right[set=material, role="darkGrey"] icon:pencil[role="darkGrey"] *Activate manual entry*. +
...
. Open the menu *Item » Item UI » [Open variation] » Element: Sales prices*.
. In a line, click on icon:ellipsis-v[role="darkGrey"] and then on icon:sell[set=material, role="darkGrey"] *Lowest price* icon:arrow_right[set=material, role="darkGrey"] icon:calculate_acquisition_pricepng[set=plenty, role="darkGrey"] *Activate automatic calculation*. +
