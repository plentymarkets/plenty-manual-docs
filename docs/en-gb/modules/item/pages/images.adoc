...
Who hosts your domain? How you’ll proceed depends on whether your domain is hosted by xref:item:images.adoc#300[plentymarkets] or by an xref:item:images.adoc#400[external provider].
...
Every plentymarkets system has its own xref:data:ftp-access.adoc#[FTP server].
