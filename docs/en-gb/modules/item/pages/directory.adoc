...
|
include::../../_textblocks/directory/global/condition.adoc[]

|*Condition for API*
|
include::../../_textblocks/directory/global/condition-api.adoc[]

| *Type*
|
include::../../_textblocks/directory/global/type-stocktype.adoc[]

|[#intable-manufacturer]*Manufacturer*
|
include::../../_textblocks/directory/global/manufacturer.adoc[]

| *Manufacturing country*
|
include::../../_textblocks/directory/global/manufacturing-country.adoc[]

| *Revenue account*
|
include::../../_textblocks/directory/global/revenue-account.adoc[]

| *Max. order quantity*
|
include::../../_textblocks/directory/global/max-order-quantity.adoc[]

| *Age rating*
|
include::../../_textblocks/directory/global/age-rating.adoc[]

| *Promotional coupon/POS discount*
|
include::../../_textblocks/directory/global/promotional-coupon.adoc[]

| *Subscription*
|
include::../../_textblocks/directory/global/subscription.adoc[]

| *Shipping package*
|
include::../../_textblocks/directory/global/shipping-package.adoc[]

| *Serial number*
|
include::../../_textblocks/directory/global/serial-number.adoc[]
|====
...
If an order contains items without a shipping profile, then the items will be given <<online-store/setting-up-ceres#260, the default shipping profile for the default online store>>. If no default shipping profile was specified, then the shipping profile with the highest priority will be used.
...
| *Store special*
|
include::../../_textblocks/directory/global/store-special.adoc[]

| *Item feedback*
|
include::../../_textblocks/directory/global/item-feedback.adoc[]
|====
...
| *Product type*
|
include::../../_textblocks/directory/multichannel/product-type.adoc[]

| *FBA Fulfillment*
|
include::../../_textblocks/directory/multichannel/fba-fulfillment.adoc[]

| *Amazon FBA*
|
include::../../_textblocks/directory/multichannel/amazon-fba.adoc[]
|====
...
| *Listing template*
|
include::../../_textblocks/directory/multichannel/listing-template.adoc[]

| *Category 1*; +
*Category 2*
|
include::../../_textblocks/directory/multichannel/ebay-category.adoc[]

| *Store category 1*; +
*Store category 2*
|
include::../../_textblocks/directory/multichannel/ebay-store-category.adoc[]
...
. First, you’ll create <<item/settings/properties#500, properties>> of the type *Text* or *HTML*.
. Then you’ll <<item/settings/properties#1400, link these properties>> with the appropriate variations.
====
...
| *Name 1*
|
include::../../_textblocks/directory/texts/name1.adoc[]

| *Name 2*
|
include::../../_textblocks/directory/texts/name2.adoc[]

| *Name 3*
|
include::../../_textblocks/directory/texts/name3.adoc[]

| *Preview text*
|
include::../../_textblocks/directory/texts/preview-text.adoc[]

| *Item text*
|
include::../../_textblocks/directory/texts/item-text.adoc[]

| *Technical data*
|
include::../../_textblocks/directory/texts/technical-data.adoc[]
...
| *Meta description*
|
include::../../_textblocks/directory/texts/meta-description.adoc[]

| *Meta keywords*
|
include::../../_textblocks/directory/texts/meta-keywords.adoc[]

| *Item template*
|Not recommended. It’s technically possible to select a <<item/online-store/callisto-templates#, template>> to alter the design of the detail view of an item.
...
* <<item/managing-items#94, the image is linked to at least one variation>>.
* <<item/managing-items#intable-availability, you have made the images available for the marketplace>>.
* <<item/settings/attributes#intable-allow-image-link, you have allowed image links in the basic settings>>.
...
Instead of uploading files in this tab, <<item/settings/properties#500, create a property>> of the type "File".
====
...
| *Variation name*
|
include::../../_textblocks/directory/variation/settings/basic-settings/variation-name.adoc[]

|[#intable-variation-number]*Variation No.*
|
include::../../_textblocks/directory/variation/settings/basic-settings/variation-no.adoc[]

| *External  variation ID*
|
include::../../_textblocks/directory/variation/settings/basic-settings/external-variation-id.adoc[]

| *Model*
|
include::../../_textblocks/directory/variation/settings/basic-settings/model.adoc[]

| *Position*
|
include::../../_textblocks/directory/variation/settings/basic-settings/position.adoc[]
...
|
include::../../_textblocks/directory/variation/settings/availability/active.adoc[]

2+| *Availability*

|[#intable-symbol]*Symbols 1-10*
|
include::../../_textblocks/directory/variation/settings/availability/symbol.adoc[]
...
*_Note_*: Both functions complement each other and are only applied if the <<item/managing-items#intable-limitation, Limitation>> option is set to *To net stock*.
...
! *Available automatically if net stock is positive*
!
include::../../_textblocks/directory/variation/settings/availability/show-online-store/automatically-available.adoc[]

! *Not available automatically if net stock is 0 or negative*
!
include::../../_textblocks/directory/variation/settings/availability/show-online-store/automatically-not-available.adoc[]
...
! *Visible automatically if net stock is positive*
!
include::../../_textblocks/directory/variation/settings/availability/client/automatically-visible.adoc[]

! *Invisible automatically if net stock is 0 or negative*
!
include::../../_textblocks/directory/variation/settings/availability/client/automatically-invisible.adoc[]

!===

*_Relationship to other settings_*: These options take priority over the <<item/managing-items#intable-item-list, item list>> options further below.
...
! *Always invisible*
!
include::../../_textblocks/directory/variation/settings/availability/item-list/always-invisible.adoc[]

! *Visible automatically if net stock is positive*
!
include::../../_textblocks/directory/variation/settings/availability/item-list/automatically-visible.adoc[]

! *Invisible automatically if net stock is 0 or negative*
!
include::../../_textblocks/directory/variation/settings/availability/item-list/automatically-invisible.adoc[]
...
|
include::../../_textblocks/directory/variation/settings/availability/limitation.adoc[]

| *Max. order quantity*
|
include::../../_textblocks/directory/variation/settings/availability/max-order-quantity.adoc[]

| *Min. order quantity*
|
include::../../_textblocks/directory/variation/settings/availability/min-order-quantity.adoc[]

| *Interval order quantity*
|
include::../../_textblocks/directory/variation/settings/availability/interval-order-quantity.adoc[]

| *Release date*
|
include::../../_textblocks/directory/variation/settings/availability/release-date.adoc[]

| *Available until*
|
include::../../_textblocks/directory/variation/settings/availability/available-until.adoc[]
...
| *MOIN*
|The "My OTTO Identification Number" is an alphanumeric product identification that is provided by <<markets/otto/otto-market#, OTTO Market>>.
...
! *Quantity*
!
include::../../_textblocks/directory/variation/settings/dimensions/content-quantity.adoc[]

! *Unit*
!
include::../../_textblocks/directory/variation/settings/dimensions/content-unit.adoc[]

!===

| *Length/Width/Height*
|
include::../../_textblocks/directory/variation/settings/dimensions/length-width-height.adoc[]

| *Gross weight*
|
include::../../_textblocks/directory/variation/settings/dimensions/gross-weight.adoc[]

| *Net weight*
|
include::../../_textblocks/directory/variation/settings/dimensions/net-weight.adoc[]

| *Units contained*
|
include::../../_textblocks/directory/variation/settings/dimensions/units-contained.adoc[]

|[#intable-unit-price]*Show unit price*
|
include::../../_textblocks/directory/variation/settings/dimensions/show-unit-price.adoc[]
...
| *VAT*
|
include::../../_textblocks/directory/variation/settings/costs/vat.adoc[]

| *Net purchase price*
|
include::../../_textblocks/directory/variation/settings/costs/net-purchase-price.adoc[]

| *Moving average purchase price (net)*
|
include::../../_textblocks/directory/variation/settings/costs/moving-average-purchase-price.adoc[]

| *Net transportation costs*
|
include::../../_textblocks/directory/variation/settings/costs/net-transportation-costs.adoc[]

| *Net storage costs*
|
include::../../_textblocks/directory/variation/settings/costs/net-storage-costs.adoc[]

| *Customs*
|
include::../../_textblocks/directory/variation/settings/costs/customs.adoc[]

| *Customs tariff number*
|
include::../../_textblocks/directory/variation/settings/costs/customs-tariff-number.adoc[]

| *Operating costs*
|
include::../../_textblocks/directory/variation/settings/costs/operating-costs.adoc[]
...
| *Order picking*
|
include::../../_textblocks/directory/variation/settings/shipping/order-picking.adoc[]

| *Main warehouse*
|
include::../../_textblocks/directory/variation/settings/shipping/main-warehouse.adoc[]

| *Pallet type*
|
include::../../_textblocks/directory/variation/settings/shipping/pallet-type.adoc[]
...
! *Quantity*
!
include::../../_textblocks/directory/variation/settings/shipping/packing-units-quantity.adoc[]

! *Unit*
!
include::../../_textblocks/directory/variation/settings/shipping/packing-units-unit.adoc[]
...
|
include::../../_textblocks/directory/variation/settings/shipping/extra-shipping-charge.adoc[]
...
It’s true that there’s a marketplace called "Store".
...
You can learn more about these settings in our <<item/online-store/checklist-items-visibility#, checklist for item visibility in the plentyShop>>.
====
